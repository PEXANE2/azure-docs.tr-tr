...
1. Yedekleme zamanlaması sihirbazında, **ileri** ** > Başlarken ' i seçin** .
...
1. **Ilk yedekleme türünü seçin** sayfasında, ilk yedeklemeyi ağ üzerinden mi yoksa çevrimdışı yedekleme mi kullanacağınızı belirleyin. İlk yedeklemeyi ağ üzerinden almak için, **ileri** > **ağ üzerinden otomatik olarak** ' i seçin.
