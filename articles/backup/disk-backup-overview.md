...
Azure disk yedekleme, [Artımlı anlık görüntü](https://docs.microsoft.com/azure/virtual-machines/windows/disks-incremental-snapshots) kullanan aracısız ve kilitlenmeyle tutarlı bir çözümdür ve aşağıdaki avantajları sunar:
