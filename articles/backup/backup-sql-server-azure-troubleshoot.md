...
Yedekleme işlemi ve sınırlamaları hakkında daha fazla bilgi için bkz. [Azure VM 'lerde SQL Server yedekleme hakkında](sql-support-matrix.md#feature-consideration-and-limitations).
