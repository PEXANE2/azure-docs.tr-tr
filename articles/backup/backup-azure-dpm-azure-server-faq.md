---
title: Azure Backup Sunucusu ve DPM (Data Protection Manager) hakkında SSS
description: Bu makalede, Microsoft Azure Backup sunucusu (MABS) ve DPM hakkında sık sorulan soruların yanıtlarını bulun.
