...
1. Azure portal, bir [Kurtarma Hizmetleri Kasası](https://docs.microsoft.com/azure/backup/backup-configure-vault#create-a-recovery-services-vault)oluşturun ve yedekleme hedeflerinden dosyalar, klasörler ve sistem durumu ' nu seçin.
2. [Kurtarma Hizmetleri Kasası kimlik bilgilerini ve Aracı yükleyicisini](https://docs.microsoft.com/azure/backup/backup-configure-vault#download-the-mars-agent) şirket içi bir makineye indirin. 
...
4. İstemcideki Aracı konsolundan [yedeklemeyi yapılandırın](https://docs.microsoft.com/azure/backup/backup-configure-vault#create-a-backup-policy). Korumaya başlamak için yedekleme verilerinizin bekletme ilkesini belirtin.
