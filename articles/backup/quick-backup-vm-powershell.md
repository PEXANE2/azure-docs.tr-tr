---
title: Hızlı başlangıç-PowerShell ile sanal makine yedekleme
description: Bu hızlı başlangıçta Azure PowerShell modülü ile Azure sanal makinelerinizi nasıl yedekleyeceğinizi öğrenin.
ms.devlang: azurecli
ms.topic: quickstart
ms.date: 04/16/2019
