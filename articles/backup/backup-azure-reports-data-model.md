...
| AlertSeverity |Text |Uyarının önem derecesi. Örneğin, kritik |
| AlertStatus |Text |Uyarının durumu. Örneğin, etkin |
...
| Backupıtemtype |Text |Yedekleme öğesi türü. Örneğin, VM, dosya klasörü |
...
| ProtectionState |Text |Yedekleme öğesinin geçerli koruma durumu. Örneğin, korumalı, Protectiondurdurulmuş |
...
| MonthlyRetentionFormat |Text |Aylık saklama için yapılandırma türü. Örneğin günlük tabanlı, haftalık için haftalık |
| MonthlyRetentionTimes |Text |Aylık bekletmenin yapılandırıldığı tarih ve saat |
| MonthlyRetentionWeeksOfTheMonth |Text |Aylık bekletme yapılandırıldığında ayın haftası. Örneğin, Ilk, son vb. |
| PolicyName |Text |Tanımlanan ilkenin adı |
| Policyuniqueıd |Text |İlkeyi tanımlamak için benzersiz kimlik |
| RetentionType |Text |Bekletme ilkesi türü. Örneğin, günlük, haftalık, aylık, yıllık |
...
| YearlyRetentionFormat |Text |Yıllık saklama için yapılandırma türü. Örneğin günlük tabanlı, haftalık için haftalık |
...
| YearlyRetentionWeeksOfTheMonth |Text |Yıllık bekletme yapılandırıldığında ayın haftası. Örneğin, Ilk, son vb. |
...
| StorageReplicationType |Text |Kasa için depolama çoğaltma türü. Örneğin, Geoyedekli |
