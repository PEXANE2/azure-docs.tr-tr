---
title: Azure Backup ile dosya ve klasörleri yedeklerken sık sorulan sorular
...
* Dosya sistemi kimliği: NTFS, desteklenen tek dosya sistemidir.
...
2. Karalama klasörü konumunun yolunun aşağıda gösterilen kayıt defteri anahtarı girişlerinin değerleriyle eşleştiğinden emin olun:
  ...
  | Kayıt defteri yolu | Kayıt Defteri Anahtarı | Value |
  | --- | --- | --- |
...
* Çevrimdışı birimler: Azure Backup Aracısı kullanılarak beklenen yedekleme için önbellek klasörünün çevrimiçi olması gerekir
