...
Kurtarma Hizmetleri kasası için kaynak hareketi Avustralya Doğu, Avustralya Güney Doğu, Kanada Orta, Kanada Doğu, Güney Doğu Asya, Doğu Asya, Orta ABD, Kuzey Orta ABD, Doğu ABD, Doğu US2, Güney orta ABD, Batı Orta ABD, Batı Orta US2, Batı ABD, Batı ABD, Batı ABD, Batı ABD, Orta Hindistan, Güney Hindistan, Japonya Doğu, Japonya Batı, Kore Orta, Kore Güney, Kuzey Avrupa, Batı Avrupa, Güney Afrika Kuzey, Güney Afrika Batı, İngiltere Güney ve İngiltere Batı.
...
- Abonelikler arasında kasa taşımak için, hedef aboneliğin kaynak abonelikle aynı kiracıda olması ve durumunun etkinleştirilmesi gerekir.
...
- Klasik model de dağıtılan kaynakları taşıma seçenekleri, kaynakları abonelik içinde mi yoksa yeni bir aboneye mi taşıydığınıza bağlı olarak değişir. Daha fazla bilgi için bu [makaleye](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-move-resources)bakın.
- Kasa için tanımlanan yedekleme ilkeleri, kasa abonelikler arasında veya yeni bir kaynak grubuna geçtikten sonra korunur.
- IaaS VM'lerde Abonelikler ve kaynak grupları arasında Azure Dosyaları, Azure Dosya Eşitlemesi veya SQL ile kasa taşıma desteklenmez.
...
> [!NOTE]
>
> **Azure Site Kurtarma** ile kullanmak üzere yapılandırılan Kurtarma Hizmetleri kasaları henüz hareket edemez. **Azure Site Kurtarma'yı**kullanarak olağanüstü durum kurtarma için herhangi bir VM (Azure IaaS, Hyper-V, VMware) veya fiziksel makineleri yapılandırmışsanız, taşıma işlemi engellenir. Site Kurtarma hizmeti için kaynak taşıma özelliği henüz kullanılamıyor.
...
4. Kaynakları **Taşı** bıçağında, seçili kasa için aşağıdaki resimde gösterildiği gibi onay kutusunu seçerek isteğe bağlı ilgili kaynakların taşınması önerilir.
...
Yukarıdaki cmdlets çalıştırdıktan sonra, belirtilen kaynakları taşımak istediğinizi onaylamak için istenecektir. Onaylamak için **Y** yazın. Başarılı bir doğrulamadan sonra kaynak taşınır.
