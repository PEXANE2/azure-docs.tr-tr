...
1. **Proje adı**alanına `CreateADLApplication`girin ve ardından **Oluştur**' u seçin.
1. NuGet paketlerini projenize ekleyin.
   ...
   1. Aşağıdaki NuGet paketlerini arayıp yükleyin:
      ...
      * `Microsoft.Azure.DataLake.Store`-Bu makale v 1.0.0 kullanır.
      * `Microsoft.Rest.ClientRuntime.Azure.Authentication`-Bu makale v 2.3.1 kullanır.
