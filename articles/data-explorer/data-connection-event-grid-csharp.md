...
Bu betik depolama hesabınızda yeni bir kapsayıcı oluşturur, var olan bir dosyayı (blob olarak) bu kapsayıcıya yükler ve ardından kapsayıcıdaki Blobları listeler.
...
> [!NOTE]
> Azure Veri Gezgini, Blobların gönderisini silmez. Blob silmeyi yönetmek için [Azure Blob depolama yaşam döngüsünü](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal) kullanarak Blobları üç ila beş güne koruyun.
