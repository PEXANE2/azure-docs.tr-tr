---
title: Python kullanarak Azure Veri Gezgini ile uçtan uca blob alma
description: Bu makalede, Python kullanarak uçtan uca örnek ile Azure Veri Gezgini ile alma blob 'larını nasıl kullanacağınızı öğreneceksiniz.
...
ms.locfileid: "72809607"
---
# <a name="end-to-end-blob-ingestion-into-azure-data-explorer-using-python"></a>Python kullanarak Azure Veri Gezgini ile uçtan uca blob alma
...
*  Bir küme ve veritabanı oluşturmanın diğer yolları hakkında bilgi edinmek için [bir Azure Veri Gezgini kümesi ve veritabanı oluşturun](create-cluster-database-python.md) .
