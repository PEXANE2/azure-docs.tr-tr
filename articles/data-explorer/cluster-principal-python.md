---
title: Python kullanarak Azure Veri Gezgini için küme sorumlularını ekleme
description: Bu makalede, Python kullanarak Azure Veri Gezgini için küme sorumluları eklemeyi öğreneceksiniz.
...
---
# <a name="add-cluster-principals-for-azure-data-explorer-by-using-python"></a>Python kullanarak Azure Veri Gezgini için küme sorumlularını ekleme
...
Azure Veri Gezgini, günlük ve telemetri verileri için hızlı ve üst düzeyde ölçeklenebilir veri keşfetme hizmetidir. Bu makalede, Python kullanarak Azure Veri Gezgini için küme sorumluları eklersiniz.
...
| principal_assignment_name | *clusterPrincipalAssignment1* | Küme asıl kaynağınızın adı.|
...
* [Veritabanı sorumluları Ekle](database-principal-python.md)
