---
title: Azure Service Fabric hizmet modeli XML şema eleman grupları
description: Service Fabric hizmet modelinin XML şemasındaki öğe gruplarını açıklar.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "79282087"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-fabric-service-model-xml-schema-elements"></a>Servis Kumaş servis modeli XML şema elemanları

## <a name="partitiondescriptiongroup-group"></a>PartitionDescriptionGroup grubu
Bir hizmetin bölümleme düzenini tanımlar.

|Öznitelik|Değer|
|---|---|
|content|3 element(ler)|
...
#### <a name="uniformint64partition"></a>UniformInt64Bölüm
...
## <a name="scalingpolicymechanismgroup-group"></a>ÖlçeklemePolitikasıMekanizmaGrubu grubu
Ölçekleme mekanizmasını tanımlar.

|Öznitelik|Değer|
|---|---|
|content|2 eleman(lar)|
...
#### <a name="addremoveincrementalnamedpartitionscalingmechanism"></a>AddRemoveIncrementalNamedPartitionScalingMekanizması
...
Ölçekleme tetikleyicisini tanımlar.
