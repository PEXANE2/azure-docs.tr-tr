...
İlk olarak, öğreticinin ilk bölümünde oluşturulan TLS/SSL sertifikasıyla kümeye bağlanın. `Connect-ServiceFabricCluster` cmdlet’ini veya `sfctl cluster upgrade-status` komutunu kullanın.
