---
title: Azure Service Fabric hizmet modeli XML şeması açıklamaları
description: Service Fabric hizmeti modelinin, konum ve bileşen Özeti dahil olmak üzere XML şemasının bir açıklaması.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639199"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Hizmet modeli XML şeması belgeleri
Bu makale, Service Fabric SDK ile yüklenen ServiceFabricServiceModel. xsd şema dosyasını belgeler.  Varsayılan olarak, şema dosyası *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*'e yüklenir.

## <a name="namespace-bindings"></a>Ad alanı bağlamaları

|Alan kodu|Ad alanı URI 'SI|
|---|---|
|x|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Bileşen Özeti 
ServiceFabricServiceModel. xsd dosyasında aşağıdaki bileşenler tanımlanmıştır:
- [257 öğeleri](service-fabric-service-model-schema-elements.md)
...
- [3 öğe grubu](service-fabric-service-model-schema-element-groups.md)
- [16 öznitelik grubu](service-fabric-service-model-schema-attribute-groups.md)
