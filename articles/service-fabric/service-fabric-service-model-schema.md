---
title: Azure Hizmet Kumaşı hizmet modeli XML şema açıklamaları
description: Konum ve bileşenlerin özeti de dahil olmak üzere Service Fabric servis modelinin XML şemasının açıklaması.
ms.topic: reference
ms.date: 12/10/2018
...
# <a name="service-model-xml-schema-documentation"></a>Servis modeli XML şema dokümantasyonu
Bu makale, Service Fabric SDK ile yüklenen ServiceFabricServiceModel.xsd şema dosyasını belgeledir.  Varsayılan olarak, şema dosyası *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*yüklenir.
...
Aşağıdaki bileşenler ServiceFabricServiceModel.xsd tanımlanır:
...
- [3 element grubu](service-fabric-service-model-schema-element-groups.md)
