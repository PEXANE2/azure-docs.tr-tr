...
3. Web tarayıcısını kullanarak `http://localhost:8080` adresine gidin. Metin kutusuna yeni bir öğe yazın ve **+ Ekle**' ye tıklayın. Kesme noktası isabet etmelidir. Yürütmeye devam etmek, satırlarda adım adım veya geçerli yöntemin dışına geçmek için VS Code üstündeki hata ayıklama araç çubuğunu kullanabilirsiniz. 
