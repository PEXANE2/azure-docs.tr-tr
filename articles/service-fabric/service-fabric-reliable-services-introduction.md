...
Bu hizmet tipik bir .NET hizmeti gibi gelse de, kullanılan veri yapılarının (`IReliableQueue` ve `IReliableDictionary`) Service Fabric tarafından sağlandığı ve yüksek oranda güvenilir, kullanılabilir ve tutarlı olduğu fark vardır.
