...
|CrlCheckingFlag|uint, varsayılan değer 0x40000000|Dinamik|Varsayılan sertifika zinciri doğrulama bayrağı; bileşene özgü bayrak tarafından geçersiz kılınabilir. Örneğin, Federation/X509CertChainFlags 0x10000000 CERT_CHAIN_REVOCATION_CHECK_END_CERT 0x20000000 CERT_CHAIN_REVOCATION_CHECK_CHAIN 0x40000000 CERT_CHAIN_REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT 0x80000000 CERT_CHAIN_REVOCATION_CHECK_CACHE_ONLY ayarı 0 olarak ayarlandığında, desteklenen değerlerin tam listesini devre dışı bırakır, Certgetcertificatezincirinin dwFlags tarafından belgelenmiştir: https://msdn.microsoft.com/library/windows/desktop/aa376078(v=vs.85).aspx |
...
|GetChaosReport | dize, varsayılan "admin\|\|user" |Dinamik| Belirli bir zaman aralığı içinde Chaos durumunu getirir. |
...
|GetNodeTransitionProgress | dize, varsayılan "admin\|\|user" |Dinamik| Düğüm geçiş komutunda ilerleme durumunu almak için güvenlik yapılandırması. |
