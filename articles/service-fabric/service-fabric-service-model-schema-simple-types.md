---
title: Azure Servis Kumaş servis modeli XML şema basit türleri
description: Service Fabric servis modelinin XML şemasındaki basit türleri açıklar.
ms.topic: reference
ms.date: 12/10/2018
...
# <a name="service-model-xml-schema-simple-types"></a>Servis modeli XML şema basit türleri

## <a name="fabricuri-simpletype"></a>FabricUri simpleType
Microsoft Azure Hizmet Kumaş Adlandırma sistemi tarafından hizmetlerin kararlı bir tanımlayıcısı olarak kullanılan bir URI. 
