...
| Parametre | Açıklama |
| --- | --- |
| Uygulama kimliği  |Yükseltilmekte olan uygulamanın KIMLIĞI. <br> Bu genellikle uygulamanın ' Fabric: ' URI düzeni olmadan tam adıdır. Sürüm 6,0 ' den başlayarak, hiyerarşik adlar ' \~ ' karakteriyle sınırlandırılmıştır. Örneğin, uygulama adı ' Fabric:/MyApp/APP1 ' ise uygulama kimliği, önceki sürümlerde 6.0 + ve ' MyApp/APP1 ' içinde ' MyApp @ no__t-0app1 ' olur.|
