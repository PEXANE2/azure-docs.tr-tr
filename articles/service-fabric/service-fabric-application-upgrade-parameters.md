...
mode | İzin verilen değerler Izleniyor, **upgrademode**, **iziztoredauto**, **monitortoredmanual**. Varsayılan olarak, **Monitortoredauto**. Bu değerlerin açıklamaları için Visual Studio ve PowerShell *gerekli parametreler* bölümüne bakın.|
