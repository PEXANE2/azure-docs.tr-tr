...
**Üretim iş yükleri için önerilen VM boyutu (SKU) en az 50 GB yerel SSD ile standart D2_V2 (veya eşdeğerdir).** En az 50 GB yerel SSD önerilir, ancak bazı iş yükleri (örneğin, Windows kapsayıcıları çalıştıran) daha büyük diskler gerektirir. Üretim iş yükleri için diğer [VM boyutlarını](../virtual-machines/sizes-general.md) seçerken, aşağıdaki kısıtlamaları göz önünde bulundurun:
