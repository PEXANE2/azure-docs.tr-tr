...
* **Sunucu kimlik doğrulaması:** Yönetim istemcisinin gerçek kümeyle konuştureceğini bilmesini sağlamak için, küme yönetimi uç noktalarının bir yönetim istemcisinde kimliğini doğrular. Bu sertifika, HTTPS yönetim API 'SI ve HTTPS üzerinden Service Fabric Explorer için TLS de sağlar.
