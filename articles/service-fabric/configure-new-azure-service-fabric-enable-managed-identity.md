...
---
# <a name="configure-managed-identity-support-for-a-new-service-fabric-cluster-preview"></a>Yeni bir Hizmet Kumaşı kümesi için yönetilen kimlik desteğini yapılandırma (önizleme)
