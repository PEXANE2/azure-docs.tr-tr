---
title: Azure Service Fabric hizmet modeli XML şeması karmaşık türleri
...
|tür|[ServiceTypeHealthPolicyType](#servicetypehealthpolicytype-complextype)|
|Ayarlan|0|
...
|tür|[Servicetemplatesttype](#servicetemplatestype-complextype)|
...
|tür|[DefaultServicesType](#defaultservicestype-complextype)|
...
|---|---|
|name|Sorumlular|
|tür|[SecurityPrincipalsType](#securityprincipalstype-complextype)|
|Ayarlan|0|
...
|---|---|
|name|İlkeler|
|tür|[Applicationpolicıestype](#applicationpoliciestype-complextype)|
|Ayarlan|0|
...
|---|---|
|name|Tanılama|
|tür|[DiagnosticsType](#diagnosticstype-complextype)|
|Ayarlan|0|
...
|tür|[EnvironmentType](#environmenttype-complextype)|
...
|---|---|
|name|HealthPolicy|
|tür|[ApplicationHealthPolicyType](#applicationhealthpolicytype-complextype)|
|Ayarlan|0|
...
|tür|[FabricCertificateType](#fabriccertificatetype-complextype)|
|Ayarlan|0|
...
|---|---|
|name|FabricSettings|
|tür|[SettingsOverridesType](#settingsoverridestype-complextype)|
|Ayarlan|0|
...
|---|---|
|name|EntryPoint|
|tür|[EntryPointDescriptionType](#entrypointdescriptiontype-complextype)|
|Ayarlan|1|
...
|tür|[EnvironmentVariablesType](#environmentvariablestype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
ConfigPackage bölüm adı Settings.xml.
...
|---|---|
|name|ConfigPackage|
|tür|[ConfigPackageDescriptionType](#configpackagedescriptiontype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
#### <a name="includedockerhealthstatusinsystemhealthreport"></a>Includedockerhealthstatusınsystemhealthreport
Kapsayıcıda bu kapsayıcı için HEALTHCHECK etkin ve Docker raporları health_status olay varsa, bu Service Fabric, sistem tarafından bildirilen sistem durumunun bir parçası olarak bunu içerir. Health_status sağlıksız olduğunda Service Fabric bir sistem durumu uyarısı rapor eder. Varsayılan olarak true değerine ayarlanır.

|Öznitelik|Değer|
|---|---|
|name|Includedockerhealthstatusınsystemhealthreport|
|tür|xs: Boolean|
|kullan|isteğe bağlı|
|default|true|

#### <a name="restartcontaineronunhealthydockerhealthstatus"></a>RestartContainerOnUnhealthyDockerHealthStatus
Kapsayıcıda bu kapsayıcı için sistem durumu denetımı etkinse ve Docker raporları health_status olayı varsa, Docker tarafından rapor edildiğinde health_status Service Fabric kapsayıcıyı yeniden başlatır.
...
ApplicationManifest.xml içindeki "Depo\kimlik bilgileri" etiketinde belirtilen kimlik bilgileri yerine clusterManifest.xml ' de belirtilen varsayılan depo kimlik bilgilerini kullanın.
...
Kapsayıcı için yalıtım modu. Geçerli değerler varsayılan, Process veya Hyper-V ' d ı (yalnızca Windows kapsayıcıları için desteklenir).
...
|tür|[Depotorcredentialstype](#repositorycredentialstype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
|---|---|
|name|HealthConfig|
|tür|[ContainerHealthConfigType](#containerhealthconfigtype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
|---|---|
|name|PortBinding|
|tür|[PortBindingType](#portbindingtype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|---|---|
|name|CertificateRef|
|tür|[ContainerCertificateType](#containercertificatetype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|tür|[ContainerLoggingDriverType](#containerloggingdrivertype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
|---|---|
|name|NetworkConfig|
|tür|[ContainerNetworkConfigType](#containernetworkconfigtype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
|---|---|
|name|Birim|
|tür|[ContainerVolumeType](#containervolumetype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|---|---|
|name|SecurityOption|
|tür|[SecurityOptionsType](#securityoptionstype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|

#### <a name="imageoverrides"></a>Imagekılmalar
Başlatılacak işletim sistemi derleme numarasına karşılık gelen görüntü adları.

|Öznitelik|Değer|
|---|---|
|name|Imagekılmalar|
|tür|[Imageoverdesttype](#imageoverridestype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
|---|---|
|name|Etiketle|
|tür|[ContainerLabelType](#containerlabeltype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|---|---|
|name|DriverOption|
|tür|[DriverOptionType](#driveroptiontype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|tür|[ContainerNetworkPolicyEndpointBindingType](#containernetworkpolicyendpointbindingtype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
#### <a name="codepackagelinkfolder"></a>Codepackagelınkfolder

|Öznitelik|Değer|
|---|---|
|name|Codepackagelınkfolder|

#### <a name="configpackagelinkfolder"></a>Configpackagelınkfolder

|Öznitelik|Değer|
|---|---|
|name|Configpackagelınkfolder|

#### <a name="datapackagelinkfolder"></a>Datapackagelınkfolder

|Öznitelik|Değer|
|---|---|
|name|Datapackagelınkfolder|
...
#### <a name="servicegroup"></a>Servicegroup 'a gidin
...
|---|---|
|name|UnmanagedDll|
|tür|[UnmanagedDllType](#unmanageddlltype-complextype)|
...
|tür|[ManagedAssemblyType](#managedassemblytype-complextype)|
...
Bu değer, özniteliğinin değerinin korumasını tanımlar. Bu, SecretsStoreRef/şifrelenmiş/düz metin olabilir.
SecretsStoreRef olarak ayarlandıysa, bu değer kümenin SecureStore öğesinde şifrelenmiş saklı bir gizli dizi ile sonuçlanır ve bu, etkinleştirilmesinin ardından şifresinin çözülmesi ve şifresi çözülür.
...
|---|---|
|name|Kül|
|tür|[DllHostEntryPointType](#dllhostentrypointtype-complextype)|
...
|---|---|
|name|ContainerHost|
|tür|[ContainerHostEntryPointType](#containerhostentrypointtype-complextype)|
...
|tür|[EnvironmentVariableOverrideType](#environmentvariableoverridetype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
Ortam değişkeninin türü. Düz metin/şifrelenmiş/SecretsStoreRef olabilir.
...
|---|---|
|name|EnvironmentVariable|
|tür|[EnvironmentVariableType](#environmentvariabletype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|tür|[Inputendpointtype](#inputendpointtype-complextype)|
...
|tür|[InternalEndpointType](#internalendpointtype-complextype)|
...
#### <a name="backuprestoreservicereplicatorendpoint"></a>Backuprestorezervicerepereptorendpoint
...
#### <a name="upgradeorchestrationservicereplicatorendpoint"></a>Upgradeorchestrationservicerepereptorendpoint
...
#### <a name="sharedlogfileid"></a>Sharedlogfileıd
...
#### <a name="sharedlogfilesizeinmb"></a>Sharedlogfilesizeınmb
...
|---|---|
|name|Görüntü|
|tür|[ImageType](#imagetype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|---|---|
|name|Uç Noktalar|
|tür|[FabricEndpointsType](#fabricendpointstype-complextype)|
|Ayarlan|0|
...
|---|---|
|name|Sertifikalar|
|tür|[Certificatesttype](#certificatestype-complextype)|
|Ayarlan|0|
...
|tür|[ContainerNetworkPolicyType](#containernetworkpolicytype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|---|---|
|name|Parametre|
|tür|[ParameterType](#parametertype-complextype)|
|Ayarlan|1|
|maxOccurs|unbounded|
...
Bu değer, ' password ' özniteliğinde belirttiğiniz parola türünü tanımlar. Bu, SecretsStoreRef/şifrelenmiş/düz metin olabilir.
SecretsStoreRef olarak ayarlanırsa, SecretStore 'dan başvuru değeri alıyoruz.
Şifrelenmiş olarak ayarlandıysa, uygulama geliştiricisi bir sertifika oluşturmaktan ve hassas bilgileri şifrelemek için Invoke-ServiceFabricEncryptSecret cmdlet 'ini kullanarak sorumludur.
...
Kullanılabilecek ıOPS cinsinden maksimum GÇ oranı (okuma ve yazma). Pozitif bir tamsayı olmalıdır.
...
|tür|[StatefulServiceTypeType](#statefulservicetypetype-complextype)|
...
|tür|[StatelessServiceTypeType](#statelessservicetypetype-complextype)|
...
|tür|[StatefulServiceGroupTypeType](#statefulservicegrouptypetype-complextype)|
...
|tür|[StatelessServiceGroupTypeType](#statelessservicegrouptypetype-complextype)|
...
|---|---|
|name|RunAsPolicy|
|tür|[RunAsPolicyType](#runaspolicytype-complextype)|
|Ayarlan|0|
...
|tür|[SecurityAccessPolicyType](#securityaccesspolicytype-complextype)|
|Ayarlan|0|
...
|tür|[PackageSharingPolicyType](#packagesharingpolicytype-complextype)|
|Ayarlan|0|
...
|tür|[EndpointBindingPolicyType](#endpointbindingpolicytype-complextype)|
|Ayarlan|0|
...
|tür|[ServiceFabricRuntimeAccessPolicyType](#servicefabricruntimeaccesspolicytype-complextype)|
|Ayarlan|0|
|maxOccurs|1|

#### <a name="servicepackageresourcegovernancepolicy"></a>Servicepackageresourcehüküancepolicy
Tüm hizmet paketinin düzeyinde uygulanan kaynak idare ilkesini tanımlar.

|Öznitelik|Değer|
|---|---|
|name|Servicepackageresourcehüküancepolicy|
|tür|[ServicePackageResourceGovernancePolicyType](#servicepackageresourcegovernancepolicytype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
|tür|[ResourceGovernancePolicyType](#resourcegovernancepolicytype-complextype)|
|Ayarlan|0|
...
|tür|[ServicePackageContainerPolicyType](#servicepackagecontainerpolicytype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
|tür|[Containerhostpolicıestype](#containerhostpoliciestype-complextype)|
|Ayarlan|0|
...
|tür|[Configpackagepolicıestype](#configpackagepoliciestype-complextype)|
|Ayarlan|0|
...
|tür|[Networkpolicıestype](#networkpoliciestype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
|---|---|
|name|ServiceTypes|
|tür|[ServiceAndServiceGroupTypesType](#serviceandservicegrouptypestype-complextype)|
...
|---|---|
|name|CodePackage|
|tür|[CodePackageType](#codepackagetype-complextype)|
|maxOccurs|unbounded|
...
|---|---|
|name|ConfigPackage|
|tür|[ConfigPackageType](#configpackagetype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|---|---|
|name|DataPackage|
|tür|[DataPackageType](#datapackagetype-complextype)|
|Ayarlan|0|
|maxOccurs|unbounded|
...
|---|---|
|name|Kaynaklar|
|tür|[ResourcesType](#resourcestype-complextype)|
|Ayarlan|0|
...
|---|---|
|name|Tanılama|
|tür|[Servicediagnoçıkartstype](#servicediagnosticstype-complextype)|
|Ayarlan|0|
...
|tür|[StatelessServiceType](#statelessservicetype-complextype)|
...
|tür|[StatefulServiceType](#statefulservicetype-complextype)|
...
|tür|[StatelessServiceGroupType](#statelessservicegrouptype-complextype)|
...
|tür|[StatefulServiceGroupType](#statefulservicegrouptype-complextype)|
...
Bir hizmetin yerleştirilmesi için gereken etiketleri bildirir. Dinamik olarak etkileyen hizmet yerleştirmesi için faydalıdır. 
...
Bir hizmetin yerleştirilmesi ve çalıştırılması için gerekli etiketleri bildirir. Dinamik olarak etkileyen hizmet yerleştirme ve çalıştırma için faydalıdır. 
...
|tür|[Windowsfabricdeploymentınformation](#windowsfabricdeploymentinformation-complextype)|
|Ayarlan|0|
