...
|Öznitelik|Değer|
|---|---|
|ad|Maxyüztunhealthyıdeployedapplications|
|type|xs: String|
|kullan|isteğe bağlı|
|default|0|
...
|---|---|
|ad|ServiceTemplates|
|type|[Servicetemplatesttype](#servicetemplatestype-complextype)|
...
|Öznitelik|Değer|
|---|---|
|ad|Includedockerhealthstatusınsystemhealthreport|
|type|xs: Boolean|
|kullan|isteğe bağlı|
|default|true|
...
|Öznitelik|Değer|
|---|---|
|ad|UseDefaultRepositoryCredentials|
|type|xs: String|
|kullan|isteğe bağlı|
|default|yanlış|
...
|Öznitelik|Değer|
|---|---|
|ad|UseTokenAuthenticationCredentials|
|type|xs: String|
|kullan|isteğe bağlı|
|default|yanlış|
...
|---|---|
|ad|Imagekılmalar|
|type|[Imageoverdesttype](#imageoverridestype-complextype)|
|Ayarlan|0|
|maxOccurs|1|
...
|content|0 öğe, 1 öznitelik|
|tanımlanmış|Görünüm|
|ad|ContainerNetworkPolicyEndpointBindingType|
...
|content|0 öğe, 3 öznitelik|
|tanımlanmış|Görünüm|
|ad|EnvironmentVariableOverrideType|
...
|---|---|
|ad|Tanılama|
|type|[Servicediagnoçıkartstype](#servicediagnosticstype-complextype)|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|ad|Maxyüztunhealthi Hizmetleri|
|type|xs: String|
|kullan|isteğe bağlı|
|default|0|
...
|Öznitelik|Değer|
|---|---|
|ad|Maxyüztunhealthypartitionsperservice|
|type|xs: String|
|kullan|isteğe bağlı|
|default|0|
...
|Öznitelik|Değer|
|---|---|
|ad|Maxyüztunhealthyıreplicasperpartition|
|type|xs: String|
|kullan|isteğe bağlı|
|default|0|
...
|tanımlanmış|Görünüm|
|ad|Windowsfabricdeploymentınformation|
