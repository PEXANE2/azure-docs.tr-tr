...
True ise, bu parametrenin değeri şifrelenir. Uygulama geliştiricisi, önemli bilgileri şifrelemek için bir sertifika oluşturmaktan ve Invoke-ServiceFabricEncryptSecret cmdlet 'ini kullanarak sorumludur. Değeri şifrelemek için kullanılacak sertifika bilgileri, sertifikalar bölümünde belirtilmiştir. Bu öznitelik kullanım dışıdır. Lütfen tür özniteliğini kullanın.
