...
|Öznitelik|Değer|
|---|---|
|tür|[EndpointOverrideType](service-fabric-service-model-schema-complex-types.md#endpointoverridetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[ContainerNetworkPolicyEndpointBindingType](service-fabric-service-model-schema-complex-types.md#containernetworkpolicyendpointbindingtype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[FabricEndpointsType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Yerel olarak NodeType öğesinde, [InfrastructureNodeType complexType](service-fabric-service-model-schema-complex-types.md#infrastructurenodetype-complextype)|
|name|Uç Noktalar|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[EntryPointDescriptionType](service-fabric-service-model-schema-complex-types.md#entrypointdescriptiontype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[EnvironmentOverridesType](service-fabric-service-model-schema-complex-types.md#environmentoverridestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Servicemanifestımport öğesinde yerel olarak|
...
|Öznitelik|Değer|
|---|---|
|tür|[EnvironmentVariableOverrideType](service-fabric-service-model-schema-complex-types.md#environmentvariableoverridetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[EnvironmentVariableType](service-fabric-service-model-schema-complex-types.md#environmentvariabletype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[EnvironmentVariablesType](service-fabric-service-model-schema-complex-types.md#environmentvariablestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Codepackagetype complexType](service-fabric-service-model-schema-complex-types.md#codepackagetype-complextype) içinde yerel olarak|
...
|---|---|
|name|Özellikler|
|tür|[ServiceTypeExtensionPolicyPropertiesType](service-fabric-service-model-schema-complex-types.md#servicetypeextensionpolicypropertiestype-complextype)|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[ExeHostEntryPointType](service-fabric-service-model-schema-complex-types.md#exehostentrypointtype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[ExtensionsType](service-fabric-service-model-schema-complex-types.md#extensionstype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Görünüm|
|name|Uzantıları|
...
|Öznitelik|Değer|
|---|---|
|tür|[SettingsOverridesType](service-fabric-service-model-schema-complex-types.md#settingsoverridestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Clustermanifesttype complexType](service-fabric-service-model-schema-complex-types.md#clustermanifesttype-complextype) içinde yerel olarak|
|name|FabricSettings|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[ContainerHealthConfigType](service-fabric-service-model-schema-complex-types.md#containerhealthconfigtype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Containerhostpolicıestype complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype) içinde yerel olarak|
|name|HealthConfig|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[ApplicationHealthPolicyType](service-fabric-service-model-schema-complex-types.md#applicationhealthpolicytype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Applicationpolicıestype complexType](service-fabric-service-model-schema-complex-types.md#applicationpoliciestype-complextype) içinde yerel olarak|
|name|HealthPolicy|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[ImageType](service-fabric-service-model-schema-complex-types.md#imagetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
Veya Azure Container Registry için depo ve görüntü https://hub.docker.com .
...
|Öznitelik|Değer|
|---|---|
|tür|[Imageoverdesttype](service-fabric-service-model-schema-complex-types.md#imageoverridestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Containerhostpolicıestype complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype) içinde yerel olarak|
|name|Imagekılmalar|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[InfrastructureInformationType](service-fabric-service-model-schema-complex-types.md#infrastructureinformationtype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Görünüm|
...
|Öznitelik|Değer|
|---|---|
|tür|[FabricKtlLoggerSettingsType](service-fabric-service-model-schema-complex-types.md#fabricktlloggersettingstype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|NodeType öğesinde yerel olarak|
...
|Öznitelik|Değer|
|---|---|
|tür|[ContainerLabelType](service-fabric-service-model-schema-complex-types.md#containerlabeltype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Containerhostpolicıestype complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype) içinde yerel olarak|
|name|Etiketle|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[LoadMetricType](service-fabric-service-model-schema-complex-types.md#loadmetrictype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[ContainerLoggingDriverType](service-fabric-service-model-schema-complex-types.md#containerloggingdrivertype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Containerhostpolicıestype complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype) içinde yerel olarak|
...
|tür|[LogicalDirectoryType](service-fabric-service-model-schema-complex-types.md#logicaldirectorytype-complextype)|
|maxOccurs|unbounded|
...
|Öznitelik|Değer|
|---|---|
|tür|[ManagedAssemblyType](service-fabric-service-model-schema-complex-types.md#managedassemblytype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[ServiceGroupMemberType](service-fabric-service-model-schema-complex-types.md#servicegroupmembertype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[ContainerNetworkConfigType](service-fabric-service-model-schema-complex-types.md#containernetworkconfigtype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Containerhostpolicıestype complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype) içinde yerel olarak|
|name|NetworkConfig|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[Networkpolicıestype](service-fabric-service-model-schema-complex-types.md#networkpoliciestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[FabricNodeType](service-fabric-service-model-schema-complex-types.md#fabricnodetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[InfrastructureNodeType](service-fabric-service-model-schema-complex-types.md#infrastructurenodetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[PackageSharingPolicyType](service-fabric-service-model-schema-complex-types.md#packagesharingpolicytype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[ParameterType](service-fabric-service-model-schema-complex-types.md#parametertype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
## <a name="parameter-element-defined-in-parameters"></a>Parametrelerde tanımlanmış parametre öğesi
...
## <a name="parameter-element-defined-in-section"></a>Bölüm içinde tanımlanan parametre öğesi
...
True ise, bu parametrenin değeri şifrelenir. Uygulama geliştiricisi, bir sertifika oluşturmaktan ve hassas bilgileri şifrelemek için Invoke-ServiceFabricEncryptSecret cmdlet 'ini kullanarak sorumludur. Değeri şifrelemek için kullanılacak sertifika bilgileri, sertifikalar bölümünde belirtilmiştir. Bu öznitelik kullanım dışıdır. Lütfen tür özniteliğini kullanın.
...
Bu değer, ' Value ' özniteliğinde belirttiğiniz değerin türünü tanımlar. Bu, SecretsStoreRef/şifrelenmiş/düz metin olabilir.
SecretsStoreRef olarak ayarlanırsa, SecretStore 'dan başvuru değeri alıyoruz.
Şifrelenmiş olarak ayarlandıysa, uygulama geliştiricisi bir sertifika oluşturmaktan ve hassas bilgileri şifrelemek için Invoke-ServiceFabricEncryptSecret cmdlet 'ini kullanarak sorumludur.
...
|Öznitelik|Değer|
|---|---|
|tür|[ParametersType](service-fabric-service-model-schema-complex-types.md#parameterstype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Görünüm|
|name|Parametreler|
...
|Öznitelik|Değer|
|---|---|
|tür|[Applicationpolicıestype](service-fabric-service-model-schema-complex-types.md#applicationpoliciestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Applicationmanifesttype complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype)içinde yerel olarak, [EnvironmentType complexType](service-fabric-service-model-schema-complex-types.md#environmenttype-complextype)|
|name|İlkeler|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[ServiceManifestImportPoliciesType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Servicemanifestımport öğesinde yerel olarak|
|name|İlkeler|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[PortBindingType](service-fabric-service-model-schema-complex-types.md#portbindingtype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[SecurityPrincipalsType](service-fabric-service-model-schema-complex-types.md#securityprincipalstype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Applicationmanifesttype complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype)içinde yerel olarak, [EnvironmentType complexType](service-fabric-service-model-schema-complex-types.md#environmenttype-complextype)|
|name|Sorumlular|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[Depotorcredentialstype](service-fabric-service-model-schema-complex-types.md#repositorycredentialstype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Containerhostpolicıestype complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype) içinde yerel olarak|
...
|Öznitelik|Değer|
|---|---|
|tür|[Resourceoverdesttype](service-fabric-service-model-schema-complex-types.md#resourceoverridestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Servicemanifestımport öğesinde yerel olarak|
|name|Resourcekılmalar|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[ResourcesType](service-fabric-service-model-schema-complex-types.md#resourcestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[AzureRoleType](service-fabric-service-model-schema-complex-types.md#azureroletype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[BlackICE](service-fabric-service-model-schema-complex-types.md#blackbirdroletype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Roller öğesinde yerel olarak|
|name|Rol|
|Ayarlan|1|
...
|Öznitelik|Değer|
|---|---|
|tür|[PaaSRoleType](service-fabric-service-model-schema-complex-types.md#paasroletype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Roller öğesinde yerel olarak|
|name|Rol|
|maxOccurs|unbounded|
...
|Öznitelik|Değer|
|---|---|
|tür|[ScalingPolicyType](service-fabric-service-model-schema-complex-types.md#scalingpolicytype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
Geçersiz kılınacak Settings.xml dosyasındaki bölüm.
...
|Öznitelik|Değer|
|---|---|
|tür|[SecurityOptionsType](service-fabric-service-model-schema-complex-types.md#securityoptionstype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Containerhostpolicıestype complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype) içinde yerel olarak|
|name|SecurityOption|
|Ayarlan|0|
...
|tür|[StatelessServiceType](service-fabric-service-model-schema-complex-types.md#statelessservicetype-complextype)|
...
|tür|[StatefulServiceType](service-fabric-service-model-schema-complex-types.md#statefulservicetype-complextype)|
...
|Öznitelik|Değer|
|---|---|
|tür|[ServiceFabricRuntimeAccessPolicyType](service-fabric-service-model-schema-complex-types.md#servicefabricruntimeaccesspolicytype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)içinde yerel olarak, [Servicepackagetype complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
...
|tür|[StatelessServiceGroupType](service-fabric-service-model-schema-complex-types.md#statelessservicegrouptype-complextype)|
...
|tür|[StatefulServiceGroupType](service-fabric-service-model-schema-complex-types.md#statefulservicegrouptype-complextype)|
...
|Öznitelik|Değer|
|---|---|
|tür|[ServiceManifestType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Görünüm|
...
|tür|[ServiceManifestRefType](service-fabric-service-model-schema-complex-types.md#servicemanifestreftype-complextype)|
...
|Öznitelik|Değer|
|---|---|
|tür|[ServicePackageType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Görünüm|
|name|ServicePackage|
...
|Öznitelik|Değer|
|---|---|
|tür|[ServicePackageContainerPolicyType](service-fabric-service-model-schema-complex-types.md#servicepackagecontainerpolicytype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)içinde yerel olarak, [Servicepackagetype complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
...
|Öznitelik|Değer|
|---|---|
|tür|[ServicePackageResourceGovernancePolicyType](service-fabric-service-model-schema-complex-types.md#servicepackageresourcegovernancepolicytype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)içinde yerel olarak, [Servicepackagetype complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
|name|Servicepackageresourcehüküancepolicy|
|Ayarlan|0|
|maxOccurs|1|
...
## <a name="serviceplacementpolicy-element-defined-in-serviceplacementpolicies"></a>ServicePlacementPolicies içinde tanımlanan ServicePlacementPolicy öğesi
Hizmetin belirli küme hata etki alanlarında çalıştırılmasını veya çalışacağını belirten bir hizmet yerleştirme ilkesi tanımlar.  Küme, coğrafi uzaklıkları veya/veya coğrafi bölge bölgelerini yaydığı zaman faydalıdır.
...
|Öznitelik|Değer|
|---|---|
|tür|[Servicetemplatesttype](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Applicationmanifesttype complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype)içinde yerel olarak [applicationınstancetype complexType](service-fabric-service-model-schema-complex-types.md#applicationinstancetype-complextype)|
...
|Öznitelik|Değer|
|---|---|
|tür|[ServiceAndServiceGroupTypesType](service-fabric-service-model-schema-complex-types.md#serviceandservicegrouptypestype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Servicemanifesttype complexType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype) içinde yerel olarak|
|name|ServiceTypes|
...
|Öznitelik|Değer|
|---|---|
|tür|[SettingsType](service-fabric-service-model-schema-complex-types.md#settingstype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Görünüm|
|name|Ayarlar|
...
|Öznitelik|Değer|
|---|---|
|tür|[StatefulServiceGroupTypeType](service-fabric-service-model-schema-complex-types.md#statefulservicegrouptypetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[StatefulServiceTypeType](service-fabric-service-model-schema-complex-types.md#statefulservicetypetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
...
|Öznitelik|Değer|
|---|---|
|tür|[StatelessServiceGroupTypeType](service-fabric-service-model-schema-complex-types.md#statelessservicegrouptypetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Serviceandservicegrouptypestype complexType](service-fabric-service-model-schema-complex-types.md#serviceandservicegrouptypestype-complextype) içinde yerel olarak|
...
|Öznitelik|Değer|
|---|---|
|tür|[StatelessServiceTypeType](service-fabric-service-model-schema-complex-types.md#statelessservicetypetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Serviceandservicegrouptypestype complexType](service-fabric-service-model-schema-complex-types.md#serviceandservicegrouptypestype-complextype), [ServiceTypesType complexType](service-fabric-service-model-schema-complex-types.md#servicetypestype-complextype) içinde yerel olarak|
...
|Öznitelik|Değer|
|---|---|
|tür|[Targetınformationtype](service-fabric-service-model-schema-complex-types.md#targetinformationtype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|Görünüm|
|name|Targetınformation|
...
Desteklenmiyor, kullanmayın. Konağa yönetilmeyen derlemenin adı (örneğin, Queue.dll).

|Öznitelik|Değer|
|---|---|
|tür|[UnmanagedDllType](service-fabric-service-model-schema-complex-types.md#unmanageddlltype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Dllhostentrypointtype complexType](service-fabric-service-model-schema-complex-types.md#dllhostentrypointtype-complextype) içinde yerel olarak|
|name|UnmanagedDll|
...
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Fabricendpointstype complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) içinde yerel olarak|
|name|Upgradeorchestrationservicerepereptorendpoint|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[ContainerVolumeType](service-fabric-service-model-schema-complex-types.md#containervolumetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
|tanımlanmış|[Containerhostpolicıestype complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype) içinde yerel olarak|
|name|Birim|
|Ayarlan|0|
...
|Öznitelik|Değer|
|---|---|
|tür|[PaaSVoteType](service-fabric-service-model-schema-complex-types.md#paasvotetype-complextype)|
|içerik|0 öğe, 0 öznitelik|
