...
| health | Service Fabric uygulamasının sistem durumunu alır. |
...
| load | Service Fabric bir uygulamayla ilgili yükleme bilgilerini alır. |
...
| upload | Service Fabric uygulama paketini görüntü deposuna kopyalayın. |
...
Kümeyle birlikte Service Fabric bir uygulama türü sağlar. Yeni uygulamaların örneklendirilmesinden önce bu gereklidir. Sağlama işlemi, Relativepathınımafıtemte tarafından belirtilen uygulama paketinde ya da External. sfpkg URI 'sini kullanılarak gerçekleştirilebilir. --Dış sağlama ayarlı değilse, bu komut görüntü deposu sağlamasını bekler.
...
| --imagesdeposu-dize | Uygulama paketini yüklemek için hedef görüntü deposu.  Varsayılan\: doku\:ımabir yapısı. |
