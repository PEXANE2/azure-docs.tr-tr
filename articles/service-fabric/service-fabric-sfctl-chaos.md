---
title: Azure Service Fabric CLı-sfctl Chaos
description: Azure Service Fabric komut satırı arabirimi olan sfctl hakkında bilgi edinin. Chaos yönetimi için komutların bir listesini içerir.
author: jeffj6123
ms.topic: reference
ms.date: 1/16/2020
ms.author: jejarry
...
| get | Chaos durumunu alır. |
| start | Kümede Chaos 'ı başlatır. |
| Dur | Kümede çalışıyorsa, Chaos 'yi durdurulur ve Chaos zamanlamasını durdurulmuş bir duruma koyar. |
