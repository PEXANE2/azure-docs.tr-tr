...
PowerShell kullanarak, parametresi `New-ServiceFabricApplication` komut için bir [karma tablo](https://technet.microsoft.com/library/ee692803.aspx)olarak sağlanır:
