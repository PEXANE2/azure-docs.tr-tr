...
Mevcut bir anahtar kasasını kullanmak için, [dağıtım için](../key-vault/general/manage-with-cli2.md#bkmk_KVperCLI) anahtar kasasının, işlem kaynak sağlayıcısının bu kaynaktan sertifika almasını ve küme düğümlerine yüklemesini sağlamak için etkinleştirilmesi gerekir.
