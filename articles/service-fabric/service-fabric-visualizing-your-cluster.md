...
![Ekran görüntüsü, OLAYLARıN seçili olduğu düğümler bölmesini gösterir.][sfx-eventstore]
...
Yedekleme ve geri yükleme hizmeti hakkında daha fazla bilgi için [REST API başvurusuna](/rest/api/servicefabric/sfclient-index-backuprestore)bakın.
