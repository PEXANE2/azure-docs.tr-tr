---
title: Azure Event Grid ile CloudEvents v 1.0 şeması
description: Azure Event Grid olaylar için CloudEvents v 1.0 şemasının nasıl kullanılacağını açıklar. Hizmet, bulut olaylarının JSON uygulamasındaki olayları destekler.
ms.topic: conceptual
ms.date: 07/07/2020
...
ms.locfileid: "91324187"
---
# <a name="cloudevents-v10-schema-with-azure-event-grid"></a>Azure Event Grid ile CloudEvents v 1.0 şeması
