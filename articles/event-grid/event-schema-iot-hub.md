---
title: IoT Hub için Azure Olay Izgara şeması | Microsoft Dokümanlar
...
---
# <a name="azure-event-grid-event-schema-for-iot-hub"></a>IoT Hub için Azure Olay Izgara olay şeması
...
Örnek komut dosyaları ve öğreticilerin listesi için [IoT Hub etkinlik kaynağına](event-sources.md#iot-hub)bakın.
