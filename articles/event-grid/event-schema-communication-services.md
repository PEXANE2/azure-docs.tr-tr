---
title: Event Grid kaynağı olarak Azure Iletişim Hizmetleri
description: Bu makalede, Azure Iletişim hizmetlerinin Event Grid olay kaynağı olarak nasıl kullanılacağı açıklanır.
ms.topic: conceptual
ms.date: 02/11/2021
ms.author: mikben
...
> [!NOTE]
> Verilerin olay işlemeyle nasıl ilişkili olduğu hakkında daha fazla bilgi edinmek için, [veri fazlalığını ziyaret edin kavramsal belgeler](../communication-services/concepts/privacy.md)
...
Iletişim Hizmetleri kaynağınız tarafından oluşturulan olaylara abone olmak için Azure portal veya Azure CLı kullanabilirsiniz. [Iletişim HIZMETLERINDE SMS olaylarını nasıl işleyeceğinizi](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) inceleyerek olayları işlemeye başlayın
...
| Başlık | Açıklama |
| --- | --- |
| [Iletişim hizmetlerinde SMS olaylarını işleme](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Web kancası kullanarak Iletişim hizmetiniz tarafından alınan tüm SMS olaylarını işleme. |
...
| Başlık | Açıklama |
|---------|---------|
| [Hızlı başlangıç: SMS olaylarını Işleme](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Event Grid kullanarak SMS olaylarına nasıl abone olunacağını gösterir.   |
