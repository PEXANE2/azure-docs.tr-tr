...
3. Geçerli fiyatlandırma katmanı **temel**ise, aşağıdaki iletiyi görürsünüz. Bunu seçin. 
...
Bu bölümde, bir konunun veya etki alanının fiyatlandırma katmanını değiştirmek için Azure CLı komutlarının nasıl kullanılacağı gösterilmektedir. 
