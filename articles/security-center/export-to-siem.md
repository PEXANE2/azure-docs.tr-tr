...
- **Power BI**  -  [Power BI Desktop Microsoft Graph GÜVENLIK API 'Sine bağlanın](https://docs.microsoft.com/power-bi/connect-data/desktop-connect-graph-security)
...
- [Güvenlik uyarılarını ve önerilerini sürekli dışa aktarma](continuous-export.md)