...
* Güvenlik Merkezi, **Get-MprotComputerStatus** çalıştırıldığında ve aşağıdakilerden biri gerçekleştiğinde **"makinelerinizdeki Endpoint Protection sistem durumu sorunlarını çözme"** işlemi yapmanızı önerir:
  ...
  * Aşağıdaki Imza güncelleştirmelerinden biri veya her ikisi 7 daha büyükse veya eşitse:
...
- Real-Time koruma durumunu denetle: **HKLM: \ Software\Wow6432Node\Symantec\Symantec Endpoint Protection\AV\Storages\Filesystem\RealTimeScan\OnOff = = 1**
...
- Dosya **/opt/iSEC/ens/threatprevention/bin/isecav** var
