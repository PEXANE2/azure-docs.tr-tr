...
> [!NOTE]
> Bu seçenek yalnızca kiracı düzeyinde izinlere sahip kullanıcılar için görüntülenir. [Kendinize kiracı genelinde Izinler verin](https://docs.microsoft.com/azure/security-center/security-center-management-groups#grant-tenant-wide-permissions-to-yourself).
