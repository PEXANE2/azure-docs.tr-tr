...
**Veri erişimi**: Microsoft personeli, güvenlik önerileri sağlamak ve olası güvenlik tehditlerini araştırmak için, kilitlenme bilgi döküm dosyaları, işlem oluşturma olayları, VM diski anlık görüntüleri ve yapıtlar dahil olmak üzere Azure hizmetleri tarafından toplanan veya çözümlenen bilgilere erişebilir. Müşteri verilerini veya sanal makinelerinizdeki kişisel verileri istemeden dahil edebilir. Microsoft’un Müşteri Verilerini kullanmayacağını veya reklam ya da benzeri ticari amaçlarla bundan bilgi türetmeyeceğini belirten [Microsoft Çevrimiçi Hizmet Koşulları ve Gizlilik Bildirimi](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=31) belgesine bağlı kalıyoruz. Müşteri Verileri yalnızca size Azure hizmetlerini sağlamak için, bu hizmetleri sağlamayla uyumlu amaçlar da dahil olmak üzere gerektiğinde kullanılır. Müşteri Verileri üzerindeki tüm haklarınız saklıdır.

**Veri kullanımı**: Microsoft, önleme ve algılama olanaklarımızı geliştirmek için birden çok kiracı genelinde görülen desenleri ve tehdit bilgilerini kullanır; Bu konuda [Gizlilik Bildirimizdeki](https://www.microsoft.com/privacystatement/en-us/OnlineServices/Default.aspx)gizlilik taahhütlerine göre yaptık.

## <a name="data-location"></a>Veri konumu

**Çalışma alanınız**: Aşağıdaki geos için bir çalışma alanı belirtilmiştir ve kilitlenme dökümleri ve bazı uyarı verisi türleri dahil olmak üzere Azure sanal makinelerinizden toplanan veriler en yakın çalışma alanında depolanır.
...
**Azure Güvenlik merkezi depolaması**: İş ortağı uyarıları da dahil olmak üzere güvenlik uyarıları hakkında bilgiler, ilgili Azure kaynağının konumuna göre bölgesel olarak depolanır, ancak güvenlik sistem durumu ve öneriyle ilgili bilgiler merkezi olarak Birleşik Devletler ya da Müşterinin konumuna göre Avrupa.
