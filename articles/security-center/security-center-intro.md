...
IoT için Azure Güvenlik Merkezi (Nesnelerin İnterneti), uçtan, şirket içinde, Azure 'da ve diğer bulutlarda çalışan iş yükleri arasında birleştirilmiş görünürlük ve denetim, uyarlamalı tehdit önleme ve akıllı tehdit koruması ve yanıt sunarak karma iş yükü korumasını basitleştirir. Daha fazla bilgi için bkz. [IoT Için Azure Güvenlik Merkezi](https://docs.microsoft.com/azure/asc-for-iot/).
