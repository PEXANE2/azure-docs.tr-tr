...
|----------------|:-------------------:|---------------|
|**MFA’yı etkinleştirme**|10|-MFA, aboneliğinizde sahip izinleri olan hesaplarda etkinleştirilmelidir<br>-MFA, aboneliğinizde yazma izinleri olan hesaplar etkinleştirilmelidir|
