---
title: UK NHS için Azure Güvenlik ve Uyumluluk Şeması-IaaS Web uygulaması
description: UK NHS için Azure Güvenlik ve Uyumluluk Şeması-IaaS Web uygulaması
services: security
author: jomolesk
...
![UK NHS Için IaaS Web uygulaması başvuru mimarisi diyagramı](images/uknhs-iaaswa-architecture.png?raw=true "UK NHS Için IaaS Web uygulaması başvuru mimarisi diyagramı")
...
**Azure depolama**: Rest gereksinimlerinde şifrelenmiş verileri karşılamak için tüm [Azure depolama](https://azure.microsoft.com/services/storage/) [depolama hizmeti şifrelemesi](https://docs.microsoft.com/azure/storage/storage-service-encryption)kullanır. Bu, NHS Digital tarafından tanımlanan kurumsal güvenlik taahhütleri ve uyumluluk gereksinimleri desteğiyle verileri korumanıza ve korumaya yardımcı olur.
...
Bu başvuru mimarisi için veri akışı diyagramı [indirilebilir](https://aka.ms/uknhs-iaaswa-tm) veya aşağıda bulunabilir. Bu model, müşterilerin değişiklik yaparken sistem altyapısında olası risk noktalarını anlamasına yardımcı olabilir.

![UK NHS tehdit modeli Için IaaS Web uygulaması](images/uknhs-iaaswa-threat-model.png?raw=true "UK NHS tehdit modeli Için IaaS Web uygulaması")
...
[Azure Güvenlik ve uyumluluk şeması – UK NHS IaaS Web uygulaması uygulama matrisi](https://aka.ms/uknhs-iaaswa-cim) , ' nin nasıl yapıldığını açıklayan ayrıntılı açıklamalar dahil olmak üzere IaaS Web uygulaması mimarisi tarafından hangi Birleşik Krallık NHS gereksinimlerine değinilmesine ilişkin bilgiler sağlar. uygulama, kapsanan her bir ilkenin gereksinimlerini karşılar.
