...
description: Threat Modeling Tool hassas veri azaltma hakkında bilgi edinin. Bkz. risk azaltma bilgileri ve kod örneklerini görüntüleme.
services: security
...
| **Referanslar**              | [Dinamik veri maskeleme](https://msdn.microsoft.com/library/mt130841) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [.NET şifre API 'Leri kullanarak parola karması](https://docs.asp.net/en/latest/security/data-protection/consumer-apis/password-hashing.html) |
...
| **Referanslar**              | [SQL Server 'da hassas verileri şifreleme](https://technet.microsoft.com/library/ff848751(v=sql.105).aspx), [nasıl yapılır: SQL Server bir veri sütununu](https://msdn.microsoft.com/library/ms179331)şifreleme, [sertifikayla şifreleme](https://msdn.microsoft.com/library/ms188061) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [SQL Server Saydam Veri Şifrelemesi anlama (TDE)](https://technet.microsoft.com/library/bb934049(v=sql.105).aspx) |
...
| **Referanslar**              | [SQL veritabanı yedekleme şifrelemesi](https://msdn.microsoft.com/library/dn449489) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Sanal makineleriniz tarafından kullanılan diskleri şifrelemek için Azure disk şifrelemesini kullanma](https://azure.microsoft.com/documentation/articles/storage-security-guide/#_using-azure-disk-encryption-to-encrypt-disks-used-by-your-virtual-machines) |
...
| **Referanslar**              | [Service Fabric uygulamalarında gizli dizileri yönetme](https://azure.microsoft.com/documentation/articles/service-fabric-application-secret-management/) |
...
| **Referanslar**              | [Bekleyen veriler için Azure Depolama Hizmeti Şifrelemesi (Önizleme)](https://azure.microsoft.com/documentation/articles/storage-service-encryption/) |
...
| **Öznitelikler**              | Yok  |
| **Referanslar**              | Microsoft Intune ilkeleri ve [Anahtarlık Valet](https://components.xamarin.com/view/square.valet) [ile cihazlarınızda ayarları ve özellikleri yönetme](https://docs.microsoft.com/mem/intune/configuration/) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [.Net Için şifre gizleme](https://www.ssware.com/cryptoobfuscator/obfuscator-net.htm) |
...
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Fortify](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_weak_token) |
...
| **Referanslar**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [FORTIFY Krallığı](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_weak_class_reference), [WCF güvenlik kodu dergi temelleri](https://www.codemag.com/article/0611051) |
