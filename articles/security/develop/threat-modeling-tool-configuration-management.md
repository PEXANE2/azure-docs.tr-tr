...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | YOK  |
| **Başvurular**              | [ASP.NET hata ayıklamaya genel bakış](/previous-versions/ms227556(v=vs.140)), [ASP.net izlemeye genel bakış](/previous-versions/bb386420(v=vs.140)), [nasıl yapılır: bir ASP.NET uygulaması için izlemeyi etkinleştirme](/previous-versions/0x5wc973(v=vs.140)), [nasıl yapılır: ASP.NET uygulamaları için hata ayıklamayı etkinleştirme](https://msdn.microsoft.com/library/e8z01xdh(VS.80).aspx) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | YOK  |
| **Başvurular**              | [OWASP tıklama-Yiyilmez savunma sayfası](https://cheatsheetseries.owasp.org/cheatsheets/Clickjacking_Defense_Cheat_Sheet.html), [IE Iç Işlevleri-combating tıklama-X-Frame-Options ile çarpıcı](/archive/blogs/ieinternals/combating-clickjacking-with-x-frame-options) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | YOK  |
| **Başvurular**              | [IE8 güvenlik bölümü V: kapsamlı koruma](/archive/blogs/ie/ie8-security-part-v-comprehensive-protection), [MIME türü](https://en.wikipedia.org/wiki/Mime_type) |
...
| **Başvurular**              | [Azure SQL veritabanı güvenlik duvarını yapılandırma](../../azure-sql/database/firewall-configure.md), [veritabanı altyapısı erişimi Için bir Windows Güvenlik Duvarı yapılandırma](/sql/database-engine/configure-windows/configure-a-windows-firewall-for-database-engine-access) |
...
| **Öznitelikler**              | YOK  |
| **Başvurular**              | [ASP.NET Web API 2 ' de çapraz kaynak Isteklerini etkinleştirme](https://www.asp.net/web-api/overview/security/enabling-cross-origin-requests-in-web-api), [ASP.NET Web API 2 ' de ASP.NET Web api-cors desteği](/archive/msdn-magazine/2013/december/asp-net-web-api-cors-support-in-asp-net-web-api-2) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | YOK  |
| **Başvurular**              | [Windows 10 IoT Core 'da güvenli önyükleme ve bit dolabı cihaz şifrelemesini etkinleştirme](/windows/iot-core/secure-your-device/securebootandbitlocker) |
...
| **Başvurular**              | [Cihaz yönetimine genel bakış IoT Hub](../../iot-hub/iot-hub-device-management-overview.md) [cihaz üretici yazılımını güncelleştirme](../../iot-hub/tutorial-firmware-update.md) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | YOK  |
| **Başvurular**              | [Azure depolama Güvenlik Kılavuzu-depolama hesabı anahtarlarınızı yönetme](../../storage/blobs/security-recommendations.md#identity-and-access-management) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | YOK  |
| **Başvurular**              | [Azure Depolama Hizmetleri için CORS Desteği](/rest/api/storageservices/Cross-Origin-Resource-Sharing--CORS--Support-for-the-Azure-Storage-Services) |
...
| **Öznitelikler**              | YOK  |
| **Başvurular**              | [MSDN](/previous-versions/msp-n-p/ff648500(v=pandp.10)), [fortify Krallığı](https://vulncat.fortify.com) |
