...
description: Threat Modeling Tool giriş doğrulaması hakkında bilgi edinin. Bkz. risk azaltma bilgileri ve kod örneklerini görüntüleme.
services: security
...
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [XSLT güvenliği](https://msdn.microsoft.com/library/ms763800(v=vs.85).aspx), [XsltSettings. EnableScript özelliği](https://msdn.microsoft.com/library/system.xml.xsl.xsltsettings.enablescript.aspx) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [IE8 güvenlik bölümü V-kapsamlı koruma](https://docs.microsoft.com/archive/blogs/ie/ie8-security-part-v-comprehensive-protection)  |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Kısıtlanmamış dosya yükleme](https://owasp.org/www-community/vulnerabilities/Unrestricted_File_Upload), [Dosya imza tablosu](https://www.garykessler.net/library/file_sigs.html) |
...
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Doğrulama ekleme](https://www.asp.net/mvc/overview/getting-started/introduction/adding-validation), [bir MVC uygulamasındaki model verilerini](https://msdn.microsoft.com/library/dd410404(v=vs.90).aspx)doğrulama, [ASP.NET MVC uygulamalarınız için temel ilkeler](https://msdn.microsoft.com/magazine/dd942822.aspx) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Güvenli olmayan girişi kodlama](https://msdn.microsoft.com/library/ff647397.aspx#paght000003_step3), [HTML temizleme](https://github.com/mganss/HtmlSanitizer) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [OAuth 2,0 yetkilendirme çerçevesi-açık Redirectors](https://tools.ietf.org/html/rfc6749#section-10.15) |
...
| **İlgili teknolojiler** | Generic, MVC5, MVC6 |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [MVC uygulamasındaki model verilerini doğrulama](https://msdn.microsoft.com/library/dd410404(v=vs.90).aspx), [ASP.NET MVC uygulamalarınız için temel ilkeler](https://msdn.microsoft.com/magazine/dd942822.aspx) |
...
| **İlgili teknolojiler** | Genel, Web Forms, MVC5, MVC6  |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [DefaultRegexMatchTimeout özelliği](https://msdn.microsoft.com/library/system.web.configuration.httpruntimesection.defaultregexmatchtimeout.aspx) |
...
| **İlgili teknolojiler** | MVC5, MVC6 |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [ASP.NET Web API 'de model doğrulaması](https://www.asp.net/web-api/overview/formats-and-model-binding/model-validation-in-aspnet-web-api) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Azure Cosmos DB 'da SQL Parametreleştirme duyurusu](https://azure.microsoft.com/blog/announcing-sql-parameterization-in-documentdb/) |
...
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [MSDN](https://msdn.microsoft.com/library/ff647820.aspx) |
...
| **İlgili teknolojiler** | Genel, NET Framework 3 |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [MSDN](https://msdn.microsoft.com/library/ff647875.aspx) |
