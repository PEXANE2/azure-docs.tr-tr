...
### <a name="example"></a>Örnek
Satır içi varlıkları çözmeniz gerekiyorsa ancak dış varlıkları çözmeniz gerekmiyorsa, XmlReaderSettings. XmlResolver özelliğini null olarak ayarlayın. Örnek: 
