...
| **Referanslar**              | [SQL Server-bir kimlik doğrulama modu seçin](https://msdn.microsoft.com/library/ms144284.aspx) |
...
| **Referanslar**              | [Azure Active Directory kimlik doğrulaması kullanarak SQL veritabanı 'na bağlanma](https://azure.microsoft.com/documentation/articles/sql-database-aad-authentication/) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [SQL Server parola ilkesi](https://technet.microsoft.com/library/ms161959(v=sql.110).aspx) |
...
| **Referanslar**              | [Kapsanan veritabanlarında En Iyi güvenlik uygulamaları](https://msdn.microsoft.com/library/ff929055.aspx) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Azure Multi-Factor Authentication nedir?](https://azure.microsoft.com/documentation/articles/multi-factor-authentication/) |
...
| **Referanslar**              | [Service Fabric kümesi güvenlik senaryoları](https://azure.microsoft.com/documentation/articles/service-fabric-cluster-security) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Ortam-Azure |
| **Referanslar**              | [Küme güvenliği senaryoları-güvenlik önerileri](https://azure.microsoft.com/documentation/articles/service-fabric-cluster-security/#security-recommendations) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Ortam-Azure |
| **Referanslar**              | [X. 509.440 sertifikaları ve Service Fabric](https://azure.microsoft.com/documentation/articles/service-fabric-cluster-security/#x509-certificates-and-service-fabric) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [IdentityServer3-büyük resim](https://identityserver.github.io/Documentation/docsv2/overview/bigPicture.html) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Kimlik sunucusu dağıtımı-önbelleğe alma](https://identityserver.github.io/Documentation/docsv2/advanced/deployment.html) |
...
| **Öznitelikler**              | Yok |
| **Referanslar**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx) |
...
| **Referanslar**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [fortify](https://community.microfocus.com/t5/UFT-Discussions/UFT-API-Test-with-WCF-wsHttpBinding/m-p/600927) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [ASP.NET Web API 'si](https://www.asp.net/web-api/overview/security/authentication-and-authorization-in-aspnet-web-api), [dış kimlik doğrulama hizmetleri, ASP.NET Web API 'Si ile](https://www.asp.net/web-api/overview/security/external-authentication-services) kimlik doğrulaması ve yetkilendirme (C#) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Web uygulamaları için Azure Active Directory Ile modern kimlik doğrulaması](https://blogs.msdn.microsoft.com/microsoft_press/2016/01/04/new-book-modern-authentication-with-azure-active-directory-for-web-applications/), [REDSıS 'i adal belirteç önbelleği olarak kullanma](https://blogs.msdn.microsoft.com/mrochon/2016/09/19/using-redis-as-adal-token-cache/)  |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [Web uygulamaları için Azure Active Directory ile modern kimlik doğrulama](https://blogs.msdn.microsoft.com/microsoft_press/2016/01/04/new-book-modern-authentication-with-azure-active-directory-for-web-applications/) |
...
| **İlgili teknolojiler** | Genel |
| **Öznitelikler**              | Yok  |
| **Referanslar**              | [ADAL](https://azure.microsoft.com/documentation/articles/active-directory-authentication-libraries/) |
...
| **Referanslar**              | [Azure IoT Hub güvenlik belirteçleri](https://azure.microsoft.com/documentation/articles/iot-hub-sas-tokens/) |
...
| **Referanslar**              | [Kapsayıcılar ve Bloblar için anonim okuma erişimini yönetme](https://azure.microsoft.com/documentation/articles/storage-manage-access-to-resources/), [paylaşılan erişim imzaları, 1. Bölüm: SAS modelini anlama](https://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-1/) |
