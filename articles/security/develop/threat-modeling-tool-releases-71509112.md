...
![Ekran görüntüleri bir hata gösterir: dosya nesnesi başvurusunu açarken hata bir nesnenin örneğine ayarlanmadı.](./media/threat-modeling-tool-releases-71509112/tmt_save_error-300x131.png)
...
![Ekran görüntüsü, bir model Aç iletişim kutusunda OneDrive ' ın seçili olduğunu gösterir.](./media/threat-modeling-tool-releases-71509112/tmt_save_onedrive-300x149.png)
