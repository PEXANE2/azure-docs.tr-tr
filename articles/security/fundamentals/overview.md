...
Ayrıca, belirli bir olay algılandığında [belirli eylemleri otomatik olarak yürütmek](https://blogs.technet.microsoft.com/robdavies/2016/04/20/simple-look-at-oms-alert-remediation-with-runbooks-part-1/) için güvenlik & uyumluluğunu yapılandırabilirsiniz.
...
Uygulama, HTTP yük dengelemesi, tanımlama bilgisi tabanlı oturum benzeşimi, [TLS yük boşaltma](../../application-gateway/tutorial-restrict-web-traffic-powershell.md), özel sistem durumu araştırmaları, çoklu site desteği ve birçok başka uygulama teslim DENETLEYICISI (ADC) özelliği sunar.
