...
*Daha fazla bilgi için bkz. [güvenlik denetimi: kimlik ve erişim denetimi](../benchmarks/security-control-identity-access-control.md).*
...
*Daha fazla bilgi için bkz. [güvenlik denetimi: veri koruma](../benchmarks/security-control-data-protection.md).*
...
- [Azure DDoS koruması 'nda Azure rol tabanlı erişim denetimi 'ni (Azure RBAC) yönetme](../../ddos-protection/manage-ddos-protection.md)
...
*Daha fazla bilgi için bkz. [güvenlik denetimi: envanter ve varlık yönetimi](../benchmarks/security-control-inventory-asset-management.md).*
...
*Daha fazla bilgi için bkz. [güvenlik denetimi: güvenli yapılandırma](../benchmarks/security-control-secure-configuration.md).*
...
*Daha fazla bilgi için bkz. [güvenlik denetimi: kötü amaçlı yazılımdan koruma](../benchmarks/security-control-malware-defense.md).*
...
*Daha fazla bilgi için bkz. [güvenlik denetimi: olay yanıtı](../benchmarks/security-control-incident-response.md).*
...
*Daha fazla bilgi için bkz. [güvenlik denetimi: Penetme testleri ve Red ekibi alıştırmaları](../benchmarks/security-control-penetration-tests-red-team-exercises.md).*
...
- Bkz. [Azure Güvenlik kıyaslaması](../benchmarks/overview.md)
- [Azure güvenlik temelleri](../benchmarks/security-baselines-overview.md) hakkında daha fazla bilgi edinin