---
title: Azure etki alanlarının başvuru listesi
description: Azure etki alanlarının başvuru listesi (kapsamlı değil)
services: security
author: memildin
manager: rkarlin
ms.assetid: ''
...
Bu sayfa, kullanımdaki Azure etki alanlarının kısmi bir listesidir. Bunlardan bazıları REST API uç noktalardır.
...
|[Azure Blob Depolama](../../storage/blobs/index.yml)|*.blob.core.windows.net|
|[Azure Cloud Services](../../cloud-services/cloud-services-choose-me.md) ve [Azure sanal makineleri](../../virtual-machines/index.yml)|*. cloudapp.net|
...
|[Azure Dosyaları](../../storage/files/storage-files-introduction.md)|*. file.core.windows.net|
