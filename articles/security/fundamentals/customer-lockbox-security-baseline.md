...
**Rehberlik**: müşteri kasası istekleriniz için yönetici erişimine sahip kullanıcı hesaplarının envanterini saklayın. Rol tabanlı erişim denetimi 'ni (RBAC) yapılandırmak için, aboneliğiniz için Azure portal kimlik ve erişim denetimi (ıAM) bölmesini kullanabilirsiniz. Roller, kullanıcılar, gruplar, hizmet sorumluları ve Azure Active Directory içindeki yönetilen kimliklere uygulanır.
...
* [Azure rol tabanlı erişim denetimlerini anlama](https://docs.microsoft.com/azure/role-based-access-control/overview)
