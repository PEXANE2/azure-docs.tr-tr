...
* [Müşteri Kasası erişim isteği izinlerini anlayın](https://docs.microsoft.com/azure/security/fundamentals/customer-lockbox-overview)
...
* [Azure Active Directory örneği oluşturma ve yapılandırma](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-access-create-new-tenant)
...
* [Azure Active Directory raporlamayı anlayın](https://docs.microsoft.com/azure/active-directory/reports-monitoring/)

* [Azure Active Directory erişim incelemelerini kullanma](https://docs.microsoft.com/azure/active-directory/governance/access-reviews-overview)
...
* [Azure Active Directory riskli oturum açma nasıl görüntülenir](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-risky-sign-ins)
...
* [Müşteri Kasası iş akışını anlayın](https://docs.microsoft.com/azure/security/fundamentals/customer-lockbox-overview)
...
* [Müşteri Kasası içinde denetimi etkinleştirme](https://docs.microsoft.com/azure/security/fundamentals/customer-lockbox-overview)
...
* [Azure rol tabanlı erişim denetimini anlama (Azure RBAC)](https://docs.microsoft.com/azure/role-based-access-control/overview)
