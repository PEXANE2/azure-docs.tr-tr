...
**Rehberlik** : müşteri kasası isteklerinizi açmak ve yapılandırmak Için etkin Azure MULTI-Factor AUTHENTICATION (MFA) Ile ayrıcalıklı erişim iş istasyonu (Paw) kullanın.
