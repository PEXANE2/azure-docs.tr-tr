...
| Container Registry               | Evet                | Evet                | -                  |
| **İşlem**                      |                    |                    |                    |
| Sanal Makineler                 | Evet                | Evet, RSA 2048 bit  | -                  |
...
| **Depolama**                      |                    |                    |                    |
| Blob Depolama                     | Yes                | Evet, RSA 2048 bit  | Evet                |
| Premium blob depolaması             | Evet                | Evet, RSA 2048 bit  | Evet                |
...
| Dosya Premium depolaması             | Evet                | Evet, RSA 2048 bit  | -                  |
| Dosya Eşitleme                        | Evet                | Evet, RSA 2048 bit  | -                  |
| Kuyruk Depolama                    | Evet                | Evet                | Evet                |
| Avere vFXT                       | Evet                | -                  | -                  |
| Redis için Azure Cache            | Evet                | Yok\*              | -                  |
