...
- [Sızma testleri ve kırmızı takım alıştırmaları](security-control-penetration-tests-red-team-exercises.md)
...
Ayrıntılı geri bildiriminiz ve etkin katılım ile Azure Güvenlik kıyaslama çabasında hoş geldiniz. Kıyaslama ekibinin doğrudan girişini sağlamak isterseniz, lütfen [https://aka.ms/AzSecBenchmark](https://aka.ms/AzSecBenchmark)formu doldurun.
