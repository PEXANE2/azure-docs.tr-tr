---
title: Azure Güvenlik kıyaslaması v1 'ye Genel Bakış
description: Azure Güvenlik kıyaslaması v1 genel bakış
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
ms.locfileid: "90059418"
---
# <a name="overview-of-the-azure-security-benchmark-v1"></a>Azure Güvenlik kıyaslamaya genel bakış (v1)

> [!NOTE]
> En güncel Azure Güvenlik kıyaslaması [burada](overview.md)bulunabilir.

Azure Güvenlik Karşılaştırması, Azure’da uygulamalarınızın ve verilerinizin güvenliğini geliştirmeye yardımcı olacak öneriler içerir.
