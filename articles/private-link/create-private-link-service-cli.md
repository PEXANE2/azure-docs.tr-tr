---
title: Hızlı başlangıç-Azure CLı kullanarak Azure özel bağlantı hizmeti oluşturma
description: Bu hızlı başlangıçta Azure CLı kullanarak Azure özel bağlantı hizmeti oluşturmayı öğrenin
