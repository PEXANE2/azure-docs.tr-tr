---
title: Güvenlik aracıları olmadan IoT hizmeti için Defender
description: IoT hizmeti için Defender 'ın yerleşik iş akışını kullanmaya başlayın.
...
ms.locfileid: "90941702"
---
# <a name="get-started-with-built-in-iot-hub-integration"></a>Yerleşik IoT Hub tümleştirmeyle çalışmaya başlama

Bu seçenek, IoT güvenlik aracıları için Defender 'ı kullanmadan hizmeti kullanmanıza olanak sağlar.
...
Tebrikler! IoT Hub IoT hizmeti için Defender 'ı etkinleştirmeyi tamamladınız.
