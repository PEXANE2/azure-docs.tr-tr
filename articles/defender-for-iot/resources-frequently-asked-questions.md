...
## <a name="who-is-defender-for-iot-made-for"></a>IoT için kimin ne için yaptığı

IoT için Defender, Azure IoT Hub güvenliği kapsamında tümleşiktir ve günlük iş çözümü güvenlik işlemleri için yönetim sağlar. IoT için Defender, Azure Güvenlik Merkezi özelliklerine de tümleştirilir ve genel güvenlik çözümünüzün bir parçası olarak IoT güvenliği 'Ni izlemeye ve yönetmeye yönelik tümleşik bir görünüm sağlar.
...
Hayır, ancak önerilir. Azure Güvenlik Merkezi olmadan, IoT için Defender sınırlı bağlantılı kaynak verileri alır ve olası saldırı yüzeyi, tehditler ve olası saldırılara ilişkin sınırlı bir analiz sağlar.

## <a name="do-i-have-to-be-an-azure-iot-customer"></a>Azure IoT müşterisi olmam gerekiyor mu?

Evet. IoT için Defender, Azure IoT bağlantısı ve altyapısına bağımlıdır.
...
1. IoT için Defender güvenlik aracısını, değişiklikler olmadan veya değiştirmeden yükler. Bu seçenek, en yüksek düzeyde gelişmiş güvenlik öngörülerini cihaz davranışı ve erişimi sağlar.

1. Kendi aracınızı oluşturun ve IoT için Defender güvenlik iletisi şemasını uygulayın. Bu seçenek, cihaz güvenlik aracınızın en üstünde IoT çözümleme araçları için Defender kullanımını mümkün bir şekilde sunar.
...
## <a name="where-can-i-get-the-defender-for-iot-security-agent"></a>IoT güvenlik Aracısı için Defender 'ı nereden alabilirim?
...
## <a name="where-does-the-defender-for-iot-agent-get-installed"></a>IoT aracısının Defender 'ı nereye yüklesin?
...
IoT için Defender, yapılandırılabilir aracı taramaları, veri arabellekleri ve aracı tarafından oluşturulan veri miktarını artıran veya azaltan özel uyarılar oluşturma yeteneği sağlar.
...
## <a name="why-should-i-add-defender-for-iot-to-the-module-identity-what-is-it-used-for"></a>IoT için neden Defender 'ı modül kimliğine eklemem gerekir? Ne için kullanılır?

IoT modülü için Defender, aracı yapılandırma ve yönetimi için kullanılır.
