...
* Çalışan düğümlerinin [kapasitesini büyümeye](howto-hyperscale-scaling.md#increase-vcores) devam edin. Her çalışan en fazla 2 TiB depolama alanına sahip olabilir. Ancak düğüm ekleme işlemi daha hızlı tamamlandığından düğümlerin yeniden boyutlandırılması için düğüm ekleme denenmelidir.
