...
## <a name="retired-postgresql-engine-versions-not-supported-in-azure-postgresql"></a>Kullanımdan kaldırılan PostgreSQL altyapısı sürümleri Azure PostgreSQL 'de desteklenmiyor
...
- Karşılaşabileceğiniz herhangi bir destek sorunu PostgreSQL veritabanıyla ilişkili olursa size destek sağlayacağız. Bu gibi durumlarda, size herhangi bir destek sağlayabilmesi için veritabanınızı yükseltmeniz gerekir.
...
- Kullanımdan kaldırılan veritabanı sürümünde tanımlanan önemli bir veritabanı güvenliği güvenlik açığı durumunda, Azure, veritabanınızı otomatik olarak daha yüksek bir sürüme yükseltmeyi tercih edebilir.
