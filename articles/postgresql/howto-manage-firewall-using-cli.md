...
```
Çıktı, varsa, varsayılan olarak JSON biçiminde güvenlik duvarı kurallarını listeler. Daha okunabilir bir tablo biçimi için çıkış olarak anahtar `--output table` kullanabilirsiniz.
```azurecli-interactive
