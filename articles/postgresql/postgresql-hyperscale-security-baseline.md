...
**Rehberlik**: Hyperscale (Citus) denetim düzlemine erişimi denetlemek için Azure rol tabanlı erişim denetimi (Azure RBAC) kullanın (ör. Azure Portal). RBAC, veritabanı içindeki kullanıcı izinlerini etkilemez.
