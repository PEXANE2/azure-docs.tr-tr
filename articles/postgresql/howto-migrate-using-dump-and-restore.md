...
[Pg_dump](https://www.postgresql.org/docs/9.3/static/app-pgdump.html) , PostgreSQL veritabanını pg_dump tarafından oluşturulan bir arşiv dosyasından geri yüklemek Için bir PostgreSQL veritabanını bir döküm dosyasına ve [pg_restore](https://www.postgresql.org/docs/9.3/static/app-pgrestore.html) ' i ayıklamak için kullanabilirsiniz.
...
- [pg_dump](https://www.postgresql.org/docs/9.6/static/app-pgdump.html) ve [pg_restore](https://www.postgresql.org/docs/9.6/static/app-pgrestore.html) komut satırı yardımcı programları yüklendi
...
> [!NOTE]
> Ayrıntılı sözdizimi bilgileri için, [pg_dump](https://www.postgresql.org/docs/9.6/static/app-pgdump.html) ve [pg_restore](https://www.postgresql.org/docs/9.6/static/app-pgrestore.html)makalelerine bakın.
>
