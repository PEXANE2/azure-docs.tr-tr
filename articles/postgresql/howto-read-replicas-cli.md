...
`azure.replication_support` parametresi ana sunucuda **çoğaltma** olarak ayarlanmalıdır. Bu statik parametre değiştirildiğinde, değişikliğin etkili olması için sunucu yeniden başlatması gerekir.

1. `azure.replication_support` çoğaltmaya ayarlayın.
