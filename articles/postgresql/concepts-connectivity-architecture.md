...
description: PostgreSQL için Azure veritabanı sunucunuza yönelik bağlantı mimarisini açıklar.
author: kummanish
ms.author: manishku
...
> [!NOTE]
> *Doğu ABD 2* Ayrıca BIR üçüncül IP adresine `52.167.104.0`sahiptir.
