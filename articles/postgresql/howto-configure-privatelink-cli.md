...
PostgreSQL sunucu KIMLIĞININ, sonraki adımda PostgreSQL sunucu KIMLIĞINI kullanacaksınız ```/subscriptions/subscriptionId/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/servername.``` benzer olduğunu aklınızda görürsünüz. 
...
2.  `nslookup mydemopostgresserver.postgres.privatelink.database.azure.com` yazın. 
