...
[Az postgreSQL esnek-sunucu oluştur](/cli/azure/postgresql/flexible-server?view=azure-cli-latest&preserve-view=true)komutuyla esnek bir sunucu oluşturun. Aşağıdaki komut, Azure CLı 'nın yerel bağlamından hizmet varsayılanlarını ve değerlerini kullanarak bir sunucu oluşturur:
