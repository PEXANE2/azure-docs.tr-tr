...
PostgreSQL esnek sunucusunu silmek istiyorsanız [az Postgres esnek-sunucu Delete](/cli/azure/PostgreSQL/server#az-PostgreSQL-flexible-server-delete) komutunu çalıştırabilirsiniz.
