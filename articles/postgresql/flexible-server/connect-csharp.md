---
title: 'Hızlı başlangıç: C# ile bağlanma-PostgreSQL için Azure veritabanı-esnek sunucu'
description: Bu hızlı başlangıçta, PostgreSQL için Azure veritabanı 'na bağlanmak ve buradan veri sorgulamak için kullanabileceğiniz bir C# (.net) kod örneği sağlanır (esnek sunucu).
author: mksuni
ms.author: sumuth
...
ms.locfileid: "98606157"
---
# <a name="quickstart-use-net-c-to-connect-and-query-data-in-azure-database-for-postgresql---flexible-server"></a>Hızlı başlangıç: PostgreSQL için Azure veritabanı 'na bağlanmak ve veri sorgulamak için .NET (C#) kullanma-esnek sunucu
...
- [Azure Portal](./quickstart-create-server-portal.md) kullanarak PostgreSQL Için Azure veritabanı esnek sunucusu oluşturma <br/> ya da bir tane yoksa [Azure CLI](./quickstart-create-server-cli.md) .
- Sunucuda bulunan boş bir *Postgres* veritabanını kullanın veya [Yeni bir veritabanı](./quickstart-create-server-portal.md#connect-to-the-postgresql-database-using-psql)oluşturun.
