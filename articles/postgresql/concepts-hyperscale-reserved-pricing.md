...
1. **Ekle**’yi seçin. **Satın alma rezervasyonları** bölmesinde PostgreSQL **için Azure veritabanı** ' nı seçerek PostgreSQL veritabanlarınız için yeni bir ayırma satın alın.
