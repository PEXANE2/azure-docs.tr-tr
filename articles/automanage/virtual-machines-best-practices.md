...
|-----------|---------------|----------------------|-------------------------|
|VM öngörüleri Izleme    |VM'ler için Azure İzleyici, çalışan işlemleri ve diğer kaynaklardaki bağımlılıklar dahil olmak üzere sanal makinelerinizin performansını ve sistem durumunu izler. [Daha fazla](../azure-monitor/vm/vminsights-overview.md)bilgi edinin.    |Azure VM En Iyi uygulamaları – üretim    |Hayır    |
...
<sup>1</sup> yapılandırma profilleri, oto Yönet 'i etkinleştirdiğinizde kullanılabilir. [Daha fazla](automanage-virtual-machines.md)bilgi edinin. Yapılandırma profilinin varsayılan ayarlarını da ayarlayabilir ve en iyi yöntemler kısıtlamaları içinde kendi tercihlerinizi ayarlayabilirsiniz.
