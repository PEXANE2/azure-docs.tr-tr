...
Bu güvenlik temeli [Azure Güvenlik kıyaslama sürümü 1,0](../security/benchmarks/overview-v1.md) ' dan Azure Web uygulaması güvenlik duvarı 'na kılavuzluk uygular. Azure Güvenlik kıyaslaması, bulut Çözümlerinizi Azure 'da nasıl güvence altına almak için öneriler sağlar. İçerik, Azure Güvenlik kıyaslaması tarafından tanımlanan **güvenlik denetimlerine** ve Azure Web uygulaması güvenlik duvarı için geçerli olan ilgili kılavuza göre gruplandırılır. Azure Web uygulaması güvenlik duvarı için geçerli olmayan **denetimler** dışlandı. 
...
- [Application Gateway WAF ilkesi](https://docs.microsoft.com/cli/azure/network/application-gateway/waf-policy?view=azure-cli-latest) 

- [Ön kapıda WAF ilkesi](https://docs.microsoft.com/cli/azure/ext/front-door/network/front-door/waf-policy?view=azure-cli-latest)
...
- [Microsoft Web uygulaması güvenlik duvarındaki verileri Azure Sentinel 'e bağlama](/azure/sentinel/connect-microsoft-waf)
...
- [Azure etkinlik günlüğü için tanılama ayarlarını etkinleştirme](/azure/azure-monitor) 
...
- [Azure 'da uyarı oluşturma](/azure/azure-monitor/learn/tutorial-response)
...
Aboneliklerinizde oluşturulabilecek kaynak türlerine kısıtlamalar koymak için Azure Ilkesini kullanın. Azure Kaynak Grafiği 'ni kullanarak aboneliklerindeki kaynakları sorgulama ve bulma. Ortamda bulunan tüm Azure kaynaklarının onaylandığından emin olun.
