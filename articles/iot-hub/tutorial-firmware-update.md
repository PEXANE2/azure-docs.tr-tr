...
Üretici yazılımı güncelleştirme işlemini, bir **cihaz türüyle** etiketlenmiş tüm cihazlarda başlatmak için arka uç uygulamasında bir [Otomatik Cihaz Yönetimi yapılandırması](iot-hub-automatic-device-management.md#create-a-configuration) oluşturursunuz. Bu bölümde şunları nasıl yapabileceğinizi öğrenirsiniz:
