...
1. **Addtagsandquery** projesine sağ tıklayın ve sorguları yeniden çalıştırmak için **yeni örnek Başlat** > **Hata Ayıkla** ' yı seçin. Bu kez, **Mydeviceıd** her iki sorgu sonucunda görünmelidir.
