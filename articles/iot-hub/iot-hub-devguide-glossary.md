...
[Aygıt gezgini,](https://github.com/Azure/azure-iot-sdk-csharp/tree/master/tools/DeviceExplorer) Windows'ta çalışan ve aygıtlarınızı [kimlik kayıt defterinde](#identity-registry)yönetmenize olanak tanıyan bir araçtır. Araç ayrıca aygıtlarınıza ileti gönderip alabilir.
