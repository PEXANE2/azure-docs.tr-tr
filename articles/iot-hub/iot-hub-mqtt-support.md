...
İlk olarak, bir cihazın abone `$iothub/methods/POST/#`olması gerekir. IoT Hub, geçerli bir JSON ya da `$iothub/methods/POST/{method name}/?$rid={request id}`boş bir gövdele Yöntem istekleri konuya gönderir.
