---
title: "Hızlı başlatma: IoT Hub'ında IoT hizmeti için Azure Güvenlik Merkezi'ni etkinleştirme"
...
1. IoT Hub'ınızı açın ve **ardından Güvenlik** menüsünden **Genel Bakış'ı** seçin. 
2. **Ayarlar** ekranını seçin ve Log Analytics ayarlarının çalışma alanı yapılandırmasını istediğiniz gibi değiştirin.
