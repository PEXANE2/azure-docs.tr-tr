...
1. **Ayarlar'ı**tıklatın ve Log Analytics çalışma alanı yapılandırmanızı değiştirin.
...
1. **Daha fazla araştırma**yı tıklatın , sonra bu **uyarıya sahip hangi cihazların olduğunu görmek için buraya tıklayın ve DeviceId sütununa bakın.**
