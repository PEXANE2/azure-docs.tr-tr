...
1. Aracıyı **Daemon** olarak yükler - aygıtın servis yönetimi için **sistemli** kullandığını varsayar.

1. Aracıyı sağlanan kimlik doğrulama parametreleriyle yapılandırır.
