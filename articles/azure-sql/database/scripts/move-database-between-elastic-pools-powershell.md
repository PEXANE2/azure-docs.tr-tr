---
title: 'PowerShell: veritabanlarını elastik havuzlar arasında taşıma'
description: PowerShell kullanarak iki elastik havuz arasında SQL veritabanında bir veritabanını taşımak için örnek betik Azure PowerShell.
...
Bu PowerShell betiği örneği, iki elastik havuz oluşturur ve SQL veritabanında bir veritabanını bir elastik havuzdan başka bir elastik havuza taşımaktadır ve sonra bir veritabanını elastik havuzun dışına tek bir veritabanı işlem boyutuna taşımaktadır.
