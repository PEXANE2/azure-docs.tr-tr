...
DTU tabanlı satın alma modelinden Azure SQL veritabanı 'na bir veritabanını sanal çekirdek tabanlı satın alma modeline geçirmek, DTU tabanlı satın alma modelindeki standart ve Premium hizmet katmanları arasında yükseltme veya eski sürüme düşürme ile benzerdir.
