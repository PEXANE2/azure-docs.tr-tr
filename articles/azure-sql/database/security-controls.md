...
| Koruyucu: veri bulma ve sınıflandırma  | Yes | Bkz. [Azure SQL veritabanı ve Azure SYNAPSE Analytics veri bulma & sınıflandırması](data-discovery-and-classification-overview.md). |
