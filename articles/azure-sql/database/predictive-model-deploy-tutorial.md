...
[İkinci bölümde](predictive-model-build-compare-tutorial.md), R 'de birden çok makine öğrenimi modeli oluşturup eğitme ve en doğru olanı seçme hakkında bilgi edindiniz.

## <a name="prerequisites"></a>Ön koşullar

* Bu öğretici serisinin üçüncü kısmı, [**bir**](predictive-model-prepare-data-tutorial.md) kısmını ve [**ikinci kısmını**](predictive-model-build-compare-tutorial.md)tamamladığınız varsayılır.
...
1. `rental_rx_models`Modeli depolamak için bir tablo () oluşturun.
...
`predict_rentalcount_new`Eğitilen modeli ve yeni veri kümesini kullanarak tahminleri yapan bir saklı yordam () oluşturun.
...
Artık `predict_rentalcount_new` yeni verilerden Kiralama sayısını tahmin etmek için saklı yordamı kullanabilirsiniz.
...
Tutorialdb 'yi veritabanını kullanmayı bitirdiğinizde, bunu sunucudan silin.
