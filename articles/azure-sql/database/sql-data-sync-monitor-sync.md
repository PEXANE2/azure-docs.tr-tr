...
![Veri eşitleme izleme panosu](./media/sql-data-sync-monitor-sync/sync-monitoring-dashboard.png)
...
![Veri eşitleme e-posta bildirimleri](./media/sql-data-sync-monitor-sync/sync-email-notifications.png)
...
8.  Değişken adını olarak ayarlayın `DataSyncLogLastUpdatedTime` ve türünü DateTime olarak ayarlayın.
...
10. Hesabınız ve SQL Data Sync yapılandırmanız için gerekli değişiklikleri yapın. (Daha ayrıntılı bilgi için bkz. örnek komut dosyası.)
    ...
    3.  Azure Izleyici günlük bilgileri. Bu bilgileri Azure portal bul | Ayarlar | Bağlı kaynaklar. Azure Izleyici günlüklerine veri gönderme hakkında daha fazla bilgi için bkz. [http veri toplayıcı API 'si (Önizleme) Ile Azure izleyici günlüklerine veri gönderme](../../azure-monitor/platform/data-collector-api.md).
...
-   [SQL Veritabanı'na Genel Bakış](../../sql-database/sql-database-technical-overview.md)
