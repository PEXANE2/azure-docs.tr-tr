...
* Bu öğreticinin ikinci bölümünde [**Birinci bölüm bir**](clustering-model-prepare-data-tutorial.md) ve önkoşulları tamamladığınız varsayılır.
...
![Dirsek grafiği](./media/clustering-model-build-tutorial/elbow-graph.png)
...
Dört küme, [Birinci bölümde](clustering-model-prepare-data-tutorial.md#separate-customers)tanımlanan değişkenler kullanılarak verilmiştir:
...
> [Öğretici: Azure SQL veritabanı Machine Learning Services (Önizleme) ile R 'de kümeleme modeli dağıtma](clustering-model-deploy-tutorial.md)
