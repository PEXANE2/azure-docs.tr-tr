...
Kimlik bilgilerinizi geçirmek için, `$agent` daha önce PowerShell nesnesine geçirerek aşağıdaki komutu yürütün.
...
- Sunucular ve veritabanları olan kök düzeyi hedefleri, \<serverName\> \<databaseName\> yalnızca kök düzeyi hedefi içeren "(,)" adlı yeni bir hedef gruba geçirilecektir.
