...
Azure SQL veritabanınızda zaten yüklü olmayan bir paket kullanmanız gerekiyorsa, bunu [sqlmlutils](https://github.com/Microsoft/sqlmlutils)kullanarak yükleyebilirsiniz. **sqlmlutils** , kullanıcıların sql 'de Microsoft Azure sql ve SQL Server veritabanlarıyla etkileşim kurmasına ve r veya Python istemcisinden SQL 'de r veya Python kodu yürütmesine yardımcı olmak üzere tasarlanan bir pakettir. Şu anda, Azure SQL veritabanı 'nda yalnızca **sqlmlutils** 'ın R sürümü destekleniyor.
