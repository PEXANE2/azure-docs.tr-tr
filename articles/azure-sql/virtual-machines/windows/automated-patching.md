...
* PowerShell ile otomatik düzeltme eki uygulamayı yapılandırmayı planlıyorsanız [en son Azure PowerShell komutlarını yükleyebilirsiniz](/powershell/azure/) .
