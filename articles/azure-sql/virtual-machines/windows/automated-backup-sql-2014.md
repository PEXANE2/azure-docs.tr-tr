...
- Hedef veritabanlarının varsayılan SQL Server örneğinde olması gerekir. SQL Server IaaS Aracısı uzantısı adlandırılmış örnekleri desteklemiyor.
