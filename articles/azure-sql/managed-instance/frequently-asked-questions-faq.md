...
Yönetilen örnekleri Azure portal, [PowerShell](/powershell/module/az.sql/remove-azsqlinstance?preserve-view=true&view=azps-4.3.0), [Azure CLı](/cli/azure/sql/mi#az-sql-mi-delete) veya [Kaynak Yöneticisi REST API 'leri](/rest/api/sql/managedinstances/delete)aracılığıyla silebilirsiniz.
