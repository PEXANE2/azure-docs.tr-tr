...
|Group name  |Tür  |principalId  |Rol tanımı  |Role definition ID  |
|---------|---------|---------|---------|---------|
|Architects     |Kullanıcı grubu         |\<principalId\>         |Katılımcı         |b24988ac-6180-42a0-ab88-20f7382dd24c  |
|Değerlendirme     |Kullanıcı grubu         |\<principalId\>         |Okuyucu         |acdd72a7-3385-48ef-bd42-f606fba81ae7  |
|VM Specialists     |Kullanıcı grubu         |\<principalId\>         |VM Contributor         |9980e02c-c2be-4d73-94e8-173b1dc7cf3c  |
|Otomasyon     |Service principal name (SPN)         |\<principalId\>         |Katılımcı         |b24988ac-6180-42a0-ab88-20f7382dd24c  |
