...
- Müşteri kiracılarında verileri yedekleme ve geri yükleme
...
- Kiracılar arasında yayılan birden çok Sentinel çalışma alanı genelinde [olayları görüntüleme](../../sentinel/multiple-workspace-view.md)
