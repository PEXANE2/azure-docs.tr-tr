---
title: Yönetilen hizmetler teklifini Azure Market’te yayımlama
...
---
# <a name="publish-a-managed-services-offer-to-azure-marketplace"></a>Yönetilen hizmetler teklifini Azure Market’te yayımlama

Bu makalede, [Azure İş Ortağı Portalı'nı](https://cloudpartner.azure.com/)kullanarak Azure [Marketi'nde](https://azuremarketplace.microsoft.com) genel veya özel yönetilen hizmetler teklifini nasıl yayınlayacağınızı ve teklifi satın alan bir müşterinin Azure temsilci kaynak yönetimi için yerleşik kaynaklara nasıl dahil olduğunu öğreneceksiniz.

> [!NOTE]
> Bu teklifleri oluşturmak ve yayınlamak için [İş Merkezi'nde](../../marketplace/partner-center-portal/create-account.md) geçerli bir hesabınız olması gerekir. Zaten bir hesabınız yoksa, kayıt [işlemi,](https://aka.ms/joinmarketplace) İş Ortağı Merkezi'nde bir hesap oluşturma ve Ticari Pazar programına kaydolma adımlarında size yol açar. Microsoft İş Ortağı Ağı (MPN) Kimliğiniz, müşteri etkileşimleri üzerindeki etkinizi izlemek için yayımladığınız tekliflerle [otomatik olarak ilişkilendirilir.](../../billing/billing-partner-admin-link-started.md)
>
...
Yönetilen Hizmetler teklifini yayımlamak, Azure Marketi'nde başka türde bir teklif yayınlamaya benzer. Bu işlem hakkında bilgi edinmek için [Azure Marketi ve AppSource Yayımlama Kılavuzu'na](../../marketplace/marketplace-publishers-guide.md) bakın ve [Azure ve AppSource Marketplace tekliflerini yönetin.](../../marketplace/cloud-partner-portal/manage-offers/cpp-manage-offers.md) Ayrıca [ticari pazar sertifikasyonu ilkelerini](https://docs.microsoft.com/legal/marketplace/certification-policies)( özellikle [Yönetilen Hizmetler](https://docs.microsoft.com/legal/marketplace/certification-policies#700-managed-services) bölümünü) gözden geçirmelisiniz.

Bir müşteri teklifinizi ekledikten sonra, [azure temsilci kaynak yönetimi için dahil](#the-customer-onboarding-process)edilecek bir veya daha fazla özel abonelik veya kaynak grubuna temsilci atayabilecektir. Bir abonelik (veya abonelik teki kaynak grupları) gemiye binilmeden önce, **Microsoft.ManagedServices** kaynak sağlayıcısını el ile kaydederek aboneliğin yerleşik olarak onaylanması gerektiğini unutmayın.

> [!IMPORTANT]
> Yönetilen hizmetler teklifindeki her plan, kiracınızdaki Azure Etkin Dizin (Azure AD) varlıklarını tanımladığınız ve bu planı satın alan müşteriler için temsilci kaynak gruplarına ve/veya aboneliklere erişebileceğiniz bir **Bildirim Ayrıntıları** bölümü içerir. Buraya eklediğiniz herhangi bir grubun (veya kullanıcı veya hizmet sorumlusunun) planı satın alan her müşteri için aynı izinlere sahip olacağını unutmayın. Her müşteriyle çalışmak üzere farklı gruplar atamak için, her müşteriye özel ayrı bir özel plan yayımlamanız gerekir.

## <a name="create-your-offer-in-the-cloud-partner-portal"></a>Teklifinizi Bulut İş Ortağı Portalı'nda oluşturun
