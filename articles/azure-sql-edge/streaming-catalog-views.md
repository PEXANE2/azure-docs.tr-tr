...
Bu bölüm, T-SQL akışıyla ilgili kullanılabilir katalog görünümlerini ve işlevlerini içerir.
...
|[sys. external_job_streams](sys-external-job-streams.md)|Bir dış akış işiyle eşlenen giriş veya çıkış dış akış nesnesi için bir satır döndürür.|
