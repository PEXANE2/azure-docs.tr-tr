...
Modeli, bir veritabanındaki bir tabloda Azure SQL Edge veya Azure SQL yönetilen örneği 'nde depolayın `models` `onnx` . Bağlantı dizesinde _ * sunucu adresini * *, **Kullanıcı adı** ve **parolayı** belirtin.
