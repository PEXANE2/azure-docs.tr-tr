---
title: Azure Veri Kataloğuna Giriş
...
Azure Veri Kataloğu tamamen yönetilen bir bulut hizmetidir. Kullanıcıların gereksinim duydukları veri kaynaklarını keşfetmelerini ve buldukları veri kaynaklarını anlamalarını sağlar. Bunun yanı sıra, Veri Kataloğu kuruluşların mevcut yatırımlarından daha fazla değer elde etmesine yardımcı olur.
...
* Kullanıcılar, başka bir işlemin parçası olarak bu kaynakla temas etmedikçe bir veri kaynağının var olduğunu bilmeyebilirler. Veri kaynaklarının kayıtlı olduğu merkezi bir konum yoktur.
...
* Kullanıcıların bir bilgi varlığıyla ilgili soruları varsa, verilerden sorumlu olan uzmanı veya ekibi bulması ve bunlarla çevrimdışı etkileşim kurması gerekir. Veriler le kullanımına ilişkin bakış açıları olan uzmanlar arasında açık bir bağlantı yoktur.
...
* Veri kaynakları için belge oluşturma genellikle sonuç vermeyen bir işlemdir. Belgeleri veri kaynaklarıyla senkronize tutmak devam eden bir sorumluluktur. Kullanıcılar, güncelliğini yikadı olarak algılanan belgelere güvenmeyebilir.
...
Veri Kataloğu'na başlamak için:
