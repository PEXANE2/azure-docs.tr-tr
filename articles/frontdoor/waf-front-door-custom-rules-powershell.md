---
title: Özel kurallarla bir Web uygulaması güvenlik duvarı (WAF) ilkesi yapılandırma ve ön kapı için varsayılan Ruse kümesi Azure PowerShell
...
Bu makalede, bazı özel kurallardan oluşan ve Azure tarafından yönetilen varsayılan Ruse kümesi etkinleştirilmiş bir WAF ilkesinin nasıl yapılandırılacağı gösterilmektedir.
...
- [Ön kapı Için WAF](waf-overview.md) hakkında daha fazla bilgi edinin
