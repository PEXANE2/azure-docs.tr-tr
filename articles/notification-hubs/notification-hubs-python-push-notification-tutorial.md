...
description: Python uygulamasından Azure Notification Hubs kullanmayı öğrenin.
...
- ileti, anında Iletme bildirimi hizmetine başarıyla gönderildiğinde.
    ...
    ```
- Herhangi bir anında iletme bildirimi için herhangi bir hedef yoksa, yanıt olarak şu çıktıyı görürsünüz (kayıtlar uyuşmayan bazı etiketlere sahip olduğundan, bildirimi teslim etmek için hiçbir kayıt bulunmadığını gösterir)
    ```xml
...
- Bu makaledeki tüm kodu içeren tam [Python Rest sarmalayıcı örneğini]indirin.
- [Son haberler öğreticisindeki] Notification Hubs etiketleme özelliğini öğrenmeye devam edin
- [Yerelleştirme eğitim öğreticisindeki] Notification Hubs şablonları hakkında bilgi edinmeye devam edin
