...
description: Azure Data Box Gateway sorunları nasıl giderebileceğinizi öğrenin. Tanılama çalıştırabilir, destek için bilgi toplayabilir ve günlükleri kullanarak sorun giderme yapabilirsiniz.
services: databox
author: alkohli
ms.service: databox
