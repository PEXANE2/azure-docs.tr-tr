...
Büyük/küçük harfe duyarsız bir etiket adı ve etiket değeri aramak gerekirse,, ' ı **uzatma** parametresiyle `mv-expand` kullanın. Bu sorgu önceki sorgudan daha fazla kota kullanır, bu nedenle yalnızca gerekliyse `mv-expand` kullanın.
