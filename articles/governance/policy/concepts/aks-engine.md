...
> [!NOTE]
> AKS altyapısı için Azure Ilkesi genel önizlemede ve SLA 'sı yoktur. Gatekeeper v3 beta aşamasındadır ve açık kaynaklı topluluk tarafından desteklenir. Hizmet yalnızca yerleşik ilke tanımlarını, Linux düğüm havuzlarını ve hizmet sorumlusu ile yapılandırılmış her kaynak grubu için tek bir AKS motoru kümesini destekler.
