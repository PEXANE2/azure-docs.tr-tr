...
description: Bu örnek ilke tanımı, ağ izleyicisinin bir parametrede tanımlanmış belirtilen bölge için etkin olup olmadığını denetler.
ms.date: 01/23/2019
ms.topic: sample
