...
### <a name="passwords-are-not-displayed-when-entered"></a>Girilen parolalar görüntülenmez.

**Kimlik**: 1002.01 d1system. 1-01. d **sahiplik**: müşteri
...
### <a name="electronic-signatures-based-upon-biometrics-are-designed-to-ensure-that-they-cannot-be-used-by-any-individual-other-than-their-genuine-owners"></a>Biyometri 'e dayalı elektronik imzalar, bunların orijinal sahipleri dışında herhangi bir kişi tarafından kullanılmadığından emin olmak için tasarlanmıştır.

**Kimlik**: 11209.01 q2organizational. 9-01. q **sahiplik**: uygulanamaz
...
### <a name="unique-ids-that-can-be-used-to-trace-activities-to-the-responsible-individual-are-required-for-all-types-of-organizational-and-non-organizational-users"></a>Tüm kurumsal ve kurumsal olmayan kullanıcılar için etkinlikleri sorumlu kişiye izlemek üzere kullanılabilecek benzersiz kimlikler.

**Kimlik**: 1122.01 q1system. 1-01. q **sahiplik**: müşteri
...
### <a name="sharedgroup-and-generic-user-ids-are-only-used-in-exceptional-circumstances-where-there-is-a-clear-business-benefit-when-user-functions-do-not-need-to-be-traced-additional-accountability-controls-are-implemented-and-after-approval-by-management"></a>Paylaşılan/Grup ve genel kullanıcı kimlikleri yalnızca açık bir iş avantajı olduğu durumlarda, Kullanıcı işlevlerinin izlenmesi gerekmiyorsa, ek sorumluluk denetimlerinin uygulanması ve yönetim tarafından onaylandıktan sonra kullanılır.

**Kimlik**: 1124.01 q1system. 34-01. q **sahiplik**: müşteri
...
### <a name="help-desk-support-requires-user-identification-for-any-transaction-that-has-information-security-implications"></a>Yardım masası desteği, bilgi güvenliği etkilerine sahip herhangi bir işlem için Kullanıcı kimliği gerektirir.

**Kimlik**: 1128.01 q2system. 5-01. q **sahiplik**: müşteri
...
### <a name="information-collected-from-multiple-sources-shall-be-aggregated-for-review"></a>Birden çok kaynaktan toplanan bilgiler İnceleme için toplanmalıdır.

**Kimlik**: 12103.09 ab1organizational. 5-09. AB **sahipliği**: müşteri
...
### <a name="automated-systems-support-near-real-time-analysis-and-alerting-of-events-eg-malicious-code-potential-intrusions-and-integrate-intrusion-detection-into-access-and-flow-control-mechanisms"></a>Otomatik sistemler, olayların gerçek zamanlı analizini ve uyarı uyarılarını (örn. kötü amaçlı kod, olası saldırılar) ve erişim ve akış denetim mekanizmalarına tümleştirmeyi destekler.

**Kimlik**: 1218.09 ab3system. 47-09. AB **sahipliği**: müşteri
...
### <a name="security-is-maintained-through-all-aspects-of-the-transaction"></a>Güvenlik, işlemin tüm yönleri aracılığıyla sürdürülür.

**Kimlik**: 0944.09 y1organizational. 2-09. y **sahiplik**: uygulanamaz
