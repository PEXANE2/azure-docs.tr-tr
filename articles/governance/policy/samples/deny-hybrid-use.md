...
description: Bu örnek ilke tanımı, sanal makineler ve sanal makine ölçek kümeleri için Azure hibrit kullanım avantajı (AHUB) kullanımını yasaklar.
ms.date: 01/23/2019
ms.topic: sample
