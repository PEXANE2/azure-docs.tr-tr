...
1. Select or enter the following values:
   ...
   | Kaynak grubu | Select **Create new**, specify a name, and then select **OK**. In the screenshot, the resource group name is *mypolicyquickstart\<Date in MMDD>rg*. |
