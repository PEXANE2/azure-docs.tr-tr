...
|\[önizleme\]: denetim gereksinimlerini desteklemek için Fedrampa yüksek denetimlerini denetleme ve belirli VM uzantılarını dağıtma|İlke ataması|Güvenlik açığı değerlendirmesi SQL sunucularınızda etkinleştirilmelidir|İlke etkileri hakkında daha fazla bilgi için bkz. [Azure Ilke efektlerini anlama](../../../policy/concepts/effects.md).|
...
|\[önizleme\]: denetim gereksinimlerini desteklemek için Fedrampa yüksek denetimlerini denetleme ve belirli VM uzantılarını dağıtma|İlke ataması|Yazma izinlerine sahip dış hesapların aboneliğinizden kaldırılması gerekir|İlke etkileri hakkında daha fazla bilgi için bkz. [Azure Ilke efektlerini anlama](../../../policy/concepts/effects.md).|
