...
Bu şema, MySQL veritabanı sunucularının TLS/SSL bağlantılarını zorunlu tutmanıza yardımcı olan bir [Azure ilke](../../../policy/overview.md) tanımı atar.
...
Bu şema, PostgreSQL veritabanı sunucularının TLS/SSL bağlantılarını zorunlu tutmanıza yardımcı olan bir [Azure ilke](../../../policy/overview.md) tanımı atar.
