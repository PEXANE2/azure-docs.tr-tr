...
> [CIS Microsoft Azure temel kıyaslama kıyaslama şeması-genel bakış](./index.md)
> [CIS Microsoft Azure temel kıyaslama kıyaslama şeması-denetim eşleme](./control-mapping.md)
