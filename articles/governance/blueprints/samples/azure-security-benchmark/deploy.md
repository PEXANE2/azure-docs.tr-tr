---
title: Azure Güvenlik kıyaslaması şeması örneğini dağıtma
description: Şema yapıt parametresi ayrıntıları dahil olmak üzere Azure Güvenlik kıyaslaması şeması örneği için adımları dağıtın.
ms.date: 05/01/2020
ms.topic: sample
...
ms.locfileid: "82725969"
---
# <a name="deploy-the-azure-security-benchmark-blueprint-sample"></a>Azure Güvenlik kıyaslaması şeması örneğini dağıtma
...
|-|-|-|-|
|Azure Güvenlik kıyaslama önerilerini denetleme ve belirli destekleyici VM uzantılarını dağıtma|İlke ataması|
Windows VM Yöneticileri grubundan dışlanan kullanıcıların listesi|Yöneticiler yerel grubunda dışlanması gereken üyelerin noktalı virgülle ayrılmış listesi. Ex: yönetici; myUser1; myUser2|
...
Azure Güvenlik kıyaslaması şeması örneğini dağıtma adımlarını gözden geçirdiğinize göre, şema ve denetim eşlemesi hakkında bilgi edinmek için aşağıdaki makaleleri ziyaret edin:

> [!div class="nextstepaction"]
> [Azure Güvenlik kıyaslaması şeması-genel bakış](./index.md)
> [Azure Güvenlik kıyaslaması şema-Control Mapping](./control-mapping.md)
