---
title: FedRAMP Orta plan örnek kontrolleri
description: FedRAMP Orta plan örneğinin kontrol haritalaması. Her denetim, değerlendirmeye yardımcı olan bir veya daha fazla Azure İlkesiyle eşlenir.
ms.date: 10/31/2019
ms.topic: sample
...
Şimdi FedRAMP Orta planının kontrol haritalama inceledik, planı ve nasıl bu örnek dağıtmak hakkında bilgi edinmek için aşağıdaki makaleleri ziyaret edin:

> [!div class="nextstepaction"]
> [FedRAMP Orta planı - Genel Bakış](./index.md)
> [FodRAMP Orta plan - Dağıtım adımları](./deploy.md)
