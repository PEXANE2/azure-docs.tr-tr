...
Bu şema, veri güvenliği bildirimlerinin düzgün şekilde etkinleştirildiğinden emin olmanıza yardımcı olan ilke tanımları sağlar. Buna ek olarak, bu şema SQL sunucularında denetim ve gelişmiş veri güvenliğinin yapılandırılmasını sağlar.
