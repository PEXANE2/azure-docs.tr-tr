---
title: NIST SP 800-53 R4 plan örnek kontrolleri
description: NIST SP 800-53 R4 plan örneğinin kontrol eşlemi. Her denetim, değerlendirmeye yardımcı olan bir veya daha fazla Azure İlkesiyle eşlenir.
ms.date: 11/18/2019
ms.topic: sample
...
## <a name="ac-16-security-attributes"></a>AC-16 Güvenlik Özellikleri
...
Şimdi NIST SP 800-53 R4 planının kontrol eşleme inceledik, plan hakkında bilgi edinmek ve bu örnek dağıtmak için aşağıdaki makaleleri ziyaret edin:

> [!div class="nextstepaction"]
> [NIST SP 800-53 R4 planı - Genel Bakış](./index.md)
> [NIST SP 800-53 R4 planı - Dağıtım adımları](./deploy.md)
