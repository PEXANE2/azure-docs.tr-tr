...
1. Şema atamasının parametre değerlerini sağlayın:
   ...
   - Blueprint parametreleri
     ...
     - **VM aracıları için Log Analytics çalışma alanı (ilke: ıso 27001 Için Blueprint girişimi)** : bir çalışma ALANıNıN kaynak kimliğini belirtir. Bu parametre, kaynak KIMLIĞINI oluşturmak için bir `concat` işlevi kullanır.
...
|-|-|-|-|
|\[Preview @ no__t-1: Linux VM Ölçek Kümeleri için Log Analytics aracısı dağıtma (VMSS)|İlke ataması|İsteğe bağlı: kapsama eklemek için desteklenen Linux işletim sistemini destekleyen VM görüntülerinin listesi|Seçim Varsayılan değer _["none"]_ değeridir.|
|\[Preview @ no__t-1: Linux sanal makineleri için Log Analytics aracısı dağıtma|İlke ataması|İsteğe bağlı: kapsama eklemek için desteklenen Linux işletim sistemini destekleyen VM görüntülerinin listesi|Seçim Varsayılan değer _["none"]_ değeridir.|
|\[Preview @ no__t-1: Windows VM Ölçek Kümeleri için Log Analytics aracısı dağıtma (VMSS)|İlke ataması|İsteğe bağlı: kapsama eklemek için desteklenen Windows işletim sistemini destekleyen VM görüntülerinin listesi|Seçim Varsayılan değer _["none"]_ değeridir.|
|\[Preview @ no__t-1: Windows VM 'Leri için Log Analytics aracısı dağıtma|İlke ataması|İsteğe bağlı: kapsama eklemek için desteklenen Windows işletim sistemini destekleyen VM görüntülerinin listesi|Seçim Varsayılan değer _["none"]_ değeridir.|
...
|Log Analytics kaynak grubu|Kaynak grubu|Name|**Kilitli** -kaynak grubunu benzersiz hale getirmek için **kuruluş adını** `-sharedsvsc-log-rg` ile birleştirir.|
|Log Analytics kaynak grubu|Kaynak grubu|Konum|**Kilitli** -şema parametresini kullanır.|
|Log Analytics şablonu|Kaynak Yöneticisi şablonu|Hizmet katmanı|Log Analytics çalışma alanının katmanını ayarlar. Varsayılan değer _PerNode_değeridir.|
|Log Analytics şablonu|Kaynak Yöneticisi şablonu|Günlük tutma gün sayısı|Gün cinsinden veri saklama. Varsayılan değer _365_' dir.|
|Log Analytics şablonu|Kaynak Yöneticisi şablonu|Konum|Log Analytics çalışma alanını oluşturmak için kullanılan bölge. Varsayılan değer _Batı ABD 2_.|
|Ağ kaynak grubu|Kaynak grubu|Name|**Kilitli** -kaynak grubunu benzersiz hale getirmek için **kuruluş adını** `-sharedsvcs-net-rg` ile birleştirir.|
|Ağ kaynak grubu|Kaynak grubu|Konum|**Kilitli** -şema parametresini kullanır.|
|Azure Güvenlik Duvarı şablonu|Kaynak Yöneticisi şablonu|Azure Güvenlik Duvarı özel IP 'si|[Azure Güvenlik duvarının](../../../../firewall/overview.md)özel IP 'sini yapılandırır. Bu değer, paylaşılan hizmetler alt ağında varsayılan yol tablosu olarak da kullanılır. **Azure Güvenlik Duvarı alt ağ adresi ön eki**'NDE tanımlanan CIDR gösteriminin bir parçası olmalıdır. Varsayılan değer _10.0.4.4_' dir.|
|Azure Güvenlik Duvarı şablonu|Kaynak Yöneticisi şablonu|Günlük tutma gün sayısı|Gün cinsinden veri saklama. Varsayılan değer _365_' dir.|
|Ağ güvenlik grubu şablonu|Kaynak Yöneticisi şablonu|Günlük tutma gün sayısı|Gün cinsinden veri saklama. Varsayılan değer _365_' dir.|
|Sanal ağ ve yol tablosu şablonu|Kaynak Yöneticisi şablonu|Sanal ağ adresi ön eki|Sanal ağın CıDR gösterimi. Varsayılan değer _10.0.0.0/16_' dır.|
|Sanal ağ ve yol tablosu şablonu|Kaynak Yöneticisi şablonu|Sanal ağ DDoS korumasını etkinleştir|Sanal ağ için DDoS korumasını yapılandırır. Varsayılan değer _true_'dur.|
|Sanal ağ ve yol tablosu şablonu|Kaynak Yöneticisi şablonu|Paylaşılan hizmetler alt ağ adresi ön eki|Paylaşılan hizmetler alt ağının CıDR gösterimi. Varsayılan değer _10.0.0.0/24_' dir.|
|Sanal ağ ve yol tablosu şablonu|Kaynak Yöneticisi şablonu|DMZ alt ağ adresi öneki|DMZ alt ağı için CıDR gösterimi. Varsayılan değer _10.0.1.0/24_' dir.|
|Sanal ağ ve yol tablosu şablonu|Kaynak Yöneticisi şablonu|Application Gateway alt ağ adresi öneki|Uygulama ağ geçidi alt ağının CıDR gösterimi. Varsayılan değer _10.0.2.0/24_' dir.|
|Sanal ağ ve yol tablosu şablonu|Kaynak Yöneticisi şablonu|Sanal ağ geçidi alt ağ adresi ön eki|Sanal ağ geçidi alt ağının CıDR gösterimi. Varsayılan değer _10.0.3.0/24_' dir.|
|Sanal ağ ve yol tablosu şablonu|Kaynak Yöneticisi şablonu|Azure Güvenlik Duvarı alt ağ adresi ön eki|[Azure Güvenlik Duvarı](../../../../firewall/overview.md) alt ağı için CIDR Gösterimi. **Azure Güvenlik Duvarı özel IP** parametresini içermelidir.|
|Key Vault kaynak grubu|Kaynak grubu|Name|**Kilitli** -kaynak grubunu benzersiz hale getirmek için **kuruluş adını** `-sharedsvcs-kv-rg` ile birleştirir.|
|Key Vault kaynak grubu|Kaynak grubu|Konum|**Kilitli** -şema parametresini kullanır.|
|Key Vault şablonu|Kaynak Yöneticisi şablonu|JumpBox Yönetici Kullanıcı adı|Sıçrama kutusu için Kullanıcı adı. Sıçrama **kutusu şablonundaki**aynı özellik değeriyle eşleşmelidir. Varsayılan değer _JB-admin-User_değeridir.|
|Key Vault şablonu|Kaynak Yöneticisi şablonu|JumpBox yönetici SSH anahtarı veya parolası|Sıçrama kutusundaki hesabın anahtar veya parolası. Sıçrama **kutusu şablonundaki**aynı özellik değeriyle eşleşmelidir. Varsayılan değer olmadığından boş bırakılamaz.|
|Key Vault şablonu|Kaynak Yöneticisi şablonu|Etki alanı yöneticisi Kullanıcı adı|Active Directory VM 'ye erişmek ve diğer VM 'Leri bir etki alanına katmak için kullanılan Kullanıcı adı. **Active Directory Domain Services şablonundaki** **Domain Admin kullanıcı** özelliği değeriyle eşleşmelidir. Varsayılan değer _etki alanı-yönetici-kullanıcı_' dır.|
|Key Vault şablonu|Kaynak Yöneticisi şablonu|Etki alanı yöneticisi parolası|Etki alanı yöneticisi kullanıcısının parolası. Varsayılan değer olmadığından boş bırakılamaz.|
|Key Vault şablonu|Kaynak Yöneticisi şablonu|AAD nesne KIMLIĞI|Key Vault örneğine erişim gerektiren hesabın AAD nesne tanımlayıcısı. Varsayılan değer olmadığından boş bırakılamaz. Azure portal bu değeri bulmak için, _Hizmetler_altında "kullanıcılar" ı arayın ve seçin. Hesap adını filtrelemek için _ad_ kutusunu kullanın ve bu hesabı seçin. _Kullanıcı profili_ sayfasında, _nesne kimliğinin_yanındaki "kopyalamak için tıklayın" simgesini seçin.  |
|Key Vault şablonu|Kaynak Yöneticisi şablonu|Günlük tutma gün sayısı|Gün cinsinden veri saklama. Varsayılan değer _365_' dir.|
|Key Vault şablonu|Kaynak Yöneticisi şablonu|Key Vault SKU 'SU|Oluşturulan Key Vault SKU 'sunu belirtir. Varsayılan değer _Premium_' dur.|
|Atlama kutusu kaynak grubu|Kaynak grubu|Name|**Kilitli** -kaynak grubunu benzersiz hale getirmek için **kuruluş adını** `-sharedsvcs-jb-rg` ile birleştirir.|
|Atlama kutusu kaynak grubu|Kaynak grubu|Konum|**Kilitli** -şema parametresini kullanır.|
|Sıçrama kutusu şablonu|Kaynak Yöneticisi şablonu|JumpBox Yönetici Kullanıcı adı|Sıçrama kutusu VM 'lerine erişmek için kullanılan Kullanıcı adı. **Key Vault şablonunda**aynı özellik değeriyle eşleşmelidir. Varsayılan değer _JB-admin-User_değeridir.|
|Sıçrama kutusu şablonu|Kaynak Yöneticisi şablonu|JumpBox yönetici parolası (Key Vault kaynak KIMLIĞI)|Key Vault kaynak KIMLIĞI. "/Subscriptions/{subscriptionId}/resourceGroups/{orgName}-sharedsvcs-kv-rg/providers/Microsoft.KeyVault/vaults/{orgName}-sharedsvcs-kv" kullanın ve `{subscriptionId}` ' yı abonelik KIMLIĞINIZLE ve `{orgName}` ' i **Şirket adıyla** değiştirin Şema parametresi.|
|Sıçrama kutusu şablonu|Kaynak Yöneticisi şablonu|JumpBox yönetici parolası (Key Vault gizli adı)|Sıçrama kutusu yöneticisinin Kullanıcı adı. **Key Vault Template** özelliği **JumpBox Yönetici Kullanıcı adı**' nın değeriyle eşleşmelidir.|
|Sıçrama kutusu şablonu|Kaynak Yöneticisi şablonu|JumpBox Işletim sistemi|Sıçrama kutusu sanal makinesinin işletim sistemini belirler. Varsayılan değer _Windows_' dır.|
|Active Directory Domain Services kaynak grubu|Kaynak grubu|Name|**Kilitli** -kaynak grubunu benzersiz hale getirmek için **kuruluş adını** `-sharedsvcs-adds-rg` ile birleştirir.|
|Active Directory Domain Services kaynak grubu|Kaynak grubu|Konum|**Kilitli** -şema parametresini kullanır.|
|Active Directory Domain Services şablonu|Kaynak Yöneticisi şablonu|Etki alanı yöneticisi Kullanıcı adı|Atlama kutusu ekleme için Kullanıcı adı. **Key Vault şablonunda**aynı özellik değeriyle eşleşmelidir. Varsayılan değer _ekler-admin-User_.|
|Active Directory Domain Services şablonu|Kaynak Yöneticisi şablonu|Etki alanı yönetici parolası (Key Vault kaynak KIMLIĞI)|Key Vault kaynak KIMLIĞI. "/Subscriptions/{subscriptionId}/resourceGroups/{orgName}-sharedsvcs-kv-rg/providers/Microsoft.KeyVault/vaults/{orgName}-sharedsvcs-kv" kullanın ve `{subscriptionId}` ' yı abonelik KIMLIĞINIZLE ve `{orgName}` ' i **Şirket adıyla** değiştirin Şema parametresi.|
|Active Directory Domain Services şablonu|Kaynak Yöneticisi şablonu|Etki alanı yönetici parolası (Key Vault gizli adı)|Etki alanı yöneticisinin Kullanıcı adı. **Key Vault şablon** özelliği **etki alanı Yönetici Kullanıcı adı**' nın değeriyle eşleşmelidir.|
|Active Directory Domain Services şablonu|Kaynak Yöneticisi şablonu|Etki alanı adı|Örnek tarafından oluşturulan Active Directory adı. Varsayılan değer _contoso.com_' dir.|
|Active Directory Domain Services şablonu|Kaynak Yöneticisi şablonu|Etki alanı yöneticisi kullanıcısı|Yönetici AD hesabı için Kullanıcı adı ve cihazları AD etki alanına katma. **Key Vault şablonundaki** **ad Yöneticisi Kullanıcı adı** özellik değeriyle eşleşmelidir. Varsayılan değer _etki alanı-yönetici-kullanıcı_' dır.|
|Active Directory Domain Services şablonu|Kaynak Yöneticisi şablonu|Etki alanı yöneticisi parolası|Parolayı depolamak için Key Vault ayrıntılarını ayarlayın. Varsayılan değer olmadığından boş bırakılamaz.|
