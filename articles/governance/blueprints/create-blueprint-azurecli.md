...
- Daha önce Azure şemaları kullanmadıysanız, ile Azure CLı aracılığıyla kaynak sağlayıcısını kaydedin `az provider register --namespace Microsoft.Blueprint` .
