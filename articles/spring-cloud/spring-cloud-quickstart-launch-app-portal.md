...
5. Uygulamayı oluşturun `gateway` ve jar dosyasını dağıtın.  Aşağıdaki adımlar yay bulutu uzantısını gerektirir. Önkoşulları önkoşullara yüklemediyseniz, aşağıdaki komutu çalıştırın:
