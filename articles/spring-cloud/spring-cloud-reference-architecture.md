...
Azure yay bulutu, güvenli bir ortamda dağıtıldığında Azure 'dan çıkış yapmak için yönetim trafiği gerektirir. Bunu gerçekleştirmek için, [VNET 'Te Azure yay bulutu 'nı çalıştırmaya yönelik müşteri sorumlulukları](/azure/spring-cloud/spring-cloud-vnet-customer-responsibilities)bölümünde listelenen ağ ve uygulama kurallarına izin vermeniz gerekir.
