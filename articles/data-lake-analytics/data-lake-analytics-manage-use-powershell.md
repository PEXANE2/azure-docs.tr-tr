...
### <a name="check-for-the-existence-of-a-file"></a>Bir dosyanın var olup olmadığını denetle
...
U-SQL kataloğu, U-SQL betikleri tarafından paylaşılabilmesi için verileri ve kodu yapılandırmak üzere kullanılır. Katalog, Azure Data Lake veri ile mümkün olan en yüksek performansı sunar. Daha fazla bilgi için bkz. [U-SQL kataloğunu kullanma](./data-lake-analytics-u-sql-get-started.md).
