...
2. U-SQL ve Spark 'ın verileri yönetme arasındaki farkları anlayın
   ...
   [Azure Data Lake Storage 1.](../data-lake-store/data-lake-store-overview.md) verilerinizi [Azure Data Lake Storage 2.](../storage/blobs/data-lake-storage-introduction.md)taşımak istiyorsanız, hem dosya verilerini hem de katalog tarafından tutulan verileri kopyalamanız gerekir. Bkz. [Spark veri biçimlerini anlama](data-lake-analytics-understand-spark-data-formats.md)
