...
**Rehberlik**: Data Lake Analytics kimlik doğrulaması, Azure Active Directory ile sağlandığı ve rol tabanlı erişim DENETIMLERI (RBAC) tarafından güvenli hale getirildiği için varsayılan parola kavramına sahip değildir.
