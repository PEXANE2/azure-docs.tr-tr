...
1. CTRL + SHIFT + P tuşlarına basarak komut paletini açın ve ardından adl yazın **: Paketleri indirmek için yerel** çalıştırma paketini indirin.  
...
İlk kez Kullanıcı için adl 'yi kullanın **: ** [U-SQL yerel çalıştırma ortamı ayarlanmamışsa](#set-up-the-u-sql-local-run-environment)yerel çalıştırma paketlerini indirmek için yerel çalıştırma paketini indirin.

1. CTRL + SHIFT + P tuşlarına basarak komut paletini açın ve ardından adl yazın **: Yerel çalıştırma hizmetini**başlatın.   
...
1. Adl kullan **: ** [U-SQL yerel çalıştırma ortamı ayarlanmamışsa](#set-up-the-u-sql-local-run-environment)yerel çalıştırma paketlerini indirmek için yerel çalıştırma paketini indirin.
...
1. CTRL + SHIFT + P tuşlarına basarak komut paletini açın ve ardından adl yazın **: Yerel çalıştırma hizmetini**başlatın. Cmd konsolu açılır. **Dataroot** 'ın ayarlandığından emin olun.
2. Arka plan C# kodunuzda bir kesme noktası ayarlayın.
3. Betik düzenleyicisine geri döndüğünüzde, sağ tıklayın ve adl **' i seçin: Yerel hata**ayıklama.
