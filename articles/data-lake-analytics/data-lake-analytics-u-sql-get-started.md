...
Bu betikte herhangi bir dönüştürme adımı yok. Adlı `SearchLog.tsv`kaynak dosyadan okur, şema bunu birleştirir ve satır kümesini SearchLog-First-u-SQL. csv adlı bir dosyaya geri yazar.

`Duration` Alandaki veri türünün yanındaki soru işaretine dikkat edin. Bu, `Duration` alanın null olabileceği anlamına gelir.
...
Aşağıdaki mutlak dosya yolu, adında `mystore`bir Data Lake Store dosya anlamına gelir:
