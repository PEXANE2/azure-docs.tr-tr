...
Herhangi bir şemada, **EventSource** `Recommendation` ve **OperationName** ' ı arayarak Advisor öneri olaylarını belirleyebilirsiniz `Microsoft.Advisor/recommendations/available/action`.
