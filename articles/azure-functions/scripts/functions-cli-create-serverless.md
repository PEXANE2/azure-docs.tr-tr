---
title: Azure CLI'yi kullanarak sunucusuz bir işlev uygulaması oluşturun
description: Azure CLI'yi kullanarak Azure'da sunucusuz yürütme için bir işlev uygulaması oluşturma
