...
1. İşlev uygulamanızı genişletin ve **işlevler**' in **+** yanındaki düğmeyi seçin. **Portalda** > **devam et**' i seçin.

1. **Daha fazla şablon seçin...**, ardından son ' u seçin **ve şablonları görüntüleyin**

1. HTTP tetikleyicisi ' ni seçin `TurbineRepair` , işlev **adını**yazın, `Function` **[kimlik doğrulama düzeyi](functions-bindings-http-webhook-trigger.md#http-auth)** için öğesini seçin ve ardından **Oluştur**' u seçin.  
