...
!["Ngrok" yardımcı programını başlattıktan sonra komut Isteminin gösterildiği ekran görüntüsü.](./media/functions-debug-event-grid-trigger-local/functions-debug-event-grid-trigger-local-ngrok.png)
