...
| Parametre        | Parameter Type  | Açıklama |
|------------------|-----------------|-------------|
...
| **`{content}`**    | Request content | İsteğe bağlı. The JSON-formatted orchestrator function input. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | İsteğe bağlı. The reason for terminating the orchestration instance. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | İsteğe bağlı. The reason for rewinding the orchestration instance. |
...
| **`op`**          | Query string    | İsteğe bağlı. The name of the user-defined operation to invoke. |
| **`{content}`**   | Request content | The JSON-formatted event payload. |
