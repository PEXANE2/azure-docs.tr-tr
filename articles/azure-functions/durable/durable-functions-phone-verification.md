...
> [!NOTE]
> `HttpStart` [Örnek uygulamadaki ve hızlı](#prerequisites) başlangıçta bulunan işlev, Orchestrator işlevini tetikleyen [düzenleme istemcisi](durable-functions-bindings.md#orchestration-client) olarak davranır.
