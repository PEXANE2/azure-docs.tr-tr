...
Ve aşağıda JavaScript için gereken yapılandırma bulunur. `function.json` Dosyadaki görev hub 'ı özelliği uygulama ayarı aracılığıyla ayarlanır:
