...
Varış sonrasında, olayın JSON yükü, işlevin kullanması için ```EventSchema``` POJO içine de serileştirilir. Bu işlem, işlevin bir nesne yönelimli bir şekilde olay özelliklerine erişmesine olanak tanır.
