...
Aşağıdaki örnek, tek bir tablo satırını okuyan bir [ C# işlevi](functions-dotnet-class-library.md) gösterir. Tabloya yerleştirilen her kayıt için, işlev tetiklenecektir.
