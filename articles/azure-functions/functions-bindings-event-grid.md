...
Tetikleyici ve bağlamalarla çalışma, uygun pakete başvurmanız gerekir. Uzantı diğer tüm uygulama türlerini paketlarken, .NET sınıf kitaplıkları için NuGet paketi kullanılır.
