...
C# Ve F# Azure işlevleri 2. x ve üzeri işlevleri için, Event Grid tetikleyicisi için aşağıdaki parametre türünü kullanma seçeneğiniz de vardır:
...
Bu uç nokta deseninin 2. x ve üzeri Işlevleri için kullanın:
