...
| -------------------------- | ------ | ---------------------------------------------------- |
| Azure Blob Depolama Alanı         | https  | \<storage_account>. blob.core.windows.net/path/file   |
| Azure Blob Depolama Alanı         | wasb   | \<container>@\<storage_account>. blob.core.windows.net/path/file |
