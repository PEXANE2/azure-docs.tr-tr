...
| **Yordamlar** | [Evet](/sql/t-sql/statements/create-procedure-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest&preserve-view=true) | Evet |
...
| **Maliyet denetimi** | Evet, ölçek yukarı ve ölçek azaltma eylemlerini kullanma. | Evet, [Azure Portal veya T-SQL yordamını](https://docs.microsoft.com/azure/synapse-analytics/sql/data-processed#cost-control)kullanarak. |
...
| **[İşlemler](develop-transactions.md)** | Evet | Evet, meta veri nesnelerinde uygulanabilir. |
