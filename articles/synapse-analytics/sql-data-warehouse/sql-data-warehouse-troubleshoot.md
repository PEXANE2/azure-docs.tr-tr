---
title: Adanmış SQL havuzunda sorun giderme
description: Azure SYNAPSE Analytics 'te adanmış SQL havuzunda sorun giderme.
...
| En iyi yöntemleri uygulama                              | Sorgu performansını artırmanın yollarını öğrenmek için başlamak için en iyi yer, [ADANMıŞ SQL havuzu en iyi yöntemler](sql-data-warehouse-best-practices.md) makaleleridir. |
| Ölçeklendirmeyle performansı artırma                      | Bazen, performansı iyileştirmeye yönelik çözüm, [Özel SQL havuzunuzu ölçeklendirerek](sql-data-warehouse-manage-compute-overview.md), sorgularınızı yalnızca daha fazla işlem gücü eklemektir. |
