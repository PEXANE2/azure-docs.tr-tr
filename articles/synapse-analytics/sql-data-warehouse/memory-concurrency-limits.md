...
description: Azure SYNAPSE Analytics 'te adanmış SQL havuzu için çeşitli performans düzeylerine ve kaynak sınıflarına ayrılan bellek ve eşzamanlılık sınırlarını görüntüleyin.
...
ms.locfileid: "96455353"
---
# <a name="memory-and-concurrency-limits-for-dedicated-sql-pool-in-azure-synapse-analytics"></a>Azure SYNAPSE Analytics 'te adanmış SQL havuzu için bellek ve eşzamanlılık sınırları
