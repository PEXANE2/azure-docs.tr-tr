...
Diğer iş ortakları hakkında daha fazla bilgi için bkz. [Iş zekası ortakları](sql-data-warehouse-partner-business-intelligence.md), [veri tümleştirme iş ortakları](sql-data-warehouse-partner-data-integration.md) ve [veri yönetimi iş ortakları](sql-data-warehouse-partner-data-management.md).
