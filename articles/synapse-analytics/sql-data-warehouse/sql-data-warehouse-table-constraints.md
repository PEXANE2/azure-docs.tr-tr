...
Sözdizimi için [alter table](/sql/t-sql/statements/alter-table-transact-sql) ve [Create Table](/sql/t-sql/statements/create-table-azure-sql-data-warehouse)' i işaretleyin. 
