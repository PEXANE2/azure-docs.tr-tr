...
description: SQL Analytics için Visual Studio ve SQL Server Geliştirme Araçları (SSDT) yükleyin
...
SQL Analytics için özellik sürümlerinin SSDT desteği içermeyebilecek zamanlar vardır. Aşağıdaki özellikler şu anda desteklenmeyen:
