...
1. ADLS Gen 2 depolama hesabı anahtarını alın:
...
1. ADLS Gen 2 depolama uç noktası URL 'sini alın:
...
1. Seçim ADLS 2. depolama hesabı anahtarınızın ve uç noktasının ne olduğunu her zaman kontrol edebilirsiniz:
