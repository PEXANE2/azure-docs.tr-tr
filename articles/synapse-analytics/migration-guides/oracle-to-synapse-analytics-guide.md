---
title: "Oracle 'dan Azure SYNAPSE Analytics: geçiş kılavuzu"
description: Aşağıdaki bölümlerde, mevcut bir Oracle veritabanı çözümünü Azure SYNAPSE Analytics 'e geçirme ile ilgili yenilikler hakkında genel bir bakış sağlanmaktadır.
...
ms.locfileid: "103225833"
---
# <a name="migration-guide-migrate-oracle-data-warehouse-to-a-dedicated-sql-pool-in-azure-synapse-analytics"></a>Geçiş Kılavuzu: Oracle veri ambarını Azure SYNAPSE Analytics 'te adanmış bir SQL havuzuna geçirme
Aşağıdaki bölümlerde, mevcut bir Oracle veri ambarı çözümünü Azure SYNAPSE Analytics 'e geçirme ile ilgili yenilikler hakkında genel bir bakış sağlanmaktadır.
...
- Oracle nesnelerini SQL Server dönüştürmek için Oracle için SSMA. Daha fazla bilgi için bkz. [Oracle veritabanlarını SQL Server 'ye geçirme (OracleToSQL)](https://docs.microsoft.com/sql/ssma/oracle/migrating-oracle-databases-to-sql-server-oracletosql) . 
