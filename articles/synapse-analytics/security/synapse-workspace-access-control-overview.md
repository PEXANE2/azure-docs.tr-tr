...
### <a name="creating-and-managing-synapse-resources"></a>SYNAPSE kaynaklarını oluşturma ve yönetme
...
Bu kaynakları oluşturmak için kaynak grubunda bir Azure sahibi veya katkıda bulunan olması gerekir.  Bunları yönetmek için kaynak grubunda veya tek tek kaynaklarda bir Azure sahibi veya katkıda bulunan olması gerekir. 
...
Sunucusuz SQL havuzları ve Apache Spark tabloları, verilerini çalışma alanıyla ilişkili bir ADLS 2. kapsayıcısında depolar.  Kullanıcılara ve çalışma alanı MSI bu ADLS 2. depolama kapsayıcısına Depolama Blobu veri katılımcısı erişimine sahip olması gerekir.  
