...
SYNAPSE Analytics 'te yönetilen özel uç nokta hakkında daha fazla bilgi için bkz. [yönetilen özel uç noktalar](../security/synapse-workspace-managed-private-endpoints.md).
