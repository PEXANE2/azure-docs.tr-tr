---
title: Azure Synapse Analytics'te SQL havuzuna girme
description: Azure Synapse Analytics'te sql havuzuna nasıl veri sindirilenöğrenin
...
---
# <a name="ingesting-data-into-a-sql-pool"></a>SQL havuzuna veri alma

Bu makalede, Azure Synapse Analytics'i kullanarak bir Azure Veri Gölü Gen 2 depolama hesabından sql havuzuna nasıl veri alacağınızı öğreneceksiniz.

## <a name="prerequisites"></a>Ön koşullar

* **Azure aboneliği**: Azure aboneliğiniz yoksa, başlamadan önce ücretsiz bir [Azure hesabı](https://azure.microsoft.com/free/) oluşturun.
* **Azure depolama hesabı**: Kaynak *veri* deposu olarak Azure Veri Gölü Depolama Gen 2'yi kullanıyorsunuz. Depolama hesabınız yoksa, bir depolama hesabı oluşturmak için adımlar için [bir Azure Depolama hesabı oluşturma'ya](../../storage/blobs/data-lake-storage-quickstart-create-account.md?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json) bakın.
* **Azure Synapse Analytics**: *Lavabo* veri deposu olarak SQL havuzu kullanıyorsunuz. Azure Synapse Analytics örneğiniz yoksa, oluşturmak için adımlar için [bir SQL havuzu oluştur'a](../../sql-database/sql-database-get-started-portal.md?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json) bakın.

## <a name="create-linked-services"></a>Bağlı hizmetler oluşturma

Azure Synapse Analytics'te bağlantılı bir hizmet, bağlantı bilgilerinizi diğer hizmetlerle tanımladığınız yerdir. Bu bölümde, bir Azure Synapse Analytics ve Azure Veri Gölü Depolama Gen2 bağlantılı hizmet eklersiniz.
...
1. Kimlik doğrulama kimlik bilgilerinizi girin. Hesap anahtarı, hizmet sorumlusu ve yönetilen kimlik şu anda desteklenen kimlik doğrulama türleridir. Kimlik bilgilerinizin doğru luğunu doğrulamak için test bağlantısını tıklatın. Tamamlandığında **Oluştur'u** tıklatın.
1. 3-5 adımlarını yineleyin, ancak Azure Veri Gölü Depolama Gen2 yerine Azure Synapse Analytics döşemesini seçin ve ilgili bağlantı kimlik bilgilerini girin. Azure Synapse Analytics için SQL kimlik doğrulaması, yönetilen kimlik ve hizmet ilkesi şu anda desteklenir.

## <a name="create-pipeline"></a>İşlem hattı oluşturma

Bir ardışık iş, bir dizi etkinlik yürütmesi için mantıksal akışı içerir. Bu bölümde, ADLS gen 2'den sql havuzuna veri yutacak bir kopyalama etkinliği içeren bir ardışık işlem oluşturursunuz.
...
1. Veri deponuz olarak Azure Synapse Analytics'i seçin ve devam et'i tıklatın.
1. Set özellikleri bölmesinde, oluşturduğunuz Azure Synapse Analytics bağlantılı hizmetini seçin. Varolan bir tabloya yazıyorsanız, açılır dosyadan seçin. Aksi takdirde, **Edit'i** işaretleyin ve yeni tablo adınızı girin. Tamamlandığında Tamam'ı tıklatın
1. Tablo oluşturuyorsanız, tablo seçeneği alanında **Otomatik oluşturma tablosunu etkinleştirin.**
...
Synapse Analytics için veri tümleştirmesi hakkında daha fazla bilgi için [Azure Veri Gölü Depolama Gen2 makalesinde veri alma](data-integration-data-lake.md) bölümüne bakın.
