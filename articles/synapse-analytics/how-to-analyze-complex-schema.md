...
| N 'endpoint = https://ACCOUNTNAME.documents-staging.windows-ppe.net:443/ ; Account = ACCOUNTNAME; Database = DatabaseName; koleksiyon = COLLECTIONNAME; Region = REGIONTOQUERY ', gizli = ' YOURSECRET ' |' CosmosDB ' (SYNAPSE bağlantısı)|
