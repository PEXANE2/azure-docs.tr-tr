...
*   GitHub deposundan betiği [`Get-ConfigurationParams.ps1`](https://github.com/Azure-Samples/storsimple-dotnet-data-manager-get-started/blob/master/Data_Manager_Job_Run/Get-ConfigurationParams.ps1) .
...
1. Yapılandırma parametrelerini almak için aşağıdaki adımları uygulayın:
    1. `C:\DataTransformation` konumundaki GitHub deposu betiğinden `Get-ConfigurationParams.ps1` indirin.
    1. GitHub deposundan `Get-ConfigurationParams.ps1` betiğini çalıştırın. Aşağıdaki komutu yazın:
...
3. Visual Studio 2012, 2013 veya 2015 kullanarak bir C# .NET konsol uygulaması oluşturun.
    ...
    2. **C# Visual > konsol uygulaması > yüklü > şablonları**' nı seçin.
