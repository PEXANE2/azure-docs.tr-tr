...
-    > **Disk** **Storage** > **Details**ayrıntıları > **özelliklerinizi**depolama ' yı seçin. **Önceden ayrılan disk alanını**devre dışı bırakın.
...
2.   > **Disk** **Add Stage** > **düzenleme**için aşama yinelemesi Ekle ' yi seçin.
