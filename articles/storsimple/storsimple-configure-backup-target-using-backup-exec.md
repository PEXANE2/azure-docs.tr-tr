...
- Görev Yöneticisi 'nde varsayılan [Windows Server bakımını](/windows/win32/w8cookbook/automatic-maintenance) devre dışı bırakın. Bunu aşağıdaki yollarla yapın:
  ...
  - Windows Sysinternals 'dan [PsExec](/sysinternals/downloads/psexec) 'yi indirin. PsExec indirdikten sonra Azure PowerShell yönetici olarak çalıştırın ve şunu yazın:
    ```powershell
