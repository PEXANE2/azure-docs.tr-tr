...
Alternatif olarak, SharePoint 'e dahil olan Microsoft `RBS Migrate()` PowerShell cmdlet 'ini de kullanabilirsiniz. Daha fazla bilgi için bkz. [KÇY içine veya dışına Içerik geçirme](https://technet.microsoft.com/library/ff628255.aspx).
