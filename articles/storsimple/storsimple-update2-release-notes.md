...
| 2 |Güncellemeler |Güncelleştirme 1 ' e yükselttikten sonra, klasik Azure portalında birden çok cihazda duyulabilir alarm uyarıları oluştu. Bu sorun düzeltilmiştir. |Evet |Hayır |
| 3 |OpenStack kimlik doğrulaması |Bulut hizmeti sağlayıcınız olarak OpenStack kullanırken, bulut kimlik doğrulama dizeniz çok uzun olduğu bir hata alabilirsiniz. Bu düzeltilmiştir. |Evet |Hayır |
