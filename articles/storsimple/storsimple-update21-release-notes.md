...
| 7 |Windows Yönetim Araçları (WMI) |Yazılımın önceki sürümlerinde, "\<managementexception> sağlayıcısı yükleme hatası" özel durumuyla birkaç Web proxy hatası örneği vardı. Bu hata bir WMI bellek sızıntısı ile sınırlandırıyordu ve şimdi düzeltildi. |Yes |Hayır |
