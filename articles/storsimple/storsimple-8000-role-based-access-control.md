...
description: StorSimple bağlamında Azure rol tabanlı Access Control 'nin (RBAC) nasıl kullanılacağını açıklar.
services: storsimple
documentationcenter: ''
author: alkohli
manager: jconnoc
...
Rol atamasının kapsamı olan kaynak, kaynak grubu veya abonelik içinden erişim verebilirsiniz. Erişim sağlarken, üst düğümde verilen erişimin alt öğe tarafından devralındığını göz önünde bulundurun. Daha fazla bilgi için [rol tabanlı erişim denetimi](../role-based-access-control/overview.md)' ne gidin.
