...
6. **Cihaz ayarları** sayfasında:
   ...
   2. Oluşturmakta olduğunuz cihaz **türü** için **dosya sunucusu** simgesine ![](./media/storsimple-virtual-array-deploy3-fs-setup/image6.png) tıklayın. Bir dosya sunucusu, paylaşılan klasörler oluşturmanıza izin verir.
   3. Cihazınız bir dosya sunucusu olduğundan, cihazı bir etki alanına eklemeniz gerekir. Bir **etki alanı adı**girin.
   4. **Apply (Uygula)** düğmesine tıklayın.
...
8. **Apply (Uygula)** düğmesine tıklayın. Bu işlem cihaz ayarlarını uygular ve doğrular.
...
9. (İsteğe bağlı olarak) Web Proxy sunucunuzu yapılandırın. Web proxy yapılandırması isteğe bağlı olsa da, bir Web proxy 'si kullanıyorsanız, burada yalnızca yapılandırabilirsiniz.
   ...
   **Web proxy** sayfasında:
   ...
   1. **Web proxy URL 'sini** şu biçimde sağlayın: *http://&lt;Host-IP adresi veya FQDN&gt;:P ort numarası*. HTTPS URL 'Lerinin desteklenmediğini unutmayın.
...
1. ![](./media/storsimple-virtual-array-deploy3-fs-setup/image22.png) + R tuşlarına basın. Çalıştır penceresinde, dosya sunucusu *adını* dosya sunucunuza atadığınız cihaz adı ile değiştirerek yol olarak  *&#92; &#92;&gt;&lt;dosya sunucusu adını* belirtin. **Tamam** düğmesine tıklayın.
