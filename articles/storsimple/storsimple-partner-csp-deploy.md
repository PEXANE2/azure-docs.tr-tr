...
2. Sol bölmede **müşteriler**' e tıklayın. Abonelik eklemek istediğiniz müşteriyi bulun veya buraya gidin. Müşterinizin Şirket ![adına ait satırı](./media/storsimple-partner-csp-deploy/expand_pane_icon.png) genişletmek için onay simgesini Genişlet simgesine tıklayın. Ayrıntılar ' da, **Abonelik Ekle**' ye tıklayın.
