...
Eski protokolleri ve şifre paketlerini sağlayan bir komut dosyası oluşturmak için aşağıdaki kodu örnek olarak kullanın.   Bu belgenin amaçları doğrultusunda, bu betiğin adı: TLSsettings. ps1. 
  
```Powershell
...
Aşağıdaki bilgilerle bir CMD dosyası oluşturun. 
...
## <a name="step-4-validation"></a>4\. Adım: doğrulama 
