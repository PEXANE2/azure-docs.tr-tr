...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Azure için Bulut Benimseme Çerçevesi</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Pluralsight tarafından sunulan ücretsiz Azure Kursları</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="visually-hidden">Microsoft Azure Belgeleri</h1>
        <ul class="pivots">
            <li>
                        ...
                        <ul id="get-started1" class="cardsL">
                            <li>
                                <div class="container intro">
                                    <h2 class="likeAnH1">Azure’u kullanmaya başlama</h2>
                                    <p>Hızlı başlangıç bilgileri, örnekler ve öğreticilerle en popüler hizmetlerimizi keşfedin.</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                            ...
                                            <div class="cardText">
                                               ...
                                               <h4>Uygulama Modelleri</h4>
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/azure/containers/">Kapsayıcılar</a></li>
                                                    <li><a class="barLink" href="/azure/aks/">Kubernetes ile mikro hizmetler</a></li>
                                                    <li><a class="barLink" href="/azure/service-fabric/">Service Fabric ile mikro hizmetler</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://docs.microsoft.com/azure/index#pivot=products&panel=all">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Tüm Azure Hizmetlerini görüntüleyin<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li>
                ...
                <ul id="products">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/qnamaker/home">
                                                ...
                                                <p>Soru-Cevap Oluşturma API’si</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/blockchain/service/">
                                                ...
                                                <p>Azure Blok Zinciri Hizmeti</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/blockchain/tokens/">
                                                ...
                                                <p>Azure Blok Zinciri Belirteçleri</p>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/virtual-machines/linux/">
                                                ...
                                                <p>Linux Sanal Makineleri</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/windows/">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>Windows Sanal Makineleri</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/virtual-machine-scale-sets/">
                                                ...
                                                <p>Sanal Makine Ölçek Kümeleri</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/aks/">
                                                <img src="media/index/containerservice.svg" alt="" />
                                                <p>Azure Kubernetes Hizmeti (AKS)</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>Sanal Makinelerde SQL Server</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/vmware-cloudsimple/">
                                                ...
                                                <p>CloudSimple tarafından sunulan Azure VMware Çözümü</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Kapsayıcılar</h3>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/postgresql/">
                                                ...
                                                <p>PostgreSQL için Azure Veritabanı</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/mysql/">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/integrations">
                                                ...
                                                <p>Geliştirici Araçlarının Tümleştirilmesi</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cli">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/active-directory-domain-services">
                                                <img src="media/index/ActiveDirectory.svg" alt="" />
                                                <p>Domain Services için Azure Active Directory</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/iot-dps/">
                                                ...
                                                <p>IoT Hub Cihazı Sağlama Hizmeti</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/media-services/media-services-manage-channels-overview">
                                                ...
                                                <p>Canlı ve İsteğe Bağlı Akış</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/role-based-access-control/">
                                                ...
                                                <p>Rol tabanlı erişim denetimi</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Machine Learning Hizmeti</h3>
                                                    <p>Makine öğrenmesini ve yapay zeka modellerini oluşturun, dağıtın ve yönetin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Bilişsel Arama</h3>
                                                    <p>Tümüyle yönetilen, hizmet olarak arama çözümü</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Açık Veri Kümeleri</h3>
                                                    <p>Makine öğrenmesi modelleri geliştirmeye yönelik seçkin genel veri kümeleri</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Büyük verilerle çalışmayı kolaylaştıran, dağıtılmış analiz hizmeti</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Event Hubs</h3>
                                                    <p>Milyonlarca cihazdan telemetri alın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure HDInsight için Apache Spark</h3>
                                                    <p>Görev açısından kritik dağıtımlar için bulutta Apache Spark</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure HDInsight için Apache Storm</h3>
                                                    <p>Büyük veriler için gerçek zamanlı akış işleme kolaylaştırıldı</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure HDInsight için R Server</h3>
                                                    <p>Büyük veri için tahmine dayalı analiz, makine öğrenimi ve istatistiksel modelleme</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Blob depolama tümleştirmesi temelli, yüksek düzeyde ölçeklenebilir, güvenli Data Lake depolaması</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>NetApp tarafından desteklenen kurumsal sınıf NFS dosya hizmeti</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#blockchain">Blok zinciri</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Blok Zinciri Hizmeti</h3>
                                                    <p>Konsorsiyum blok zinciri ağları oluşturup bunları yönetin ve genişletin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Blok zincirinizi zahmetsiz bir şekilde buluta bağlama</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Blok Zinciri Belirteçleri</h3>
                                                    <p>Kayıt defteri tabanlı belirteçleri kolayca tanımlama, oluşturma ve yönetme</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Linux Sanal Makineleri</h3>
                                                    <p>Ubuntu, Red Hat ve daha fazlası için sanal makineler sağlayın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows Sanal Makineleri</h3>
                                                    <p>SQL Server, SharePoint ve daha fazlası için sanal makineler sağlayın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>İşlevler</h3>
                                                    <p>Sunucusuz kodlama ile olayları işleyin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Kubernetes Hizmeti (AKS)</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Yüksek oranda kullanılabilir, sonsuz ölçeklenebilir bulut uygulamaları ve API'ler oluşturun</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sanal Makinelerde SQL Server</h3>
                                                    <p>Kurumsal SQL Server uygulamalarını bulutta barındırın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure üzerinde SAP HANA Büyük Örnekleri</h3>
                                                    <p>Diğer tüm hiper ölçekli bulut sağlayıcılarına kıyasla en büyük SAP HANA iş yüklerini çalıştırın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CloudSimple tarafından sunulan Azure VMware Çözümü</h3>
                                                    <p>Azure’da VMware platformu çalıştırma</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Red Hat ile birlikte çalıştırılan, tam olarak yönetilen OpenShift hizmeti</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Kapsayıcılar ve mikro hizmetlerle hızlı Kubernetes geliştirme</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#databases">Veritabanları</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Redis için Azure Önbelleği</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>PostgreSQL için Azure Veritabanı</h3>
                                                    <p>Uygulama geliştiricileri için yönetilen PostgreSQL veritabanı hizmeti</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MySQL için Azure Veritabanı</h3>
                                                    <p>Uygulama geliştiricileri için yönetilen MySQL veritabanı hizmeti</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Veritabanı Geçiş Hizmeti</h3>
                                                    <p>Bulut geçişinizin karmaşıklığını azaltın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio</h3>
                                                    <p>Android, iOS, Windows, web ve bulut için tam özellikli bir tümleşik geliştirme ortamı (IDE)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Visual Studio Code masaüstünüzde çalışan ve Windows, macOS ile Linux’ta kullanılabilen hafif ama güçlü bir kaynak kod düzenleyicidir.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SDK’lar</h3>
                                                    <p>Bildiğiniz programlama dilleriyle bulut uygulamaları oluşturun</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Geliştirici Araçlarının Tümleştirilmesi</h3>
                                                    <p>Azure geliştirmenize yardımcı olmaya yönelik üçüncü taraf araçları</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CLI</h3>
                                                    <p>Doğrudan komut satırı araçlarından buluta erişin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Uygulama Yapılandırması</h3>
                                                    <p>Uygulama yapılandırması için hızlı, ölçeklenebilir parametre depolaması</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Web uygulaması ve hizmetlerindeki sorunları algılayın, önceliklendirin ve tanılayın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Sınıf, geliştirme, test ve diğer senaryolar için bulutta laboratuvarlar oluşturun (önceki adıyla DevTest Labs)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Geliştirici Araçlarının Tümleştirilmesi</h3>
                                                    <p>Popüler uzantılarla Azure’ı genişletin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HockeyApp</h3>
                                                    <p>Mobil uygulamalar dağıtın, geri bildirim ve kilitlenme raporları toplayın ve kullanımı izleyin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DevOps Projeleri</h3>
                                                    <p>Herhangi bir platformdaki herhangi bir dili hızlıca Azure’a dağıtma</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Şirket içi dizinleri eşitleyin ve çoklu oturum açmayı etkinleştirin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hassas bilgileri denetlemek için kuruluş ilkeleri oluşturup dağıtın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Domain Services için Active Directory</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>En iyi yöntemlerimiz ve kılavuzlarımızla Azure’da bulut çözümünüzün güvenliğini sağlamayı öğrenin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Service Bus</h3>
                                                    <p>Özel ve genel bulut ortamları genelinde bağlantı sağlayın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Event Grid</h3>
                                                    <p>Çok büyük ölçekte, güvenilir olay teslimi olanağı elde edin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bulutta hızla dijital tarım çözümleri oluşturun.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Finansal hizmetler</h3>
                                                    <p>Finansal Hizmetler sektörü için çözümler ve kullanım örnekleri.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sağlık ve Yaşam Bilimleri</h3>
                                                    <p>Sağlık ve Yaşam Bilimleri sektörü için çözümler ve kullanım örnekleri.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Üretim</h3>
                                                    <p>Üretim sektörü için çözümler ve kullanım örnekleri.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Perakende</h3>
                                                    <p>Perakende sektörü için çözümler ve kullanım örnekleri.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Central</h3>
                                                    <p>IoT çözümlerinin oluşturulmasını hızlandırın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT çözüm hızlandırıcıları</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Alanların ve altyapıların dijital kopyasını oluşturma</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Hub Cihazı Sağlama Hizmeti</h3>
                                                    <p>Azure IoT Hub için kullanıcı müdahalesi gerektirmeyen, tam zamanında sağlama</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Sphere</h3>
                                                    <p>Yüksek oranda güvenli, bağlı MCU destekli cihazlar oluşturma</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Yönetim ve İdare</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Scheduler</h3>
                                                    <p>İşlerinizi basit veya karmaşık yinelenen zamanlamalara göre çalıştırın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Otomasyon</h3>
                                                    <p>Süreç otomasyonu sayesinde bulut yönetimini basitleştirin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure İzleyici</h3>
                                                    <p>Tüm Azure kaynakları için oldukça ayrıntılı ve gerçek zamanlı izleme verileri</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gelişmiş bulut güvenliği aracılığıyla tehdit algılama ve engelleme olanağına sahip olun</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure portal</h3>
                                                    <p>Tüm Azure ürünlerini tek ve birleşik bir konsol üzerinde oluşturun, yönetin ve izleyin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Uygulama kaynaklarınızı yönetme biçiminizi basitleştirin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cloud Shell</h3>
                                                    <p>Tarayıcı tabanlı bir kabukla Azure yönetimini kolaylaştırın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure mobil uygulaması</h3>
                                                    <p>Azure kaynaklarınıza istediğiniz zaman, istediğiniz yerden bağlanın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Yönetilen Uygulamalar</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Geçişi</h3>
                                                    <p>Şirket içi sanal makinelerinizi kolayca keşfedin, değerlendirin, doğru boyuta getirin ve Azure’a geçirin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Video ve sesleri uygun ölçekte kodlayın, depolayın ve akışla sunun</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Encoding</h3>
                                                    <p>Bulut ölçeğinde Studio Sınıfı kodlama</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Canlı ve isteğe bağlı akış</h3>
                                                    <p>İçeriği, işletme ihtiyaçlarını karşılamak için neredeyse her cihaza ölçekle sunun</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tüm oynatma ihtiyaçlarınız için tek bir oynatıcı</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>AES, PlayReady, Widevine ve Fairplay kullanarak içerikleri güvenli bir şekilde teslim edin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Konuşma ve görüntü hizmetlerini kullanarak video dosyalarındaki öngörüleri keşfedin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Video Indexer</h3>
                                                    <p>Multimedya içeriğinizi bulunabilir ve erişebilir duruma getirin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Çok yönlü bir algılama cihazıyla kendi modelinizi oluşturun</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DNS</h3>
                                                    <p>DNS etki alanınızı Azure'da barındırın</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>VPN Gateway</h3>
                                                    <p>Şirketler arası güvenli bağlantı kurun</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Güvenlik Duvarı</h3>
                                                    <p>Yüksek kullanılabilirliğe ve ölçeklenebilirliğe sahip bulut tabanlı ağ güvenlik hizmeti</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Bastion</h3>
                                                    <p>Azure portal aracılığıyla bir genel IP adresi olmadan SSL üzerinden sanal makinelere güvenli ve sorunsuz bir şekilde bağlanma</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ağ altyapısı değişikliklerinin, müşterilerinizin performansını nasıl etkilediğini değerlendirin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Ayrılmış HSM</h3>
                                                    <p>Azure'da şifreleme anahtarı depolama alanını kullanma</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Gelişmiş Tehdit Koruması</h3>
                                                    <p>Kuruluşunuzu buluttaki ve şirket içindeki tehditlere karşı koruyun</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Rol tabanlı erişim denetimi</h3>
                                                    <p>Azure kaynaklarına erişimi yönetme</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Microsoft'un tüm işletmenize bulut ölçeğinde akıllı güvenlik analizi olanakları sunan SIEM çözümünü kullanmayı öğrenin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#other">Bağımsız Bulutlar</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Depolama</h3>
                                                    <p>Dayanıklı, yüksek oranda kullanılabilir ve büyük ölçüde ölçeklenebilir bulut depolaması</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Yönetilen Diskler</h3>
                                                    <p>Azure sanal makineler için kalıcı ve güvenli disk depolama</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Data Box ailesi</h3>
                                                    <p>Çevrimdışı veya ağ tabanlı veri aktarımına olanak sağlayan depolama cihazları ailesi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure HPC Önbelleği</h3>
                                                    <p>Azure’da esnek, dosya tabanlı iş yüklerini çalıştırma</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Avere vFXT</h3>
                                                    <p>Azure’da yüksek performanslı, dosya tabanlı iş yüklerini çalıştırma</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>HPC ortamları için hibrit depolama iyileştirme çözümü</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Depolama Gezgini</h3>
                                                    <p>Depolamayı Windows, macOS ve Linux’tan dilediğiniz yerde kolayca yönetin</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Arşiv Depolama</h3>
                                                    <p>Nadiren erişilen veriler için düşük maliyetli, güvenli bulut depolama</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure NetApp Files</h3>
                                                    <p>NetApp tarafından desteklenen kurumsal sınıf ağ dosya hizmetleri</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gerçek zamanlı web işlevlerini kolayca ekleme</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure portal</h3>
                                                <p>
                                                    <a href="/azure/azure-portal/">Kullanmaya başlayın</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure mobil uygulaması</h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">Kullanmaya başlayın</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure Resource Manager </h3>
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/resources/templates/">Örnek şablonlar</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/templates/">Başvuru</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure Dev Spaces </h3>
                                                ...
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-netcore-visualstudio">.NET Core ve Visual Studio için indirme</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-nodejs">Node.js için indirme</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
