...
description: Bir Windows sanal makine ölçek kümesindeki sanal makine örneklerini ve bağlı diskleri şifrelemek için Azure CLı 'yi nasıl kullanacağınızı öğrenin
author: ju-shim
ms.author: jushiman
ms.topic: tutorial
