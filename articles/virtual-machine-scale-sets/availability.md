---
title: Azure sanal makine ölçek kümeleri için kullanılabilirlik seçenekleri | Microsoft Docs
description: Azure 'da Windows sanal makine ölçek kümeleri çalıştırmaya yönelik kullanılabilirlik özellikleri hakkında bilgi edinin
