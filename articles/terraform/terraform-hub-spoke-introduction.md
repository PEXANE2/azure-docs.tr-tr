...
- **Terrayform 'U yükleyip yapılandırma**: Azure 'Da VM 'leri ve diğer altyapıyı sağlamak Için [terrayform 'u yükleyip yapılandırın](terraform-install-configure.md)
