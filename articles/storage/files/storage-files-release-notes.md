...
ms.locfileid: "72176720"
---
# <a name="release-notes-for-the-azure-file-sync-agent"></a>Azure Dosya Eşitleme Aracısı için sürüm notları
Azure Dosya Eşitleme, şirket içi bir dosya sunucusunun esnekliğini, performansını ve uyumluluğunu vermeden kuruluşunuzun dosya paylaşımlarını Azure dosyalarında merkezileştirmenizi sağlar. Windows Server yüklemelerinizi Azure dosya paylaşımınızın hızlı bir önbelleğine dönüştürürsünüz. Verilerinize yerel olarak erişmek için Windows Server 'da bulunan herhangi bir protokolü kullanabilirsiniz (SMB, NFS ve FTPS dahil). Dünyanın dört bir yanında ihtiyacınız olan sayıda önbellekler olabilir.

Bu makalede, Azure Dosya Eşitleme aracısının desteklenen sürümleri için sürüm notları sağlanmaktadır.

## <a name="supported-versions"></a>Desteklenen sürümler
Azure Dosya Eşitleme Aracısı için aşağıdaki sürümler desteklenir:

| Ina | Aracı sürüm numarası | Sürüm tarihi | Durum |
|----|----------------------|--------------|------------------|
| V8 Release- [KB4511224](https://support.microsoft.com/help/4511224)| 8.0.0.0 | 8 Ekim 2019 | Desteklenir |
| Temmuz 2019 güncelleştirme paketi- [KB4490497](https://support.microsoft.com/help/4490497)| 7.2.0.0 | 24 Temmuz 2019 | Desteklenir |
| Temmuz 2019 güncelleştirme paketi- [KB4490496](https://support.microsoft.com/help/4490496)| 7.1.0.0 | 12 Temmuz 2019 | Desteklenir |
| V7 Release- [KB4490495](https://support.microsoft.com/help/4490495)| 7.0.0.0 | 19 Haziran 2019 | Desteklenir |
| Haziran 2019 güncelleştirme paketi- [KB4489739](https://support.microsoft.com/help/4489739)| 6.3.0.0 | 27 Haziran 2019 | Desteklenir |
| Haziran 2019 güncelleştirme paketi- [KB4489738](https://support.microsoft.com/help/4489738)| 6.2.0.0 | 13 Haziran 2019 | Desteklenir |
| 2019 Mayıs güncelleştirme paketi- [KB4489737](https://support.microsoft.com/help/4489737)| 6.1.0.0 | 7 Mayıs 2019 | Desteklenir |
| V6 yayını- [KB4489736](https://support.microsoft.com/help/4489736)| 6.0.0.0 | 21 Nisan 2019 | Desteklenir |
| Nisan 2019 güncelleştirme paketi- [KB4481061](https://support.microsoft.com/help/4481061)| 5.2.0.0 | 4 Nisan 2019 | Desteklenir |
| Mart 2019 güncelleştirme paketi- [KB4481060](https://support.microsoft.com/help/4481060)| 5.1.0.0 | 7 Mart 2019 | Desteklenir |
| V5 sürümü- [KB4459989](https://support.microsoft.com/help/4459989)| 5.0.2.0 | 12 Şubat 2019 | Desteklenir |
| Ocak 2019 güncelleştirme paketi- [KB4481059](https://support.microsoft.com/help/4481059)| 4.3.0.0 | 14 Ocak 2019 | Desteklenen-Aracı sürümünün 5 Kasım 2019 tarihinde dolacağı |
| Aralık 2018 güncelleştirme paketi- [KB4459990](https://support.microsoft.com/help/4459990)| 4.2.0.0 | 10 Aralık 2018 | Desteklenen-Aracı sürümünün 5 Kasım 2019 tarihinde dolacağı |
| Aralık 2018 güncelleştirme paketi | 4.1.0.0 | 4 Aralık 2018 | Desteklenen-Aracı sürümünün 5 Kasım 2019 tarihinde dolacağı |
| V4 sürümü | 4.0.1.0 | 13 Kasım 2018 | Desteklenen-Aracı sürümünün 5 Kasım 2019 tarihinde dolacağı |
| V3 sürümü | 3.1.0.0 - 3.4.0.0 | Desteklenmez | Desteklenmiyor-Aracı sürümleri 19 Ağustos 2019 tarihinde zaman aşımına uğradı |
...
### <a name="agent-installation-and-server-configuration"></a>Aracı yüklemesi ve sunucu yapılandırması
...
- Koruma, yedekleme ve katmanlı dosyalara erişen diğer uygulamalar, çevrimdışı özniteliğe uymadıkları ve bu dosyaların içeriğini okumayı atlamadıkça istenmeyen geri çekenlere neden olabilir. Daha fazla bilgi için bkz. [sorun giderme Azure dosya eşitleme](storage-sync-files-troubleshoot.md).
...
- 2\.048 karakterden uzun olan yollar.
- 2 KB 'tan büyükse güvenlik tanımlayıcısının isteğe bağlı erişim denetimi listesi (DACL) bölümü. (Bu sorun yalnızca tek bir öğe üzerinde 40 ' den fazla erişim denetimi girişi (ACE) olduğunda geçerlidir.)
- Denetim için kullanılan bir güvenlik tanımlayıcısının sistem erişim denetimi listesi (SACL) bölümü.
- Genişletilmiş öznitelikler.
- Alternatif veri akışları.
- Yeniden ayrıştırma noktaları.
- Sabit bağlantılar.
- Sıkıştırma (sunucu dosyası üzerinde ayarlandıysa), diğer uç noktalardan bu dosyaya yapılan değişiklikler korunmazsa korunmaz.
- Hizmetin verileri okumasını engelleyen EFS (veya başka bir Kullanıcı modu şifrelemesi) ile şifrelenen herhangi bir dosya.

    > [!Note]  
    > Azure Dosya Eşitleme her zaman iletimde verileri şifreler. Veriler her zaman Azure 'da Rest 'de şifrelenir.
 
### <a name="server-endpoint"></a>Sunucu uç noktası
- Sunucu uç noktası, yalnızca bir NTFS biriminde oluşturulabilir. ReFS, FAT, FAT32 ve diğer dosya sistemleri şu anda Azure Dosya Eşitleme tarafından desteklenmemektedir.
...
- Yük Devretme Kümelemesi yalnızca kümelenmiş disklerle desteklenir, ancak küme paylaşılan birimleri (CSV) ile desteklenmez.
- Sunucu uç noktası iç içe olamaz. Bu, başka bir uç nokta ile paralel olarak aynı birimde bir arada bulunabilir.
...
- Katmanlı bir dosya Robocopy kullanılarak başka bir konuma kopyalanırsa, sonuçta elde edilen dosya katmanlı değildir. Robocopy bu özniteliği kopyalama işlemlerinde yanlış bir biçimde içerdiğinden, çevrimdışı özniteliği ayarlanmış olabilir.
...
- Katmanlı bir dosya Robocopy kullanılarak başka bir konuma kopyalanırsa, sonuçta elde edilen dosya katmanlı değildir. Robocopy bu özniteliği kopyalama işlemlerinde yanlış bir biçimde içerdiğinden, çevrimdışı özniteliği ayarlanmış olabilir.
- Robocopy kullanarak dosyaları kopyalarken dosya zaman damgalarını korumak için/MıR seçeneğini kullanın. Bu, eski dosyaların son erişilen dosyalardan daha önce katmanlı olmasını sağlayacaktır.
- Dosya özelliklerini bir SMB istemcisinden görüntülerken, dosya meta verilerinin SMB önbelleklemesi nedeniyle çevrimdışı özniteliği hatalı ayarlanmış gibi görünebilir.
...
- Azure Kamu Bulutu desteği
  - Azure Kamu Bulutu için Önizleme desteği ekledik. Bu, beyaz listelenmiş bir abonelik ve Microsoft 'tan özel bir aracı indirmesi gerektirir. Önizlemeye erişim sağlamak için lütfen [AzureFiles@microsoft.com](mailto:AzureFiles@microsoft.com)' de doğrudan bize e-posta gönderin.
