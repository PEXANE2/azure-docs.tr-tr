...
Paylaşım düzeyi izinlerini güncelleştirmek için bir [kimliğe erişim izinleri atay'ı](https://docs.microsoft.com/azure/storage/files/storage-files-identity-auth-active-directory-domain-service-enable#assign-access-permissions-to-an-identity)'na bakın.
