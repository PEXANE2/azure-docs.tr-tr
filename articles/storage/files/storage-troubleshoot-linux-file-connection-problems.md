...
description: Linux 'ta Azure dosyaları sorunlarını giderme. Linux istemcilerinden bağlandığınızda Azure dosyaları ile ilgili yaygın sorunları inceleyin ve olası çözümlere bakın.
author: jeffpatt24
ms.service: storage
...
Sorunu gidermek için, [Linux 'Ta Azure dosyaları bağlama hataları için sorun giderme aracını](https://github.com/Azure-Samples/azure-files-samples/tree/master/AzFileDiagnostics/Linux)kullanın. Bu araç:
