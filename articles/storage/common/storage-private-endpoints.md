...
Bir sanal ağ üzerindeki istemciler, özel bir uç nokta kullanılırken bile depolama hesabı için aynı bağlantı dizesini kullanabilir.
...
> [!TIP]
> Özel veya şirket içi bir DNS sunucusu kullanıyorsanız, Özel uç noktalar için DNS kaynak kayıtlarını yapılandırmak üzere depolama hizmetinin ' Privatelink ' alt etki alanını kullanmanız gerekir.
...
Önizleme sırasında, hizmet uç noktaları olan bir alt ağda özel bir uç nokta oluşturamazsınız. Hizmet uç noktaları ve özel uç noktalar için aynı VNet 'te ayrı alt ağlar oluşturabilirsiniz.
