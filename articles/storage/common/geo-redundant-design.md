---
title: Yüksek oranda kullanılabilir uygulamalar tasarlamak için coğrafi artıklığı kullanın
titleSuffix: Azure Storage
description: Kayıpları işleyecek kadar esnek olan yüksek oranda kullanılabilir bir uygulama tasarlamak için coğrafi olarak yedekli depolamayı nasıl kullanacağınızı öğrenin.
services: storage
author: tamram
ms.service: storage
ms.topic: conceptual
