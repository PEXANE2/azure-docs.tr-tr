...
Azure Key Vault kullanarak ilişkili maliyetler vardır. Daha fazla bilgi için bkz. [Key Vault fiyatlandırması](https://azure.microsoft.com/pricing/details/key-vault/).
