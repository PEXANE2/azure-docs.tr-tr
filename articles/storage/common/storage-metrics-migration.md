...
> [!NOTE]
> Klasik ölçümler olarak kullanılamayan çeşitli yeni kapasite ölçümleri de mevcuttur. Listenin tamamını görüntülemek için bkz. [ölçümler](../blobs/monitor-blob-storage-reference.md#metrics).
