...
| Azure Izleyici 'de uyarıları ayarlama | Günlük uyarıları, kullanıcıların kaynak günlüklerini her ayarlama sıklığını değerlendirmek için Log Analytics bir sorgu kullanmasına izin verir ve sonuçlara göre bir uyarı tetiklersiniz, bkz. [Azure izleyici 'de günlük uyarıları](../../azure-monitor/platform/alerts-unified-log.md). | - |
