...
| Yanlışlıkla silinmeye engel olmak için depolama hesabını kilitle | Yönetici olarak, kuruluşunuzdaki diğer kullanıcıların yanlışlıkla önemli kaynakları silmesini veya değiştirmesini engellemek için bir abonelik, kaynak grubu veya kaynağı kilitlemeniz gerekebilir. [beklenmeyen değişiklikleri engellemek için kaynakları kilitleme](/azure/azure-resource-manager/management/lock-resources)bölümüne bakın.
...
| Ağ yönlendirme tercihini yapılandırma | Ağ trafiğinin, Microsoft küresel ağ veya Internet yönlendirmesi kullanılarak Internet üzerinden kendi hesabınıza nasıl yönlendirildiğini belirtmek için, Azure depolama hesabınız için ağ yönlendirme tercihini yapılandırabilirsiniz. bkz. [Azure Storage için ağ yönlendirme tercihini yapılandırma](../common/network-routing-preference.md). | - |
...
| Azure Izleyici 'de uyarıları ayarlama | Günlük uyarıları, kullanıcıların kaynak günlüklerini her ayarlama sıklığını değerlendirmek için Log Analytics bir sorgu kullanmasına izin verir ve sonuçlara göre bir uyarı tetiklersiniz, bkz. [Azure izleyici 'de günlük uyarıları](/azure/azure-monitor/platform/alerts-unified-log). | - |
