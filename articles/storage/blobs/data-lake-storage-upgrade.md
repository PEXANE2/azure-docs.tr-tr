...
### <a name="platform-capabilities"></a>Platform capabilities
...
| eklentisi  | REST API over HTTPS | REST API over HTTP/HTTPS| *Available now* |
...
| Bölgesel kullanılabilirlik | See [here](https://azure.microsoft.com/regions/) | All [Azure regions](https://azure.microsoft.com/global-infrastructure/regions/)                                                                                                                                                                                                                                                                                                                                       | *Available now*                                                                                                                           |
| Fiyat                                       | See [Pricing](https://azure.microsoft.com/pricing/details/data-lake-store/)                                                                            | See [Pricing](https://azure.microsoft.com/pricing/details/storage/data-lake/)                                                                                                                                                                                                                                                                                                                                         |                                                                                                                                           |
| Kullanılabilirlik Hizmet Düzeyi Anlaşması                            | [See SLA](https://azure.microsoft.com/support/legal/sla/data-lake-store/v1_0/)                                                                   | [See SLA](https://azure.microsoft.com/support/legal/sla/storage/v1_3/)                                                                                                                                                                                                                                                                                                                                                | *Available now*                                                                                                                           |
| Veri Yönetimi                             | File Expiration                                                                                                                                        | Lifecycle policies                                                                                                                                                                                                                                                                                                                                                                                                          | Lifecycle policies *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md).                                                                                                                     |

### <a name="programming-interfaces"></a>Programming interfaces
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| .NET SDK                  | [Bağlantı](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *Available now* | *Available now* |
| Java SDK                | [Bağlantı](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Available now*                                                      | *Available now*                                     |
...
| REST API                 | [Bağlantı](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Available now*                                                      | *Available now*                                                                                                                                               |
| PowerShell | [Bağlantı](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | *Available now* |
| CLI                 | [Bağlantı](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Available now*                                                      | *Available now*                                                               |
...
| **Alan**             | **Availability for Data Lake Storage Gen1**                                                                                                                                    | **Availability for Data Lake Storage Gen2 – with Shared Key auth**                                                                                                           | **Availability for Data Lake Storage Gen2 – with OAuth**                                                                                        |
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
|                      | [SQL Veri Ambarı](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-load-from-azure-data-lake-store)                                            | *Desteklenmiyor*                                                                                                                                                              | *Available now* [Link](https://docs.microsoft.com/sql/t-sql/statements/create-external-data-source-transact-sql?view=sql-server-2017) |
...
|                      | [Veri Kataloğu](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-with-data-catalog)                                                                       | *Not yet available*                                                                                                                                                          | *Not yet available*                                                                                                                             |
...
|                      | [Akış Analizi](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-stream-analytics)                                                                   | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
| Tüketim          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
...
| Verimlilik         | [Azure portalda](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-get-started-portal)                                                                      | *Desteklenmiyor*                                                                                                                                                              | Account management *– Available now* <br><br>Data operations *–*  *Not yet available*                                                                   |
...
|                      | [Azure Depolama Gezgini](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-in-storage-explorer)                                                          | *Available now*                                                                                                                                                              | *Available now*                                                                                                                                 |
...
| Alan            | İş ortağı  | Product/Service  | Availability for Data Lake Storage Gen1                                                                                                                                               | Availability for Data Lake Storage Gen2 – with Shared Key auth                                                   | Availability for Data Lake Storage Gen2 – with Oauth                                                             |
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| Analytics framework | Cloudera     | CDH                  | [Bağlantı](https://www.cloudera.com/documentation/enterprise/5-11-x/topics/admin_adls_config.html)                                                                                            | *Not yet available*                                                                                                  | [Bağlantı](https://www.cloudera.com/documentation/enterprise/latest/topics/admin_adls2_config.html)                                                                                                  |
|                     | Cloudera     | Altus                | [Bağlantı](https://www.cloudera.com/more/news-and-blogs/press-releases/2017-09-27-cloudera-introduces-altus-data-engineering-microsoft-azure-hybrid-multi-cloud-data-analytic-workflows.html) | *Desteklenmiyor*                                                                                                                  | *Not yet available*                                                                                                  |
...
|                     | Qubole       |                      | [Bağlantı](https://www.qubole.com/blog/big-data-analytics-microsoft-azure-data-lake-store-qubole/)                                                                                            | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
| ETL                 | StreamSets   |                      | [Bağlantı](https://streamsets.com/blog/ingest-data-azure)                                                                                                                                     | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | Informatica  |                      | [Bağlantı](https://kb.informatica.com/proddocs/Product%20Documentation/6/IC_Spring2017_MicrosoftAzureDataLakeStoreV2ConnectorGuide_en.pdf)                                                    | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | Attunity     |                      | [Bağlantı](https://www.attunity.com/company/press-releases/microsoft-and-attunity-announce-strategic-partnership-for-data-migration/)                                                         | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | Alteryx      |                      | [Bağlantı](https://help.alteryx.com/2018.2/DataSources/AzureDataLake.htm)                                                                                                                     | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | ImanisData   |                      | [Bağlantı](https://www.imanisdata.com/expansion-azure-support-azure-data-lake-store-integration/)                                                                                             | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
...
| Etkinlik günlükleri                                                                                          | [Bağlantı](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#audit-logs)   | One-off requests for logs for specific duration using support ticket – *Available now* Azure Monitoring integration - *Not yet available* |
| Tanılama günlükleri                                                                                        | [Bağlantı](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md). <br>Azure Monitoring integration - *Not yet available* |
| Ölçümler                                                                                                | *Desteklenmiyor*                                                                                               | *Available now -* [Link](https://docs.microsoft.com/azure/storage/common/storage-metrics-in-azure-monitor)                          |
...
| Strateji                   | Pros                                                                                  | Simgeler                                                           | When to use?                                                                                                                                                                                             |
|--------------------------------|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Strateji                       | Araçlar                                                                                                             | Pros                                                                                                                             | Dikkat edilmesi gerekenler                                                                                                                                                                                                                                                                                                                |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
