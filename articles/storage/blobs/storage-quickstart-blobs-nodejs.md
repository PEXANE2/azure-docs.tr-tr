...
Konsol isteminde *blob-quickstart-v12.js* dosyasını içeren dizine gidin, ardından `node` uygulamayı çalıştırmak için aşağıdaki komutu yürütün.
