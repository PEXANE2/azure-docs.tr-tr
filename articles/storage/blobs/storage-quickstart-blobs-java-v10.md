---
title: "Hızlı Başlangıç: Blob oluşturmak için Java Storage SDK 'sını kullanma"
...
> [API Başvurusu](https://docs.microsoft.com/java/api/overview/azure/storage)
