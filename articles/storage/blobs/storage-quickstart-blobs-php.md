...
Bu hızlı başlangıçta karşıya yüklenen bloblara artık ihtiyacınız kalmadığında, **deleteContainer()** yöntemini kullanarak kapsayıcının tamamını silebilirsiniz. Oluşturulan dosyalara artık ihtiyaç duyulmuyorsa, dosyaları silmek için **DeleteBlob ()** yöntemini kullanırsınız.
