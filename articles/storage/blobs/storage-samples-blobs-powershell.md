...
| [Windows üzerinde AzCopy kullanarak Blobları depolama hesapları arasında geçirme](/previous-versions/azure/storage/storage-common-transfer-between-storage-accounts?toc=%2fpowershell%2fmodule%2ftoc.json)| Windows üzerinde AzCopy kullanarak blobları Azure Depolama hesapları arasında geçirir. |
|**Blob depolama**||
