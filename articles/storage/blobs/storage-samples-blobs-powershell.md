...
description: Depolama hesabı oluşturma, blob 'ları hesaplar arasında geçirme ve daha fazlası gibi Azure Blob depolamayla çalışma için Azure PowerShell komut dosyası örneklerinin bağlantılarını inceleyin.
...
| [Windows üzerinde AzCopy kullanarak Blobları depolama hesapları arasında geçirme](/previous-versions/azure/storage/storage-common-transfer-between-storage-accounts?toc=%252fpowershell%252fmodule%252ftoc.json)| Windows üzerinde AzCopy kullanarak blobları Azure Depolama hesapları arasında geçirir. |
|**Blob depolama**||
