...
[Azure depolama ölçümleri](./monitor-blob-storage.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json), depolama hesabınızın performansına ve kullanılabilirliğine ilişkin birleşik bir görünüm sağlamak için Azure izleyiciyi kullanır.
