...
Azure Tablo depolama, [Azure kaynaklarından gelen verileri izleme](../../azure-monitor/insights/monitor-azure-resource.md#monitoring-data)bölümünde açıklanan diğer Azure kaynaklarıyla aynı türde izleme verilerini toplar. 
...
Kaynak günlüklerini Azure depolama 'ya arşivleme hakkında daha fazla bilgi için bkz. [Azure Kaynak günlükleri](../../azure-monitor/platform/resource-logs.md#send-to-azure-storage).
...
Kaynak günlüklerini Olay Hub 'larına gönderme hakkında daha fazla bilgi için bkz. [Azure Kaynak günlükleri](../../azure-monitor/platform/resource-logs.md#send-to-azure-event-hubs).
...
Azure Tablo depolama da dahil olmak üzere tüm Azure Izleyici destek ölçümlerinin bir listesi için bkz. [Azure izleyici desteklenen ölçümler](../../azure-monitor/platform/metrics-supported.md).
...
Güvenlik bilgileri ve olay yönetimi ve izleme araçlarını kullanarak, Olay Hub 'ınıza gönderilen günlük verilerine erişebilir ve bu verileri okuyabilirsiniz. Daha fazla bilgi için bkz. [Azure Kaynak günlükleri](../../azure-monitor/platform/resource-logs.md#send-to-azure-event-hubs).
...
Daha fazla bilgi için bkz. [Azure izleme verilerini Olay Hub 'ına ve dış iş ortaklarına akış](../../azure-monitor/platform/stream-monitoring-data-event-hubs.md).

Veriler **Storagetablelogs** tablosunda depolanır. 

#### <a name="sample-kusto-queries"></a>Örnek kusto sorguları

Tablo Depolamayı izlemenize yardımcı olması için **günlük araması** çubuğuna girebileceğiniz bazı sorgular aşağıda verilmiştir. Bu sorgular [Yeni dille](../../azure-monitor/log-query/log-query-overview.md)çalışır.
