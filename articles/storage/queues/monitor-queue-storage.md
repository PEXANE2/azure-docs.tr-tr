...
Komutunu kullanarak günlükleri etkinleştirin [`az monitor diagnostic-settings create`](/cli/azure/monitor/diagnostic-settings#az_monitor_diagnostic_settings_create) .
...
Depolama hesabınızın veya kuyruk depolama hizmetinin ölçüm tanımını listeleyebilirsiniz. Komutunu kullanın [`az monitor metrics list-definitions`](/cli/azure/monitor/metrics#az_monitor_metrics_list_definitions) .
...
Depolama hesabınızın veya kuyruk depolama hizmetinin ölçüm değerlerini okuyabilirsiniz. Komutunu kullanın [`az monitor metrics list`](/cli/azure/monitor/metrics#az_monitor_metrics_list) .
