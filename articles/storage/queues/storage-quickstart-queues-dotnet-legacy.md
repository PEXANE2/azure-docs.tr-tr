...
### <a name="add-a-message"></a>Bir ileti ekleme
...
Süre sonu olmayan bir ileti eklemek için [Addmessageasync](/dotnet/api/microsoft.azure.storage.queue.cloudqueue.addmessageasync)çağrısında `Timespan.FromSeconds(-1)` kullanın.
