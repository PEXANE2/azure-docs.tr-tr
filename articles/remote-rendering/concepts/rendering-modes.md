...
* [C# ConnectToRuntimeParams yapısı](/dotnet/api/microsoft.azure.remoterendering.connecttoruntimeparams)
* [C++ AzureSession:: ConnectToRuntime ()](/cpp/api/remote-rendering/azuresession#connecttoruntime)
* [C++ ConnectToRuntimeParams yapısı](/cpp/api/remote-rendering/connecttoruntimeparams)
