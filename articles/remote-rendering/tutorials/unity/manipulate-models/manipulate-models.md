...
1. **Remoteraycaster** adlı yeni bir betik oluşturun ve içeriğini şu kodla değiştirin:
    ...
    > [!NOTE]
    > Unity, [**raycasthit**](https://docs.unity3d.com/ScriptReference/RaycastHit.html)adlı bir sınıfa sahiptir ve Azure uzaktan Işleme, [**Raycasthit**](/dotnet/api/microsoft.azure.remoterendering.raycasthit)adlı bir sınıfa sahiptir. Büyük harf **C** derleme hatalarını önlemek için önemli bir farktır.
