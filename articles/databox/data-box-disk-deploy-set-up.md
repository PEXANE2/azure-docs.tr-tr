...
description: Bu öğreticide Azure Data Box Disk'i paketinden çıkarmayı, disklere bağlamayı, destek anahtarını almayı ve Windows veya Linux istemcilerinde disklerin kilidini açmayı öğreneceksiniz.
services: databox
author: alkohli
ms.service: databox
ms.subservice: disk
...
2. Azure portalında Data Box Disk Siparişinize gidin. **Genel > Tüm kaynaklar** adımlarını izleyerek arama yapıp Data Box Disk Siparişinizi seçin. Destek anahtarını kopyalamak için kopyala simgesini kullanın. Disklerin kilidini açmak için bu destek anahtarı kullanılacaktır.
...
1. Azure portalında Data Box Disk Siparişinize gidin. **Genel > Tüm kaynaklar** adımlarını izleyerek arama yapıp Data Box Disk Siparişinizi seçin.
...
8. Diskin kilidi açıldıktan sonra, bağlama noktasına gidip diskin içeriklerini görüntüleyebilirsiniz. Şimdi *BlockBlob* veya *PageBlob* klasörlerine veri kopyalamaya hazırsınız demektir. 
    ...
    ![Data Box Disk içeriği 2](media/data-box-disk-deploy-set-up/data-box-disk-content-linux.png)
