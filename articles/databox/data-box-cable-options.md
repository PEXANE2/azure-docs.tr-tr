...
description: Yönetim bağlantı noktası veya VERI bağlantı noktası kullanarak Azure Data Box veri aktarımı için kablonun farklı yolları hakkında bilgi edinin.
services: databox
author: alkohli
ms.service: databox
ms.subservice: pod
