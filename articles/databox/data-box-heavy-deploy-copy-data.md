...
description: Bu öğreticide, yerel web kullanıcı arabirimiyle SMB'yi kullanarak konak bilgisayarınızdan Azure Data Box Heavy'ye bağlanmayı ve veri kopyalamayı öğreneceksiniz.
services: databox
author: alkohli
ms.service: databox
ms.subservice: heavy
