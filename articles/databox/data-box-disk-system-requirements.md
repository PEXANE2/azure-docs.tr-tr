...
1. [Öğreticiyi kullanarak Data Box disk sipariş etmeniz gerekir: Azure Data Box Disk](data-box-disk-deploy-ordered.md)sıralayın. Disklerinizi ve disk başına bir bağlantı kablosunu aldınız.
