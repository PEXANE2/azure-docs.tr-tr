...
description: Bu öğreticide Azure Data Box Heavy'nizin kablolarını takmayı, Azure Data Box Heavy'ye bağlanmayı ve Azure Data Box Heavy'yi açmayı öğreneceksiniz.
services: databox
author: alkohli
ms.service: databox
ms.subservice: heavy
