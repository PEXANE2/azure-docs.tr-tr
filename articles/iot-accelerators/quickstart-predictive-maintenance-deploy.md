---
title: Bulut tabanlı IoT tahmine dayalı bakım çözümünü deneyin-Azure | Microsoft Docs
...
Dağıtımı başlatmak için **Oluştur** ' a tıklayın. Bu işlemin çalışması en az beş dakika sürer:
