...
4. Formu bir konu ve etki alanı adlarıyla girin. Özel anahtar için parola ile ped veya PFX ' i seçin. Sertifika isteği oluşturmak için **Yeni bir anahtar çifti oluştur** ' u seçin.
   ...
   ![Sertifika Isteği ayrıntılarını görüntüle ekranını ve yeni bir anahtar çifti Oluştur düğmesini gösteren ekran görüntüsü.](media/howto-opc-vault-secure/approve-reject.png "Sertifikayı onayla")
