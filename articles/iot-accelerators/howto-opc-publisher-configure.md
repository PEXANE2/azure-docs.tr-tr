...
Yöntem isteği ve yanıtlarının JSON yükünün biçimi [opcpublisher/HubMethodModel. cs](https://github.com/Azure/iot-edge-opc-publisher/tree/master/opcpublisher)içinde tanımlanır.
