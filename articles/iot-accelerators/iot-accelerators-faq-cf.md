...
[www.azureiotsolutions.com](www.azureiotsolutions.com) çözümden dağıttıysanız, sanal Makineye oturum açamazsınız. ' De, parolayı rastgele oluşturulan ve size sıfırlayamazsınız olduğundan oturum açamazsınız.
