---
title: Öğretici-IoT Tak ve Kullan örnek cihaz kodunu Azure IoT Hub bağlama | Microsoft Docs
description: Öğretici-birden çok bileşen kullanan ve bir IoT Hub 'ına bağlanan IoT Tak ve Kullan örnek cihaz kodu (C, C#, Java, JavaScript veya Python) oluşturun ve çalıştırın. Cihaz tarafından hub 'a gönderilen bilgileri görüntülemek için Azure IoT gezgin aracını kullanın.
author: ericmitt
ms.author: ericmitt
ms.date: 07/22/2020
ms.topic: tutorial
...
ms.locfileid: "106061018"
---
# <a name="tutorial-connect-an-iot-plug-and-play-multiple-component-device-applications-running-on-linux-or-windows-to-iot-hub"></a>Öğretici: Linux veya Windows üzerinde çalışan bir IoT Tak ve Kullan birden çok bileşen cihaz uygulamasını IoT Hub 'a bağlama
