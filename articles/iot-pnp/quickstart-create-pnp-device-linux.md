...
You also need an Azure IoT hub in your Azure subscription to complete this quickstart. Azure aboneliğiniz yoksa başlamadan önce [ücretsiz bir hesap](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) oluşturun. If you don't already have an IoT hub to use, follow the rest of this section to create one.
...
Bir kabuk açın. Execute the following command to install Vcpkg:
