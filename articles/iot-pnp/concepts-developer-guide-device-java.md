---
title: Cihaz Geliştirici Kılavuzu (Java)-IoT Tak ve Kullan | Microsoft Docs
description: Java cihaz geliştiricileri için IoT Tak ve Kullan açıklaması
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91580547"
---
# <a name="iot-plug-and-play-device-developer-guide-java"></a>IoT Tak ve Kullan cihaz Geliştirici Kılavuzu (Java)
