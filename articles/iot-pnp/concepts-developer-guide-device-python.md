---
title: Cihaz Geliştirici Kılavuzu (Python)-IoT Tak ve Kullan | Microsoft Docs
description: Python cihaz geliştiricileri için IoT Tak ve Kullan açıklaması
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91580733"
---
# <a name="iot-plug-and-play-device-developer-guide-python"></a>IoT Tak ve Kullan cihaz Geliştirici Kılavuzu (Python)
