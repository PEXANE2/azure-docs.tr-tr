...
description: IoT Hub 'ına bağlanan IoT Tak ve Kullan önizlemesi örnek cihaz kodunu derleyin ve çalıştırın. Cihaz tarafından hub 'a gönderilen bilgileri görüntülemek için Azure IoT gezgin aracını kullanın.
author: ChrisGMsft
ms.author: chrisgre
ms.date: 08/02/2019
ms.topic: quickstart
...
ms.locfileid: "69878246"
---
# <a name="quickstart-connect-a-sample-iot-plug-and-play-preview-device-application-to-iot-hub"></a>Hızlı Başlangıç: Örnek IoT Tak ve Kullan önizleme cihaz uygulamasını IoT Hub 'ye bağlama
