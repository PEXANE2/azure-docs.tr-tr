...
Key Vault başlangıçta [Azure Key Vault hizmet limitlerinde](service-limits.md)belirtilen limitler ile oluşturuldu.  Anahtar Kasanızı koyma oranları yla en üst düzeye çıkarmak için, iş lerinizi en üst düzeye çıkarmak için önerilen bazı kılavuz ilkeler/en iyi uygulamalar aşağıda verilmiştir:
...
1. Bir hizmetin kimlik bilgilerini depolamak için Key Vault kullanıyorsanız, bu hizmetin doğrudan kimlik doğrulaması için Azure AD Kimlik Doğrulaması'nı destekleyip desteklemediğini denetleyin. Bu, Key Vault üzerindeki yükü azaltır, güvenilirliği artırır ve Key Vault artık Azure AD belirteci'ni kullanabileceğinden kodunuzu basitleştirir.  Birçok hizmet Azure AD Auth'u kullanmaya geçti.  [Azure kaynakları için yönetilen kimlikleri destekleyen Hizmetler'deki](../../active-directory/managed-identities-azure-resources/services-support-managed-identities.md#azure-services-that-support-managed-identities-for-azure-resources)geçerli listeye bakın.
