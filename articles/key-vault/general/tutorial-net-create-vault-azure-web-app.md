...
Yourkeyvaultname> değerini anahtar kasanızın adıyla değiştirin \<ve principalıd> \<öğesini aşağıdaki komutta **PrincipalId** değeri ile değiştirin:
