...
Metodu çağırmadan önce belirtecin sona erme süresini denetlemeniz gerekmez `GetAccessTokenAsync` , çünkü `AzureServiceTokenProvider` belirteci bellekte önbelleğe alır ve bunu yalnızca süresi dolmadan önce Azure AD 'den alırsınız. 
