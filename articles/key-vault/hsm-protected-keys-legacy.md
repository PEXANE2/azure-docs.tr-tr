...
ms.locfileid: "77429312"
---
# <a name="import-hsm-protected-keys-for-key-vault-legacy"></a>Key Vault için HSM korumalı anahtarları içeri aktarma (eski)
...
* [5. Adım: anahtarınızı Azure Key Vault aktarma](#step-5-transfer-your-key-to-azure-key-vault)
...
* C++ **Vcredist_x64. exe** adlı bir görsel yeniden dağıtılabilir paket.
...
NCipher araçlarının yolunuzda ( **% nfast_home% \ bin**) olduğundan emin olun. Örneğin, aşağıdakileri yazın:
...
Bu komut,% NFAST_KMDATA% \ yerel klasörünüzde, **key_simple_** **başlayan ve ardından** komutta belirtilen bir ad olan bir ada sahip bir simgeleştirilmiş anahtar dosyası oluşturur. Örneğin: **key_simple_contosokey**. Bu dosya şifreli bir anahtar içeriyor.
...
Komut tamamlandığında, **Sonuç: başarılı** ve anahtarınızın daha düşük izinlerle kopyası, key_xferacId_\<contosokey > adlı dosyada bulunur.
...
## <a name="step-5-transfer-your-key-to-azure-key-vault"></a>5\. Adım: anahtarınızı Azure Key Vault aktarma
