...
- Azure CLI - Ortamınız için bu kuruluma sahip değilseniz, [Azure CLI'yi kullanarak Anahtar Kasası Yönet'e](key-vault-manage-with-cli2.md)bakın.
