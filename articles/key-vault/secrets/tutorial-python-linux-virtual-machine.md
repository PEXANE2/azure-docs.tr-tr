...
Daha sonra devam etmeden önce [Key Vault temel kavramlarını](../general/basic-concepts.md)anladığınızdan emin olun.
...
Şu komutu çalıştırın. Gizli değeri görmeniz gerekir.
