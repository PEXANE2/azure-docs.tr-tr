...
Daha fazla bilgi ve Key Vault'u kullanmaya başlamak için bir öğretici için (HSM korumalı anahtarlar için anahtar kasası nasıl oluşturulacak) için Azure [Anahtar Kasası nedir?](../general/overview.md)
