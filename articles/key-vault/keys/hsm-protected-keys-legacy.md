...
* **Vcredist_x64. exe** adlı yeniden dağıtılabilir Visual C++ paketi.
...
Komut tamamlandığında **Result: Success** ' ı görürsünüz ve anahtarınızın daha düşük izinlerle olan kopyası key_xferacId_\<contosokey> adlı dosyada bulunur.
