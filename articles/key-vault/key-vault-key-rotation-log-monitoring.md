...
İlk olarak, anahtar kasasında oturum açmayı etkinleştirmelisiniz. Aşağıdaki PowerShell komutlarını kullanın. [(Anahtar-tonoz-günlük ile ilgili bu makalede](key-vault-logging.md)tüm ayrıntıları görebilirsiniz.)
