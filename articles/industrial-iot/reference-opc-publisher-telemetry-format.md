---
title: Microsoft OPC yayımcısı telemetri biçimi
description: Bu makalede yapılandırma ayarları dosyasına genel bir bakış sunulmaktadır
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787587"
---
# <a name="opc-publisher-telemetry-format"></a>OPC yayımcısı telemetri biçimi

OPC yayımcısı sürüm 2,6 ve üzeri [, OPC UA belirtiminin 14. bölümünde](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) belirtildiği gibi standartlaştırılmış OPC UA PUBSUB JSON biçimini destekler ve şuna benzer:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Ayrıca, OPC yayımcısının tüm sürümleri, [Azure Time Series Insights](https://azure.microsoft.com/services/time-series-insights/) ile uyumlu, standartlaştırılmış olmayan, basıt bir JSON telemetri biçimini destekler ve şuna benzer:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>OPC yayımcısı telemetri yapılandırma dosyası biçimi
```
