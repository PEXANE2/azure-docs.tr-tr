---
title: Azure CLI - Laboratuvarda sanal bir makine oluşturun ve doğrulayın
...
| [az laboratuvar vm oluşturmak](/cli/azure/lab/vm?view=azure-cli-latest#az-lab-vm-create) | Laboratuvardaki bir sanal makineyi (VM) oluşturur. |
