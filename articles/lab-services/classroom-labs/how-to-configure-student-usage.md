...
1. **E-posta ile davet gönder** penceresinde, isteğe bağlı bir ileti girin ve ardından **Gönder**' i seçin. 
    ...
    **Kullanıcılar** listesinin **davet** sütunu, eklenen her kullanıcı için davetiye durumunu görüntüler. Durum,>tarihinde gönderilmek **üzere ve sonrasında** **gönderilmesi \< **için değişmelidir. 
...
1. **Kullanıcılar** bölmesinde Kullanıcı başına kota ' i seçin: ** \<araç çubuğunda sayı> saat (ler)** . 
1. **Kullanıcı başına kota** penceresinde, her öğrenciye, zamanlanan sınıf süresi dışında vermek istediğiniz saat sayısını belirtin ve ardından **Kaydet**' i seçin.
    ...
    Değiştirilen değerler artık **Kullanıcı başına kota \<** ' de görüntülenir: araç çubuğunda ve Kullanıcı listesindeki>düğme
...
1. **Seçili kullanıcı veya kullanıcıların e \<-posta adresi için kotayı ayarla>**, seçilen öğrenciye veya öğrenciye vermek istediğiniz ek laboratuvar saati sayısını girin ve ardından **Uygula**' yı seçin. 
