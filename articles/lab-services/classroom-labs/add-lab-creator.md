...
- , `@outlook.com`, Veya `@hotmail.com` `@msn.com` `@live.com`gibi bir Microsoft e-posta hesabı.
...
Microsoft hesabı kaydolmak için, Eğitmenler ' e [http://signup.live.com](http://signup.live.com)gitmelidir.  
