...
2.  **Tınloginpassword**IÇIN, SQL Yöneticisi oturum açma tarafından kullanılacak parolayı girin. Parolayı güvenli ve gizleme için "asma kilide" simgesini kullanın.
...
2. **Görevler** sekmesinde bir ortam oluşturma görevi Azure DevTest Labs ekleyin. Görev aşağıdaki gibi yapılandırın:
...
Yayın tanımında, **Görev Ekle**' yi seçin ve ardından **Dağıt** sekmesine bir **ortamı sil Azure DevTest Labs** ekleyin. Aşağıdaki gibi yapılandırın:
