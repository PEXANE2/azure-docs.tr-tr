...
- [Laboratuvarınızda](devtest-lab-get-started-with-lab-policies.md)Kullanıcı başına veya laboratuvar başına sanal makine sayısı gibi ilkeler ayarlayın. 
...
Doğrudan tercih ettiğiniz [sürekli tümleştirme (CI) aracından](devtest-lab-integrate-ci-cd-vsts.md), tümleşik geliştirme ORTAMıNDAN (IDE) veya otomatik sürüm işlem hattınızdan geliştirme/test ortamları sağlamak için önceden hazırlanmış EKLENTILER veya API kullanın. Kapsamlı komut satırı aracını da kullanabilirsiniz.
