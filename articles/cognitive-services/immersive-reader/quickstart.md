---
title: 'Hızlı başlangıç: C ile modern okuyucuyu Başlatan bir Web uygulaması oluşturma #'
...
---
# <a name="quickstart-create-a-web-app-that-launches-the-immersive-reader-c"></a>Hızlı başlangıç: tam ekran okuyucuyu Başlatan bir Web uygulaması oluşturma (C#)
...
İlk olarak, _Views\shared\layout.exe. cshtml_dosyasını açın. Satırdan ```</head>```önce aşağıdaki kodu ekleyin:
