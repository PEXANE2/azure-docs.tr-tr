...
> [!IMPORTANT]
> Bu hızlı başlangıç, tanıyıcı v 1.0 API biçimini kullanır. Aboneliğiniz `West US 2` veya `West Europe` bölgedeyse bunun yerine v[2,0 API hızlı](./curl-train-extract.md) başlangıcını izlemelisiniz.
...
Aşağıdaki JSON çıkışıyla `200 (Success)` bir yanıt alacaksınız:
...
> [REST API başvuru belgeleri](https://westus2.dev.cognitive.microsoft.com/docs/services/form-recognizer-api/operations/AnalyzeWithCustomModel)