...
Har **işlem-konumu** üst bilgisi içeren bir `202 (Success)` yanıtı alacaksınız. Bu üstbilginin değeri, zaman uyumsuz işlemin durumunu sorgulamak ve sonuçları almak için kullanabileceğiniz bir işlem KIMLIĞI içerir. Aşağıdaki örnekte, `operations/` sonraki dize işlem KIMLIĞIDIR.
