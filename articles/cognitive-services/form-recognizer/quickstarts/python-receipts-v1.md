...
> [!IMPORTANT]
> Bu hızlı başlangıç, tanıyıcı v 1.0 API biçimini kullanır. Aboneliğiniz `West US 2` veya `West Europe` bölgedeyse bunun yerine v[2,0 API hızlı](./python-train-extract.md) başlangıcını izlemelisiniz.
