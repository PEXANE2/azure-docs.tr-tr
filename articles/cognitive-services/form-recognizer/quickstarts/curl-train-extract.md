...
1. `<SAS URL>`Azure Blob depolama kapsayıcısının paylaşılan erişim imzası (SAS) URL 'si ile değiştirin. [!INCLUDE [get SAS URL](../includes/sas-instructions.md)]
