---
title: Kod örnekleri - Content Moderator, C#
titleSuffix: Azure Cognitive Services
description: Azure bilişsel hizmetler Content Moderator, uygulamalarınızda REST API çağrılar aracılığıyla Özellik tabanlı örnekleri kullanın.
...
ms.locfileid: "73744303"
---
# <a name="content-moderator-rest-samples-in-c"></a>C 'de REST örnekleri Content Moderator #

Aşağıdaki listede Azure Content Moderator API'si kullanılarak derlenen kod örneklerine bağlantılar bulunmaktadır.
...
Bu örneklerin adımları için [isteğe bağlı Web seminerini](https://info.microsoft.com/cognitive-services-content-moderator-ondemand.html) teslim alın.
