...
Uygulamanızla birleştirmek için kodunuzda REST API kullanın veya [görüntü denetleme .net hızlı](image-moderation-quickstart-dotnet.md) başlangıcı ile başlayın.
