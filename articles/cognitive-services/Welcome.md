...
Azure bilişsel hizmetler, Azure Active Directory kimlik bilgileri, geçerli bir kaynak anahtarı ve [Azure sanal ağları](cognitive-services-virtual-networks.md)aracılığıyla [kimlik doğrulaması](authentication.md) dahil katmanlı bir güvenlik modeli sağlar.
...
Bilişsel hizmetler çeşitli [Destek seçenekleri](cognitive-services-support-options.md)sunar.
