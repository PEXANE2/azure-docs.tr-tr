...
Kaynağından bir anahtar aldıktan sonra, adlı anahtar için [bir ortam değişkeni oluşturun](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account#configure-an-environment-variable-for-authentication) `BING_SEARCH_V7_SUBSCRIPTION_KEY` .
...
> [!NOTE]
> Bu hızlı başlangıçta adlı Bing Görsel Arama anahtarınız için [bir ortam değişkeni oluşturdunuz](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account#configure-an-environment-variable-for-authentication) varsayılır `BING_SEARCH_V7_SUBSCRIPTION_KEY` .
