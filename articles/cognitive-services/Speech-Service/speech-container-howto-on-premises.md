...
|Gereklidir|Amaç|
|--|--|
| Azure Account | Azure aboneliğiniz yoksa başlamadan önce [ücretsiz bir hesap][free-azure-account] oluşturun. |
...
| Hizmet | CPU / Container | Memory / Container |
|--|--|--|
