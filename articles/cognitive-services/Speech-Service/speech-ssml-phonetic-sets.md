...
| `sapi` | `ipa` | Örnek 1           | Örnek 2  | Örnek 3 |
|--------|-------|---------------------|------------|-----------|
| Anlatımı      | `w`   | **b**.,**UE**de | Al |           |
| {1&gt;y&lt;1}      | `j`   | **y**, f**e**w   | **ben**açık  |           |
...
| {1&gt;d&lt;1}      | `d`   | **d**IG   | ran**d**OM  | ro**d**    |
| Ek      | `k`   | **c**UT   | SLA**CK** | Ira**q**   |
| G      | `g`   | **g**o    | a**g**o     | DRA**g**   |
...
| `sapi` | `ipa` | Örnek 1          | Örnek 2  | Örnek 3 |
|--------|-------|--------------------|------------|-----------|
| m      | `l`   | **l**kimliği, g**l**ad  | PA**l**Ace | Chi**ll** |
...
Konuşma hizmeti telefon kümesi, devam eden harften sonra stres koyar; ancak `fr-FR` konuşma hizmeti telefon kümesi, IPA alt stres ' ˌ ' öğesini desteklemiyor. IPA alt stres gerekliyse, IPA doğrudan kullanmanız gerekir.
...
| {1&gt;d&lt;1}      | `d`   | **d**ire    | Ron**d**EUR   | Chau**d**e                       |
| vadeli      | `f`   | **f**emme   | su**FF**IXE   | Bo**f**                          |
| G      | `g`   | **g**auche  | é**g**Ale     | ba**Gu**e                        |
| denetimini     | `ŋ`   |             |               | [<sup>1</sup>](#fr-1)Park**etme** |
| hy     | `ɥ`   | h**u**ile   | n**u**ire     |                                  |
| Ek      | `k`   | **c**Arte   | é**c**aille   | **c** olarak                          |
| m      | `l`   | **l**Ong    | é**l**ire     | ba**l**                          |
...
| Anlatımı      | `w`   | **OU**ı     | f**OU 'su**    |                                  |
| {1&gt;y&lt;1}      | `j`   | **y**od     | p**ekibi**  | Maro**ille**                    |
...
<a id="fr-1"></a>*yalnızca bazı yabancı sözcükler için* 
**1** .

> [!TIP]
> `fr-FR` konuşma hizmeti telefon kümesi, aşağıdaki Fransızca destekleri, `n‿`, `t‿`ve `z‿`desteklemez. Gerekirse, IPA doğrudan kullanmayı göz önünde bulundurmanız gerekir.
...
<a id="de-v-2"></a>
**2** *sözcük-yalnızca **bir**ppointe gibi yabancı kaynak kelimelerde kullanıma açılır. İlk başta: ' v**e**rstauen dili.*
...
| vadeli | `f` | **F**ahrtdauer | Angri**FF**slustig | abbruchrei**f** |  |
| G | `g` | **g**. |  | [<sup>6</sup>](#de-c-6) GRE**g** |  |
| olsun | `h` | **H**ausanbau |  |  |  |
| {1&gt;y&lt;1} | `j` | **J**od | Reakt | Hu**ı** |  |
| Ek | `k` | **K**OMA | Aspe**k**t | Flec**k** |  |
| m | `l` | **l**au | ähne**l**n | zugörüntüle**l** |  |
...
<a id="de-c-2"></a> *"e" ve "i" sonra 2 yumuşak "CH"* 
<br>
<a id="de-c-3"></a> *yalnızca yabancı kaynak sözcüklerde 3 
, örneğin: Len**d**l.*<br>
<a id="de-c-4"></a>
**4** *yalnızca yabancı kaynak kelimelerde: Clau**d**e gibi.*<br>
<a id="de-c-5"></a>
**5** *yalnızca yabancı kaynak kelimelerde: Kanal**g**e.*<br>
<a id="de-c-6"></a>
**6** *sözcük-yalnızca GRE**g**gibi yabancı kaynak kelimelerde sonlandırılabilen.*<br>
<a id="de-c-7"></a>
**7** *yalnızca yabancı kaynak kelimelerde: **ng**Uygurca.*<br>
<a id="de-c-8"></a>
**8** *yalnızca yabancı kaynak kelimelerde: **S**taccato.*<br>
<a id="de-c-9"></a> *yalnızca yabancı kaynak kelimelerde 9 
, örneğin: gr**Oo**ve.*<br>
<a id="de-c-10"></a>
**10** *tüm ön uç olmayan (a, aa, Oh, ow, uh, ODTÜ ve diphthong AW) sonra IPA `x` sabit bir "CH" dır.*<br>
<a id="de-c-11"></a>
**11** *IPA `ç`, önde gelen bir ' CH ' (IH, iy, Eh, AE, uy, UE, OE, eu de Diphthongs ay, oy) ve ünsüzler*<br>
<a id="de-c-12"></a>**12** *sözcük 
başlangıçta yalnızca yabancı kaynak kelimelerde: **J**Uan. Dili-başlangıçta da şu şekilde kelimeyle: ba**ch**silinebilir.*<br>
...
> [!NOTE]
> İki sesli harfler orijinal bir diphthong dışında iki ayrı sesli bir [GS\] telefonu eklememiz gerekiyor. Bu sözlü, daha fazla bilgi için bkz. <a href="http://en.wikipedia.org/wiki/Glottal_stop" target="_blank">gırtı <span class="docon docon-navigate-external x-hidden-focus"></a></a>.
...
| Ben      | `i`   | **ben**bérika  | Av**ı**Spa    | Vergi**ı**     |
| a      | `e`   | **e**Solante | **e-** nsaat    | Elefant**e** |
...
| {1&gt;d&lt;1}      | `d`        | **d**Edo dili   |                | portlan**d**   |
|        | `ð`        |            | de**d**o       | Verda**d**     |
| vadeli      | `f`        | **f**ácil  | ele**f**Ante   | PU**f**        |
| G      | `g`        | **g**angası  |                | dópin**g**     |
|        | `ɣ`        |            | a**g**UA       | Tug**g**     |
| j      | `j`        | **g**Odo   | Cal **'yi**oluştur   | yeniden**y**        |
| JJ     | `j.j` `jj` |            | Vi**a**      |                |
| Ek      | `k`        | **c**Oche  | Bo**c**a       | titáni**c**    |
| m      | `l`        | **l**ápiz  | a**l**a        | Corde**l**     |
...
| Anlatımı      | `w`        | h**u**ESO  | AG**u**a       | şapkası**u**       |
| x      | `x`        | **j**OTA   | bir**j**o        | rElo**j**      |

> [!TIP]
> `es-ES` konuşma hizmeti telefon kümesi, aşağıdaki Ispanyolca IPA, `β`, `ð`ve `ɣ`desteklemez. Gerekirse, IPA doğrudan kullanmayı göz önünde bulundurmanız gerekir.

# <a name="zh-cn"></a>[zh-CN](#tab/zh-CN)

`zh-CN` için konuşma hizmeti telefon kümesi, yerel telefon <a href="https://en.wikipedia.org/wiki/Pinyin" target="_blank">Pinyin <span class="docon docon-navigate-external x-hidden-focus"></span> </a> kümesini temel alır.
...
`zh-TW` için konuşma hizmeti telefon kümesi, yerel telefonun <a href="https://en.wikipedia.org/wiki/Bopomofo" target="_blank">Bopomofo <span class="docon docon-navigate-external x-hidden-focus"></span> </a> kümesini temel alır.
...
`ja-JP` için konuşma hizmeti telefon kümesi, yerel telefon <a href="https://en.wikipedia.org/wiki/Kana" target="_blank">kana <span class="docon docon-navigate-external x-hidden-focus"></span> </a> kümesini temel alır.
