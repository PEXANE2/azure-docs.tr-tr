...
>[!NOTE]
>Telaffuz değerlendirmesi özelliği şu anda yalnızca `westus` ve bölgelerinde kullanılabilir `eastasia` . Bu özellik şu anda yalnızca `en-US` dilde kullanılabilir.
