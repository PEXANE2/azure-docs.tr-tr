...
1. Proje dizini seçin
    1. Projeyi içine koymak için bir dizin seçin. Bu `helloworld` , giriş dizininizde Xcode projesi için tüm dosyaları içeren bir dizin oluşturur.
