---
title: Konuşmacı Tanıma hızlı başlangıç-konuşma hizmeti
titleSuffix: Azure Cognitive Services
description: "\"Konuşuyor\" sorusuna yanıt vermek için konuşma SDK 'sının konuşmacı tanımayı nasıl kullanacağınızı öğrenin. Bu hızlı başlangıçta, hem konuşmacı doğrulama hem de tanımlama ile çalışmaya yönelik ortak tasarım desenleri hakkında bilgi edinirsiniz. Bu, her ikisi de benzersiz sesleri belirlemek için Voice biometri kullanır."
...
ms.locfileid: "89410860"
---
# <a name="get-started-with-speaker-recognition"></a>Konuşmacı Tanıma 'Yı kullanmaya başlama
