...
- SpeechSDK 'de SR:*config. FromHost ("WSS://Virginia.STT.Speech.Azure.us", " \<your-key\> ");*
- SpeechSDK: config içinde TTS *. FromHost ("https []() ://Virginia.TTS.Speech.Azure.us", " \<your-key\> ");*
...
- SpeechSDK 'de SR: *config. FromHost ("WSS://chinaeast2.STT.Speech.Azure.cn", " \<your-key\> ");*
- SpeechSDK: config içinde TTS  *. FromHost ("https []() ://chinaeast2.TTS.Speech.Azure.cn", " \<your-key\> ");*
