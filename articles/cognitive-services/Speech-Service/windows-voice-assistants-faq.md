...
Bu winvoiceassistants@microsoft.com kaynakları istemek için iletişim kurun.
...
Kompakt görünümden geçişi tam uygulama görünümüne getirmek için appView API `TryEnterViewModeAsync`'sini kullanın:
