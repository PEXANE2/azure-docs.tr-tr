...
Hızlı başlangıç, [konuşma tanıma](quickstart-swift-macos.md)için de kullanılabilir.
...
1. @No__t-0 dizesini aboneliğinizle ilişkili bölgeyle değiştirin (örneğin, ücretsiz deneme aboneliği için `westus`).
