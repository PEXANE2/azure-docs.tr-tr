...
Bir `IntentRecognizer` nesnesi başlatabilmeniz için, LUSıS uç noktası anahtarınızı ve bölgenizi kullanan bir yapılandırma oluşturmanız gerekir. `recognizeIntent()` yöntemine bu kodu ekleyin.
...
Basitlik sağlamak için gelecekte işlemin tamamlanmasını bekliyoruz.
...
(Bu sürüme bazı açıklamalar ekledik) [!code-cpp[](~/samples-cognitive-services-speech-sdk/quickstart/cpp/windows/intent-recognition/helloworld/helloworld.cpp?range=6-81)]
