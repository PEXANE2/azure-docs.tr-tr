---
title: 'Hızlı başlangıç: konuşmayı metne dönüştürme, Java (Windows, Linux)-konuşma hizmeti'
...
1. Dizeyi `YourServiceRegion` [bölgesiyle](~/articles/cognitive-services/Speech-Service/regions.md)değiştirin.
