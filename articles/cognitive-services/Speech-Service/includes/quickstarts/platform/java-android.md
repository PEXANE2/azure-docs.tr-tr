...
description: Bunu konuşma hizmeti SDK 'Sı ile Java (Android) kullanmaya yönelik platformunuzu ayarlamak için bu kılavuzu kullanın.
...
Konuşma SDK 'Sı, 32/64 bit ARM ve Intel x86/x64 uyumlu işlemcilerin bulunduğu Android cihazlarıyla uyumludur.

## <a name="install-the-speech-sdk-using-android-studio"></a>Android Studio kullanarak konuşma SDK 'sını yükler
