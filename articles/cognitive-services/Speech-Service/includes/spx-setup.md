...
Windows 'a SPX aracını yüklemek için aşağıdaki adımları izleyin:
...
2. SPX araç [ZIP arşivini](https://aka.ms/speech/spx-zips.zip)indirip ayıklayın.
...
Komut isteminde dizini bu konum olarak değiştirin ve ardından `spx` , SPX aracının yardımını görmek için yazın.

#### <a name="linux-install"></a>[Linux yüklemesi](#tab/linuxinstall)

X64 CPU 'ya Linux üzerinde SPX aracını yüklemek için aşağıdaki adımları izleyin:
...
`spx`SPX aracı yardımını görmek için yazın.
