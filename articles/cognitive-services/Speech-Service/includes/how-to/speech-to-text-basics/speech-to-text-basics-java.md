...
Bir anahtar ve bölge kullanılarak [`SpeechConfig`](https://docs.microsoft.com/java/api/com.microsoft.cognitiveservices.speech.speechconfig?view=azure-java-stable) nasıl oluşturulduğuna bir göz atalım.
