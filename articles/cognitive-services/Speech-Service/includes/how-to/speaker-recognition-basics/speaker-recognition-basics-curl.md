...
[Bir ses profili oluşturarak](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/createprofile)başlayın. Bu makaledeki her bir kıvrımlı komuta konuşma hizmeti abonelik anahtarınızı ve bölgenizi eklemeniz gerekir.
...
Artık [bir ses örneğini ses profiline karşı doğrulamaya](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/verifyprofile)hazırsınız. Bu ses örneği, ses profilini kaydetmek için kullandığınız örneklerle aynı parolayı içermelidir.
...
Son olarak, [ses profilini silin](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/deleteprofile).
...
[Bir metin bağımsız doğrulama profili oluşturarak](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/createprofile)başlayın.
...
Ardından, [ses profilini kaydedin](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/createenrollment). Bu, üç ses örneği göndermek yerine, toplam 20 saniyelik ses içeren ses örnekleri göndermeniz gerekir.
...
Artık [bir ses örneğini ses profiline karşı doğrulamaya](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/verifyprofile)hazırsınız. Bu ses örneğinin bir parola içermesi gerekmez. En az dört saniyelik ses içerdiği sürece herhangi bir konuşma içerebilir.
...
Son olarak, [ses profilini silin](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/deleteprofile).
...
[Metin bağımsız bir kimlik profili oluşturarak](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/createprofile)başlayın.
...
Ardından, [ses profilini kaydedin](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/createenrollment). Yine, toplam 20 saniyelik ses içeren ses örnekleri göndermeniz gerekir. Bu örneklerin bir parola içermesi gerekmez.
...
Son olarak, [ses profilini silin](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/deleteprofile).
