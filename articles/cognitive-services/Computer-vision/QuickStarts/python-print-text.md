...
> [!NOTE]
> Ingilizce dil metnini ayıklıyorsanız, yeni [okuma işlemini](../concept-recognizing-text.md)kullanmayı göz önünde bulundurun. [Python hızlı](./python-hand-text.md) başlangıcı kullanılabilir. 
