...
ms.locfileid: "70138065"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-computer-vision-rest-api-and-c"></a>Hızlı Başlangıç: Görüntü İşleme REST API kullanarak yazdırılan metni (OCR) ayıklayın veC#
