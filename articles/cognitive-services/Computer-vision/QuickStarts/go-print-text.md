...
> [!NOTE]
> Ingilizce dil metnini ayıklıyorsanız, yeni [okuma işlemini](../concept-recognizing-text.md)kullanmayı göz önünde bulundurun. [Go hızlı](../quickstarts-sdk/client-library.md?pivots=programming-language-go%253fpivots%253dprogramming-language-go#call-the-read-api) başlangıcı kullanılabilir.
