---
title: 'Hızlı başlangıç: Görüntü İşleme 2,0 ve 2,1-Ayıkla ve el yazısı metin-REST, Python'
...
1. İsteğe bağlı olarak, değerini `image_url` , metin çıkarmak istediğiniz farklı bır görüntünün URL 'siyle değiştirin.
