---
title: 'Quickstart: Yazdırılan metni ayıklayın- REST, JavaScript'
...
1. _Get-printed-text.html_adlı bir dosya oluşturun, metin düzenleyicisinde açın ve aşağıdaki kodu kopyalayın.
