---
title: 'Hızlı başlangıç: Node.js için görüntü analizi istemci kitaplığı'
description: Bu hızlı başlangıç ile Node.js için görüntü analizi istemci kitaplığıyla çalışmaya başlama
...
|[VisualFeatureTypes](/javascript/api/@azure/cognitiveservices-computervision/visualfeaturetypes)| Bu Enum, standart bir çözümle işleminde yapılabilecek farklı görüntü analizi türlerini tanımlar. İhtiyaçlarınıza bağlı olarak bir **Visualfeaturetypes** değeri kümesi belirtirsiniz. |
...
> [!div class="nextstepaction"]
> [Bir sorunla karşılaşdığım](https://microsoft.qualtrics.com/jfe/form/SV_0Cl5zkG3CnDjq6O?PLanguage=Javascript&Section=analyze-image) [bir görüntüyü çözümleytim](?success=analyze-image#run-the-application)
