---
title: 'Hızlı Başlangıç: .NET için Görüntü İşleme istemci kitaplığı | Microsoft Docs'
description: .NET için Görüntü İşleme istemci kitaplığı ile çalışmaya başlayın.
...
Konsol penceresinde (cmd, PowerShell veya Bash gibi), adıyla `dotnet new` `computer-vision-quickstart`yeni bir konsol uygulaması oluşturmak için komutunu kullanın. Bu komut, tek bir kaynak dosyası olan C# basit bir "Merhaba Dünya" projesi oluşturur: *Program.cs*.
