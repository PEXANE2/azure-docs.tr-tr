...
- 3,0 API 'Leri sunuldu. 1 Ekim 2019 ' de 3,0 öncesi API 'Leri kullanımdan kaldırma hakkında duyuruldu. Kullanmaya başlama hakkında örnekler için [hızlı](./quickstarts/image-classification.md) başlangıçlara bakın.
