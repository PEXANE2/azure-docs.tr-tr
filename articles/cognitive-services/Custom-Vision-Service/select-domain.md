...
Compact etki alanları tarafından oluşturulan modeller yerel olarak çalışacak şekilde aktarılabilir. Model performansı seçilen etki alanına göre değişir. Aşağıdaki tabloda, Intel Masaüstü CPU ve NVIDIA GPU \[1\]model boyutunu ve çıkarımı süresini raporlarız. 
...
|---|---|---|---|---|
|Sınıflandırma|Genel (Compact)|5 MB|13 MS|5 MS|
|Nesne Algılama|Genel (Compact)|45 MB|35 MS|5 MS|
