...
ms.locfileid: "68561121"
---
# <a name="tutorial-use-an-onnx-model-from-custom-vision-with-windows-ml-preview"></a>Öğretici: Windows ML ile Özel Görüntü İşleme bir ONNX modeli kullanma (Önizleme)
