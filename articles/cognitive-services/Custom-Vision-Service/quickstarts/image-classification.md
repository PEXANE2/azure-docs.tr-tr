...
description: 'Hızlı başlangıç: bir görüntü sınıflandırma projesi oluşturun, Etiketler ekleyin, görüntüleri yükleyin, projenize eğitme yapın ve Özel Görüntü İşleme istemci kitaplığı veya REST API kullanarak tahmin yapın'
