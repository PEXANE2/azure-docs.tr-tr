...
Varlık rolleri, LUSıS uygulamasının veri modeli için geçerlidir. [Ortak çalışan veya katkıda bulunan](luis-concept-keys.md#contributions-from-other-authors) rolleri, yazma erişimi düzeyleri için geçerlidir. 
