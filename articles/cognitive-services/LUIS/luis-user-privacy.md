...
- Modeli iyileştirmenize yardımcı olmak için [etkin öğrenme](luis-concept-review-endpoint-utterances.md) tarafından kullanılan günlüğe kaydedilmiş kullanıcı sorguları
  - Kullanıcılar isteğe `&log=false` ekleyerek sorgu günlüğünü kapatabilir, Ayrıntılar [buraya](troubleshooting.md#how-can-i-disable-the-logging-of-utterances)
...
| | **Kullanıcı hesabı** | **Uygulamanızı** | **Örnek söyleyler** | **Son Kullanıcı sorguları** |
| --- | --- | --- | --- | --- |
...
| | **Kullanıcı hesabı** | **Uygulamanızı** | **Utterance (s)** | **Son Kullanıcı sorguları** |
| --- | --- | --- | --- | --- |
