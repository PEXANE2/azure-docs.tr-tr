---
title: 'Hızlı Başlangıç: Değişiklik, eğit App, Node. js-LUSıS'
...
ms.locfileid: "70307500"
---
# <a name="quickstart-change-model-using-nodejs"></a>Hızlı Başlangıç: Node. js kullanarak modeli değiştirme
