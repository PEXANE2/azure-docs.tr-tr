---
title: 'Hızlı başlangıç: Language Understanding (LUSıS) istemci kitaplıkları'
...
ms.locfileid: "88237406"
---
# <a name="quickstart-language-understanding-luis-client-library"></a>Hızlı başlangıç: Language Understanding (LUSıS) istemci kitaplığı

Language Understanding (LUSıS) istemci kitaplığı ile çalışmaya başlayın. SDK 'Yı yüklemek için bu adımları izleyin ve temel görevler için örnek kodu deneyin.  Language Understanding (LUU), bir kullanıcının konuşma, doğal dil metnine, genel anlamı tahmin etmek ve ilgili ayrıntılı bilgileri almak için özel makine öğrenimi zekası uygulamanıza olanak sağlar.
