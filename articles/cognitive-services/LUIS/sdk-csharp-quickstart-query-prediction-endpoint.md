...
description: Bu hızlı başlangıçta, Azure bilişsel Hizmetler C# Luin uygulamasına bir Kullanıcı alıp göndermek ve tahmin almak için SDK 'nın nasıl kullanılacağı gösterilir.
author: diberry
manager: nitinme
...
ms.locfileid: "75611109"
---
# <a name="quickstart-query-v3-prediction-endpoint-with-c-net-sdk"></a>Hızlı başlangıç: .NET SDK ile C# v3 tahmin uç noktası sorgulama
