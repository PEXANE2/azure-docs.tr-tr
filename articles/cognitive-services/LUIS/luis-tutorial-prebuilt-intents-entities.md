...
1. Aşağıdaki amaçları ve **Done** (Bitti) öğesini seçin: 
   ...
   * Utilities.Stop
     ...
     Bu ıntents kullanıcı, konuşma, nerede ve ne bunlar yapmak kaydolmasını belirlemek yararlıdır. Bu hedefleri varlıkları kullanımını içerir. Bu varlıkların LUIS uygulaması için otomatik olarak eklenir: sayı, sıra ve Utilities.DirectionalReference. 
