---
title: 'Hızlı Başlangıç: Değişiklik, eğitme uygulaması, Python-LUSıS'
...
1. Aşağıdaki kod parçacığını `add-utterances-3-6.py` adlı dosyaya kopyalayın:
...
### <a name="add-utterances-from-the-command-line"></a>Komut satırından konuşma ekleme
...
Konuşmalar modele eklendiğinde aşağıdaki yanıt döndürülür.  
