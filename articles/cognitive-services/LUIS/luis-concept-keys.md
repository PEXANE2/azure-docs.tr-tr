...
> [!CAUTION]
> Kolaylık olması için, çoğu örnek, [kotasında](luis-limits.md#key-limits)birkaç ücretsiz tahmin uç noktası çağrısı sağladığından [Başlangıç anahtarını](#starter-key) kullanır.
...
**Geçirilen [kaynak geçişi](luis-migration-authoring.md) olan uygulamalar için**: kaynak sahibi olarak, bir `contributor`ekleyebilirsiniz.
