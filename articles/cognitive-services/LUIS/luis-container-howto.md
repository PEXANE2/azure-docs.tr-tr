...
[`docker pull`](https://docs.docker.com/engine/reference/commandline/pull/)Depodan bir kapsayıcı görüntüsü indirmek için komutunu kullanın `mcr.microsoft.com/azure-cognitive-services/language/luis` :
