...
:::image type="content" source="media/sign-in/resource-selection.png" alt-text="Kısmi ekran-abonelik ve yazma kaynağı seçme açılan kutuları ile HALSıS portalının görüntüsü.":::
