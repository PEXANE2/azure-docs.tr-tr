...
Bilişsel Hizmetler iki doğal dil işleme hizmetleri sağlar, [Dil Anlayışı](what-is-luis.md) ve [QnA Maker](../qnamaker/overview/overview.md), her biri farklı bir amaç ile. Her hizmeti ne zaman kullanacağımı ve birbirlerine nasıl iltifat ettiklerini anlayın. 
...
* [LUIS](luis-concept-best-practices.md) en iyi uygulamaları
* [QnA Maker](../qnamaker/concepts/best-practices.md) en iyi uygulamaları

## <a name="see-also"></a>Ayrıca bkz.

* [Dil Anlama (LUIS)](what-is-luis.md)
