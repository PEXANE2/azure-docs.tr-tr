---
title: 'Hızlı Başlangıç: Değişiklik, eğitme uygulaması, Java-LUSıS'
...
ms.locfileid: "70307524"
---
# <a name="quickstart-change-model-using-java"></a>Hızlı Başlangıç: Java kullanarak modeli değiştirme 
