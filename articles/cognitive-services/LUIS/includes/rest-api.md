...
1. İle başlayan değerleri `_*_YOUR-` kendi değerlerinizle değiştirin.
...
1. Daha önce yaptığınız gibi, değerlerini `_*_YOUR-` kendi değerlerinizle başlayarak değiştirin.
...
1. İle başlayan değerleri `_*_YOUR-` kendi değerlerinizle değiştirin.
    ...
    |Bilgi|Amaç|
    |--|--|
    |`_*_YOUR-PREDICTION-ENDPOINT_*_`| Tahmin URL 'niz uç noktasıdır. Uygulama için Azure kaynakları sayfasında, LUO portalında bulunur.<br>Örneğin, `https://westus.api.cognitive.microsoft.com/`.|
