...
|--|--|
|[Liste varlığı](#add-list-entities-for-exact-matches)|alternatif formlar olarak eş anlamlılarla birlikte kurallı adların listesi|
...
Liste varlıkları sabit ve kapalı bir ilgili sözcük kümesini temsil eder. Yazar olarak, yazar olarak listeyi değiştireyken, LUYA listeyi küçültmez veya küçülemez. Ayrıca, bir [list Entity. JSON biçimi (başvuru-varlık-List. MD # örnek-JSON------------------------- 
...
1. **Liste varlığı oluştur** iletişim kutusunda **Yeni alt liste ekle...** öğesine, gibi bir liste öğesi adı `Green`girip eş anlamlılar ekleyin.
...
Aşağıdaki söyleyde iki konum vardır ve her biri, ve `to` `from`gibi çeşitli sözcükler tarafından anlam olarak belirtilmiştir: 

`Pick up the package from Seattle and deliver to New York City.`

Bu yordamda, önceden oluşturulmuş `origin` bir `destination` geographyV2 varlığına roller ekleyin.
...
1. **Rol...** metin kutusuna rolün `Origin` adını girin ve ardından ENTER tuşuna yazın. İkinci bir rol adı ekleyin ve `Destination` ardından girin. 
