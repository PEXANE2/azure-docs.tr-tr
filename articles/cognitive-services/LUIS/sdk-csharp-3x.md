---
title: 'Hızlı başlangıç: Language Understanding (LUSıS) yazma istemci kitaplığı 3. x for .NET'
titleSuffix: Azure Cognitive Services
description: .NET için LUSıS istemci kitaplığı 3. x ile çalışmaya başlayın. Paketi yüklemek için bu adımları izleyin ve temel görevler için örnek kodu deneyin.
...
ms.locfileid: "74807509"
---
# <a name="quickstart-language-understanding-luis-client-library-3x-for-net"></a>Hızlı başlangıç: Language Understanding (LUSıS) istemci kitaplığı 3. x for .NET

.NET için Language Understanding (LUSıS) istemci kitaplığı 3. x ile çalışmaya başlayın. Paketi yüklemek için bu adımları izleyin ve temel görevler için örnek kodu deneyin.  Language Understanding (LUU), bir kullanıcının konuşma, doğal dil metnine, genel anlamı tahmin etmek ve ilgili ayrıntılı bilgileri almak için özel makine öğrenimi zekası uygulamanıza olanak sağlar.

.NET için Language Understanding (LUSıS) istemci kitaplığı 3. x kullanın:

* Yayınlanmış bir uç noktayı sorgula
