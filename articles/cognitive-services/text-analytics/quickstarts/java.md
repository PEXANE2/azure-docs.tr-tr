...
1. En sevdiğiniz IDE (veya masaüstünüzdeki yeni klasör) içinde yeni bir Java projesi oluşturun. Adlı bir sınıf oluşturun `DetectLanguage.java` .
...
1. En sevdiğiniz IDE (veya masaüstünüzdeki yeni klasör) içinde yeni bir Java projesi oluşturun. Adında bir sınıf oluşturun `GetSentiment.java` .
1. Aşağıda belirtilen kodu sınıfınıza ekleyin.
1. Metin Analizi anahtarınızı ve uç noktanızı koda kopyalayın.
1. [Gson](https://github.com/google/gson) kitaplığının yüklü olduğundan emin olun.
1. Programı IDE 'de çalıştırın veya çalıştırmak için komut satırını kullanın (kod açıklamalarındaki yönergeler).
...
1. En sevdiğiniz IDE (veya masaüstünüzdeki yeni klasör) içinde yeni bir Java projesi oluşturun. Adında bir sınıf oluşturun `GetKeyPhrases.java` .
1. Aşağıda belirtilen kodu sınıfınıza ekleyin.
1. Metin Analizi anahtarınızı ve uç noktanızı koda kopyalayın. 
1. [Gson](https://github.com/google/gson) kitaplığının yüklü olduğundan emin olun.
1. Programı IDE 'de çalıştırın veya çalıştırmak için komut satırını kullanın (kod açıklamalarındaki yönergeler).
...
1. En sevdiğiniz IDE (veya masaüstünüzdeki yeni klasör) içinde yeni bir Java projesi oluşturun. Adında bir sınıf oluşturun `GetEntities.java` .
1. Aşağıda belirtilen kodu sınıfınıza ekleyin.
1. Metin Analizi anahtarınızı ve uç noktanızı koda kopyalayın. 
1. [Gson](https://github.com/google/gson) kitaplığının yüklü olduğundan emin olun.
1. Programı IDE 'de çalıştırın veya çalıştırmak için komut satırını kullanın (kod açıklamalarındaki yönergeler).
