...
>
> Örnek: `https://<your-custom-subdomain>.cognitiveservices.azure.com/text/analytics/v3.1-preview.2/entities/recognition/pii?domain=phi&model-version=2020-07-01`
 
Uç noktaya istek gönderdiğinizde aşağıdaki varlık kategorileri döndürülür `/v3.1-preview.2/entities/recognition/pii` .
