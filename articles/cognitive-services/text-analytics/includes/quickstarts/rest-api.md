...
ms.locfileid: "102444182"
---
# <a name="version-31-preview"></a>[Sürüm 3,1 Önizleme](#tab/version-3-1)

[v 3.1 başvuru belgeleri](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-3/)
...
> [!NOTE]
> Aşağıdaki örnek, `opinionMining=true` metin içindeki yönleriyle (ürünlerin veya hizmetlerin öznitelikleri gibi) ilgili ayrıntılı bilgiler sağlayan parametresini kullanarak yaklaşım analizi için bir Istek araştırma özelliği içerir.
