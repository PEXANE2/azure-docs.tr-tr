...
Yeni bir dosya oluşturun, _Facedetection. RB_ ve aşağıdaki kodu ekleyin. Bu kod, belirli bir görüntü URL 'SI için Yüz Tanıma API'si çağırır.
