...
description: Web 'in özel bir görünümünün nasıl aranacağını açıklar.
...
|Offset    | Sonuçları döndürmeden önce atlanacak arama sonuçlarının sayısı. Yalnızca Web, görüntü ve video uç noktaları için kullanılabilir.        |
