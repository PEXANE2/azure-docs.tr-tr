...
description: C# ' deki istekleri Azure bilişsel hizmeti olan Bing yerel Iş Arama API 'Sine göndermeye başlamak için bu hızlı başlangıcı kullanın.
