...
Bing yerel Iş Arama API 'sindeki JSON yanıtları bir `SearchResponse` nesnesi içerir. API, `places` alanında ilgili arama sonuçlarını döndürür. Sonuç bulunmazsa `places` alanı yanıta eklenmez.
