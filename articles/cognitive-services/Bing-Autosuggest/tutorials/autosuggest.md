...
Öğreticiyi takip edebilmek için Bing Otomatik Öneri API'si için bir abonelik anahtarına ihtiyacınız olacaktır. Bir tane yoksa, Azure portal [Bing otomatik öneri bir kaynak oluşturun](https://portal.azure.com/#create/Microsoft.CognitiveServicesBingAutosuggest-v7) .
...
Metin alanına sahip bir HTML formu oluşturun. Olayı işleyin `oninput` ve `bingAutosuggest()` metin alanının içeriğini ve Bing otomatik öneri API'si anahtarını geçirerek işlevi çağırın.
