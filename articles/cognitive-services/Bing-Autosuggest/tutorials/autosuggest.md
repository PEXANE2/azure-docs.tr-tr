...
Metin alanına sahip bir HTML formu oluşturun. `oninput` Olayı işleyin ve metin alanının içeriğini `bingAutosuggest()` ve Bing otomatik öneri API'si anahtarını geçirerek işlevi çağırın.
