...
Metin alanına sahip bir HTML formu oluşturun. `oninput` olayını işleyin ve metin alanının içeriğini ve Bing Otomatik Öneri API'si anahtarını geçirerek `bingAutosuggest()` işlevini çağırın.
