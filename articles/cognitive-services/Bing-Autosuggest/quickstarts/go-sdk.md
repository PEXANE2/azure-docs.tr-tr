---
title: 'Hızlı başlangıç: go için istemci kitaplığı Bing Otomatik Öneri | Microsoft Docs'
description: Go için Bing Otomatik Öneri istemci kitaplığı ile çalışmaya başlayın ve kısmi sorgu dizelerine göre arama önerileri alın.
...
ms.locfileid: "75474091"
---
# <a name="quickstart-bing-autosuggest-client-library-for-go"></a>Hızlı başlangıç: go için istemci kitaplığı Bing Otomatik Öneri
...
`my-app` adlı bir çalışma alanı ve `src`, `pkg`ve `bin`için gereken alt dizinleri oluşturalım:
...
Sonra, `src/sample-app.go`adlı bir dosya oluşturalım:
...
`sample-app.go` açın ve paket adını ekleyin ve aşağıdaki kitaplıkları içeri aktarın:
...
`main`adlı bir işlev oluşturun. Ardından Bing Otomatik Öneri anahtarınız ve uç noktanız için ortam değişkenleri oluşturun.
...
> [!NOTE] 
> Bu hızlı başlangıçta Bing otomatik öneri anahtarınız için [bir ortam değişkeni oluşturdunuz](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account#configure-an-environment-variable-for-authentication) , `BING_AUTOSUGGEST_SUBSCRIPTION_KEY`adlı ve `BING_AUTOSUGGEST_ENDPOINT`adlı uç noktanız için bir ortam değişkeni oluşturdunuz.

`main()` işlevinde, uç nokta ve anahtarınızla bir istemci örneği oluşturun. 
