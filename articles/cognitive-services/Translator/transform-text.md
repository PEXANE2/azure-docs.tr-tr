...
| Parametre | Açıklama |
|:---|:---|
| Yetkilendirme üst bilgisi | **Gerekli** Uygulamayı tanımlamak için kullanılan HTTP üstbilgisi. Anahtar: "yetkilendirme" ve değer: "taşıyıcı" + "" + erişim belirteci kullanın. Ayrıntılar için buraya gidin.|
| language | **Gerekli** Dil kodunu temsil eden bir dize. Bu **parametre, dil adı olarak yalnızca** İngilizce ile desteklenir.|
