---
title: Belge çevirisi iptal işlemi yöntemi
titleSuffix: Azure Cognitive Services
description: Cancel işlemleri yöntemi, şu anda işleme veya sıraya alınmış bir işlemi iptal eder.
...
ms.locfileid: "105613166"
---
# <a name="document-translation-cancel-operations"></a>Belge çevirisi: iptal işlemleri
...
## <a name="cancel-operations-response"></a>İşlem yanıtını iptal et
