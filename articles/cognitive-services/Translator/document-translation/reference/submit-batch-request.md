---
title: Belge çevirisi toplu istek gönder
titleSuffix: Azure Cognitive Services
description: Belge çevirisi hizmetine bir belge çevirisi isteği gönderir.
...
ms.locfileid: "105613098"
---
# <a name="document-translation-submit-batch-request"></a>Belge çevirisi: toplu istek gönder

Belge çevirisi hizmetine toplu (Batch) çeviri isteği göndermek için bu API 'yi kullanın. Her istek birden çok belge içerebilir ve her belge için bir kaynak ve hedef kapsayıcı içermelidir.
