...
Sonra URL 'YI oluşturalım. URL, `Parse()` ve `Query()` yöntemleri kullanılarak oluşturulmuştur. Parametrelerinin `Add()` yöntemiyle eklendiğini fark edeceksiniz. Bu örnekte, Ingilizce 'den Almanca 'ya ve Italyanca 'e çeviriyoruz: `de` ve. `it`
