...
* [Power otomatikleştir](https://us.flow.microsoft.com/) portalında:
    ...
    * Akışı [soru-cevap oluşturma GenerateAnswer](/connectors/cognitiveservicesqnamaker/)kullanacak şekilde yapılandırmak için şablon kullanın.
...
* [Soru-cevap oluşturma Bağlayıcısı](https://us.flow.microsoft.com/connectors/shared_cognitiveservicesqnamaker/qna-maker/) ve [bağlayıcı ayarları](/connectors/cognitiveservicesqnamaker/)