...
`<your-custom-domain>`**bitiş noktası** değişkenini özel etki alanınızı adı olarak değiştirin. Bu konum, Azure portal Soru-Cevap Oluşturma kaynağınız için **genel bakış** sayfasında bulunur.
