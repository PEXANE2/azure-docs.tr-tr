...
Kaynağından bir anahtar aldıktan sonra, ve `QNAMAKER_AUTHORING_ENDPOINT`adlı `QNAMAKER_RESOURCE_KEY` kaynak için [ortam değişkenleri oluşturun](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account#configure-an-environment-variable-for-authentication) . Azure portal kaynağın **hızlı başlangıç** sayfasında bulunan anahtar ve ana bilgisayar değerlerini kullanın.
...
Bir düğüm`package.json` dosyası oluşturmak için komutunuçalıştırın.`npm init -y` 
...
Uygulamayı uygulama dizininizdeki komutla çalıştırın. `node rest-apis.js`
