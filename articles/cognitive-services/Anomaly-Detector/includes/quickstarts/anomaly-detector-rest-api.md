...
Anomali algılayıcı kavramlarıyla ilgili üst düzey bir görünüm için bkz. [genel bakış](../../overview.md) makalesi.

## <a name="prerequisites"></a>Önkoşullar

- Azure aboneliği- [ücretsiz olarak bir tane oluşturun](https://azure.microsoft.com/free/cognitive-services)
- Azure aboneliğiniz olduktan sonra <a href="https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesAnomalyDetector"  title=" "  target="_blank"> <span class="docon docon-navigate-external x-hidden-focus"></span> </a> anahtar ve uç noktanıza ulaşmak için Azure Portal bir anomali algılayıcı kaynağı oluşturun. Dağıtım için bekleyin ve **Kaynağa Git** düğmesini seçin.
...
## <a name="detect-anomalies-for-an-entire-series"></a>Tüm bir serinin bozuklukilerini Algıla
...
- Anomali için sınanacak zaman serisi verilerinin geçerli bir JSON dosyası. Kendi dosyanız yoksa, [İstek gövdesi](https://westus2.dev.cognitive.microsoft.com/docs/services/AnomalyDetector/operations/post-timeseries-entire-detect)örneğinden dosyasında bir sample.jsoluşturabilirsiniz.
...
Daha fazla bilgi için [anomali ALGıLAMA Rest başvurusuna](https://westus2.dev.cognitive.microsoft.com/docs/services/AnomalyDetector/operations/post-timeseries-entire-detect)bakın.
