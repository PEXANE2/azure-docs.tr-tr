---
title: 'Hızlı başlangıç: Bing Video Arama istemci kitaplığını kullanma'
titleSuffix: Azure Cognitive Services
description: Video Arama API 'SI, arama yeteneklerini uygulamalarınızın tümleştirmesini kolaylaştıran istemci kitaplıkları sunar. Arama istekleri göndermeye başlamak için bu hızlı başlangıcı kullanın ve sonuçları geri alın.
