            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/cognitive-services/Bing-Autosuggest">Bing Otomatik Öneri</a></p>
                        <p><a href="/azure/cognitive-services/bing-custom-search">Bing Özel Arama</a></p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>LUIS ile amaç alma</h3>
                        <p><a href="/azure/cognitive-services/luis/luis-get-started-cs-get-intent">C# kullanma</a></p>
                        <p><a href="/azure/cognitive-services/luis/luis-get-started-java-get-intent">Java kullanma</a></p>
                        <p><a href="/azure/cognitive-services/luis/luis-get-started-node-get-intent">Node.js'yi kullanma</a></p>
                        <p><a href="/azure/cognitive-services/luis/luis-get-started-python-get-intent">Python’u kullanma</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Metin Analizi hizmeti ile dil algılama, yaklaşımı analiz etme</h3>
                        <p><a href="/azure/cognitive-services/Text-Analytics/quickstarts/csharp">C# kullanma</a></p>
                        <p><a href="/azure/cognitive-services/Text-Analytics/quickstarts/java">Java kullanma</a></p>
                        <p><a href="/azure/cognitive-services/Text-Analytics/quickstarts/nodejs">Node.js'yi kullanma</a></p>
                        <p><a href="/azure/cognitive-services/Text-Analytics/quickstarts/python">Python’u kullanma</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bing Web Araması ile ilgili web sorgularını alma</h3>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bing Görüntü Araması ile ilgili görüntü sorgularını alma</h3>
...
<ul class="cardsM panelContent singlePanelContent cols cols3" style="display:flex!important;">
    <li>
        <a class="card" href="/azure/cognitive-services/Computer-vision/tutorials/csharptutorial" data-linktype="external"><img class="cardImage" alt="" src="media/index/i_tasks.svg" data-linktype="external">
            <div class="cardText">
                <h3>Görüntü İşleme API'sini kullanarak bir uygulama oluşturma</h3>
            </div>
        </a>
    </li>
    <li>
        <a class="card" href="/azure/cognitive-services/speech-service/how-to-recognize-intents-from-speech-csharp" data-linktype="external"><img class="cardImage" alt="" src="media/index/i_tasks.svg" data-linktype="external">
            <div class="cardText" >
                <h3>Konuşma Tanıma SDK'sı ve LUIS ile amaçları tanıma</h3>
            </div>
        </a>
    </li>
    <li>
        <a class="card" href="/azure/cognitive-services/luis/luis-quickstart-intents-only" data-linktype="external"><img class="cardImage" alt="" src="media/index/i_tasks.svg" data-linktype="external">
            <div class="cardText">
                <h3>LUIS uygulaması oluşturma</h3>
            </div>
        </a>
    </li>
    <li>
        <a class="card" href="/azure/cognitive-services/Text-Analytics/tutorials/tutorial-power-bi-key-phrases" data-linktype="external"><img class="cardImage" alt="" src="media/index/i_tasks.svg" data-linktype="external">
            <div class="cardText">
                <h3>Metin Analizi özelliğini Power BI ile kullanma</h3>
            </div>
        </a>
    </li>
    <li>
        <a class="card" href="/azure/cognitive-services/bing-web-search/tutorial-bing-web-search-single-page-app" data-linktype="external"><img class="cardImage" alt="" src="media/index/i_tasks.svg" data-linktype="external">
            <div class="cardText">
                <h3>Bing Web Araması uygulaması oluşturma</h3>
            </div>
        </a>
    </li>
    <li>
