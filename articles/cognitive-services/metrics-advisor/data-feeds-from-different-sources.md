...
* **Bağlantı dizesi** : Azure Tablo depolamadan bağlantı dizesinin nasıl alınacağını öğrenmek için lütfen [bir bağlantı dizesini görüntüleme ve kopyalama](../../storage/common/storage-account-keys-manage.md?tabs=azure-portal&toc=%252fazure%252fstorage%252ftables%252ftoc.json#view-account-access-keys) bölümüne bakın.
