...
1. Abonelik açıldıktan sonra, sol taraftaki **kaynak sağlayıcıları**' na tıklayın. Sonra sağ bölmede, ara penceresinde *eşleme* araması yapın veya **Microsoft. eşleme** ' yi bulmak için kaydırma çubuğunu kullanın ve **duruma** bakın. Durum **_kayıtlıysa_*_, aşağıdaki adımları atlayın ve bölüm _* Create peerasn ' ye** geçin. Durum **_notregistered_*_ Ise _* Microsoft. eşleme** ' yi seçin ve **Kaydet**' e tıklayın.
...
1. Kayıt işleminin tamamlanabilmesi için en az bir dakika bekleyin. Ardından **Yenile** ' ye tıklayın ve durumun **_kayıtlı_** olduğunu doğrulayın.
