...
Microsoft Bulut bağlanırken birincil hedef, Microsoft 'un tüm veri merkezlerini birbirine bağlayan Microsoft 'un ortak ağ omurgası olan bir Kullanıcı sitesinden Microsoft küresel ağı 'na gidiş dönüş süresini (RTT) azaltarak gecikme süresini en aza indirmektir. ve birden çok bulut uygulaması giriş noktası. Bkz. [Office 365 ' de en iyi bağlantı ve performansı alma](https://techcommunity.microsoft.com/t5/Office-365-Blog/Getting-the-best-connectivity-and-performance-in-Office-365/ba-p/124694).

> [!div class="mx-imgBorder"]
> ![dağıtılmış erişim](./media/distributed-access.png) görüntüsü
