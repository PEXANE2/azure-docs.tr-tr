...
1. **Eşleme oluştur** sayfasında, **temel bilgiler** sekmesinde, kutulara aşağıda gösterildiği gibi kutuyu girin:
    ...
    ![Ekran görüntüsü yeni oluştur bağlantısı adlı bir eşleme sayfası temelleri Oluştur sekmesini gösterir.](./media/setup-basics-tab.png)
...
7. **İleri ' yi seçin:** devam etmek için yapılandırma.
    ...
    ![Ekran görüntüsü, tüm değerleri girilen eşleme sayfası temelleri Oluştur sekmesini gösterir.](./media/setup-direct-basics-filled-tab.png)
