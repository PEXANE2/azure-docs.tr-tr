...
Depolama sağlama sırasında, bağlama kimlik bilgileri için secretName adlı bir gizli dizi oluşturulur. Çok kiracılı bir bağlamda, secretNamespace için değeri açıkça ayarlamanız önemle önerilir, aksi takdirde depolama hesabı kimlik bilgileri diğer kullanıcılar tarafından okunabilir.
