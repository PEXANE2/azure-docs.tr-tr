...
> [!TIP]
> Betik Bash 4 özelliklerini kullanır, bu nedenle Bash 'nizin güncel olduğundan emin olun. Geçerli sürümünüzü ile `bash --version`kontrol edebilirsiniz.
...
Geri bildirim ve askcoin@microsoft.com soru için bizimle iletişim kurun.
