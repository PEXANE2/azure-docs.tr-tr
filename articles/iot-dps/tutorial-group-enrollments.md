...
description: Bu öğreticide, IoT Hub cihaz sağlama hizmeti için Java cihaz ve hizmet SDK 'Sı ve kayıt grupları kullanarak sanal bir X. 509.952 cihazı oluşturma ve sağlama
author: wesmc7777
ms.author: wesmc
ms.date: 11/12/2019
ms.topic: tutorial
