...
2. Bir komut istemi açın. Cihaz benzetim kod örneği için GitHub deposunu kopyalayın:
    ...
    ```
3. Kök `azure-iot-sdk-java` dizinine gidin ve gereken tüm paketleri indirmek için projeyi derleyin.
...
4. Örnek oluşturun ve sonra oluşturulan. jar dosyasını yürütmek için `target` klasöre gidin.
