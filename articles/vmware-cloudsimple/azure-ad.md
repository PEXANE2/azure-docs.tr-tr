---
title: Azure VMware çözümleri (AVS)-AVS özel bulutu 'nda Azure AD 'yi kimlik kaynağı olarak kullanın
description: Azure 'dan AVS 'ye erişen kullanıcıların kimliğini doğrulamak için Azure AD 'nin AVS özel bulutunuzda bir kimlik sağlayıcısı olarak nasıl ekleneceğini açıklar.
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/15/2019
ms.topic: article
...
ms.locfileid: "77015932"
---
# <a name="use-azure-ad-as-an-identity-provider-for-vcenter-on-avs-private-cloud"></a>AVS özel bulutu 'nda vCenter için kimlik sağlayıcısı olarak Azure AD kullanma

VMware yöneticilerinin vCenter 'a erişmesi için Azure Active Directory (Azure AD) ile kimlik doğrulaması yapmak üzere AVS özel bulut vCenter 'ı ayarlayabilirsiniz. Çoklu oturum açma kimlik kaynağı kurulduktan sonra, **cloudowner** kullanıcısı kimlik kaynağından vCenter 'a kullanıcı ekleyebilir.  
...
Azure AD, Microsoft çok kiracılı, bulut tabanlı dizin ve kimlik yönetimi hizmetidir. Azure AD, kullanıcıların kimliğini doğrulamak ve Azure 'da farklı hizmetlere erişmek için ölçeklenebilir, tutarlı ve güvenilir bir kimlik doğrulama mekanizması sağlar. Ayrıca, Azure AD 'yi bir kimlik doğrulama/kimlik kaynağı olarak kullanmak üzere herhangi bir üçüncü taraf hizmeti için Güvenli LDAP hizmetleri sağlar. Azure AD, AVS özel bulutunu yöneten kullanıcılar için AVS özel bulutuna erişim vermek üzere kullanılabilen temel Dizin Hizmetleri, Gelişmiş kimlik yönetimi ve uygulama erişim yönetimini birleştirir.
...
2. [AVS özel bulut vCenter 'unuzda bir kimlik kaynağı ayarlama](#set-up-an-identity-source-on-your-avs-private-cloud-vcenter)
...
## <a name="set-up-an-identity-source-on-your-avs-private-cloud-vcenter"></a>AVS özel bulut vCenter 'unuzda bir kimlik kaynağı ayarlama

1. AVS özel bulut vCenter 'niz için [ayrıcalıkları ilerletin](escalate-private-cloud-privileges.md) .
...
3. Ayrıcalıkların ilerletiden sonra AVS özel bulut vCenter 'unuzda oturum açın.
