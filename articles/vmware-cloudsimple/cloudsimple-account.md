...
description: CloudSimple hizmetinizle birlikte oluşturulan ve Azure aboneliğinizle ilişkili olan CloudSimple hesabını yönetme hakkında bilgi edinin.
author: sharaths-cs
ms.author: dikamath
ms.date: 04/10/2019
ms.topic: article
