...
description: CloudSimple hizmetinin Azure konumlarında yerel olarak VMware 'yi dağıtmanıza nasıl olanak sağladığını öğrenin. Özel bulutlar, Azure bulutunun geri kalanı ile tümleşiktir.
author: sharaths-cs
ms.author: dikamath
ms.date: 08/15/2019
ms.topic: article
