...
* Dosya indirmek için, tam dosya yolunu açılır pencereye (yani, `/home/user` Varsayılan olarak gösterilen dizin altındaki bir yol) girin ve "İndir" düğmesini seçin.  
> [!NOTE] 
