...
ms.locfileid: "100095635"
---
# <a name="azure-policy-built-in-definitions-for-azure-portal"></a>Azure portal için Azure Ilkesi yerleşik tanımları

Bu sayfa, Azure portal için [Azure ilkesi](../governance/policy/overview.md) yerleşik ilke tanımlarının bir dizinidir. Diğer hizmetlere yönelik diğer Azure Ilkesi için yerleşik olarak [bulunan Azure ilkesi yerleşik tanımları](../governance/policy/samples/built-in-policies.md)bölümüne bakın.
