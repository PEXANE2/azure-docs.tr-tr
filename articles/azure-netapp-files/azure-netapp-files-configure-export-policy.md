...
2.  Dışarı aktarma ilkesi kuralı oluşturmak için aşağıdaki bilgileri belirtin:   
    ...
    * **Salt okunurdur** ve **okuma/yazma** : nfsv 4.1 ile Kerberos Şifrelemesi kullanırsanız, [Nfsv 4.1 Kerberos şifrelemesini yapılandırma](configure-kerberos-encryption.md)bölümündeki yönergeleri izleyin.  Kerberos 'un performans etkisi için bkz. [NFSv 4.1 üzerinde Kerberos 'un performans etkisi](configure-kerberos-encryption.md#kerberos_performance). 
