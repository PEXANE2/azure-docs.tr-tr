---
title: BizTalk Services uygulamaları Azure Logic Apps 'ye geçirme
description: Uygulamalarınızı ve çözümlerinizi Microsoft Azure BizTalk Services (MABS) konumundan Azure Logic Apps 'a taşıma
services: logic-apps
