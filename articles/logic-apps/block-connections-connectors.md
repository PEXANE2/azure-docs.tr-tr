...
1. [Logic Apps bağlayıcıları listesini](/connectors/connector-reference/connector-reference-logicapps-connectors)ziyaret edin.
...
* [Azure Logic Apps için Azure Ilkesi yerleşik ilke tanımları](./policy-reference.md)
