...
1. Eylemin özellikleriyle ilgili bilgileri girin:
   ...
   ![Eylemin özelliklerine ilişkin bilgileri sağladığınız yeri gösteren ekran görüntüsü.](media/logic-apps-enterprise-integration-rosettanet/decode-action-details.png)
