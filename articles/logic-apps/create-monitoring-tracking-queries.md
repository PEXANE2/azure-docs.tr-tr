...
1. Boş bir sorgudan veya var olan mevcut sorgulardan başlayın.
   ...
   * Mevcut sorguların mevcut olup olmadığını denetlemek için sorgu araç çubuğunda, önceki sorgu çalıştırmalarının sorgularını gösteren **örnek sorgular** > **geçmiş**' i seçin veya önceden oluşturulmuş sorguları gösteren **sorgu Gezgini**' ni seçin.
