...
1. Koleksiyonda, hedef sisteme giden trafiğe izin veren bir kural ekleyin.
   ...
   * [Azure CLı: az Network Firewall Network-Rule](/cli/azure/ext/azure-firewall/network/firewall/network-rule#ext-azure-firewall-az-network-firewall-network-rule-create)
