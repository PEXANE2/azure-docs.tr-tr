...
> [!NOTE]
> Kaynak bağlantı noktaları kısa ömürlü olduğundan tüm kurallar için `*` olarak ayarlayın.

| Amaç | Direction | Hedef bağlantı noktaları | Kaynak hizmeti etiketi | Hedef hizmeti etiketi | Notlar |
|---------|-----------|-------------------|--------------------|-------------------------|-------|
