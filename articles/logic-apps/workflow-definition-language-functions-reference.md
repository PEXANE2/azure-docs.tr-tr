...
| <*ayarlar*> | Hayır | Dize | Tarafından `number.ToString(<format>, <locale>)`desteklendiği şekilde kullanılacak yerel ayar. Belirtilmemişse, varsayılan değer `en-us`. |
|||||
