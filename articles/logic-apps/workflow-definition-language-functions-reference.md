...
* Dize değeri boşsa, `-1` döndürülür:

* Dize ve alt dize değerlerinin ikisi de boşsa, `0` döndürülür.

* Yalnızca alt dize değeri boşsa, aşağıdaki iki değerin daha büyük bir örneği döndürülür:

  * `0`

  * Dizenin uzunluğu, eksi 1.
