---
title: Azure yönetilen disklerini yönetmek için Azure Depolama Gezgini kullanma
description: Bölgeler arasında Azure yönetilen diskini karşıya yüklemeyi, indirmeyi ve geçirmeyi ve Azure Depolama Gezgini kullanarak yönetilen diskin anlık görüntüsünü oluşturmayı öğrenin.
author: roygara
ms.author: rogarana
ms.date: 09/25/2019
ms.topic: how-to
...
1. Listeden aboneliğinizi seçip **Uygula**’ya tıklayın.
    ...
    ![Aboneliğinizi seçin](media/disks-upload-vhd-to-managed-disk-storage-explorer/select-subscription.png)
...
[Azure Portal kullanarak BIR VHD 'den VM oluşturma](./windows/create-vm-specialized-portal.md)hakkında bilgi edinin.

[Azure Portal kullanarak bir WINDOWS VM 'ye yönetilen veri diski eklemeyi](./windows/attach-managed-disk-portal.md)öğrenin.