...
ms.locfileid: "86526937"
---
# <a name="monitor-a-vm-with-azure-monitor-logs"></a>Azure İzleyici günlükleri ile VM izleme
...
| [azure vm extension set](/cli/azure/vm/extension) | Bir sanal makineye karşı VM uzantısı çalıştırır. |
