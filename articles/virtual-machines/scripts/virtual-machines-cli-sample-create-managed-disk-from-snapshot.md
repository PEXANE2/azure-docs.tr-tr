---
title: Snapshot (Linux)-CLı örneğinden yönetilen disk oluşturma
...
ms.locfileid: "89323211"
---
# <a name="create-a-managed-disk-from-a-snapshot-with-cli-linux"></a>CLı (Linux) ile anlık görüntüden yönetilen disk oluşturma
