---
title: Farklı bölgedeki bir depolama hesabına VHD olarak anlık görüntü gönderme/kopyalama-PowerShell örneği
...
| [New-AzStorageContext](/powershell/module/az.storage/new-azstoragecontext) | Hesap adını ve anahtarını kullanarak depolama hesabı bağlamı oluşturur. Bu bağlam depolama hesabında okuma/yazma işlemi gerçekleştirmek için kullanılabilir. |
| [Start-AzStorageBlobCopy](/powershell/module/az.storage/start-azstorageblobcopy) | Bir anlık görüntüde kullanılan VHD dosyasını bir depolama hesabına kopyalar |
