...
| [Add-AzVhd](/powershell/module/az.compute/add-azvhd)                                               | Şirket içi bir sanal makineden, Azure’da bulut depolama hesabındaki bir bloba sanal sabit disk yükler.                                                                       |
| [New-Azımageconfig](/powershell/module/az.compute/new-azimageconfig)                               | Yapılandırılabilir bir görüntü nesnesi oluşturur.                                                                                                                                                 |
| [Set-AzImageOsDisk](/powershell/module/az.compute/set-azimageosdisk)                               | Bir görüntü nesnesinde işletim sistemi disk özelliklerini ayarlar.                                                                                                                        |
| [New-Azımage](/powershell/module/az.compute/new-azimage)                                           | Yeni bir görüntü oluşturur.                                                                                                                                                                 |
...
| [Set-Azvmsourceımage](/powershell/module/az.compute/set-azvmsourceimage)                           | Sanal makine için bir görüntü belirtir.                                                                                                                                            |
| [Set-AzVMOSDisk](/powershell/module/az.compute/set-azvmosdisk)                                     | Bir sanal makinedeki işletim sistemi disk özelliklerini ayarlar.                                                                                                                      |
| [Set-AzVMOperatingSystem](/powershell/module/az.compute/set-azvmoperatingsystem)                   | Bir sanal makinedeki işletim sistemi disk özelliklerini ayarlar.                                                                                                                      |
