...
| [az vm extension set](https://docs.microsoft.com/cli/azure/vm) | Özel Betik Uzantısını sanal makineye ekleyerek WordPress yüklemeye yönelik bir betiği çağırır. |
