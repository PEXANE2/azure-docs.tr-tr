---
title: Azure PowerShell Betiği Örneği - DSC ile IIS
...
ms.locfileid: "87010028"
---
# <a name="use-an-azure-powershell-sample-script-to-create-an-iis-vm"></a>IIS VM oluşturmak için Azure PowerShell örnek komut dosyası kullanma
...
| [Set-Azvmexgeri](/powershell/module/az.compute/set-azvmextension) | Sanal makineye bir VM uzantısı ekleyin. Bu örnekte IIS yüklemek için DSC uzantısı kullanılır. |
