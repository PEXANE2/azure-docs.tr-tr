---
title: SysRq ve NMI aramaları için Azure Seri Konsolu | Microsoft Dokümanlar
...
### <a name="enable-nmi"></a>NMI'yi etkinleştirme
...
* Ana Seri Konsol Linux dokümantasyon sayfası [burada](serial-console-linux.md)yer almaktadır.
...
* Seri Konsol, [Windows](serial-console-windows.md) VM'ler için de kullanılabilir
