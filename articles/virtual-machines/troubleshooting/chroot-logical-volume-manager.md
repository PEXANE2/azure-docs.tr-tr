...
Lsblk komutunu yürütün ve/kurtarma işlemi şu anda/ve/Rescue/Boot/Boot ![chroot](./media/chroot-logical-volume-manager/chrooted.png)
...
**GRUB2-editenv listesi** , çekirdek varsayılan ![sonraki önyüklemede hangi çekirdeğin yükleneceğini gösterir](./media/chroot-logical-volume-manager/kernel-default.png)

**GRUB2-set-varsayılan** bir çekirdek ![GRUB2 kümesine değiştirmek için kullanılır](./media/chroot-logical-volume-manager/grub2-set-default.png)

**GRUB2-editenv** listesi, yeni çekirdek ![sonraki önyüklemede hangi çekirdeğin yükleneceğini gösterir](./media/chroot-logical-volume-manager/kernel-new.png)

**GRUB2-mkconfig** ![GRUB2 mkconfig](./media/chroot-logical-volume-manager/grub2-mkconfig.png) için gereken sürümleri kullanarak grub. cfg dosyasını yeniden oluşturur
...
Gerekirse **çekirdek**
![gelişmiş](./media/chroot-logical-volume-manager/rpm-remove-kernel.png) yükseltin
...
Portal **DISKLERINDEN** VM 'yi seçin ve **diski ayır ![
ayır** ' ı seçin](./media/chroot-logical-volume-manager/detach-disk.png) 

Değişiklikleri kaydedin ![bağlantıyı kaydet](./media/chroot-logical-volume-manager/save-detach.png) 

Artık disk, etkilenen VM 'nin orijinal işletim sistemi diski ile takas olmasına izin vermek için kullanılabilir hale gelir.

Azure portal başarısız olan sanal makineye gidin ve **diskleri** seçin -> **işletim sistemi diski**
takas diski ![takas edin](./media/chroot-logical-volume-manager/swap-disk.png) 
