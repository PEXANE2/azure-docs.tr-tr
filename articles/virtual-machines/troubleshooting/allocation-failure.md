...
Farklı bir VM boyutu kullanma seçeneğiniz yoksa, aynı coğrafi bölgede farklı bir bölgeye dağıtım yapmayı deneyin. Her bölgedeki kullanılabilir VM boyutları hakkında daha fazla bilgi için https://aka.ms/azure-regions
