...
Kullanıcı adınız, *securityauthority*\\*Kullanıcı* adı biçimindedir (örnek: Corp\user1), *SECURITYAUTHORITY* bölümü, sanal makinenin bilgisayar adı (yerel güvenlik yetkilisi için) veya bir Active Directory etki alanı adı olabilir.
...
* Yerel hesaplar için *ComputerName*\\*UserName* sözdizimini kullanın (örnek: SQL1\Admin4798).
* Etki alanı hesapları için *DomainName*\\*UserName* sözdizimini kullanın (örnek: CONTOSO\peterodman).
