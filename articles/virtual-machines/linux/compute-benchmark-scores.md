---
title: Azure Linux VM 'Leri için işlem kıyaslama puanları | Microsoft Docs
...
| VM Boyutu | CPU | vCPU sayısı | NUMA düğümleri | Bellek (GiB) | Ortalama puan | StdDev | StdDev | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
