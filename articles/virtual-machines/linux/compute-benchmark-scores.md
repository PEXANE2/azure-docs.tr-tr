---
title: Azure Linux VM'leri için hesaplama kıyaslama puanları
description: Linux çalıştıran Azure VM'ler için CoreMark hesaplama kıyaslama puanlarını karşılaştırın.
...
ms.locfileid: "78969739"
---
# <a name="compute-benchmark-scores-for-linux-vms"></a>Linux VM'leri için hesaplama kıyaslama puanları
Aşağıdaki CoreMark kıyaslama puanları, Azure'un Ubuntu'yu çalıştıran yüksek performanslı VM serisinin işlem performansını gösterir. [Windows VM'ler](../windows/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)için hesaplama kıyaslama puanları da mevcuttur.

## <a name="av2---general-compute"></a>Av2 - Genel İşlem
(15.03.2019 12:06:55 pbi 3897709)

| VM Boyutu | CPU | Sanal çekirdek | NUMA Düğümleri | Bellek(GİB) | Avg Puanı | Stdsapma | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
Not: Av2 serisi VM'ler çeşitli donanım türlerine ve işlemcilere dağıtılabilir (yukarıda görüldüğü gibi). Av2 serisi VM'ler, geliştirme ve test gibi giriş düzeyi iş yükleri için en uygun CPU performansına ve bellek yapılandırmalarına sahiptir. Boyut, dağıtılan donanımdan bağımsız olarak çalışan örnek için nispeten tutarlı işlemci performansı sunmak için daraltılır; ancak, belirli yeni işlemci optimizasyonlarından yararlanan yazılımlar işlemci türleri arasında daha önemli farklılıklar görebilir.

## <a name="b---burstable"></a>B - Patlanabilir
(15.03.2019 12:27:08 pbi 3897709)
...
Not: B Serisi VM'ler, performans gereksinimleri ne kadar büyük olan iş yükleri içindir. VM örnekleri, taban çizgisinden daha az kullanırken kredi birikir. VM kredi biriktirdiğinde, VM kısa CPU patlaması gereksinimlerini karşılamak için %100'e kadar kullanarak taban çizgisinin üzerine çıkabilir. Patlama süresi VM boyutu ve zaman bir fonksiyonu olan kullanılabilir kredi bağlıdır.  

CoreMark genellikle kullanılabilir seri krediler içinde tamamlayan kısa bir testtir.  Bu nedenle, yukarıdaki sayılar genellikle VM'nin patlama performansını temsil eder ve kısa, patlamalı, iş yüklerinin (B-Serisi tipik) performansının genellikle göreceğini yansıtır.

## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - Genel İşlem + Premium Depolama
(03.12.2019 18:52:03 pbi 3897709)
...
## <a name="dv3---general-compute"></a>Dv3 - Genel Hesaplama
(03.12.2019 18:54:27 pbi 3897709)
...
## <a name="dsv2---storage-optimized"></a>DSv2 - Depolama Optimize
(15.03.2019 12:53:13 pbi 3897709)
...
## <a name="dv2---general-compute"></a>Dv2 - Genel Hesaplama
(03.12.2019 18:53:48 pbi 3897709)
...
## <a name="esv3---memory-optimized--premium-storage"></a>Esv3 - Bellek Optimize + Premium Depolama
(03.12.2019 19:17:33 pbi 3897709)
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - Bellek Tercihi + Premium Depolama (yalıtılmış)
(04.11.2019 22:07:29 pbi 3897709)

| VM Boyutu | CPU | Sanal çekirdek | NUMA Düğümleri | Bellek(GİB) | Avg Puanı | Stdsapma | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E64is_v3 | Intel(R) Xeon(R) Cpu E5-2673 v4 @ 2.30GHz | 64 | 2 | 425.2 | 627,745 | 4,062 | 0.65% | 196 |

## <a name="ev3---memory-optimized"></a>Ev3 - Bellek Optimize
(03.12.2019 18:52:13 pbi 3897709)
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 - Bellek Optimize (izole)
(03.12.2019 18:57:51 pbi 3897709)
...
## <a name="fsv2---compute--storage-optimized"></a>Fsv2 - Bilgi İşlem + Depolama Optimize
(03.12.2019 18:51:35 pbi 3897709)

| VM Boyutu | CPU | Sanal çekirdek | NUMA Düğümleri | Bellek(GİB) | Avg Puanı | Stdsapma | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_F2s_v2 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 2 | 1 | 3.9 | 28,219 | 1,843 | 6.53% | 700 |
| Standard_F4s_v2 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 4 | 1 | 7.8 | 53,911 | 1,002 | 1.86% | 707 |
| Standard_F8s_v2 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 8 | 1 | 15.7 | 106,467 | 1,101 | 1.03% | 707 |
| Standard_F16s_v2 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 16 | 1 | 31.4 | 211,311 | 1,724 | 0.82% | 707 |
| Standard_F32s_v2 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 32 | 1 | 62.9 | 423,175 | 4,346 | 1.03% | 707 |
| Standard_F64s_v2 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 64 | 2 | 125.9 | 829,537 | 21,574 | 2.60% | 707 |
| Standard_F72s_v2 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 72 | 2 | 141.7 | 933,800 | 26,783 | 2.87% | 707 |

## <a name="fs---compute-and-storage-optimized"></a>Fs - Bilgi İşlem ve Depolama Optimize
(15.03.2019 12:12:51 pbi 3897709)
...
## <a name="f---compute-optimized"></a>F - İşlem Optimize
(03.12.2019 18:53:59 pbi 3897709)
...
## <a name="gs---storage-optimized"></a>GS - Depolama Optimize
(03.12.2019 22:22:33 pbi 3897709)
...
## <a name="g---compute-optimized"></a>G - İşlem Optimize
(03.12.2019 22:23:51 PBi 3897709)
...
## <a name="h---high-performance-compute-hpc"></a>H - Yüksek Performanslı İşlem (HPC)
(03.12.2019 22:50:51 PBi 3897709)
...
## <a name="lv2---storage-optimized"></a>Lv2 - Depolama Optimize
(14.03.2019 17:49:04 pbi 3897709)

| VM Boyutu | CPU | Sanal çekirdek | NUMA Düğümleri | Bellek(GİB) | Avg Puanı | Stdsapma | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32 Çekirdekli İşlemci | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 32 Çekirdekli İşlemci | 16 | 2 | 125.9 | 154,829 | 3,708 | 2.40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 32 Çekirdekli İşlemci | 32 | 4 | 251.9 | 310,811 | 7,751 | 2.49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 32 Çekirdekli İşlemci | 64 | 8 | 503.9 | 595,140 | 14,572 | 2.45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 32 Çekirdekli İşlemci | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |

## <a name="ls---storage-optimized"></a>Ls - Depolama Optimize
(03.12.2019 22:22:29 pbi 3897709)

| VM Boyutu | CPU | Sanal çekirdek | NUMA Düğümleri | Bellek(GİB) | Avg Puanı | Stdsapma | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standart_L4s | Intel(R) Xeon(R) Cpu E5-2698B v3 @ 2.00GHz | 4 | 1 | 31.4 | 56,488 | 2,916 | 5.16% | 287 |
| Standart_L8s | Intel(R) Xeon(R) Cpu E5-2698B v3 @ 2.00GHz | 8 | 1 | 62.9 | 107,017 | 2,323 | 2.17% | 287 |
| Standart_L16s | Intel(R) Xeon(R) Cpu E5-2698B v3 @ 2.00GHz | 16 | 1 | 125.9 | 210,865 | 3,653 | 1.73% | 280 |
| Standart_L32s | Intel(R) Xeon(R) Cpu E5-2698B v3 @ 2.00GHz | 32 | 2 | 251.9 | 399,963 | 9,254 | %2,31 | 287 |

## <a name="m---memory-optimized"></a>M - Bellek Optimize
(04.11.2019 19:30:39 pbi 3897709)
...
(03.12.2019 23:19:19 pbi 3897709)
...
(03.12.2019 23:08:03 pbi 3897709)
...
(03.12.2019 23:19:10 pbi 3897709)
...
(03.12.2019 23:08:13 pbi 3897709)
...
Linux numaraları Ubuntu'da [CoreMark](https://www.eembc.org/coremark/faq.php) çalıştırılarak hesaplandı. CoreMark sanal CPU sayısına ayarlanan iş parçacığı sayısı ve PThreads için eşzamanlılık ayarlanmış ile yapılandırıldı. Hedef yineleme sayısı, en az 20 saniyelik (genellikle çok daha uzun) bir çalışma süresi sağlamak için beklenen performansa göre ayarlandı. Nihai skor, tamamlanan yineleme lerin sayısını, testi çalıştırmak için geçen saniye sayısına bölünür. Her test her VM'de en az yedi kez çalıştırıldı. Yukarıda gösterilen test çalışma tarihleri. Testler, VM'nin tarih çalıştırılırken desteklenmişolduğu Azure ortak bölgelerindebirden fazla VM'de çalışır. Performans değişken olduğu için Temel A ve B (Burstable) serisi gösterilmez. N serisi GPU merkezli olarak gösterilmez ve Coremark GPU performansını ölçmez.

## <a name="next-steps"></a>Sonraki adımlar
* Depolama kapasiteleri, disk ayrıntıları ve VM boyutları arasında seçim yapmak için ek hususlar [için sanal makineler için Boyutlar'a](sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)bakın.
* Linux VM'lerde CoreMark komut dosyalarını çalıştırmak için [CoreMark komut dosyası paketini](https://download.microsoft.com/download/3/0/5/305A3707-4D3A-4599-9670-AAEB423B4663/AzureCoreMarkScriptPack.zip)indirin.
