---
title: Azure CLı ile VM adı çözümlemesi için dahili DNS kullanma | Microsoft Docs
...
[az vm create](/cli/azure/vm) ile bir VM oluşturun. `--nics` Bayrak, Azure 'a dağıtım sırasında vNIC 'yi VM 'ye bağlar. Aşağıdaki örnek, Azure yönetilen diskler ile `myVM` adlı bir VM oluşturur ve önceki adımdan adlı `myNic` vNIC 'yi ekler:
