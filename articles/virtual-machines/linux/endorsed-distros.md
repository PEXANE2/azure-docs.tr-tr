...
| Red Hat Enterprise Linux |RHEL 6.7+, 7.1+, 8.0+ |Çekirdek olarak |Paket: "WALinuxAgent" altında repo olarak <br/>Kaynak kodu: [GitHub](https://github.com/Azure/WALinuxAgent) |
