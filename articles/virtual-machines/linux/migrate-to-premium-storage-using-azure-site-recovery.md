---
title: Azure Site Kurtarma ile Linux VM'lerinizi Azure Premium Depolama'ya taşıyın
...
3. VM'lerin çoğaltılacağı bir bölge belirtin. Aynı bölgede geçiş amacıyla, kaynak VM'lerinizin ve kaynak depolama hesaplarınızın bulunduğu bölgeyi seçin. 
...
* [Linux sanal sabit disk yükleme](upload-vhd.md)
