...
VM 'niz ile birden çok SSH anahtarı kullanmak istiyorsanız, bu `--ssh-key-values sshkey-desktop.pub sshkey-laptop.pub`gibi, bunları boşlukla ayrılmış bir listeye girebilirsiniz.
