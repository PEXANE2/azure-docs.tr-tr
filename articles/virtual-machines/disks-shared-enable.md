...
Paylaşılan diskler çeşitli işletim sistemlerini destekler. Desteklenen işletim sistemleri için kavramsal makalenin [Windows](./disks-shared.md#windows) ve [Linux](./disks-shared.md#linux) bölümlerine bakın.
