...
Önce bu küme için sanal makineleri oluşturmanız gerekir. Daha sonra, bir yük dengeleyici oluşturur ve arka uç havuzlarındaki sanal makineleri kullanırsınız. [Standart yük dengeleyiciyi](../../../load-balancer/load-balancer-overview.md)öneririz.  
