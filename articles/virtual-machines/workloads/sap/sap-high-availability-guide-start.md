...
description: Bu makalede, SAP NetWeaver için Azure sanal makineler yüksek kullanılabilirliği hakkında bilgi edinin.
...
* SAP yüksek kullanılabilirlik:
  * ![Windows logosu.][Logo_Windows]  **Windows,** **Windows Server yük devretme kümesi (wsfc)** kullanarak
  * ![Linux logosu.][Logo_Linux] **Linux,** **Linux kümesi çerçevesini** kullanma
...
Makale hem ![ Windows logosunu ele alır.][Logo_Windows] **Windows** ve ![ Linux logosu.][Logo_Linux] **Linux**.
...
* ![Windows logosu.][Logo_Windows] [SAP Ass/SCS örnekleri için bir Windows Yük devretme kümesi ve **paylaşılan disk** kullanarak SAP yüksek kullanılabilirlik için Azure altyapısını hazırlama][sap-high-availability-infrastructure-wsfc-shared-disk]

* ![Windows logosu.][Logo_Windows] [SAP Ass/SCS örnekleri için bir Windows Yük devretme kümesi ve **dosya paylaşma** kullanarak SAP yüksek kullanılabilirlik için Azure altyapısını hazırlama][sap-high-availability-infrastructure-wsfc-file-share]

* ![Linux logosu.][Logo_Linux] [SAP Ass/SCS örnekleri için SUSE Linux Enterprise Server kümesi çerçevesi kullanarak SAP yüksek kullanılabilirlik için Azure altyapısını hazırlama][sap-suse-ascs-ha-setting-ha-nfs]

* ![Linux logosu.][Logo_Linux] [Azure NetApp dosyaları ile SAP Ass/SCS örnekleri için SUSE Linux Enterprise Server kümesi çerçevesi kullanarak SAP yüksek kullanılabilirlik için Azure altyapısını hazırlama][sap-suse-ascs-ha-setting-ha-anf]
...
* ![Windows logosu.][Logo_Windows] [SAP Ass/SCS örnekleri için bir Windows Yük devretme kümesi ve **paylaşılan disk** kullanarak SAP NetWeaver yüksek kullanılabilirliği 'ni yükler][sap-high-availability-installation-wsfc-shared-disk]

* ![Windows logosu.][Logo_Windows] [SAP Ass/SCS örnekleri için bir Windows Yük devretme kümesi ve **dosya paylaşma** kullanarak SAP NetWeaver yüksek kullanılabilirliği 'nı yükler][sap-high-availability-installation-wsfc-file-share]

* ![Linux logosu.][Logo_Linux] [SAP ASCS/SCS örnekleri için SUSE Linux Enterprise Server kümesi çerçevesi kullanarak SAP NetWeaver yüksek kullanılabilirliği 'nı yükler][sap-suse-ascs-ha-sap-installation]

* ![Linux logosu.][Logo_Linux] [Azure NetApp Files sahip SAP ASCS/SCS örnekleri için SUSE Linux Enterprise Server kümesi çerçevesi kullanarak SAP NetWeaver yüksek kullanılabilirliği 'nı yükler][sap-suse-ascs-ha-sap-installation-anf]
