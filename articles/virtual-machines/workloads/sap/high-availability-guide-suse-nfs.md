...
1. Load Balancer oluşturun (iç). [Standart yük dengeleyiciyi](../../../load-balancer/load-balancer-overview.md)öneririz.  
   1. Standart yük dengeleyici oluşturmak için aşağıdaki yönergeleri izleyin:
      ...
      1. Arka uç havuzlarını oluşturma
         1. NFS kümesinin parçası olması gereken tüm sanal makinelerin birincil ağ arabirimlerine bağlanıldı
            ...
            1. Yeni arka uç havuzunun adını girin (örneğin, **NW arka ucu**)
            1. Sanal ağ seçin
...
1. **[A]** DRBD Split-beybulunan algılama kurulumu
   ...
   Bölünmüş bir beyinme bildirimi ayarlama hakkında [resmi DRBD belgelerini](https://www.linbit.com/drbd-user-guide/users-guide-drbd-8-4/#s-split-brain-notification) okuyun.

   Ayrıca bölünmüş bir beyinden otomatik olarak kurtarmak mümkündür. Daha fazla bilgi için [Otomatik bölünmüş Bemek kurtarma ilkelerini](https://www.linbit.com/drbd-user-guide/users-guide-drbd-8-4/#s-automatic-split-brain-recovery-configuration) okuyun
