...
- 26/03/2020: [SAP uygulamaları için SLES'te Azure VM'lerde SAP NetWeaver](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse)için yüksek kullanılabilirlik değişikliği , SAP uygulamaları için Azure [NetApp Dosyaları ile SLES'te Azure VM'lerde SAP NetWeaver için yüksek kullanılabilirlik](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-netapp-files), [NFS için yüksek kullanılabilirlik SLES'teki Azure VM'lerde](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-nfs)Azure VM'lerde , [SLES multi-SID kılavuzunda Azure VM'lerde SAP NetWeaver için yüksek kullanılabilirlik,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-multi-sid) [SAP uygulamaları için RHEL'de Azure VM'lerde SAP NetWeaver için yüksek kullanılabilirlik](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-rhel) ve [Azure ile RHEL'de AZURE VM'lerde SAP NetWeaver için yüksek kullanılabilirlik ](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-rhel-netapp-files)Diyagramları güncellemek ve Azure Yük Bakiyesi arka uç havuzu oluşturma yönergelerini netleştirmek için SAP uygulamaları için NetApp Files
...
- 03/09/2020: [SAP uygulamaları için SUSE Linux Enterprise Server'da Azure VM'lerde SAP NetWeaver](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse)için yüksek kullanılabilirlik değişikliği , SAP için Azure [NetApp Dosyaları ile SUSE Linux Enterprise Server'da SAP NetWeaver için yüksek kullanılabilirlik uygulamalar](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-netapp-files), [SUSE Linux Enterprise Server'da Azure VM'lerde NFS için yüksek kullanılabilirlik](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-nfs), [Azure'da SUSE Linux Enterprise Server'da Pacemaker'ı ayarlama](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-pacemaker), [Pacemaker ile SUSE Linux Enterprise Server'da IBM Db2 LUW'un Azure VM'lerde yüksek kullanılabilirliği](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/dbms-guide-ha-ibm), [SUSE Linux Enterprise Server'da Azure VM'lerde SAP HANA'nın yüksek kullanılabilirliği](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-high-availability) ve [sles multi-SID kılavuzunda Azure VM'lerde SAP NetWeaver için yüksek kullanılabilirlik,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-multi-sid) kaynak aracısı azure-lb ile küme kaynaklarını güncellemek için 
...
- 11/08/2019: [SUSE Linux Enterprise Server'da Azure VM'lerde SAP HANA'nın yüksek kullanılabilirlik](sap-hana-high-availability.md)değişiklikleri , [Azure sanal makinelerde SAP HANA Sistem Çoğaltmasını Ayarlama (VM'ler)](sap-hana-high-availability-rhel.md), [SAP uygulamaları için SUSE Linux Enterprise Server'da SAP NetWeaver için Azure Sanal Makineler yüksek kullanılabilirlik](high-availability-guide-suse.md), SAP Net [NetApp Dosyaları ile SUSE Linux Enterprise Server'da SAP NetWeaver için Azure Sanal Makineler yüksek kullanılabilirlik](high-availability-guide-suse-netapp-files.md), Sanal Makineler, SAP Net Web'de Sanal [Azure Kurumsal Kurumsal Kurumsal ](high-availability-guide-rhel.md), [Azure Sanal Makineler, Red Hat Enterprise Linux'ta SAP NetWeaver için Azure NetApp Files ile yüksek kullanılabilirlik](high-availability-guide-rhel-netapp-files.md), [SUSE Linux Enterprise Server'da Azure VM'lerde NFS için yüksek kullanılabilirlik, SUSE Linux Enterprise Server'da](high-availability-guide-suse-nfs.md) [GlusterFS, SUSE Enterprise Linux'ta GlusterFS, Red Hat Enterprise Linux'ta GlusterFS,AZURE](high-availability-guide-rhel-glusterfs.md) standart yük dengeleyicisini önermek için  
...
- 22.10.2019: [SAP uygulamaları için SUSE Linux Enterprise Server'da Azure VM'lerde SAP NetWeaver](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse)için yüksek kullanılabilirlik değişikliği , SAP için Azure [NetApp Dosyaları ile SUSE Linux Enterprise Server'da SAP NetWeaver için yüksek kullanılabilirlik uygulamalar](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-netapp-files), [SUSE Linux Enterprise Server'da Azure VM'lerde NFS için yüksek kullanılabilirlik](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-nfs), [Azure'da SUSE Linux Enterprise Server'da Pacemaker'ı ayarlama](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-pacemaker), [Pacemaker ile SUSE Linux Enterprise Server'da IBM Db2 LUW'un Azure VM'lerde yüksek kullanılabilirliği](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/dbms-guide-ha-ibm), ve Azure Yük Dengesi Algılama Sertleştirme [suse Linux Enterprise Server'da Azure VM'lerde SAP HANA'nın yüksek kullanılabilirliği](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-high-availability)
