...
Bu belgede, Azure IaaS 'de SAP aşırı dağıtıldığında göz önünde bulundurmanız gereken birkaç farklı alanı ele alır. Bu belgeye yönelik bir önkoşul olarak, Azure [sanal makineler Için Azure sanal MAKINELERI DBMS dağıtımı, SAP iş yükü](dbms_guide_general.md) ve diğer kılavuzlar için [Azure belgelerindeki](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/get-started)belge konularını okuduğunuzdan önce göz önünde bulundurmanız gerekir. Bu belgede, Linux ve Windows Işletim sistemlerinde çalışan SAP Ao ele alınmaktadır. Azure 'da desteklenen en düşük sürüm, SAP Ade 16,0 düzeltme eki düzeyi 2 ' dir.  En son SAP sürümünü ve en son düzeltme eki düzeyini dağıtmanız önerilir.  En düşük SAP ASE 16,3 düzeltme eki düzeyi 7 önerilir.  SAP 'nin en son sürümü [hedeflenen asa 16,0 yayın zamanlaması ve CR liste bilgileri](https://wiki.scn.sap.com/wiki/display/SYBASE/Targeted+ASE+16.0+Release+Schedule+and+CR+list+Information)bölümünde bulunabilir.
...
Veri cihazları ve günlük cihazları için ayrı diskler önerilir.  Sistem veritabanları sybgüvenlik ve `saptools` adanmış diskler gerektirmez ve SAP veritabanı verilerini ve günlük cihazlarını içeren disklere yerleştirilebilir 
...
| SAP ATıCı sürümü | 16,3 PL 7 veya üzeri | 16,3 PL 7 veya üzeri | --- |
...
| Dosya sistemi | BIÇIMLENDIRMESI | XFS |
...
- SAP Ade 16,3 PL7 veya üstünü dağıtın
...
- Linux IŞLETIM sisteminde `saptune` SAP-Ao çalıştırma 
...
[Sybase asa 16,3 PL7 belgelerinin](https://help.sap.com/viewer/product/SAP_ASE/16.0.3.7/en-US) başlangıç sayfası, belgelerinin bulunduğu çeşitli belgelere bağlantılar sağlar:
...
[Her zaman-on DR node kurulumu ile Sybase ASE](https://techcommunity.microsoft.com/t5/running-sap-applications-on-the/installation-procedure-for-sybase-16-3-patch-level-3-always-on/ba-p/368199) 
