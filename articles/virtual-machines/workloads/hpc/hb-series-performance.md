---
title: HB Serisi VM boyut performansı-Azure sanal makineleri | Microsoft Docs
...
| RDMA gecikme & bant genişliği                        | 2.35 USEC, 96,5 GB/sn   |
...
|  #bytes         | #iterations     | t_min [mikro saniye]     | t_max [mikro saniye]     | t_typical [mikro saniye] | t_avg [mikro saniye]     | t_stdev [mikro saniye]   |
|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|
...
## <a name="osu-mpi-latency-test"></a>OSU MPı gecikme süresi sınaması

OSU MPı gecikme süresi test v 5.4.3.
...
| #bytes  | Gecikme süresi [mikro saniye] (MPICH 3,3 + CH4) | Gecikme süresi [mikro saniye] (OpenMPI 4.0.0) | Gecikme süresi [mikro saniye] (MVAPICH2 2,3) | Gecikme süresi [mikro saniye] (Intel MPı 2019) |
|------|----------|----------|----------|----------|
...
OSU MPı bant genişliği sınama v 5.4.3.

```azure-cli
./mvapich2-2.3.install/bin/mpirun_rsh -np 2 -hostfile ~/hostfile MV2_CPU_MAPPING=[INSERT CORE #] ./mvapich2-2.3/osu_benchmarks/mpi/pt2pt/osu_bw
```

| #Size            | Bant genişliği (MB/s) | Bant genişliği (GB/sn) |
|------------------|------------------|------------------|
| 2                | 4,03             | 0,03             |
| 4                | 8.2              | 0,07             |
| 8                | 16,15            | 0.13             |
