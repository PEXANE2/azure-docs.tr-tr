---
title: HB serisi VM boyut performansı - Azure Sanal Makineler | Microsoft Dokümanlar
description: Azure'daki HB serisi VM boyutları için performans testi sonuçları hakkında bilgi edinin.
...
HB serisi boyutlarda çeşitli performans testleri yapılmıştır. Bu performans testinin sonuçlarından bazıları aşağıda veda edilebistir.


| İş yükü                                        | HB                    |
|-------------------------------------------------|-----------------------|
| STREAM Triad                                    | ~260 GB/s (CCX başına 32-33 GB/s)  |
| Yüksek Performanslı Linpack (HPL)                  | ~ 1.000 GigaFLOPS (Rpeak), ~ 860 GigaFLOPS (Rmax) |
| RDMA gecikme & bant genişliği                        | 2.35usec, 96.5 Gb/s   |
| YEREL NVMe SSD üzerinde FIO                           | ~ 1.7 GB / s okur, ~ 1.0 GB / s yazıyor      |  
| IOR üzerinde 4 * Azure Premium SSD (P30 Yönetilen Diskler, RAID0)**  | ~ 725 MB / s okur, ~ 780 MB / yazıyor   |
...
| #bytes  | Gecikme [mikrosaniye] (MPICH 3.3 + CH4) | Gecikme [mikrosaniye] (OpenMPI 4.0.0) | Gecikme [mikrosaniye] (MVAPICH2 2.3) | Gecikme gecikmesi [mikrosaniye] (Intel MPI 2019) |
|------|----------|----------|----------|----------|
