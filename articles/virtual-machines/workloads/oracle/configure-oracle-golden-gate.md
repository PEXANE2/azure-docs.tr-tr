...
Aşağıdaki adım isteğe bağlıdır, ancak önerilir. Daha fazla bilgi için bkz. [Azure kullanılabilirlik kümeleri Kılavuzu](/previous-versions/azure/virtual-machines/windows/infrastructure-example).
...
İsteğe bağlı olarak,. bashrc dosyasına ORACLE_HOME ve ORACLE_SID ekleyebilir ve bu ayarların gelecekteki oturum açma işlemleri için kaydedilmesini sağlayabilirsiniz:
...
3. Yazılım konumunu değiştirin. Ardından **Başlat Yöneticisi** kutusunu seçin ve veritabanı konumunu girin. Devam etmek için **İleri** seçeneğini belirleyin.
...
2. Altın Kapı sahibini ve Kullanıcı hesaplarını oluşturun.
   ...
   > [!NOTE]
   > Sahip hesabının C# # öneki olmalıdır.
   >
...
#### <a name="2-set-up-the-replication-on-myvm1-primary"></a>2. myVM1 üzerinde çoğaltmayı ayarlama (birincil)
...
[VM dağıtımı CLI örneklerini keşfedin](https://github.com/Azure-Samples/azure-cli-samples/tree/master/virtual-machine)