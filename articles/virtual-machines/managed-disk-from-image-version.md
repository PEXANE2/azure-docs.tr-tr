...
`source`Değişkeni görüntü sürümünün kimliği olarak ayarlayın, ardından, yönetilen diski oluşturmak için [az disk Create](/cli/azure/disk?view=azure-cli-latest#az_disk_create) kullanın. 
