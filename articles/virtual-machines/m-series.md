...
ms.locfileid: "77493676"
---
# <a name="m-series"></a>A serisi

M serisi, yüksek bir vCPU sayısı (128 vCPU kadar) ve büyük miktarda bellek (3,8 TiB 'ye kadar) sunar. Son derece büyük veritabanları veya yüksek sanal CPU sayılarından ve büyük miktarda bellekten faydalanabilir diğer uygulamalar için de idealdir. A serisi boyutlar Intel® Xeon® CPU E7-8890 v3 @ 2.50 GHz 'yi temel alır

D serisi VM 'nin özelliği, hiper Iş parçacığı oluşturma teknolojisine sahip Intel®
