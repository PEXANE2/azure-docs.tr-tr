...
VM serisini belirlemek için [Windows sanal makinesi](./sizes.md) veya [Linux](./sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) için desteklenen boyutlara giderek başlayın.
