---
title: Azure sanal makineleri için bakım denetimi
description: Bakım denetimini kullanarak bakım Azure VM 'lerinize ne zaman uygulanacağını nasıl denetleyeceğinizi öğrenin.
