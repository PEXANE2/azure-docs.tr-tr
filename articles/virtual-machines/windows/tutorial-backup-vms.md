...
1. Tarayıcıyı açın ve varsayılan IIS sayfasını görüntülemek için VM'nin IP adresine bağlanın.
    ...
    ![Varsayılan IIS Web sayfasını gösteren ekran görüntüsü.](./media/tutorial-backup-vms/iis-working.png)
