---
title: Azure Windows VM 'Leri için kıyaslama puanlarını hesaplama | Microsoft Docs
...
| Size | vCPU sayısı | NUMA düğümleri | CPU | Çalıştırmalar | Ortalama taban oranı | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
