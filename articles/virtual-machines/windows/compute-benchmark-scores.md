---
title: Azure Windows VM'leri için hesaplama kıyaslama puanları
description: Windows Server çalıştıran Azure VM'ler için SPECint hesaplama kıyaslama puanlarını karşılaştırın.
author: cynthn
...
ms.locfileid: "82086241"
---
# <a name="compute-benchmark-scores-for-windows-vms"></a>Windows VM'ler için hesaplama kıyaslama puanları
Aşağıdaki SPECInt kıyaslama puanları, Windows Server çalıştıran belirli Azure VM'leri için bilgi işlem performansını gösterir. Linux [VM'ler](../linux/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)için hesaplama kıyaslama puanları da mevcuttur.


## <a name="av2---general-compute"></a>Av2 - Genel İşlem
| Boyut | Sanal çekirdek | NUMA Düğümleri | CPU | Çalıştırmalar | Avg Taban Oranı | Stdsapma | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
SPEC Int genellikle mevcut patlama kredileri egzoz oldukça uzun süren bir testtir.  Bu nedenle yukarıdaki sayılar VM'nin temel performansına daha yakındır (ancak çalıştırmalar arasında biriken bir miktar patlama süresini yansıtabilir).  Kısacası, iş yükleri (B-Serisi tipik) performansı genellikle Ds v3 Serisi'ne daha yakın olacaktır...
...
| Boyut | Sanal çekirdek | NUMA Düğümleri | CPU | Çalıştırmalar | Avg Taban Oranı | Stdsapma | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_F2s_v2 | 2 | 1 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 46 | 56.5 | 2.4 | 
| Standard_F4s_v2 | 4 | 1 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 60 | 110.2 | 4.7 | 
| Standard_F8s_v2 | 8 | 1 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 36 | 215.2 | 5.3 | 
| Standard_F16s_v2 | 16 | 1 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 36 | 409.3 | 15.5 | 
| Standard_F32s_v2 | 32 | 1 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 31 | 760.9 | 16.9 | 
| Standard_F64s_v2 | 64 | 2 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 33 | 1440.9 | 26.0 | 
| Standard_F72s_v2 | 72 | 2 | Intel(R) Xeon(R) Platin 8168 CPU @ 2.70GHz | 29 | 1372.1 | 8.2 | 
...
| Boyut | Sanal çekirdek | NUMA Düğümleri | CPU | Çalıştırmalar | Avg Taban Oranı | Stdsapma | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standart_L4s | 4 | 1 | Intel(R) Xeon(R) Cpu E5-2698B v3 @ 2.00GHz | 29 | 122.7 | 6.6 | 
| Standart_L8s | 8 | 1 | Intel(R) Xeon(R) Cpu E5-2698B v3 @ 2.00GHz | 30 | 223.3 | 7,5 | 
| Standart_L16s | 16 | 1 | Intel(R) Xeon(R) Cpu E5-2698B v3 @ 2.00GHz | 31 | 397.3 | 2,5 | 
| Standart_L32s | 32 | 2 | Intel(R) Xeon(R) Cpu E5-2698B v3 @ 2.00GHz | 31 | 766.1 | 3,5 | 
...
Windows numaraları Windows Server'da [SPECint 2006](https://www.spec.org/cpu2006/results/rint2006.html) çalıştırılarak hesaplandı. SPECint, vCPU başına bir kopya ile taban fiyat seçeneği (SPECint_rate2006) kullanılarak çalıştırıldı. SPECint, her bir testten ortanca değeri alarak ve bileşik bir puan oluşturmak için ağırlıklandırarak, her üç kez olmak üzere 12 ayrı testten oluşur. Bu testler daha sonra gösterilen ortalama puanları sağlamak için birden çok VM arasında çalıştırıldı.

## <a name="next-steps"></a>Sonraki adımlar
* Depolama kapasiteleri, disk ayrıntıları ve VM boyutları arasında seçim yapmak için ek hususlar [için sanal makineler için Boyutlar'a](sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)bakın.
