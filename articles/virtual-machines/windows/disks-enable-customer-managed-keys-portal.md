---
title: SSE ile yönetilen disklerle müşterinin yönettiği anahtarları etkinleştirmek için Azure portal kullanın
description: Yönetilen disklerinizde müşteri tarafından yönetilen anahtarları kullanarak sunucu tarafı şifrelemeyi etkinleştirmek için Azure portal kullanın.
author: roygara
ms.date: 07/10/2020
ms.topic: how-to
ms.author: rogarana
