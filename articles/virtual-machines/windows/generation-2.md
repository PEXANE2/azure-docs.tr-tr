...
* Windows 10 Pro, Windows 10 Kurumsal
...
Windows Server 2012 işletim sistemi olarak bir VM oluşturuyorsanız, nesil 1 (BIOS) veya nesil 2 (UEFI) VM SKU'yu seçeceksiniz ve bu aşağıdakigibi görünür:
...
* **İşletim sistemi disk boyutunu nasıl artırırım?**  
  2 TB'den büyük işletim sistemi diskleri nesilden nesile yeni 2 VM'dir. Varsayılan olarak, işletim sistemi diskleri nesil 2 VM'ler için 2 TB'den daha küçüktür. Disk boyutunu önerilen maksimum 4 TB'ye kadar artırabilirsiniz. İşletim sistemi disk boyutunu artırmak için Azure CLI veya Azure portalını kullanın. Diskleri programlı olarak genişletme hakkında bilgi [için](expand-os-disk.md)bkz.
...
* Şirket içi sistemlerden Azure'a yüklemek için [nasıl bir VHD hazırlayacağınızı](prepare-for-upload-vhd-image.md) öğrenin.
