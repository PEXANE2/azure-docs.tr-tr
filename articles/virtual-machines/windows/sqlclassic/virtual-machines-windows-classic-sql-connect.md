...
ms.locfileid: "78389069"
---
# <a name="connect-to-a-sql-server-virtual-machine-on-azure-classic-deployment"></a>Azure 'da SQL Server sanal makinesine bağlanma (klasik dağıtım)
