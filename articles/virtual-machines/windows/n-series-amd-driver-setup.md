...
1. Sürücü kurulum dosyalarını aşağı ayıklayın ve ayıklayın. Klasöre gidin ve Windows işletim sisteminiz için desteklenen sürücüyü yüklemek üzere ' Setup. exe ' yi çalıştırın.
