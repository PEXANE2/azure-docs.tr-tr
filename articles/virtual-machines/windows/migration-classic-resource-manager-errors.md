...
description: IaaS kaynaklarının Azure Service Management 'tan Azure Resource Manager yığınına geçirilmesi sırasında oluşan en yaygın hatalar ve azaltmaları hakkında bilgi edinin.
author: tanmaygore
manager: vashan
