...
description: Bu makalede, IaaS kaynaklarının Azure Hizmet Yönetimi'nden Azure Kaynak Yöneticisi yığınına geçişi sırasında en sık karşılaşılan hataları ve azaltıcı etkenleri kataloglar.
