...
15. **Yükle**'ye tıklayın. **Ad-birincil-DC** sanal makinesi otomatik olarak yeniden başlatılır.
...
5. **Etki alanı** onay kutusunu seçin ve metin kutusuna **corp.contoso.com** yazın. **Tamam** düğmesine tıklayın.
