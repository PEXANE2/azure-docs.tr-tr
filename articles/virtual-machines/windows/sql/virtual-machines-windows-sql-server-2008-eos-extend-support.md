...
* [End of support](/sql/sql-server/end-of-support/sql-server-end-of-life-overview) & [Genişletilmiş güvenlik güncelleştirmelerinin](/sql/sql-server/end-of-support/sql-server-extended-security-updates) destek bitişi