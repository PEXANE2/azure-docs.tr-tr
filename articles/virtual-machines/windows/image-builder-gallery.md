...
`RegistrationState` Sonraki adıma geçmeden `Registered` önce bekleyin.

Sağlayıcı kayıtlarınızı denetleyin. Her birinin döndürüldüğünden `Registered`emin olun.
