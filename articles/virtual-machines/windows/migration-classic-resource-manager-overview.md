---
title: Klasik kaynakları Azure Kaynak Yöneticisi'ne geçirin - Genel Bakış
description: Bu makale, klasik kaynaklardan Azure Kaynak Yöneticisi'ne platform destekli geçiş
...
ms.locfileid: "77915223"
---
# <a name="platform-supported-migration-of-iaas-resources-from-classic-to-azure-resource-manager"></a>IaaS kaynaklarının klasikten Azure Kaynak Yöneticisi'ne platform destekli geçişi
