...
description: Windows sanal makineleriniz için Azure Metadata Service kullanan Zamanlanmış olaylar.
...
- [Platform tarafından başlatılan bakım](../maintenance-and-updates.md?bc=/azure/virtual-machines/windows/breadcrumb/toc.json&toc=/azure/virtual-machines/windows/toc.json) (ÖRNEĞIN, VM yeniden başlatma, dinamik geçiş veya konak için güncelleştirmeleri koruma)
...
> [!NOTE]
> Bir yapı denetleyicisi (FC) kiracısındaki tüm sanal makinelerin (VM 'Ler) Zamanlanan Olaylar bir FC kiracısındaki tüm VM 'lere teslim edilir. FC kiracısı, bir tek başına VM 'ye, bulut hizmeti tamamına, bir kullanılabilirlik kümesine ve bir VM Ölçek kümesi (VMSS) için bir yerleştirme grubuna karşılık gelir ve kullanılabilirlik alanı kullanımından bağımsız olarak sahiptir. 
...
- [Azure 'Da Windows sanal makineleri için planlı bakım](../maintenance-and-updates.md?bc=/azure/virtual-machines/windows/breadcrumb/toc.json&toc=/azure/virtual-machines/windows/toc.json)hakkında bilgi edinin.
