...
| Kaynak Grubu     | Dağıtılan kaynağın içinde çalıştığı kaynak grubu. Daha fazla bilgi için Azure [Kaynak Yöneticisi'ne genel bakış bilgisine bakın.](../../azure-resource-manager/management/overview.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |    "MyRG"                                                                                                                                                                                                                                                                                                                                                        |
...
Meter Bölgesi metre ile ilişkilidir. Tüm bölgeler için tek bir fiyat kullanan bazı Azure hizmetleri için Meter Region alanı boş olabilir. Ancak, VM'ler Sanal Makineler için bölge başına özel fiyatlara sahip olduğundan, bu alan doldurulur. Benzer şekilde, Sanal Makineler için Kaynak Konumu VM'nin dağıtıldığı konumdur. Her iki alanda da Azure bölgesi aynıdır, ancak bölge adı için farklı bir dize kuralı olabilir.
...
Kullanım ayrıntılarınız hakkında daha fazla bilgi edinmek için microsoft [Azure faturanızı anlayın' a bakın.](../../cost-management-billing/understand/review-individual-bill.md)
