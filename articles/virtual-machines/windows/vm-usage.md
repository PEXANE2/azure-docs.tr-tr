...
Ek bilgi alanındaki hizmet türü alanı, dağıttığınız tam VM boyutuna karşılık gelir. Premium depolama VM 'Leri (SSD tabanlı) ve Premium olmayan depolama VM 'Leri (HDD tabanlı) aynı şekilde fiyatlandırılır. Standart\_DS2\_v2 gibi SSD tabanlı bir boyut dağıtırsanız, dızı alt kategori sütununda SSD olmayan boyut (' standart\_D2\_v2 VM ') ve ek bilgi alanındaki SSD boyutunu (' standart\_DS2\_v2 ') görürsünüz.
