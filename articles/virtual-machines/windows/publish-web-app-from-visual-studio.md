...
- VM 'nin yapılandırılmış bir DNS adı olmalıdır. Daha fazla bilgi için bkz. [WINDOWS VM için Azure Portal tam etki alanı adı oluşturma](../create-fqdn.md).
