...
VM için yönetici kullanıcı adını ve parolasını [Get-Credential](/powershell/module/microsoft.powershell.security/get-credential)ile ayarlayın:
