...
| * Kısıtlanmış vCPU 'Lar| Yalnızca belirli VM boyutları için kullanılır. [Kısıtlanmış vCPU özellikli boyut](https://docs.microsoft.com/azure/virtual-machines/constrained-vcpu) Için vCPU sayısını belirtir |
