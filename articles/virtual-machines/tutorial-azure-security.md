---
title: Öğretici-Azure 'da VM 'Ler için Azure Güvenlik Merkezi 'Ni kullanma
description: Bu öğreticide, Azure 'da sanal makinelerinizi korumaya ve güvenli hale getirmeye yardımcı olmak için Azure Güvenlik Merkezi özellikleri hakkında bilgi edineceksiniz.
author: cynthn
manager: gwallace
...
ms.locfileid: "94595250"
---
# <a name="tutorial-use-azure-security-center-to-monitor-virtual-machines"></a>Öğretici: sanal makineleri izlemek için Azure Güvenlik Merkezi 'ni kullanma
...
> [Jenkins, GitHub ve Docker ile CI/CD altyapısı oluşturma](/azure/developer/jenkins/pipeline-with-github-and-docker)