...
2. Azure Cosmos DB hesabınıza çapraz kaynak çağrıları yapaabilecek çıkış noktaları için virgülle ayrılmış bir liste belirtin. Örneğin, `https://www.mydomain.com`, `https://mydomain.com`, `https://api.mydomain.com`. Tüm kaynakları sağlamak ve **Gönder**' i seçmek için "\*" joker karakterini de kullanabilirsiniz. 
