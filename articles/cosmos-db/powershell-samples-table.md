...
Aşağıdaki tabloda Tablo API'si için Azure Cosmos DB örnek Azure PowerShell betiklerinin bağlantıları yer almaktadır.
...
|Görev | Description |
|---|---|
|[Hesap ve tablo oluşturma](scripts/powershell/table/ps-table-create.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Bir Azure Cosmos hesabı ve tablosu oluşturur. |
|[Tabloları listeleme veya al](scripts/powershell/table/ps-table-list-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Tabloları listeleyin veya alın. |
|[RU/s 'yi al](scripts/powershell/table/ps-table-ru-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Bir tablo için RU/s 'yi alın. |
|[RU/s 'yi Güncelleştir](scripts/powershell/table/ps-table-ru-update.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Bir tablo için RU/sn 'yi güncelleştirin. |
...
|[Kaynakları silinmeye karşı kilitle](scripts/powershell/table/powershell-table-lock.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Kaynakların kaynak kilitleri ile silinmesini engelleyin. |
|||
