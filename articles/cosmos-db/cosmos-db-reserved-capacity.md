...
Azure Cosmos DB ayrılmış kapasite, &mdash; bir yıllık veya üç yıllık ön taahhüt ile normal fiyatlarla yüzde 65 ' a kadar Cosmos DB maliyetlerinizi önemli ölçüde azaltabilir. Ayrılmış kapasite bir faturalandırma indirimi sağlar ve Azure Cosmos DB kaynaklarınızın çalışma zamanı durumunu etkilemez.
...
:::image type="content" source="./media/cosmos-db-reserved-capacity/reserved-capacity-recommendation.png" alt-text="Ayrılmış kapasite önerileri":::
