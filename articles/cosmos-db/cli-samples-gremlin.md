---
title: Azure Cosmos DB Gremlin API için Azure CLI örnekleri
description: Azure Cosmos DB Gremlin API için Azure CLI örnekleri
author: markjbrown
...
| [İş buzunu değiştir](scripts/cli/gremlin/throughput.md?toc=%2fcli%2fazure%2ftoc.json) | Bir veritabanında ve grafikte RU/s'yi güncelleştirin.|
