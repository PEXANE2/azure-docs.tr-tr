...
> [!NOTE]
> Bu makale, Azure Cosmos DB MongoDB 3,6 için API 'sidir. MongoDB 4,0 sürümü için bkz. [mongodb 4,0 desteklenen özellikler ve sözdizimi](mongodb-feature-support-40.md).
