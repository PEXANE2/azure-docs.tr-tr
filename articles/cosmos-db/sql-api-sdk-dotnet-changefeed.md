...
|**API belgeleri**|[Değişiklik Akışı İşlemcisi kitaplığı API başvurusu belgeleri](/dotnet/api/microsoft.azure.documents.changefeedprocessor?view=azure-dotnet&preserve-view=true)|
