...
3. Portaldan USERNAME değerini 13. satırdaki `<PROVIDE>` üzerine yapıştırın.
...
3. Portala geri dönün ve PASSWORD değerini kopyalayın. Portaldan PASSWORD değerini 14. satırdaki `<PROVIDE>` üzerine yapıştırın.
...
4. Program.cs dosyasını kaydedin.
