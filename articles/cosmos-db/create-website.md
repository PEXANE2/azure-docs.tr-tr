...
:::image type="content" source="./media/create-website/template-deployment.png" alt-text="Azure’a dağıtın":::
...
:::image type="content" source="./media/create-website/resource-group.png" alt-text="Azure’a dağıtın":::
...
:::image type="content" source="./media/create-website/cosmos-keys.png" alt-text="Azure’a dağıtın":::
...
:::image type="content" source="./media/create-website/application-settings.png" alt-text="Azure’a dağıtın":::
...
:::image type="content" source="./media/create-website/deployment-center.png" alt-text="Azure’a dağıtın":::
...
:::image type="content" source="./media/create-website/app-home-screen.png" alt-text="Azure’a dağıtın":::
...
:::image type="content" source="./media/create-website/startup.png" alt-text="Azure’a dağıtın":::
...
:::image type="content" source="./media/create-website/template-keys.png" alt-text="Azure’a dağıtın":::
...
:::image type="content" source="./media/create-website/deploy-from-github.png" alt-text="Azure’a dağıtın":::
