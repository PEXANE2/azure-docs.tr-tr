...
[:::image type="content" source="../media/template-deployments/deploy-to-azure.svg" alt-text="Azure’a dağıtma":::](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-cosmosdb-webapp%2Fazuredeploy.json)
...
:::image type="content" source="./media/create-website/template-deployment.png" alt-text="Azure’a dağıtma":::
...
:::image type="content" source="./media/create-website/resource-group.png" alt-text="Azure’a dağıtma":::
...
:::image type="content" source="./media/create-website/cosmos-keys.png" alt-text="Azure’a dağıtma":::
...
:::image type="content" source="./media/create-website/application-settings.png" alt-text="Azure’a dağıtma":::
...
:::image type="content" source="./media/create-website/deployment-center.png" alt-text="Azure’a dağıtma":::
...
:::image type="content" source="./media/create-website/app-home-screen.png" alt-text="Azure’a dağıtma":::
...
:::image type="content" source="./media/create-website/startup.png" alt-text="Azure’a dağıtma":::
...
:::image type="content" source="./media/create-website/template-keys.png" alt-text="Azure’a dağıtma":::
...
:::image type="content" source="./media/create-website/deploy-from-github.png" alt-text="Azure’a dağıtma":::
