...
1. Baltimore CyberTrust kök sertifikasını öğesinden [https://cacert.omniroot.com/bc2025.crt](https://cacert.omniroot.com/bc2025.crt)yerel olarak indirin. `.cer` dosya uzantısını kullanarak dosyayı yeniden adlandırın.
...
>
> Artık düzgün şekilde biçimlendirilen bir. cer dosyanız olmalıdır. İçindeki `uprofile.js` yolun bu dosyaya işaret ettiğini doğrulayın.
...
2. Gerekli `npm install` NPM modüllerini yüklemek için ' i çalıştırın.
