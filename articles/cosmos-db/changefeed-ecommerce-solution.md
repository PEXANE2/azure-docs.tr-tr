...
2. **Cosmos DB:** Oluşturulan veriler bir Azure Cosmos DB koleksiyonunda depolanır.  

3. **Değişiklik akışı:** Değişiklik akışı Azure Cosmos DB koleksiyonundaki değişiklikleri dinler. Her seferinde yeni bir belge (yani gibi bir öğe görüntüleyen bir kullanıcı bir olay meydana geldiğinde bunların sepetine öğe ekleme veya bir öğe satın alma) koleksiyona eklendiğinde, değişiklik akışı tetikleyen bir [Azure işlevi](../azure-functions/functions-overview.md).  
