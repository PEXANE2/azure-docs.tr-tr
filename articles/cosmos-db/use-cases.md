...
:::image type="content" source="./media/use-cases/apps-with-global-reach.png" alt-text="Azure Cosmos DB Web uygulaması başvuru mimarisini gösteren diyagram." border="false":::
