---
title: Azure Cosmos DB SQL (Core) API 'SI için Azure CLı örnekleri
description: Azure Cosmos DB SQL (Core) API 'SI için Azure CLı örnekleri
author: markjbrown
