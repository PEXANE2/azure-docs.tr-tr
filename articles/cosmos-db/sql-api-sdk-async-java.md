...
|**Başlarken** | [Zaman uyumsuz Java SDK 'sını kullanmaya başlama](https://github.com/Azure-Samples/azure-cosmos-db-sql-api-async-java-getting-started) | 
...
| **Desteklenen en düşük çalışma zamanı**|[JDK 8](https://aka.ms/azure-jdks) | 
