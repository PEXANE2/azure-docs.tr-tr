...
---
# <a name="restrict-user-access-to-data-operations-only"></a>Yalnızca veri işlemlerine Kullanıcı erişimini kısıtlama
...
Her bir kimlik doğrulama yöntemi, farklı işlem kümelerine erişim sağlar: ![her bir çakışma, kimlik doğrulama türü başına işlem](./media/how-to-restrict-user-data/operations.png).
...
- `$MySubscriptionId`-izinleri sınırlandırmak istediğiniz Azure Cosmos hesabını içeren abonelik KIMLIĞI. Örneğin: `e5c8766a-eeb0-40e8-af56-0eb142ebf78e`.
