...
> [!NOTE]
> Emulator 'u/Key seçeneğiyle başlattıysanız, yerine `C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw==`oluşturulan anahtarı kullanın. /Key seçeneği hakkında daha fazla bilgi için bkz [. komut satırı araç başvurusu.](#command-line-syntax)
...
[MongoDB için Azure Cosmos DB API](mongodb-introduction.md)kullanıyorsanız, aşağıdaki bağlantı dizesini kullanın:
