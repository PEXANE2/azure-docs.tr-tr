---
title: MongoDB özellik desteği için Azure Cosmos DB API 'sini kullanma
description: MongoDB 3,4 için Azure Cosmos DB 'in API 'sine yönelik API 'nin sağladığı özellik desteği hakkında bilgi edinin.
...
ms.locfileid: "70050103"
---
# <a name="azure-cosmos-dbs-api-for-mongodb-supported-features-and-syntax"></a>MongoDB için API Azure Cosmos DB: desteklenen özellikler ve söz dizimi
...
Cosmos DB, genel önizlemede toplama işlem hattını destekler. Genel önizlemenin katılımı hakkında yönergeler için [Azure bloguna](https://aka.ms/mongodb-aggregation) bakın.
...
Cosmos DB, varsayılan olarak veritabanına yazılan belgelerdeki her alanı dizine ekler. Benzersiz dizinler, varsayılan "_id" anahtarında özgünlüğün korunmasına benzer bir şekilde bir koleksiyondaki tüm belgeler genelinde belirli bir alanda yinelenen değer olmamasını sağlar. ' Unique ' kısıtlaması dahil CreateIndex komutunu kullanarak Cosmos DB özel dizinler oluşturabilirsiniz.
...
<sup>Not: Bu makalede, MongoDB veritabanları ile kablo protokol uyumluluğu sağlayan Azure Cosmos DB bir özelliği açıklanır. Microsoft bu hizmeti sağlamak için MongoDB veritabanlarını çalıştırmaz. Azure Cosmos DB MongoDB, Inc ile bağlantılı değildir.</sup>
