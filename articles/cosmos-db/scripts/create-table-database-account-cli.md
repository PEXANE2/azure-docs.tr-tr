---
title: Azure CLı betiği-bir Azure Cosmos DB Tablo API'si hesabı, veritabanı ve tablo oluşturma
...
ms.locfileid: "69616705"
---
# <a name="azure-cosmos-db-create-a-table-api-account-using-azure-cli"></a>Azure Cosmos DB: Azure CLı kullanarak Tablo API'si hesabı oluşturma
