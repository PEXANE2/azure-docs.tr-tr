---
title: Azure Cosmos DB için bir SQL (Core) API veritabanı ve kapsayıcısı oluşturun
description: Azure Cosmos DB için bir SQL (Core) API veritabanı ve kapsayıcısı oluşturun
author: markjbrown
ms.author: mjbrown
...
---
# <a name="create-an-azure-cosmos-sql-core-api-account-database-and-container-using-azure-cli"></a>Azure CLı kullanarak bir Azure Cosmos SQL (çekirdek) API hesabı, veritabanı ve kapsayıcısı oluşturma
