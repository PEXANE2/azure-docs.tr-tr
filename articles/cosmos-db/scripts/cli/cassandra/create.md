...
---
# <a name="create-an-azure-cosmos-cassandra-api-account-keyspace-and-table-using-azure-cli"></a>Azure CLI'yi kullanarak Bir Azure Cosmos Cassandra API hesabı, anahtar alanı ve tablo oluşturun
