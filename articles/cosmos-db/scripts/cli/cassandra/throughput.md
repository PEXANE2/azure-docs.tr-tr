...
| [az cosmosdb Cassandra anahtar alanı üretilen iş güncelleştirmesi](/cli/azure/cosmosdb/cassandra/keyspace/throughput?view=azure-cli-latest&preserve-view=true#az-cosmosdb-cassandra-keyspace-throughput-update) | Azure Cosmos Cassandra keyspace için RU/s 'yi güncelleştirin. |
