...
|   |   |
|---|---|
|**SDK'sını indirme**|[PyPI](https://pypi.python.org/pypi/azure-cosmosdb-table/)|
...
|**SDK'sı için katkıda bulunan**|[GitHub](https://github.com/Azure/azure-cosmosdb-python/tree/master/azure-cosmosdb-table)|
