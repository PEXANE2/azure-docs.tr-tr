---
title: Azure Cosmos DB REST API kullanarak geri yüklenebilen veritabanı hesaplarını listeleme
description: Bir abonelik altında bulunan tüm geri yüklenebilen Azure Cosmos DB veritabanı hesaplarını listeler.
author: kanshiG
...
ms.locfileid: "99537586"
---
# <a name="list-restorable-database-accounts-using-azure-cosmos-db-rest-api"></a>Azure Cosmos DB REST API kullanarak geri yüklenebilen veritabanı hesaplarını listeleme
...
Abonelik altında bulunan tüm geri yüklenebilen Azure Cosmos DB veritabanı hesaplarını listeler. Bu çağrı için `Microsoft.DocumentDB/locations/restorableDatabaseAccounts/read` izin gerekir.
...
| Properties. Restokıblelocations |[Restokıblelocationresource](#restorablelocationresource)[]| Veritabanı hesabının geri yüklenebileceği bölgelerin listesi. |
...
* [Geri yüklenebilen veritabanı hesapları-konuma göre liste.](restorable-database-accounts-list-by-location.md)
