...
Hizmet kullanılamıyor özel durumlar, zaman aşımına neden olan geçici bağlantı sorunları olduğunda yüzeysel olabilir. Genellikle, bu senaryoya ilişkin yığın izleme, `ServiceUnavailableException` Tanılama ayrıntılarıyla bir hata içerecektir. Örneğin:
