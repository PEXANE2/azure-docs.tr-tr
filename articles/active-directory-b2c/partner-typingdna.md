...
3. [Buradakı](./custom-policy-ui-customization.md#3-configure-cors) CORS gereksinimlerini takip eden SAĞLAYıCııNıZDA HTML dosyalarını barındırın.
