...
| Mevcut uygulamaları b2clogin.com 'e geçirme | Login.microsoftonline.com 'ın kullanımdan kaldırılması, 04 Aralık 2020 ' de tüm Azure AD B2C kiracılar için geçerli olur. [Daha fazla bilgi edinin](b2clogin.md). |
