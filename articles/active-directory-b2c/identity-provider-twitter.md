...
Bu noktada Twitter kimlik sağlayıcısı ayarlanmıştır, ancak oturum açma sayfalarında henüz mevcut değildir. Twitter kimlik sağlayıcısını bir Kullanıcı akışına eklemek için:
