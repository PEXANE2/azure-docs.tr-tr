...
Azure Active Directory (Azure AD) B2C 'de bir GitHub hesabını bir [kimlik sağlayıcısı](active-directory-b2c-reference-oauth-code.md) olarak kullanmak için kiracınızda onu temsil eden bir uygulama oluşturmanız gerekir. Zaten bir GitHub hesabınız yoksa kaydolabilirsiniz [https://www.github.com/](https://www.github.com/).
