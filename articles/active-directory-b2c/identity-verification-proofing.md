---
title: Azure AD B2C için kimlik doğrulama ve doğrulama
titleSuffix: Azure AD B2C
description: Kimlik doğrulama ve doğrulama çözümlerini sağlamak üzere Azure AD B2C ile tümleştirilen iş ortaklarımız hakkında bilgi edinin
...
ms.locfileid: "105027682"
---
# <a name="identity-verification-and-proofing-partners"></a>Kimlik doğrulama ve sağlama iş ortakları
...
Aşağıdaki ISV iş ortaklarıyla Microsoft iş ortakları.
