...
1. Üstteki menüden **Dizin + abonelik** filtresi ' ni seçin ve ardından Mau faturalandırmaya yükseltmek istediğiniz Azure AD B2C dizini seçin.<br/>
    Azure portal](./media/billing/portal-mau-01-select-b2c-directory.png) dizin ve abonelik filtresi ![
...
1. MAU faturalandırmayı yükseltmeyi gerçekleştirmek için **Onayla** ' yı seçin.<br/>
    Azure portal](./media/billing/portal-mau-04-confirm-change-to-mau.png) ![MAU tabanlı faturalandırma onay iletişim kutusu
...
1. **Oluştur**’u seçin.
    Azure portal Azure AD B2C kaynak oluşturma sayfasını ![](./media/billing/portal-01-create-b2c-resource-page.png)
