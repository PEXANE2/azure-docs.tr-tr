...
[En güncel Azure AD B2C fiyatlandırmayla](https://azure.microsoft.com/pricing/details/active-directory-b2c/)birlikte kullanıldığında günlük, haftalık ve aylık Azure tüketimini tahmin edebilirsiniz.  Bir tahmin özellikle, kiracı davranışında yapılan ve genel maliyeti etkileyebilecek değişiklikler için plan yaptığınızda faydalıdır. [Bağlı Azure aboneliğinizdeki](active-directory-b2c-how-to-enable-billing.md)gerçek maliyetleri gözden geçirebilirsiniz.
