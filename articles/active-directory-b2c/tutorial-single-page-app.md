...
1. Kaydolma iş akışında, kullanıcı kimliğini bir e-posta adresi kullanarak toplamak ve doğrulamak için bir sayfa sunar. Kaydolma iş akışı, kullanıcının parolasını ve Kullanıcı akışında tanımlanan istenen öznitelikleri de toplar.
    ...
    ![Oturum açma/kaydolma Kullanıcı akışından sunulan kaydolma sayfası](./media/tutorial-single-page-app/azure-ad-b2c-sign-up-workflow.png)
...
> [Öğretici: Azure AD B2C kullanarak SPA 'dan ASP.NET Core Web API 'sine erişim Izni verme >](tutorial-single-page-app-webapi.md)
