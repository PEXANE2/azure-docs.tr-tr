...
1. 授权回调域`https://your-tenant-name.b2clogin.com/your-tenant-name}.onmicrosoft.com/oauth2/authresp` ( **授权回调域** geri arama URL) girin. Örneğin, contoso `tenant_name` Ise, URL 'yi olarak ayarlayın `https://contoso.b2clogin.com/contoso.onmicrosoft.com/oauth2/authresp`.
