...
Bu makale, Kullanıcı geçiş makalesinin devamlılığı ve sosyal kimlik geçişine odaklanır. Başlamadan önce [Kullanıcı geçişini](user-migration.md)okuyun.
...
Örnek uygulamayı kullanma hakkında daha fazla bilgi için bkz [. Azure Active Directory B2C: Kullanıcı geçişi](user-migration.md)
