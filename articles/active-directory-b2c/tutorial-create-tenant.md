...
1. **Mevcut bir Azure AD B2C kiracıyı Azure aboneliğime bağla** ' yı seçin. Bu adımı gerçekleştirmek için Owner rolü olarak oturum açmış olmanız gerekir.
