...
|TokenLifeTimeInSeconds| Hayır| SAML onaylama süresini belirtir. Bu değer, yukarıda belirtilen NotBefore değerinden saniye cinsinden olur. Varsayılan değer 300 saniyedir (5 dakika). |
