...
- İki algılayıcı sağlayıcısından gelen **algılayıcı verileri algılayıcı** [araçları](https://www.davisinstruments.com/product/enviromonitor-gateway/), [Teralytic](https://teralytic.com/)
