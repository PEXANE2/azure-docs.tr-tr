...
1. **Haritada işaretle**: harita denetim aracını kullanarak grubun sınırını çizin ve işaretleyin. Sınırları işaretlemek için, proje grubu ![](./media/create-farms-in-azure-farmbeats/pencil-icon-1.png) ve tam sınırları işaretleyin.
