---
title: Azure PowerShell örnekleri - Azure Cloud Service (genişletilmiş destek) oluşturma
description: Azure bulut hizmeti (genişletilmiş destek) dağıtımları oluşturmak için örnek betikler
ms.topic: sample
...
## <a name="create-new-cloud-service-with-single-role"></a>Tek rol ile yeni bulut hizmeti oluştur
...
## <a name="create-new-cloud-service-with-single-role-and-remote-desktop-extension"></a>Tek rol ve Uzak Masaüstü uzantısı ile yeni bulut hizmeti oluşturma
...
## <a name="create-a-cloud-service-with-a-single-role-and-windows-azure-diagnostics-extension"></a>Tek bir rol ve Windows Azure Tanılama Uzantısı ile bulut hizmeti oluşturma
...
-ExtensionProfileExtension $extension
```
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Key Vault tek rol ve sertifikayla yeni bulut hizmeti oluştur
...
## <a name="create-new-cloud-service-with-multiple-roles-and-extensions"></a>Birden çok rol ve uzantı ile yeni bulut hizmeti oluşturma
