...
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Anahtar kasasından tek bir rol ve sertifikayla yeni bir bulut hizmeti oluşturun
