...
Önceden hazırlanmış panolar dilediğinizi kullanabilirsiniz veya kendi panonuzu ile özelleştirilmiş raporlar oluşturabilirsiniz. Cloudyn raporlarını bilmiyorsanız bkz. [Cloudyn raporlarını kullanma](use-reports.md).

## <a name="create-a-custom-dashboard"></a>Özel bir pano oluşturma

Özel bir pano ile hızla çalışmaya başlamak için özelliklerini kullanmak için mevcut bir çoğaltabilirsiniz. Ardından, gereksinimlerinize uyacak şekilde değiştirebilirsiniz. Kopyalamak istediğiniz panoda **farklı kaydet**' e tıklayın. Özelleştirilmiş Panolar yalnızca çoğaltabilirsiniz — Cloudyn'e dahil olan panoları yineleyemez.

Özel bir Pano oluşturmak için:

1. Giriş sayfasında **Yeni Ekle**' ye tıklayın. Panom'u sayfası görüntülenir.  
    Yeni raporlar eklediğiniz Pano sayfamı ![](./media/dashboards/my-dashboard.png)
...
2. Raporda istediğiniz değişiklikleri yapın ve **Kaydet**' e tıklayın. Rapor güncelleştirilir ve yaptığınız değişiklikleri görüntüler.

## <a name="share-a-custom-dashboard"></a>Özel bir panoyu paylaşma

Özel bir panoyu başkalarıyla _ortak_ veya _varlığına_paylaşabilirsiniz. Tüm kullanıcılar, ortak paylaştığınızda panoyu görüntüleyebilirsiniz. Yalnızca geçerli varlık erişimi olan kullanıcılar, My varlığa paylaştığınızda panoyu görüntüleyebilirsiniz. My varlık ve genel ile özel bir pano paylaşma adımları benzerdir.

Kamu için özel bir panoyu paylaşmak için:

1. Panoda **Pano ayarları**' na tıklayın. Pano ayarları kutusu görüntülenir.  
    özel bir Pano için Pano ayarlarını ![](./media/dashboards/dashboard-options.png)
2. Pano ayarları kutusunda, ok simgesine ve ardından **Public**öğesine tıklayın. Genel Pano onay iletişim kutusunda görüntülenir.
3. **Evet**' e tıklayın. Panoyu başkalarının kullanıma sunuldu.
...
Pano bileşenini silmek için, pano bileşeninde **Sil**' e tıklayın. **Sil** ' i tıklatmak Pano bileşenini hemen siler.
...
2. **Paylaşma** ' ya ve ardından **genel**' i seçin.
3. Genel genel Pano onay kutusu görüntülenir.
4. Panoyu genel genel pano olarak ayarlamak için **Evet** ' e tıklayın.

Geçerli bir varlığın tüm kullanıcılarla pano paylaşma için:

1. Pano giriş sayfasında, **Düzenle**' ye tıklayın.
2. **Paylaşma** ' ya tıkladıktan sonra **varlığımı**' nı seçin.
3. Panoyu ortak bir pano olarak ayarlamak için **Evet** ' e tıklayın.
...
1. Çoğaltmak istediğiniz panoda **farklı kaydet**' e tıklayın. Yeni bir pano, aynı ada ve bir sayı ile açılır.
2. Yinelenen Panoyu yeniden adlandırma ve istediğiniz gibi değiştirin.

-Veya-

1. Pano Ayarları ' nda, çoğaltmak istediğiniz panonun satırına **farklı kaydet** ' e tıklayın.
...
- Varsayılan olarak ayarlamak istediğiniz Pano sekmesine tıklayın ve ardından sağ tarafta **varsayılan** ' a tıklayın.

-Veya-

1. Kullanılabilir panolar listesini görmek için **Pano ayarları** ' na tıklayın ve varsayılan olarak ayarlamak istediğiniz panoyu seçin.  
    Varsayılan bir Pano için ![Pano seçenekleri](./media/dashboards/dashboard-options.png)
2. Panonun satırındaki **varsayılan** öğesine tıklayın. Varsayılan Pano onay kutusu görüntülenir.
