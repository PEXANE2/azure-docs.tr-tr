...
| Alert type | Kurumsal Sözleşme | Microsoft Müşteri Sözleşmesi | Web direct/Pay-As-You-Go |
|---|---|---|---|
| Budget | ✔ | ✔ | ✔ |
| Credit | ✔ |✘ | ✘ |
...
When you view the details of a dismissed alert, you can reactivate it if manual action is needed. Aşağıdaki resimde bir örnek gösterilir.
