---
title: DDoS koruması telemetrisini görüntüleyin ve yapılandırın
...
ms.locfileid: "92905690"
---
# <a name="view-and-configure-ddos-protection-telemetry"></a>DDoS koruması telemetrisini görüntüleyin ve yapılandırın
...
Telemetrinin doğrulanması için DDoS saldırısının benzetimini yapmak için bkz. [DDoS algılamayı doğrulama](test-through-simulations.md).
...
> [DDoS saldırı risk azaltma raporlarını ve akış günlüklerini yapılandırma](reports-and-flow-logs.md)