...
Karma Runbook Worker, çalışan, runbook işlerini alacak ve durumu raporlamak üzere otomasyon hesabınızla iletişim kurmak için bir aracıya bağımlıdır. Windows için bu aracı, Microsoft Monitoring Agent (MMA) olarak da adlandırılan Windows Log Analytics aracısıdır. Linux için bu, Linux için Log Analytics aracısıdır.
