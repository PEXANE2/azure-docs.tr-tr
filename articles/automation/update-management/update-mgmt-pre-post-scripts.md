...
![Betikleri seçin](./media/update-mgmt-pre-post-scripts/select-scripts.png)
...
![Seçili öğeler](./media/update-mgmt-pre-post-scripts/selected-items.png)
...
![Sonuçları Güncelleştir](./media/update-mgmt-pre-post-scripts/update-results.png)
...
![Dağıtım çalıştırma sonuçları](./media/update-mgmt-pre-post-scripts/deployment-run.png)
...
![Galeri listesi](./media/update-mgmt-pre-post-scripts/runbook-gallery.png)
...
* Güncelleştirme yönetimi hakkında daha fazla bilgi için bkz. [VM 'niz için güncelleştirmeleri ve düzeltme eklerini yönetme](update-mgmt-manage-updates-for-vm.md).
