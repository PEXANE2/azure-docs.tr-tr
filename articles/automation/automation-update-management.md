...
**Güncelleştirme yönetimi çözümünü** yeni veya var olan bir Otomasyon hesabına ve aboneliğinizdeki Log Analytics çalışma alanına dağıtmanıza yardımcı olmak Için bir Azure [Kaynak Yöneticisi şablonu](automation-update-management-deploy-template.md) kullanılabilir.
