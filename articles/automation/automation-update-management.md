...
Güncelleştirme dağıtımları oluşturmak ve yönetmek için belirli izinlere ihtiyacınız vardır. Bu izinler hakkında bilgi edinmek için [Rol Tabanlı erişim – Yönetimi Güncelleştir'](automation-role-based-access-control.md#update-management)e bakın.
