...
description: Azure için avere vFXT 'nin ihtiyaçlarınıza uygun olup olmadığına karar vermek için bu sık sorulan soruları kullanın. Azure için avere vFXT 'nin diğer Azure bileşenleriyle nasıl çalıştığını öğrenin.
author: ekpgh
