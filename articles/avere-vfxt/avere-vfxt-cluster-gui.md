...
* SSH tüneli bağlantısı için Web tarayıcınızı açın ve `https://127.0.0.1:8443`gidin.
...
Kullanıcı adı `admin` ve kümeyi oluştururken verdiğiniz yönetici parolasını girin.
