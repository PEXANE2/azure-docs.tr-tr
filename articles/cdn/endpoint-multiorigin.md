...
4. Çoklu kaynak özelliğini etkinleştirmek için en az bir kaynak grubunuz olması gerekir. **Kaynak grubu oluştur**' u seçin:
    ...
    :::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-2.png" alt-text="CDN uç noktası" border="true":::
...
5. **Kaynak grubu yapılandırması Ekle** ' de aşağıdaki bilgileri girin veya seçin:
   ...
   :::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-3.png" alt-text="CDN uç noktası" border="true":::
...
1. Uç noktanız için kaynak ayarları ' nda **+ kaynak oluştur**' u seçin.
    ...
    :::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-5.png" alt-text="CDN uç noktası" border="true":::
...
2. **Kaynak Yapılandırması Ekle** ' de aşağıdaki bilgileri girin veya seçin:
   ...
   | Ağırlık      | 1 ile 1000 arasında bir sayı girin.   |
    ...
    :::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-6.png" alt-text="CDN uç noktası" border="true":::

3. **Ekle**’yi seçin.

4. Tüm kaynaklar için kaynak yolunu ayarlamak üzere **Kaynağı Yapılandır** ' ı seçin:

    :::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-7.png" alt-text="CDN uç noktası" border="true":::
...
1. Azure CDN uç noktasının kaynak ayarlarında, yapılandırmak istediğiniz kaynak grubunun adını seçin:
    ...
    :::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-8.png" alt-text="CDN uç noktası" border="true":::

2. **Güncelleştirme kaynak grubu**' nda **+ Başlangıç kaynağı**' nı seçin:

    :::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-9.png" alt-text="CDN uç noktası" border="true":::

4. Açılır kutuda gruba eklenecek kaynağı seçin ve **Tamam**' ı seçin.

5. Kaynağı gruba eklendiğini doğrulayıp **Kaydet**' i seçin:

    :::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-10.png" alt-text="CDN uç noktası" border="true":::
...
2. Kaynak grubundan bir kaynağı kaldırmak için, kaynak yanındaki çöp kutusu simgesini seçin ve **Kaydet**' i seçin:
    ...
    :::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-11.png" alt-text="CDN uç noktası" border="true":::
...
:::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-12.png" alt-text="CDN uç noktası" border="true":::
...
:::image type="content" source="./media/endpoint-multiorigin/endpoint-multiorigin-13.png" alt-text="CDN uç noktası" border="true":::
