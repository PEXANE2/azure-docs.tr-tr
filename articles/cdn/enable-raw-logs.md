...
1. Azure portal menüsünde, **-CDN-profile >\<** **tüm kaynaklar** >> seçin.
...
Microsoft Service Azure CDN Şu anda ham Günlükler sağlıyor (toplu olarak saatlik). Ham Günlükler her bir girdiyle aşağıdaki şemaya sahip API istekleri sağlar: 
