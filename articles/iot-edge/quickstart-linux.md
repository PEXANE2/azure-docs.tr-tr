...
* Bash veya Cloud Shell kullanıcıları için aşağıdaki komutu bir metin düzenleyicisine kopyalayın, yer tutucu metnini bilgilerinizi ile değiştirin, sonra bash veya Cloud Shell pencerenize kopyalayın:
