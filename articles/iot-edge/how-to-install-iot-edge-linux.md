...
El ile cihaz sağlama için ile sağlamak gereken bir [cihaz bağlantı dizesini](how-to-register-device.md#register-in-the-azure-portal) IOT hub'ına yeni bir cihazı kaydederek oluşturabilirsiniz.
