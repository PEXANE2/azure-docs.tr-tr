---
title: Azure IoT Edge bir model Machine Learning eğitme ve dağıtma | Microsoft Docs
description: Azure Machine Learning kullanarak bir makine öğrenimi modeli eğitin ve ardından modeli bir Azure IoT Edge modülü olarak dağıtılabilecek kapsayıcı görüntüsü olarak paketleyin.
author: kgremban
manager: philmea
ms.author: kgremban
ms.date: 06/13/2019
