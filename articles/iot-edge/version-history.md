...
* **IoT Edge 1,2 (Önizleme)** en son önizleme sürümündeki özellikler ve yetenekler için ek içerik içerir: [1,2-RC1](https://github.com/Azure/azure-iotedge/releases/tag/1.2-rc1)
