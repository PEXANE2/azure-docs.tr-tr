...
1. [Python örnekleri için Azure IoT aygıtı SDK'dan](https://github.com/Azure/azure-iot-sdk-python/tree/master/azure-iot-device/samples/advanced-edge-scenarios) **send_message** örneğini alın.
