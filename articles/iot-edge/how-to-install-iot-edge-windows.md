...
Uninstall-IoTEdge komutu Windows IoT Core üzerinde çalışmaz. Windows IoT çekirdek cihazlarından IoT Edge kaldırmak için Windows IoT çekirdek görüntünüzü yeniden dağıtmanız gerekir.
