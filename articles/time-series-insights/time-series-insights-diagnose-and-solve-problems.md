...
### <a name="learn-about-common-azure-time-series-insights-challenges-and-mitigationsbr"></a>Yaygın Azure Time Series Insights zorlukları ve azaltmaları hakkında bilgi edinin</br>
...
Veri içeren bir olay kaynağı oluşturduktan sonra, ortamlar sağlandığında [kısıtlama](time-series-insights-environment-mitigate-latency.md) yaygın bir sorundur. Azure IoT Hub ve Azure olayları hub 'Ları, verileri yedi güne kadar depolar. Azure Time Series Insights her zaman olay kaynağındaki en eski olay (ilk ın, ilk çıkar veya *FIFO*) ile başlar.

Örneğin, bir S1, tek birimlik Azure Time Series Insights ortamına bağlandığınızda bir olay kaynağında 5.000.000 olayındaysanız, Azure Time Series Insights günde yaklaşık 1.000.000 olay okur. Azure Time Series Insights beş günden fazla gecikme yaşmış olabilir. Ancak neler olduğu, ortamın kısıtlandığı şeydir.
...
Aşağıdaki şekilde, S1 SKU 'SU ve 3 kapasitesi olan bir Azure Time Series Insights ortamı gösterilmektedir. Günde 3.000.000 olay alabilir.
...
* Her olay hub 'ı iletisi tek bir Azure Time Series Insights olayına düzleştirilir, azaltma gerçekleşmez.
* Her olay hub 'ı iletisi 100 Azure Time Series Insights olayına düzleştirilir, her dakika 4.600 olay belirtilmelidir.
...
Gecikme sayısını onarmak için ortamınızın SKU kapasitesini artırın. Daha fazla bilgi için [Azure Time Series Insights ortamınızdaki ölçeği](time-series-insights-how-to-scale-your-environment.md)okuyun.
...
Azure Time Series Insights artık verileri geri alma, ancak olaylar hala IoT Hub veya Olay Hub 'ına akışa yaramazsa, bu olası nedeni göz önünde bulundurun.
