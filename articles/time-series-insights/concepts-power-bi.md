...
### <a name="learn-more-about-integrating-azure-time-series-insights-with-power-bibr"></a>Azure Time Series Insights Power BI ile tümleştirme hakkında daha fazla bilgi edinin.</br>
...
Veriler bağlandıktan sonra, bilgi paylaşımı olanaklarınızı daha da geliştirmek için Power BI tüm zengin görselleştirme ve grafik araçları mevcuttur. 

   [Power BI ![grafik oluşturma örnekleri](./media/concepts-connect-power-bi/power-bi-tsi-example.png)](./media/concepts-connect-power-bi/power-bi-tsi-example.png#lightbox)
