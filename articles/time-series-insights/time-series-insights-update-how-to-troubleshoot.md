...
- Olay kaynak anahtarınız yeniden üretildi ve önizleme ortamınız yeni olay kaynak anahtarına ihtiyaç duyuyor olabilir.
...
Yeni anahtarla Time Series Insights önizleme ortamınızı güncelleştirmek için, hub kaynağınızı Azure portal açın ve yeni anahtarı kopyalayın. TSI kaynağına gidin ve olay kaynakları ' na tıklayın. 
