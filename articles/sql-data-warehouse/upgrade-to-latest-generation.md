...
1. Yükseltilecek Işlem için Iyileştirilmiş Gen1 katman SQL havuzu duraklatıldığında, [SQL havuzunu sürdürür](pause-and-resume-compute-portal.md).
   ...
   > [!NOTE]
   > Gen2 'e geçiş yapmak için SQL havuzunun çalışıyor olması gerekir.
...
2. Görevler sekmesi altında **Gen2 kartına Yükselt** ' i seçin: ![Upgrade_1](./media/sql-data-warehouse-upgrade-to-latest-generation/upgrade-to-gen2-1.png)
