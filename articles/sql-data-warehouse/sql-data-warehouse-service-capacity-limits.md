...
| Tablo |Sütun başına bayt |Sütun [veri türüne](sql-data-warehouse-tables-data-types.md)bağımlıdır. Karakter veri türleri için, en fazla sınır 2 GB 'a kadar (satır taşması) depolamayı saklayabilir.  Bir veri sayfasında char veya varchar limit gibi Unicode olmayan karakterler 8000, nchar veya nvarchar sınırı gibi Unicode karakterler bir veri sayfasında 4000 ' tür.  Performansı artırmak için veri sayfası depolama boyutlarını kullanın. |
