...
Ayrıca bkz. [tablo istatistiklerini][Manage table statistics], [CREATE STATISTICS][CREATE STATISTICS]yönetme, [istatistik][güncelleştirme istatistiklerini] güncelleştirme
...
Ayrıca bkz. [işlemleri][Understanding transactions], [Optimizing transactions][Optimizing transactions]anlama, tablo [bölümleme][tablo bölümleme], [truncate table][TRUNCATE TABLE], [ALTER TABLE][ALTER TABLE], [Create Table as Select (CTAS)]Create[Table as Select (CTAS)]
