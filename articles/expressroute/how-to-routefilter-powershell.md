---
title: 'Microsoft eşlemesi için rota filtrelerini yapılandırma-ExpressRoute: PowerShell: Azure | Microsoft Docs'
...
### <a name="about"></a>Yol filtreleri hakkında
...
## <a name="prefixes"></a>1. Adım: ön eklerin ve BGP topluluk değerlerinin listesini alın
...
## <a name="attach"></a>3. Adım: yol filtresini bir ExpressRoute devresine Iliştirme
...
### <a name="getproperties"></a>Bir yol filtresinin özelliklerini almak için
...
### <a name="updateproperties"></a>Bir yol filtresinin özelliklerini güncelleştirmek için
...
### <a name="detach"></a>Bir ExpressRoute bağlantı hattından yol filtresini ayırmak için
...
### <a name="delete"></a>Yol filtresini silmek için
