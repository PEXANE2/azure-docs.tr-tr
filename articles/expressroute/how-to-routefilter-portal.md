...
Yeni kaynak oluşturma seçeneğini belirleyerek bir yol filtresi oluşturabilirsiniz. Aşağıdaki görüntüde gösterildiği gibi, **kaynak** > **ağı oluştur ağ** > **routefilter**öğesine tıklayın:
