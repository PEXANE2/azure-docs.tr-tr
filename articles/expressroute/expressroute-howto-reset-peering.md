...
* ExpressRoute devrenizin Azure özel eşlemesi üzerinde çift yönlü Iletme algılamasını (BFD) etkinleştirin. ExpressRoute devreniz 1 Ağustos 2018 ' den sonra oluşturulduysa BFD varsayılan olarak etkindir. Devreniz daha önce oluşturulduysa BFD etkin değildi. Eşlemeyi devre dışı bırakarak ve yeniden etkinleştirerek BFD 'yi etkinleştirebilirsiniz. BFD 'nin yalnızca Azure özel eşleme 'de desteklendiğini not edilmelidir.
