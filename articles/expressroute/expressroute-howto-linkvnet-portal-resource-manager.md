...
2. Artık sanal ağ geçidinizin ExpressRoute Devrenize bağlamak için bir bağlantı sağlamaya başlayabilirsiniz.  > **Add** Bağlantı **Ekle ' ye tıklayarak** **bağlantı ekle** sayfasını açın ve değerleri yapılandırın.
