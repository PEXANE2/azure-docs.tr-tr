...
1. Uyarıları yapılandırmak için **Azure İzleyicisi**' ne gidin ve **Uyarılar**' a tıklayın.
...
## <a name="alerts-based-on-each-peering"></a>Her eşlemeye göre uyarılar
 ...
 ![Yazdırılacak](./media/expressroute-monitoring-metrics-alerts/basedpeering.jpg)
...
**Uyarı ölçütlerinde**, sinyal türü Için **etkinlik günlüğü** ' nü seçebilir ve sinyali seçebilirsiniz.
  ...
  ![farklı](./media/expressroute-monitoring-metrics-alerts/alertshowto6activitylog.jpg)
