...
1. Ekranın sol üst kısmında Azure portal **kaynak oluştur** > **veritabanları** > **MariaDB için Azure veritabanı**' nı seçin.
...
8. **Özel uç nokta (Önizleme) oluştur-yapılandırma**' da bu bilgileri girin veya seçin:
    ...
    |Özel DNS bölgesi |Seçin *(yeni) Privatelink. Database. Azure. com* |
    |||
...
2.  `nslookup mydemomserver.mariadb.privatelink.database.azure.com`girin. 
