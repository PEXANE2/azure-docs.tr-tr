---
title: Redsıs için Azure önbelleğini yapılandırma | Microsoft Docs
...
@No__t_0 ilkeleri hakkında daha fazla bilgi için bkz. [çıkarma ilkeleri](https://redis.io/topics/lru-cache#eviction-policies).
