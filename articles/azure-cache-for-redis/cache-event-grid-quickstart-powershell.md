...
New-AzRedisCache
   ...
   [<CommonParameters>]
```
PowerShell 'de bir önbellek örneği oluşturma hakkında daha fazla bilgi için [Azure PowerShell başvurusuna](https://docs.microsoft.com/powershell/module/az.rediscache/new-azrediscache?view=azps-5.2.0)bakın. 
...
Import-AzRedisCache
      ...
      [<CommonParameters>]
```
PowerShell 'de içeri aktarma hakkında daha fazla bilgi için [Azure PowerShell başvurusuna](https://docs.microsoft.com/powershell/module/az.rediscache/import-azrediscache?view=azps-5.2.0)bakın. 
