...
* [Planlama hakkında SSS](cache-planning-faq.md)
* [Geliştirme hakkında SSS](cache-development-faq.md)
* [Yönetim hakkında SSS](cache-management-faq.md)
* [İzleme ve sorun giderme SSS](cache-monitor-troubleshoot-faq.md)

## <a name="deprecated-cache-services"></a>Kullanım dışı önbellek hizmetleri
...
### <a name="in-role-cache"></a>In-Role önbelleği
...
Arşivlenmiş belgeleri görüntülemek için bkz. [arşivlenmiş In-Role önbelleği belgeleri](/previous-versions/azure/azure-services/dn386103(v=azure.100)).
...
* Daha geniş bir hedef kitleye ulaşmak için, [Azure önbelleği Için Microsoft Q&soru sayfasında](/answers/topics/azure-cache-redis.html) soru gönderebilir ve Azure önbellek ekibine ve topluluğun diğer üyelerine ulaşabilirsiniz.
...
* Sorunuzu bizimle bize de gönderebilirsiniz [azurecache@microsoft.com](mailto:azurecache@microsoft.com) .