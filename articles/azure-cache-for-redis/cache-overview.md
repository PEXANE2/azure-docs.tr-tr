...
| Enterprise | Redsıs Labs ' Redsıs Enterprise Software tarafından desteklenen yüksek performanslı önbellekler. Bu katman RediSearch, RedisBloom ve RedisTimeSeries gibi Redsıs modüllerini destekler. Ayrıca, Premium katmandan daha yüksek kullanılabilirlik sağlar. |
...
| Özellik Açıklaması | Temel | Standart | Premium | Enterprise | Enterprise Flash |
| ------------------- | :-----: | :------: | :---: | :---: | :---: |
