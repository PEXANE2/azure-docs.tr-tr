...
* [Redsıs için Azure önbelleği kullanan bir Python uygulaması oluşturma](https://docs.microsoft.com/azure/azure-cache-for-redis/cache-python-get-started)
