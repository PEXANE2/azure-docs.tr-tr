...
## <a name="azure-vmware-solution-limits"></a>Azure VMware Çözüm sınırları
...
## <a name="data-lake-storage-limits"></a>Data Lake Storage sınırları
...
## <a name="managed-identity-limits"></a>Yönetilen kimlik limitleri
