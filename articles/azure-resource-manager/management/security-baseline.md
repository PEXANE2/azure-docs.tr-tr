...
ms.locfileid: "93133730"
---
# <a name="azure-security-baseline-for-azure-resource-manager"></a>Azure Resource Manager için Azure Güvenlik temeli

Bu güvenlik temeli, Microsoft Azure Kaynak Yöneticisi [Azure Güvenlik kıyaslama sürümü 1,0](../../security/benchmarks/overview-v1.md) ' dan kılavuzluk uygular. Azure Güvenlik kıyaslaması, bulut Çözümlerinizi Azure 'da nasıl güvence altına almak için öneriler sağlar.
