...
Resource Manager kullanmaya yeni başladıysanız, öncelikle [Azure Resource Manager'a genel bakış](overview.md) bölümünde tanımlanan terimleri gözden geçirmek isteyebilirsiniz.
