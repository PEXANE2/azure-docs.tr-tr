...
2. Azure portal menüsünde **tüm hizmetler**' i seçin.
    ...
    ![abonelikleri Seç](./media/resource-manager-supported-services/select-all-services.png)
...
3. **Tüm hizmetler** kutusunda, **Kaynak Gezgini**' ni girin ve ardından **Kaynak Gezgini**' yi seçin.
    ...
    ![Tüm hizmetleri seçin](./media/resource-manager-supported-services/select-resource-explorer.png)
