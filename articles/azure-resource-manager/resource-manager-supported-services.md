...
Kaynak türü adı şu biçimdedir: **{kaynak-sağlayıcısı}/{kaynak-türü}** . The resource type for a key vault is **Microsoft.KeyVault/vaults**.
