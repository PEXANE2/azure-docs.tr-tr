...
Bu eğitimde, Azure anahtar kasanızdan bir sır aldınız. Ardından şablon dağıtımınızda sırrı kullandınız. Bağlı şablon oluşturmayı öğrenmek için bkz.:
