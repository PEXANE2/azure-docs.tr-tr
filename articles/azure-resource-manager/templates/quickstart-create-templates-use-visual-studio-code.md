...
![Resource Manager şablonu hızlı başlangıç Visual Studio kod diyagramı](./media/quickstart-create-templates-use-visual-studio-code/resource-manager-template-quickstart-vscode-diagram.png)
