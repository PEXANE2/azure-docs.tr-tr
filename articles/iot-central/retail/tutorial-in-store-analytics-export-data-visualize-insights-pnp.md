...
* Önceki iki öğreticiyi tamamlamak için [Azure IoT Central'da mağaza içi bir analiz uygulaması oluşturun](./tutorial-in-store-analytics-create-app-pnp.md) ve operatör [panosunu özelleştirin ve Azure IoT Central'daki cihazları yönetin.](./tutorial-in-store-analytics-customize-dashboard-pnp.md)
...
![Doluluk veri seti](./media/tutorial-in-store-analytics-visualize-insights-pnp/dataset-2.png)
...
Mantık uygulamasını oluşturmadan önce, Azure IoT Central öğreticisinde [mağaza içi analiz uygulaması oluşturun'da](./tutorial-in-store-analytics-create-app-pnp.md) IoT Central uygulamanıza bağladığınız iki RuuviTag sensörünün aygıt dizinlerine ihtiyacınız vardır:
...
1. **Aygıt adlarını**not edin. Aşağıdaki ekran görüntüsünde, disler **f5dcf4ac32e8** ve **e29ffc8d5326:**
    ...
    ![Cihaz T.C.](./media/tutorial-in-store-analytics-visualize-insights-pnp/device-ids.png)
...
1. Eklediğiniz mantığın görsel sürümünü görmek için **Kaydet'i** seçin ve ardından **Designer'ı** seçin:
    ...
    ![Mantık uygulaması tasarımı](./media/tutorial-in-store-analytics-visualize-insights-pnp/logic-app.png)
...
1. Oturum açma işlemi tamamlandıktan sonra, **veri kümesi eylemine ekle satırlarında:**
    ...
    * Değişikliklerinizi kaydetmek için **Kaydet** seçeneğini belirleyin. **Bölge 1 ortam** eylemi aşağıdaki ekran ![görüntüsüne benzer: Bölge 1 ortamı](./media/tutorial-in-store-analytics-visualize-insights-pnp/zone-1-action.png)
...
1. Veri **kümesi 2 eylemine satır ekle:**
    ...
    * **Nem** alanını seçin ve ardından **Parse Telemetri'nin**yanında **daha fazlasını görün'u** seçin. Sonra **nem**seçin.
    * **Sıcaklık** alanını seçin ve ardından **Parse Telemetri'nin**yanında **daha fazlasını gör'üni** seçin. Sonra **sıcaklık**seçin.
    Değişikliklerinizi kaydetmek için **Kaydet** seçeneğini belirleyin.  **Bölge 2 ortam** eylemi aşağıdaki ekran ![görüntüsüne benzer: Bölge 2 ortamı](./media/tutorial-in-store-analytics-visualize-insights-pnp/zone-2-action.png)
...
1. Veri **kümesi eylemine satır ekle:**
    ...
    * Değişikliklerinizi kaydetmek için **Kaydet** seçeneğini belirleyin. **Dwell Time arabirimi** eylemi aşağıdaki ![ekran görüntüsüne benzer: Doluluk eylemi](./media/tutorial-in-store-analytics-visualize-insights-pnp/occupancy-action-1.png)
...
1. Veri **kümesi eylemine satır ekle:**
    ...
    * Değişikliklerinizi kaydetmek için **Kaydet** seçeneğini belirleyin. **Kişiler Sayısı arabirimi** eylemi aşağıdaki ![ekran görüntüsüne benzer: Doluluk eylemi](./media/tutorial-in-store-analytics-visualize-insights-pnp/occupancy-action-2.png)
