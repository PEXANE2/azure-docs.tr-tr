...
Bir uygulama oluşturmak için [Azure Portal](https://ms.portal.azure.com) gidin ve soldaki ana gezinti menüsünde **kaynak oluştur** ' u seçin.
...
Başlamak için sol taraftaki ana gezinti menüsünde **tüm kaynaklar** ' ı seçin. Kaynak listenizde bulmak için uygulamanızın adını yazmak üzere arama kutusunu kullanın. Ardından, yönetmek istediğiniz IoT Central uygulamayı seçin.
