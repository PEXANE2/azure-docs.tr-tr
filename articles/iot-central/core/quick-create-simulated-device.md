...
![Aygıt Şablonları sayfası](./media/quick-create-simulated-device/device-definitions.png)
...
1. Birkaç saniye sonra yeni cihaz şablonunuzu görebilirsiniz:
    ...
    ![MXChip IoT DevKit cihaz şablonu](./media/quick-create-simulated-device/devkit-template.png)
...
1. Müşteri **Adı** ve **Son Hizmet Tarihi** bulut özelliklerini ve Fan **Speed** özelliğini seçin. Sonra **Ekle bölümünü**seçin:
    ...
    ![Yeni form oluşturma](media/quick-create-simulated-device/new-form.png)
...
1. **Yayınla'yı**Seçin :
    ...
    ![Yayınlanan model](media/quick-create-simulated-device/published-model.png)
...
1. Listede simüle edilmiş cihazınızı seçin. Ardından **Uygula**'yı seçin. Artık aynı simüle edilmiş aygıtı cihazınızşablongörünümlerinde bina deneyimi görebilirsiniz. Bu görünüm grafikler ve diğer görseller için yararlıdır.
    ...
    ![Önizleme aygıtını yapılandırma](./media/quick-create-simulated-device/configure-preview.png)
