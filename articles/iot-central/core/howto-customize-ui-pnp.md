...
![Standart IoT Central teması](./media/howto-customize-ui-pnp/standard-ui.png)
...
![Özel IoT Central teması](./media/howto-customize-ui-pnp/themed-ui.png)
...
![IoT Central temaları](./media/howto-customize-ui-pnp/themes.png)
...
Logo resminiz uygulamanızın adını içeriyorsa, uygulama adı metnini gizleyebilirsiniz. Daha fazla bilgi için bkz. [uygulamanızı yönetme](./howto-administer-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json#change-application-name-and-url).
...
![Yardım bağlantılarını IoT Central özelleştirme](./media/howto-customize-ui-pnp/help-links.png)

Ayrıca, Yardım menüsüne yeni girişler ekleyebilir ve varsayılan girişleri kaldırabilirsiniz:

![Özelleştirilmiş IoT Central yardımı](./media/howto-customize-ui-pnp/custom-help.png)
...
- [Uygulamanızı yönetme](./howto-administer-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
- [Panonuza kutucuk ekleme](./howto-add-tiles-to-your-dashboard.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)