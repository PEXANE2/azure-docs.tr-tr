...
ms.locfileid: "73588427"
---
# <a name="extend-azure-iot-central-with-custom-analytics-using-azure-databricks-preview-features"></a>Azure Databricks kullanarak Azure IoT Central özel çözümlemeler ile genişletme (Önizleme özellikleri)
...
Bu nasıl yapılır Kılavuzu, [yerleşik analiz araçlarıyla](./howto-create-custom-analytics-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)daha önce yapabilecekleri IoT Central nasıl uzatılamayacak hakkında sizi gösterir.
...
1. **Koordinatlar** metin kutusuna şu değeri girin: `com.microsoft.azure:azure-eventhubs-spark_2.11:2.3.10`
...
Artık özel analizler oluşturmayı bildiğinize göre, önerilen sonraki adım [Azure IoT Central verilerinizi Power BI panosunda görselleştirmeyi ve çözümlemeyi](./howto-connect-powerbi.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)öğrenmektir.
