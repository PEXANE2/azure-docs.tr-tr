...
> [!div class="mx-imgBorder"]
> ![Kutucuk toplaması ayarları için açılan menü](media/howto-add-tiles-to-your-dashboard/aggregation-settings.png)

Ayrıca, kutucukta **cetvel** simgesine tıklayarak grafik görselleştirmeyi değiştirebilirsiniz.

> [!div class="mx-imgBorder"]
> ![Kutucuk görselleştirme ayarları için açılan menü](media/howto-add-tiles-to-your-dashboard/visualization-settings.png)
