...
Başlamadan önce, bir önceki hızlı başlangıç [oluşturma Azure IoT Central uygulaması oluşturmanız](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) ve birlikte çalışmak üzere **ortam algılayıcısı** cihaz şablonu oluşturmak için [IoT Central uygulamanıza sanal bir cihaz eklemeniz](./quick-create-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) gerekir.
...
1. **Koşullar** bölümünde, kuralınızı neyin tetikleyeceğini tanımlarsınız. Sıcaklık telemetrisine dayalı bir koşul tanımlamak için aşağıdaki bilgileri kullanın:
    ...
    ![Kural koşulu oluştur](./media/quick-configure-rules-pnp/condition.png)
...
1. Eyleminizi tanımlamak için aşağıdaki tablodaki bilgileri kullanın:
    ...
    ![Kural oluşturma eylemi](./media/quick-configure-rules-pnp/action.png)
...
> [Cihazlarınızı izlemek Için Azure IoT Central kullanın](quick-monitor-devices-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
