...
1. Sol bölmedeki ***cihaz şablonları** _ sekmesine gidin, _* + Yeni * *: ![ yeni cihaz şablonu oluştur ](./media/howto-connect-ruuvi/devicetemplate-new.png) sayfasında, ***özel şablon oluşturma**_ veya _ *_önceden yapılandırılmış bir cihaz şablonu kullanma_* seçeneği sunulur.*
