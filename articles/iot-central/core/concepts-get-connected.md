...
Bir cihaz için DPS sağlamak üzere IoT Central uygulamanızdan kapsam KIMLIĞI, kimlik bilgileri ve cihaz KIMLIĞINI kullanın. Kimlik bilgisi türleri hakkında daha fazla bilgi edinmek için bkz. [X. 509.440 grup kaydı](#x509-group-enrollment) ve [SAS grubu kaydı](#sas-group-enrollment). Cihaz kimlikleri hakkında daha fazla bilgi için bkz. [cihaz kaydı](#device-registration).
