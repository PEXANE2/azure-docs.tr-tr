...
1. Cihaz şablonu ![cihaz şablonlarından **+ Yeni** ' yi seçin](media/howto-connect-raspberry-pi-csharp/adddevicetemplate.png)
   

2. **Raspberry PI** 'yi seçin ve cihaz şablonu eklemek ![Raspberry PI cihaz şablonunu oluşturun](media/howto-connect-raspberry-pi-csharp/newdevicetemplate.png)
