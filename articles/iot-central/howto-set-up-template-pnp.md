...
> [Yeni bir cihaz şablonu sürümü](howto-version-device-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
> oluşturma bir[mxyonga IoT devkit cihazını Azure IoT Central uygulamanıza bağlama](howto-connect-devkit-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
