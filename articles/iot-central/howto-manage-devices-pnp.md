...
1. Sol gezinti menüsünde **cihazlar** ' ı seçin. Burada tüm cihazların ve cihaz şablonlarınızın bir listesini görürsünüz.
...
1. Sol gezinti menüsünde **cihazlar** ' ı seçin.
...
1. **Geçişi**seçin:
    ...
    ![Cihazları İlişkilendir](./media/howto-manage-devices-pnp/unassociateddevices2a.png)
...
1. Dışarı aktarmak istediğiniz cihazları seçin ve ardından **dışarı aktarma** eylemini seçin.
    ...
    ![Dışarı Aktarma](./media/howto-manage-devices-pnp/export1a.png)
...
1. Gezinti menüsünde **cihazlar** ' ı seçin.
