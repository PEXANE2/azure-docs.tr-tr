...
Uygulamanın çalıştığını doğrulamak için aşağıdaki komutu çalıştırın ve tarayıcınızda [localhost: 3000](http://localhost:3000) dizinine gidin.
