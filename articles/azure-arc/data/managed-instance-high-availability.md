...
- Kubernetes kümesinin [paylaşılan, uzak depolama birimi](https://docs.microsoft.com/en-us/azure/azure-arc/data/storage-configuration#factors-to-consider-when-choosing-your-storage-configuration) olması gerekir 
