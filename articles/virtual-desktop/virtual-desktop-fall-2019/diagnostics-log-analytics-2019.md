...
Tanılama özelliğiyle Log Analytics kullanabilmeniz için önce [bir çalışma alanı oluşturmanız](../../azure-monitor/vm/quick-collect-windows-computer.md#create-a-workspace)gerekir.
