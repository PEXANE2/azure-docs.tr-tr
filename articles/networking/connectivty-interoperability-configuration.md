...
[]: ./media/backend-interoperability/ExR1-Hub-Connection.png "ExpressRoute 1 ' ın bir hub VNET EXR Gateway 'e yönelik 5 bağlantı yapılandırması"
...
[]: ./media/backend-interoperability/ExR2-Remote-Connection.png "uzak VNET EXR Gateway 'e ExpressRoute 2 bağlantısı yapılandırması"
