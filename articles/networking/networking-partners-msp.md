---
title: 'Ağ Ortakları: Azure Ağ | Microsoft Dokümanlar'
description: Bu makalede, MSP Ağ ortaklarının bir listesini sağlar
services: networking
author: skishen525
...
[Azure Ağ Yönetilen Hizmet Sağlayıcısı (MSP) İş Ortağı Programı,](https://azure.microsoft.com/blog/enhancing-the-customer-experience-with-the-azure-networking-msp-partner-program/) ağ hizmetleri odaklı MSP'ler, Telcos ve Sistem Entegratörleri 'nin (SI) Azure'un ağ ürünleri ve hizmetleri portföyüne odaklanmış bulut ve karma ağ hizmetleri sunmasını sağlar.

Azure Ağ MSP'leri, kurumsal bulut ağı gereksinimlerini ve bulut ve karma ağ la ilgili tüm yönleriyle ilgili zorlukları ele alan özel bir yönetilen hizmet sağlayıcıları kümesidir. Yönetilen ağ hizmetleri aşağıdaki hizmetlerden birini veya birkaçını içerir: ağ mimarisi, planlama, dağıtım, operasyonlar, bakım ve optimizasyon.

![Msp][0]

Müşteriler, MSP tarafından yönetilen hizmet tekliflerini Azure Marketi'nden veya doğrudan MSP'den satın alabilir. MSP'ler Azure Deniz Feneri'ni kullanarak müşterilerin aboneliklerinde ve [Azure Lighthouse](https://azure.microsoft.com/services/azure-lighthouse/)kaynak gruplarında Azure ağ kaynaklarını dağıtabilir ve yönetebilir.

## <a name="azure-marketplace-offers-by-azure-networking-msp-partners"></a><a name="msp"></a>Azure Marketi, Azure Ağ MSP iş ortakları tarafından sunulamaktadır

Azure Ağ MSP iş ortakları tarafından sunulan yönetilen bulut ağ hizmetleri hakkında daha fazla bilgi için bu bölümdeki bağlantıları kullanın. Bulut ağı hizmetleri ortağınız aşağıdaki bölümde listelenmemişse, sağlayıcının bizimle iletişime geçmesini sorun. Onlar bir e-posta göndererek bize ManagedVirtualWAN@microsoft.comulaşabilirsiniz. 

| **Msp** | **Bulut Ağı Dönüşüm Hizmetleri** | **Yönetilen Ekspres Rota** | **Yönetilen Sanal WAN** |
| ---| ---| ---| ---|
...
|[Uyanık BT](https://vigilant.it/manage-cloud-service/)|[Azure Sağlık Kontrolü: 5 Günlük Değerlendirme](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/vigilant-it.ahc01)|[ExpressRoute: 5 Günlük Uygulama](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/vigilant-it.erd01)|||
|[Vandis](https://www.vandis.com/microsoft-azure-practice/)||[Vandis Yönetilen ExpressRoute](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/vandis.vandis_managed_expressroute?tab=Overview)|[Vandis Yönetilen VWAN Fortinet tarafından desteklenmektedir](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/vandis.vandis_managed_vwan_powered_by_fortinet?tab=Overview); [Vandis Yönetilen VWAN Palo Alto Networks tarafından desteklenmektedir](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/vandis.vandis_managed_vwan_powered_by_palo_alto_networks?tab=Overview)|

Aşağıdaki Azure Ağ MSP İş Ortaklarından yeni Yönetilen Güvenlik Hizmetleri ve Yönetilen MEC Hizmetleri de dahil olmak üzere Azure Marketi teklifleri yol haritamızda yer almaktadır: [Amdocs](https://www.amdocs.com/); [AXESDN](https://www.axesdn.com/en/azure-msp.html); [CenturyLink](https://www.centurylink.com/business/networking/cloud-connectivity.html);    [IX Erişim](https://www.ixreach.com/services/sdn-cloud-connect/);  [InterCloud](https://intercloud.com/partners/microsoft-azure/);  [KINX](https://www.kinx.net/service/cloud/?lang=en); [Megaport](https://www.megaport.com/services/microsoft-expressroute/);  [OmniClouds](https://omniclouds.com/services/);  [Sejong Telekom](https://www.sejongtelecom.net/en/pages/service/cloud_ms);  [Teknik Mahindra](https://networkservices.techmahindra.com/pages/default.aspx); [Federe Kablosuz](https://www.federatedwireless.com/caas/)

## <a name="expressroute-partners"></a><a name="expressroute"></a>ExpressRoute iş ortakları

İş ortakları hakkında daha fazla bilgi için [ExpressRoute iş ortakları ve konumları](../expressroute/expressroute-locations-providers.md)hakkında bilgi alavurun.

## <a name="virtual-wan-partners"></a><a name="vwan"></a>Sanal WAN iş ortakları

İş ortakları hakkında daha fazla bilgi için [Virtual WAN iş ortakları ve sağlayıcılarına](../virtual-wan/virtual-wan-locations-partners.md)bakın.
