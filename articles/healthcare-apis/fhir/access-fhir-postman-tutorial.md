...
- Yapılandırıldı `audience` . Bu genellikle FHıR sunucusunun URL 'sidir. Örneğin, `https://<FHIR-SERVER-NAME>.azurehealthcareapis.com` yalnızca `https://azurehealthcareapis.com` .
