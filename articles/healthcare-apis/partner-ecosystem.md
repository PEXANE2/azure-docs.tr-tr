---
title: FHıR için Azure API etrafında iş ortağı ekosistemi
description: Bu makalede, FHıR için Azure API ile uçtan uca bir çözüm oluşturmaya yönelik benzersiz IP veya danışmanlık hizmetleri sunan bazı iş ortakları vurgulanmıştır
...
FHıR için Azure API 'SI etrafında yerleşik olarak bulunan uçtan uca bir çözüm oluştururken, benzersiz IP 'leri için bir iş ortağının yardımına veya her şeyi bir araya getirmek için yardımcı olmanız gerekebilir. Farklı iş ortaklarının bu ekosistemini büyüyen ve bunlardan birkaçını tanıtmak istediğim için çalışıyoruz.
