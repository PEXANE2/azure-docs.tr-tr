...
Bu başvuru mimarisi, uygulama katmanında Vm'lerde merkezi hizmetleri çalıştırır. Merkezi Hizmetler, tek bir VM 'de olduğunda olası bir tek hata noktasıdır. Tipik dağıtım ve yüksek kullanılabilirlik gerekli değildir.
