...
1. Kasa > **ayarları** **çoğaltılan öğeler** > , yük devredilecek makineye sağ tıklayın > **yeniden koruyun**.
...
1. Kasa > **ayarları** **çoğaltılan öğeler**>, geri dönecek başarısız geri VM 'Leri seçin ve **yeniden koru**' ya tıklayın.
