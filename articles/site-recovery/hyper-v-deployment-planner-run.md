---
title: Hyper-V Dağıtım Planlayıcısı Azure Site Recovery içinde çalıştırma
...
* [IR toplu işleme](hyper-v-deployment-planner-analyze-report.md#initial-replication-batching)
