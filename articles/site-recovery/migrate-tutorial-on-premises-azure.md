...
Bu makalede, [Azure Site Recovery](site-recovery-overview.md)kullanarak şirket Içi makinelerin Azure 'a nasıl geçirileceği açıklanır. 

> [!TIP]
> Artık Azure geçişi 'ni kullanarak Azure Site Recovery hizmeti yerine şirket içi makineleri Azure 'a geçirebilirsiniz. [Daha fazla bilgi edinin](../migrate/migrate-services-overview.md).
