...
2. Silmek istediğiniz VMM sunucusunda bulutlar tarafından kullanılan tüm ağ eşlemelerini silin. **Site Recovery Infrastructure**  >  **System Center VMM**  >  **ağ eşlemesi**için Site Recovery altyapısında, ağ eşleme > **Sil**' e sağ tıklayın.
3. VMM sunucusunun KIMLIĞINI aklınızda edin.
4. Kaldırmak istediğiniz VMM sunucusundaki bulutlardan çoğaltma ilkelerinin ilişkisini kaldırın.  **Site Recovery Infrastructure**  >  **System Center VMM**  >   **çoğaltma ilkeleri**için Site Recovery altyapısında, ilişkili ilkeye çift tıklayın. Buluta sağ tıklayın > **Ilişkiyi kaldırın**.
5. VMM sunucusunu veya etkin düğümü silin. **Site Recovery Infrastructure**  >  **System Center VMM**  >  **VMM sunucuları**için Site Recovery altyapısı ' nda, **Sil**> sunucuya sağ tıklayın.
...
2. Hyper-V sitesi için ilkelerin ilişkisini kaldırın. **Site Recovery Infrastructure**  >  **Hyper-V siteleri**  >   **çoğaltma ilkeleri**için Site Recovery altyapısında, ilişkili ilkeye çift tıklayın. **Ilişkiyi kaldırmak**> siteye sağ tıklayın.
3. Hyper-V konaklarınızı silin. **Site Recovery Infrastructure**  >  **Hyper-v siteleri**  >  **Hyper-v Konakları**için Site Recovery altyapısında, **Sil**> sunucuya sağ tıklayın.
4. Hyper-V sitesini, tüm Konakları kaldırıldıktan sonra silin. **Site Recovery Infrastructure**  >  **Hyper-v siteleri**  >  **Hyper-v siteleri**için Site Recovery altyapısında, **Sil**> siteye sağ tıklayın.
