...
Evet, kullanılabilirlik bölgelerindeki VM 'Leri başka bir Azure bölgesine çoğaltabilirsiniz. Hedef VM, hedef bölgede destekleniyorsa tek bir örnek, bir kullanılabilirlik kümesinde veya bir kullanılabilirlik bölgesinde dağıtılabilir. 
