...
ms.locfileid: "74040404"
---
# <a name="deprecation-of-disaster-recovery-between-customer-managed-sites-with-vmm-using-azure-site-recovery"></a>Azure Site Recovery kullanarak, müşteri tarafından yönetilen siteler arasında (VMM ile) olağanüstü durum kurtarma kullanımdan kaldırılması
...
> [!IMPORTANT]
> Lütfen VMM 'yi hazırlama bölümündeki adımları yürütmemenizi unutmayın.
...
Hyper-V çoğaltmasını kullanma seçeneği 2 ' yi seçerek, lütfen aşağıdaki adımları yürütün:
