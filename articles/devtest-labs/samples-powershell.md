...
|[VHD’den özel görüntü oluşturma](scripts/create-custom-image-from-vhd.md)| Bu PowerShell betiği, Azure DevTest Labs laboratuvarında özel bir görüntü oluşturur. |
|[Laboratuvarda özel rol oluşturma](scripts/create-custom-role-in-lab.md)| Bu PowerShell betiği, Azure Lab Services laboratuvarında özel bir rol oluşturur. |
