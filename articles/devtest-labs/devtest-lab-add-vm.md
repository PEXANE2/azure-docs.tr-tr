...
description: Azure DevTest Labs bir laboratuvara sanal makine eklemek için Azure portal nasıl kullanacağınızı öğrenin. Özel bir görüntü veya formül olan bir tabanı seçebilirsiniz.
ms.topic: article
ms.date: 06/26/2020
