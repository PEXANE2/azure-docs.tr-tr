...
|-----------|----------|-------------|-------------|
| `keyName` | string |  *Durum* veya dinamik özellik adı.  Bir `keyName` , dizi içinde benzersiz olmalıdır  `StyleObject` .| Evet |
| `type` | string |Değer "String" değeridir. | Evet |
| `rules` | [`StringRuleObject`](#stringruleobject)[]| N sayıda *durum* değeri dizisi.| Evet |
...
| Özellik | Tür | Açıklama | Gerekli |
|-----------|----------|-------------|-------------|
| `stateValue1` | string | Değer dizesinin stateValue1 olduğu renk. | Hayır |
| `stateValue2` | string | Değer dizesinin stateValue olduğu renk. | Hayır |
| `stateValueN` | string | Değer dizesinin stateValueN ve olduğu renk. | Hayır |
