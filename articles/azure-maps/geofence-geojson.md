...
description: Azure haritalar bölge verileri hakkında bilgi edinin. Bir bölge alanına göre koordinatların konumunu alırken bölge alma ve bölge oluşturma API 'Lerini nasıl kullanacağınızı öğrenin.
author: anastasia-ms
ms.author: v-stharr
ms.date: 02/14/2019
ms.topic: conceptual
