...
| [Azure haritalar leaflet eklentisi](https://github.com/azure-samples/azure-maps-leaflet) | [Azure haritalar kutucuk hizmetlerinden](/rest/api/maps/renderv2/getmaptilepreview)kutucuk katmanlarının kaplamasını kolaylaştıran bir [leaflet](https://leafletjs.com/) JavaScript eklentisi. |
 | [Azure Maps Openkatmanlarında eklentisi](https://github.com/azure-samples/azure-maps-openlayers) | [Azure haritalar kutucuk hizmetlerinden](/rest/api/maps/renderv2/getmaptilepreview)kutucuk katmanlarının kaplamasını kolaylaştıran bir [openkatmanlarında](https://www.openlayers.org/) JavaScript eklentisi. |
