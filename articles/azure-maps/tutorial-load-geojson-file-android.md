...
Bu öğretici, Azure Maps Android SDK konum verilerinin coğrafi json dosyasını içeri aktarma işleminde size rehberlik eder. Bu öğreticide aşağıdakilerin nasıl yapılacağını öğreneceksiniz:
...
2. Android Studio 'nun Proje panelinde **uygulama** klasörüne sağ tıklayın ve sayfasına gidin `New > Folder > Assets Folder` .
