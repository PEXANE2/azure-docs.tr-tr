...
2. SQLite veritabanı Dosyanızı Windows ortamınızda kullanılabilir durumda olduğundan emin olun. Henüz bir tane yoksa (örneğin, açık kaynak bölümünde çok sayıda mevcuttur, örneğin, http://www.ch-werner.de/sqliteodbc/) bir SQLite ODBC sürücüsü yükleyebilirsiniz.
