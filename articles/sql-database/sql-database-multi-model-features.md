...
- NoSQL Veri yapılarınızın analitik veya işlemesinin performansını artırmak üzere [bellek içi teknolojiler](sql-database-in-memory.md) gibi veritabanı özelliklerini uygulamak, verilerinizin başka bir yerinde kopyasını oluşturmak ve bazı analitik iş yüklerinin birincil veritabanından yük devretmek için [işlem çoğaltma](sql-database-managed-instance-transactional-replication.md) veya [okunabilir çoğaltmalar](sql-database-read-scale-out.md) kullanın.
