...
SÜR yedeklemeleri, coğrafi olarak yedekli depolama ile korunur. Daha fazla bilgi için bkz. [Azure depolama artıklığı](../storage/common/storage-redundancy.md).
...
Invr gibi, LTR yedeklemeler, coğrafi olarak yedekli depolama ile korunur. Daha fazla bilgi için bkz. [Azure depolama artıklığı](../storage/common/storage-redundancy.md).
