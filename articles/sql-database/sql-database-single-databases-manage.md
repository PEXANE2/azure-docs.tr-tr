---
title: Sunucular ve tek veritabanları oluşturma, yönetme
description: SQL Veritabanı sunucuları ve tek veritabanları oluşturma ve yönetme hakkında bilgi edinin.
...
Azure portalı, PowerShell, Azure CLI, REST API ve Transact-SQL'i kullanarak SQL Veritabanı sunucularını ve tek veritabanlarını oluşturabilir ve yönetebilirsiniz.

## <a name="azure-portal-manage-sql-database-servers-and-single-databases"></a>Azure portalı: SQL Veritabanı sunucularını ve tek veritabanlarını yönetme
...
[Azure portalını](https://portal.azure.com)kullanarak bir SQL Veritabanı sunucusu oluşturmak için boş bir SQL sunucusu (mantıksal sunucu) formuna gidin.  

### <a name="create-a-blank-or-sample-sql-single-database"></a>Boş veya örneksql tek veritabanı oluşturma

[Azure portalını](https://portal.azure.com)kullanarak bir Azure SQL tek veritabanı oluşturmak için boş bir SQL Veritabanı formuna gidin ve istenen bilgileri sağlayın. Azure SQL veritabanının kaynak grubunu ve SQL Veritabanı sunucusunu önceden veya tek bir veritabanını oluştururken oluşturabilirsiniz. Boş bir veritabanı oluşturabilir veya Adventure Works LT tabanlı örnek bir veritabanı oluşturabilirsiniz.
...
Yönetilen Örnek oluşturmak için [bkz.](sql-database-managed-instance-get-started.md)

## <a name="manage-an-existing-sql-database-server"></a>Varolan bir SQL Veritabanı sunucusunun yönetimi

Varolan bir SQL Veritabanı sunucusunu yönetmek için, belirli SQL veritabanı sayfası, **SQL sunucuları** sayfası veya **Tüm kaynaklar** sayfası gibi bir dizi yöntem kullanarak sunucuya gidin.
...
Azure PowerShell ile Azure SQL Veritabanı sunucuları, tek ve havuzlu veritabanları ve SQL Veritabanı sunucu güvenlik duvarları oluşturmak ve yönetmek için aşağıdaki PowerShell cmdlets'i kullanın. PowerShell'i yüklemeniz veya yükseltmeniz gerekiyorsa, [Azure PowerShell modüllerini yükle'ye](/powershell/azure/install-az-ps)bakın.

> [!TIP]
> PowerShell örnek komut dosyaları için, [Azure SQL tek veritabanı oluşturmak ve bir SQL Veritabanı sunucusu güvenlik duvarı kuralını yapılandırmak](scripts/sql-database-create-and-configure-database-powershell.md) için PowerShell'i kullan'a bakın ve [PowerShell'i kullanarak bir SQL tek veritabanını izleyin ve ölçeklendirin.](scripts/sql-database-monitor-and-scale-database-powershell.md)
...
## <a name="azure-cli-manage-sql-database-servers-and-single-databases"></a>Azure CLI: SQL Veritabanı sunucularını ve tek veritabanlarını yönetme
...
> [!TIP]
> Azure CLI hızlı başlatma için [bkz.](sql-database-cli-samples.md) Azure CLI örnek komut dosyaları için, [azure SQL tek veritabanı oluşturmak ve bir SQL Veritabanı güvenlik duvarı kuralını yapılandırmak için CLI'yi kullanın](scripts/sql-database-create-and-configure-database-cli.md) ve Bir Azure SQL tek [veritabanını izlemek ve ölçeklendirmek için CLI'yi kullanın'a](scripts/sql-database-monitor-and-scale-database-cli.md)bakın.
>
...
| Komut | Açıklama |
| --- | --- |
|[VERITABANı OLUŞTUR](https://docs.microsoft.com/sql/t-sql/statements/create-database-transact-sql?view=azuresqldb-current)|Yeni bir tek veritabanı oluşturur. Yeni bir veritabanı oluşturmak için ana veritabanına bağlı olmalısınız.|
...
|[Sunucular - Liste](https://docs.microsoft.com/rest/api/sql/servers/list)|Abonelikteki sunucuların listesini verir.|
