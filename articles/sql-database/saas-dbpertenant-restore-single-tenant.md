...
Demo betiği, tarayıcınızdaki bu yeni kiracı veritabanının Olaylar sayfasını açar. URL ```http://events.wingtip-dpt.&lt;user&gt;.trafficmanager.net/contosoconcerthall_old``` 'den, bu sayfanın ada *_old* eklendiği geri yüklenen veritabanından verileri gösterdiğini unutmayın.
