...
1. **Azure depolama hesabına PolyBase bağlantısı:**
   ...
   1. PolyBase kullanarak genel amaçlı `abfss://` v2 depolama hesabınıza bağlanmak için şemayla dış veri kaynağı oluşturun:
