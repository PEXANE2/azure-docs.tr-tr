...
2. **Kaynak** > **Databases**veritabanları > **SQL veritabanı**oluşturma sayfasına gidin.
...
1. **Veritabanları** > **Clinic**Clinic > **tabloları**' nı genişletin.
...
**Clinic** > **Security**güvenlik > **Always Encrypted anahtarlarını**genişleterek SSMS 'de anahtarların oluşturulmasını doğrulayabilirsiniz.
