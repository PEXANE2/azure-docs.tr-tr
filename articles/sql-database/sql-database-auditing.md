...
- Veritabanında etkinleştirilmesinin yanı sıra veritabanı veya veri ambarında denetimi etkinleştirmek, sunucu denetiminin ayarlarından *hiçbirini geçersiz kılmaz veya değiştirmez.* Her iki denetim de yan yana bulunur. Diğer bir deyişle, veritabanı paralel olarak iki kez denetlenir; sunucu ilkesi tarafından bir kez ve veritabanı ilkesi tarafından bir kez.
...
Bir depolama hesabına denetim günlükleri yazmayı yapılandırmak için **depolama** ve açık **depolama ayrıntıları**' nı seçin. Günlüklerin kaydedileceği Azure Depolama hesabını seçin ve ardından bekletme dönemini seçin. Ardından **Tamam**'a tıklayın. Saklama süresinden daha eski Günlükler silinir.
...
- Sunucu veya veritabanı düzeyinde denetim olayları için bir sabit günlük deposu yapılandırmak için, [Azure depolama tarafından verilen yönergeleri](https://docs.microsoft.com/azure/storage/blobs/storage-blob-immutability-policies-manage#enabling-allow-protected-append-blobs-writes) izleyin (lütfen sabit blob depolamayı yapılandırırken **ek ekler 'e izin ver** ' i seçtiğinizden emin olun).
- Denetim günlüklerini, VNet veya güvenlik duvarının arkasındaki bir Azure depolama hesabına yazabilirsiniz. Belirli yönergeler için bkz. [VNET ve güvenlik duvarının arkasındaki depolama hesabına yönelik denetim yazma](create-auditing-storage-account-vnet-firewall.md).
...
> [!WARNING]
> Üzerinde SQL havuzu olan bir sunucuda denetimin etkinleştirilmesi **, SQL havuzunun devam ettirmekte ve** fatura ücretlerine neden olabilecek yeniden duraklatılmasına neden olur.
> Duraklatılmış bir SQL havuzunda denetim etkinleştirilmesi mümkün değildir. Etkinleştirmek için, SQL havuzunun duraklamasını kaldırın.
