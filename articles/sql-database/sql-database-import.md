...
Almanın ilerlemesini denetlemek için [Get-Azsqldatabaseımportexportstatus](/powershell/module/az.sql/get-azsqldatabaseimportexportstatus) cmdlet 'ini kullanabilirsiniz. İsteğin genellikle döndürdüğü `Status: InProgress`cmdlet 'i hemen çalıştırın. Gördüğünüz `Status: Succeeded`zaman içeri aktarma tamamlanır.
