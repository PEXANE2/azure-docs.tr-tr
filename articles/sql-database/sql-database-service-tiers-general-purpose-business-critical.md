---
title: 'Azure SQL veritabanı-genel amaçlı ve iş açısından kritik '
...
- Genel amaçlı hizmet katmanında `tempdb` eklenmiş bir SSD kullanır ve bu depolama maliyeti sanal çekirdek fiyatına dahildir.
