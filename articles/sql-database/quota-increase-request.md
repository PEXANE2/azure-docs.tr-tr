...
## <a id="newquota"></a>Yeni bir destek isteği oluşturun
...
## <a id="sqldbquota"></a>SQL veritabanı kota türleri
...
## <a id="sqlmiquota"></a>Yönetilen örnek kota türü
...
Son adım, SQL veritabanı kota isteğinizin kalan ayrıntılarını doldurmasıdır. Ardından Ileri ' yi seçin **: gözden geçir + oluşturma > >** , istek ayrıntılarını inceledikten sonra, isteği göndermek için **Oluştur** ' a tıklayın.
