---
title: CLI örnek-monitör-ölçek-tek Azure SQL veritabanı
...
> [!TIP]
> Veritabanında gerçekleştirilen işlemlerin listesini almak için [az sql db op listesini](/cli/azure/sql/db/op?#az-sql-db-op-list) kullanın ve az sql [db op](/cli/azure/sql/db/op#az-sql-db-op-cancel) veritabanındaki bir güncelleştirme işlemini iptal etmek için iptal edin.
...
| [az sql db show-usage](/cli/azure/sql#az-sql-show-usage) | Tek veya havuza alınan bir veritabanının boyut kullanım bilgilerini gösterir. |
