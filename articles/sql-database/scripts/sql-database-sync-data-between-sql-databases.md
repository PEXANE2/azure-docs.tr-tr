...
- Eşitleme şemasını güncelleştirme
    ...
    - PowerShell ile- [varolan bir eşitleme grubundaki eşitleme şemasını güncelleştirmek Için PowerShell kullanın](sql-database-sync-update-schema.md)
