---
title: PowerShell örnek-Azure SQL Veritabanı'nda tek bir veritabanı oluşturma
description: Azure SQL Veritabanı'nda tek bir veritabanı oluşturmak için Azure PowerShell örnek komut dosyası
...
---
# <a name="use-powershell-to-create-a-single-azure-sql-database-and-configure-a-sql-database-server-firewall-rule"></a>Tek bir Azure SQL veritabanı oluşturmak ve bir SQL Veritabanı sunucusu güvenlik duvarı kuralını yapılandırmak için PowerShell'i kullanın
