---
title: CLI örneği Geri Yükleme Geo yedekleme - Azure SQL Veritabanı
description: Azure SQL Yönetilen Örnek Veritabanını coğrafi yedekli bir yedeklemeden geri yüklemek için Azure CLI örnek komut dosyası.
...
---
# <a name="use-cli-to-restore-a-managed-instance-database-to-another-geo-region"></a>Yönetilen Örnek veritabanını başka bir coğrafi bölgeye geri yüklemek için CLI'yi kullanma

Bu Azure CLI komut dosyası örneği, uzak bir coğrafi bölgeden (coğrafi geri yükleme) bir Azure SQL Yönetilen Örnek veritabanını geri yükler.  
...
Varolan yönetilen örnek çifti, [bkz.](sql-database-create-configure-managed-instance-cli.md)
...
| | |
|---|---|
| [az sql midb](/cli/azure/sql/midb) | Yönetilen Örnek Veritabanı komutları. |
