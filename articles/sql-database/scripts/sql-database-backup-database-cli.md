---
title: "Azure CLı: Azure SQL veritabanı 'nda bir veritabanını yedekleme"
...
Bu Azure CLı örneği, SQL veritabanında bir veritabanını bir Azure depolama kapsayıcısına yedekler.  
