...
description: Visual Studio 'Yu kullanarak bir Azure SQL veritabanına bağlanan ve Transact-SQL deyimleriyle sorgulayan bir C# uygulaması oluşturun.
...
---
# <a name="quickstart-use-net-and-c-in-visual-studio-to-connect-to-and-query-an-azure-sql-database"></a>Hızlı başlangıç: Azure SQL veritabanına bağlanmak ve veritabanını sorgulamak için Visual Studio 'Da .NET ve C# kullanın
...
1. Kod Düzenleyicisi 'nde, **program.cs** içeriğini aşağıdaki kodla değiştirin. , `<server>`, Ve `<username>` `<password>` `<database>`için değerlerinizi değiştirin.
