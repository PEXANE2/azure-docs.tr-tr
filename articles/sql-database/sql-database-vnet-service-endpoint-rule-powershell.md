...
*Sanal ağ kuralları* , Azure [SQL veritabanı](sql-database-technical-overview.md) 'nda tek veritabanlarınız ve elastik havuzunuz için veritabanı sunucusunun ve Azure [SYNAPSE](../synapse-analytics/sql-data-warehouse/sql-data-warehouse-overview-what-is.md) 'deki belirli alt ağlardan gönderilen iletişimleri kabul edip etmediğini denetleyen bir güvenlik duvarı güvenlik özelliğidir.
