...
- [Uyarı oluşturma](sql-database-managed-instance-alerts.md) , yönetilen örnek için CPU kullanımı, depolama alanı TÜKETIMI, IOPS ve diğerleri gibi izlenen ölçümler üzerinde uyarı ayarlamanıza olanak sağlar. Bu kılavuzda, yönetilen örnek için uyarıları etkinleştirme ve yapılandırma hakkında bilgi edineceksiniz.
