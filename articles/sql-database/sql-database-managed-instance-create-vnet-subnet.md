...
>
> Yönetilen bir örnek oluşturulduktan sonra, yönetilen örneği veya VNet 'i başka bir kaynak grubuna veya aboneliğe taşımak desteklenmez.  Yönetilen örneği başka bir alt ağa taşımak de desteklenmez.
>
