...
> - Sanal kümeyi silme işlemi, yaklaşık 1,5 saat boyunca uzun süredir çalışan bir işlemdir (Bu işlem tamamlanana kadar, sanal kümenin portalda görünür olacağı sanal küme silme zamanına yönelik [yönetilen örnek yönetimi işlemlerine](https://docs.microsoft.com/azure/sql-database/sql-database-managed-instance#managed-instance-management-operations) bakın).
