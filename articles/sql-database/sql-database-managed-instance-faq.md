...
Hatalar ve bilinen sorunlar için bkz. [bilinen sorunlar](sql-database-release-notes.md#known-issues).

## <a name="new-features"></a>Yeni özellikler

**En son özellikleri ve özellikleri genel önizlemede nerede bulabilirim?**

Yeni ve Önizleme özellikleri için bkz. [sürüm notları](sql-database-release-notes.md?tabs=managed-instance).
...
Yönetilen örnek varsayılan DNS bölgesi *. Database.Windows.net* değiştirilebilir. 
...
Yönetilen örnek denetim düzlemi, yönetim bağlantı noktalarını koruyan NSG kurallarını korur.
...
IP adresini kullanarak yönetilen örneğe bağlanma desteklenmiyor. Yönetilen örnek konak adı, yönetilen örnek sanal kümesinin önünde yük dengeleyiciye eşlenir. Tek bir sanal küme birden çok yönetilen örnek barındırabildiğinden, adını belirtmeden doğru yönetilen örneğe yönlendirilemez.

Yönetilen örnek sanal küme mimarisi hakkında daha fazla bilgi için bkz. [sanal küme bağlantısı mimarisi](sql-database-managed-instance-connectivity-architecture.md#virtual-cluster-connectivity-architecture).
