...
9. Oluşturulan betikte yer tutucuları olan aşağıdaki SQL sorgusunu düzenleyin ve çalıştırın:
   ...
   > [!NOTE]
   > Belirli kullanıcıları belirli veritabanı `sp_addrolemember` rollerine eşlemek için de kullanabilirsiniz.
