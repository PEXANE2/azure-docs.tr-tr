...
|[Azure İzleyici günlükleri ile izleme](saas-dbpertenant-log-analytics.md) | Birden çok havuzda büyük miktarlarda kaynağı izlemek için [Azure izleyici günlüklerini](../log-analytics/log-analytics-overview.md) nasıl kullanacağınızı öğrenin. |
