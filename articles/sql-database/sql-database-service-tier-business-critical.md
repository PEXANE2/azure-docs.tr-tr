...
İş Açısından Kritik hizmet katmanı, temel alınan SSD depolamadan (ortalama 1-2 ms) düşük Gecikmeli yanıt gerektiren uygulamalar için tasarlanmıştır, temeldeki altyapı başarısız olursa hızlı kurtarma, birincil veritabanının fazla okunabilir ikincil çoğaltmasını ücretsiz olarak okuma ve rapor, analiz ve salt okunur sorgular yüklemeye gerek duyar.
