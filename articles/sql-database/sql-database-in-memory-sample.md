...
3. -S `<placeholders>` -U-P-d parametreleri için doğru gerçek değerlerle değiştirin.
...
Bellek Içi testleriniz, bu uyarlaması iş yükü için, veritabanı ile aynı Azure bölgesindeki bir Azure VM üzerinde `ostress` çalışırken bu performansı **dokuz kez** artmış olarak göstermiştir.
