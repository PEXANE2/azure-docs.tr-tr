...
- [Tek bir veritabanı oluşturma](../sql-database-single-database-get-started.md)
- [Esnek havuz oluşturma](../sql-database-elastic-pool.md#creating-a-new-sql-database-elastic-pool-using-the-azure-portal)
- [Yönetilen örnek oluşturma](../sql-database-managed-instance-get-started.md)
- [SQL sanal makinesi oluşturma](../../virtual-machines/windows/sql/quickstart-sql-vm-create-portal.md)