...
1. Web tarayıcınızdahttp://events.wingtip-dpt.&lt, Wingtip bilet olayları hub 'ını açın (; user&gt;. trafficmanager.NET-Kullanıcı &lt;&gt; , dağıtımınızın Kullanıcı değeri ile değiştirin).
    ...
    *Ipucu: ekranı büyütmek için fareyi konumun üzerine getirin.* 
...
1. Katalog veritabanı kurtarıldıktan hemen sonra, Web tarayıcınızda Wingtip bilet olayları merkezini yenileyin.
   ...
   * Bir çevrimdışı kiracının Olaylar sayfasını doğrudan açarsanız, ' kiracı çevrimdışı ' bildirimini görüntüler. Örneğin, contoso Concert Salı çevrimdışıysa, şunu açmayı http://events.wingtip-dpt.&ltdeneyin; user&gt;. trafficmanager.net/contosoconcerthall ![contoso çevrimdışı sayfası](media/saas-dbpertenant-dr-geo-replication/dr-in-progress-offline-contosoconcerthall.png) 
...
4. Contoso Concert salyamı olayları sayfasını (http://events.wingtip-dpt.&lt; user&gt;. trafficmanager.net/contosoconcerthall-Kullanıcı &lt;&gt; , dağıtımınızın Kullanıcı değeri ile değiştirin) yenileyip son olayın silindiğini görürsünüz.
