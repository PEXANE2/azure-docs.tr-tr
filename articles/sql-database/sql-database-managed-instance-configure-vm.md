...
SQL yönetilen örneği özel sanal ağınıza yerleştirildiğinden, SQL Server Management Studio veya Azure Data Studio gibi yüklü bir SQL istemci aracı ile Azure VM oluşturmanız gerekir. Bu araç, yönetilen örneğe bağlanmanıza ve sorguları yürütmenize imkan tanır. Bu hızlı başlangıçta SQL Server Management Studio kullanılmıştır.
