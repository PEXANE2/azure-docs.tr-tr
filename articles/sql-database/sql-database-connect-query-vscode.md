...
2. Sorguyu **Ctrl**+çalıştırmak `Product` ve ve `ProductCategory` tablolarından sonuçları göstermek için CTRL**SHIFT**+**E** tuşlarına basın.

    ![2 tablodan veri alma sorgusu](./media/sql-database-connect-query-vscode/query.png)

## <a name="insert-data"></a>Veri ekleme

Tabloya yeni bir ürün eklemek için aşağıdaki INSERT Transact-SQL ifadesini çalıştırın. [INSERT](https://msdn.microsoft.com/library/ms174335.aspx) `SalesLT.Product`
...
2. `Product` Tabloya yeni bir satır eklemek için **CTRL**+**SHIFT**+**E** tuşlarına basın.
