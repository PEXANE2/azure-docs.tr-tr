...
description: Bu makalede, Azure portalını kullanarak bir Röle ad alanı oluşturmanızı gösteren bir gözden geçirme sağlar.
...
2. [Azure Kaynak Yöneticisi](../azure-resource-manager/management/overview.md) şablonları.
