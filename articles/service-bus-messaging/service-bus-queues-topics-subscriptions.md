...
[JMS 2,0 varlıkları](java-message-service-20-entities.md) ve [bunların](how-to-use-java-message-service-20.md)nasıl kullanılacağı hakkında daha fazla bilgi edinin.
