...
```
## <a name="is-it-possible-to-disable-tls-10-or-11-on-service-bus-namespaces"></a>Service Bus ad alanlarında TLS 1,0 veya 1,1 devre dışı bırakmak mümkün mü?
Hayır. Service Bus ad alanlarında TLS 1,0 veya 1,1 devre dışı bırakılamıyor. Service Bus bağlanan istemci uygulamalarınızda TLS 1,2 veya üstünü kullanın. Daha fazla bilgi için bkz. [Azure Service Bus-Microsoft Tech Community Ile TLS 1,2 kullanımını zorlama](https://techcommunity.microsoft.com/t5/messaging-on-azure/enforcing-tls-1-2-use-with-azure-service-bus/ba-p/370912).
