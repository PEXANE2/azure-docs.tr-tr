...
> [!IMPORTANT]
> Birden çok genel IP adresine sahip Azure Güvenlik Duvarı Azure PowerShell, Azure CLı, REST ve şablonlar aracılığıyla kullanılabilir. Portal Kullanıcı arabirimi bölgelere artımlı olarak ekleniyor ve dağıtım tamamlandığında tüm bölgelerde kullanılabilir olacak.
