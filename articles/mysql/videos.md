---
title: MySQL için Azure veritabanı videoları
description: Bu sayfada, Microsoft 'un Azure 'da yönetilen MySQL teklifi olan MySQL için Azure veritabanı 'nı öğrenmeyle ilgili video içeriği listelenmiştir.
author: savjani
ms.author: pariks
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "94532429"
---
# <a name="azure-database-for-mysql-videos"></a>MySQL için Azure veritabanı videoları

Bu sayfa, MySQL için Azure veritabanı hakkında bilgi edinmek için video içeriği sağlar.
...
## <a name="how-to-get-started-with-the-new-azure-database-for-mysql-service"></a>Yeni MySQL hizmeti için Azure veritabanı 'nı kullanmaya başlama
