...
Veri kaynağı |*Hiçbiri* | Sıfırdan yeni bir sunucu oluşturmak için *Yok*'u seçin. (Mevcut bir MySQL için Azure veritabanı sunucusunun coğrafi yedeğinden bir sunucu oluşturuyorsanız *yedeklemeyi* seçersiniz).
