...
Sunucunuz için kullanılabilir yavaş sorgu günlük dosyalarını listelemek için [az mysql server-logs listesi](/cli/azure/mysql/server-logs#az-mysql-server-logs-list) komutunu çalıştırın.
...
Az [mysql server-logs indirme](/cli/azure/mysql/server-logs#az-mysql-server-logs-download) komutu ile sunucunuz için tek tek günlük dosyalarını indirebilirsiniz. 
