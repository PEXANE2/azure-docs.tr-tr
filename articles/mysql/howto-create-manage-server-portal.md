---
title: Sunucuyönet - Azure portalı - MySQL için Azure Veritabanı
description: Azure portalından MySQL sunucusu için bir Azure Veritabanını nasıl yönetebilirsiniz öğrenin.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "80062411"
---
# <a name="manage-an-azure-database-for-mysql-server-using-the-azure-portal"></a>Azure portalını kullanarak MySQL sunucusu için bir Azure Veritabanını yönetme
Bu makalede, MySQL sunucuları için Azure Veritabanınızı nasıl yönetacağınızı gösterilmektedir. Yönetim görevleri arasında bilgi işlem ve depolama ölçekleme, yönetici parola sıfırlama ve sunucu ayrıntılarının görüntülenmesi yer almaktadır.

## <a name="sign-in"></a>Oturum aç
[Azure portalında](https://portal.azure.com)oturum açın.

## <a name="create-a-server"></a>Sunucu oluşturma
MySQL sunucusu için bir Azure Veritabanı oluşturma yı ve nasıl başlayacağınızı öğrenmek için [hızlı başlat'ı](quickstart-create-mysql-server-database-using-azure-portal.md) ziyaret edin.
...
- [MySQL için Azure Veritabanı'nda aladeğiştirme ve izleme seçenekleri](concepts-monitoring.md) hakkında bilgi edinin
