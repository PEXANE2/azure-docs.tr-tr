...
Bu komut için özelleştirmek üzere ek bağımsız değişkenler sağlayabilirsiniz. [Az MySQL esnek-sunucu oluşturma](/cli/azure/mysql/flexible-server?view=azure-cli-latest#az_mysql_flexible_server_create)için tüm bağımsız değişkenlere bakın.
