---
title: 'Hızlı başlangıç: Mysqlesnek sunucusu için Azure veritabanı ile Java ve JDBC kullanma'
description: Bir MySQL için Azure veritabanı esnek sunucu veritabanı ile Java ve JDBC kullanmayı öğrenin.
author: mksuni
ms.author: sumuth
ms.service: mysql
...
ms.locfileid: "98606167"
---
# <a name="quickstart-use-java-and-jdbc-with-azure-database-for-mysql-flexible-server"></a>Hızlı başlangıç: MySQL için Azure veritabanı esnek sunucusu ile Java ve JDBC kullanma

Bu konu başlığı altında, [MySQL Için Azure veritabanı esnek sunucusu](./index.yml)'nda bilgi depolamak ve almak üzere Java ve [JDBC](https://en.wikipedia.org/wiki/Java_Database_Connectivity) kullanan bir örnek uygulama oluşturma gösterilmektedir.
...
> [!NOTE]
> MySQL sunucuları oluşturma hakkında daha ayrıntılı bilgileri [Azure portalı kullanarak MySQL için Azure Veritabanı sunucusu oluşturma](./quickstart-create-server-portal.md) başlıklı makaleyi okuyarak edinebilirsiniz.
...
Sunucuya yerel makinenizden erişmek için IP adresı> <girdiğinizden emin olun. Bu komut, geliştirme için uygun bir Burstable katman MySQL esnek sunucusu oluşturur.

Oluşturduğunuz MySQL sunucusunda, **flexibtaserverdb** adlı boş bir veritabanı bulunur. Bu veritabanı, bu makale için kullanacağız.
