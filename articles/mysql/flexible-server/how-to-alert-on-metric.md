...
8. **Eşik** türünü seçin (örn. "Static" veya "Dynamic"), **işleç** (örn. "Büyüktür") ve **toplama türü** (örn. Ortalama). Bu, ölçüm uyarı kuralının değerlendileceğini belirten mantığı belirleyecek.
    ...
    - **Dinamik** eşik kullanıyorsanız, **eşik duyarlılığını** tanımlamaya devam edin. Ölçüm grafiği, hesaplanan eşikleri son verilere göre görüntüler. [Dinamik eşikler durum türü ve duyarlılık seçenekleri hakkında daha fazla bilgi edinin](../../azure-monitor/platform/alerts-dynamic-thresholds.md).
...
12. Uyarı üzerinde bildirim almak için yeni bir eylem grubu da oluşturabilirsiniz. Daha fazla bilgi için [eylem grubu oluşturma ve yönetme](../../azure-monitor/platform/action-groups.md) bölümüne bakın.
...
- [Ölçümler üzerinde uyarı ayarlama](../../azure-monitor/platform/alerts-metric.md)hakkında daha fazla bilgi edinin.
...
- [Azure İzleyici'de ölçüm uyarılarının nasıl çalıştığını anlama](../../azure-monitor/platform/alerts-metric-overview.md)