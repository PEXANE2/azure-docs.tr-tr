...
Ağ Geçidi Hizmeti, bir IP adresinin arkasında yer alan durum bilgisiz işlem düğümleri grubunda barındırılır. Bu, istemciniz, MySQL için Azure veritabanı sunucusuna bağlanmaya çalışırken ilk olarak ulaşacak. 
...
| Batı ABD 2 | 13.66.136.192 | 13.66.226.202  | | 
||||
