---
title: C++/NDK'da kaba relocalization
description: C++/NDK'da kaba yeniden yerelleştirme kullanarak çapaların nasıl oluşturulup bulunabildiğini derinlemesine açıklama.
author: bucurb
manager: dacoghl
...
---
# <a name="how-to-create-and-locate-anchors-using-coarse-relocalization-in-cndk"></a>C++/NDK'da kaba yeniden yerelleştirme yi kullanarak çapa oluşturma ve bulma
