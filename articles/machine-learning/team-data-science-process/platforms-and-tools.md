...
DSVM'nin Windows sürümü hakkında daha fazla bilgi için Azure Marketi'ndeki [Microsoft Data Science Virtual Machine](https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-dsvm.dsvm-windows) bölümüne bakın. DSVM Linux sürümü için, [Linux Veri Bilimi Sanal Makine](https://azure.microsoft.com/marketplace/partners/microsoft-ads/linux-data-science-vm/)bakın.
