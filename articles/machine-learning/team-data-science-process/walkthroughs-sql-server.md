---
title: R, Python ve T-SQL-Team Data Science Işlemi ile SQL Server Analytics
...
Bu izlenecek yollar, tahmine dayalı analiz yapmak için SQL Server, SQL Server R Services ve SQL Server Python hizmetlerini kullanır. R ve Python kodu saklı yordamlarda dağıtılır. Bunlar, Team Data Science Işleminde özetlenen adımları izler. Ekip veri bilimi sürecine genel bir bakış için bkz. [veri bilimi işlemi](overview.md). 
...
## <a name="predict-taxi-tips-using-python-and-sql-queries-with-sql-server"></a>SQL Server ile Python ve SQL sorguları kullanarak TAXI ipuçlarını tahmin edin 
