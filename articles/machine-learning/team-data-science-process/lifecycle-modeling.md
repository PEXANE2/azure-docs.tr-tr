...
Bu aşamada üretilen yapıtları içerir:
   ...
   * **Kontrol noktası kararı**: modelin bir üretim sistemine dağıtmak için yeterince iyi performans yapıp yapmadığını değerlendirin. Bazı temel sorular sormak için şunlardır:
