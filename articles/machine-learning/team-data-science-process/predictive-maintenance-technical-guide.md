...
* Çözüm dağıtıldığında oluşturulan Stream Analytics Icon](./media/predictive-maintenance-technical-guide/icon-stream-analytics.png) ![Stream Analytics işleri bulma (*Örneğin*, tahmine dayalı bakım çözümü için **maintenancesa02asapbi** ve **maintenancesa02asablob** )
* Seçme
...
* İşlem hattının son adım, SQL veritabanı'na veri (örneğin tahminler makine öğreniminin) yazmaktır. En fazla üç saat verilerin SQL veritabanı'nda görünmesi için beklemeniz gerekebilir. SQL veritabanınızda kullanılabilir veri miktarını izlemenin bir yolu [Azure Portal](https://portal.azure.com/). Sol bölmede SQL VERITABANı ![SQL simge](./media/predictive-maintenance-technical-guide/icon-SQL-databases.png) bulun ve tıklayın. Daha sonra veritabanınızın **pmaintenancedb** bulun ve üzerine tıklayın. Altındaki sonraki sayfada, Yönet'e tıklayın.
...
2. Durgun yoldaki rapor dosyası veri kaynağı, Power BI Desktop ile güncelleştirin.
   ...
   * İkinci **tabloya tıklayın** . daha sonra sağ **' sorgu ayarları '** panelinde **' uygulanan adımlar '** altında bulunan ' **kaynak '** öğesinin yanındaki ![gezinti simgesine](./media/predictive-maintenance-technical-guide/icon-navigation.png) tıklayın ve sunucu ve veritabanı adlarını yukarıdaki adımlarda olduğu gibi güncelleştirin ve Tamam ' a tıklayın.
...
3. Seçim [Power BI çevrimiçi](https://www.powerbi.com/)olarak soğuk yol panosunu yayımlayın. Bu adım bir Power BI hesabına (veya Office 365 hesabına) ihtiyaç duyuyor.
   ...
   * Raporu açtığınızda, tüm görselleştirmeleri panonuza sabitlemek için ![SABITLEME simgesine](./media/predictive-maintenance-technical-guide/icon-pin.png) tıklayın. Ayrıntılı yönergeleri bulmak için bkz. bir [panodaki kutucuğu bir Power BI panoya sabitleme](https://support.powerbi.com/knowledgebase/articles/430323-pin-a-tile-to-a-power-bi-dashboard-from-a-report).
   ...
   * Verilerin yenilenmesini zamanlamak için, farenizi **PredictiveMaintenanceAerospace** veri kümesinin üzerine getirin, ![üç nokta simgesine](./media/predictive-maintenance-technical-guide/icon-elipsis.png) ve sonra **yenilemeyi zamanla**' yı seçin.
     ...
     **Note:** Bir uyarı açıklaması görürseniz, **kimlik bilgilerini düzenle** ' ye tıklayın ve veritabanı kimlik bilgilerinizin adım 1 ' de açıklananlarla aynı olduğundan emin olun.
     <br/>
     ![yenilemeyi zamanla](./media/predictive-maintenance-technical-guide/schedule-refresh.png)
     <br/>
