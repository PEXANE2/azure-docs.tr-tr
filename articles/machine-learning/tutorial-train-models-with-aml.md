...
Mevcut çalışma alanından bir çalışma alanı nesnesi oluşturun. `Workspace.from_config()`**config. JSON** dosyasını okur ve şu adlı bir nesneye ayrıntıları yükler `ws` :
