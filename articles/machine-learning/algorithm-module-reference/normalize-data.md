...
5. **Dönüştürme yöntemi** açılan listesinden, seçili tüm sütunlara uygulamak için tek bir matematik işlevi seçin. 
    ...
    - **MinMax**: minimum-Max normalleştirici her özelliği [0, 1] aralığına göre.
      ...
      ![Min&#45;Max işlevini kullanarak normalleştirme](media/module/aml-normalization-minmax.png "AML_normalization-MinMax")  
...
6. İşlem hattını gönder veya **Normalleştir veri** modülünü çift tıklayıp **Seçileni Çalıştır**' ı seçin. 
