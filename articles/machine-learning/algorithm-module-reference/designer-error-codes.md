...
## <a name="error-0033"></a>Hata 0033  
 ...
 Bağımsız değişken sonsuz ise Azure Machine Learning bu hata oluşur. Bağımsız değişken ya da `double.NegativeInfinity` ise bu hatayı alırsınız. `double.PositiveInfinity`  
