...
description: Birden fazla değeri tahmin etmek için Azure Machine Learning tasarımcısında çok Lass lojistik regresyon modülünü nasıl kullanacağınızı öğrenin.
