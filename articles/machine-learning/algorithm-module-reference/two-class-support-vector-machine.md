...
description: İkili bir sınıflandırıcı oluşturmak için Azure Machine Learning Two-Class destek vektör makinesi modülünü nasıl kullanacağınızı öğrenin.
