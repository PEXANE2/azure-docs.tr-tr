...
|Karışık öğe türlerinde "{column_id}" kimlikli sütun oluşturulamıyor: \ n\tType, öbek {chunk_id_1} "{type_1}". {Chunk_id_2} öbekteki tür "{type_2}", {1} öbek boyutuyla: {chunk_size}.|
...
|Özel durum Iletileri|
|------------------------|
|Büyük olasılıkla eski bir serileştirme biçimiyle serileştirildiği için model seri durumdan çıkarılamadı. Lütfen modeli yeniden eğitin ve yeniden kaydedin.|
...
|Desteklenmeyen parametre türü ' {parameter_name} ' belirtildi.|
|Desteklenmeyen parametre türü ' {parameter_name} ' belirtildi. Neden: {Reason}.|
...
|Özel durum Iletileri|
|------------------------|
|Sütun adları dize değil.|
|Sütun adları: {column_names} dize değil.|
