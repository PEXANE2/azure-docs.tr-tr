...
description: Özel R kodunu çalıştırmak için Azure Machine Learning tasarımcısında R betiği Yürüt modülünü nasıl kullanacağınızı öğrenin.
