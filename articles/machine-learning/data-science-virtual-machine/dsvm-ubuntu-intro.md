...
Jupyıterlab, yeni nesil jupi Not defterleri ve Jupde de mevcuttur. Bu dosyaya erişmek için JupyterHub 'da oturum açın ve https:\//Your-VM-IP: 8000/User/The-username/Lab URL 'sine gıdın ve VM 'yi yapılandırırken seçtiğiniz kullanıcı adıyla "adınızı-username" değerini değiştirin. Bundan sonra, bir sertifika hatası nedeniyle başlangıçta siteye erişiminizi engellemiş olabilirsiniz.
