...
| Nasıl, yapılandırılmış / DSVM üzerinde yüklü?  | İki genel `conda` ortamı oluşturulur: <br /> * `/anaconda/` ' de bulunan `root` ortamı Python 3,7 ' dir. <br/> * `/anaconda/envs/python2` ' de bulunan `python2` ortamı Python 2,7 ' dir.       |
