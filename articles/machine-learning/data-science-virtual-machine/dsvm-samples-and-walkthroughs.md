...
| Örnek kategorisi | Description | Konumlar |
| ------------- | ------------- | ------------- |
...
Jupiter 'a erişmek için masaüstü veya uygulama menüsünde **Jupiter** simgesini seçin. Ayrıca, jupi 'nin bir DSVM 'nin Linux sürümünde de erişebilirsiniz. Bir Web tarayıcısından uzaktan erişmek için `https://<Full Domain Name or IP Address of the DSVM>:8000` Ubuntu 'a gidin.
