...
7. Klasik web hizmetleri için oluşturma **ml tanılama** kapsayıcı.
   ...
   3. Kapsayıcı **ml tanılama** mevcut olmayan'a tıklayın **+ kapsayıcı**, kapsayıcı "ml-diagnostics" adını verin ve seçin **erişim türü** "BLOB". **Tamam**’a tıklayın.
