...
## <a id="visualizations"></a>Görselleştirmelerle çalışma
...
Bu işlem, Pandas 'teki scatter_matrix işlevini kullanarak dağılım çizim matrisi oluşturan aşağıdaki görüntülerde gösterilmiştir.
