...
> [!IMPORTANT]
> Web hizmetine dağıtılmadan önce yerel olarak hata ayıklaması önerilir, daha fazla bilgi için bkz. [yerel olarak hata ayıklama](./how-to-troubleshoot-deployment.md#debug-locally)
>
