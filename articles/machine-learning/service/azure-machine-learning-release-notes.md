...
+ **Yeni özellikler**
  + Etkinleştirilen `TabularDataset`, AutomatedML tarafından tüketilmelidir. `TabularDataset`hakkında daha fazla bilgi edinmek için lütfen https://aka.ms/azureml/howto/createdatasets ziyaret edin.
