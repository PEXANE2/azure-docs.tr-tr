...
@No__t_0 bağımsız değişkeni, veri deposunun değişiklikler için denetlenme sıklığını dakika cinsinden belirtmenize olanak tanır.
...
Web tarayıcınızda Machine Learning hizmet çalışma alanınıza gidin. Gezinti bölmesinin **varlıklar** bölümünde işlem **hatları**' nı seçin. Bu bağlantı sizi çalışma alanında yayınlanan işlem hatları listesine yönlendirir.

![Çalışma alanının ardışık düzenleri sayfası](media/how-to-schedule-a-pipeline/pipelines-list.png)
