---
title: 'Görsel arabirim örnek #7: kitap incelemelerini sınıflandırın'
titleSuffix: Azure Machine Learning
description: Farklı kategorilerde makine öğrenimi modeli sınıflandırmasına yönelik bir bilgisayar incelemesi oluşturma hakkında bilgi edinin.
...
Bu örnek, Azure Machine Learning görsel arabirimde metin sınıflandırması işlem hattı oluşturmak için metin analizi modüllerinin nasıl kullanılacağını gösterir.
...
[deneme ![Graph](./media/how-to-ui-sample-text-classification/nlp-modules-overall.png)](./media/how-to-ui-sample-text-classification/nlp-modules-overall.png#lightbox)

## <a name="data"></a>Veriler

Bu deneyde, **Vikipedi SP 500** veri kümesini kullanacağız. Veri kümesi, her S & P 500 şirketinin makalelerini temel alan Viküm 'den (https://www.wikipedia.org/) türetilir. Azure Machine Learning görsel arabirimine yüklemeden önce, veri kümesi şu şekilde işlenir:
...
Algoritma seçiminiz genellikle kullanım durumunun gereksinimlerine bağlıdır. Bu denemenin hedefi şirket kategorisini tahmin etmek olduğundan, çok sınıf bir sınıflandırıcı modeli iyi bir seçimdir. Özellik sayısının büyük olduğunu ve bu özelliklerin seyrek olduğunu düşünürken, bu deneme için **birden çok Lass lojistik regresyon** modeli kullanıyoruz.
...
[n-gram puanı ![Graph](./media/how-to-ui-sample-text-classification/n-gram.png)](./media/how-to-ui-sample-text-classification/n-gram.png)
