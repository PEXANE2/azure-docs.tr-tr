...
1. Uzantı için bir hoş geldiniz sekmesi Visual Studio Code açılır ve Azure sembolü (aşağıdaki ekran görüntüsünde kırmızı renkle vurgulanır) etkinlik çubuğuna eklenir.
   ...
   ![Visual Studio Code etkinlik çubuğundaki Azure simgesi](./media/how-to-vscode-tools/azure-activity-bar.png)
...
1. **Train.py** açın ve hata ayıklayıcıyı açıp Çalıştır düğmesine basarak çalıştırın (veya yalnızca F5 tuşuna basın).
   ...
   [![, MNIST eğitimi çalıştırın](./media/how-to-vscode-tools/run-mnist.gif)](./media/how-to-vscode-tools/run-mnist.gif#lightbox)

Her şey doğru şekilde yüklenirse, betik çalışır ve çıktılar klasöründe bir TensorFlow modeli oluşturur.

[TensorFlow modelini göster ![](./media/how-to-vscode-tools/show-tensorflow-model.gif)](./media/how-to-vscode-tools/show-tensorflow-model.gif#lightbox)
...
İşte bu kadar! Şimdi, kodunuzu bulutta çalıştırmak için yalnızca uzantıyı kullanın! Aşağıdaki izlenecek yol videosunun, yeni bir Azure Machine Learning çalışma alanı ve işlem oluşturmak için gereken süre miktarını ve eğitim betiğini çalıştırmak için gereken süreyi sıkıştırıp aldığını unutmayın.

   [Azure ML denemesi ![başlatın](./media/how-to-vscode-tools/start-golden-path.gif)](./media/how-to-vscode-tools/start-golden-path.gif#lightbox)

Deneme Çalıştır düğmesine tıkladıktan sonra, istemleri aşağıdaki gibi yanıtlayın:

1. Azure aboneliğinizi seçin.
1. *Yeni* bir Azure Machine Learning çalışma alanı oluşturmayı seçin.
...
1. Uzantı, sizin için her şeyi ayarlarken ve komut dosyanızı yürüttüğünde, arka ve rahat oturdum!
    ...
    [bulutta eğitme ![](./media/how-to-vscode-tools/run-golden-path.gif)](./media/how-to-vscode-tools/run-golden-path.gif#lightbox)

Birkaç saniye içinde, deneme işleminin Azure 'a gönderildiği, VS Code bildiriminde **deneme çalıştırmasını görüntüle** bağlantısına tıklayarak vs Code ya da Azure sekmesindeki Yenile düğmesine basarak, Azure Machine Learning Studio 'da ilerleme durumunu görüntüleyebileceğiniz bir bildirim alırsınız.
...
[Portalda ![deneme çalıştırması](./media/how-to-vscode-tools/experiment-run-on-portal.PNG)](./media/how-to-vscode-tools/experiment-run-on-portal.PNG#lightbox)
...
1. Visual Studio Code etkinlik çubuğunda Azure simgesini seçin. Azure Machine Learning kenar çubuğu görüntülenir.
    ...
    [![çalışma alanı oluşturma](./media/how-to-vscode-tools/create-workspace.gif)](./media/how-to-vscode-tools/create-workspace.gif#lightbox)
...
1. Bir çalışma alanında, **etkin** deneme olarak ayarlamak için bir denemeye sağ tıklayabilirsiniz. **Etkin** deneme, bulutta o anda açık olan ve Visual Studio Code açık olan klasöre bağlantı sağlar. Bu klasör yerel Python betiklerinizi içermelidir. Etkin bir deneme ayarlayarak, tüm eğitim çalıştırmaları için anahtar ölçümler, nerede çalıştırıldıklarından bağımsız olarak deneme içinde depolanır.
    ...
    [![deneme oluşturma](./media/how-to-vscode-tools/create-experiment.gif)](./media/how-to-vscode-tools/create-experiment.gif#lightbox)
...
[Visual Studio Code ' de AML işlem oluşturma ![](./media/how-to-vscode-tools/create-remote-compute.gif)](./media/how-to-vscode-tools/create-remote-compute.gif#lightbox)
...
[işlem için çalıştırma yapılandırması oluşturma ![](./media/how-to-vscode-tools/create-runconfig.gif)](./media/how-to-vscode-tools/create-runconfig.gif#lightbox)
...
[deneme ![yerel olarak çalıştırın](./media/how-to-vscode-tools/run-experiment.gif)](./media/how-to-vscode-tools/run-experiment.gif#lightbox)
...
[bir modeli AML 'ye kaydetme ![](./media/how-to-vscode-tools/register-model.gif)](./media/how-to-vscode-tools/register-model.gif#lightbox)
...
[Web hizmeti dağıtma ![](./media/how-to-vscode-tools/create-image.gif)](./media/how-to-vscode-tools/create-image.gif#lightbox)
...
[Visual Studio Code için Azure Machine Learning klavye kısayollarını ![](./media/how-to-vscode-tools/commands.gif)](./media/how-to-vscode-tools/commands.gif#lightbox)
