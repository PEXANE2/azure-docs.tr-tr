...
<div>
<style scoped>. dataframe tbody tr TH: yalnızca-of-type {Vertical-ALIGN: Middle;}. dataframe tbody tr TH {Vertical-ALIGN: top;}. dataframe iş parçacığı TH {text-align: Right;}</style>
