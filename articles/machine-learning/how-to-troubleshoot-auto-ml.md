...
ms.locfileid: "102435681"
---
# <a name="troubleshoot-automated-ml-experiments-in-python"></a>Python 'da otomatik ML denemeleri sorunlarını giderme

Bu kılavuzda, [Azure MACHINE LEARNING SDK](/python/api/overview/azure/ml/intro?preserve-view=true&view=azure-ml-py)ile otomatikleştirilmiş makine öğrenimi denemeleri içinde bilinen sorunları belirlemeyi ve çözümlemeyi öğrenin.
