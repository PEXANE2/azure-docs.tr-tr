...
Sınıf `AMLRequest` yalnızca score.py ham deftere nakledilen verilere erişmenizi sağlar, istemci tarafı bileşeni yoktur. Bir istemciden, verileri normal olarak yayınlarsınız. Örneğin, aşağıdaki Python kodu bir resim dosyasını okur ve verileri gönderir:
...
> [!WARNING]
> Azure Machine Learning, yalnızca POST ve GET isteklerini puanlama hizmetini çalıştıran kapsayıcılara yönlendirecektir. Bu, uçuş öncesi CORS isteklerine OPTIONS isteklerini kullanan tarayıcılar nedeniyle hatalara neden olabilir.
> 
