...
+ [Öğreticiler ve nasıl yapılır makaleleri](./index.yml) 
+ [Başlangıç veri bilimi videoları](./data-science-for-beginners-ask-a-question-you-can-answer-with-data.md) 
...
+ **Azure müşterileri Için Teknik destek**: Azure Portal aracılığıyla [destek istekleri gönderir ve yönetin](../../azure-portal/supportability/how-to-create-azure-support-request.md) .

+ **Kullanıcı Forumu**: soru sorun, sorular yanıtlayın ve [Azure Machine Learning Studio (klasik) destek forumundaki](/answers/topics/azure-machine-learning.html)diğer kullanıcılarla bağlantı yapın.
