...
Ardından, [Get-AzMlWebService](/powershell/module/az.machinelearning/get-azmlwebservice) cmdlet 'Ini çağırarak Web hizmeti tanım nesnesini alın.
...
Eğitilen modelin tanımını yeni eğitilen modeli kullanacak şekilde değiştirmek için, önce [Export-AzMlWebService](/powershell/module/az.machinelearning/export-azmlwebservice) cmdlet 'INI kullanarak JSON biçimli bir dosyaya dışarı aktarmanız gerekir.
...
Değiştirilen JSON dosyasını, tahmine dayalı denemeyi güncelleştirmek için kullanabileceğiniz bir Web hizmeti tanım nesnesine geri dönüştürmek için [Import-AzMlWebService](/powershell/module/az.machinelearning/import-azmlwebservice) cmdlet 'ini kullanın.
...
Son olarak, tahmine dayalı denemesini güncelleştirmek için [Update-azmlwebservice](/powershell/module/az.machinelearning/update-azmlwebservice) cmdlet 'ini kullanın.
