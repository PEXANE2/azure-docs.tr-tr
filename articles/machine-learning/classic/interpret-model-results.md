...
Bu deneyde, birden çok Lass sınıflandırmasına örnek olarak bir mektup tanıma görevi gerçekleştirirsiniz. Sınıflandırıcı, el ile yazılmış görüntülerden ayıklanan bazı el ile yazılmış öznitelik değerlerine bağlı olarak belirli bir% 28class %29 harfini tahmin etmeye çalışır.
