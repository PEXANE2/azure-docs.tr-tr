...
## <a name="train-multiple-models"></a><a name="train"></a>Birden çok modeli eğitme
...
> [!TIP]
> Çözmeye çalıştığınız belirli bir sorunu en iyi şekilde karşılayacak Machine Learning algoritmasının karar vermeyle ilgili yardım almak için bkz. [Microsoft Azure Machine Learning Studio algoritmaları seçme (klasik)](../how-to-select-algorithms.md).
> 
> 
