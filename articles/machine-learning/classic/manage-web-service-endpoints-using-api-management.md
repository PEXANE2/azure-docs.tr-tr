...
![Ekran görüntüsü, bir hizmet oluşturmak için gerekli seçeneklere sahip bir P I yönetim hizmeti iletişim kutusu gösterir.](./media/manage-web-service-endpoints-using-api-management/create-service.png)
...
![Ekran görüntüsünde bir onaylama iletisi ve yayımlama seçeneği gösterilir.](./media/manage-web-service-endpoints-using-api-management/yes-to-publish.png)
...
![Ekran görüntüsünde, Web hizmeti panosunda bir P I anahtarını bulabileceğiniz denemeler gösterilmektedir.](./media/manage-web-service-endpoints-using-api-management/find-api-key.png)
...
![Ekran görüntüsü, denemenin sonucunu gösterir ve bu, tırnak işaretleri içinde iyi bir gün ve birkaç basamak okur.](./media/manage-web-service-endpoints-using-api-management/sample-output.png)
