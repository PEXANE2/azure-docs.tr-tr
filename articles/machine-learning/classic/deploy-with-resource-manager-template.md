---
title: 'ML Studio (klasik): Azure Resource Manager çalışma alanlarını dağıtma-Azure'
...
```
Bu şablonu, c:\temp\altındaki dosyaya mlworkspace.jsolarak kaydedin.
