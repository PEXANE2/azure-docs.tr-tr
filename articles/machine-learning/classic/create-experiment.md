---
title: 'ML Studio (klasik): hızlı başlangıç: veri bilimi denemesi oluşturma-Azure'
...
Bu hızlı başlangıçta, marka ve teknik belirtimler gibi farklı değişkenlere göre bir otomobil fiyatını tahmin eden [Azure Machine Learning Studio (klasik)](../overview-what-is-machine-learning-studio.md#ml-studio-classic-vs-azure-machine-learning-studio) ' de bir makine öğrenimi denemesi oluşturursunuz.
...
> marka, gövde stili, tekerlek-tabanı, altyapı boyutu, Horsepower, yoğun-rpm, Highway-MPG, Fiyat
