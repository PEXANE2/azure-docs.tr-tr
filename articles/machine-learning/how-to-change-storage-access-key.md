...
Veri depolarını kaydetme hakkında daha fazla bilgi için bkz [`Datastore`](https://docs.microsoft.com/python/api/azureml-core/azureml.core.datastore(class)?view=azure-ml-py&preserve-view=true) . sınıf başvurusu.
