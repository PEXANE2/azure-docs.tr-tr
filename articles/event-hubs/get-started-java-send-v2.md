...
Aşağıdaki örnek için önce en sevdiğiniz Java geliştirme ortamında bir konsol/kabuk uygulaması için yeni bir Maven projesi oluşturun. Adlı `Sender`bir sınıf ekleyin ve aşağıdaki kodu sınıfına ekleyin:
