...
> [!NOTE]
> Bu bölümdeki kod, Event Hubs SDK 'nın geçerli kararlı sürümü (1.3.1) içindir. SDK 'nın önizleme sürümünü kullanan örnek kodu arıyorsanız, [Bu sayfaya](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/eventhub/azure-eventhubs/examples)bakın.
