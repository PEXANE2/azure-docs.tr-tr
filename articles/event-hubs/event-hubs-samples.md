...
ms.locfileid: "85315520"
---
# <a name="git-repositories-with-samples-for-azure-event-hubs"></a>Azure Event Hubs için örnek içeren Git depoları 
[GitHub](https://github.com/Azure/azure-event-hubs/tree/master/samples)üzerinde Event Hubs örnekleri bulabilirsiniz. Bu örnekler [Azure Event Hubs](/azure/event-hubs/)'daki temel özellikleri gösterir. Bu makale, her birinin bağlantılarıyla birlikte kullanılabilir örnekleri kategorilere ayırır ve açıklar.
