...
FTP 'den **orc biçimindeki**verileri kopyalamak için aşağıdaki özellikler desteklenir:
...
**Orc BIÇIMINDE**FTP 'den veri kopyalamak için, etkinlik **kaynağını** kopyalama bölümünde aşağıdaki özellikler desteklenir:
