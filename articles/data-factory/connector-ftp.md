...
**Orc/JSON BIÇIMINDE**FTP 'den veri kopyalamak için aşağıdaki özellikler desteklenir:
...
**Orc/JSON BIÇIMINDE**FTP 'den veri kopyalamak için, etkinlik **kaynağını** kopyalama bölümünde aşağıdaki özellikler desteklenir:
