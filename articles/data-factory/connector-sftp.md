...
**Orc biçiminde**SFTP 'den veri kopyalamak için aşağıdaki özellikler desteklenir:
...
**Orc biçiminde**SFTP 'den veri kopyalamak için, etkinlik **kaynağını** kopyalama bölümünde aşağıdaki özellikler desteklenir:
