...
**Orc/JSON biçiminde**SFTP 'den veri kopyalamak için aşağıdaki özellikler desteklenir:
...
**Orc/JSON biçiminde**SFTP verilerini kopyalamak için, etkinlik **kaynağını** kopyalama bölümünde aşağıdaki özellikler desteklenir:
