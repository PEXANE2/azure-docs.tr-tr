...
Bu makalede, ve SFTP sunucusundan verilerin nasıl kopyalanacağı özetlenmektedir. Azure Data Factory hakkında bilgi edinmek için [giriş makalesi](introduction.md).
...
|:--- |:--- |:--- |
| type | Type özelliği: **SFTP**olarak ayarlanmalıdır. |Evet |
...
| Özellik | Açıklama | Gereklidir |
|:--- |:--- |:--- |
| userName adı | SFTP sunucusuna erişimi olan kullanıcı. |Evet |
| parola | Kullanıcı için parola (userName). Data Factory'de güvenle depolamak için bir SecureString olarak bu alanı işaretleyin veya [Azure Key Vault'ta depolanan bir gizli dizi başvuru](store-credentials-in-key-vault.md). | Evet |
...
| Özellik   | Açıklama                                                  | Gereklidir |
| ---------- | ------------------------------------------------------------ | -------- |
| type       | Veri kümesindeki `location` öğesinin altında bulunan tür özelliği **Sftplocation**olarak ayarlanmalıdır. | Evet      |
...
| Özellik                 | Açıklama                                                  | Gereklidir                                      |
| ------------------------ | ------------------------------------------------------------ | --------------------------------------------- |
| type                     | `storeSettings` altındaki Type özelliği **Sftpreadsettings**olarak ayarlanmalıdır. | Evet                                           |
...
| Özellik                 | Açıklama                                                  | Gereklidir |
| ------------------------ | ------------------------------------------------------------ | -------- |
| type                     | `storeSettings` altındaki Type özelliği **Sftpwritesettings**olarak ayarlanmalıdır. | Evet      |
