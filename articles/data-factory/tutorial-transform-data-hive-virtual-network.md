...
description: Azure sanal ağı 'ndaki (VNet) bir HDInsight kümesinde Hive etkinliğini kullanarak verileri dönüştüren bir Data Factory işlem hattı oluşturmak için Azure PowerShell kullanın.
