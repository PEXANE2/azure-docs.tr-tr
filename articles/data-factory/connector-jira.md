...
| Konağının | Jira hizmetinin IP adresi veya ana bilgisayar adı. (örneğin, jira.example.com)  | Evet |
...
| kullanıcı adı | Jira hizmetine erişmek için kullandığınız Kullanıcı adı.  | Evet |
