...
ms.locfileid: "84559712"
---
# <a name="incrementally-load-data-from-multiple-tables-in-sql-server-to-an-azure-sql-database-using-the-azure-portal"></a>SQL Server bir Azure SQL veritabanına Azure portal kullanarak birden çok tablodan verileri artımlı olarak yükleme
