...
Bu öğreticide, bir SQL Server veritabanındaki birden çok tablodan gelen Delta verileri Azure SQL veritabanı 'ndaki bir veritabanına yükleyen bir işlem hattı ile bir Azure Data Factory oluşturacaksınız.    
...
### <a name="create-destination-tables-in-your-database"></a>Veritabanınızda hedef tablolar oluşturma
...
### <a name="create-another-table-in-your-database-to-store-the-high-watermark-value"></a>Üst eşik değerini depolamak için veritabanınızda başka bir tablo oluşturun
...
### <a name="create-a-stored-procedure-in-your-database"></a>Veritabanınızda bir saklı yordam oluşturma
...
### <a name="create-data-types-and-additional-stored-procedures-in-your-database"></a>Veritabanınızda veri türleri ve ek saklı yordamlar oluşturun
...
1. Soldaki **İzleyici** sekmesine geçin. **El ile tetikleme** yoluyla tetiklenen işlem hattı çalıştırmasını görürsünüz. Etkinlik ayrıntılarını görüntülemek ve işlem hattını yeniden çalıştırmak için işlem **hattı adı** sütununun altındaki bağlantıları kullanabilirsiniz.
