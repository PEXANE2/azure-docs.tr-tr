...
> [!IMPORTANT]
> Azure Data Factory tümleştirme çalışma zamanını kullanarak verileri kopyalarsanız Azure hizmetlerinin sunucuya erişebilmesi için bir [azure SQL Server güvenlik duvarı](https://docs.microsoft.com/azure/sql-database/sql-database-firewall-configure) yapılandırın.
...
|:--- |:--- |:--- |
| type | **Type** özelliği **Azuressqldatabase**olarak ayarlanmalıdır. | Yes |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| type | DataSet 'in **Type** özelliği **Azuressqltable**olarak ayarlanmalıdır. | Yes |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| type | Kopyalama etkinliği kaynağının **Type** özelliği **Azuressqlsource**olarak ayarlanmalıdır. "SqlSource" türü, geriye dönük uyumluluk için hala desteklenmektedir. | Yes |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| type | Kopyalama etkinliği havuzunun **Type** özelliği **Azuressqlsink**olarak ayarlanmalıdır. "SqlSink" türü, geriye dönük uyumluluk için hala destekleniyor. | Yes |
...
**Seçenek 2:** [Kopyalama etkinliği içinde bir saklı yordamı çağırmayı](#invoke-a-stored-procedure-from-a-sql-sink)da seçebilirsiniz. Bu yaklaşım, kopyalama etkinliğinde varsayılan yaklaşım olarak toplu ekleme `writeBatchSize` kullanmak yerine kaynak tablodaki her bir toplu işi (özelliği tarafından yönetilir) çalıştırır.
