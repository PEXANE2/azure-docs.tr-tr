...
>[!NOTE]
>Bu Marketo Bağlayıcısı REST API Marketo 'nın üzerine kurulmuştur. Marketo 'nın hizmet tarafında [eşzamanlı istek sınırına](https://developers.marketo.com/rest-api/) sahip olduğunu unutmayın. "REST API kullanılmaya çalışılırken hata" hatası ":" 100 "en yüksek oran sınırı ' 20 ' saniye (606) ile aşıldı" veya "REST API kullanılmaya çalışılırken hata oluştu: eşzamanlı erişim sınırı ' 10 ' değerine ulaşıldı (615)", eşzamanlı kopyalama etkinliğinin çalışmasını azaltmak için göz önünde bulundurun hizmete yönelik istek sayısını azaltın.
...
|:--- |:--- |:--- |
| type | Type özelliği: **Marketo** olarak ayarlanmalıdır | Evet |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| type | Kopyalama etkinliği kaynağının Type özelliği şu şekilde ayarlanmalıdır: **menkul tosource** | Evet |
