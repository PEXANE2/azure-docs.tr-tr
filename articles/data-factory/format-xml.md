...
Aşağıdaki özellikler kopyalama etkinliği **_ \_ kaynağı \**** bölümünde desteklenir. [XML Bağlayıcısı davranışından](#xml-connector-behavior)daha fazla bilgi edinin.
