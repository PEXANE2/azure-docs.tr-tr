...
AzureDTExec'i çağırdığınızda, içinde SSIS Paketi etkinliğini yürüten benzersiz ardışık hatlar oluşturulduktan ve çalıştırıldıktan sonra, bunlar Veri Fabrikası portalında izlenebilir. Veri Fabrikası'nı kullanarak düzenlemek/zamanlamak istiyorsanız, veri fabrikası tetikleyicilerini bunlara atayabilirsiniz. Daha fazla bilgi için, [Veri Fabrikası faaliyetleri olarak SSIS paketlerini çalıştır'a](https://docs.microsoft.com/azure/data-factory/how-to-invoke-ssis-package-ssis-activity)bakın.
