...
AzureDTExec 'yi kullanmak için sürüm 18,3 veya üzeri olan SSMS 'nin en son sürümünü indirip yükleyin. [Bu Web sitesinden](/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017)indirin.
...
AzureDTExec çağırma, dtexec 'yi çağırarak benzer seçenekler sunar. Daha fazla bilgi için bkz. [dtexec yardımcı programı](/sql/integration-services/packages/dtexec-utility?view=sql-server-2017). Şu anda desteklenen seçenekler şunlardır:
