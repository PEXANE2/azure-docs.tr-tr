...
Şablonları kullanarak Azure Veri Fabrikası varlıklarını dağıtırken [Azure Key Vault'tan](../../key-vault/key-vault-overview.md) sırları çekmeniz gerekiyorsa, aşağıdaki örnekte gösterildiği gibi **anahtar kasasını** ve **gizli adı** belirtin:
