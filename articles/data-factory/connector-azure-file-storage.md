...
>[!TIP]
>Yazma için ADF Kullanıcı arabirimini kullanırken, "Azure dosya depolaması" girişinin, bağlantılı hizmet oluşturma için belirli bir girişini bulabilirsiniz ve bu, tür nesnesi oluşturur `FileServer` .
