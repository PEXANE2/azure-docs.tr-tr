...
- Data Factory SAP tablosu Bağlayıcısı 'nda kullanılmakta olan SAP kullanıcısının aşağıdaki izinlere sahip olması gerekir:
  ...
  - S_SDSAUTH yetkilendirme nesnesinin yürütme etkinliği veya S_RFC yürütme etkinliğinin izinleri: FUGR-RFC1, SYST, SYSU FUNC-RFCPING, RFC_FUNCTION_SEARCH ACTVT – 16 yetkilendirme nesnesi. 
