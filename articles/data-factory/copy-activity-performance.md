...
Bir kaynak veri deposundan bir havuz veri deposuna veri kopyaladığınızda, blob Storage 'ı geçici bir hazırlama deposu olarak kullanmayı tercih edebilirsiniz. [Daha fazla bilgi edinin](copy-activity-performance-features.md#staged-copy).
