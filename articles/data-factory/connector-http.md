...
**Orc BIÇIMINDEKI**http 'den veri kopyalamak için aşağıdaki özellikler desteklenir:
...
**Orc BIÇIMINDEKI**http 'den veri kopyalamak için, etkinlik **kaynağını** kopyalama bölümünde aşağıdaki özellikler desteklenir:
