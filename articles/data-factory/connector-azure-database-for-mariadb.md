...
|:--- |:--- |:--- |
| type | Type özelliği şu şekilde ayarlanmalıdır: **AzureMariaDB** | Evet |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| type | Veri kümesinin Type özelliği şu şekilde ayarlanmalıdır: **AzureMariaDBTable** | Evet |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| type | Kopyalama etkinliği kaynağının Type özelliği şu şekilde ayarlanmalıdır: **AzureMariaDBSource** | Evet |
