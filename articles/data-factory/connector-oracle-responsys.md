...
|:--- |:--- |:--- |
| tür | Type özelliği: **Responsys** olarak ayarlanmalıdır | Evet |
| endpoint | Respopnsys sunucusunun uç noktası  | Evet |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| tür | DataSet 'in Type özelliği: **ResponsysObject** olarak ayarlanmalıdır | Evet |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| tür | Kopyalama etkinliği kaynağının Type özelliği: **ResponsysSource** olarak ayarlanmalıdır | Evet |
