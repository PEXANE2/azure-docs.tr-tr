...
___
### <code>like</code>
<code><b>like(<i>&lt;string&gt;</i> : string, <i>&lt;pattern match&gt;</i> : string) => boolean</b></><br/><br/> stili, tam anlamıyla eşleşen bir dizedir. Özel durumlar aşağıdaki özel sembollerdir: _ ' ' ' ' ' ' ' ' ' ' ' ' içinde girişte herhangi bir karakterle eşleşen ' (similar to  . ' ' Regu l ar ifadeleri)%, girişte sıfır veya daha fazla karakterle eşleşir (' ' ' similar to . * Posix ' ' ' düzenleme noktası a r ifadelerinde).
...
Gets t h e ' ' ' SOUNDEX ' ' ' kodufor the string.  
* ``soundex('genius') -> 'G520'``  
___
### <code>split</code>
...
<code><b>varianceSampleIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => double</b></><br/><br/> bir ölçütlere göre, taraflı olmayan variayla 'yi alır.nce of a column.  
...
Dönüştürme işlevleri, verileri ve veri türlerini dönüştürmek için kullanılır
