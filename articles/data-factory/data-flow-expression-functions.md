...
Bir consinüs ters değeri hesaplar* ``acos(1) -> 0.0``
---
### <code>add</code>
...
Belirli bir uzunluğa ulaşana kadar dizeyi sağlanan doldurmaya göre aşağı doğru doldurma. Dize uzunluğuna eşit veya daha büyük ise, bu * ``lpad('great', 10, '-') -> '-----great'`` , bir-op 
* ``lpad('great', 4, '-') -> 'great'`` 
* ' ' Lpad (' harika ', 8, ' < > ')-> ' < ><great'``
---
...
Dizeyi, belirli bir uzunluğa ulaşana kadar sağlanan doldurmaya göre sağ Altlar. Dize uzunluğuna eşit veya daha büyük ise * ``rpad('great', 10, '-') -> 'great-----'``, bu, işlem 
* ``rpad('great', 4, '-') -> 'great'`` 
* ``rpad('great', 8, '<>') -> 'great<><'`` 
---
