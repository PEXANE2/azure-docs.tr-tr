...
| Özellik   | Açıklama                                                  | Gerekli |
| ---------- | ------------------------------------------------------------ | -------- |
| tür       |  `location` Bir veri kümesinde bulunan tür özelliği **AmazonS3Location** olarak ayarlanmalıdır. | Evet      |
...
| sürüm | S3 sürümü etkinse S3 nesnesinin sürümü. Bir sürüm belirtilmemişse, en son sürüm alınacaktır. |Hayır |
