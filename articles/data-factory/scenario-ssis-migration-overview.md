...
Ayrıca, geçiş hedefine toplu paket yeniden dağıtımı yapmak için [SSIS DevOps araçlarını](https://docs.microsoft.com/sql/integration-services/devops/ssis-devops-overview)kullanmanın pratik bir yoludur.  
...
- [SSIS iş yüklerini buluta yükselt ve Kaydır](https://docs.microsoft.com/sql/integration-services/lift-shift/ssis-azure-lift-shift-ssis-packages-overview)
- [SSIS DevOps Araçları](https://docs.microsoft.com/sql/integration-services/devops/ssis-devops-overview)
...
- [Yönetilen kimlik kimlik doğrulamasını kullanma](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-storage-connection-manager#managed-identities-for-azure-resources-authentication)
