---
title: Azure Data Factory kullanarak kareden veri kopyalama (Önizleme)
...
|:--- |:--- |:--- |
| type | Type özelliği: **Square** olarak ayarlanmalıdır | Evet |
| Konağının | Kare örneğinin URL 'SI. (örn. mystore.mysquare.com)  | Evet |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| type | Veri kümesinin Type özelliği: **Squareobject** olarak ayarlanmalıdır | Evet |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| type | Kopyalama etkinliği kaynağının Type özelliği: **SquareSource** olarak ayarlanmalıdır | Evet |
