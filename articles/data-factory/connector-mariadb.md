...
|:--- |:--- |:--- |
| tür | Type özelliği: **MariaDB** olarak ayarlanmalıdır | Yes |
...
| Özellik | Açıklama | Gerekli |
|:--- |:--- |:--- |
| tür | Kopyalama etkinliği kaynağının Type özelliği: **Mariadbsource** olarak ayarlanmalıdır | Yes |
