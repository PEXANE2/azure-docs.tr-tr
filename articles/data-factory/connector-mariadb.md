...
|:--- |:--- |:--- |
| type | Type özelliği ayarlanmalıdır: **MariaDB** | Yes |
...
| Özellik | Açıklama | Gereklidir |
|:--- |:--- |:--- |
| type | Kopyalama etkinliği kaynağı öğesinin type özelliği ayarlanmalıdır: **MariaDBSource** | Yes |
