...
`collectBlockchainWorkbenchTroubleshooting.ps1`Günlükleri toplamak ve sorun giderme bilgileri klasörünü içeren BIR ZIP dosyası oluşturmak için betiği çalıştırın. Örnek:
