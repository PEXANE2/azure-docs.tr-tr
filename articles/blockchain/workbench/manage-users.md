...
5.  Complete the required fields for the new user. **Oluştur**'u seçin.
...
10. **Ata**'yı seçin. The added users are displayed in the list with the administrator role assigned.
