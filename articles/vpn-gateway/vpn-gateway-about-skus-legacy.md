...
## <a name="supported-configurations-by-sku-and-vpn-type"></a><a name="config"></a>SKU ve VPN türüne göre desteklenen konfigürasyonlar
...
## <a name="change-to-the-new-gateway-skus"></a><a name="change"></a>Yeni ağ geçidi SKU 'Larına değiştirme
