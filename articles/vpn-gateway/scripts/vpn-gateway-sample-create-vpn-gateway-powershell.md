---
title: Azure PowerShell betiği örneği-VPN Gateway oluşturma
titleSuffix: Azure VPN Gateway
description: Bir PowerShell betiğini kullanarak bir sanal ağ, ağ alt ağı ve rota tabanlı VPN Gateway oluşturma hakkında bilgi edinin.
...
ms.locfileid: "100385889"
---
# <a name="create-a-vpn-gateway---powershell-script-sample"></a>VPN Gateway oluşturma-PowerShell betiği örneği

Bu PowerShell betiği, rota tabanlı bir VPN ağ geçidi oluşturur.
