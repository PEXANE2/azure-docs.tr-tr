...
description: Ortak Noktadan siteye bağlantı sorunlarını ve diğer sanal özel ağ hatalarını ve sorunlarını gidermeyi ve çözmeyi öğrenin.
...
RADIUS sunucusunun doğru yapılandırıldığından emin olun. Daha fazla bilgi için bkz. [RADIUS kimlik doğrulamasını Azure AD Multi-Factor Authentication sunucusu Ile tümleştirme](../active-directory/authentication/howto-mfaserver-dir-radius.md).
...
1. **Başlat**' a tıklayın, **Device Manager** yazın ve sonuç listesinden seçin. Yönetici parolası veya onay istenirse parolayı yazın ya da onay sağlayın.
