...
Aşağıdaki kaynakları aşağıdaki ekran görüntülerinde gösterildiği gibi oluşturun. Adımlar için bkz. [siteden sıteye VPN bağlantısı oluşturma](vpn-gateway-howto-site-to-site-resource-manager-portal.md).
