...
description: Azure Kullanılabilirlik Alanları ' de bölgesel olarak yedekli VPN ağ geçitlerini ve ExpressRoute ağ geçitlerini dağıtmayı öğrenin.
