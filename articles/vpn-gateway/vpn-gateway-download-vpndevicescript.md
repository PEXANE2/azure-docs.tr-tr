...
## <a name="about"></a>VPN cihaz yapılandırması betikleri hakkında
...
* [Azure portal siteden siteye bağlantı oluşturma](vpn-gateway-howto-site-to-site-resource-manager-portal.md)
