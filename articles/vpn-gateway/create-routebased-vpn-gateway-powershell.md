...
description: Şirket içi ağınıza yönelik bir VPN bağlantısı veya sanal ağlara bağlanmak için hızlı bir şekilde rota tabanlı Azure VPN Gateway oluşturmak için PowerShell 'i kullanın.
