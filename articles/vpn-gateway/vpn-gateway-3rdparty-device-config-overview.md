...
### <a name ="policybased"></a>Seçim Özel IPSec/ıKE ilkesini UsePolicyBasedTrafficSelectors ile kullanma
...
### <a name ="bgp"></a>Seçim S2S VPN bağlantısında BGP kullanma
