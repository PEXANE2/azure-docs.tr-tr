...
## <a name="about-ipsec-and-ike-policy-parameters-for-azure-vpn-gateways"></a><a name="about"></a>Azure VPN ağ geçitleri için IPSec ve ıKE ilke parametreleri hakkında
...
## <a name="part-1---workflow-to-create-and-set-ipsecike-policy"></a><a name ="workflow"></a>Bölüm 1-IPSec/ıKE ilkesi oluşturmak ve ayarlamak için Iş akışı
...
## <a name="part-2---supported-cryptographic-algorithms--key-strengths"></a><a name ="params"></a>2. Bölüm-desteklenen şifreleme algoritmaları & anahtar güçlerinin
...
## <a name="part-3---create-a-new-s2s-vpn-connection-with-ipsecike-policy"></a><a name ="crossprem"></a>3. kısım-IPSec/ıKE ilkesiyle yeni bir S2S VPN bağlantısı oluşturma
...
* Azure Resource Manager PowerShell cmdlet 'lerini yükler. PowerShell cmdlet 'lerini yükleme hakkında daha fazla bilgi için bkz. [Azure PowerShell genel bakış](/powershell/azure/) .
...
### <a name="step-2---create-a-s2s-vpn-connection-with-an-ipsecike-policy"></a><a name="s2sconnection"></a>2. adım-IPSec/ıKE ilkesiyle bir S2S VPN bağlantısı oluşturma
...
## <a name="part-4---create-a-new-vnet-to-vnet-connection-with-ipsecike-policy"></a><a name ="vnet2vnet"></a>Bölüm 4-IPSec/ıKE ilkesiyle yeni VNet-VNet bağlantısı oluşturma
...
### <a name="step-1---create-the-second-virtual-network-and-vpn-gateway"></a><a name="createvnet2"></a>1. adım-ikinci sanal ağı ve VPN ağ geçidini oluşturma
...
## <a name="part-5---update-ipsecike-policy-for-a-connection"></a><a name ="managepolicy"></a>5. kısım-bağlantı için IPSec/ıKE ilkesini güncelleştirme
