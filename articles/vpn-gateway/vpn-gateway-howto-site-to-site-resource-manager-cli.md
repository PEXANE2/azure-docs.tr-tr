...
## <a name="PublicIP"></a>6. genel IP adresi isteyin
...
## <a name="CreateGateway"></a>7. VPN Gateway oluşturma
...
## <a name="VPNDevice"></a>8. VPN cihazınızı yapılandırın
...
## <a name="CreateConnection"></a>9. VPN bağlantısını oluşturun
