---
title: 'Şirket içi ağları sanal ağa bağlayın: Siteden Siteye VPN: CLI'
...
* CLI komutlarınızı çalıştırmak için Azure Bulut Su Şurunu kullanabilirsiniz (aşağıdaki talimatlar). Ancak, komutlarınızı yerel olarak çalıştırmayı tercih ederseniz, CLI komutlarının (2.0 veya sonraki) en son sürümünü yüklediğinizi doğrulayın. CLI komutlarını yükleme hakkında bilgi için bkz. [Azure CLI’yi yükleme](/cli/azure/install-azure-cli) ve [Azure CLI’yi Kullanmaya Başlama](/cli/azure/get-started-with-azure-cli). 
...
CLI'yi yerel olarak çalıştırmayı seçerseniz aboneliğinize bağlanın. Tarayıcıda Azure Bulut Su Ünü kullanıyorsanız, aboneliğinize bağlanmanız gerekmez. Azure Bulut BulutU'da otomatik olarak bağlanırsınız. Ancak, bağlandıktan sonra doğru aboneliği kullandığınızı doğrulamak isteyebilirsiniz.
...
## <a name="4-create-the-gateway-subnet"></a>4. <a name="gwsub"> </a>Ağ geçidi alt ağı oluşturma
...
## <a name="5-create-the-local-network-gateway"></a><a name="localnet"></a>5. Yerel ağ ağ geçidini oluşturma
...
## <a name="6-request-a-public-ip-address"></a><a name="PublicIP"></a>6. Genel IP adresi isteme
...
## <a name="7-create-the-vpn-gateway"></a><a name="CreateGateway"></a>7. VPN ağ geçidini oluşturun

Sanal ağ VPN ağ geçidini oluşturun. VPN ağ geçidi oluşturma işleminin tamamlanması 45 dakika veya daha uzun sürebilir.

Aşağıdaki değerleri kullanın:

* Siteden Siteye bir yapılandırma için *--gateway-type* değeri *Vpn* olmalıdır. Ağ geçidi türü her zaman, uygulamakta olduğunuz yapılandırmaya özeldir. Daha fazla bilgi için [Ağ Geçidi türlerine](vpn-gateway-about-vpn-gateway-settings.md#gwtype)bakın.
...
## <a name="10-verify-the-vpn-connection"></a><a name="toverify"></a>10. VPN bağlantısını doğrulayın
...
* Zorunlu Tünelleme hakkında bilgi için [Zorunlu Tünelleme hakkında](vpn-gateway-forced-tunneling-rm.md)bilgi için bkz.
