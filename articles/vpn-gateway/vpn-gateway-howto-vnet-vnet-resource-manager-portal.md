...
* Ağ trafiğini bir sanal ağ içindeki kaynaklarla nasıl sınırlayabilmeniz hakkında bilgi için bkz. [ağ güvenliği](../virtual-network/network-security-groups-overview.md).
