...
[Azure ilkesi](../governance/policy/index.yml) , altyapınızın iş standartları ile uyumlu olması için Azure kaynaklarınız için ruya zorlayabilir.
