---
title: Azure RBAC ve Azure portal kullanarak rol atamaları ekleme veya kaldırma
...
[!INCLUDE [Azure RBAC definition grant access](../../includes/role-based-access-control-definition-grant.md)] Bu makalede Azure portal kullanılarak rollerin nasıl atanacağı açıklanır.
