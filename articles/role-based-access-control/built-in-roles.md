...
Tüm kaynakları yönetmek için tam erişim verir, ancak Azure RBAC 'de roller atamanıza, Azure 'da atamaları yönetmenize veya görüntü galerileri paylaşmanıza izin vermez. [Daha fazla bilgi](rbac-and-directory-admin-roles.md)
