...
Gizli dizileri hariç küme/ad alanındaki tüm kaynakları görüntülemenize izin verir. [Daha fazla bilgi](../aks/manage-azure-rbac.md)
...
Kaynak kotaları, ad alanları, Pod güvenlik ilkeleri, sertifika imzalama istekleri, (küme) rolleri ve (küme) rolü bağlamaları dışında, küme/ad alanındaki her şeyi güncelleştirmenizi sağlar. [Daha fazla bilgi](../aks/manage-azure-rbac.md)
...
Anahtar kasalarını yönetmenize izin verir, ancak bunlara erişim sağlamaz. [Daha fazla bilgi](../key-vault/general/secure-your-key-vault.md)
