...
, SQL Server ve veritabanlarının güvenlikle ilgili ilkelerini yönetmenizi sağlar, ancak bunlara erişemez. [Daha fazla bilgi](../azure-sql/database/azure-defender-for-sql.md)
...
SQL Server ve veritabanlarını yönetmenizi sağlar, ancak bunlara yönelik erişimleri ve güvenlikle ilgili ilkeleri yönetemez. [Daha fazla bilgi](../azure-sql/database/authentication-aad-configure.md)
...
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Keys/Wrap/Action | Bir simetrik anahtarı Key Vault anahtarla sarın. Key Vault anahtarı asimetrik ise, bu işlemin okuma erişimiyle gerçekleştirilebileceğini unutmayın. |
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Keys/Unwrap/Action | Bir simetrik anahtarı Key Vault anahtarla sarmalayın. |
> | **NotDataActions** |  |
> | *yok* |  |
...
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Keys/Backup/Action | Bir anahtarın yedekleme dosyasını oluşturun. Dosya, aynı aboneliğin Key Vault anahtarı geri yüklemek için kullanılabilir. Kısıtlamalar uygulanabilir. |
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Keys/Encrypt/Action | Bir anahtar ile düz metin şifreleyin. Anahtar asimetrik ise, bu işlemin okuma erişimi olan sorumlular tarafından gerçekleştirilebileceğini unutmayın. |
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Keys/Decrypt/Action | Şifreli olarak bir anahtarla şifresini çözün. |
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Keys/Wrap/Action | Bir simetrik anahtarı Key Vault anahtarla sarın. Key Vault anahtarı asimetrik ise, bu işlemin okuma erişimiyle gerçekleştirilebileceğini unutmayın. |
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Keys/Unwrap/Action | Bir simetrik anahtarı Key Vault anahtarla sarmalayın. |
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Keys/Sign/Action | Karma bir anahtarla imzalayın. |
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Keys/Verify/Action | Karmayı doğrulayın. Anahtar asimetrik ise, bu işlemin okuma erişimi olan sorumlular tarafından gerçekleştirilebileceğini unutmayın. |
> | **NotDataActions** |  |
> | *yok* |  |
...
> | *yok* |  |
> | **Veri eylemleri** |  |
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Secrets/getSecret/Action | Gizli dizi değerini alın. |
> | [Microsoft. Keykasası](resource-provider-operations.md#microsoftkeyvault)/Vaults/Secrets/ReadMetadata/Action | Gizli dizi özelliklerini listeleyin veya görüntüleyin, ancak değerini değil. |
> | **NotDataActions** |  |
> | *yok* |  |
...
Tüm izleme verilerini okuyabilir ve izleme ayarlarını düzenleyebilir. Ayrıca bkz. [Azure izleyici ile roller, izinler ve güvenlik ile çalışmaya başlama](../azure-monitor/platform/roles-permissions-security.md#built-in-monitoring-roles). [Daha fazla bilgi](../azure-monitor/platform/roles-permissions-security.md)
...
Tüm izleme verilerini okuyabilir (ölçümler, Günlükler vb.). Ayrıca bkz. [Azure izleyici ile roller, izinler ve güvenlik ile çalışmaya başlama](../azure-monitor/platform/roles-permissions-security.md#built-in-monitoring-roles). [Daha fazla bilgi](../azure-monitor/platform/roles-permissions-security.md)
