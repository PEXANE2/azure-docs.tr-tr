...
ms.openlocfilehash: d1b8b28fc3b37daa466b5d5e6825c6cfbc221409
ms.sourcegitcommit: 2aeb2c41fd22a02552ff871479124b567fa4463c
ms.translationtype: MT
ms.contentlocale: tr-TR
ms.lasthandoff: 04/22/2021
ms.locfileid: "107863326"
---
# <a name="azure-policy-built-in-definitions-for-azure-rbac"></a>Azure RBAC için Azure Ilkesi yerleşik tanımları

Bu sayfa, Azure RBAC için [Azure ilkesi](../governance/policy/overview.md) yerleşik ilke tanımlarının bir dizinidir. Diğer hizmetlere yönelik diğer Azure Ilkesi için yerleşik olarak [bulunan Azure ilkesi yerleşik tanımları](../governance/policy/samples/built-in-policies.md)bölümüne bakın.
