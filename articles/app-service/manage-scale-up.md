...
App Service uygulamalarını ölçeklendirmeyle ilgili videolar için aşağıdaki kaynaklara bakın:
 
* [Azure Web sitelerini ölçeklendirme zamanı-Stefan Schackow ile](https://azure.microsoft.com/resources/videos/azure-web-sites-free-vs-standard-scaling/)
* [Azure Web siteleri, CPU veya zamanlanmış-Stefan Schackow ile otomatik ölçeklendirme](https://azure.microsoft.com/resources/videos/auto-scaling-azure-web-sites/)
* [Azure Web siteleri, Stefan Schackow ile nasıl ölçeklendirilir?](https://azure.microsoft.com/resources/videos/how-azure-web-sites-scale/)
