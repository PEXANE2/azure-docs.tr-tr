...
Trafiğin [Azure App Service](overview.md)yükünü dengelemek için [Azure Traffic Manager](/azure/traffic-manager/) kullandığınızda App Service uygulamasına **\<Traffic-Manager-Endpoint >. trafficmanager. net**kullanılarak erişilebilir. Kullanıcılarınız için daha tanınabilir bir etki alanı adı sağlamak üzere App Service uygulamanız ile www\.contoso.com gibi özel bir etki alanı adı atayabilirsiniz.
...
> [!NOTE]
> CNAME 'nizin DNS sistemine yayılması biraz zaman alabilir. CNAME 'in kullanılabilir olduğunu doğrulamak için <a href="https://www.digwebinterface.com/">https://www.digwebinterface.com/</a> gibi bir hizmet kullanabilirsiniz.
> 
> 

1. Etki alanı çözümlemesi başarılı olduktan sonra [Azure portalında](https://portal.azure.com) uygulama sayfanıza geri dönün
2. Sol gezinti bölmesinde, **özel etki alanları** ' nı seçin > **ana bilgisayar adı ekleyin**.
