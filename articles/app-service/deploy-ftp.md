...
Gelişmiş güvenlik için FTP'ye yalnızca SSL üzerinden izin vermelisiniz. FTP dağıtımını kullanmazsanız hem FTP hem de FTPS'yi devre dışı kullanabilirsiniz.
