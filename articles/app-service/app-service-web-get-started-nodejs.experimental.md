...
Cloud Shell, `myAppServicePlan` [`az webapp create`](/cli/azure/webapp?view=azure-cli-latest#az-webapp-create) komutuyla App Service planında bir Web uygulaması oluşturun.
...
Düğüm çalışma zamanını 10.14.1 olarak ayarlayın. Desteklenen tüm çalışma zamanlarını görmek için öğesini [`az webapp list-runtimes`](/cli/azure/webapp?view=azure-cli-latest#az-webapp-list-runtimes)çalıştırın.
...
Yeni oluşturduğunuz web uygulamasına göz atın. Benzersiz `<app_name>` bir uygulama adıyla değiştirin.

```http
http://<app_name>.azurewebsites.net
```

Yeni Web uygulamanız şöyle görünmelidir: ![boş Web uygulaması sayfası](media/app-service-web-get-started-nodejs-poc/app-service-web-service-created.png)
