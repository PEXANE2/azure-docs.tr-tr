...
## <a name="how-do-i-upload-and-configure-an-existing-tlsssl-certificate-for-my-web-app"></a>Nasıl yaparım? Web uygulamam için mevcut bir TLS/SSL sertifikası karşıya yüklemek ve yapılandırmak mı istiyorsunuz?

Var olan özel bir TLS/SSL sertifikasını karşıya yükleme ve ayarlama hakkında bilgi edinmek için bkz. [App Service UYGULAMANıZA TLS/SSL sertifikası ekleme](configure-ssl-certificate.md).


## <a name="how-do-i-purchase-and-configure-a-new-tlsssl-certificate-in-azure-for-my-web-app"></a>Nasıl yaparım? Web uygulamam için Azure 'da yeni bir TLS/SSL sertifikası satın alıp yapılandırın.

App Service Web uygulamanız için bir TLS/SSL sertifikası satın almayı ve ayarlamayı öğrenmek için, bkz. [App Service UYGULAMANıZA TLS/SSL sertifikası ekleme](configure-ssl-certificate.md).
...
Azure uygulama Web sitenize yapılan gelen çağrılar için adanmış veya ayrılmış bir IP adresi ayarlamak için, IP tabanlı bir TLS/SSL sertifikası yükleyip yapılandırın.
