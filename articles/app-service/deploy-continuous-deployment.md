...
* [Azure Pipelines 'den Azure Uygulama Hizmetleri 'ne dağıtma](/azure/devops/pipelines/apps/cd/deploy-webdeploy-webapps?view=azure-devops&preserve-view=true)
