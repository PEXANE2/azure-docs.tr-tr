...
[Azure CLI](/cli/azure/install-azure-cli) veya [Azure PowerShell](/powershell/azure/)kullanarak **PremiumV2** katmanında uygulama oluşturmayı otomatik hale getirebilirsiniz.
