...
Artık joker karakter adıyla eşleşen herhangi bir alt etki alanı ekleyebilirsiniz (örneğin, `sub1.contoso.com` ve `sub2.contoso.com` her ikisi de eşleşir `*.contoso.com` ).
