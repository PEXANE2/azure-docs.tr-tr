---
title: "Quickstart: Linux'ta Python uygulaması oluşturun - Azure Uygulama Hizmeti"
...
Bu komut, tam çalışma birkaç dakika sürebilir. Çalıştırıldığında, aşağıdaki örneğe benzer bilgiler görüntüler:
