...
> [!NOTE]
> 3. sürüm. *x* varsayılan .NET Core Yapılandırma API 'lerini kullanır, bağlantı dizesi adlarını değiştirmek IÇIN bir API yoktur. Bkz. [Visual Studio kullanarak Web Işleri geliştirme ve dağıtma](webjobs-dotnet-deploy-vs.md)
...
Daha fazla ayrıntı için [Event Hubs bağlama](../azure-functions/functions-bindings-event-hubs.md#host-json) makalesine bakın.
...
`SamplingPercentageEstimatorSettings`Nesne [Uyarlamalı örnekleme](../azure-monitor/app/sampling.md)yapılandırır. Yani, bazı yüksek hacimli senaryolarda, Application Insights, Telemetri verilerinin seçili bir alt kümesini sunucusuna gönderir.
