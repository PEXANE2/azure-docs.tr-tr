...
Bu ek SDK işlevselliği için kod parçacıkları, [.net Için HDıNSIGHT SDK başvuru belgelerinde](/dotnet/api/overview/azure/hdinsight&preserve-view=true)bulunabilir.
