...
Oozie aynı dizindeki bir iş için gereken tüm kaynakları depolamanızı bekler. Bu örnekte, kullanılır `wasbs:///tutorials/useoozie` . Bu dizini oluşturmak için aşağıdaki adımları izleyin:
