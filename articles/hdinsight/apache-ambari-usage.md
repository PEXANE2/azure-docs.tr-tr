...
Hangi baş düğümüne 'un etkin olduğunu denetlemek için, tek yönlü kümedeki düğümlerden birine SSH, `ping headnodehost` çalıştırın ve IP 'yi iki baş düğümüne ile karşılaştırın.
