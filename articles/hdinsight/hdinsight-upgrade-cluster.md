...
:::image type="content" source="./media/hdinsight-upgrade-cluster/upgrade-workflow-diagram.png" alt-text="HDInsight yükseltme iş akışı diyagramı" border="false":::
