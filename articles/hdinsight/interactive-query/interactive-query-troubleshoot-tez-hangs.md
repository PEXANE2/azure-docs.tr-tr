...
Varsayılan olarak `yarn.scheduler.capacity.maximum-applications`, çalışmakta olan veya bekleyen en fazla uygulama sayısını denetler ve varsayılan olarak `10000`.
