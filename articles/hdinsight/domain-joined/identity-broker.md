...
KIMLIK Aracısı etkinleştirildikten sonra, etki alanı hesaplarıyla SSH senaryolarında Azure AD DS depolanan bir parola karması gerekecektir. Etki alanına katılmış bir VM 'ye SSH eklemek veya `kinit` komutunu çalıştırmak için bir parola sağlamanız gerekir. 
