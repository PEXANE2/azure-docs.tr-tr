...
1. Yük devretme denetleyicisi hizmetlerinin çalışıp çalışmadığını onaylayın:
    ...
    Yük devretme denetleyicisi Hizmetleri çalışmıyorsa, muhtemelen bir sorun nedeniyle HDInsight-Agent ' ın yük devretme denetleyicisi 'ni başlatmasını engelliyor olabilir. HDInsight-Agent günlük `/var/log/hdinsight-agent/hdinsight-agent.out` dosyasını denetleyin.
