---
title: HDInsight 'ta Apache Hive ile Java Kullanıcı tanımlı işlev (UDF)-Azure
...
2. Aşağıdaki komutu girerek dosyayı HDInsight kümesine kopyalamak için komutunukullanın:`scp`
