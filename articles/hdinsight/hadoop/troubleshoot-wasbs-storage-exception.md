...
Azure depolama veya Data Lake Storage 2. için güvenli aktarım etkinse, URI, sırasıyla veya `wasbs://` `abfss://`olur.  Ayrıca bkz. [Güvenli aktarım](../../storage/common/storage-require-secure-transfer.md).
