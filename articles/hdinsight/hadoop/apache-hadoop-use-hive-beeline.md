...
1. Bir Web tarayıcısından `https://CLUSTERNAME.azurehdinsight.net/#/main/services/HIVE/summary`' a gidin; burada `CLUSTERNAME` kümenizin adıdır. HiveServer2 'ın çalıştığından emin olun.
