...
Kümenizdeki farklı düğüm türlerine ait konak adlarını almak için lütfen [REST API ambarı](hdinsight-hadoop-manage-ambari-rest-api.md#get-the-fqdn-of-cluster-nodes)'nı kullanın.
