---
title: Apache Kafka Azure Cosmos DB Azure HDInsight 'a yapılandırılmış akış Apache Spark
...
2. **Özel dağıtım** bölümündeki girişleri doldurmak için aşağıdaki bilgileri kullanın:
    ...
    ![HDInsight özel dağıtımı](./media/apache-kafka-spark-structured-streaming-cosmosdb/parameters.png)
