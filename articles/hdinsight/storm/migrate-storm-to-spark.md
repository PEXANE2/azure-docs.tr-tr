...
> [!div class="mx-imgBorder"]
> ](./media/migrate-storm-to-spark/spark-streaming-to-output.png) çıkış ![Spark akış yolu
...
> [!div class="mx-imgBorder"]
> yapılandırılmış akış](./media/migrate-storm-to-spark/structured-streaming-data-processing.png) veri işlemeyi ![

> [!div class="mx-imgBorder"]
> yapılandırılmış akış](./media/migrate-storm-to-spark/structured-streaming-model.png) için ![programlama modeli
...
* Fırtınası tarafından işlenen veriler, Azure depolama veya Azure Data Lake Storage 2. gibi bir veri havuzuna yazılır.
    ...
    > [!div class="mx-imgBorder"]
    > geçerli ortamın kabul ![diyagramı](./media/migrate-storm-to-spark/presumed-current-environment.png)
...
1. **Eski kümeyi gerektiği gibi kaldırın.** Anahtar tamamlandıktan ve düzgün şekilde çalışmaya başladıktan sonra eski HDInsight 3,6 fırtınası kümesini gerektiği gibi kaldırın.
    ...
    > [!div class="mx-imgBorder"]
    > gerekli olan eski HDInsight kümelerini kaldırmak ![](./media/migrate-storm-to-spark/remove-old-clusters1.png)
