...
1. Satır 165 ' de değeri `Standard_A4_V2``Standard_A3` değiştirin. Daha sonra **Kaydet**’e tıklayın.
...
Sanal makinenin HBase kümesiyle iletişim kurabildiğini doğrulamak için, sanal makineden komutunu `ping headnode0.<dns suffix>` kullanın. Örneğin, `ping hn0-hbaseg.hjfrnszlumfuhfk4pi1guh410c.bx.internal.cloudapp.net`.
