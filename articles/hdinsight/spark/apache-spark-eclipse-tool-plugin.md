...
Yükleme yönergeleri için Eclipse [için Azure Araç Kiti'ni yükleme'ye](https://docs.microsoft.com/azure/java/eclipse/azure-toolkit-for-eclipse-installation)bakın.
