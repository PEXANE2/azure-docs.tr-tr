...
1. Bir Web tarayıcısından `https://CLUSTERNAME.azurehdinsight.net/jupyter`' a gidin; burada `CLUSTERNAME` kümenizin adıdır. İstendiğinde, küme için küme oturum açma kimlik bilgilerini girin.
