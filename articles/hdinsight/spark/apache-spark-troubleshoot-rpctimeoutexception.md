---
title: Azure HDInsight 'ta Apache Spark Thrift sunucusu için RpcTimeoutException
...
`OutOfMemoryError`Ayrıca ,`sparkthriftdriver.log` aşağıdaki örnekte olduğu gibi hatalardagörüntülenebilir:`overhead limit exceeded`
...
Tüm ağ bağlantıları için zaman aşımını denetler.`spark.network.timeout` Ağ zaman aşımını artırmak bazı kritik işlemlerin tamamlanabilmesi için daha fazla zaman alabilir, ancak bu durum sorunu tamamen çözmeyecektir.
