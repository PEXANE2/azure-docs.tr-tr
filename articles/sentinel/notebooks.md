...
2. Select individual notebooks to read their descriptions, required data types, and data sources. Örnek:
...
4. Open the project you just created, and then open the **Notebooks** folder to see the notebooks. Örnek:
