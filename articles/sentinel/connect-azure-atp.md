...
description: Azure Gelişmiş tehdit koruması (ATP) ile Azure Sentinel 'e tek bir tıklama ile günlüklerin nasıl akışının nasıl yapılacağını öğrenin.
services: sentinel
