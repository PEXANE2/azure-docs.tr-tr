...
> [!NOTE]
> -   Azure Sentinel CMK özelliği yalnızca **Yeni** olan ve bu özelliğe erişim sağlayan müşteriler için Azure Özellik kaydı tarafından denetlenmektedir. azuresentinelCMK@microsoft.comile iletişime geçerek erişim isteyebilirsiniz ve kapasite kullanılabilir olduğu için bekleyen istekler onaylanır.
...
1.  [Kurtarma seçeneklerini aç:](../key-vault/key-vault-best-practices.md#turn-on-recovery-options)

    -   [Geçici silmenin](../key-vault/key-vault-ovw-soft-delete.md) açık olduğundan emin olun.

    -   Geçici silme işleminden sonra bile gizli dizi/kasaların zorla silinmesine karşı koruma sağlamak için [Temizleme korumasını](../key-vault/key-vault-ovw-soft-delete.md#purge-protection) açın.
