---
title: Azure Stack Edge cihazınız için VM görüntüleri oluşturma
description: Azure Stack Edge cihazlarınız ile kullanmak üzere Linux veya Windows VM görüntülerinin nasıl oluşturulacağını açıklar.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
