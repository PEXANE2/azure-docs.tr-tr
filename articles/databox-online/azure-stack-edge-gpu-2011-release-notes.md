---
title: Azure Stack Edge Pro 2011 sürüm notları
description: Azure Stack Edge Pro çalıştıran 2011 sürümü için kritik açık sorunları ve çözümleri açıklar.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "96467226"
---
# <a name="azure-stack-edge-2011-release-notes"></a>Azure Stack Edge 2011 sürüm notları

Aşağıdaki sürüm notları, Azure Stack Edge cihazlarınız için kritik açık sorunları ve 2011 sürümü için çözülmüş sorunları belirler. Bu sürüm notları Azure Stack Edge Pro GPU, Azure Stack Edge Pro R ve Azure Stack Edge Mini R cihazları için geçerlidir. Belirli bir modele karşılık gelen özellikler ve sorunlar, uygulanabilir her yerde çağırılır.
...
Bu makale **Azure Stack Edge 2011** sürümü için geçerlidir<!--which maps to software version number **2.1.XXXX.XXXX**-->.

## <a name="whats-new"></a>Yenilikler

Azure Stack Edge 2011 sürümünde aşağıdaki yeni özellikler mevcuttur. 

- **Azure Stack Edge Pro r ve Azure Stack Edge Mini r cihazlarının genel kullanılabilirliği** -Bu yayın başlatıldığında Azure Stack Edge Pro R ve Azure Stack Edge Mini r cihazları kullanılabilir. Daha fazla bilgi için bkz. [Azure Stack Edge Pro R](azure-stack-edge-j-series-overview.md) nedir ve [Azure Stack Edge Mini r nedir?](azure-stack-edge-k-series-overview.md).  
...
## <a name="known-issues-in-2011-release"></a>2011 sürümündeki bilinen sorunlar

Aşağıdaki tabloda, 2011 sürümündeki bilinen sorunların bir özeti verilmiştir.
...
|**e.**|Kubernetes |Kubernetes, .NET uygulamaları tarafından kullanılan ortam değişkeni adlarında ":" öğesini desteklemez. Bu ayrıca Event Grid IoT Edge modülünün Azure Stack Edge cihazında ve diğer uygulamalarda çalışması için de gereklidir. Daha fazla bilgi için bkz. [ASP.NET Core documentation](/aspnet/core/fundamentals/configuration/?tabs=basicconfiguration&view=aspnetcore-3.1#environment-variables).|":" Öğesini çift alt çizgi ile değiştirin. Daha fazla bilgi için bkz. [Kubernetes sorunu](https://github.com/kubernetes/kubernetes/issues/53201)|
...
|**2.0.**|Kubernetes + güncelleştirme |2008 yayınları gibi eski yazılım sürümlerinin, bu güncelleştirme ClusterConnectionException ile başarısız olmasına neden olan bir yarış durumu güncelleştirme sorunu vardır. |Yeni derlemelerin kullanılması bu sorunu giderebilmelidir. Bu sorunu hala görüyorsanız, geçici çözüm yükseltmeyi yeniden denemeniz ve çalışması gerekir.|
