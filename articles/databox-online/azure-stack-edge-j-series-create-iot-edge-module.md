---
title: GPU ile Azure Stack Edge için C# IoT Edge modülü | Microsoft Docs
description: Azure Stack Edge GPU cihazınıza dağıtılabilecek bir C# IoT Edge modülünü geliştirmeyi öğrenin.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
![Azure IoT Edge modülünün Azure Stack Edge üzerinde nasıl çalıştığı](./media/azure-stack-edge-j-series-create-iot-edge-module/how-module-works-1.png)
...
- Çalıştıran bir Azure Stack Edge cihazı.
    ...
    Daha fazla bilgi için Azure Stack Edge için [Işlem yapılandırma](azure-stack-edge-j-series-deploy-configure-compute.md#configure-compute) bölümüne gidin.
...
Bu modülü Azure Stack Edge üzerinde dağıtmak ve çalıştırmak için, [modül ekleme](azure-stack-edge-j-series-deploy-configure-compute.md#add-a-module)içindeki adımlara bakın.
