...
- [Windows istemcilerinde TLS 1,2 'yi Yapılandırma Azure Stack Edge Pro GPU cihazına erişme](azure-stack-edge-j-series-configure-tls-settings.md)
...
- [Ayrıcalıklı erişim iş istasyonlarını anlama](/azure/active-directory/devices/concept-azure-managed-workstation) 
...
- [Azure Resource Manager parolasını ayarlama](azure-stack-edge-j-series-set-azure-resource-manager-password.md)
...
- [Windows ortamında PowerShell betiği yürütmeyi denetleme](https://docs.microsoft.com/powershell/module/microsoft.powershell.security/set-executionpolicy?view=powershell-7.1&amp;viewFallbackFrom=powershell-6&amp;preserve-view=true)
...
- [Azure Güvenlik Karşılaştırması: Ağ Güvenliği](/azure/security/benchmarks/)
