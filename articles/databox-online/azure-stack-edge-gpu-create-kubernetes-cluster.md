...
5. Yerel Web Kullanıcı arabiriminizdeki **cihaz** sayfasında Kubernetes API uç noktası vardır. Daha fazla bilgi için bkz. [Kubernetes API uç noktasını edinme](azure-stack-edge-gpu-deploy-configure-compute.md#get-kubernetes-api-endpoint) yönergeleri
