...
|Desteklenen protokoller     | Veri alımında standart SMB ve NFS protokolleri için destek. <br> Desteklenen sürümler hakkında daha fazla bilgi için bkz. [Azure Stack Edge sistem gereksinimleri](azure-stack-edge-system-requirements.md).|
...
* **Azure Stack Edge kaynağı** : bir Azure Stack Edge cihazını, farklı coğrafi konumlardan erişebileceğiniz bir web arabiriminden yönetmenizi sağlayan Azure Portal bir kaynaktır. Kaynak oluşturmak ve yönetmek, cihazları ve uyarıları görüntülemek ve yönetmek ve paylaşımları yönetmek için Azure Stack Edge kaynağını kullanın.  
    ...
    Daha fazla bilgi için [Azure Stack Edge cihazınız için sipariş oluşturma](azure-stack-edge-deploy-prep.md#create-a-new-resource)bölümüne gidin.
...
- [Azure Stack Edge sistem gereksinimlerini](azure-stack-edge-system-requirements.md)gözden geçirin.
