...
- Şu şekilde cihazın PowerShell arabirimi aracılığıyla kullanılabilen izleme komutları:
    ...
    - `dkrdbe stats`kapsayıcı kaynak kullanımı istatistiklerinin canlı akışını almak için. Komut CPU, bellek kullanımı, bellek sınırı ve ağ GÇ ölçümlerini destekler.
    - `dkrdbe system df`kullanılan disk alanı miktarı hakkında bilgi almak için. 
    - `dkrdbe image prune`kullanılmayan görüntüleri temizlemek ve boş alan boşaltmak için.
