...
- **Alan programlanabilir geçit dizisi (FPGA) günlüğe kaydetme geliştirmeleri** -bu SÜRÜMDE, FPGA ile ilgili günlüğe kaydetme ve uyarı geliştirmeleri yaptık. Bu, Edge işlem özelliğini FPGA ile kullanıyorsanız Data Box Edge için gerekli bir güncelleştirmedir. Daha fazla bilgi için bkz. [Data Box Edge Edge COMPUTE ile verileri dönüştürme](azure-stack-edge-deploy-configure-compute-advanced.md).
