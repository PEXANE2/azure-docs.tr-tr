...
1. [Yeni kaynak oluşturma](azure-stack-edge-gpu-deploy-prep.md?tabs=azure-portal#create-a-new-resource)bölümündeki adımları izleyerek mevcut cihaz için yeni bir sipariş oluşturun. **Sevkiyat Adresi** sekmesinde, **zaten bir cihazım varsa ' ı** seçin.
...
1. [Etkinleştirme anahtarını alın](azure-stack-edge-gpu-deploy-prep.md?tabs=azure-portal#get-the-activation-key).
...
1. [Cihazı etkinleştirin](azure-stack-edge-gpu-deploy-activate.md).
