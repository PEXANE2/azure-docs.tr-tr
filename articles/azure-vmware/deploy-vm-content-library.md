...
ms.locfileid: "86014238"
---
# <a name="create-a-content-library-to-deploy-vms-in-azure-vmware-solution-avs"></a>Azure VMware çözümünde (AVS) VM 'Leri dağıtmak için bir içerik kitaplığı oluşturma
