...
## <a name="number-of-results-template-up-to-version-2018-04-16"></a>Sonuç şablonu sayısı (sürüm 2018-04-16 ' e kadar)
Aşağıdaki örnek, bir [dizi sonuç uyarı kuralı](../platform/alerts-unified-log.md#count-of-the-results-table-rows)oluşturur.

### <a name="notes"></a>Notlar

- Bu örnek bir [Web kancası yükü](../platform/alerts-log-webhook.md)içerir. Uyarı kuralı bir Web kancası tetikleyememesi durumunda **Customwebkancapayload** öğesini kaldırın.
...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Ölçüm ölçümü şablonu (sürüm 2018-04-16 ' e kadar)
Aşağıdaki örnek, bir [ölçüm ölçümü uyarı kuralı](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value)oluşturur.
...
## <a name="template-for-all-resource-types-from-version-2020-05-01-preview"></a>Tüm kaynak türleri için şablon (sürüm 2020-05-01-Önizleme)
Aşağıdaki örnek, herhangi bir kaynağı hedefleyebilir bir kural oluşturur.
