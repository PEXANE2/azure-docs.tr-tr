...
* [Günlük sorguları hakkında daha fazla bilgi edinin](../log-query/log-query-overview.md).
* [İşlevler hakkında daha fazla bilgi edinin](../log-query/functions.md).