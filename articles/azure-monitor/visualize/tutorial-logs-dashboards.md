...
Bu öğreticideki örneği tamamlamak için [Log Analytics çalışma alanına bağlı](../vm/quick-collect-azurevm.md) mevcut bir sanal makinenizin olması gerekir.  
...
> [Log Analytics uyarılarla olaylara yanıt verme](../alerts/tutorial-response.md)