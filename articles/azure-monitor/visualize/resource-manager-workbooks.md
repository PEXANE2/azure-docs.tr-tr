...
Çalışma kitapları karmaşık olabilir, bu nedenle, çalışma kitabını Azure portal oluşturmak ve ardından bir Kaynak Yöneticisi şablonu oluşturmak için tipik bir stratejidir. [Çalışma kitaplarını dağıtmak için Azure Resource Manager şablonda](../visualize/workbooks-automate.md)bu yöntemin ayrıntılarına bakın.
...
* [Eylem grupları hakkında daha fazla bilgi edinin](../visualize/workbooks-overview.md).
