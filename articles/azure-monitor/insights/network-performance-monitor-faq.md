...
Linux tabanlı düğümleri kullanarak ağları izleme özelliği artık genel kullanıma sunulmuştur. Aracıyı [buradan](../../virtual-machines/extensions/oms-linux.md)öğrenebilirsiniz. Linux Agents yalnızca NPM 'nin performans Izleyicisi özelliği için izleme özelliği sağlar ve hizmet bağlantısı Izleyicisi ile ExpressRoute Izleyici özellikleri için kullanılamaz
...
[Burada](./network-performance-monitor-performance-monitor.md#choose-the-protocol)her bir protokolün göreli avantajları hakkında daha fazla bilgi edinebilirsiniz.
