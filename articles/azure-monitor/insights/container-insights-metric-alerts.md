...
* Özel ölçümler yalnızca Azure bölgelerinin bir alt kümesinde kullanılabilir. Desteklenen bölgelerin listesi [desteklenen bölgelerde](../platform/metrics-custom-overview.md#supported-regions)belgelenmiştir.
