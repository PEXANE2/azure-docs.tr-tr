...
Aşağıdaki örnek, mevcut bir çalışma alanına [Windows olayları](../agents/data-sources-windows-events.md) koleksiyonu ekler.
...
Aşağıdaki örnek, [Syslog olaylarının](../agents/data-sources-syslog.md) koleksiyonunu mevcut bir çalışma alanına ekler.
...
Aşağıdaki örnek, mevcut bir çalışma alanına [Windows performans sayaçları](../agents/data-sources-performance-counters.md) koleksiyonu ekler.
...
Aşağıdaki örnek, [Linux performans sayaçlarının](../agents/data-sources-performance-counters.md) koleksiyonunu var olan bir çalışma alanına ekler.
...
Aşağıdaki örnek, mevcut bir çalışma alanına [özel Günlükler](../agents/data-sources-custom-logs.md) koleksiyonu ekler.

### <a name="notes"></a>Notlar

- Sınırlayıcılar ve Dışlamalar yapılandırması karmaşık olabilir. Yardım için, Azure portal kullanarak özel bir günlük tanımlayabilir ve [Get-Azoperationalınsightsdatasource](/powershell/module/az.operationalinsights/get-azoperationalinsightsdatasource) ile kendi yapılandırmasını Al komutunu **CustomLog** **olarak ayarlayın.**
...
Aşağıdaki örnek, [IIS günlüklerinin](../agents/data-sources-iis-logs.md) koleksiyonunu mevcut bir çalışma alanına ekler.
