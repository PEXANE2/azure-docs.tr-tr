...
Bazı durumlarda, filtreleme yalnızca alana değil, sorgu işleme altyapısı tarafından, değerlendirilen sütun örtülü olarak oluşturulur:
```Kusto
//less efficient
SecurityEvent
