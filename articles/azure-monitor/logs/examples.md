...
Bu örnek, **olay** tablosunda **EventLog** 'ın _uygulama_ ve **rendereddescription** 'un _şifreleme_ içerdiği kayıtlar için arama yapar. Son 24 saat içindeki kayıtları içerir.
...
_Sıralama geri alma_ ile ilgili kayıtlar için **olayları** ve **securityevents** ' i arayın.
...
Bu örnek, _contoso_ ile başlayan bilgisayarların CPU kullanımını hesaplar ve grafiklerini yapar.
...
Bu örnek, **etkinlik** sütununda tüm terim _Izinlerini_ içeren **securityevent** kayıtlarının sayısını gösterir. Sorgu, son 30 dakika içinde oluşturulan kayıtlar için geçerlidir.
