...
> [!IMPORTANT]
> Configuration Manager sürüm 2010 ' den başlayarak bu özellik kullanım dışıdır.<!-- 8269855 --> Daha fazla bilgi için bkz. [Configuration Manager Için kaldırılan ve kullanım dışı Özellikler](/mem/configmgr/core/plan-design/changes/deprecated/removed-and-deprecated-cmfeatures).
...
Configuration Manager hizmet bağlantı noktası site sistemi rolünü barındıran bilgisayarda Windows Log Analytics Aracısı 'nı yüklemeye yönelik yöntemleri anlamak için [Windows bilgisayarları Azure 'da Azure izleyici 'ye bağlama](../agents/agent-windows.md) makalesini gözden geçirin.  
