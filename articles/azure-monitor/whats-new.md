...
- [JavaScript uygulamaları Için kaynak eşleme desteği-Azure izleyici Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/source-map-support) -yeni makale.
...
### <a name="metrics"></a>Ölçümler
- [Disk ölçümleri Azure Portal](https://docs.microsoft.com/azure/azure-monitor/platform/portal-disk-metrics-deprecation) -yeni makalede kullanımdan kaldırıldı.
...
- [VM'ler için Azure izleyici uyarılar](insights/vminsights-alerts.md) -Yeni Makale
...
- [Azure depolama 'da tanılama verilerini depolama ve görüntüleme](/azure/cloud-services/diagnostics-extension-to-storage) -tamamen yeniden yazıldı ve güncelleştirildi.
...
- Azure Izleyici belgelerine katkıda bulunmak istiyorsanız [docs katılımcısı Kılavuzu](https://docs.microsoft.com/contribute/)' na bakın.