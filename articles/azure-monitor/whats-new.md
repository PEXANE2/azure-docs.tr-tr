...
### <a name="application-insights"></a>Application Insights
- [Çalışan hizmeti uygulamaları için Application Insights (http olmayan uygulamalar)](app/worker-service.md) - C# koda varsayılan günlük kaydı düzeyi eklendi. Paket başvurusu sürümü güncelleştirildi.
