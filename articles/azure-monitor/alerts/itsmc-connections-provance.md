...
2. **Çalışma alanı VERI kaynakları** altında **ITSM bağlantıları**' na tıklayın.
    ![Yeni bağlantı](media/itsmc-overview/add-new-itsm-connection.png)
...
![Bağlantı adı ve Iş ortağı türü listelerini vurgulayan ekran görüntüsü.](media/itsmc-connections-provance/itsm-connections-provance-latest.png)
