...
Aşağıdaki örnek, bir [dizi sonuç uyarı kuralı](../alerts/alerts-unified-log.md#count-of-the-results-table-rows)oluşturur.

### <a name="notes"></a>Notlar

- Bu örnek bir [Web kancası yükü](../alerts/alerts-log-webhook.md)içerir. Uyarı kuralı bir Web kancası tetikleyememesi durumunda **Customwebkancapayload** öğesini kaldırın.
...
Aşağıdaki örnek, bir [ölçüm ölçümü uyarı kuralı](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value)oluşturur.
