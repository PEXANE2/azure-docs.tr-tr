...
1. **Eylem kuralı parametrelerini doğrulamadınız mı?**  
    ...
    [Eylem kuralı belgelerini](../alerts/alerts-action-rules.md)veya [PowerShell set-azactionrule komutunu eylem kuralını](/powershell/module/az.alertsmanagement/set-azactionrule?view=azps-3.5.0) denetleyin. 
