...
3. **Uygulama kimliği URI 'si** için **Ayarla** ' yı seçin.
   ...
   [![Uygulamanın U R I 'yi ayarlama seçeneğinin ekran görüntüsü.](media/itsm-connector-secure-webhook-connections-azure-configuration/azure-ad.png)](media/itsm-connector-secure-webhook-connections-azure-configuration/azure-ad-expand.png#lightbox)
4. **Kaydet**’i seçin.
...
Eylem grupları hakkında daha fazla bilgi edinmek için [Azure Portal eylem grupları oluşturma ve yönetme](../alerts/action-groups.md)konusuna bakın.
...
3. [Eylem grubu Ekle](../alerts/action-groups.md#create-an-action-group-by-using-the-azure-portal)' yi seçin ve alanları girin.
...
6. Şu ayrıntıları seçin:
   ...
   ![Güvenli Web kancası eylemini gösteren ekran görüntüsü.](media/itsm-connector-secure-webhook-connections-azure-configuration/secure-webhook.png)
