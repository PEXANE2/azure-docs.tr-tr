...
| Uyarılar | Azure Izleyici tarafından oluşturulan uyarılar. | [Azure portal](alerts-managing-alert-instances.md)<br>[Uyarı yönetimi REST API](https://docs.microsoft.com/rest/api/monitor/alertsmanagement/alerts) |
