...
2. Çoğu çalışma kitabı denetimi _zaman aralığı_ kapsam seçiciyi destekler. _Zaman aralığı_ açılan öğesini açın ve alt kısımdaki saat ettirmeye parametreleri grubunda öğesini seçin `{TimeRange}` .
