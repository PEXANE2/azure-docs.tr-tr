...
| Hedef | Açıklama | Başvuru |
|:---|:---|:---|
| Azure İzleyici Ölçümleri | Platform ölçümleri, Azure Izleyici ölçümleri veritabanına hiçbir yapılandırma olmadan yazar. Ölçüm Gezgini platform ölçümlerine erişin.  | [Azure Ölçüm Gezgini'ni kullanmaya başlama](metrics-getting-started.md)<br>[Azure Izleyici ile desteklenen ölçümler](metrics-supported.md) |
...
| Azure İzleyici Ölçümleri | Özel ölçümler API 'SI | Azure Izleyici ölçüm veritabanındaki herhangi bir REST istemcisinden ve mağazalardan ölçüm verileri toplayın. | [Bir Azure kaynağı için Azure Izleyici ölçüm deposuna bir REST API kullanarak özel ölçümler gönderme](metrics-store-custom-rest-api.md) |
