...
> [!NOTE]
> Ortak Yapılandırma Azure Izleyici havuzu tanımında iki özellik, *PrincipalId* ve *gizli*dizi vardır. Bunlar yalnızca klasik VM 'Ler ve klasik bulut hizmetleri için gereklidir. Bu özellikler diğer kaynaklar için kullanılmamalıdır.
