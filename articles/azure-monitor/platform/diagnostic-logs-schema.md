...
|---|---|---|
| zaman | Gerekli | Olayın zaman damgası (UTC). |
...
| konum | İsteğe bağlı | Olayı yayan kaynağın bölgesi, örn. "Doğu ABD" veya "Fransa Güney" |
| özellikler | İsteğe bağlı | Bu belirli olay kategorisiyle ilgili genişletilmiş özellikler. Tüm özel/benzersiz özellikler şemanın "Bölüm B" içinde yerleştirilmelidir. |
...
| Çözümleme Hizmetleri | https://azure.microsoft.com/blog/azure-analysis-services-integration-with-azure-diagnostic-logs/ |
...
| IOT hub'ı | [IoT Hub Işlemler](../../iot-hub/iot-hub-monitor-resource-health.md#use-azure-monitor) |
...
| Hizmet Veri Yolu |[Azure Service Bus günlükleri](../../service-bus-messaging/service-bus-diagnostic-logs.md) |
...
Bazı kategoriler yalnızca belirli kaynak türleri için desteklenir. Bu, bazı biçimde kullanılabilen tümünün listesidir.  Örneğin, Microsoft. SQL/Servers/veritabanları kategorileri tüm veritabanı türleri için kullanılamaz. Daha fazla bilgi için bkz. [SQL veritabanı tanılama günlüğü bilgileri](../../sql-database/sql-database-metrics-diag-logging.md). 
...
|Microsoft. Databricks/çalışma alanları|hesaplar|Databricks hesapları|
|Microsoft. Databricks/çalışma alanları|Çizelge|Databricks Işleri|
...
|Microsoft.Devices/ıothubs|Distributedizleme|Dağıtılmış Izleme (Önizleme)|
|Microsoft.Devices/ıothubs|Yapılandırmaları|Yapılandırmaları|
|Microsoft.Devices/ıothubs|DeviceStreams|Cihaz akışları (Önizleme)|
...
|Microsoft.EventHub/namespaces|KafkaCoordinatorLogs|Kafka Coordinator günlükleri|
|Microsoft.EventHub/namespaces|KafkaUserErrorLogs|Kafka Kullanıcı hatası günlükleri|
|Microsoft.EventHub/namespaces|EventHubVNetConnectionEvent|VNet/IP filtreleme bağlantı günlükleri|
|Microsoft.EventHub/namespaces|CustomerManagedKeyUserLogs|Müşteri tarafından yönetilen anahtar günlükleri|
...
|Microsoft. ıotspaces/Graph|Çalışma|Çalışma|
...
|Microsoft. Network/Publicıpaddresses|DDoSProtectionNotifications|DDoS koruması bildirimleri|
|Microsoft. Network/Publicıpaddresses|DDoSMitigationFlowLogs|DDoS azaltma kararlarının akış günlükleri|
|Microsoft. Network/Publicıpaddresses|DDoSMitigationReports|DDoS azaltmaları raporları|
...
|Microsoft. RecoveryServices/kasa|AzureSiteRecoveryEvents|Azure Site Recovery olaylar|
...
|Microsoft.Sql/servers/databases|Sqlinsıghts|SQL öngörüleri|
...
|Microsoft.Sql/servers/databases|Çık|Çık|
