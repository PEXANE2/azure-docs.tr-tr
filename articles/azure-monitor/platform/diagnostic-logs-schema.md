...
Kaynak türünün bir birleşimi ( `resourceId` özellikte mevcuttur) ve bir şemayı `category` benzersiz bir şekilde tanımlar. Bu makalede, kaynak günlükleri için en üst düzey şema ve her hizmet için şemaların serileştirilmesi bağlantıları açıklanmaktadır.
...
|Microsoft. AnalysisServices/sunucuları|Altyapı|Altyapı|
...
|Microsoft. Powerbiadanmış/kapasiteler|Altyapı|Altyapı|
