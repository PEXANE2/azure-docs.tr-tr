...
![AIMS Aıops logosu](./media/partners/aims.jpg)

AIMS Aıops (BT Işlemleri için yapay zeka), Azure performans ölçümlerinin analizini kolaylaştırır (altyapı ve hizmetler için), verimlilik, uygun şekilde ölçeklenebilen, denetim maliyetlerini ve iş öngörülerini sağlamak için eyleme dönüştürülebilir öngörüler sağlar.  AIMS, BT Ops ekiplerinin sıkıcı bir şekilde çalışmasını hafifetmek için makine öğrenimini kullanır.  AIMS, sorunsuz karma denetim için şirket içi teknolojileri de destekler.  AIMS, Azure Marketi 'nde ve tamamen işlevsel ücretsiz bir topluluk sürümü olarak kullanılabilir.

[Azure için AIMS Aıops belgeleri](https://www.aims.ai/platform/azure)
...
[AlertLogic belgeleri.](https://legacy.docs.alertlogic.com/userGuides/log-manager-collection-sources.htm)
...
[AppDynamics belgeleri](https://www.appdynamics.com/net/azure/) 
...
[Azure için botmetric tanıtımı](https://www.botmetric.com/blog/announcing-botmetric-cost-governance-beta-microsoft-azure/)
...
[Circonus belgeleri](https://docs.circonus.com/circonus/agents/cloud-agent/azure/)
...
[Bulut sistem durumu belgeleri](https://www.cloudhealthtech.com/products/azure-management)
...
[Cloudmonitorx tanıtımı](https://cloudmonix.com/features/azure-management/)
...
Önceki el ile yapılandırılmış tümleştirmeyi hala kullanıyorsanız, [Dataköpek Web sitesindeki belgelere](https://docs.datadoghq.com/integrations/azure/)bakın.
...
[Elastik belgeler](https://www.elastic.co/guide/en/logstash/master/azure-module.html)
...
[Arcgörüş belgelerini inceleyin](https://community.softwaregrp.com/t5/Discussions/Announcing-General-Availability-of-ArcSight-Smart-Connectors-7/m-p/1671852)
...
[Moogsoft belgeleri](https://www.moogsoft.com/partners/microsoft-azure)

## <a name="newrelic"></a>NewRelic

![Newrelik logosu](./media/partners/newrelic.png)

[Newrelik belgeleri](https://newrelic.com/azure)
...
[OpsGenie belgeleri](https://www.opsgenie.com/docs/integrations/azure-integration)
...
[Pagerharcı belgeleri](https://www.pagerduty.com/docs/guides/azure-integration-guide/)
...
[Promıtor belgeleri](https://promitor.io/)
...
[ScienceLogic belgeleri](https://www.sciencelogic.com/product/technologies/microsoft/azure)
...
[Serverless360 belgeleri](https://docs.serverless360.com/docs/)
...
[Hizmeti hemen hakkında daha fazla bilgi edinin](https://www.servicenow.com/solutions/aiops.html)
...
[Azure Izleyici için splunk belgeleri ekleme eklentisi](https://github.com/Microsoft/AzureMonitorAddonForSplunk/wiki/Azure-Monitor-Addon-For-Splunk)

## <a name="squaredup"></a>SquaredUp 

![SquaredUp logosu](./media/partners/squaredup.png)

Azure için SquaredUp, Azure uygulamalarınızı görselleştirmeyi cihazlarda çalıştırılmasını basit hale getirir. Size gerçek zamanlı, etkileşimli panolar sağlar. İşlemci, kaynak grupları, Etiketler ve tek tek kaynaklar hakkında daha fazla bilgi almak için, CPU, en çok gelen bağlantı, Application Insights yanıt süresi, toplam maliyet ve Özet sağlık durumu gibi ölçümleri görebilir, daha ayrıntılı ölçümler veya kullandığınız diğer araçlardan (ServiceNow gibi) ilgili verileri görmek için Log Analytics detaya gidebilirsiniz. Örneğin, dynaTrace, Pagerharcı veya Pingdom.  Kendi panolarınızı özelleştirebilir, yayımlayabilir ve bireyler veya intranet sayfalarında paylaşabilirsiniz. 

[SquaredUp Web sitesi](https://squaredup.com/)
...
[SumoLogic belgeleri](https://www.sumologic.com/azure) 
