...
![Mantıksal uygulama tasarımcısında bir adıma eklenen yeni bir eylemin ekran görüntüsü. Azure Izleyici günlükleri bir eylem Seç altında vurgulanır.](media/logs-export-logicapp/select-query-action-list.png)
...
[![Gövde Seç](media/logs-export-logicapp/select-body.png)](media/logs-export-logicapp/select-body.png#lightbox)
...
![JSON yükünü Ayrıştır](media/logs-export-logicapp/parse-json-payload.png)
...
[![Oluşturma eylemi için gövde seçin](media/logs-export-logicapp/select-body-compose.png)](media/logs-export-logicapp/select-body-compose.png#lightbox)
...
[![Blob ifadesi](media/logs-export-logicapp/blob-expression.png)](media/logs-export-logicapp/blob-expression.png#lightbox)
...
![Blob ifadesi oluştur](media/logs-export-logicapp/create-blob.png)
...
[![Çalışma geçmişi](media/logs-export-logicapp/runs-history.png)](media/logs-export-logicapp/runs-history.png#lightbox)
...
[![Blob verileri](media/logs-export-logicapp/blob-data.png)](media/logs-export-logicapp/blob-data.png#lightbox)
