...
| | Tanılama<br>Uzantı (WAD) | Log Analytics<br>Aracısı | Bağımlılık<br>Aracısı |
|:---|:---|:---|:---|
...
| | Tanılama<br>Uzantı (LAD) | Telegraf<br>Aracısı | Log Analytics<br>Aracısı | Bağımlılık<br>Aracısı |
|:---|:---|:---|:---|:---|
