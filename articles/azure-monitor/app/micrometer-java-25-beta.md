...
* Application Insights Web Auto 2.5.0-BETA veya üzeri
* Mikro ölçüm Azure kayıt defteri 1.1.0 veya üzeri
* [Application Insights kaynağı](../../azure-monitor/app/create-new-resource.md )
...
2. Dosyayı `ApplicationInsights.xml` Resources klasörüne koy
...
* Azure 'daki Spring hakkında daha fazla bilgi edinmek için [Azure 'da resmi yay belgelerini](https://docs.microsoft.com/java/azure/spring-framework/?view=azure-java-stable)inceleyin.
