---
title: Azure Application Insights Java izleme günlüklerini keşfet (2.5.0-BETA) | Microsoft Docs
description: Application Insights (2.5.0-BETA) içinde Log4J veya Logback izlemeleri ara
...
ms.locfileid: "68298366"
---
# <a name="explore-java-trace-logs-in-application-insights-250-beta"></a>Application Insights Java izleme günlüklerini keşfet (2.5.0-BETA)
...
## <a name="note-if-you-are-using-the-application-insights-java-agent"></a>Note: Application Insights Java Aracısı kullanıyorsanız
