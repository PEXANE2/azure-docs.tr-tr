...
- Şu anda hangi uzantının hangi sürümünü buldum?
    - `https://<yoursitename>.scm.azurewebsites.net/ApplicationInsights` kısmına gidin. Daha fazla bilgi için [Uzantı/Aracı tabanlı izleme için adım adım sorun giderme kılavuzu ' nu](https://docs.microsoft.com/azure/azure-monitor/app/azure-web-apps?tabs=net#troubleshooting) ziyaret edin.
