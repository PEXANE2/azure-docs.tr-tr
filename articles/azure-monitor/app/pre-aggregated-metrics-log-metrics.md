...
Ön toplama yı uygulamayan SDK'lar için (diğer bir şekilde Uygulama Öngörüleri SDK'larının eski sürümleri veya tarayıcı araçları için) Uygulama Öngörüleri arka ucu, Uygulama tarafından alınan olayları toplayarak yeni ölçümleri doldurmaya devam eder Öngörüler olay toplama bitiş noktası. Bu, kablo üzerinden iletilen veri hacminin azalmasından yararlanmasanız da, önceden toplanmış ölçümleri kullanmaya devam edebileceğiniz ve daha iyi performans ve sDK'larla yakın gerçek zamanlı boyutsal uyarı nın desteğini deneyimlediğiniz anlamına gelir. toplama sırasında önceden toplu ölçümler.
...
Gelecekte özel ölçümleri boyutlarla depolama, Uygulama Öngörüleri'nden ayrı olarak faturalandırılırken, boyutsal olmayan özel ölçümlerin depolanması serbest kalacak (kotaya kadar) özel ölçümlerin toplanması varsayılan olarak kapatılır . Yaklaşan fiyatlandırma modeli değişiklikleri hakkında resmi [fiyatlandırma sayfamızdan](https://azure.microsoft.com/pricing/details/monitor/)bilgi alabilirsiniz.
