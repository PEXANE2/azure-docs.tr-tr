...
> [!NOTE]
> SharePoint URL 'Si, farklı bir modül biçimi "...\ai.2.gbl.min.js" kullanır (ek **. GBL.**) Bu alternatif modül biçimi, betiklerin yüklenememesine neden olacak ve bu da SDK 'nın başlatılmasına ve telemetri olaylarının kaybolmasına neden olacak bir sorunu önlemek için gereklidir.
>
> Sorun, requireJS 'nin yüklenmesi ve SDK 'dan önce başlatılması nedeniyle oluşur.
