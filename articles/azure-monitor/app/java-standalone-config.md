...
> [!NOTE]
> Günlükçü için bir özel durum geçirilirse, günlük iletisi (ve özel durum) `exceptions` tablo yerine tablonun altındaki Azure Portal görünür `traces` .
