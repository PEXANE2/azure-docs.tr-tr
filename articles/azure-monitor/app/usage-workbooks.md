...
Her bölümde kendi gelişmiş ayarları bulunur. Bu, Ayarlar simgesi ![Application Insights çalışma kitapları bölümü, **parametreleri Ekle** düğmesinin sağında](./media/usage-workbooks/005-settings.png) bulunan denetimleri düzenleyen aracılığıyla erişilebilir.
...
Şu anda desteklenen dört farklı parametre türü vardır:
  ...
  |         |          |
   ...
   | **Açılan** | Kullanıcı bir değer kümesinden seçim yapmak için kullanılır. |
