---
title: Azure Application Insights Java Web uygulamaları için performans izleme (2.5.0-BETA) | Microsoft Docs
description: Application Insights (2.5.0-BETA) ile Java Web sitenizin genişletilmiş performansı ve kullanımı izleniyor.
...
2. Uygulama sunucusu başlangıç betiğini düzenleyin ve aşağıdaki JVM bağımsız değişkeni ekleyin:
