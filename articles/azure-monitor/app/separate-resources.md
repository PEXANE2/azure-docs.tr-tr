...
-   Anlamlı değerlerin [Cloud_RoleName](./app-map.md?tabs=net#set-or-override-cloud-role-name) özniteliğine ayarlandığından emin olmak için özel kod eklemeniz gerekebilir. Bu öznitelik için anlamlı değerler ayarlanmaksızın, Portal deneyimlerinden *hiçbiri* çalışmayacak.
