...
* Özel ölçümler yalnızca Azure bölgelerinin bir alt kümesinde kullanılabilir. Desteklenen bölgelerin listesi [burada](../essentials/metrics-custom-overview.md#supported-regions)belgelenmiştir.
