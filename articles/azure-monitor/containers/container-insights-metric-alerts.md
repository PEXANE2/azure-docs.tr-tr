...
* Özel ölçümler yalnızca Azure bölgelerinin bir alt kümesinde kullanılabilir. Desteklenen bölgelerin listesi [desteklenen bölgelerde](../essentials/metrics-custom-overview.md#supported-regions)belgelenmiştir.

* Ölçüm uyarılarını ve ek ölçümlerin giriş işlemlerini desteklemek için gereken en düşük aracı sürümü, Azure Arc etkinleştirilmiş Kubernetes kümesi için AKS ve **MCR.Microsoft.com/azuremonitor/containerinsights/ciprod:ciprod09252020** için **MCR.Microsoft.com/azuremonitor/containerinsights/ciprod:ciprod05262020** .
...
* Uyarı kurallarında varsayılan olarak bunlara atanmış bir eylem grubu yoktur. Uyarı kuralını düzenleyerek, var olan bir eylem grubunu seçerek veya yeni bir eylem grubu oluşturarak uyarıya bir [eylem grubu](../alerts/action-groups.md) ekleyebilirsiniz.
...
5. Uyarı kuralları, kullanıcılara bir uyarının tetiklendiğini bildirmek için bir [eylem grubuyla](../alerts/action-groups.md) ilişkili değildir. **Atanmış eylem grubu yok** ' u seçin ve **eylem grupları** sayfasında, **Ekle** veya **Oluştur**' u seçerek mevcut bir eylem grubu belirtin veya bir eylem grubu oluşturun.
