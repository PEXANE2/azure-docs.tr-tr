...
| Seçenek | Açıklama |
|:---|:---|
| Kapsam | Sorgu için kullanılan veri kapsamını belirtir. Bu, birden çok çalışma alanında belirli bir kaynak için Log Analytics çalışma alanındaki veya verilerdeki tüm veriler olabilir. Bkz. [sorgu kapsamı](scope.md). |
...
| Saat seçici | Sorgu için kullanılabilir olan veriler için zaman aralığını seçin. Sorguya bir zaman filtresi eklerseniz bu geçersiz kılınır. Bkz. [Azure izleyici Log Analytics günlük sorgusu kapsamı ve zaman aralığı](scope.md). |
