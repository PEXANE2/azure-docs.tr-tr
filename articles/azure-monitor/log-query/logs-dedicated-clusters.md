...
- **Keyvaultproperties** -Azure Key Vault anahtarı güncelleştirir. Bkz. [anahtar tanımlayıcı ayrıntıları ile küme güncelleştirme](../platform/customer-managed-keys.md#update-cluster-with-key-identifier-details). Şu parametreleri içerir: *Keyvaulturi*, *KeyName*, *keyversion*. 
