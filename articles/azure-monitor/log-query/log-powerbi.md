...
:::image type="content" source="media/log-powerbi-excel/export-query2.png" alt-text="Dışarı aktarma seçenek menüsü açılan Log Analytics sorgu" border="true":::
