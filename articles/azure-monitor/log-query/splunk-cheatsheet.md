...
Aşağıdaki tabloda, splunk ile Azure Izleyici günlükleri arasındaki kavramlar ve veri yapıları karşılaştırılmaktadır.
 ...
 | Veri kaydı | event | satır |  Yalnızca terminoloji değişikliği. |
...
| **Azure İzleyici** | **bilgi** | <code>find Session.Id=="c8894ffd-e684-43c9-9125-42adc25cd3fc" and ingestion_time()> ago(24h)</code> |
...
Farklı toplama işlevleri için [Azure izleyici günlük sorgularındaki toplamalara](/azure/data-explorer/kusto/query/samples?&pivots=azuremonitor#aggregations) bakın.
