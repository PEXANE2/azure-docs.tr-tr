...
- **İşlemi.**  Azure Izleyici 'den Excel 'e veya [Power BI](../platform/powerbi.md)günlük verilerini içeri aktardığınızda, dışarı aktarılacak verileri tanımlamak için bir günlük sorgusu oluşturun.
