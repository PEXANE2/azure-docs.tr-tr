...
[Azure Marketi](https://azuremarketplace.microsoft.com/marketplace/apps/datadog1591740804488.dd_liftr_v2?tab=Overview) 'nde bulunan "Azure Ile dataköpek tümleştirmesi" önizlemesine abone olun
...
[Azure Izleyici Grafana tümleştirmesi](visualize/grafana-plugin.md)
...
[Azure Izleyici etkileyen veri telegraf tümleştirmesi](essentials/collect-custom-metrics-linux-telegraf.md) 
...
[Site24X7 belgeleri](https://www.site24x7.com/azure/?utm_source=microsoft-partner-page&utm_medium=webpage&utm_campaign=ms-partner)
...
- [REST API kullanarak ölçümlere erişin](essentials/rest-api-walkthrough.md)
- [Etkinlik günlüğünü Microsoft dışı bir hizmete akış](essentials/activity-log.md#legacy-collection-methods)
- [Kaynak günlüklerini Microsoft dışı bir hizmete akış](essentials/resource-logs.md#send-to-azure-event-hubs)
