...
## <a name="prerequisites"></a>Önkoşullar
 ...
 - Etkin bir Iletişim Hizmetleri kaynağı ve bağlantı dizesi. [Iletişim Hizmetleri kaynağı oluşturun](https://docs.microsoft.com/azure/communication-services/quickstarts/create-communication-resource?tabs=windows&pivots=platform-azp).
...
Aşağıdaki örneklerde [DefaultAzureCredential](https://docs.microsoft.com/dotnet/api/azure.identity.defaultazurecredential)kullanılmaktadır. Bu kimlik bilgisi üretim ve geliştirme ortamları için uygundur.
...
- [.NET için Azure kimlik Kitaplığı hakkında daha fazla bilgi edinin](https://docs.microsoft.com/dotnet/api/overview/azure/identity-readme)
