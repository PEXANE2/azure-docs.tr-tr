...
| Microsoft. Communication. ChatParticipantAddedToThreadWithUser|  Bir sohbet iş parçacığına yeni katılımcı eklendiğinde kullanıcının parçası olduğu bir kullanıcı için yayımlandı.|
| Microsoft. Communication. ChatParticipantRemovedFromThreadWithUser |  Bir katılımcı bir sohbet iş parçacığından kaldırıldığında kullanıcının parçası olduğu bir kullanıcıya yayımlanır. |
| Microsoft. Communication. ChatThreadCreated  | Bir sohbet iş parçacığı oluşturulduğunda yayımlandı  |
| Microsoft. Communication. ChatThreadDeleted| Bir sohbet iş parçacığı silindiğinde yayımlandı  |
| Microsoft. Communication. ChatThreadParticipantAdded | Sohbet iş parçacığına yeni katılımcı eklendiğinde yayımlandı  |
| Microsoft. Communication. ChatThreadParticipantRemoved | Sohbet iş parçacığına yeni katılımcı eklendiğinde yayımlandı.  |  
| Microsoft. Communication. ChatMessageReceivedInThread | Sohbet iş parçacığında bir ileti alındığında yayımlandı  |    
| Microsoft. Communication. ChatThreadPropertiesUpdated| Bir sohbet iş parçacığının konu başlığı gibi özellikleri güncelleştirildikten sonra yayımlanır.|    
| Microsoft. Communication. ChatMessageEditedInThread | Sohbet iş parçacığında bir ileti düzenlendiğinde yayımlandı |  
| Microsoft. Communication. ChatMessageDeletedInThread | Sohbet iş parçacığında bir ileti silindiğinde yayımlandı  |  
...
### <a name="microsoftcommunicationchatparticipantaddedtothreadwithuser--event"></a>Microsoft. Communication. ChatParticipantAddedToThreadWithUser olayı 
```json
[{
...
### <a name="microsoftcommunicationchatparticipantremovedfromthreadwithuser-event"></a>Microsoft. Communication. ChatParticipantRemovedFromThreadWithUser olayı 
```json
[{
...
### <a name="microsoftcommunicationchatthreadcreated-event"></a>Microsoft. Communication. ChatThreadCreated olayı
...
```
### <a name="microsoftcommunicationchatthreadpropertiesupdated-event"></a>Microsoft. Communication. ChatThreadPropertiesUpdated olayı
...
```
### <a name="microsoftcommunicationchatthreaddeleted-event"></a>Microsoft. Communication. ChatThreadDeleted olayı
...
```
### <a name="microsoftcommunicationchatthreadparticipantadded-event"></a>Microsoft. Communication. ChatThreadParticipantAdded olayı
...
```
### <a name="microsoftcommunicationchatthreadparticipantremoved-event"></a>Microsoft. Communication. ChatThreadParticipantRemoved olayı
...
```
### <a name="microsoftcommunicationchatmessagereceivedinthread-event"></a>Microsoft. Communication. ChatMessageReceivedInThread olayı
...
```
### <a name="microsoftcommunicationchatmessageeditedinthread-event"></a>Microsoft. Communication. ChatMessageEditedInThread olayı
...
### <a name="microsoftcommunicationchatmessagedeletedinthread-event"></a>Microsoft. Communication. ChatMessageDeletedInThread olayı
