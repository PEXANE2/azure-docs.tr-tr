...
[Azure Iletişim hizmetlerinde olay işleme](https://docs.microsoft.com/azure/event-grid/event-schema-communication-services)hakkında daha fazla bilgi edinin.
