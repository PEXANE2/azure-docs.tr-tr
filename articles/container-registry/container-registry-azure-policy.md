...
1. **Uyumluluk**' i seçin.
1. Portalda ![](./media/container-registry-azure-policy/azure-policy-compliance.png)uyumluluk durumlarını sınırlamak veya ilkeler ilkesi uyumluluğunu aramak için filtreleri kullanın.
