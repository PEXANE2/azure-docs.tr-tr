---
title: Öğretici-bulut Azure Container Registry görevlerinde kapsayıcı görüntüleri oluşturma
...
Hizmet sorumlusunun **parolasını** kasada depolamak için [az ad SP Create-for-RBAC][az-ad-sp-create-for-rbac] command to create the service principal, and [az keyvault secret set][az-keyvault-secret-set] kullanın:
