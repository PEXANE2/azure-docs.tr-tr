...
* `--concurrency` -X temizleme görevlerinin eşzamanlı olarak işleneceğini belirtir. Bu parametre sağlanmazsa varsayılan bir değer kullanılacaktır.
