...
Kayıt defteri kaynak adı büyük harf veya karma durum olsa bile, örneğin `docker push myregistry.azurecr.io/myimage:latest`, `myRegistry`gibi tüm küçük harfli sunucu URL 'sini kullandığınızdan emin olun.
