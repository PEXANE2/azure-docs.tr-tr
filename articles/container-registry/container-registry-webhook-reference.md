...
|Öğe|Tür|Açıklama|
|-------------|----------|-----------|
|`id`|Dize|The ID of the webhook event.|
|`timestamp`|Tarih Saat|The time at which the webhook event was triggered.|
|`action`|Dize|The action that triggered the webhook event.|
...
|Öğe|Tür|Açıklama|
|------------------|----------|-----------|
|`mediaType`|Dize|The MIME type of the referenced object.|
|`size`|Int32|The number of bytes of the content. Same as Length field.|
|`digest`|Dize|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`length`|Int32|The number of bytes of the content. Same as Size field.|
|`repository`|Dize|The repository name.|
|`tag`|Dize|The image tag name.|

### <a name="request"></a>request

|Öğe|Tür|Açıklama|
|------------------|----------|-----------|
|`id`|Dize|The ID of the request that initiated the event.|
|`host`|Dize|The externally accessible hostname of the registry instance, as specified by the HTTP host header on incoming requests.|
|`method`|Dize|The request method that generated the event.|
|`useragent`|Dize|The user agent header of the request.|
...
|`digest`|Dize|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`repository`|Dize|The repository name.|
|`tag`|Dize|The chart tag name.|
|`name`|Dize|The chart name.|
|`version`|Dize|The chart version.|
