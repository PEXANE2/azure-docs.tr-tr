...
Kayıt defterinizin görüntülerini listelemek için portalda Kayıt defterinize gidin ve **depolar**' ı seçin, ardından ile oluşturduğunuz depoyu seçin `docker push` .
