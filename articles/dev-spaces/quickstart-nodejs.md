...
To deploy an updated version of your service, you can update any file in your project and rerun *Launch Server*. Örnek:
...
While the service is running, return to VS Code and update line 13 in `server.js`. Örnek:
```javascript
