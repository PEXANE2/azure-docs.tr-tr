...
To deploy an updated version of your service, you can update any file in your project and rerun *.NET Core Launch (AZDS)* . Örnek:
...
While the service is running in debugging mode, update line 22 in `Controllers/HomeController.cs`. Örnek:
