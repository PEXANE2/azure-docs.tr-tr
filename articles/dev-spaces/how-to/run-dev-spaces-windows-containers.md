...
Örnek uygulama, Windows hizmetini kümenizde çalıştırmak için [Held][helm-installed] kullanır. `charts` dizinine gidin ve Held 'yi kullanarak Windows hizmetini çalıştırın:
