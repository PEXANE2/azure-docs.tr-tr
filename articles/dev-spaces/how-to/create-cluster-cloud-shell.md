...
Kümenin oluşturulması birkaç dakika sürer.  When complete, the output is shown in the JSON format. Look for `provisioningState` and verify it's `Succeeded`.
