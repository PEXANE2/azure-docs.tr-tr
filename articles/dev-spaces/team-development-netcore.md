---
title: .NET Core ve Visual Studio Code kullanarak ekip geliştirme
services: azure-dev-spaces
ms.date: 07/09/2018
ms.topic: tutorial
description: Bu öğretici, Azure Kubernetes Hizmeti'ndeki bir .NET Core uygulamasında ekip geliştirme yapmak için Azure Dev Alanları ve Visual Studio Kodunu nasıl kullanacağınızı gösterir
...
---
# <a name="team-development-using-net-core-and-visual-studio-code-with-azure-dev-spaces"></a>Azure Geliştirme Alanları ile .NET Core ve Visual Studio Code kullanarak ekip geliştirme
...
VS `mywebapi` Kodu penceresine gidin ve yönteme `string Get(int id)` `Controllers/ValuesController.cs`kod edin, örneğin:
