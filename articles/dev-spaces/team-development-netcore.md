---
title: .NET Core ve VS Code kullanarak Azure Dev Spaces takım geliştirme
...
ms.locfileid: "74279532"
---
# <a name="team-development-with-azure-dev-spaces-using-net-core-and-vs-code"></a>.NET Core ve VS Code kullanarak Azure Dev Spaces takım geliştirme
...
`mywebapi` için VS Code penceresine gidin ve `Controllers/ValuesController.cs``string Get(int id)` yöntemine bir kod düzenleme yapın, örneğin:
