---
title: Java ve Visual Studio Code kullanarak takım geliştirme
...
* Her türlü tümleştirme testini yapmak zor olur. Tümleştirme testi yalnızca yürütme sonrası gerçekleşebilir, bu da geliştirme döngüsünün sonraki aşamalarında sorunlarla karşılaşacağınız anlamına gelir.
    ...
    ![Mikro hizmetler geliştirirken karşılaştığınız zorlukları gösteren diyagram.](media/common/microservices-challenges.png)
...
![Basit C ı C D alanı kurulumunu gösteren bir diyagram.](media/common/ci-cd-space-setup.png)
...
İçin VS Code penceresine gidin ve ' `mywebapi` de yöntemine bir kod düzenleme yapın `String index()` `src/main/java/com/ms/sample/mywebapi/Application.java` , örneğin:
