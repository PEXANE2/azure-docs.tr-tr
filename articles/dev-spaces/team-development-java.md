---
title: Java ve VS Code kullanarak Azure Dev Spaces takım geliştirme
...
ms.locfileid: "74279539"
---
# <a name="team-development-with-azure-dev-spaces-using-java-and-vs-code"></a>Java ve VS Code kullanarak Azure Dev Spaces takım geliştirme
...
`mywebapi` için VS Code penceresine gidin ve `src/main/java/com/ms/sample/mywebapi/Application.java``String index()` yöntemine bir kod düzenleme yapın, örneğin:
