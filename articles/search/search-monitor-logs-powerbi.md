...
1. Arama hizmetiniz için tanılama günlüğünü etkinleştirin:
...
[Power BI hizmeti tasarımcılar için temel kavramlar](https://docs.microsoft.com/power-bi/service-basic-concepts)