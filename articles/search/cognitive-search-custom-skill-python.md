...
İşlev uygulaması projesinin **Concatenator** klasöründe yenı bir http tetiklemeli işlev de oluşturulur. Bunun içinde, bu içerikle birlikte "\__init__. Kopyala" adlı bir dosya olacaktır:
