...
`geo.distance` **$OrderBy** ' deki sözdizimi **$Filter**' deki ile aynıdır. $Orderby kullanılırken `geo.distance` , geçerli olduğu alan türünde olmalıdır `Edm.GeographyPoint` ve ayrıca olmalıdır `sortable` .
