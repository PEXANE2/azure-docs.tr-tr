...
| [**SharePoint Online Dizin Oluşturucu**](search-howto-index-sharepoint-online.md) | Dizin Oluşturucu veri kaynağı | SharePoint içeriğinin Dizin Oluşturucu tabanlı dizin oluşturma için yeni veri kaynağı. | [Arama REST API 2020-06-30-Önizleme](/rest/api/searchservice/) |
