...
|||
|-|-|
| [Cosmos DB Dizin Oluşturucu](search-howto-index-cosmosdb.md) | MongoDB API (Önizleme), Gremlin API (Önizleme) ve Cassandra API (Önizleme) API türleri için destek. | 
...
| IP erişim kısıtlaması | Yönetim REST API [`api-version=2019-10-01-Preview`](https://docs.microsoft.com/rest/api/searchmanagement/index-2019-10-01-preview) kullanarak, erişim IZNI verilen IP adreslerine yönelik kısıtlamalara sahip bir hizmet oluşturabilirsiniz. |
