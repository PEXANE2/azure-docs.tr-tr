...
+ [REST API](/rest/api/searchservice/)
  ...
  + [Dizin Oluşturucu oluştur (api-Version = 2020-06-30)](/rest/api/searchservice/create-indexer)

## <a name="see-also"></a>Ayrıca bkz.

+ [Azure Bilişsel Arama REST API'si](/rest/api/searchservice/)
