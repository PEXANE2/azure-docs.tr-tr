...
Bu makalede, bir `search=` [arama belgeleri](https://docs.microsoft.com/rest/api/searchservice/search-documents) işleminin parametresini doldurarak basit sözdizimini göstermek için örnekleri kullanırız.
