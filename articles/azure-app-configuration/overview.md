...
description: Azure uygulama yapılandırma hizmeti 'ne genel bakış konusunu okuyun. Uygulama yapılandırmasını neden kullanmak istediğinizi anlayın ve bunu nasıl kullanabileceğinizi öğrenin.
author: lisaguthrie
ms.author: lcozzens
