...
2. *Function1.cs*'i açın ve .NET Core genel yapılandırma sağlayıcısına ve .NET Core uygulama yapılandırma sağlayıcısına bir başvuru ekleyin.
