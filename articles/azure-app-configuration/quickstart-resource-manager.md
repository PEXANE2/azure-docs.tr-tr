...
Bu hızlı başlangıçta kullanılan şablonlar [Azure hızlı başlangıç şablonlarından](https://azure.microsoft.com/resources/templates/)alınır. [İlk şablon](https://azure.microsoft.com/resources/templates/101-app-configuration-store/) bir uygulama yapılandırma deposu oluşturur:
