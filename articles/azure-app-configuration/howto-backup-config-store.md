...
Azure İşlev Uygulaması 'ın yönetilen kimliğine depolama kuyruğuna erişim izni vermek için aşağıdaki komutu veya [Azure Portal](/azure/storage/common/storage-auth-aad-rbac-portal#assign-azure-roles-using-the-azure-portal) kullanın. 
