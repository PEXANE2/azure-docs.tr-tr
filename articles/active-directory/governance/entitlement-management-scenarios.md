...
1. [Raporları ve günlükleri Arşivle](entitlement-management-logs-and-reporting.md)
...
Ayrıca, Microsoft Graph kullanarak erişim paketlerini, katalogları, ilkeleri, istekleri ve atamaları yönetebilirsiniz.  Temsilci izni olan bir uygulamayla uygun bir roldeki kullanıcı `EntitlementManagement.ReadWrite.All` , [YETKILENDIRME yönetimi API](/graph/tutorial-access-package-api)'sini çağırabilir.
