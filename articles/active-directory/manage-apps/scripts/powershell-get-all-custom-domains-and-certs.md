---
title: PowerShell örneği - Özel etki alanlarını kullanarak Uygulama Proxy uygulamaları
description: Özel etki alanlarını ve sertifika bilgilerini kullanan tüm Azure Active Directory (Azure AD) Uygulama Proxy uygulamalarını listeleyen PowerShell örneği.
...
---
# <a name="get-all-application-proxy-apps-using-custom-domains-and-certificate-information"></a>Özel etki alanlarını ve sertifika bilgilerini kullanarak tüm Uygulama Proxy uygulamalarını edinin

Bu PowerShell komut dosyası örneği, özel etki alanlarını kullanan tüm Azure Etkin Dizin (Azure AD) Uygulama Proxy uygulamalarını listeler ve özel etki alanlarıyla ilişkili sertifika bilgilerini listeler.
