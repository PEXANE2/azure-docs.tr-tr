...
ms.locfileid: "102548975"
---
# <a name="get-all-azure-ad-proxy-application-apps-that-are-published-with-the-identical-certificate"></a>Aynı sertifikayla yayınlanan tüm Azure AD proxy uygulama uygulamalarını alın
