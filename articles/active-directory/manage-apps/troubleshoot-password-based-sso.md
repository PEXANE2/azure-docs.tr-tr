---
title: Azure AD 'de parola tabanlı çoklu oturum açma sorunlarını giderme
description: Parola tabanlı çoklu oturum açma için yapılandırılmış bir Azure AD uygulamasıyla ilgili sorunları giderme.
author: kenwith
manager: celestedg
