...
| 3  | PerPersonal                            | displayName              | displayName                             | Yok                                                                                           |
| 4  | PerPersonal                            | firstName                | givenName                               | Yok                                                                                           |
| 5  | PerPersonal                            | lastName                 | sn                                      | Yok                                                                                           |
| 6  | Kullanıcı                                   | addressLine1             | streetAddress                           | Yok                                                                                           |
| 7  | Kullanıcı                                   | city                     | m                                       | Yok                                                                                           |
| 8  | Kullanıcı                                   | ülke                  | Ortak                                      | Yok                                                                                           |
| 9  | Kullanıcı                                   | durum                    | St                                      | Yok                                                                                           |
| 10 | Kullanıcı                                   | kullanıcı adı                 | samAccountName                          | Yok                                                                                           |
| 11 | Kullanıcı                                   | Posta kodu                  | posta kodu                              | Yok                                                                                           |
| 12 | PerEmail                               | emailAddress             | posta                                    | Yok                                                                                           |
| 13 | EmpJob                                 | İş Unvanı                 | title                                   | Yok                                                                                           |
| 14 | EmpJob                                 | Yönetici kimliği                | yönetici                                 | Yok                                                                                           |
| 15 | \.şirket\.CountryOfRegistration Iş | twoCharCountryCode       | c                                       | Yok                                                                                           |
| 16 | EmpJob\.departmanı                     | Bölüm               | Bölüm                              | Yok                                                                                           |
| 17 | EmpJob\.bölümü                       | bölme                 | Şirket                                 | Yok                                                                                           |
| 18 | EmpJob\.konumu                       | officeLocationAddress    | streetAddress                           | Yok                                                                                           |
| 19 | EmpJob\.konumu                       | officeLocationZipCode    | posta kodu                              | Yok                                                                                           |
