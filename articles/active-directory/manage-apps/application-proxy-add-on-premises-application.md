...
> [!IMPORTANT]
> Bağlayıcıyı Windows Server 2019 ' ye yüklüyorsanız, HTTP2 sınırlaması vardır. Bağlayıcıyı bu sürümde başarıyla kullanmak için aşağıdaki kayıt defteri anahtarını ekleyin ve sunucuyu yeniden başlatın:
    ```
