...
Bu hızlı başlangıç, Azure AD kiracınıza eklenmiş bir uygulamayı silmek için Azure portal kullanır.
...
- (İsteğe bağlı: [Çoklu oturum açma ayarlama](add-application-portal-setup-sso.md)işleminin tamamlanması).
...
1. Azure AD portalında **Kurumsal uygulamalar** ' ı seçin ve ardından silmek istediğiniz uygulamayı bulun ve seçin. Bu durumda, önceki hızlı başlangıçta eklediğimiz GitHub_test uygulamayı siliyoruz.
2. Gezinmede Yönet bölümünde **Özellikler**' i seçin.
3. Sil ' i seçin ve ardından Azure AD kiracınızdan uygulamayı silmek istediğinizi onaylamak için Evet ' i seçin.
