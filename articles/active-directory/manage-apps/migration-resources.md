...
Uygulama erişimini ve kimlik doğrulamasını Azure Active Directory (Azure AD) ile geçirmenize yardımcı olacak kaynaklar. Uygulamaları Azure AD 'ye geçirme deneyiminizle ilgili geri bildirimde bulunmak için bu kısa https://aka.ms/AppsMigrationFeedback) ankete katılın (geçiş için engelleyiciler, alet kullanımı/yönergeler veya şirket içi ıDP 'nizi sürdürme nedenleri dahil). 
