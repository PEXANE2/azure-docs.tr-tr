...
> [!NOTE]
> Bu makale, kuruluşunuzun uygulama portalı 'nın yapılandırmasını planlamak isteyen BT uzmanları için tasarlanmıştır. Uygulamalarımı ve koleksiyonlarımı kullanma hakkında son kullanıcı hakkında bilgi için bkz. My Apps [portalından oturum açma ve uygulama başlatma](../user-help/my-apps-portal-end-user-access.md).
>
