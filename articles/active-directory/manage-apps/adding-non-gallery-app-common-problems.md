---
title: Galeri dışı bir uygulama ekleme sorunu | Microsoft Docs
...
Bu makale, **Özel Galeri olmayan uygulamalar** eklerken ve bunları çözmek için yapabilecekleriniz konusunda yaygın sorunları anlamanıza yardımcı olur. 
...
Bazen geçici sorunlar, ağ sorunları veya bir hata nedeniyle uygulama ekleme başarısız olur. Azure portal, bu durum, uygulamanın sağ üst köşesindeki **Bildirimler** simgesine (zil) tıkladığınızda ve **uygulama bildirimi oluşturma** bildirimizin yanında kırmızı (!) bir simge görüyorsanız bunu söyleyebilir. Bu, uygulama oluşturulurken bir hata olduğunu gösterir.
...
Özel uygulamalar hakkında bilgi edinmek istiyorsanız, [Azure AD uygulamaları belge kitaplığı](https://docs.microsoft.com/azure/active-directory/active-directory-apps-index) , Azure AD ile çoklu oturum açma ve nasıl çalıştığı hakkında daha fazla bilgi edinmenize yardımcı olur.
...
1. Azure portal sağ üst köşesindeki **Bildirimler** simgesine (zil) tıklayın
...
- **Iç Işlem kimliği** : sistemlerimizde hata aramak için KULLANABILMEMIZ iç kimlik
