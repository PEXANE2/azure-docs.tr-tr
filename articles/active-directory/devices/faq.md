...
>[!NOTE] 
>Kayıtlı cihazlar için, kullanıcıların kaynaklara erişemese emin olmak için cihazı kaldırmanızı öneririz. Daha fazla bilgi için bkz. [cihaz kaydı nedir?](/mem/intune/user-help/use-managed-devices-to-get-work-done). 
...
- Federasyon oturum açma işlemleri, Federasyon sunucunuzun etkin ve erişilebilir WS-Trust uç noktaları desteklemesini gerektirir. 
