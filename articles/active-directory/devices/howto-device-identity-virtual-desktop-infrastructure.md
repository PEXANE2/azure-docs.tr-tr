...
[ADFS kullanılarak federe olan etki alanına katılmış Windows cihazları için karma Azure AD katılımı yapılandırma](manage-stale-devices.md)
