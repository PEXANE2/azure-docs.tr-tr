...
![Sign-in activity](./media/concept-sign-ins/reporting-azure-sign-in-screen.png "Oturum açma etkinliği")
...
![Sign-in activity](./media/concept-sign-ins/sign-in-activity.png "Oturum açma etkinliği")

Araç çubuğunda **Sütunlar**’a tıklayarak liste görünümünü özelleştirebilirsiniz.

![Sign-in activity](./media/concept-sign-ins/19.png "Oturum açma etkinliği")

Displays additional fields or remove fields that are already displayed.

![Sign-in activity](./media/concept-sign-ins/02.png "Oturum açma etkinliği")

Select an item in the list view to get more detailed information.

![Sign-in activity](./media/concept-sign-ins/basic-sign-in.png "Oturum açma etkinliği")
...
![Sign-in activity](./media/concept-sign-ins/04.png "Oturum açma etkinliği")
...
![Sign-in activity](./media/concept-sign-ins/12.png "Oturum açma etkinliği")
...
![Sign-in activity](./media/concept-sign-ins/06.png "Oturum açma etkinliği")
...
![Sign-in activity](./media/concept-sign-ins/08.png "Oturum açma etkinliği")
...
![Sign-in activity](./media/concept-sign-ins/10.png "Oturum açma etkinliği")

The app-usage graphs weekly aggregations of sign-ins for your top three applications in a given time period. Zaman dönemi için varsayılan süre 30 gündür.

![Sign-in activity](./media/concept-sign-ins/graph-chart.png "Oturum açma etkinliği")
