---
title: B2B işbirliğinde kullanıcı belirteçlerini anlama - Azure AD
description: Azure Active Directory B2B işbirliği için kullanıcı belirteç başvurusu
...
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>Azure AD B2B işbirliğinde kullanıcı belirteçlerini anlama

B2B işbirliği kullanıcısı için belirteç nasıl göründüğünü bilmek istiyorsanız, azure etkin dizin (Azure AD) konuğu ve kaynak kiracısındaki Bir Microsoft hesap konuğu (kiracı için) için taşıyıcı belirteç ayrıntıları ve belirteç içeriği aşağıda verilmiştir 04dcc6ab-388a-4559-b527-fbec656300ea). JSON Web Belirteci (JWT) içeriğini [https://jwt.io/](https://jwt.io/) [https://jwt.ms/](https://jwt.ms/)görmek için kullanın veya.
...
## <a name="microsoft-account-guest-token"></a>Microsoft hesap konuk belirteci
```
