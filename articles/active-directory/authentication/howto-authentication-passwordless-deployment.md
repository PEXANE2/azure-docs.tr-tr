...
Kuruluşunuz için en iyi yöntemi seçme hakkında daha fazla bilgi için bkz. [passwordless yöntemine karar verme](https://docs.microsoft.com/azure/security/fundamentals/ad-passwordless#deciding-a-passwordless-method).
...
| --- | --- | --- |
| [Azure Multi-Factor Authentication ve self servis parola sıfırlama (SSPR) Için Birleşik kayıt](howto-registration-mfa-sspr-combined.md) etkin (Önizleme özelliği) | √ | √ |
