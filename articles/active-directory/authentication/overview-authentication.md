...
Başlamak için, [self servis parola sıfırlama][quickstart-sspr] ve [Azure Multi-Factor Authentication öğreticisi][tutorial-mfa-applications]hızlı başlangıç başlığına bakın.
