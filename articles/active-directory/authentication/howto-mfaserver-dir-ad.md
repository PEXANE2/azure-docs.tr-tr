...
| Base DN |Tüm dizin sorgularının başlatıldığı temel dizin nesnesinin ayırt edici adını girin.  Örneğin, dc=abc,dc=com. |
...
Belirli bir dizinin özniteliklerini gerektiği şekilde özelleştirebilirsiniz.  Bu, özel öznitelikler eklemenizi ve eşitlemeyi yalnızca size gereken öznitelikleri kapsayacak şekilde ayarlamanızı sağlar. Use the name of the attribute as defined in the directory schema for the value of each attribute field. Aşağıdaki tabloda her özellikle ilgili ek bilgiler sağlanmıştır.
...
To edit attributes, click **Edit** on the Attributes tab.  This brings up a window where you can edit the attributes. Herhangi bir özniteliğin yanındaki **...** simgesini seçerek hangi özelliklerin görüntüleneceğini seçebileceğiniz pencereyi açın.
