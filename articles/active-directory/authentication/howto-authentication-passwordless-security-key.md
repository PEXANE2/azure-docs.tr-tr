...
1. **Azure Active Directory** > **Security**güvenlik > **kimlik doğrulama yöntemleri** > **kimlik doğrulama yöntemi ilkesi 'ne (Önizleme)** gidin.
...
1. Öğesine [https://myprofile.microsoft.com](https://myprofile.microsoft.com)gidin.
