...
3. **Ekle**'ye tıklayın.
4. Taban URL 'SI Ekle iletişim kutusunda, HTTP kimlik doğrulamasının gerçekleştirildiği Web sitesinin URL 'sini girin (<http://localhost/owa>gibi) ve bir uygulama adı sağlayın (isteğe bağlı). Uygulama adı Azure Multi-Factor Authentication raporlarında görünür ve SMS veya Mobil Uygulama kimlik doğrulama iletilerinde görüntülenebilir.
