...
Self servis parola sıfırlamayı devre dışı bırakmak için Azure portal **Azure Active Directory** arayın ve seçin. **Parola sıfırlama** > **Özellikler** ' i seçin ve ardından **self servis parola sıfırlama etkin**altında **yok** ' u seçin. Hazırlanıyor, **Kaydet**' i seçin.
