...
Azure Multi-Factor Authentication için NPS uzantısıyla ilgili hatalarla karşılaşırsanız, bir çözüme daha hızlı ulaşmak için bu makaleyi kullanın. NPS uzantısı günlükleri, **sunucu rolleri** > , NPS uzantısının yüklendiği sunucudaki **ağ Ilkesi ve erişim Hizmetleri** > **özel görünümler** altında Olay Görüntüleyicisi bulunur.
...
| **Geçersiz parametre** | \{0} \ olan CompanyName uzunluğu izin verilen en fazla uzunluktan daha uzun {1} |
