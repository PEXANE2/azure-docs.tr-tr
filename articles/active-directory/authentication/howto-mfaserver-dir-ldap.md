...
4. İstemciden Azure Multi-Factor Authentication Sunucusu LDAPS kullanmayı planlıyorsanız, MFA sunucusuyla aynı sunucuda bir SSL sertifikası yüklü olmalıdır. SSL sertifikası kutusunun yanındaki Git ' **e tıklayın ve** güvenli bağlantı için kullanılacak bir sertifika seçin.
5. **Ekle**'ye tıklayın.
