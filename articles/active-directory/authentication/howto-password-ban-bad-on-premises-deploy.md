...
### <a name="install-the-dc-agent-service"></a>Install the DC Agent service
   ...
   You can automate the software installation by using standard MSI procedures. Örnek:
