...
ms.locfileid: "74846292"
---
# <a name="tutorial-complete-an-azure-ad-self-service-password-reset-pilot-roll-out"></a>Öğretici: Azure AD self servis parola sıfırlama pilotunun dağıtımını tamamlama
