...
| [OATH belirteçleri](concept-authentication-methods.md#oath-hardware-tokens) | Kullanıcılar için OATH belirteçlerini yönetmek üzere bulut tabanlı Azure MFA ortamlarında kullanılır. |
