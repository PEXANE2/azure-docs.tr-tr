...
Belirteç ömrünü gözden geçirmek için Azure AD [PowerShell 'i kullanarak Azure AD ilkelerini sorgulayın](../develop/configure-token-lifetimes.md#get-started). Yerinde olan tüm ilkeleri devre dışı bırakın.
