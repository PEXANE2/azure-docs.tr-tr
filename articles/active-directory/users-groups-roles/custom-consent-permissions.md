...
> [!NOTE]
> Azure AD Yönetici portalı, bu makalede listelenen izinlerin özel bir dizin rolü tanımına eklenmesini henüz desteklememektedir. Bu makalede listelenen izinlerle [özel bir dizin rolü oluşturmak Için Azure AD PowerShell kullanmanız](roles-create-custom.md#create-a-role-using-powershell) gerekir.
...
- [Azure portal, Azure AD PowerShell ve Graph API kullanarak özel roller oluşturun](roles-create-custom.md)
