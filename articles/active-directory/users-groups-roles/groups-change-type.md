...
description: Mevcut grupları, Azure AD Yönetim Merkezi veya PowerShell cmdlet 'lerini kullanarak statik veya dinamik üyeliğe nasıl dönüştüreceğiniz hakkında bilgi edinin.
