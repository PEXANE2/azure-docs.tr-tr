...
Daha fazla ayrıntı için bkz. [özel rol oluşturma ve atama](roles-create-custom.md) ve [PowerShell kullanarak kaynak kapsamıyla özel roller atama](roles-assign-powershell.md).
...
Microsoft Graph API 'sinde, belirtilen örneği kullanarak özel bir rol oluşturun. Daha fazla ayrıntı için bkz. [özel rol oluşturma ve atama](roles-create-custom.md) ve [Microsoft Graph API kullanarak özel yönetici rolleri atama](roles-assign-graph.md).
...
Rol ataması bir güvenlik sorumlusu KIMLIĞINI (bir kullanıcı veya hizmet sorumlusu olabilir), bir rol tanımı KIMLIĞI ve bir Azure AD kaynak kapsamını birleştirir. Rol atamasının öğeleri hakkında daha fazla bilgi için bkz. [özel rollere genel bakış](roles-custom-overview.md)
