...
![Çok faktörlü kimlik doğrulaması](./media/app-sign-in-risk/118.png)
...
- İlkenizi silmek için ilkenizi seçin ve sonra hızlı erişim araç çubuğunda **Sil** ' e tıklayın.
   ...
   ![Çok faktörlü kimlik doğrulaması](./media/app-sign-in-risk/33.png)
