...
> [!IMPORTANT]
> Temel ilkeler kullanımdan kaldırıldı. Daha fazla bilgi için bkz. [Azure Active Directory yenilikler Için arşiv](../fundamentals/whats-new-archive.md#replacement-of-baseline-policies-with-security-defaults) .
