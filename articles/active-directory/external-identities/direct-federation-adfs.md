...
5. **Tamam** düğmesine tıklayın. AD FS sunucusu artık SAML 2,0 protokolü kullanılarak doğrudan Federasyon için yapılandırılmıştır.
...
1.  **Son**’u seçin. 
1.  **Talep kurallarını Düzenle** penceresinde yeni kural görüntülenir. **Uygula**’ya tıklayın.  
1.  **Tamam** düğmesine tıklayın. AD FS sunucusu artık WS-Beskullanan doğrudan Federasyon için yapılandırılmıştır.
