...
| Güvenlik ilkesi ve uyumluluğu: konak/kuruluş tarafından yönetilir (örneğin, [koşullu erişim ilkeleriyle](./conditional-access.md)).           | Güvenlik ilkesi ve uyumluluğu: konak/kuruluş tarafından yönetilir (örneğin, [koşullu erişim ilkeleriyle](./conditional-access.md)). | Güvenlik ilkesi ve uyumluluk: Uygulama tarafından yönetilir.        |
...
| Daha fazla bilgi: [çok kiracılı uygulamalardaki kimlik yönetimi](/azure/architecture/multitenant-identity/), [nasıl yapılır Kılavuzu](../develop/howto-convert-app-to-be-multi-tenant.md) | Daha fazla bilgi: [Blog gönderisi](https://blogs.technet.microsoft.com/enterprisemobility/2017/02/01/azure-ad-b2b-new-updates-make-cross-business-collab-easy/), [Belgeler](what-is-b2b.md)                   | Daha fazla bilgi: [Ürün sayfası](https://azure.microsoft.com/services/active-directory-b2c/), [Belgeler](../../active-directory-b2c/index.yml)       |
