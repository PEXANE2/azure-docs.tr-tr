...
Onay sisteminiz, kaydolma akışını denetlemek için iki API uç noktasından [API yanıt türlerini](self-service-sign-up-add-api-connector.md#expected-response-types-from-the-web-api) kullanabilir.
