...
1. Web uygulaması, Azure AD tarafından verilen Yetkilendirme kodunu kullanarak, Azure AD 'nin belirteç uç noktasına, yetkilendirme kodunu, istemci uygulaması (uygulama KIMLIĞI ve yeniden yönlendirme URI 'SI) ve istenen kaynak (Web API 'si için uygulama KIMLIĞI URI 'SI) ayrıntılarını içeren bir istek gönderir.
