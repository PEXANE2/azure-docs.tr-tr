...
### <a name="unmanaged-azure-active-directory-accounts-in-b2b-update-for-march-2021"></a>Mart 2021 için B2B güncelleştirmesinde yönetilmeyen Azure Etkin Dizin hesapları

**Türü:** Değişiklik planı  
**Hizmet kategorisi:** B2b  
**Ürün kapasitesi:** B2B/B2C
 
**31 Mart 2021'den itibaren Microsoft,** B2B işbirliği senaryoları için yönetilmeyen Azure Active Directory (Azure AD) hesapları ve kiracılar oluşturarak artık davetlerin itfasını desteklemez. Bunun için hazırlık olarak, bir [kerelik parola kimlik doğrulaması e-posta](https://docs.microsoft.com/azure/active-directory/b2b/one-time-passcode)tercih öneririz.
...
Yakın gelecekte, Azure AD hesaplarına sahip kullanıcılar, Uygulama Kayıt Portalı 'nı (apps.dev.microsoft.com) kullanarak yakınsanan uygulamaları kaydedebilecek ve yönetemeyecek veya Azure portalındaki Uygulama kayıtları (eski) deneyimindeki uygulamaları kaydedebilecek ve yönetemeyecek.
