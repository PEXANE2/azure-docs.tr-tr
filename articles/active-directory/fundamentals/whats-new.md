...
- [Amazon Web Services (AWS)](https://docs.microsoft.com/azure/active-directory/saas-apps/amazon-web-service-tutorial#configure-azure-ad-single-sign-on) öğesinden alınan roller
...
Daha fazla bilgi için bkz. [riskli kullanıcılar](https://aka.ms/RiskyUsersDocs), [riskli oturum açma](https://aka.ms/RiskySigninsDocs)işlemleri ve [risk algılamaları](https://aka.ms/RiskDetectionsDocs).
...
- Azuread `-Filter` modülündeki `Get-AzureADDirectoryRole` parametreye yeni bir parametre eklendi. Bu parametre, cmdlet tarafından döndürülen dizin rollerini filtrelemenize yardımcı olur.
...
### <a name="improvements-to-the-ui-of-the-dynamic-group-rule-builder-in-the-azure-portal"></a>Azure portalında dinamik grup kuralı oluşturucusunun Kullanıcı arabirimindeki iyileştirmeler
...
>[!Important]
>25 Eylül 2019 tarihinden önce bu adımları tamamlamazsanız, Azure Active Directory kiracınız gelişmiş deneyim için otomatik olarak etkinleştirilir. Sorularınız varsa lütfen adresinden registrationpreview@microsoft.combizimle iletişime geçin.
