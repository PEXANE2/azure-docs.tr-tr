...
> [!NOTE]
> Tek bir insan kimliğinde, eski etki alanı geçişi, birleşme veya alım gibi bir kaynaktan sağlanan birden çok hesap varsa, yalnızca Kullanıcı tarafından kullanılan hesabı bir günlük esasına göre eşitlemeniz gerekir, örneğin, bilgisayarında oturum açmak için kullandıkları Özellikler .
