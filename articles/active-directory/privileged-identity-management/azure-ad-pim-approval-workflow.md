...
1. Onaylamak istediğiniz isteği bulun ve seçin. Onaylama veya reddetme sayfası görüntülenir.
    ...
    !["İstekleri onaylama-Azure AD rolleri" sayfasını gösteren ekran görüntüsü.](./media/azure-ad-pim-approval-workflow/resources-approve-pane.png)
