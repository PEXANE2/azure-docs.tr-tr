...
>**Note:** Kimlik koruması yalnızca doğru kimlik bilgileri kullanıldığında risk algılamalarını oluşturur. Oturum açma sırasında yanlış kimlik bilgileri kullanılıyorsa, kimlik bilgilerinin güvenliğinin riskini temsil etmez.
