...
`Invoke-AzureADIPDismissRiskyUser.ps1`Depoya dahil edilen betik, kuruluşların kendi dizinindeki tüm riskli kullanıcıları kapatması için izin verir.
