...
> [!WARNING]
> Bulut sağlama yapılandırması bir hizmet sorumlusu oluşturur. Hizmet sorumlusu Azure portal görünür. Azure portal hizmet sorumlusu deneyimini kullanarak öznitelik eşlemelerini değiştirmemelisiniz.  Bu desteklenmez.
...
1.  Sorgu `https://graph.microsoft.com/beta/serviceprincipals/?$filter=startswith(Displayname,'Active')`çalıştırın. Bu sorgu, hizmet sorumlularının filtrelenmiş bir listesini döndürür.
