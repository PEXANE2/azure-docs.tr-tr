...
3. Azure AD Connect sağlama aracısını çalıştırın (AADConnectProvisioningAgent. Installer)
...
5.  **Yeni yapılandırma**
tıklayın ![](media/tutorial-single-forest/configure1.png)
...
![eşitleme](media/tutorial-single-forest/synchronize1.png)</br>

## <a name="test-signing-in-with-one-of-our-users"></a>Kullanıcılarımızdan biriyle oturum açma testi

1. [https://myapps.microsoft.com](https://myapps.microsoft.com) gidin
