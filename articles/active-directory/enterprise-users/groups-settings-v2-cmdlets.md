...
> - [Azure portalı](../fundamentals/active-directory-groups-create-azure-portal.md?context=azure/active-directory/users-groups-roles/context/ugr-context)
...
Artık modüldeki cmdlet 'leri kullanmaya başlayabilirsiniz. Azure AD modülündeki cmdlet 'lerin tam açıklaması için lütfen [Azure Active Directory PowerShell sürüm 2](/powershell/azure/active-directory/install-adv2)' ye yönelik çevrimiçi başvuru belgelerine bakın.
...
> [!NOTE]
> Azure AD PowerShell cmdlet 'leri OData sorgu standardını uygular. Daha fazla bilgi için bkz. OData [uç noktası kullanılarak OData sistem sorgu seçeneklerinde](/previous-versions/dynamicscrm-2015/developers-guide/gg309461(v=crm.7)#BKMK_filter) **$Filter** .
