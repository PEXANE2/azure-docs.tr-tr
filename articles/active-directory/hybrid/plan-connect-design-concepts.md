...
* Nesne Azure AD 'ye aktarıldıktan sonra Sourcetutturucu değeri değiştirilirse Azure AD Connect eşitleme bir hata oluşturur ve sorun düzeltilmez ve Sourcetutturucu kaynak dizinde geri değiştirilmediğinde bu nesnede daha fazla değişikliğe izin vermez.
