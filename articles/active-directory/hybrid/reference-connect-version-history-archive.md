...
- Azure AD Connect, bir güncelleştirme her yapıldığında AD FS Azure AD güveninin yedeklemesini oluşturur ve gerektiğinde kolayca geri yüklemek için ayrı bir dosyada depolar. [Azure AD Connect ' de yeni işlevsellik ve Azure AD güven yönetimi hakkında daha fazla bilgi edinin](./how-to-connect-azure-ad-trust.md).
...
Masaüstü SSO 'SU
* Yeni yükleme sırasında Sign-In seçeneğiniz olarak parola eşitleme 'yi seçtiyseniz, Sign-In ekranının Masaüstü SSO özelliğini etkinleştirmenize izin vermediğinde Azure AD Connect sihirbazında sorun düzeltildi.
...
Parola Sıfırlama
* Bağlantı bir güvenlik duvarı veya ara sunucu tarafından sonlandırdıysanız Azure Azure AD Connect sunucusunun yeniden bağlantı kurmayı denememesine neden olabilecek bir sorun düzeltildi.
...
* Azure AD Multi-Factor Authentication kullanarak genel yönetici desteği ve Yükleme sihirbazında Privileged Identity Management.
...
* Birden çok şirket içi Exchange kuruluşu destekler. Daha fazla bilgi için bkz. [birden çok Active Directory ormanlı karma dağıtımlar](/previous-versions/exchange-server/exchange-150/jj873754(v=exchg.150)).
...
* Ms-DS-Externaldirectoryobjectıd özniteliği Active Directory 'e geri yazılır. Bu özellik Microsoft 365 uygulamaları için destek ekler. Karma bir Exchange dağıtımında çevrimiçi ve şirket içi posta kutularına erişmek için OAuth2 kullanır.
