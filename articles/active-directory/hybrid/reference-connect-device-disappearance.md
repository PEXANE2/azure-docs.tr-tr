...
Azure AD Connect, en az bir geçerli sertifika içeren, ancak Azure AD Connect 1,4 ' den başlayarak, eşitleme altyapısı karma Azure AD JOIN sertifikalarını tanımlayabilir ve geçerli bir karma Azure AD JOIN sertifikası olmadıkça, bilgisayar nesnesinin Azure AD 'ye eşitlenmesini sağlar.
