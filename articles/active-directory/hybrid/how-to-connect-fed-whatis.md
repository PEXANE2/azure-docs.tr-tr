...
| [Önkoşullar](how-to-connect-install-custom.md#ad-fs-configuration-prerequisites) |Azure AD Connect aracılığıyla başarılı bir AD FS yüklemesi için önkoşulları inceleyin. |
