---
title: "Öğretici: PTA kullanarak tek bir AD ormanını Azure' a entegre etme"
description: Geçiş kimlik doğrulamasını kullanarak karma kimlik ortamının nasıl kurulabildiğini gösterir.
...
---
# <a name="tutorial--integrate-a-single-ad-forest-using-pass-through-authentication-pta"></a>Öğretici: Geçiş kimlik doğrulaması (PTA) kullanarak tek bir AD ormanLarını tümleştirme

![Oluştur](media/tutorial-passthrough-authentication/diagram.png)

Aşağıdaki öğretici, geçiş kimlik doğrulamasını kullanarak karma kimlik ortamı oluşturmada size yol verecektir.  Bu ortam daha sonra sınamak veya karma kimliğin nasıl çalıştığını daha iyi tanımak için kullanılabilir.
...
6. Kullanıcı Oturum Açma ekranında **Geçiş kimlik doğrulamasını** seçin ve **tek oturum açmayı etkinleştirin** ve **İleri'yi**tıklatın.</br>
![Pta](media/tutorial-passthrough-authentication/pta1.png)</b>
7. Azure AD'ye Bağlan ekranına, yukarıda oluşturduğumuz global yöneticinin kullanıcı adını ve parolasını girin ve **İleri'yi**tıklatın.
...
9. Tek işaret-n kimlik bilgilerini etkinleştir sayfasında, contoso\Administrator kullanıcı adı ve parolasını girin ve **İleri'yi tıklatın.**
10. Yapılandırma için hazır ekranında **Yükle**'ye tıklayın.
11. Yükleme tamamlandığında **Çıkış**'a tıklayın.
12. Yükleme tamamlandıktan sonra, Eşitleme Hizmet Yöneticisi veya Eşitleme Kuralı Düzenleyicisi'ni kullanmadan önce oturum açın ve yeniden oturum açın.
