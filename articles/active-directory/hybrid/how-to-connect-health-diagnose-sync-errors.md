...
---
# <a name="diagnose-and-remediate-duplicated-attribute-sync-errors"></a>Yinelenen öznitelik eşitleme hatalarını tanılayın ve düzeltin
...
**C.** Yürütme başarısız olursa, Azure AD Connect bir dışarı aktarma hatası çalıştırıyor olabilir. Portal sayfasını yenileyip bir sonraki eşitlemeden sonra yeniden deneyin. Varsayılan eşitleme çevrimi 30 dakikadır. 


**S.** **Mevcut nesnenin** silinecek nesne olması gerekiyorsa ne olur?  
**C.** **Mevcut nesnenin** silinmesi gerekiyorsa, Işlem **kaynak bağlayıcının**bir değişikliğini içermez. Genellikle, bunu şirket içi Active Directory çözebilirsiniz. 


**S.** Kullanıcının bu çözümü uygulamak için hangi izni vardır?  
**C.** **Genel yönetici**veya RBAC ayarlarından **katılımcı** , tanılama ve sorun giderme sürecine erişme iznine sahiptir.


**S.** Bu özellik için Azure AD Connect yapılandırıp Azure AD Connect Health aracıyı güncelleştirmem gerekir mi?  
**C.** Hayır, tanılama işlemi bulut tabanlı tam bir özelliktir.


**S.** Varolan nesne geçici olarak silinirse, tanılama işlemi nesneyi yeniden etkin hale getirir mi?  
**C.** Hayır, bu çözüm **kaynak bağlantısı**dışındaki nesne özniteliklerini güncelleştirmez.
