...
**Onarım işlemi değerleri güncelleştiremedi.**
[Azure AD Connect Içindeki Usergeri yazma](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-preview#user-writeback) gibi belirli ayarlar desteklenmez. Lütfen ayarlarda devre dışı bırakın. 
