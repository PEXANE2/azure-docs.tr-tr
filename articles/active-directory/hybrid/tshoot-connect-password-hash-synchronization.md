...
ms.locfileid: "78376266"
---
# <a name="troubleshoot-password-hash-synchronization-with-azure-ad-connect-sync"></a>Azure AD Connect eşitleme ile parola karması eşitleme sorunlarını giderme
...
Parolaların neden eşitlenmemiş olduğunu anlamak için `Invoke-ADSyncDiagnostics` cmdlet 'ini kullanabilirsiniz.
...
Bir nesnenin neden parolaları eşitleyeceğini anlamak için `Invoke-ADSyncDiagnostics` cmdlet 'ini kullanabilirsiniz.
