...
* Kaynak ve hedef sistemler arasındaki şema tutarlılığını onaylayın. Genel sorunlar UPN veya posta eşleştirme gibi öznitelikleri içerir. Örneğin, Azure AD kümesindeki UPN *john_smith@contoso.com* olarak ve uygulamada, *jsmith@contoso.com* . Daha fazla bilgi için bkz. [Kullanıcı ve grup şeması başvurusu](../app-provisioning/use-scim-to-provision-users-and-groups.md).
