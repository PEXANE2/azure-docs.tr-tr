...
description: Azure Active Directory Galeri uygulamasına kullanıcı sağlamayı yapılandırırken yönetici kimlik bilgilerini kaydetme sırasında ortaya çıkan sorunları nasıl giderebileceğinizi öğrenin.
