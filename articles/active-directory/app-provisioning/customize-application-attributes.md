...
- ServiceNow
- Workday
- Azure Active Directory ([Microsoft Graph REST API v 1.0 başvurusu](https://docs.microsoft.com/graph/api/overview?view=graph-rest-1.0) ve özel dizin uzantıları desteklenir)
