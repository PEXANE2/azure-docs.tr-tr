...
6. Azure portal, [Kullanıcı özniteliği eşlemelerini düzenlemekte](customize-application-attributes.md)olduğunuz sırada, **kaynak öznitelik** listesi artık eklenen özniteliği biçiminde `<attributename> (extension_<appID>_<attributename>)`içerecektir. Özniteliği seçin ve sağlama için hedef uygulamayla eşleyin.
