---
title: Azure Active Directory portalında özel rol atamalarını görüntüleme | Microsoft Docs
...
ms.locfileid: "103015769"
---
# <a name="view-custom-role-assignments-using-azure-active-directory"></a>Azure Active Directory kullanarak özel rol atamalarını görüntüleme
...
Bu bölümde, bir rolün kurumsal çapta kapsama sahip atamalarını görüntüleme açıklanmaktadır.  Graph API kullanarak tek uygulama kapsamı atamalarını görüntülemek için, [Graph API ile özel rol atama](custom-assign-graph.md)içindeki işlemleri kullanabilirsiniz.
...
1. Rolün atamalarını görüntülemek için **atamalar** ' ı seçin. Atamalar görünümünü uygulama kaydı içinden açmak, bu Azure AD kaynağı kapsamındaki atamaları gösterir.
    ...
    ![Uygulama kaydının özelliklerinden uygulama kaydı rol atamalarını görüntüleme](./media/view-assignments/app-reg-assignments-2.png)
