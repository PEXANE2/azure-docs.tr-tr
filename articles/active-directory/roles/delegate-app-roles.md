...
- [Özel bir *rol tanımı* oluşturun](custom-create.md) ve [önceden ayarlanmış bir listeden izinleri ekleyin](custom-available-permissions.md). Bunlar, yerleşik rollerde kullanılan izinlerdir.
- Özel rolü atamak için [bir *rol ataması* oluşturun](custom-assign-powershell.md) .
...
Özel rollerin temelleri hakkında daha fazla bilgi için bkz. [özel rollere genel bakış](custom-overview.md)ve [özel rol oluşturma](custom-create.md) ve [rol atama](custom-assign-powershell.md).

## <a name="next-steps"></a>Sonraki adımlar

- [Uygulama kaydı alt türleri ve izinleri](custom-available-permissions.md)
- [Azure AD yönetici rolü başvurusu](permissions-reference.md)
