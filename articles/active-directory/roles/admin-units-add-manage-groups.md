...
1. **Azure AD > grupları** sayfasından
    ...
    ![bir yönetim birimine tek bir grup atama](./media/admin-units-add-manage-groups/assign-to-group-1.png)
...
1. **Tüm Gruplar sayfasında > Azure AD > yönetim birimleri** ' nden
    ...
    ![bir yönetim birimi seçip üye Ekle ' yi seçin.](./media/admin-units-add-manage-groups/assign-to-admin-unit.png)
...
Bu örnekte, cmdlet Add-AzureADMSAdministrativeUnitMember, grubu yönetim birimine eklemek için kullanılır. Yönetim biriminin nesne KIMLIĞI ve eklenecek grubun nesne KIMLIĞI bağımsız değişken olarak alınır. Vurgulanan bölüm, belirli bir ortam için gerektiği şekilde değiştirilebilir.
...
![Yönetim birimindeki grupları listeleme](./media/admin-units-add-manage-groups/list-groups-in-admin-units.png)
...
![Bir grup için yönetim birimlerini listeleme](./media/admin-units-add-manage-groups/list-group-au.png)
...
- Bir gruba genel bakış 'dan kaldırma

  1. **Azure AD**  >  **gruplarını** açın ve yönetim biriminden kaldırmak istediğiniz grubun profilini açın.
  1. Grubun üye olduğu tüm yönetim birimlerini listelemek için sol panelde **yönetim birimleri** ' ni seçin. Grubu kaldırmak istediğiniz yönetim birimini seçin ve ardından **Yönetim biriminden kaldır**' ı seçin.

    ![Yönetim biriminden bir grubu kaldırma](./media/admin-units-add-manage-groups/group-au-remove.png)

- Yönetim biriminden kaldır

  1. **Azure AD**  >  **Yönetim birimlerini** açın ve grubun üye olduğu yönetim birimini seçin.
  1. Üye gruplarını listelemek için sol paneldeki **gruplar** ' ı seçin.
  1. Yönetim biriminden kaldırılacak grubu seçin ve ardından **grupları kaldır**' ı seçin.
