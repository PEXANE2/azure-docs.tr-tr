...
- Varsayılan Kullanıcı izinleri için bkz. [varsayılan Konuk ve üye Kullanıcı izinlerinin karşılaştırması](/azure/active-directory/fundamentals/users-default-permissions).
