...
2. Uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için **[Wisvahili Paces çoklu oturum açmayı yapılandırın](#configure-wikispaces-single-sign-on)** .
...
### <a name="configure-wikispaces-single-sign-on"></a>Wsvahili Paces çoklu oturum açmayı yapılandırma
