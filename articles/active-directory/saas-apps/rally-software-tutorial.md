...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için, **[rmay yazılımlarını çoklu oturum açmayı yapılandırın](#configure-rally-software-single-sign-on)** .
...
### <a name="configure-rally-software-single-sign-on"></a>En düşük yazılım tek Sign-On yapılandırma
...
Erişim panelinde, düşük yazılımdan yazılım kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız RI yazılımda otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
