...
**BenefitHub** Side çoklu oturum açmayı yapılandırmak için, Indirilen **Federasyon meta veri XML** 'Sini ve uygun kopyalanmış URL 'leri Azure Portal [Destek ekibine](https://www.benefithub.com/Home/ContactUs)göndermeniz gerekir. Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.

### <a name="create-benefithub-test-user"></a>BenefitHub test kullanıcısı oluştur

Bu bölümde, BenefitHub içinde B. Simon adlı bir Kullanıcı oluşturacaksınız. Kullanıcıları BenefitHub platformunda eklemek için [BenefitHub destek ekibi](https://www.benefithub.com/Home/ContactUs) ile çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.
