...
2. Uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için **[Insight4GRC çoklu oturum açmayı yapılandırın](#configure-insight4grc-single-sign-on)** .
...
4. **Temel SAML yapılandırması** bölümünde, uygulamayı **IDP** tarafından başlatılan modda yapılandırmak istiyorsanız aşağıdaki adımları uygulayın:
    ...
    ![Insight4GRC etki alanı ve URL 'Ler çoklu oturum açma bilgileri](common/idp-intiated.png)
...
5. Uygulamayı **SP** tarafından başlatılan modda yapılandırmak Istiyorsanız **ek URL 'ler ayarla** ' ya tıklayın ve aşağıdaki adımı gerçekleştirin:
    ...
    ![Insight4GRC etki alanı ve URL 'Ler çoklu oturum açma bilgileri](common/metadata-upload-additional-signon.png)
...
### <a name="configure-insight4grc-single-sign-on"></a>Insight4GRC çoklu oturum açmayı yapılandırma
