...
Bu bölümde, büyük bir uç bulutta B. Simon adlı bir Kullanıcı oluşturacaksınız. Modern bir uç bulut platformunda kullanıcıları eklemek için, [büyük bir istemci desteği](mailto:support@upshotly.com) ekibiyle çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.
