...
2. ®, Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için bir **[Çoklu oturum açma için zaman hatası yapılandırma](#configure-chronicx-single-sign-on)** .
...
4. **Temel SAML yapılandırması** bölümünde aşağıdaki adımları gerçekleştirin:
    ...
    > [!NOTE]
    >Oturum açma URL 'SI değeri gerçek değil. Değeri gerçek Sign-On URL 'siyle güncelleştirin. Değeri almak için, zaman [hatası IX® istemci destek ekibine](https://www.casebank.com/contact-us/) başvurun. Ayrıca, Azure portal **temel SAML yapılandırması** bölümünde gösterilen desenlere de başvurabilirsiniz.
...
### <a name="configure-chronicx-single-sign-on"></a>Zaman hatası yapılandırma tek Sign-On
