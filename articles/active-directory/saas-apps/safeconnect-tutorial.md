...
2. **[SafeConnect SSO 'Yu yapılandırma](#configure-safeconnect-sso)** -uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
...
Erişim panelinde SafeConnect kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız SafeConnect 'te otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
