---
title: 'Öğretici: SafeConnect ile tümleştirme Azure Active Directory | Microsoft Docs'
...
**Safeconnect** tarafında çoklu oturum açmayı yapılandırmak için, Indirilen **meta veri XML** 'Sini ve uygun kopyalanmış URL 'Leri Azure Portal ' den [safeconnect destek ekibine](mailto:support@impulse.com)göndermeniz gerekir. Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
Bu bölümde, SafeConnect 'te Britta Simon adlı bir Kullanıcı oluşturacaksınız. Safeconnect platformunda kullanıcıları eklemek için [safeconnect destek ekibi](mailto:support@impulse.com) ile çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.
