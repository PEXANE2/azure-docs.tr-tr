...
## <a name="configure-and-test-azure-ad-single-sign-on-for-colortokens-ztna"></a>Renk belirteçleri için Azure AD çoklu oturum açmayı yapılandırma ve test etme ZTNA
...
Azure AD SSO 'yu ColorTokens ZTNA ile yapılandırmak ve test etmek için aşağıdaki yapı taşlarını doldurun:
...
1. [Azure Portal](https://portal.azure.com/), **colortokens ztna** uygulama tümleştirmesi sayfasında **Yönet** bölümünü bulun ve **Çoklu oturum açma**' yı seçin.
...
1. **Temel SAML yapılandırması** bölümünde, aşağıdaki alanlar için değerleri girin:
    ...
    a. **Oturum açma URL 'si** metin kutusunda, aşağıdaki kalıbı kullanarak bir URL yazın:`https://<COLORMASTER_HOST>/colormaster/api/v1/<TENANT_NAME>/saml/login?resourceId=<RESOURCEID>&iwa=<TRUE/FALSE>`

    b. **Tanımlayıcı (VARLıK kimliği)** metin kutusunda, aşağıdaki kalıbı kullanarak bir URL yazın:`https://<COLORMASTER_HOST>.com/<TENANT_NAME>`

    c. **Yanıt URL 'si** metin kutusuna aşağıdaki kalıbı kullanarak bir URL yazın:`https://<COLORMASTER_HOST>.com/<TENANT_NAME>`
...
Erişim panelinde ColorTokens ZTNA kutucuğunu tıklattığınızda, SSO 'yu ayarladığınız Colortoken belirteçlerinde otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Azure AD ile Colortoken 'ı kullanmayı deneyin](https://aad.portal.azure.com/)

- [Microsoft Cloud App Security oturum denetimi nedir?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Gelişmiş görünürlük ve denetimlerle ColorTokens ZTNA koruma](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)