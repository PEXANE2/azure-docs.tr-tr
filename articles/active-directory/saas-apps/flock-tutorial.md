...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Flock çoklu oturum açmayı yapılandırın](#configure-flock-single-sign-on)** .
...
### <a name="configure-flock-single-sign-on"></a>Flock tek Sign-On yapılandırma
...
Erişim panelinde Flock kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Flock 'ta otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
