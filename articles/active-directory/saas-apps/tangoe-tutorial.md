...
2. **[Tangoe komutunu yapılandırma Premium Mobil çoklu oturum açma](#configure-tangoe-command-premium-mobile-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
### <a name="configure-tangoe-command-premium-mobile-single-sign-on"></a>Tangoe komut Premium Mobil tek Sign-On yapılandırma
...
Erişim panelinde Tangoe komutu Premium Mobil kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Tangoe Command Premium Mobile 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
