---
title: 'Öğretici: Voyance ile tümleştirme Azure Active Directory | Microsoft Docs'
description: Azure Active Directory ile Voyance arasında çoklu oturum açmayı nasıl yapılandıracağınızı öğrenin.
...
Bu öğreticide, Voyance 'yi Azure Active Directory (Azure AD) ile tümleştirmeyi öğreneceksiniz.
Voyance 'yi Azure AD ile tümleştirmek aşağıdaki avantajları sağlar:

* Azure AD 'de Voyance erişimi olan denetim yapabilirsiniz.
* Kullanıcılarınızın Azure AD hesaplarıyla Voyance (çoklu oturum açma) için otomatik olarak oturum açmasını sağlayabilirsiniz.
...
* Voyance çoklu oturum açma etkin abonelik

## <a name="scenario-description"></a>Senaryo açıklaması

Bu öğreticide, Azure AD çoklu oturum açmayı bir test ortamında yapılandırıp test edersiniz.

* Voyance, **SP** ve **IDP** tarafından başlatılan SSO 'yu destekler

* Voyance **, tam zamanında** Kullanıcı sağlamayı destekler

## <a name="adding-voyance-from-the-gallery"></a>Galeriden Voyance ekleme

Voyance 'nin tümleştirmesini Azure AD 'ye göre yapılandırmak için, Galeriden, yönetilen SaaS uygulamaları listenize Voyance eklemeniz gerekir.

**Galeriden Voyance eklemek için aşağıdaki adımları uygulayın:**
...
4. **Temel SAML yapılandırması** bölümünde, uygulamayı **IDP** tarafından başlatılan modda yapılandırmak istiyorsanız aşağıdaki adımları uygulayın:
    ...
    b. **Yanıt URL 'si** metin kutusuna aşağıdaki kalıbı kullanarak bir URL yazın:`https://<companyname>.nyansa.com/saml/create/`
...
7. **Voyance 'Yi ayarlama** bölümünde uygun URL 'leri gereksiniminize göre kopyalayın.
...
Bu bölümde, Voyance 'de Britta Simon adlı bir Kullanıcı oluşturulur. Voyance, varsayılan olarak etkinleştirilen tam zamanında Kullanıcı sağlamayı destekler. Bu bölümde sizin için herhangi bir eylem öğesi yok. Bir Kullanıcı Voyance 'de zaten mevcut değilse, kimlik doğrulamasından sonra yeni bir tane oluşturulur.

>[!NOTE]
>El ile bir kullanıcı oluşturmanız gerekiyorsa [Voyance destek ekibine](maiLto:support@nyansa.com)başvurmanız gerekir.

### <a name="test-single-sign-on"></a>Çoklu oturum açma testi 

Bu bölümde, erişim panelini kullanarak Azure AD çoklu oturum açma yapılandırmanızı test edersiniz.

Erişim panelinde Voyance kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Voyance 'de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
