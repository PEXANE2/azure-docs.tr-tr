...
> * AWS tekil Sign-On [Çoklu oturum açma]()
...
3. [Azure AD ve AWS çoklu oturum açma arasında](../app-provisioning/customize-application-attributes.md)hangi verilerin eşlendiğini saptayın. 
