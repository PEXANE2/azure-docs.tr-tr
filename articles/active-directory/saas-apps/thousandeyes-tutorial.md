...
* ThousandEyes [ **Otomatik** Kullanıcı sağlamayı destekler](./thousandeyes-provisioning-tutorial.md)
...
Erişim panelinde ThousandEyes kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız ThousandEyes için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
