...
1. **Temel SAML yapılandırması** bölümünde, aşağıdaki alanlar için değerleri girin:
    ...
    > [!NOTE]
    > Bu değerler gerçek değildir. Bu değerleri gerçek oturum açma URL 'SI, tanımlayıcı ve yanıt URL 'siyle güncelleştirin. Bu değerleri almak için [Kaynak Merkezi istemci desteği ekibine](mailto:rc@aod.vn) başvurun. Ayrıca, Azure portal **temel SAML yapılandırması** bölümünde gösterilen desenlere de başvurabilirsiniz.
...
* Microsoft Access panel ' i kullanabilirsiniz. Erişim panelinde kaynak merkezi kutucuğuna tıkladığınızda bu, kaynak merkezi oturum açma URL 'sine yönlenir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
