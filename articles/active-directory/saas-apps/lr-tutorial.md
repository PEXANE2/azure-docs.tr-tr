...
* LoginRadius çoklu oturum açma etkin aboneliği
...
**Galeriden LoginRadius eklemek için aşağıdaki adımları uygulayın:**
...
4. Arama kutusuna **loginradius**yazın, sonuç panelinden **loginradius** ' ı seçin ve sonra uygulamayı eklemek için düğme **Ekle** ' ye tıklayın.
...
2. Uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için **[LoginRadius çoklu oturum açmayı yapılandırın](#configure-loginradius-single-sign-on)** .
...
4. **Temel SAML yapılandırması** bölümünde aşağıdaki adımları gerçekleştirin:
    ...
    a. **Oturum açma URL 'si** metin kutusuna bir URL yazın:`https://secure.loginradius.com/login`

    b. **Tanımlayıcı (VARLıK kimliği)** metin kutusuna bir URL yazın:`https://LoginRadius.hub.loginradius.com/`

    > [!NOTE]
    > Oturum açma URL 'SI sayfasını açın. **Çoklu oturum açma** sekmesine tıklayın ve [loginradius destek ekibi](mailto:support@loginradius.com) tarafından verilen **eklenti adını** girip **oturum aç** düğmesine tıklayın ve oturum açmak için Azure AD sayfasına yönlendirilirsiniz.
...
### <a name="configure-loginradius-single-sign-on"></a>LoginRadius çoklu oturum açmayı yapılandırma

**Loginradius** tarafında çoklu oturum açmayı yapılandırmak için, Indirilen **meta veri XML** 'Sini ve uygun kopyalanmış URL 'Leri Azure Portal 'den [loginradius destek ekibine](mailto:support@loginradius.com)göndermeniz gerekir. Bu ayar, SAML SSO bağlantısının her iki tarafında da düzgün bir şekilde ayarlanmasını sağlamak üzere ayarlanmıştır.
...
Bu bölümde, LoginRadius 'de Britta Simon adlı bir Kullanıcı oluşturacaksınız. Loginradius platformunda kullanıcıları eklemek için [loginradius destek ekibi](mailto:support@loginradius.com) ile çalışın. Çoklu oturum açma kullanılmadan önce kullanıcıların oluşturulması ve etkinleştirilmesi gerekir.

### <a name="test-single-sign-on"></a>Çoklu oturum açma testi 

Bu bölümde, erişim panelini kullanarak Azure AD çoklu oturum açma yapılandırmanızı test edersiniz.

Erişim panelinde LoginRadius kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız LoginRadius oturumunu otomatik olarak açmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
