...
2. Bir uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için **[SpaceIQ çoklu oturum açmayı yapılandırın](#configure-spaceiq-single-sign-on)** .
...
### <a name="configure-spaceiq-single-sign-on"></a>SpaceIQ çoklu oturum açmayı yapılandırma
...
Erişim panelinde SpaceIQ kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız SpaceIQ öğesinde otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
