...
> * Shopify ve için [Çoklu oturum açma](./shopify-plus-tutorial.md) (önerilir)
...
3. [Azure AD Ile Shopify Plus arasında](../app-provisioning/customize-application-attributes.md)hangi verilerin eşlendiğini saptayın. 
