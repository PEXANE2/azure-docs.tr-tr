...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için, **[Eticspoint olay yönetimi (EPıM) çoklu oturum açmayı yapılandırın](#configure-ethicspoint-incident-management-epim-single-sign-on)** .
...
4. **Temel SAML yapılandırması** bölümünde aşağıdaki adımları gerçekleştirin:
    ...
    > [!NOTE]
    > Bu değerler gerçek değildir. Bu değerleri gerçek Sign-On URL 'SI, tanımlayıcı ve yanıt URL 'siyle güncelleştirin. Bu değerleri almak için, [Eticspoint olay yönetimi (EPıM) istemci destek ekibine](https://www.navexglobal.com/company/contact-us) başvurun. Ayrıca, Azure portal **temel SAML yapılandırması** bölümünde gösterilen desenlere de başvurabilirsiniz.
...
### <a name="configure-ethicspoint-incident-management-epim-single-sign-on"></a>Eticspoint olay yönetimi (EPıM) tek Sign-On yapılandırma
