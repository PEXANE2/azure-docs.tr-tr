...
Bu bölümde, çapraz çevrimiçi portal söz konusu olduğunda B. Simon adlı bir Kullanıcı oluşturacaksınız. Çapraz çevrimiçi portal platformu olması durumunda kullanıcıları eklemek için, [Çapraz çevrimiçi portal destek ekibi](mailto:support@rockdovesolutions.com) ile birlikte çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.
