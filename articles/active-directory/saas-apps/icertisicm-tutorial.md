...
2. **[Iertıs sözleşme yönetimi platformunu tek oturum açma yapılandırma](#configure-icertis-contract-management-platform-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
### <a name="configure-icertis-contract-management-platform-single-sign-on"></a>Iertıs sözleşme yönetimi platformunu tek Sign-On yapılandırma
...
Erişim panelinde ıcertıs sözleşme yönetimi platformu kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız ıcertıs sözleşme yönetim platformunda otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
