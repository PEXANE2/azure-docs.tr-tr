---
title: 'Öğretici: posta şanslarla çoklu oturum açma (SSO) Tümleştirmesi Azure Active Directory! | Microsoft Belgeleri'
...
* Mail Luck! Çoklu oturum açma (SSO) etkin abonelik.

## <a name="scenario-description"></a>Senaryo açıklaması

Bu öğreticide, Azure AD SSO 'yu bir test ortamında yapılandırıp test edersiniz.

* Mail Luck! **SP** tarafından başlatılan SSO 'yu destekler
...
1. **Galeriden Ekle** bölümünde **posta şanslar yazın!** yazın.
...
E-posta Şanslarınıza tıkladığınızda! kutucukta, erişim panelinde otomatik olarak oturum açmış olmanız gerekir! için SSO 'yu ayarlama. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
