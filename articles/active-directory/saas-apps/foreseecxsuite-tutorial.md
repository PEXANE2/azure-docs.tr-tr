...
2. Uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için **[ForeSee CX Suite çoklu oturum açma yapılandırma](#configure-foresee-cx-suite-single-sign-on)** .
...
### <a name="configure-foresee-cx-suite-single-sign-on"></a>Configure ForeSee CX Suite çoklu oturum açma
...
Erişim panelinde ForeSee CX Suite kutucuğunu tıklattığınızda, SSO 'yu ayarladığınız ForeSee CX Suite ' de otomatik olarak oturum açmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
