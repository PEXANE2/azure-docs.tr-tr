...
## <a name="adding-zoho-one-china-from-the-gallery"></a>Galeriden Zoho bir Çin ekleme
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-zoho-one-china"></a>Zoho için Azure AD çoklu oturum açmayı yapılandırma ve test etme
...
Azure AD SSO 'yu, Zoho One Çin ile yapılandırmak ve test etmek için aşağıdaki yapı taşlarını doldurun:
...
1. [Azure Portal](https://portal.azure.com/), **Zoho One Çin** uygulama tümleştirmesi sayfasında **Yönet** bölümünü bulun ve **Çoklu oturum açma**' yı seçin.
...
1. Uygulamayı **SP** tarafından başlatılan modda yapılandırmak Istiyorsanız **ek URL 'ler ayarla** ' ya tıklayın ve aşağıdaki adımı gerçekleştirin:
    ...
    **Oturum açma URL 'si** metin kutusunda, aşağıdaki kalıbı kullanarak bir URL yazın:`https://accounts.zoho.com.cn/samlauthrequest/<zoid>?serviceurl=https://one.zoho.com.cn`
    ...
    > [!NOTE]
    > Bu değerler gerçek değildir. Bu değerleri gerçek yanıt URL 'SI ve oturum açma URL 'SI ile güncelleştirin. Bu değerleri almak için [Zoho One Çin istemci destek ekibine](mailto:support@zohocorp.com.cn) başvurun. Ayrıca, Azure portal **temel SAML yapılandırması** bölümünde gösterilen desenlere de başvurabilirsiniz.
...
Erişim panelinde Zoho One Çin kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Zoho One Çin 'de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Azure AD ile bir Çin 'de Zoho deneyin](https://aad.portal.azure.com/)

- [Microsoft Cloud App Security oturum denetimi nedir?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Gelişmiş görünürlük ve denetimlerle Zoho 'yi koruma](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
