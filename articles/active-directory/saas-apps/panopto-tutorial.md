...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Panopto çoklu oturum açmayı yapılandırın](#configure-panopto-single-sign-on)** .
...
4. **Temel SAML yapılandırması** bölümünde aşağıdaki adımları gerçekleştirin:
    ...
    **Oturum açma URL 'si** metin kutusunda, aşağıdaki kalıbı kullanarak bir URL yazın:`https://<tenant-name>.panopto.com`
    ...
    > [!NOTE]
    > Değer gerçek değil. Değeri gerçek Sign-On URL 'siyle güncelleştirin. Değeri almak için [Panopto istemci destek ekibine](mailto:support@panopto.com) başvurun. Ayrıca, Azure portal **temel SAML yapılandırması** bölümünde gösterilen desenlere de başvurabilirsiniz.
...
### <a name="configure-panopto-single-sign-on"></a>Panopto 'ı tek Sign-On yapılandırma
...
Erişim panelinde Panopto kutucuğunu tıklattığınızda, SSO 'yu ayarladığınız Panopto 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
