...
Erişim panelinde BlackICE 'ın öğrenme kutucuğunu tıklattığınızda, otomatik olarak, açık bir şekilde, SSO 'yu ayarlama hakkında bilgi edinin. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
