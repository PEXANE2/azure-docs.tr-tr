...
Erişim panelinde görüntü geçişi kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız görüntü geçişine otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
