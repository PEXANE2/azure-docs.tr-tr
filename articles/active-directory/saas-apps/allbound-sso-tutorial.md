---
title: 'Öğretici: Allbağlanacak SSO ile tümleştirme Azure Active Directory | Microsoft Docs'
description: Azure Active Directory ve Allbağlı SSO arasında çoklu oturum açmayı nasıl yapılandıracağınızı öğrenin.
...
Bu öğreticide, Allbağlanacak SSO 'yu Azure Active Directory (Azure AD) ile tümleştirmeyi öğreneceksiniz.
Allbağlanacak SSO 'yu Azure AD ile tümleştirmek aşağıdaki avantajları sağlar:

* Azure AD 'de, Allbağlanacak SSO 'ya erişimi olan bir denetim yapabilirsiniz.
* Kullanıcılarınızın Azure AD hesaplarıyla, Allbağlanacak SSO (çoklu oturum açma) ile otomatik olarak oturum açmasını sağlayabilirsiniz.
...
* Allbağlı SSO çoklu oturum açma etkin abonelik

## <a name="scenario-description"></a>Senaryo açıklaması

Bu öğreticide, Azure AD çoklu oturum açmayı bir test ortamında yapılandırıp test edersiniz.

* Allbağlanacak SSO **SP ve ıDP** tarafından başlatılan SSO 'yu destekler
* Allbağlanacak SSO **, tam zamanında** Kullanıcı sağlamasını destekler

## <a name="adding-allbound-sso-from-the-gallery"></a>Galeriden Allbağlanacak SSO ekleniyor

Allbağlanacak SSO 'nun tümleştirmesini Azure AD 'ye göre yapılandırmak için Galeriden Allbağlanacak SSO 'yu yönetilen SaaS uygulamaları listenize eklemeniz gerekir.

**Galeriden Allbağlanacak SSO eklemek için aşağıdaki adımları uygulayın:**
...
Azure AD çoklu oturum açmayı Allbağlanacak SSO ile yapılandırmak için aşağıdaki adımları uygulayın:

1. [Azure Portal](https://portal.azure.com/), **allbağlanacak SSO** uygulama tümleştirmesi sayfasında, **Çoklu oturum açma**' yı seçin.
...
4. **Temel SAML yapılandırması** bölümünde, uygulamayı **IDP** tarafından başlatılan modda yapılandırmak istiyorsanız aşağıdaki adımları uygulayın:
    ...
    b. **Yanıt URL 'si** metin kutusuna aşağıdaki kalıbı kullanarak bir URL yazın:`https://<SUBDOMAIN>.allbound.com/acs`
...
7. **Allbağlanacak SSO 'Yu ayarla** bölümünde, uygun URL 'leri gereksiniminize göre kopyalayın.
...
Bu bölümde, Azure çoklu oturum açma özelliğini kullanarak, Allbağlı SSO 'ya erişim vererek Britta Simon 'u etkinleştirin.

1. Azure portal **Kurumsal uygulamalar**' ı seçin, **tüm uygulamalar**' ı seçin ve ardından **allbağlanacak SSO**' yı seçin.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde, **Allbağlanacak SSO**' yı seçin.

    ![Uygulamalar listesindeki Allbağlanacak SSO bağlantısı](common/all-applications.png)
...
### <a name="create-allbound-sso-test-user"></a>Allbağlanacak SSO test kullanıcısı oluştur
...
Erişim panelinde Allbağlanacak SSO kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Allbağlanacak SSO 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
