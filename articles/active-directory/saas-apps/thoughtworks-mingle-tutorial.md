...
2. , Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için, en **[az bir oturum açma, en iyi şekilde oturum açmayı yapılandırma](#configure-thoughtworks-mingle-single-sign-on)** .
...
### <a name="configure-thoughtworks-mingle-single-sign-on"></a>En Iyi şekilde iş için Mingle tek Sign-On yapılandırma
...
Erişim panelinde, en iyi şekilde çalışır durumda, SSO 'yu ayarladığınız ınfetle için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
