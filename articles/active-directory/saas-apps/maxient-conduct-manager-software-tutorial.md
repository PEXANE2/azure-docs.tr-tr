...
**Maxsoli Yöneticisi yazılım** tarafında çoklu oturum açmayı yapılandırmak Için, **uygulama Federasyon meta verileri URL 'sini** [maxsoli Yöneticisi yazılım desteği ekibine](mailto:support@maxient.com)göndermeniz gerekir. Bu ayar, SAML SSO bağlantısının her iki tarafında da düzgün bir şekilde ayarlanmasını sağlamak üzere ayarlanmıştır.
...
Bu bölümde, Maxdentitytıon Manager yazılımında Britta Simon adlı bir Kullanıcı oluşturacaksınız. Maxdentityyürütme Yöneticisi yazılım [desteği ekibi](mailto:support@maxient.com) ile çalışarak, kullanıcıları Maxdentityme Yöneticisi yazılım platformunda ekleyin. Çoklu oturum açma kullanılmadan önce kullanıcıların oluşturulması ve etkinleştirilmesi gerekir.
