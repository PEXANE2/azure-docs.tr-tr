...
Erişim panelinde Iris Intranet kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Iris Intranetinde otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
