...
2. **Ayarlar** ' ın altında **kimlik doğrulaması** ' na gidin ve aşağıdaki işlemleri gerçekleştirin:
    ...
    örneğin: Ayarları kaydetmek için **Kaydet**’e tıklayın.
...
Erişim panelinde Menlo güvenlik kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Menlo güvenliğine otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
