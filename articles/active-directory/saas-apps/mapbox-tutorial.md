...
## <a name="configure-and-test-azure-ad-single-sign-on-for-mapbox"></a>Mapbox için Azure AD çoklu oturum açmayı yapılandırma ve test etme
...
Azure AD SSO 'yu Mapbox ile yapılandırmak ve test etmek için aşağıdaki yapı taşlarını doldurun:
...
1. [Azure Portal](https://portal.azure.com/), **mapbox** uygulama tümleştirmesi sayfasında, **Yönet** bölümünü bulun ve **Çoklu oturum açma**' yı seçin.
...
Erişim panelinde Mapbox kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Mapbox 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Azure AD ile Mapbox 'ı deneyin](https://aad.portal.azure.com/)

- [Microsoft Cloud App Security oturum denetimi nedir?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Gelişmiş görünürlük ve denetimlerle Mapbox 'ı koruma](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
