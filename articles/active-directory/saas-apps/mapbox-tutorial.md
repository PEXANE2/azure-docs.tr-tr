...
Erişim panelinde Mapbox kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Mapbox 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
...
- [Gelişmiş görünürlük ve denetimlerle Mapbox 'ı koruma](/cloud-app-security/proxy-intro-aad)