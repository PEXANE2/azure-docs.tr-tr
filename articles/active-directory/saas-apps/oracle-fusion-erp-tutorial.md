...
Bu öğreticide, Oracle Fusion ERP 'yi Azure Active Directory (Azure AD) ile tümleştirmeyi öğreneceksiniz. Oracle Fusion ERP 'yi Azure AD ile tümleştirdiğinizde şunları yapabilirsiniz:
...
* Oracle Fusion ERP çoklu oturum açma (SSO) etkin aboneliği.
...
1. **Galeriden Ekle** bölümünde, arama kutusuna **Oracle Fusion ERP** yazın.
1. Sonuçlar panelinden **Oracle FUSION ERP** ' yi seçin ve ardından uygulamayı ekleyin. Uygulama kiracınıza eklenirken birkaç saniye bekleyin.
...
1. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Oracle FUSION ERP SSO 'Yu yapılandırın](#configure-oracle-fusion-erp-sso)** .
    1. Oracle Fusion ERP **[test kullanıcısı oluşturun](#create-oracle-fusion-erp-test-user)** -bu, kullanıcının Azure AD gösterimine bağlı olan Oracle Fusion ERP 'de B. Simon 'un bir karşılığı olacak.
...
1. **Oracle FUSION ERP ayarla** bölümünde, gereksiniminize göre uygun URL 'leri kopyalayın.
...
* Microsoft My Apps ' i kullanabilirsiniz. Uygulamalarım içindeki Oracle Fusion ERP kutucuğuna tıkladığınızda bu, Oracle Fusion ERP oturum açma URL 'sine yönlendirilir. Uygulamalarım hakkında daha fazla bilgi için bkz. [uygulamalarıma giriş](../user-help/my-apps-portal-end-user-access.md).
