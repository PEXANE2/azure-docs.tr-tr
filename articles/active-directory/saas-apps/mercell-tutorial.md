...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Mercell çoklu oturum açmayı yapılandırın](#configure-mercell-single-sign-on)** .
...
### <a name="configure-mercell-single-sign-on"></a>Mercell tek Sign-On yapılandırma
...
Erişim panelinde Mercell kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Merhücrede otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
