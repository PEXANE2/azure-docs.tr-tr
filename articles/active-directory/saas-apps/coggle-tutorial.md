...
Erişim panelinde Cole Kutucuğa tıkladığınızda, SSO 'yu sizin için kullandığınız birlikte otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Gelişmiş görünürlük ve denetimlerle birlikte dişli koruması](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
