...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Panorama9 çoklu oturum açmayı yapılandırın](#configure-panorama9-single-sign-on)** .
...
### <a name="configure-panorama9-single-sign-on"></a>Panorama9 Single Sign-On yapılandırma
...
Erişim panelinde Panorama9 kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Panorama9 için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
