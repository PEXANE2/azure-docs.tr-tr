...
2. Uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için, **[CloudSuite Için ınsingle oturum açmayı yapılandırın](#configure-infor-cloudsuite-single-sign-on)** .
...
4. **Temel SAML yapılandırması** bölümünde, uygulamayı **IDP** tarafından başlatılan modda yapılandırmak istiyorsanız aşağıdaki adımları uygulayın:
    ...
    ![Infor CloudSuite etki alanı ve URL 'Ler çoklu oturum açma bilgileri](common/idp-intiated.png)
...
5. Uygulamayı **SP** tarafından başlatılan modda yapılandırmak Istiyorsanız **ek URL 'ler ayarla** ' ya tıklayın ve aşağıdaki adımı gerçekleştirin:
    ...
    ![Infor CloudSuite etki alanı ve URL 'Ler çoklu oturum açma bilgileri](common/metadata-upload-additional-signon.png)
...
### <a name="configure-infor-cloudsuite-single-sign-on"></a>CloudSuite Için Infor CloudSuite çoklu oturum açmayı yapılandırma
...
Erişim panelindeki CloudSuite Infor CloudSuite kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız CloudSuite ' de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
