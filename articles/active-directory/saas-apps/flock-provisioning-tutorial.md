...
1. [Flock](https://web.flock.com/?)'ta oturum açın. **Takımınızı yönetmek** > **Ayarlar simgesine** tıklayın.
...
5. Yönetici kimlik bilgileri bölümü altında, **KIRACı URL** 'sinde daha önce alınan `https://api.flock-staging.com/v2/scim` ve **API belirteci** değerlerini, sırasıyla de **gizli anahtarı** girin. Azure AD 'nin Flock 'a bağlanabildiğinden emin olmak için **Bağlantıyı Sına** ' ya tıklayın. Bağlantı başarısız olursa, Flock hesabınızın yönetici izinlerine sahip olduğundan emin olun ve yeniden deneyin.
