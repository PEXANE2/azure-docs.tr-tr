...
2. **[ASC sözleşmelerini tek oturum açma yapılandırma](#configure-asc-contracts-single-sign-on)** -uygulama tarafında çoklu oturum açma ayarlarını yapılandırma.
...
4. **SAML Ile çoklu oturum açmayı ayarlama** sayfasında, aşağıdaki adımları uygulayın:
    ...
    b. **Yanıt URL 'si** metin kutusuna şu kalıbı kullanarak bir URL yazın: `https://<subdomain>.asccontracts.com/shibboleth.sso/login`
...
### <a name="configure-asc-contracts-single-sign-on"></a>ASC sözleşmeleri çoklu oturum açmayı yapılandırma
...
Erişim panelinde ASC sözleşmeleri kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız ASC sözleşmeleri için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
