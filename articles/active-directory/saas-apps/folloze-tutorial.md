---
title: 'Öğretici: şu şekilde tümleştirme Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "73156096"
---
# <a name="tutorial-azure-active-directory-integration-with-folloze"></a>Öğretici: ile tümleştirme Azure Active Directory

Bu öğreticide, Azure Active Directory (Azure AD) ile nasıl tümleştirileceğini öğreneceksiniz.
Azure AD ile tümleştirmek, aşağıdaki avantajları sağlar:

* Azure AD 'de, her ne kadar erişim sağlayan denetim yapabilirsiniz.
...
Azure AD tümleştirmesini bir şekilde yapılandırmak için aşağıdaki öğeler gereklidir:
...
**Galerinin altına göre eklemek için aşağıdaki adımları uygulayın:**
...
4. Arama kutusuna, sonra da uygulamayı eklemek için Ekle ' ye **tıklayın, sonuç**panelinden **izlenen** ' i seçin ve ardından **Ekle** düğmesine tıklayın.

     ![Sonuçlar listesinde izlenen](common/search_new_app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD çoklu oturum açmayı yapılandırma ve test etme

Bu bölümde, Azure AD çoklu oturum açmayı, **Britta Simon**adlı bir test kullanıcısına göre izlenen şekilde yapılandırıp test edersiniz.
...
2. Uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için **[Tekli oturum açmayı yapılandırın](#configure-folloze-single-sign-on)** .
3. Azure AD **[test kullanıcısı oluşturun](#create-an-azure-ad-test-user)** -Britta Simon Ile Azure AD çoklu oturum açma sınamasını test edin.
4. Azure AD **[Test kullanıcısına atama](#assign-the-azure-ad-test-user)** -Azure AD çoklu oturum açma özelliğini kullanarak Britta Simon 'u etkinleştirin.
5. Kullanıcı Azure AD gösterimi ile bağlantılı olarak, **[Test kullanıcısına](#create-folloze-test-user)** , her ne kadar Britta Simon 'ın bir karşılığı elde etmek için oluşturun.
...
Azure AD çoklu oturum açma 'yı aşağıda belirtilen şekilde yapılandırmak için aşağıdaki adımları uygulayın:

1. [Azure Portal](https://portal.azure.com/) **, Uygulama tümleştirmesini tümleştirme sayfasında,** **Çoklu oturum açma**' yı seçin.
...
8. **Ayarla** bölümünde, uygun URL 'leri gereksiniminize göre kopyalayın.
...
### <a name="configure-folloze-single-sign-on"></a>' İ çoklu oturum açmayı yapılandırma
...
Bu bölümde, Access 'e erişim vererek Britta Simon 'u Azure çoklu oturum açma özelliğini kullanacak şekilde etkinleştirirsiniz.

1. Azure portal **Kurumsal uygulamalar**' ı seçin, **tüm uygulamalar**' ı seçin ve ardından **izlenen**' ı seçin.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise_applications.png)

2. Uygulamalar listesinde, yazıp **izlenen**öğesini seçin.

    ![Uygulamalar listesinde Izlenen bağlantı](common/all_applications.png)
