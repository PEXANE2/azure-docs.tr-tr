...
2. **[Gerçek bağlantıları çoklu oturum açma yapılandırma](#configure-real-links-single-sign-on)** -uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
...
### <a name="configure-real-links-single-sign-on"></a>Gerçek bağlantıları çoklu oturum açmayı Yapılandır
...
Erişim panelinde gerçek bağlantılar kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız gerçek bağlantılara otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
