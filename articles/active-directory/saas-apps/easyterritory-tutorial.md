...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Easytoprakları çoklu oturum açmayı yapılandırın](#configure-easyterritory-single-sign-on)** .
...
### <a name="configure-easyterritory-single-sign-on"></a>Easytoprakları tek Sign-On yapılandırma
...
Erişim panelinde Easytoprakları kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Easybölgenin içinde otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
