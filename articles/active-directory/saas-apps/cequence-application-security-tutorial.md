...
3. Microsoft Access panel ' i kullanabilirsiniz. Erişim panelinde Cequence uygulama güvenliği kutucuğuna tıkladığınızda bu, Cequence uygulama güvenliği oturum açma URL 'sine yeniden yönlendirilir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
