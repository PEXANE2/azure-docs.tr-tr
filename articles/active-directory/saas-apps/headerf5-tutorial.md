...
1. Meta veri sertifikasını, kurulum işleminin ilerleyen kısımlarında kullanılacak olan F5 (üst bilgi tabanlı) içine aktarmanız gerekir. **> trafik sertifika yönetimi > > SSL sertifika listesi**' ne > gidin. Sağ köşeyi **Içeri aktarmaya** tıklayın

    ![F5 (üst bilgi tabanlı) yapılandırma](./media/headerf5-tutorial/configure12.png)
 
1. Ayrıca, ana bilgisayar adı (`headerapp.superdemo.live`) için bir **SSL sertifikasına** de ihtiyacınız vardır. Bu örnekte joker karakter sertifikası kullanılmaktadır.

    ![F5 (üst bilgi tabanlı) yapılandırma](./media/headerf5-tutorial/configure13.png)

1. Git- **F5 (üst bilgi tabanlı) büyük-IP erişim > Kılavuzlu yapılandırma > federasyon > SAML hizmet sağlayıcısı ' na tıklayın**.
...
1. Yeni bir sanal sunucu oluşturun, **hedef adresi**belirtin, **yeniden yönlendirme bağlantı noktası** isteğe bağlıdır. Daha önce ve **Ilişkili özel anahtarı**karşıya yüklediğimiz **joker karakter sertifikasını** (veya uygulama için karşıya yüklediğiniz **sertifikayı** ) seçin.
...
1. Çoklu oturum açma altında **http üst bilgi tabanlı**' yı seçin. Uygulamanıza bağlı olarak diğer üst bilgileri ekleyebilirsiniz. SAML oturum değişkenleri listesi için eke bakın

    ![F5 (üst bilgi tabanlı) yapılandırma](./media/headerf5-tutorial/configure07.png) 

1. **Uç nokta denetimi özellikleri** belge ayrıntıları için [F5 (üst bilgi tabanlı) istemci desteği ekibine](https://support.f5.com/csp/knowledge-center/software/BIG-IP?module=BIG-IP%20APM45) başvurun.

    ![F5 (üst bilgi tabanlı) yapılandırma](./media/headerf5-tutorial/configure08.png)

1. **Oturum yönetimi özellikleri** belge ayrıntıları için [F5 (üst bilgi tabanlı) istemci desteği ekibine](https://support.f5.com/csp/knowledge-center/software/BIG-IP?module=BIG-IP%20APM45) başvurun.
