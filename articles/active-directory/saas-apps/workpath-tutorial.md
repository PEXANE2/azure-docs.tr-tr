---
title: 'Öğretici: Iş yoluyla çoklu oturum açma (SSO) Tümleştirmesi Azure Active Directory | Microsoft Docs'
...
Bu öğreticide, Iş yolunu Azure Active Directory (Azure AD) ile tümleştirmeyi öğreneceksiniz. Iş yolunu Azure AD ile tümleştirdiğinizde şunları yapabilirsiniz:

* Azure AD 'de Workpath 'e erişimi olan denetim.
* Kullanıcılarınızın Azure AD hesaplarıyla Iş yolunda otomatik olarak oturum açmalarına olanak sağlayın.
...
* İş yolu çoklu oturum açma (SSO) etkin abonelik.
...
* Workpath **SP ve ıDP** tarafından başlatılan SSO 'yu destekler
...
1. Sonuçlar panelinden **Iş yolu** ' nu seçin ve ardından uygulamayı ekleyin. Uygulama kiracınıza eklenirken birkaç saniye bekleyin.
...
1. **[Workpath SSO 'Yu yapılandırma](#configure-workpath-sso)** -uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
    1. Kullanıcının Azure AD gösterimine bağlı olan Iş yolunda B. Simon 'a karşılık gelen bir iş yolu **[test kullanıcısı oluşturun](#create-workpath-test-user)** .
...
1. [Azure Portal](https://portal.azure.com/), **iş yolu** uygulama tümleştirmesi sayfasında, **Yönet** bölümünü bulun ve **Çoklu oturum açma**' yı seçin.
...
1. Uygulamayı **SP** tarafından başlatılan modda yapılandırmak Istiyorsanız **ek URL 'ler ayarla** ' ya tıklayın ve aşağıdaki adımı gerçekleştirin:
    ...
    **Oturum açma URL 'si** metin kutusunda, aşağıdaki kalıbı kullanarak bir URL yazın:`https://<subdomain>.workpath.com/`
    ...
    > [!NOTE]
    > Bu değerler gerçek değildir. Bu değerleri gerçek tanımlayıcı, yanıt URL 'SI ve oturum açma URL 'SI ile güncelleştirin. Bu değerleri almak için [Iş yolu istemci desteği ekibine](https://www.workpath.com/en/company/) başvurun. Ayrıca, Azure portal **temel SAML yapılandırması** bölümünde gösterilen desenlere de başvurabilirsiniz.

1. Workpath uygulaması, SAML belirteci öznitelikleri yapılandırmanıza özel öznitelik eşlemeleri eklemenizi gerektiren belirli bir biçimde SAML onayları bekler. Aşağıdaki ekran görüntüsünde varsayılan özniteliklerin listesi gösterilmektedir.
...
1. **Iş yolunu ayarla** bölümünde, gereksiniminize göre uygun URL 'leri kopyalayın.
...
Bu bölümde, Iş yoluna erişim izni vererek Azure çoklu oturum açma özelliğini kullanmak için B. Simon 'u etkinleştireceksiniz.

1. Azure portal **Kurumsal uygulamalar**' ı seçin ve ardından **tüm uygulamalar**' ı seçin.
1. Uygulamalar listesinde, **Iş yolu**' nu seçin.
...
## <a name="configure-workpath-sso"></a>Workpath SSO 'yu yapılandırma

**Çalışma yolu** tarafında çoklu oturum açmayı yapılandırmak için, Indirilen **Federasyon meta veri XML** 'sini ve Azure Portal ' den uygun kopyalanmış URL 'leri [iş yolu destek ekibine](https://www.workpath.com/en/company/)göndermeniz gerekir. Bu ayar, SAML SSO bağlantısının her iki tarafında da düzgün bir şekilde ayarlanmasını sağlamak üzere ayarlanmıştır.
...
Erişim panelinde Iş yolu kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Iş yolunda otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
...
- [Azure AD ile Iş yolunu deneyin](https://aad.portal.azure.com/)