---
title: 'Öğretici: Boomı ile tümleştirme Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "73157668"
---
# <a name="tutorial-azure-active-directory-integration-with-boomi"></a>Öğretici: Boomı ile tümleştirme Azure Active Directory

Bu öğreticide, Azure Active Directory (Azure AD) ile Boomı tümleştirme hakkında bilgi edineceksiniz.
Boomı 'yi Azure AD ile tümleştirmek aşağıdaki avantajları sağlar:

* Azure AD 'de, Boomı 'ya erişimi olan bir denetim yapabilirsiniz.
* Kullanıcılarınızın Azure AD hesaplarıyla birlikte Boomi (çoklu oturum açma) için otomatik olarak oturum açmasını sağlayabilirsiniz.
...
Azure AD tümleştirmesi 'ni Boomı ile yapılandırmak için aşağıdaki öğeler gereklidir:

* Bir Azure AD aboneliği. Bir Azure AD ortamınız yoksa, [burada](https://azure.microsoft.com/pricing/free-trial/) bir aylık deneme sürümü edinebilirsiniz
* Boomı çoklu oturum açma etkin aboneliği
...
**Galeriden Boomı eklemek için aşağıdaki adımları uygulayın:**
...
4. Arama kutusuna **boomı**yazın, sonuç panelinden **boomı** seçin, sonra da uygulamayı eklemek için düğme **Ekle** ' ye tıklayın.

     ![Sonuç listesinde boomı](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD çoklu oturum açmayı yapılandırma ve test etme

Bu bölümde, **Britta Simon**adlı bir test kullanıcısına bağlı olarak, Azure AD çoklu oturum açmayı, boomı ile birlikte yapılandırıp test edersiniz.
Çoklu oturum açma için, bir Azure AD kullanıcısı ve Boomı içindeki ilgili Kullanıcı arasındaki bağlantı ilişkisinin oluşturulması gerekir.

Azure AD çoklu oturum açma 'yı Boomı ile yapılandırmak ve test etmek için aşağıdaki yapı taşlarını gerçekleştirmeniz gerekir:

1. **[Azure AD çoklu oturum açma özelliğini yapılandırarak](#configure-azure-ad-single-sign-on)** kullanıcılarınızın bu özelliği kullanmasına olanak sağlayın.
2. Uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için **[Boomı çoklu oturum açmayı yapılandırın](#configure-boomi-single-sign-on)** .
3. Azure AD **[test kullanıcısı oluşturun](#create-an-azure-ad-test-user)** -Britta Simon Ile Azure AD çoklu oturum açma sınamasını test edin.
4. Azure AD **[Test kullanıcısına atama](#assign-the-azure-ad-test-user)** -Azure AD çoklu oturum açma özelliğini kullanarak Britta Simon 'u etkinleştirin.
5. Kullanıcının Azure AD gösterimine bağlı olan, Bootta, Boomi 'da açık olan Britta Simon 'a sahip olmak için, **[boomı test kullanıcısı oluşturun](#create-boomi-test-user)** .
...
Azure AD çoklu oturum açmayı Boomı ile yapılandırmak için aşağıdaki adımları uygulayın:

1. [Azure Portal](https://portal.azure.com/), **Boomi** uygulama tümleştirmesi sayfasında, **Çoklu oturum açma**' yı seçin.
...
4. **SAML Ile çoklu oturum açmayı ayarlama** sayfasında, **temel SAML yapılandırması** Iletişim kutusunu açmak için **Düzenle** düğmesine tıklayın.
    ...
    ![Boomı etki alanı ve URL 'Ler çoklu oturum açma bilgileri](common/idp-intiated.png)
...
8. **Boomi ayarla** bölümünde uygun URL 'leri gereksiniminize göre kopyalayın.
...
### <a name="configure-boomi-single-sign-on"></a>Boomı çoklu oturum açmayı Yapılandır

1. Farklı bir Web tarayıcısı penceresinde, Boomı şirket sitenizde yönetici olarak oturum açın. 

2. **Şirket adı** ' na gidin ve **Ayarla**' ya gidin.

3. **SSO seçenekleri** sekmesine tıklayın ve aşağıdaki adımları gerçekleştirin.
    ...
    d. **Federasyon kimliği konumu**olarak, **federasyon kimliği FEDERATION_ID öznitelik öğesi** radyo düğmesini seçin.
...
Bu bölümde, Bootta Simon 'u, Boomı 'a erişim vererek Azure çoklu oturum açma özelliğini kullanarak etkinleştirebilirsiniz.

1. Azure portal **Kurumsal uygulamalar**' ı seçin, **tüm uygulamalar**' ı seçin ve ardından **Boomi**' yi seçin.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde, **Boomi**' yi seçin.

    ![Uygulamalar listesindeki Boomı bağlantısı](common/all-applications.png)
...
2. Oturum açtıktan sonra **Kullanıcı yönetimi** ' ne gidin ve **Kullanıcılar**' a gidin.

    ![Kullanıcılar](./media/boomi-tutorial/tutorial_boomi_001.png "Kullanıcılar")

3. **+** simgesine tıklayın ve **Kullanıcı rolleri ekle/koru** iletişim kutusu açılır.
    ...
    a. **Kullanıcı e-posta adresi** metin kutusuna, BrittaSimon@contoso.comgibi kullanıcının e-postasını yazın.
