...
2. **[RStudio Connect çoklu oturum açmayı yapılandırma](#configure-rstudio-connect-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
### <a name="configure-rstudio-connect-single-sign-on"></a>RStudio Connect Single Sign-On yapılandırma
...
Erişim panelinde RStudio Connect kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız RStudio Connect ' de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
