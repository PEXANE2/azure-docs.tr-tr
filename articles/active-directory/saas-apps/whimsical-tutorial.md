...
1. [Azure Portal](https://portal.azure.com/), **Whimsical** uygulama tümleştirmesi sayfasında **Yönet** bölümünü bulun ve **Çoklu oturum açma**' yı seçin.
...
Erişim panelinde duman kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız duman 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
