...
**Darwinbox** tarafında çoklu oturum açmayı yapılandırmak için, Indirilen **Federasyon meta veri XML** 'sini ve Azure Portal ' den uygun kopyalanmış URL 'leri [darwinbox destek ekibine](https://darwinbox.com/contact-us.php)göndermeniz gerekir. Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.

### <a name="create-darwinbox-test-user"></a>Darwinbox test kullanıcısı oluştur

Bu bölümde, Darwinbox 'da B. Simon adlı bir Kullanıcı oluşturacaksınız. Darwinbox platformunda kullanıcıları eklemek için [darwinbox destek ekibi](https://darwinbox.com/contact-us.php) ile çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.
