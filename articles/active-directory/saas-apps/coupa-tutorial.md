...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için, tek **[bir oturum açmayı yapılandırın](#configure-coupa-single-sign-on)** .
...
### <a name="configure-coupa-single-sign-on"></a>Kupontek Sign-On yapılandırma
...
Erişim panelinde bir kupone Kutucuğa tıkladığınızda, SSO 'yu ayarladığınız kupona 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
