...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Lynda.com çoklu oturum açmayı yapılandırın](#configure-lyndacom-single-sign-on)** .
...
4. **Temel SAML yapılandırması** bölümünde aşağıdaki adımları gerçekleştirin:
    ...
    **Oturum açma URL 'si** metin kutusunda, aşağıdaki kalıbı kullanarak bir URL yazın:`https://<subdomain>.lynda.com/Shibboleth.sso/InCommon?providerId=<url>&target=<url>`
    ...
    > [!NOTE]
    > Değer gerçek değil. Değeri gerçek Sign-On URL 'siyle güncelleştirin. Değeri almak için  [Lynda.com istemci destek ekibine](https://www.linkedin.com/help/lynda/ask) başvurun. Ayrıca, Azure portal **temel SAML yapılandırması** bölümünde gösterilen desenlere de başvurabilirsiniz.
...
### <a name="configure-lyndacom-single-sign-on"></a>Lynda.com Single Sign-On yapılandırma
...
Erişim panelinde Lynda.com kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Lynda.com için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
