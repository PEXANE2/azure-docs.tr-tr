...
> [!NOTE]
> AAD Kullanıcı hesaplarını sağlamak için Lynda.com tarafından sunulan diğer tüm Lynda.com Kullanıcı hesabı oluşturma araçlarını veya API 'Leri kullanabilirsiniz.
