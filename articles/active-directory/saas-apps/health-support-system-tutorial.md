...
1. **Temel SAML yapılandırması** bölümünde aşağıdaki alanlar için değerleri girin: **oturum açma URL 'si** metin kutusuna URL 'yi yazın: `https://suntory.karakoko.jp`
...
Sistem **durumu desteği sistem** tarafında çoklu oturum açma 'yı yapılandırmak Için, **uygulama Federasyon meta veri URL 'sini** sistem [destek ekibi](https://wellcoms.jp/inquiry/)' ne göndermeniz gerekir. Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.

### <a name="create-health-support-system-test-user"></a>Sistem durumu desteği sistem testi Kullanıcı Oluştur

Bu bölümde, sistem durumu destek sisteminde B. Simon adlı bir Kullanıcı oluşturacaksınız. Sistem durumu destek sistemi platformunda kullanıcıları eklemek için sistem [durumu desteği sistem destek ekibi](https://wellcoms.jp/inquiry/) ile çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.
