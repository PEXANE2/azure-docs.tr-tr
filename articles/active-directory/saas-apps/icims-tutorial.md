...
## <a name="configure-and-test-azure-ad-single-sign-on-for-icims"></a>IIMS için Azure AD çoklu oturum açmayı yapılandırma ve test etme
...
Azure AD SSO 'yu ıIMS ile yapılandırmak ve test etmek için aşağıdaki yapı taşlarını doldurun:
...
1. [Azure Portal](https://portal.azure.com/), **ıims** uygulama tümleştirmesi sayfasında, **Yönet** bölümünü bulun ve **Çoklu oturum açma**' yı seçin.
...
1. **Temel SAML yapılandırması** bölümünde aşağıdaki adımları gerçekleştirin:
    ...
    c. **Yanıt URL** 'si metin kutusuna bir URL yazın:`https://.icims.com/`
...
- [Azure AD ile ıIMS 'yi deneyin](https://aad.portal.azure.com/)
