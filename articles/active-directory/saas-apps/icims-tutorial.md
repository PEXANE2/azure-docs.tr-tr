...
* Microsoft My Apps ' i kullanabilirsiniz. Uygulamalarım içindeki ıIMS kutucuğuna tıkladığınızda, bu işlem ıIMS oturum açma URL 'sine yönlendirilir. Uygulamalarım hakkında daha fazla bilgi için bkz. [uygulamalarıma giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
