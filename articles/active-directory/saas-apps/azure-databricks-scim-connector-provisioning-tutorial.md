...
* Kullanıcılar için Azure Databricks ' SCıM API 'sine karşı istekleri al büyük/küçük harfe duyarlıdır, bu nedenle USER@contoso.com sorgulıyoruz, bu, user@contoso.comolarak depolarsa 0 sonuçtan oluşur.
