...
Uygulamalarım portalındaki **Roadmunk** kutucuğunu SEÇTIĞINIZDE, SSO 'Yu ayarladığınız Roadmunk hesabında otomatik olarak oturum açmış olmanız gerekir. Daha fazla bilgi için bkz. [uygulamalarım portalından oturum açma ve uygulamaları başlatma](https://docs.microsoft.com/azure/active-directory/user-help/my-apps-portal-end-user-access).
...
[Microsoft Cloud App Security kullanarak oturum denetimini nasıl zorlayacağınızı](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app)öğrenin.
