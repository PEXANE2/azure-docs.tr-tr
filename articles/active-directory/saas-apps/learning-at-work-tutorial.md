...
* Microsoft My Apps ' i kullanabilirsiniz. Uygulamalarım bölümünde öğrenme Iş kutucuğuna tıkladığınızda bu, Iş oturum açma URL 'sindeki öğrenime yönlendirilir. Uygulamalarım hakkında daha fazla bilgi için bkz. [uygulamalarıma giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
