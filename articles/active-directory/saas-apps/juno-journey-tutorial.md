...
1. **Temel SAML yapılandırması** bölümünde, **IDP** tarafından başlatılan modda uygulamayı yapılandırmak istiyorsanız aşağıdaki alanlar için değerleri girin:
    ...
    a. **Tanımlayıcı** metin kutusuna şu kalıbı kullanarak bir URL yazın: `https://<tenant-subdomain>.the-juno.com`

    b. **Yanıt URL 'si** metin kutusuna şu kalıbı kullanarak bir URL yazın: `https://<tenant-subdomain>.the-juno.com/sso/saml/login`
