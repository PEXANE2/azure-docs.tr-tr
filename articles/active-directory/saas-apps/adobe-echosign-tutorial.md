...
2. Çoklu oturum **[açmayı yapılandırma](#configure-adobe-sign-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
### <a name="configure-adobe-sign-single-sign-on"></a>Adobe Sign Single Sign-On yapılandırma
...
Erişim panelinde Adobe Işareti kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Adobe Sign ' de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
