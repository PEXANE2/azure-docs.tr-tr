...
Erişim panelinde Predictix sıralama kutucuğunu seçtiğinizde, SSO 'yu ayarladığınız Predictix sıralama örneğinde otomatik olarak oturum açmanız gerekir. Daha fazla bilgi için bkz. [uygulamalarım portalındaki uygulamalara erişme ve bunları kullanma](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
