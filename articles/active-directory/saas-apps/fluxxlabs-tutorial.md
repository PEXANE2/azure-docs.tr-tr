...
Erişim panelinde Floxx Labs kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Floxx laboratuvarlarında otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
...
- [Gelişmiş görünürlük ve denetimlerle Floxx laboratuvarlarını koruma](/cloud-app-security/proxy-intro-aad)