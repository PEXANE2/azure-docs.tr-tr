---
title: 'Öğretici Azure Active Directory: barındırılan Hero online SSO ile çoklu oturum açma (SSO) Tümleştirmesi | Microsoft Docs'
...
ms.locfileid: "92442770"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-hosted-heritage-online-sso"></a>Öğretici: barındırılan Hero online SSO ile çoklu oturum açma (SSO) Tümleştirmesi Azure Active Directory
...
**Barındırılan Hersat ONLINE SSO** tarafında çoklu oturum açmayı yapılandırmak Için, **uygulama Federasyon meta verileri URL 'sini** [barındırılan Hero online SSO destek ekibine](mailto:support@isoxford.com)göndermeniz gerekir. Bu ayar, SAML SSO bağlantısının her iki tarafında da düzgün bir şekilde ayarlanmasını sağlamak üzere ayarlanmıştır.

### <a name="create-hosted-heritage-online-sso-test-user"></a>Barındırılan Herısat çevrimiçi SSO test kullanıcısı oluştur

Bu bölümde, barındırılan Hero online SSO 'da B. Simon adlı bir Kullanıcı oluşturacaksınız. Barındırılan Hero online SSO [destek ekibi](mailto:support@isoxford.com) ile çalışarak, kullanıcıları barındırılan Hersat çevrimiçi SSO platformunda ekleyin. Çoklu oturum açma kullanılmadan önce kullanıcıların oluşturulması ve etkinleştirilmesi gerekir.

## <a name="test-sso"></a>Test SSO 'SU 

Bu bölümde, erişim panelini kullanarak Azure AD çoklu oturum açma yapılandırmanızı test edersiniz.

Erişim panelinde barındırılan Hersat online SSO kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız barındırılan Hersat çevrimiçi SSO 'SU için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
