...
* Qprronizsp tarafından başlatılan SSO 'yu destekler 
...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Qprısm çoklu oturum açmayı yapılandırın](#configure-qprism-single-sign-on)** .
...
### <a name="configure-qprism-single-sign-on"></a>Qprroniztek Sign-On yapılandırma
...
Erişim panelinde Qprronizme kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Qprronizte otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
