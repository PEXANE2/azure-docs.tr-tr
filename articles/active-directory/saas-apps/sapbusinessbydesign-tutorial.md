...
Erişim panelinde SAP Business ByDesign kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız SAP Business ByDesign ' ta otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
