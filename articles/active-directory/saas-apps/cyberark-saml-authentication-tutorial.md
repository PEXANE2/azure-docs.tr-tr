...
Erişim panelinde CyberArk SAML kimlik doğrulaması kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Siark SAML kimlik doğrulamasında otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
