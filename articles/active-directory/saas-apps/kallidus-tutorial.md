...
4. **Temel SAML yapılandırması** bölümünde aşağıdaki adımları uygulayın:
    ...
    **Yanıt URL 'si** metin kutusuna aşağıdaki kalıbı kullanarak bir URL yazın:`https://login.kallidus-suite.com/core/<ID>/Acs`
