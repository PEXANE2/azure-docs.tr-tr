...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[IdeaScale çoklu oturum açmayı yapılandırın](#configure-ideascale-single-sign-on)** .
...
### <a name="configure-ideascale-single-sign-on"></a>IdeaScale tek Sign-On yapılandırma
...
Erişim panelinde IdeaScale kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız IdeaScale 'de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
