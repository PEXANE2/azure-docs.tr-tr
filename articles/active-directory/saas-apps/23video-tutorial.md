...
5. **Bu siteye katılması gereken kişiyi davet et** bölümünde aşağıdaki adımları uygulayın:
    ...
    a. **E-posta adresleri** metin kutusunda, gibi bir kullanıcının e-posta adresini yazın B.Simon@contoso.com .  
...
Erişim panelinde 23 video kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız 23 videoda otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
