...
> * Slack için [çoklu oturum açma](./slack-tutorial.md) (önerilir)
...
3. [Azure AD ile Slack arasında eşlenecek](../app-provisioning/customize-application-attributes.md) verileri belirleyin. 
