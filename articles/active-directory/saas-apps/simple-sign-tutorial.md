...
2. Çoklu oturum açmayı **[yapılandırma](#configure-simple-sign-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
### <a name="configure-simple-sign-single-sign-on"></a>Basit Imza tek Sign-On yapılandırma
...
Erişim panelinde basit Imza kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız basit oturum açma bölümünde otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
