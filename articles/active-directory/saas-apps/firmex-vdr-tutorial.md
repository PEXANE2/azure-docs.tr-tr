...
Bu bölümde, Firmex 'de B. Simon adlı bir Kullanıcı oluşturacaksınız. Firmex platformunda kullanıcıları eklemek için [Firmex destek ekibi](mailto:support@firmex.com) ile çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.
