...
Erişim panelinde Firmex VDR kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Firmex VDR ' de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
...
- [Firmex 'yi gelişmiş görünürlük ve denetimlerle koruma](/cloud-app-security/proxy-intro-aad)