...
2. **[Argıs online çoklu oturum açmayı yapılandırma](#configure-arcgis-online-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
### <a name="configure-arcgis-online-single-sign-on"></a>Argıs online tek Sign-On yapılandırma
...
Erişim panelinde ArcGIS Çevrimiçi kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız çevrimiçi ortamda otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
