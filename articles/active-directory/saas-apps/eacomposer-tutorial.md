...
3. Microsoft Access panel ' i kullanabilirsiniz. Erişim panelinde Eabesteci kutucuğuna tıkladığınızda, bu URL 'yi Eabesteci oturum açma URL 'sine yönlendirecektir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
