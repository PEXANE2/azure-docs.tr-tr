...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Benefitsolver çoklu oturum açmayı yapılandırın](#configure-benefitsolver-single-sign-on)** .
...
### <a name="configure-benefitsolver-single-sign-on"></a>Benefitsolver Single Sign-On yapılandırma
...
Erişim panelinde Benefitsolver kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Benefitsolver için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
