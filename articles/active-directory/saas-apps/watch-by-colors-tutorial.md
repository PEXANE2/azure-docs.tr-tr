...
4. Sayfanın sağ üst köşesinde **profil**  >  **Hesap ayarları**  >  **SSO (çoklu oturum açma)** seçeneğine tıklayın.
    ...
    ![Ekran görüntüsünde, S S O 'nun devre dışı bırakıldığı hesap ayarları sayfası gösterilir.](./media/watch-by-colors-tutorial/config01.png)

5. **SSO (çoklu oturum açma)** sayfasında, aşağıdaki adımları gerçekleştirin:

    ![Ekran görüntüsü, SAML 'yi etkinleştirebileceğiniz SAML Kurulum sekmesini gösterir.](./media/watch-by-colors-tutorial/config02.png)
...
1. Sayfanın sağ üst köşesinde **profil**  >  **kullanıcıları**  >  **Kullanıcı Ekle** ' ye tıklayın.
    ...
    ![Ekran görüntüsü kullanıcılar sayfasını gösterir.](./media/watch-by-colors-tutorial/config03.png)

1. **Kullanıcı ayrıntıları** sayfasında, aşağıdaki adımları uygulayın:

    ![Ekran görüntüsünde, açıklanan değerleri girebileceğiniz kullanıcı ayrıntıları gösterilir.](./media/watch-by-colors-tutorial/config04.png)
...
Erişim panelinde renklere göre Izle kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız renklere göre Izlemek için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
