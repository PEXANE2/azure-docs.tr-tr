...
2. **[FM: sistemler çoklu oturum açma yapılandırma](#configure-fmsystems-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
### <a name="configure-fmsystems-single-sign-on"></a>FM: sistemler tek Sign-On yapılandırma
...
Erişim panelinde FM: sistemler kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız FM: sistemlerinde otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
