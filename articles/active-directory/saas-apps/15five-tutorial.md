...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[15 adet çoklu oturum açmayı yapılandırın](#configure-15five-single-sign-on)** .
...
### <a name="configure-15five-single-sign-on"></a>15Beş tek Sign-On yapılandırma
...
Erişim panelinde 15 beş Kutucuğa tıkladığınızda, SSO 'yu ayarladığınız 15 milyon tarihinde otomatik olarak oturum açmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
