...
## <a name="adding-egnyte-from-the-gallery"></a>Adding Egnyte from the gallery
...
### <a name="configure-egnyte-single-sign-on"></a>Configure Egnyte Single Sign-On
...
### <a name="create-egnyte-test-user"></a>Create Egnyte test user
