...
1. **Yönetici kimlik bilgileri** bölümünü aşağıdaki şekilde doldurun:
   ...
   * **Kiracı URL 'si –** Başarılı olan OData API hizmetleri uç noktasının adını girin. Yalnızca http veya https olmayan sunucunun ana bilgisayar adını girin. Bu değer şöyle görünmelidir: **< api-Server-name >. başarılı etmenler. com**.
