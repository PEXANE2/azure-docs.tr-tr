...
2. Çoklu **[oturum açmayı kapatma](#configure-settling-music-single-sign-on)** , uygulama tarafında tek Sign-On ayarlarını yapılandırmak için yapılandırma.
...
### <a name="configure-settling-music-single-sign-on"></a>Tek Sign-On için kapatma 'yi yapılandırma
...
Erişim panelinde müziği kapatma kutucuğunu tıklattığınızda, SSO 'yu ayarladığınız müziğin kapatılırken otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
