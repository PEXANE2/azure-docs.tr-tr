...
* Azure AD 'de Bamboo için Easyssize erişimi olan denetim.
* Kullanıcılarınızın Azure AD hesaplarıyla Bamboo için otomatik olarak oturum açabilmesi için izin sağlayın.
...
Erişim panelinde Bamboo için EasySSO kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Bamboo için EasySSO 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
