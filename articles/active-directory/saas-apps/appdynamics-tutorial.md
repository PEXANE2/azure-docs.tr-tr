...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[AppDynamics çoklu oturum açmayı yapılandırın](#configure-appdynamics-single-sign-on)** .
...
### <a name="configure-appdynamics-single-sign-on"></a>AppDynamics tek Sign-On yapılandırma
...
Erişim panelinde AppDynamics kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız AppDynamics 'te otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
