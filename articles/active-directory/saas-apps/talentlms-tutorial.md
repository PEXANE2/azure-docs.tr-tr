...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[TalentLMS çoklu oturum açmayı yapılandırın](#configure-talentlms-single-sign-on)** .
...
### <a name="configure-talentlms-single-sign-on"></a>TalentLMS tek Sign-On yapılandırma
...
Erişim panelinde TalentLMS kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız TalentLMS 'de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
