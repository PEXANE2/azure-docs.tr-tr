...
## <a name="configure-and-test-azure-ad-single-sign-on-for-bic-cloud-design"></a>BIC bulut tasarımı için Azure AD çoklu oturum açmayı yapılandırma ve test etme
...
Azure AD SSO 'yu BIC bulut tasarımıyla yapılandırmak ve test etmek için aşağıdaki yapı taşlarını doldurun:
...
1. [Azure Portal](https://portal.azure.com/), **Bic bulut tasarımı** uygulama tümleştirmesi sayfasında, **Yönet** bölümünü bulun ve **Çoklu oturum açma**' yı seçin.
...
**Bic bulut tasarım** tarafında çoklu oturum açmayı yapılandırmak Için, **uygulama Federasyon meta verileri URL 'Sini** [Bic bulut tasarım desteği ekibine](mailto:bicsupport@gbtec.de)göndermeniz gerekir. Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.

### <a name="create-bic-cloud-design-test-user"></a>BIC bulut tasarım testi kullanıcısı oluşturma

Bu bölümde BIC bulut tasarımında B. Simon adlı bir Kullanıcı oluşturacaksınız. Bic bulut tasarım platformunda kullanıcıları eklemek için [Bic bulut tasarım destek ekibi](mailto:bicsupport@gbtec.de) ile çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.

## <a name="test-sso"></a>Test SSO 'SU

Bu bölümde, erişim panelini kullanarak Azure AD çoklu oturum açma yapılandırmanızı test edin.

Erişim panelinde BIC bulutu tasarım kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız BIC bulut tasarımında otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Azure AD ile BIC bulut tasarımını deneyin](https://aad.portal.azure.com/)