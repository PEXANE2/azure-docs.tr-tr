...
1. Microsoft Access panel ' i kullanabilirsiniz. Erişim panelinde AppSec Flow SSO kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız AppSec Flow SSO 'SU için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
