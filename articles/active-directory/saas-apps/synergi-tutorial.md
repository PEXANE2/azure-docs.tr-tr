...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Synergi çoklu oturum açmayı yapılandırın](#configure-synergi-single-sign-on)** .
...
### <a name="configure-synergi-single-sign-on"></a>Synergi tek Sign-On yapılandırma
...
Erişim panelinde Synergi kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Synergi 'de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
