...
Erişim panelinde EAB 'ye git ' i tıklattığınızda, SSO 'yu ayarladığınız EAB 'nin stratejik bakım bölümüne otomatik olarak oturum açmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
