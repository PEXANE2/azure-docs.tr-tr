...
Erişim panelinde ProMaster (by ınlogik) kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız ProMaster (ınlogik tarafından) otomatik olarak oturum açmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
...
- [Gelişmiş görünürlük ve denetimlerle ProMaster 'ı koruma (ınlogik tarafından)](/cloud-app-security/proxy-intro-aad)