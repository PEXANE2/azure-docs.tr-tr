...
2. **[Çalışma yıldızlı çoklu oturum açmayı yapılandırma](#configure-workstars-single-sign-on)** uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
...
### <a name="configure-workstars-single-sign-on"></a>Çalışma yıldızlarını çoklu oturum açmayı Yapılandır
...
Erişim panelinde çalışma yıldızlarını tıklattığınızda, SSO 'yu ayarladığınız Iş yıldızları için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
