...
2. **[Dossıer çoklu oturum açmayı yapılandırma](#configure-dossier-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
4. **SAML Ile tek Sign-On ayarlama** sayfasında, **SAML imzalama sertifikası** bölümünde, **uygulama Federasyon meta verileri URL 'sini** gereksiniminize göre belirtilen seçeneklerden kopyalamak ve bilgisayarınıza kaydetmek için Kopyala düğmesine tıklayın.
...
### <a name="configure-dossier-single-sign-on"></a>Dossıer tek Sign-On yapılandırma
...
Erişim panelinde Dossıer kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Dossıer 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
