...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[Acacble çoklu oturum açmayı yapılandırın](#configure-accredible-single-sign-on)** .
...
### <a name="configure-accredible-single-sign-on"></a>Acacble tek Sign-On yapılandırma
...
Erişim panelinde erişilebilir Kutucuğa tıkladığınızda, SSO 'yu ayarladığınız Acacble 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
