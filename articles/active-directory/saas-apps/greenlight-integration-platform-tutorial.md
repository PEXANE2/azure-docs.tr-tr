...
1. **Temel SAML yapılandırması** bölümünde, **IDP** tarafından başlatılan modda uygulamayı yapılandırmak istiyorsanız aşağıdaki alanlar için değerleri girin:
    ...
    b. **Yanıt URL 'si** metin kutusuna şu kalıbı kullanarak bir URL yazın: `https://<CUSTOMER>.greenlightcorp.com/ebcprtads/checkLoginSAML.do`
...
- [Gelişmiş görünürlük ve denetimlerle, klight tümleştirme platformunu koruma](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)