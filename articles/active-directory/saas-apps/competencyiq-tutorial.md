...
2. Bir uygulama tarafında tek Sign-On ayarlarını yapılandırmak için, uzmanlığı **[Encyiq çoklu oturum açmayı yapılandırın](#configure-competencyiq-single-sign-on)** .
...
### <a name="configure-competencyiq-single-sign-on"></a>Uzmanlığı Encyiq tek Sign-On yapılandırma
...
Erişim panelinde, uzmanlığı Encyiq kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız yara için otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
