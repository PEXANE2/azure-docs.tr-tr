...
2. Uygulama tarafında tek Sign-On ayarlarını yapılandırmak için **[BitaBIZ çoklu oturum açmayı yapılandırın](#configure-bitabiz-single-sign-on)** .
...
### <a name="configure-bitabiz-single-sign-on"></a>BitaBIZ tek Sign-On yapılandırma
...
4. **Microsoft Azure AD (çoklu oturum açmayı etkinleştir)** bölümüne gidin ve aşağıdaki adımları gerçekleştirin:
    ...
    b. **Azure AD tek Sign-On hizmeti URL 'si** metin kutusunda, Azure Portal kopyaladığınız **oturum açma URL 'sini** yapıştırın.
...
Erişim panelinde BitaBIZ kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Bıtabiz 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
