---
title: 'Öğretici: Apptio ile tümleştirme Azure Active Directory | Microsoft Docs'
...
2. Uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için **[Apptio SSO 'Yu yapılandırın](#configure-apptio-sso)** .
...
6. **Apptio 'Yi ayarla** bölümünde, gereksiniminize göre uygun URL 'leri kopyalayın.
