...
Erişim panelinde Pendo kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız Pendo 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
...
- [Gelişmiş görünürlük ve denetimlerle Pendo 'ı koruma](/cloud-app-security/proxy-intro-aad)