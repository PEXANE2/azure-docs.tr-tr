...
| Logo | Çoklu oturum açma için uygulama öğreticisi | Kullanıcı hazırlama için uygulama öğreticisi |
| :--- | :--- | :--- |
| ![Logo-Amazon Web Services (AWS) konsolu](./media/tutorial-list/active-directory-saas-amazon-web-service-tutorial.png)| [Amazon Web Services (AWS) konsolu](amazon-web-service-tutorial.md)| [Amazon Web Services (AWS) konsolu-rol sağlama](amazon-web-service-tutorial.md#configure-azure-ad-sso) |
...
| ![Logo-Google Cloud Platform](./media/tutorial-list/active-directory-saas-google-apps-tutorial.png)| [Google Cloud Platform](google-apps-tutorial.md)| [Google Cloud Platform-Kullanıcı sağlama](g-suite-provisioning-tutorial.md) |
...
| ![Logo-Adobe Identity Management](./media/tutorial-list/active-directory-saas-adobe-identity-management-tutorial.png)| [Adobe Kimlik Yönetimi](adobe-identity-management-tutorial.md)|
| ![Logo-aha!](./media/tutorial-list/active-directory-saas-aha-tutorial.png)| [Aha!](aha-tutorial.md)|
| ![Logo-Alerla](./media/tutorial-list/active-directory-saas-alertops-tutorial.png)| [AlertOps](alertops-tutorial.md)|
...
| ![Logo-AWS tek Sign-On](./media/tutorial-list/active-directory-saas-aws-single-sign-on-tutorial.png)| [AWS çoklu oturum açma](aws-single-sign-on-tutorial.md)|
...
| ![Logo-Expenseın](./media/tutorial-list/active-directory-saas-expensein-tutorial.png)| [ExpenseIn](expensein-tutorial.md)|
| ![Logo-Ezofficeenvanteri](./media/tutorial-list/active-directory-saas-ezofficeinventory-tutorial.png)| [EZOfficeInventory](ezofficeinventory-tutorial.md)|
| ![Logo-kadee](./media/tutorial-list/active-directory-saas-foodee-tutorial.png)| [Foodee](foodee-tutorial.md)|
| ![Logo-Freedcamp](./media/tutorial-list/active-directory-saas-freedcamp-tutorial.png)| [Freedcamp](freedcamp-tutorial.md)|
| ![Logo-diğer hizmet](./media/tutorial-list/active-directory-saas-freshservice-tutorial.png)| [Freshservice](freshservice-tutorial.md)|
| ![Logo-ın](./media/tutorial-list/active-directory-saas-harness-tutorial.png)| [Harness](harness-tutorial.md)|
...
| ![Logo-Kendsıs-Azure AD tümleştirmesi](./media/tutorial-list/active-directory-saas-kendis-azure-ad-integration.png)| [Kendsıs-Azure AD tümleştirmesi](kendis-scaling-agile-platform-tutorial.md)|
...
| ![Logo-çevre 81](./media/tutorial-list/active-directory-saas-perimeter-81-tutorial.png)| [Perimeter 81](perimeter-81-tutorial.md)|
...
| ![Logo-Terrayform bulutu](./media/tutorial-list/active-directory-saas-terraform-cloud-tutorial.png)| [Terraform Cloud](terraform-cloud-tutorial.md)|
...
| ![Logo-Yodestesi](./media/tutorial-list/active-directory-saas-yodeck-tutorial.png)| [Yodeck](yodeck-tutorial.md)|  
| ![Logo-Zendesk](./media/tutorial-list/active-directory-saas-zendesk-tutorial.png)| [Zendesk](zendesk-tutorial.md)|  
| ![Logo-Yakınlaştır](./media/tutorial-list/active-directory-saas-zoom-tutorial.png)| [Zoom](zoom-tutorial.md)|
...
| ![Logo-Zscaler özel erişimi (ZPA)](./media/tutorial-list/active-directory-saas-zscalerprivateaccess-tutorial.png)| [Zscaler Private Access (ZPA)](zscalerprivateaccess-tutorial.md)|  
| ![Logo-Zscaler üç](./media/tutorial-list/active-directory-saas-zscaler-three-tutorial.png)| [Zscaler Three](zscaler-three-tutorial.md)|
| ![Logo-Zscaler Iki](./media/tutorial-list/active-directory-saas-zscaler-two-tutorial.png)| [Zscaler Two](zscaler-two-tutorial.md)|  
| ![Logo-Zscaler Zscyüksek](./media/tutorial-list/active-directory-saas-zscaler-zscloud-tutorial.png)| [Zscaler ZSCloud](zscaler-zscloud-tutorial.md)|
