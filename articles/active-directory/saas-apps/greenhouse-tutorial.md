...
>[!NOTE]
>AAD Kullanıcı hesaplarını sağlamak için, tüm diğer bir doğa şirket Kullanıcı hesabı oluşturma araçlarını veya çıplak şirket tarafından sunulan API 'Leri kullanabilirsiniz. 
