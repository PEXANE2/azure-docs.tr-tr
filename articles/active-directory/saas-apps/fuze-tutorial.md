...
2. **[Belirsizlik çoklu oturum açmayı yapılandırma](#configure-fuze-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
### <a name="configure-fuze-single-sign-on"></a>Belirsizlik tek Sign-On yapılandırma
...
Erişim panelinde belirsizlik kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız belirsizlik ' de otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
