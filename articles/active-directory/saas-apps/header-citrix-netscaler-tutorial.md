---
title: 'Öğretici: Citrix NetScaler ile çoklu oturum açma (SSO) Tümleştirmesi Azure Active Directory (üst bilgi tabanlı kimlik doğrulaması) | Microsoft Docs'
...
ms.locfileid: "75472166"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-citrix-netscaler-header-based-authentication"></a>Öğretici: Citrix NetScaler ile çoklu oturum açma (SSO) Tümleştirmesi Azure Active Directory (üst bilgi tabanlı kimlik doğrulaması)
...
- [Üst bilgi tabanlı kimlik doğrulaması için Citrix NetScaler çoklu oturum açmayı yapılandırma](#configure-citrix-netscaler-single-sign-on-for-header-based-authentication)
...
1. Citrix NetScaler uygulaması, SAML belirteci öznitelikleri yapılandırmanıza özel öznitelik eşlemeleri eklemenizi gerektiren belirli bir biçimde SAML onayları bekliyor. Aşağıdaki ekran görüntüsünde varsayılan özniteliklerin listesi gösterilmektedir. **Düzenle** simgesine tıklayın ve öznitelik eşlemesini değiştirin.

    ![image](common/edit-attribute.png)

1. Ayrıca, Citrix NetScaler uygulaması, daha fazla özniteliğin SAML yanıtına geri geçirilmesini bekler. Kullanıcı öznitelikleri iletişim kutusundaki Kullanıcı talepleri bölümünde aşağıdaki tabloda gösterildiği gibi SAML belirteci özniteliği eklemek için aşağıdaki adımları gerçekleştirin:
...
1. Sanal bir **sunucu**oluşturun.
    ...
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/web01.png)
...
1. Load Balancer yapılandırmak için aşağıdaki adımları uygulayın:
    ...
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/load01.png)
...
![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/bind01.png)

![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/bind02.png)
...
![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/bind03.png)

![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/bind04.png)
...
2. **Ekle** ' ye tıklayın ve ardından ayrıntıları belirtin.
    ...
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/policy01.png)
...
1. Aşağıdaki adımları uygulayın:
    ...
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/server01.png)
...
2.  **Ekle** ' ye tıklayın ve aşağıdaki adımları gerçekleştirin:
    ...
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/server02.png)
...
1.  **Gelişmiş kimlik doğrulama Ilkeleri**
    ...
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/virtual01.png)

    a. Daha önce oluşturduğunuz **kimlik doğrulama ilkesini** seçin.

    b. **Bağla**' ya tıklayın.

      ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/virtual02.png)

2. **Form tabanlı sanal sunucular**

    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/virtual03.png)
    ...
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/virtual04.png)
...
3. Değişiklikleri doğrulayın. Uygulama URL 'sine gidin. Daha önce kimliği doğrulanmamış erişim yerine kiracı oturum açma sayfanızı görmeniz gerekir.
    ...
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/virtual05.png)

## <a name="configure-citrix-netscaler-single-sign-on-for-header-based-authentication"></a>Üst bilgi tabanlı kimlik doğrulaması için Citrix NetScaler çoklu oturum açmayı yapılandırma

### <a name="citrix-adc-configuration"></a>Citrix ADC yapılandırması

### <a name="create-an-rewrite-action"></a>Yeniden yazma eylemi oluştur

1. **Appexpert > > yeniden yazma eylemlerini yeniden yazın**.
 
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header01.png)

2.  **Ekle**'ye tıklayın.

    a.  **Ad**belirtin.

    b.  Tür = **INSERT_HTTP_HEADER**.

    c.  **Üst BILGI adını** belirtin (Bu örnekte, secretıd).

    d.  Aaa ifadesini belirtin **. Kullanıcısını. ÖZNITELIĞI (`mySecretID`)** ; burada **Mysecretıd** , Citrix ADC 'ye GÖNDERILEN Azure AD SAML talebinde bulunur.

    e.  **Oluştur**'a tıklayın.

    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header02.png)
 
### <a name="create-a-rewrite-policy"></a>Yeniden yazma Ilkesi oluşturun.

1.  **Appexpert > > yeniden yazma ilkeleri**' ne gidin.
 
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header03.png)

2.  **Ekle**'ye tıklayın.

    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header04.png)

    a.  **Adı**belirtin.

    b.  Daha önce oluşturulan **eylemi** seçin.

    ,. İfade **true değerini**belirtir.

    d.  **Oluştur**' a tıklayın.

### <a name="bind-rewrite-policy-to-virtual-servers"></a>Yeniden yazma Ilkesini sanal sunuculara bağlama

1. Bir yeniden yazma ilkesini GUI kullanarak belirli bir sanal sunucuya bağlamak için.

2. **Sanal sunucular > yük dengeleme > trafik yönetimi**' ne gidin.

3. Sanal sunucuların Ayrıntılar bölmesinde listesinde, yeniden yazma ilkesini bağlamak istediğiniz **sanal sunucuyu** seçin ve ardından **Aç**' a tıklayın.

4. Sanal sunucuyu Yapılandır (Yük Dengeleme) iletişim kutusunda **ilkeler** sekmesini seçin. NetScaler üzerinde yapılandırılan tüm ilkeler listede görüntülenir.
 
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header05.png)

    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header06.png)

5.  Bu sanal sunucuya bağlamak istediğiniz ilkenin adının yanındaki **onay kutusunu** işaretleyin.

    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header07.png)

    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header08.png)
 
6.  **Tamam**’a tıklayın. Durum çubuğunda, Ilkenin başarıyla yapılandırıldığını belirten bir ileti görüntülenir.

### <a name="modify-saml-server-to-extract-attributes-from-claim"></a>Talepten öznitelikleri ayıklamak için SAML sunucusunu değiştirin

1.  **Güvenlik > aaa-uygulama trafiği > ilkelerine > kimlik doğrulaması > gelişmiş ilkeler > eylemler > sunucular**' a gidin.

2.  Uygulama için uygun **kimlik doğrulama SAML sunucusunu** seçin.
 
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header09.png)

3. Öznitelik bölümü altında, "," kullanarak ayıklamak istediğiniz SAML özniteliklerini yazın. Bu durumda **Mysecretıd**adlı özniteliği belirttik.
 
    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header10.png)

4. Uygulamalara erişmesinin doğrulanması.

    ![Citrix NetScaler yapılandırması](./media/header-citrix-netscaler-tutorial/header11.png)
