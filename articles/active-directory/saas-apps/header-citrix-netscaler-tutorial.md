...
1.  **Güvenlik** > **aaa-uygulama trafiği** > **Ilkelerine** > **kimlik doğrulaması** > **Gelişmiş İlkeler** > **Eylemler** > **sunucular**' a gidin.
...
1. **Özniteliklerde** sorun, AYıKLAMAK istediğiniz SAML özniteliklerini virgülle ayırarak girin. Örneğimizde, `mySecretID`özniteliği giriyoruz.
