---
title: 'Öğretici: yalnızca Visiile çoklu oturum açma (SSO) Tümleştirmesi Azure Active Directory Microsoft Docs'
description: Azure Active Directory ve bir arada çoklu oturum açmayı nasıl yapılandıracağınızı öğrenin.
...
Bu öğreticide, Azure Active Directory (Azure AD) ile Görünürlübir şekilde tümleştirmeyi öğreneceksiniz. Azure AD ile Görünürlübir şekilde tümleştirdiğinizde şunları yapabilirsiniz:

* Azure AD 'de, Görünürlübir biçimde erişimi olan denetim.
...
* Daha açık çoklu oturum açma (SSO) aboneliği etkin.

## <a name="scenario-description"></a>Senaryo açıklaması

Bu öğreticide, Azure AD SSO 'yu bir test ortamında yapılandırıp test edersiniz.

* **SP** tarafından başlatılan SSO 'yu bir daha destekler

* Görünürlüksiz 'yı yapılandırdıktan sonra, kuruluşunuzun hassas verilerinin gerçek zamanlı olarak ayıklanmasını ve geri alımını koruyan oturum denetimini zorunlu kılabilirsiniz. Oturum denetimi koşullu erişimden genişletiliyor. [Microsoft Cloud App Security ile oturum denetimini nasıl zorlayacağınızı öğrenin](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).

## <a name="adding-visibly-from-the-gallery"></a>Galeri 'den görünmez ekleme

Azure AD 'de Görünürlübir şekilde tümleştirmeyi yapılandırmak için, Galeri 'den yönetilen SaaS uygulamaları listenize bir Görünürlüfide eklemeniz gerekir.
...
1. Uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için, **[VISISSO 'Yu yapılandırın](#configure-visibly-sso)** .
    1. Kullanıcının Azure AD gösterimi ile bağlantılı olarak, büyük bir olasılıkla B. Simon 'a sahip olmak için, **[görünürlükli test kullanıcısı oluşturun](#create-visibly-test-user)** .
...
1. **Temel SAML yapılandırması** bölümünde, aşağıdaki alanlar için değerleri girin:
    ...
    a. **Oturum açma URL** 'si metin kutusuna URL 'yi yazın:`https://app.visibly.io/`

    b. **Yanıt URL** 'si metin kutusuna URL 'yi yazın:`https://api.visibly.io/api/v1/verifyResponse`


1. Büyük bir uygulama, SAML belirteci öznitelikleri yapılandırmanıza özel öznitelik eşlemeleri eklemenizi gerektiren belirli bir biçimde SAML onayları bekler. Aşağıdaki ekran görüntüsünde varsayılan özniteliklerin listesi gösterilmektedir.
...
1. **Görünürlüğe göre ayarla** bölümünde, gereksiniminize göre uygun URL 'leri kopyalayın.
...
## <a name="configure-visibly-sso"></a>Yalnızca Visisso yapılandırma

1. Kimlik bilgilerinizi kullanarak Görünürlübir şekilde oturum açın.
...
### <a name="create-visibly-test-user"></a>Büyük bir test kullanıcısı oluşturun

Bu bölümde, B. Simon adlı bir Kullanıcı, Görünürlübir şekilde oluşturulur. , Varsayılan olarak etkinleştirilen tam zamanında Kullanıcı sağlamayı da destekler. Bu bölümde sizin için herhangi bir eylem öğesi yok. Bir kullanıcı zaten görünmez bir şekilde yoksa, kimlik doğrulamasından sonra yeni bir tane oluşturulur.

## <a name="test-sso"></a>Test SSO 'SU 

Bu bölümde, erişim panelini kullanarak Azure AD çoklu oturum açma yapılandırmanızı test edersiniz.

Erişim panelinde görünmez Kutucuğa tıkladığınızda, SSO 'yu ayarladığınız Görünürlüğde otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Azure AD ile Görünürlübir şekilde çalışın](https://aad.portal.azure.com/)
