...
5. **Yönetici Ekle** sayfasında, aşağıdaki adımları uygulayın:
    ...
    a. Kullanıcı **adı** metin kutusuna, gibi BrittaSimon@contoso.comkullanıcının e-postasını girin.
    ...
    e. **E-posta** metin kutusuna, gibi BrittaSimon@contoso.comkullanıcının e-postasını girin.

    f. **Telefon** metin kutusuna telefon numarasını yazın.

    g. **Saat dilimi** metin kutusunda, saat dilimini seçin.
