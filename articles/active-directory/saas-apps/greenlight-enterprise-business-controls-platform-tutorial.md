...
Erişim panelinde, doğa açık kurumsal Iş denetimleri platformu kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız doğa kurumsal Iş denetimleri platformunda otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
...
- [Gelişmiş görünürlük ve denetimlerle, klight kurumsal Iş denetimleri platformunu koruma](/cloud-app-security/proxy-intro-aad)