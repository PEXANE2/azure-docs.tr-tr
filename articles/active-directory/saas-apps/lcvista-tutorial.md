...
2. **[LCVista çoklu oturum açmayı yapılandırma](#configure-lcvista-single-sign-on)** -uygulama tarafında tek Sign-On ayarlarını yapılandırmak için.
...
### <a name="configure-lcvista-single-sign-on"></a>LCVista tek Sign-On yapılandırma
...
2. **SAML yapılandırması** bölümünde **SAML oturum açmayı etkinleştir** ' i işaretleyin ve aşağıdaki görüntüde bahsedilen ayrıntıları girin. 
    ...
    ![Tek Sign-On yapılandırma](./media/lcvista-tutorial/tutorial_lcvista_config.png)
...
Erişim panelinde LCVista kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız LCVista 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
