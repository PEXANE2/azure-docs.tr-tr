...
**Kampüs** yüz tarafında çoklu oturum açmayı yapılandırmak için, Indirilen **Federasyon meta veri XML** 'sini ve Azure Portal ' den uygun kopyalanmış URL 'Leri [kampüs Café destek ekibine](mailto:support@campuscafesoftware.com)göndermeniz gerekir. Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.

### <a name="create-campus-cafe-test-user"></a>Kampüs Cafe test kullanıcısı oluşturma

Bu bölümde, kampüs Café içinde B. Simon adlı bir Kullanıcı oluşturacaksınız. Kampüs Café platformunda kullanıcıları eklemek için [kampüs destek ekibi](mailto:support@campuscafesoftware.com) ile çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.

## <a name="test-sso"></a>Test SSO 'SU 

Bu bölümde, erişim panelini kullanarak Azure AD çoklu oturum açma yapılandırmanızı test edin.

Erişim panelinde kampüs Café kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız kampüs Café ' de otomatik olarak oturum açmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
