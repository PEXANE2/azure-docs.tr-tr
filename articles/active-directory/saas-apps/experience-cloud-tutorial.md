...
**Deneyim bulut** tarafında çoklu oturum açma 'yı yapılandırmak için, Indirilen **Federasyon meta verileri XML** 'sini ve Azure Portal ' den uygun kopyalanmış URL 'leri [bulut desteği ekibine](mailto:support@medallia.com)göndermeniz gerekir. Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.

### <a name="create-experience-cloud-test-user"></a>Deneyim bulutu test kullanıcısı oluşturma

Bu bölümde, deneyim bulutu 'nda B. Simon adlı bir Kullanıcı oluşturacaksınız. Deneyim bulut platformunda kullanıcıları eklemek için [deneyim bulutu destek ekibi](mailto:support@medallia.com) ile çalışın. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi.
