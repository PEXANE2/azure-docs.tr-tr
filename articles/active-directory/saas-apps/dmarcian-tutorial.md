...
2. **[Dmarcıa SSO](#configure-dmarcian-sso)** 'yu, uygulama tarafında tek Sign-On ayarlarını yapılandırmak için yapılandırın.
...
5. Uygulamayı **SP** tarafından başlatılan modda yapılandırmak Istiyorsanız **ek URL 'ler ayarla** ' ya tıklayın ve aşağıdaki adımı gerçekleştirin:
    ...
    **Oturum açma URL 'si** metin kutusunda, aşağıdaki kalıbı kullanarak bir URL yazın:
    ...
    > [!NOTE] 
    > Bu değerler gerçek değildir. Bu değerleri, öğreticide daha sonra açıklanan gerçek tanımlayıcı, yanıt URL 'si ve Sign-On URL 'SI ile güncelleşceksiniz.
...
Erişim panelinde dmarcia kutucuğuna tıkladığınızda, SSO 'yu ayarladığınız dmarcıa 'da otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
