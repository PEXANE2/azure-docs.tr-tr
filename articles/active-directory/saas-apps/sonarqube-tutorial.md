...
3. Microsoft Access panel ' i kullanabilirsiniz. Erişim panelinde Sonarque kutucuğunu tıklattığınızda, bu, sonarquin oturum açma URL 'sine yeniden yönlendirilir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
