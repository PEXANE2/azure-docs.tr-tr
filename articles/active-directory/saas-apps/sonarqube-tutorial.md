...
## <a name="configure-and-test-azure-ad-single-sign-on-for-sonarqube"></a>Sonarqum için Azure AD çoklu oturum açmayı yapılandırma ve test etme
...
Azure AD SSO 'yu Sonarqum ile yapılandırmak ve test etmek için aşağıdaki yapı taşlarını doldurun:
...
1. [Azure Portal](https://portal.azure.com/), **sonarquin** uygulama tümleştirmesi sayfasında, **Yönet** bölümünü bulun ve **Çoklu oturum açma**' yı seçin.
...
Erişim panelinde Sonarque kutucuğunu tıklattığınızda, SSO 'yu ayarladığınız Sonarqude otomatik olarak oturum açmış olmanız gerekir. Erişim paneli hakkında daha fazla bilgi için bkz. [erişim paneline giriş](../user-help/my-apps-portal-end-user-access.md).
...
- [Azure AD ile Sonarqup 'yi deneyin](https://aad.portal.azure.com/)