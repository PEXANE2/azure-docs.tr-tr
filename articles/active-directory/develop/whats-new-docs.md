...
- [Öğretici: kullanıcılarda oturum açın ve Android uygulamasından Microsoft Graph API 'sini çağırın](tutorial-v2-android.md)
- [Web API 'Leri çağıran bir Web uygulaması: kod yapılandırması](scenario-web-app-call-api-app-configuration.md)
- [Web API 'Leri çağıran bir Web uygulaması: Web API 'SI çağırma](scenario-web-app-call-api-call-api.md)
...
- [İOS veya macOS uygulamasından Kullanıcı oturum açma ve Microsoft Graph çağırma](tutorial-v2-ios.md)
- [Hızlı başlangıç: Microsoft Identity platform tarafından korunan bir ASP.NET Web API 'SI çağırma](quickstart-v2-dotnet-native-aspnet.md)
- [Hızlı başlangıç: Microsoft 'a ASP.NET Core Web uygulamasına oturum açma ekleme](quickstart-v2-aspnet-core-webapp.md)
- [MSAL.NET ile Xamarin iOS kullanma konuları](msal-net-xamarin-ios-considerations.md)
