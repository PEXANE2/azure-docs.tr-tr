...
- [Yayımcı doğrulaması ile ilgili sorunları giderme](troubleshoot-publisher-verification.md)
- [Uygulama modeli](application-model.md)
- [Kimlik Doğrulaması ve yetkilendirme](authentication-vs-authorization.md)
- [Nasıl yapılır: Azure AD kiracısındaki bir Kullanıcı kümesiyle Azure AD uygulamanızı kısıtlama](howto-restrict-your-app-to-a-set-of-users.md)
- [Microsoft kimlik platformu uç noktasında izinler ve onay](v2-permissions-and-consent.md)
