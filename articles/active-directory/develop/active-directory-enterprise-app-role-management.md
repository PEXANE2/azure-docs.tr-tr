...
6. [Azure AD Graph Explorer 'ı](https://developer.microsoft.com/graph/graph-explorer) başka bir pencerede açın ve aşağıdaki adımları uygulayın:
...
1. [Azure AD Graph Explorer 'ı](https://developer.microsoft.com/graph/graph-explorer)açın.
...
1. [Azure AD Graph Explorer 'ı](https://developer.microsoft.com/graph/graph-explorer) başka bir pencerede açın.
