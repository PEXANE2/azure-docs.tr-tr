...
1. Uygulamanızın yukarıdaki kodu kullandığını doğruladıktan sonra, **Web. config** dosyasını açın ve özellikle aşağıdaki birkaç satırı arayan **\<ıssuernameregstreams >** bloğuna gidin:
   ```
