---
title: Android 'de Microsoft Graph API 'yi çağırmak & Kullanıcı oturum açma (v 1.0) | Mavisi
...
ms.locfileid: "74966070"
---
# <a name="quickstart-sign-in-users-and-call-the-microsoft-graph-api-from-an-android-app-v10"></a>Hızlı başlangıç: kullanıcılar oturum açın ve Android uygulamasından (v 1.0) Microsoft Graph API 'sini çağırın
...
Yeni Android uygulamaları için Microsoft Identity platform (v 2.0) ve MSAL kullanarak belirteçleri edinmeniz ve güvenli Web API 'Lerine erişmeniz önerilir. Başlamak için bkz. [hızlı başlangıç: kullanıcıları oturum açma ve Android uygulamasından MICROSOFT Graph API 'yi çağırma](quickstart-v2-android.md) .
