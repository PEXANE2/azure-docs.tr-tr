---
title: Bir Web API 'SI çağırmak için belirteç alma (tek sayfalı uygulamalar) | Mavisi
...
Bu senaryonun [bir Web API 'Sini çağırarak bir](scenario-spa-call-api.md)sonraki makaleye geçin.