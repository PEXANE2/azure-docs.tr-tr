...
| `assertion` | Gerekli | İstekte kullanılan belirtecin değeri.  Bu belirteç, bu OBO isteğini (`client-id` alanı tarafından belirtilen uygulama) yapan uygulamanın hedef kitlesi olmalıdır. |
