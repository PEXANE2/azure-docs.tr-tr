...
Bu duruma kadar çoğu geliştirici, Azure AD v 1.0 uç noktasından belirteçler isteyerek Azure AD kimlik doğrulama kitaplığı (ADAL), uygulama kaydı ve yapılandırması için Azure portal ve programlı uygulama yapılandırması için Microsoft Graph API 'SI aracılığıyla Azure AD v 1.0 platformu ile çalıştık.
