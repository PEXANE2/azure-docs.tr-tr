...
Yeni .NET Daemon uygulamaları için Microsoft Identity platform (v 2.0) ve MSAL kullanarak belirteçleri edinmeniz ve güvenli Web API 'Lerine erişmeniz önerilir: [hızlı başlangıç: bir belirteç alın ve uygulamanın kimliğini kullanarak bir konsol uygulamasından Microsoft Graph API 'si çağırın](quickstart-v2-netcore-daemon.md).
