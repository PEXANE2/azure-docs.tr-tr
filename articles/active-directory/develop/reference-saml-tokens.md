...
* Microsoft Graph API 'sini kullanarak belirteç yaşam süresi ilkesini yönetme hakkında daha fazla bilgi için bkz. [ilke kaynağı](/graph/api/resources/policy?view=graph-rest-beta).
