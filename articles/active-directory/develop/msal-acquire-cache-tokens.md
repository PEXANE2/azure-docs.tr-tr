...
Bununla birlikte, sessizce bir belirteç elde etmek zorunda **should not** kalmadan iki akış vardır:
...
- Web Apps 'te, uygulamanın oturum açmasını ve daha fazla kapsam için izin vermesini sağlayan bir kodu önceden kullandığından, [yetkilendirme kodu akışı](msal-authentication-flows.md#authorization-code) . Bir kod bir hesap değil, bir parametre olarak geçirildiğinden, bir hizmet için bir çağrı gerektiren ve bu durumda, bir hizmetin önüne girmeden önce önbellekte arama yapılamaz.
