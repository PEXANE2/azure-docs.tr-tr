...
Aşağıdaki komut, sistem tarafından atanan kimlik etkin bir VM veya uygulamanın hizmet sorumlusunu görüntülemeyi gösterir. Kendi `<VM or application name>` değerlerinizle değiştirin.
