...
- [Azure portalındaki](../../app-service/overview-managed-identity.md#using-the-azure-portal)
...
- [Azure portalındaki](../../logic-apps/create-managed-service-identity.md#enable-system-assigned-identity-in-azure-portal)
