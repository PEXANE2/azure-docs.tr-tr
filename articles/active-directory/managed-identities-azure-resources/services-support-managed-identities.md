...
| Yönetilen kimlik türü | Tüm genel kullanıma açık<br>Küresel Azure bölgeleri | Azure Kamu | Azure Almanya | Azure China 21Vianet |
| --- | :-: | :-: | :-: | :-: |
| Sistem tarafından atanan | ![Kullanılabileceğini][check] | ![Kullanılabileceğini][check] | Kullanılamaz | ![Kullanılabileceğini][check] |
| Kullanıcı tarafından atanan | ![Kullanılabileceğini][check] | ![Kullanılabileceğini][check]  | Kullanılamaz  | ![Kullanılabileceğini][check] |
...
- [Azure portalı](~/articles/digital-twins/how-to-enable-managed-identities.md)
...
| Yönetilen kimlik türü | Tüm genel kullanıma açık<br>Küresel Azure bölgeleri | Azure Kamu | Azure Almanya | Azure China 21Vianet |
| --- | :-: | :-: | :-: | :-: |
| Sistem tarafından atanan | ![Kullanılabileceğini][check] | Kullanılamaz | Kullanılamaz | ![Kullanılabileceğini][check] |
| Kullanıcı tarafından atanan | Kullanılamaz | Kullanılamaz | Kullanılamaz | Kullanılamaz |
...
| Bulut | Kaynak kimliği | Durum |
|--------|------------|:-:|
| Azure genel | `https://<account>.<region>.kusto.windows.net` | ![Kullanılabileceğini][check] |
| Azure Kamu | `https://<account>.<region>.kusto.usgovcloudapi.net` | ![Kullanılabileceğini][check] |
| Azure Almanya | `https://<account>.<region>.kusto.cloudapi.de` | ![Kullanılabileceğini][check] |
| Azure China 21Vianet | `https://<account>.<region>.kusto.chinacloudapi.cn` | ![Kullanılabileceğini][check] |
