...
If you enter data for **Authentication Phone** or **Authentication Email**, it's not visible in the global directory. Bu verileri yalnızca siz ve yöneticileriniz görebilir. Only you can see the answers to your security questions.
...
| Error case| What error do you see?| Çözüm |
| --- | --- | --- |
