...
![Node.js uygulaması çalıştırma](media/tutorial-jenkins-github-docker-cicd/running-nodejs-app.png)
...
![Başka bir GitHub işlemesinden sonra Node.js uygulamasını çalıştırma](media/tutorial-jenkins-github-docker-cicd/another-running-nodejs-app.png)
