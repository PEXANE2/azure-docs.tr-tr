...
description: Azure App Service Yalıtılmış Damga Pulları için rezervasyon indirimlerinin nasıl uygulandığını öğrenin. İndirimler bir bölgede Damga Pulu Ücretine otomatik olarak uygulanır.
author: yashesvi
ms.reviewer: yashar
