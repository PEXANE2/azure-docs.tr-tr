---
title: Azure Kurumsal Anlaşma faturanızı gözden geçirin
...
Bu öğretici yalnızca Azure Kurumsal Anlaşma olan Azure müşterileri için geçerlidir.

Bu öğreticide şunların nasıl yapıldığını öğreneceksiniz:

> [!div class="checklist"]
> * Faturalanmış ücretleri gözden geçirin
> * Hizmet fazla kullanım ücretlerini gözden geçirin
...
## <a name="review-invoiced-charges-for-most-customers"></a>Müşterilerin çoğu için faturalanmış ücretleri gözden geçirin
...
- **Hizmet fazla**kullanım: kuruluşunuzun kullanım ücretleri kredi bakiyenizi aşmaz.
- **Ayrı olarak faturalandırılan ücretler**: kuruluşunuzun kullandığı hizmetler kredi kapsamında değildir. Kredi bakiyeniz ne olursa olsun aşağıdaki hizmetler için faturalandırılırsınız:
    - Canonical
...
- **Market ücretleri**: Azure Market satın alımları ve kullanımı, kuruluşunuzun Kredisi kapsamında değildir. Bu nedenle, kredi bakiyeniz ne olursa olsun Pazar ücretleri için faturalandırılırsınız. Enterprise Portal’da bir Kurumsal Yönetici, Pazar satın alma işlemlerini etkinleştirebilir ve devre dışı bırakabilir.
...
[Azure EA portalında](https://ea.azure.com)oturum açın. Sonra **raporlar**' ı seçin. Sekmenin sağ üst köşesinde**M** görünümünü **C** olarak değiştirin ve fatura dönemine göre ayarlayın.  
...
![Indirme kullanımı sekmesini gösteren ekran görüntüsü](./media/review-enterprise-agreement-bill/ea-portal-download-usage.png)

## <a name="review-invoiced-charges-for-other-customers"></a>Diğer müşteriler için faturalanmış ücretleri gözden geçirin
...
- **Hizmet fazla**kullanım: kuruluşunuzun kullanım ücretleri kredi bakiyenizi aşmaz.
- **Ayrı olarak faturalandırılan ücretler**: kuruluşunuzun kullandığı hizmetler kredi kapsamında değildir. Aşağıdaki hizmetler için faturalandırılırsınız:
    - Canonical
    - Citrix XenApp Essentials
    - Citrix XenDesktop
    - Kayıtlı Kullanıcı
    ...
    - Visual Studio Professional (Aylık)
    - Visual Studio Professional (Yıllık)
- **Market ücretleri**: Azure Market satın alımları ve kullanımı, kuruluşunuzun Kredisi kapsamında değildir ve ayrı olarak faturalandırılır. Enterprise Portal’da bir Kurumsal Yönetici, Pazar satın alma işlemlerini etkinleştirebilir ve devre dışı bırakabilir.
...
## <a name="review-service-overage-charges-for-other-customers"></a>Diğer müşteriler için hizmet fazla kullanım ücretleri gözden geçirme
...
![Indirme kullanımı sekmesinde Gelişmiş rapor Indirmeyi gösteren ekran görüntüsü.](./media/review-enterprise-agreement-bill/ea-portal-download-usage-advanced.png)
...
|Vergi Tutarı|Geçerli değil|Belirli bir dönem için toplam satış tutarına uygulanan vergi.|
|Vergi Tutarı|Geçerli değil|Kredi uygulandıktan ve vergi eklendikten sonra fatura için ödenmesi gereken tutar.|

### <a name="review-marketplace-invoice"></a>Market faturasını gözden geçir
...
Azure EA Portalı 'nı kullanarak daha fazla bilgi edinmek için sonraki makaleye geçin.
