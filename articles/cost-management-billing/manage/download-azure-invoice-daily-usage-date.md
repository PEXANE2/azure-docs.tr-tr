---
title: Azure faturasını ve günlük kullanım verilerini indirme
...
Yalnızca Hesap Yöneticisi veya Kuruluş Yöneticisi gibi belirli rollerin fatura ve kullanım bilgilerini alma izni vardır. Faturalama bilgilerine erişme hakkında daha fazla bilgi için bkz. [Rolleri kullanarak Azure faturalamasına erişimi yönetme](manage-billing-access.md).
...
1. [Faturalara erişim izni olan bir kullanıcı](manage-billing-access.md) olarak Azure portalındaki [Abonelikler sayfasından](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade) aboneliğinizi seçin.

2. **Faturalar** 'ı seçin.

    ![Faturalama ve kullanım seçeneğini gösteren ekran görüntüsü](./media/download-azure-invoice-daily-usage-date/billingandusage.png)
...
3. PDF faturanızın kopyasını indirmek için indirme düğmesine tıklayın ve **Faturayı indir** 'i seçin. **Kullanılamıyor** iletisiyle karşılaşıyorsanız bkz. [Son fatura dönemine ait faturamı neden göremiyorum?](#noinvoice)
    ...
    ![Faturalama dönemini, indirme seçeneğini ve her faturalama dönemi için toplam ücretleri gösteren ekran görüntüsü](./media/download-azure-invoice-daily-usage-date/downloadinvoice.png)
...
Faturalar, Microsoft Müşteri Sözleşmesi’ndeki her [faturalama profili](../understand/mca-overview.md#billing-profiles) için oluşturulur. Faturaları Azure portalından indirmek için faturalama profili Sahibi, Katkıda Bulunanı, Okuyucusu veya Fatura yöneticisi olmanız gerekir.
...
### <a name="why-dont-i-see-an-invoice-for-the-last-billing-period"></a><a name="noinvoice"></a> Son faturalama dönemine ait faturamı neden göremiyorum?
...
1. [Abonelikler sayfasından](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade) aboneliğinizi seçin. Kabul etme işlemini sahip olduğunuz her abonelik için ayrıca gerçekleştirin. **Faturalar** 'a ve **Faturamı e-posta ile gönder** ’e tıklayın.
    ...
    ![Kabul etme akışını gösteren ekran görüntüsü](./media/download-azure-invoice-daily-usage-date/invoicesdeeplink01.png)

2. **Kabul et** ’e tıklayın ve koşulları kabul edin.

    ![Kabul etme akışının 2. adımını gösteren ekran görüntüsü](./media/download-azure-invoice-daily-usage-date/invoicearticlestep02.png)
...
3. Sözleşmeyi kabul ettiğinizde ek alıcıları yapılandırabilirsiniz. Bir alıcı kaldırıldığında artık e-posta adresi depolanmaz. Fikrinizi değiştirirseniz adresi yeniden eklemeniz gerekir.
    ...
    ![Kabul etme akışının 3. adımını gösteren ekran görüntüsü](./media/download-azure-invoice-daily-usage-date/invoicearticlestep03.png)
...
Yukarıdaki adımları izleyip **Faturaların e-posta ile gönderilmesini geri çevir** seçeneğine tıklayarak faturanızı e-postayla almayı geri çevirebilirsiniz. Bu seçenek, faturaların e-posta ile gönderilmesi için girilmiş olan e-posta adreslerini kaldırır. Yeniden e-posta almalarını isterseniz alıcıları yeniden yapılandırabilirsiniz.
 ...
 ![Geri çevirme akışını gösteren ekran görüntüsü](./media/download-azure-invoice-daily-usage-date/invoicearticlestep04.png)
...
1. *Maliyet Yönetimi + Faturalama* araması yapın.
1. Birden çok fatura hesabına erişiminiz varsa EA fatura hesabınız için faturalama kapsamını seçin.
...
- [Microsoft Azure faturanızı anlama](../understand/review-individual-bill.md)
- [Azure faturanızdaki terimleri anlama](../understand/understand-invoice.md)
- [Ayrıntılı Microsoft Azure kullanım bilgilerinizdeki terimleri anlama](../understand/understand-usage.md)
- [Kuruluşunuzun Azure fiyatlandırmasını görüntüleme](ea-pricing.md)
...
- [Faturalama profilinizin faturasındaki terimleri anlama](../understand/mca-understand-your-invoice.md)
- [Faturalama profilinizin Azure kullanımı ve ücretleri dosyasını anlama](../understand/mca-understand-your-usage.md)
