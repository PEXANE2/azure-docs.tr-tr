---
title: Azure hesabınız için profil bilgilerini değiştirme
...
1. **Ayrıntıları düzenle** düğmesini seçip **Profil** bilgilerini güncelleştirin.
   ...
   ![Azure profil bilgileri örneği](./media/change-azure-account-profile/profile.png)
...
Fatura bilgilerinizi nasıl güncelleştirebileceğinizi öğrenmek için bkz. [Azure aboneliği ödemesi için kullanılan kredi kartını değiştirme](change-credit-card.md).
