...
- Cloudyn'deki raporlar hakkında bilgi edinmek için bkz. [Cloudyn raporlarını kullanma](./use-reports.md).
- Raporları kullanarak [pano](./dashboards.md) oluşturmayı öğrenin.