...
**UEFI önyükleme** | Azure'da geçirilen makine otomatik olarak BIOS önyükleme Azure VM'ye dönüştürülür.<br/><br/> İşletim sistemi diskinde en fazla dört bölüm olmalı ve birimler NTFS ile biçimlendirilmelidir.
