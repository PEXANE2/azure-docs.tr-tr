---
title: Azure SQL değerlendirmesi oluşturma
description: Azure SQL yönetilen örneği ve Azure SQL veritabanı 'na geçiş için SQL örneklerini değerlendirme hakkında bilgi edinin
author: rashi-ms
ms.author: rajosh
ms.topic: tutorial
ms.date: 02/07/2021
...
- Azure geçişi projesi [oluşturduğunuzdan](./create-manage-projects.md) ve Azure geçişi: bulma ve değerlendirme aracının eklendiğinden emin olun.
- Bir değerlendirme oluşturmak için, [VMware](how-to-set-up-appliance-vmware.md)Için bir Azure geçiş gereci ayarlamanız gerekir. Gereç, şirket içi sunucuları bulur ve Azure geçişi 'ne meta veri ve performans verileri gönderir. [Daha fazla bilgi edinin](migrate-appliance.md)

## <a name="azure-sql-assessment-overview"></a>Azure SQL değerlendirmesi genel bakış
**Performans tabanlı** olarak boyutlandırma ölçütlerine sahip BIR Azure SQL değerlendirmesi oluşturabilirsiniz. 

**Boyutlandırma ölçütü** | **Ayrıntılar** | **Veriler**
--- | --- | ---
**Performans tabanlı** | Toplanan performans verilerine dayalı değerlendirmeler | Önerilen **Azure SQL yapılandırması** , CPU kullanımı, çekirdek sayısı, veritabanı dosya kuruluşları ve boyutları, dosya IOS, toplu iş sorgusu ve veritabanı başına bellek boyutu ve kullanım dahil olmak üzere SQL örnekleri ve veritabanlarının performans verilerini temel alır.

Azure SQL değerlendirmeleri hakkında [daha fazla bilgi edinin](concepts-azure-sql-assessment-calculation.md) .
