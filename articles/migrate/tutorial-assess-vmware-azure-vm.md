---
title: Azure geçişi 'nde Azure VM 'lerine geçiş için VMware sunucularını değerlendirme
description: Azure geçişi ile Azure VM 'lerine geçiş için VMware sunucularının nasıl değerlendirileyeceğinizi öğrenin.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Bu makalede, Azure geçişi: bulma ve değerlendirme aracı kullanılarak Azure VM 'lerine geçiş hazırlığı sırasında VMware ortamınızdan bulunan sunucuların nasıl değerlendirireceğiniz gösterilmektedir.
