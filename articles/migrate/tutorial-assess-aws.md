---
title: Azure geçişi ile Azure 'a geçiş için AWS örneklerini değerlendirin
description: Azure geçişi ile Azure 'a geçiş için AWS örneklerine erişmeyi öğrenin.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Bu makalede, Azure geçişi: bulma ve değerlendirme aracı kullanılarak Azure 'a geçiş için Amazon Web Services (AWS) örneklerinin nasıl değerlendirireceğiniz gösterilmektedir.
...
- AWS örneklerinin Windows Server 2003 veya SUSE Linux çalıştırmadığından emin olun. Bu sunucular için değerlendirme desteklenmiyor.
