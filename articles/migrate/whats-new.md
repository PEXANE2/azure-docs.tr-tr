...
- Azure geçişi şimdi Kullanılabilirlik Alanları sunuculara geçiş yapmanızı sağlar.
- Azure geçişi artık UEFı tabanlı VM 'Leri ve fiziksel sunucuları Azure 2. nesil VM 'lere geçirmenize olanak sağlar. 
