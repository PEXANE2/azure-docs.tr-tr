---
title: ASP.NET uygulamaları Kapsayılaştırır ve Azure Kubernetes hizmetine geçiş yapın
description: ASP.NET uygulamalarını kapsayılanın ve Azure Kubernetes hizmetine geçirme hakkında bilgi edinin.
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial
