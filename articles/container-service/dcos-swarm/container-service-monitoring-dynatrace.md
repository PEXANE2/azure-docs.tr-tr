...
1. Aracılığıyla DC/OS Kullanıcı arabirimine erişin `http://localhost:80/` . DC/OS kullanıcı arabiriminden bir kez **Universe** sekmesine gidin ve ardından **dynaTrace**için arama yapın.
