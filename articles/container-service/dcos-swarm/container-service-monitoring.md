...
Aracılığıyla `http://localhost:80/`DC/OS Kullanıcı arabirimine erişin. DC/OS Kullanıcı arabiriminde, sol alt kısımdaki "Universe" adresine gidin ve "Dataköpek" araması yapın ve "Install" a tıklayın.
