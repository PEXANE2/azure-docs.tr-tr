...
1. **Universe** adresine gidin ve **vamp**araması yapın. 
   DC/OS Universe 'de vamp ![](./media/container-service-dcos-vamp-canary-release/04_universe_deploy_vamp.png)

2. Vamp paketinin yanındaki **yükleme** ' ye tıklayın ve **Gelişmiş yükleme**' yi seçin.

3. Aşağı kaydırın ve şu elaun aramasını girin-URL: `http://elasticsearch.marathon.mesos:9200`. 
...
4. **Save (Kaydet)** düğmesine tıklayın. Vamp, dağıtımı başlatır.
...
3. **Save (Kaydet)** düğmesine tıklayın. Şema, **planlar** sayfasında depolanır ve listelenir.
...
1. **Ağırlık**' ın yanındaki ![vamp Kullanıcı arabirimi-Düzenle](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) ' ye tıklayın.
...
1. Sava/sava_cluster/WebPort Gateway sayfasında , Route sava/sava_cluster/Sava: 1.0.0/WebPort dizinine bir **koşul** eklemek IÇIN ![vamp UI-Edit](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) ' e tıklayın. 
...
3. Koşula uygulanan **kuvveti** değiştirmek Için ![vamp uı-](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) Düzenle ' ye tıklayın.
 
4. **Kuvvetini** %100 olarak ayarlayın ve ![vamp Kullanıcı arabirimi-kaydetmek için](./media/container-service-dcos-vamp-canary-release/vamp_ui_save.png) ' a tıklayın.
...
5. Son olarak, tüm kalan trafiği (tüm Firefox kullanıcıları) yeni Sava: 1.1.0 göndermek için ağ geçidi ağırlığını ayarlayın. ![vamp Kullanıcı arabirimi ' ne tıklayın, **Ağırlık** ' ın yanındaki](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) düzenleyin ve ağırlık dağılımını ayarlayın. bu nedenle %100, Route sava/sava_cluster/Sava: 1.1.0/WebPort dizinine yönlendirilir.
