...
Bu örnekte, uygulama ortak bir aracı düğümünde çalışmaktadır. Kümenin aracı FQDN 'sine göz atarak, uygulamaya internet 'ten `http://[DNSPREFIX]agents.[REGION].cloudapp.azure.com` ulaşabilirsiniz:
