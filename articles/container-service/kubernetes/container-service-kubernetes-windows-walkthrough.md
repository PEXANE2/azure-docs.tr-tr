...
İstemci bilgisayarınızdan Kubernetes kümesine bağlanmak için [`kubectl`](https://kubernetes.io/docs/user-guide/kubectl/) Kubernetes komut satırı istemcisini kullanın. 
