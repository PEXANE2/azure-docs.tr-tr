...
12. Ayrıca, isterseniz şablondaki diğer parametreleri değiştirebilir ve gereksinimlerinize bağlı olarak isteğe bağlıdır:
    ...
    * **Adres alanı** - **kaynak** > **AddressSpace** bölümü değiştirilerek ve Template. JSON içindeki **addresspredüzeltmeözelliği** değiştirilerek kaydedilmeden önce VNET 'in adres alanı değiştirilebilir **.** dosya:
    ...
    * **Alt ağ** -alt ağ adı ve alt ağ adres alanı, **Template. JSON** dosyasının **alt ağlar** bölümü değiştirilerek değiştirilebilir veya öğesine eklenebilir. Alt ağın adı, **Template. JSON** dosyasındaki **Name** özelliği değiştirilerek değiştirilebilir.  Alt ağ adres alanı, **Template. JSON** dosyasındaki **addresspredüzeltmesini** özelliğini değiştirerek değiştirilebilir:
