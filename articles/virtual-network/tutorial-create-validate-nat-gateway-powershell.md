...
```
**Myresourcegroupnat**içinde [New-Azvm]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) ile **MYVMSOURCE** adlı bir VM oluşturmak için yapılandırma tanımlarını birleştirin.
...
```
**Myresourcegroupnat**içinde [New-Azvm]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) ile **MYVMDESTINATION** adlı bir VM oluşturmak için yapılandırma tanımlarını birleştirin.
