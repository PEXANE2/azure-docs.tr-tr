---
title: IPv6 çift yığın uygulamasını dağıt - Temel Yük Dengeleyici - CLI
...
Bu bölümde, çift ön uç IP (IPv4 ve IPv6) ve yük dengeleyicisi için arka uç adresi havuzunu yapılandırıp bir Temel Yük Dengeleyicisi oluşturursunuz.

### <a name="create-load-balancer"></a>Yük dengeleyici oluşturma

Az ağ lb ile Temel Yük Dengeleyici sn dsLbFrontEnd_v4 **adlı**bir ön uç havuzu , bir önceki adımda oluşturduğunuz iPv4 genel IP adresi **dsPublicIP_v4** ile ilişkili **dsLbBackEndPool_v4** adlı bir arka uç havuzu içeren **dsLB** adlı [oluşturun.](https://docs.microsoft.com/cli/azure/network/lb?view=azure-cli-latest) 
