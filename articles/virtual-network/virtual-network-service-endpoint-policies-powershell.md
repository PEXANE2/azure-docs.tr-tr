...
Paylaşıma erişim reddedildi ve bir `New-PSDrive : Access is denied` hatası alıyorsunuz. Erişim reddedildi çünkü depolama hesabı *notallowedaccount* , hizmet uç noktası ilkesindeki izin verilen kaynaklar listesinde değil. 
