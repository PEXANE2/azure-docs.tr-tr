...
Bir değişkende izin verilen depolama hesabı için kaynak URI 'sini kaydedin. Aşağıdaki komutu yürütmeden önce, *-Subscription-ıd >\<* , abonelik kimliğinizin gerçek değeriyle değiştirin.
...
Azure dosya paylaşımından oluşturduğunuz dizine bağlayın. Aşağıdaki komutu yürütmeden önce, *\<Storage-Account-key >* değerini **$saConnectionString 1**' den *accountkey* değeriyle değiştirin.
...
Aşağıdaki komutu yürütmeden önce, *\<Storage-Account-key >* değerini **$saConnectionString 2**' den *accountkey* değeriyle değiştirin.

```bash
sudo mount --types cifs //notallowedstorageacc.file.core.windows.net/my-file-share /mnt/MyAzureFileShare2 --options vers=3.0,username=notallowedstorageacc,password=<storage-account-key>,dir_mode=0777,file_mode=0777,serverino
```

Erişim engellendi ve bir `mount error(13): Permission denied` hatası alıyorsunuz çünkü bu depolama hesabı, alt ağa uyguladığımız hizmet uç noktası ilkesinin izin verilenler listesinde değil. 
