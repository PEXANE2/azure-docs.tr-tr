...
> [!IMPORTANT]
> Azure kaynaklarıyla çalışmadan önce Azure’da şu anda iki dağıtım modeli olduğunu anlamak önemlidir: Azure Resource Manager ve klasik. Azure kaynaklarıyla çalışmadan önce [dağıtım modellerini ve araçlarlarını](../azure-resource-manager/management/deployment-models.md) iyice anladığınızdan emin olun. Bu makalenin üst kısmında bir seçenek belirleyerek farklı araçların belgelerini görüntüleyebilirsiniz. Bu makale, klasik dağıtım modelini kapsamaktadır.
> 
