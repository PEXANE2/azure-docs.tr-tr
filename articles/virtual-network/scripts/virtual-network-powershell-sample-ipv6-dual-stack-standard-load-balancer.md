---
title: Azure PowerShell komut dosyası örneği - IPv6 ön ucunu Standart Yük Dengeleyicisi(önizleme) ile yapılandır
...
---
# <a name="configure-ipv6-frontend-in-virtual-network-script-sample-with-standard-load-balancerpreview"></a>IPv6 ön ucunu sanal ağ komut dosyası örneğinde Standart Yük Dengeleyicisi(önizleme) ile yapılandırın
