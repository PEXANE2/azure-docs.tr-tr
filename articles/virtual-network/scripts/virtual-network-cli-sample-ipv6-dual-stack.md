...
description: IPv6 uç noktalarını yapılandırmak ve Azure 'da ikili yığın (IPv4 + IPv6) uygulaması dağıtmak için bir Azure CLı betik örneği kullanın.
