...
ms.locfileid: "99550802"
---
# <a name="configure-ipv6-endpoints-in-virtual-network-with-azure-powershell-script-sample"></a>Azure PowerShell betiği örneği ile sanal ağda IPv6 uç noktalarını yapılandırma
