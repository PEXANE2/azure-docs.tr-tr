---
title: Azure PowerShell komut dosyası örneği - IPv6 uç noktalarını yapılandırma
titlesuffix: Azure Virtual Network
description: Azure Sanal Ağ'da Powershell'i kullanarak IPv6 uç noktalarını etkinleştirme
...
Azure [Cloud Shell](https://shell.azure.com/powershell)’den veya yerel bir PowerShell yüklemesinden betiği yürütebilirsiniz. PowerShell'i yerel olarak kullanıyorsanız, bu komut dosyası azure Az PowerShell modül sürüm 1.0.0 veya daha sonra gerektirir. Yüklü sürümü bulmak için `Get-Module -ListAvailable Az` komutunu çalıştırın. Yükseltmeniz gerekirse, bkz. [Azure PowerShell modülünü yükleme](/powershell/azure/install-az-ps). PowerShell'i yerel olarak çalıştırıyorsanız Azure bağlantısı oluşturmak için `Connect-AzAccount` komutunu da çalıştırmanız gerekir.

[!INCLUDE [quickstarts-free-trial-note](../../../includes/quickstarts-free-trial-note.md)]

## <a name="prerequisites"></a>Ön koşullar
Azure'da bir çift yığın uygulaması dağıtmadan önce, aşağıdaki Azure PowerShell'i kullanarak aboneliğinizi bu önizleme özelliği için yalnızca bir kez yapılandırmanız gerekir:
...
| [Yeni-AzAvailabilitySet](/powershell/module/az.compute/new-azavailabilityset) | Bir kullanılabilirlik kümesi oluşturur. Kullanılabilirlik kümeleri, sanal makineleri fiziksel kaynaklara yayarak uygulama nın çalışma süresini sağlar, aksi takdirde tüm küme etkilenmez. |
