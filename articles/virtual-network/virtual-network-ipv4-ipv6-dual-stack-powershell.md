...
ms.locfileid: "84703125"
---
# <a name="deploy-an-ipv6-dual-stack-application-using-basic-load-balancer---powershell"></a>Temel Load Balancer PowerShell kullanarak IPv6 ikili yığın uygulaması dağıtma

Bu makalede, çift yığın sanal ağı ve alt ağı içeren Azure PowerShell kullanarak bir çift yığın (IPv4 + IPv6) Load Balancer uygulamasının nasıl dağıtılacağı, Çift (IPv4 + IPv6) ön uç yapılandırmaları içeren temel bir Load Balancer, çift IP yapılandırması, ağ güvenlik grubu ve genel IP 'leri olan NIC 'Ler içeren sanal makineler de gösterilmektedir.
