---
title: IPv6 çift yığın uygulamasını dağıtın - Temel Yük Dengeleyici - PowerShell
titlesuffix: Azure Virtual Network
description: Bu makalede, Azure Powershell kullanarak Azure sanal ağında bir IPv6 çift yığın uygulamasınasıl dağıtılır gösterilmektedir.
...
[New-AzLoadBalancer](/powershell/module/az.network/new-azloadbalancer)ile Temel Yük Dengeleyicisini oluşturun. Aşağıdaki örnek, iPv4 ve IPv6 frontend IP yapılandırmalarını, arka uç havuzlarını ve önceki adımlarda oluşturduğunuz yük dengeleme kurallarını kullanarak *myLoadBalancer* adlı genel bir Temel Yük Dengeleyicisi oluşturur:
