...
6. Önceden paylaşılan anahtarların hem bağlı sanal ağlarda eşleştirdiğini doğrulayın:
   ...
   - Azure Resource Manager sanal ağ: **bağlantı nesnesi** (4)
