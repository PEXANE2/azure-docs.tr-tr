...
\* = Katman, şu anda önizleme aşamasında olan [çapraz bölge Load Balancer](https://docs.microsoft.com/azure/load-balancer/cross-region-overview) işlevleriyle ilgilidir.
