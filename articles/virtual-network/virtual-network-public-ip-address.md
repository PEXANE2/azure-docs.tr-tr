...
4. Aşağıdaki ayarlara ait değerleri girin veya seçin, **genel IP adresi oluştur**altında, **Oluştur**' u seçin.
   ...
   |Konum|Evet|Genel IP adresini ilişkilendirmek istediğiniz kaynak olarak, bölge olarak da adlandırılan aynı [konumda](https://azure.microsoft.com/regions)bulunmalıdır.|
