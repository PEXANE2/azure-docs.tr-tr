...
5. Gerekli gelen ve giden iletişiminizin doğru kurallarının olup olmadığını öğrenmek için etkili güvenlik kuralları listesini gözden geçirin. [Ağ güvenlik grubuna genel bakış](./network-security-groups-overview.md)listesinde gördükleriniz hakkında daha fazla bilgi edinin.
