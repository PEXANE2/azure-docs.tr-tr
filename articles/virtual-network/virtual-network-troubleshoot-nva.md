...
description: Azure 'da ağ sanal gereci (NVA) sorunlarını giderin ve NVA yapılandırmalarının temel Azure platform gereksinimlerini doğrulayın.
...
---
# <a name="network-virtual-appliance-issues-in-azure"></a>Azure'daki ağ sanal gereci sorunları
