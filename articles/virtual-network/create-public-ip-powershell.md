...
>[!NOTE]
>Aşağıdaki komut az. Network Module Version 4.5.0 veya üzeri için geçerlidir.  Kullanılmakta olan PowerShell modülleri hakkında daha fazla bilgi için lütfen [PowerShellGet belgelerine](/powershell/module/powershellget/)bakın.
