...
|Fiyatlandırma                                         |Boş                                  |Aylık & kullanımı tabanlı                         |
...
- **Saldırı Analizi:** Saldırı sırasında beş dakikalık artışlarla ayrıntılı raporlar ve saldırı sona erdikten sonra eksiksiz bir özet alın. Bir saldırı sırasında neredeyse gerçek zamanlı izleme için, çevrimdışı bir güvenlik bilgileri ve olay yönetimi (SıEM) sistemine akış azaltma günlüğü.
...
- Trafiğin potansiyel olarak sahte bir paket olup olmadığını öğrenmek için istemciyle etkileşime geçin (ör: SYN auth veya SYN tanımlama bilgisi veya yeniden aktarım kaynağı için bir paket bırakarak).
