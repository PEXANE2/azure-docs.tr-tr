...
| **Azurecognivesearch** | Azure Bilişsel Arama (beceri ile Dizin oluşturucular kullanılıyorsa). | Her ikisi de | Hayır | Hayır |
...
| **GuestAndHybridManagement** | Azure Otomasyonu ve konuk yapılandırması. | Her ikisi de | Hayır | Evet |
