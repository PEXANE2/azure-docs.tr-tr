...
Maksimum çalışma süresi sağlamak için, uygulama Pod 'un birden fazla örneği çalışıyor olmalıdır. [kubectl get pods][kubectl-get] komutunu kullanarak çalışan ön uç görüntülerinin sayısını doğrulayın:
