...
Linux veya [Linux Için Windows alt sistemi][install-wsl]üzerinde Bash tabanlı bir kabukta, istio sürümünü indirmek için kullanın `curl` ve ardından aşağıdaki gibi ile `tar` ayıklayın:
