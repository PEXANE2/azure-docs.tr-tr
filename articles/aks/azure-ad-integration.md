...
1. **Yeni kayıt****uygulama kayıtları** >  **Azure Active Directory** > seçin.
    ...
    c. Yeniden yönlendirme URI 'SI türü için **Web** ' i seçin ve ardından, URI biçimli herhangi bir değer ( *https://aksazureadserver*gibi) girin.
