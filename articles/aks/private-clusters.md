...
* Özel bir kümede özel bir Azure sanal ağındaki özel Cisco uygulama merkezli altyapı (acı) örneklerini almak için bir özel kümedeki sanal düğümler desteklenmez.
