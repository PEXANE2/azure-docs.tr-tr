...
| Parametre                   | Değer                |
|-----------------------------|----------------------|
| **\<Kaynak-Grup adı>**  | myResourceGroupZLB (mevcut kaynak grubunu Seç) |
| **\<sanal ağ-adı>** | myVNet          |
...
- [Kullanılabilirlik alanları arasında VM 'Lerin yükünü dengeleyin](tutorial-load-balancer-standard-public-zone-redundant-portal.md).
