...
1. Bağlantılı makaledeki adımları izleyerek [Azure CLI 'Yı yükleyip yapılandırın](/cli/azure/install-azure-cli) ve Azure hesabınızda oturum açın.
