...
Özel bir IP adresi ile ilişkili **Mybackendpool** adlı bir arka uç havuzu olan **myön uç**adlı ön uç IP yapılandırmasını içeren, [az Network lb Create](https://docs.microsoft.com/cli/azure/network/lb?view=azure-cli-latest) **adlı bir** iç Load Balancer oluşturun * kısmına 10.0.0.7.
