...
* Front-end IP configuration – a load balancer can include one or more frontend IP addresses, otherwise known as a virtual IPs (VIPs). Bu IP adresleri trafik için bir giriş işlevi görür.
