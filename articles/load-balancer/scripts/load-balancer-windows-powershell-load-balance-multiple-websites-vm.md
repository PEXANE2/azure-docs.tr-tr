...
| [Yeni AzAvailabilitySet](/powershell/module/az.compute/new-azavailabilityset) | Yüksek oranda kullanılabilirlik sağlamak için bir Azure kullanılabilirlik kümesi oluşturur. |
...
| [Yeni AzLoadBalancerFrontendIpConfig](/powershell/module/az.network/new-azloadbalancerfrontendipconfig) | Yük dengeleyici için bir ön uç IP yapılandırması oluşturur. |
...
| [Yeni AzNetworkInterfaceIpConfig](/powershell/module/az.network/new-aznetworkinterfaceipconfig) | Bir sanal ağ arabirimi için gelişmiş özellikleri tanımlar. |
