...
## <a name="incorrect-overage-invoice"></a>Hatalı fazla kullanım faturası

Hatalı bir fazla kullanım faturası aldığınızı düşünüyorsanız, Azure kullanım ücretleri üzerinde mutabık kalmanıza yardımcı olması için [Azure Kurumsal Anlaşma faturanızı anlama](billing-understand-your-bill-ea.md) konusuna bakın. Microsoft'un sizi ücretlendirdiği fazla kullanımda bir yanlışlık yapıldığını düşünüyorsanız desteğe başvurun.

## <a name="change-a-po-number-for-an-overage-invoice"></a>Fazla kullanım faturası için PO numarasını değiştirme

EA yöneticisi fatura tarihinden önce bir satın alma siparişi (PO) numarası ayarlamadığı sürece Azure EA portalı otomatik olarak bir varsayılan numara oluşturur. EA yöneticisi Azure EA portalında oturum açıp **Raporlar**'a giderek PO numarasını güncelleştirebilir. PO numarasını EA yöneticisi güncelleştirebilir. PO numarasının gösterildiği sağ üst bölümde kalem simgesine tıklayın ve bilgileri güncelleştirin.

EA yöneticisi PO numarasını geçerli faturalama çeyreği içinde, fatura oluşturulmadan önce güncelleştirebilir. Ayrıca otomatik fatura bildirimi e-postasını aldıktan sonraki yedi gün içinde de bu numarayı güncelleştirebilir.

EA yöneticisi PO numarasını güncelleştirmediyse ve yeni bir PO numarası gerekiyorsa, tek seçenek krediyi tamamlamak ve yeniden fatura oluşturmaktır. PO numarasını bir müşterinin güncelleştirmesi gerekiyorsa, yardım için iş ortağınıza ulaşın.
...
Kaydınıza uygulanan tüm krediler veya düzeltmeler [https://ea.azure.com](https://ea.azure.com) adresinin **Raporlar** bölümünde görünür. Gerçek kredi tutarı hakkında belirli bir sorunuz varsa [Azure EA Portalı Desteği](https://support.microsoft.com/supportrequestform/cf791efa-485b-95a3-6fad-3daf9cd4027c)'ne ulaşın.
...
_Ayrı Olarak Faturalanan Ücretler_ ve _Azure Market Hizmetleri_, Azure Market platformundan dağıtılan üçüncü taraf hizmetleridir. İki hizmet arasındaki en önemli fark, üçüncü taraf yayıncılarla yapılan anlaşmanın yapısına bağlı olarak bunların nasıl faturalandığıdır.

Üçüncü taraf kullanımı faturanızda **Ayrı Olarak Faturalanan Ücretler** başlığı altında gösterilir. Kullanım, Azure parasal taahhüt bakiyenizi tüketir. Üçüncü taraf hizmetlerinin listesini görüntülemek için bkz. [Azure Market üçüncü taraf satıcı hizmetleri artık Azure parasal taahhüdünü kullanır](https://azure.microsoft.com/updates/azure-marketplace-third-party-reseller-services-now-use-azure-monetary-commitment/).

Faturanızda **Azure Market** başlığı altında gösterilen kullanım ayrı ücretlendirilir. Bu kullanım hiçbir parasal taahhüt kapsamında değildir. Bununla birlikte market, fazla kullanım ve ayrı faturalanan ücretler de dahil olmak üzere tüm ücretler tek faturada birleştirilir.

Azure birinci taraf fazla kullanımı ve Azure üçüncü taraf market satın almaları için tek bir fatura alırsınız.

Parasal taahhüdünüz tamamen tüketildiğinde, kullanım aylık veya çeyreklik temelinde faturalandırılır. Kaydınız Mayıs 2018'den önce başlatıldıysa, %150 parasal taahhüt eşiği kuralı uygulanır ve fazla kullanımlar için çeyrek dönemlerde faturalandırılırsınız. Kaydınız Mayıs 2018'den sonra başlatıldıysa tüm fazla kullanımlar aylık olarak faturalandırılır.
