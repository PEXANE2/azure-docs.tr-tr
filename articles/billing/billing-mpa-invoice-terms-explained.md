---
title: Azure’da Microsoft İş Ortağı Sözleşmesi faturanızı anlama
description: Azure’da Microsoft İş Ortağı Sözleşmesi faturanızı okuma ve anlama hakkında bilgi edinin
author: bandersmsft
manager: jureid
tags: billing
ms.service: billing
...
ms.locfileid: "72512535"
---
# <a name="terms-in-your-microsoft-partner-agreement-invoice"></a>Microsoft İş Ortağı Sözleşmesi faturanızdaki koşullar

Bu makale, Microsoft İş Ortağı Sözleşmesi’ne ilişkin Azure ödeme hesabı için geçerlidir. [Microsoft İş Ortağı Sözleşmesi’ne erişiminizin olup olmadığını denetleyin](#check-access-to-a-microsoft-partner-agreement).
...
| Ödeme koşulları |Microsoft faturanız için ödeme şekliniz. *Net 60 gün*, fatura tarihinden sonra 60 gün içinde ödeme yapacağınız anlamına gelir. |
...
## <a name="billing-details-by-product"></a>Ürüne göre fatura ayrıntıları

**Ürüne göre fatura ayrıntıları** bölümünde bu faturalama profili ile ilişkili her bir ürünün toplam ücretleri listelenir. Her ürünün ücretlerine ait günlük dökümü, Azure kullanımı ve ücretleri CSV dosyasından görüntüleyebilirsiniz. Azure kullanımı ve ücretleri CSV dosyasıyla fatura PDF dosyasını mutabık kılma hakkında bilgi edinmek için bkz. [Microsoft İş Ortağı Sözleşmesi faturanızı anlama](billing-mpa-understand-your-bill.md).

## <a name="how-to-pay"></a>Ödeme şekli

Faturanın alt kısmında, faturanızı ödeme yönergeleri yer alır. Fatura tarihinizden sonraki 60 gün içinde çek veya banka havalesi ile ödeme yapabilirsiniz.
