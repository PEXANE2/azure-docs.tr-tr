...
1. Azure abonelik KIMLIĞINIZ için bir değişken tanımlayın. Gerekirse, abonelik kimliklerinizi listelemek ve görüntülemek için [Get-AzSubscription](/powershell/module/az.accounts/get-azsubscription) cmdlet 'ini kullanabilirsiniz. Aşağıdaki komutta kendi abonelik KIMLIĞINIZI girin:
