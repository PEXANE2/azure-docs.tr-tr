...
1. Şimdi `Migrate-Aadds` *-Prepare* parametresini kullanarak cmdlet 'ini çalıştırın. Azure AD DS yönetilen etki alanınız için *aaddscontoso.com*gibi *-manageddomainfqdn* sağlayın:
...
`Migrate-Aadds` *-COMMIT* parametresini kullanarak cmdlet 'ini çalıştırın. *Aaddscontoso.com*gibi önceki bölümde hazırlanan Azure AD DS yönetilen etki alanınız için *-manageddomainfqdn* sağlayın:
...
`Migrate-Aadds` *-Abort* parametresini kullanarak cmdlet 'ini çalıştırın. *Aaddscontoso.com*gibi önceki bir bölümde hazırlanan Azure AD DS yönetilen etki alanınız için *-Manageddomainfqdn* ve *Myclassicvnet*gibi klasik sanal ağ adını sağlayın:
