...
Burada, ' contoso.com ', yönetilen etki alanının DNS etki alanı adıdır. ' contoso-RHEL ', yönetilen etki alanına katıldığınız RHEL sanal makinesinin ana bilgisayar adıdır.
