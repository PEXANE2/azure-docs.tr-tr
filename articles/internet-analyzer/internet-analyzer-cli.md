...
description: Bu makalede, Azure CLı kullanarak ilk Internet Çözümleyicisi testinizi oluşturmayı öğrenin.
...
2. [Azure CLI 'Yı yükler](/cli/azure/install-azure-cli).
