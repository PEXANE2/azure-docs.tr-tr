...
1. Yönetilen örnek için gerekli olan sanal ağa ve alt ağa bazı özel izinler uygulayın. Bunu yapmak için, var olan sanal ağınızın kaynak KIMLIĞINI almanız gerekir. Aşağıdaki komutu çalıştırın ve parametresinin değerini kopyalayın `Resource ID` :
