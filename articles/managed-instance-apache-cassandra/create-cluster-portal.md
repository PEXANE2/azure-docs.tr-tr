...
1. Son adımda yeni bir VNet oluşturduysanız, adım 9 ' a atlayın. Mevcut bir VNet seçtiyseniz, kümenizi oluşturmadan önce, sanal ağa ve alt ağa bazı özel izinler uygulamanız gerekir. Bunu yapmak için, var olan sanal ağınızın kaynak KIMLIĞINI almanız gerekir. [Azure CLI](https://docs.microsoft.com/cli/azure/get-started-with-azure-cli)'de şu komutu çalıştırın:
