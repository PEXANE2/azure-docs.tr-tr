...
`Start-AzStreamAnalyitcsJob` cmdlet 'i hakkında daha fazla bilgi için [Start-AzStreamAnalyticsJob başvurusunu](/powershell/module/az.streamanalytics/start-azstreamanalyticsjob)görüntüleyin.
