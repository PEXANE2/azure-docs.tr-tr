...
Daha fazla bilgi için [JavaScript](/azure/stream-analytics/stream-analytics-javascript-user-defined-functions) ve [C#](/azure/stream-analytics/stream-analytics-edge-csharp-udf)' e bakın.
