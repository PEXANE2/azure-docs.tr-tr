...
*[CI/CD NPM paketini kullanarak bir Azure Stream Analytics işini](setup-cicd-vs-code.md) Visual Studio Code kullanarak canlı akış girişine karşı yerel olarak test Stream Analytics sorguları