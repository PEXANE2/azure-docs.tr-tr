...
Stream Analytics IoT Edge ortamlarında dağıtılan Stream Analytics işleri [Stream Analytics sorgu dili başvurusunun](/stream-analytics-query/stream-analytics-query-language-reference?f=255&MSPPError=-2147217396)çoğunu destekler. Ancak, aşağıdaki işlemler Stream Analytics Edge işleri için henüz desteklenmemektedir: 
