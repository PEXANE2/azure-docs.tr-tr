...
Excel ve Power BI Desktop gibi istemci uygulamaları ile SSMS ve SSDT gibi araçlar, en son sürüme güncelleştirildiği sırada kitaplıkların en son sürümlerini yükler. Power BI Desktop, SSMS ve SSDT aylık olarak güncelleştirilir. Excel, [Office 365 ile güncelleştirilir](https://support.office.com/article/When-do-I-get-the-newest-features-in-Office-2016-for-Office-365-da36192c-58b9-4bc9-8d51-bb6eed468516). Office 365 güncelleştirmeleri daha az sıklıkla ve bazı kuruluşlar ertelenmiş kanalı kullanır, yani güncelleştirmeler üç aya kadar ertelenir.
...
**Sunucu yöneticileri** bir Azure Analysis Services sunucusu örneğine özgüdür. Veritabanları ekleme ve Kullanıcı rollerini yönetme gibi görevleri gerçekleştirmek için Azure portal, SSMS ve SSDT gibi araçlarla bağlanırlar. Varsayılan olarak, sunucuyu oluşturan Kullanıcı Analysis Services sunucu yöneticisi olarak otomatik olarak eklenir. Diğer yöneticiler, Azure portal veya SSMS kullanılarak eklenebilir. Sunucu yöneticilerinin aynı abonelikte Azure AD kiracısında bir hesabı olması gerekir. Daha fazla bilgi için bkz. [sunucu yöneticilerini yönetme](analysis-services-server-admins.md). 
