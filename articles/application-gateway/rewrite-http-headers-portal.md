...
Bu makalede, istek ve yanıtlara HTTP üstbilgilerini yeniden yazmak üzere bir [Application Gateway v2 SKU](./application-gateway-autoscaling-zone-redundant.md) örneği yapılandırmak için Azure Portal nasıl kullanılacağı açıklanır.

Azure aboneliğiniz yoksa başlamadan önce [ücretsiz bir hesap](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) oluşturun.

## <a name="before-you-begin"></a>Başlamadan önce

Bu makaledeki adımları tamamlayabilmeniz için bir Application Gateway v2 SKU örneğiniz olması gerekir. V1 SKU 'sunda üstbilgileri yeniden yazma desteklenmiyor. V2 SKU 'SU yoksa, başlamadan önce bir [Application Gateway v2 SKU](./tutorial-autoscale-ps.md) örneği oluşturun.
