...
Application Gateway ve Güvenlik Merkezi 'nin Web uygulaması kaynaklarınızın korunmasına nasıl yardımcı olduğunu öğrenin. Application Gateway Web uygulaması güvenlik duvarı (WAF), ortamınızdaki korumasız Web uygulamalarına yönelik tehditleri önlemeye, algılamaya ve bunlara yanıt vermeye yönelik sorunsuz bir görünüm sağlamak için [Güvenlik Merkezi](../security-center/security-center-introduction.md) ile tümleşir.
...
Web uygulaması güvenlik duvarını mevcut bir uygulama ağ geçidinde nasıl etkinleştireceğinizi öğrenmek için, [Web uygulaması güvenlik duvarı Ile Azure Application Gateway oluşturma veya güncelleştirme](../web-application-firewall/ag/application-gateway-web-application-firewall-portal.md)makalesini ziyaret edin.
