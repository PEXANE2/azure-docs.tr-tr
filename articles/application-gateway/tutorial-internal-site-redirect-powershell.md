...
Adresi diğer etki alanınız (örneğin `http://www.contoso.org`) olarak değiştirin ve trafiğin `www.contoso.com`dinleyiciye geri yönlendirildiğini görmeniz gerekir.
