...
Lütfen bu arada bir AKS eklentisi olarak dağıtılan Held aracılığıyla dağıtılan AGIC arasındaki farklara bakın [](ingress-controller-overview.md#difference-between-helm-deployment-and-aks-add-on)
...
### <a name="where-does-application-gateway-store-customer-data"></a>Application Gateway müşteri verilerini nerede depolar?
