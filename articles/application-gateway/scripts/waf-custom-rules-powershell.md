...
description: Azure PowerShell Script Örneği - Web Uygulaması Güvenlik Duvarı özel kuralları oluştur
author: vhorne
...
- WAF özel kuralları hakkında daha fazla bilgi [için, Web Uygulaması Güvenlik Duvarı için Özel kurallara](../custom-waf-rules-overview.md) bakın
