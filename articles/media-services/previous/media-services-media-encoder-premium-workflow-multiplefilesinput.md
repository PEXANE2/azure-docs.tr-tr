...
Aşağıda, bir dosyadan XML yapılandırmasını okuyan, doğru video dosya adı ile güncelleştiren ve bunu bir işteki göreve geçiren C# kodu verilmiştir:
...
* [Media Encoder Premium Workflow biçimleri ve codec bileşenleri](media-services-premium-workflow-encoder-formats.md)
