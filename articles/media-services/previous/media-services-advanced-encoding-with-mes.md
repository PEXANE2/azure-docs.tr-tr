...
> [!NOTE] 
> Media Encoder Standard Gelişmiş Media Services V2 özelliklerinin birçoğu şu anda v3 'de kullanılamaz. Daha fazla bilgi için [geçiş kılavuzuna](../latest/migrate-v-2-v-3-migration-introduction.md)bakın.
