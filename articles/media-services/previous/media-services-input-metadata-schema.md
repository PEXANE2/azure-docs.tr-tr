...
| Adı | Tür | Açıklama |
| --- | --- | --- |
| **Kimlik**<br /><br /> Gerekli |**xs: int** |Bu sesin veya video izlemenin sıfır tabanlı dizini.<br /><br /> Bu, bir MP4 dosyasında kullanılan TrackID olması gerekmez. |
...
| **Açıklamanın**<br /><br /> Gerekli |**xs: int** |Bu özniteliği, bu izlemenin yorum içerdiğini belirtmek için 1 olarak ayarlayın. |
