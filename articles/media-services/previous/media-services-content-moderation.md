...
| duration |Parçanın uzunluğu, "ticks." |
...
|Öğe|Açıklama|
|---|---|
| Gözden geçirmeyi öneririz | **adultScore** veya **oycyscore** 'ın iç eşikleri aşmasına göre `true` veya `false`. |
...
| index | İlk kare dizininden son kare dizinine kadar bir ölçekte çerçevenin dizini. |
