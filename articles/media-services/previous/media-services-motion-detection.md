...
| Başlangıç |"Ticks" içinde başlangıç zaman damgası. |
| duration |Olayın "ticks" cinsinden uzunluğu. |
| aralığı |Olaydaki her girdinin "ticks" cinsinden aralığı. |
| olaylar |Her olay parçası bu süre içinde algılanan hareketi içerir. |
| türü |Geçerli sürümde, bu her zaman genel hareket için ' 2 '. Bu etiket, video API 'Lerine gelecekteki sürümlerde hareketi kategorilere ayırma esnekliği verir. |
