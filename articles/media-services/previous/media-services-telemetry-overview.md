...
Bit hızı|Bit hızını izle|785000
Sağlam|True, IF FragmentDiscardedCount = = 0 && ArchiveAcquisitionError = = false|True (Bu iki değer ölçüm içinde yok ancak kaynak olayda var)<br/><br/>Sağlıklı, aşağıdaki koşullardan herhangi biri tutulmamışsa yanlış döndüren bileşik bir işlevdir:<br/><br/>-FragmentDiscardedCount > 0<br/>-ArchiveAcquisitionError = = true
