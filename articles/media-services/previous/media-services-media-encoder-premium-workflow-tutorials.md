...
## <a name="encoding-mxf-into-a-single-bitrate-mp4"></a><a id="MXF_to_MP4"></a>MXF 'yi tek bir bit hızı MP4 olarak kodlama
Bu bölümde, tek bit hızı oluşturma gösterilmektedir. AAC dosyası AAC ile kodlanmış ses olan MP4 dosyası. MXF giriş dosyası.

### <a name="starting-a-new-workflow"></a><a id="MXF_to_MP4_start_new"></a>Yeni bir iş akışı başlatılıyor
...
### <a name="using-the-media-file-input"></a><a id="MXF_to_MP4_with_file_input"></a>Medya dosyası girişini kullanma
...
### <a name="inspecting-media-streams"></a><a id="MXF_to_MP4_streams"></a>Medya akışlarını İnceleme
...
### <a name="adding-a-video-encoder-for-mp4-file-generation"></a><a id="MXF_to_MP4_file_generation"></a>İçin bir video Kodlayıcısı ekleniyor. MP4 dosyası oluşturma
...
### <a name="multiplexing-audio-and-video-streams-into-an-mp4-container"></a><a id="MXF_to_MP4_audio_and_fideo"></a>Bir MP4 kapsayıcısına ses ve video akışlarını çoğullama
...
### <a name="writing-the-mp4-file"></a><a id="MXF_to_MP4_writing_mp4"></a>MP4 dosyası yazılıyor
...
### <a name="creating-a-media-services-asset-from-the-output-file"></a><a id="MXF_to_MP4_asset_from_output"></a>Çıkış dosyasından Media Services varlık oluşturma
...
### <a name="test-the-finished-workflow-locally"></a><a id="MXF_to_MP4_test"></a>Tamamlanmış iş akışını yerel olarak test etme
...
## <a name="encoding-mxf-into-mp4---multibitrate-dynamic-packaging-enabled"></a><a id="MXF_to_MP4_with_dyn_packaging"></a>MXF 'yi MP4 'e kodlama-MultiBit hızı dinamik paketleme etkin
...
Tüm video kodlayıcılarımızın aynı ayarlarla oluşturulduğundan emin olmak için, zaten mevcut olan AVC video Kodlayıcısı 'nı çoğaltmak ve başka bir çözünürlük ve bit hızı birleşimi yapılandırmak (2,5 Mbps 'de saniyede 25 kare 960 x 540 ' den birini ekleyelim) gerekir. Varolan kodlayıcıyı çoğaltmak için, Kopyala öğesini tasarımcı yüzeyine yapıştırın.
...
### <a name="configuring-the-file-output-names"></a><a id="MXF_to_MP4_with_dyn_packaging_conf_output_names"></a>Dosya çıkış adlarını yapılandırma
...
### <a name="adding-a-separate-audio-track"></a><a id="MXF_to_MP4_with_dyn_packaging_audio_tracks"></a>Ayrı bir ses Izi ekleme
...
### <a name="adding-the-ism-smil-file"></a><a id="MXF_to_MP4_with_dyn_packaging_ism_file"></a>Ekleniyor. ISM SMıL dosyası
...
## <a name="encoding-mxf-into-multibitrate-mp4---enhanced-blueprint"></a><a id="MXF_to__multibitrate_MP4"></a>MXF 'yi çoklu bit hızına sahip MP4 ile kodlama-Gelişmiş şema
...
### <a name="workflow-overview-to-enhance"></a><a id="MXF_to_multibitrate_MP4_overview"></a>İyileştirmek için iş akışına genel bakış
...
### <a name="publishing-component-properties-onto-the-workflow-root"></a><a id="MXF_to__multibitrate_MP4_publishing"></a>Bileşen özellikleri iş akışı köküne yayımlanıyor
...
## <a name="adding-thumbnails-to-multibitrate-mp4-output"></a><a id="thumbnails_to__multibitrate_MP4"></a>Çoklu bit hızı MP4 çıkışına küçük resim ekleme
...
### <a name="workflow-overview-to-add-thumbnails-to"></a><a id="thumbnails_to__multibitrate_MP4_overview"></a>Küçük resimleri eklemek için iş akışına genel bakış
...
### <a name="adding-jpg-encoding"></a><a id="thumbnails_to__multibitrate_MP4__with_jpg"></a>JPG kodlaması ekleniyor
...
### <a name="dealing-with-color-space-conversion"></a><a id="thumbnails_to__multibitrate_MP4_color_space"></a>Renk alanı dönüştürmesiyle ilgili
...
### <a name="detecting-errors-in-a-workflow"></a><a id="thumbnails_to__multibitrate_MP4_errors"></a>Bir iş akışındaki hataları algılama
...
### <a name="finished-workflow"></a><a id="thumbnails_to__multibitrate_MP4_finish"></a>Tamamlanan Iş akışı
...
## <a name="time-based-trimming-of-multibitrate-mp4-output"></a><a id="time_based_trim"></a>Çoklu bit hızı MP4 çıkışının zaman tabanlı bölünmesi
...
### <a name="using-the-stream-trimmer"></a><a id="time_based_trim_use_stream_trimmer"></a>Akış kırpıcıyı kullanma
...
## <a name="introducing-the-scripted-component"></a><a id="scripting"></a>Komut dosyalı bileşene giriş
...
### <a name="scripting-within-a-workflow-hello-world"></a><a id="scripting_hello_world"></a>Bir iş akışı içinde betik oluşturma: Merhaba Dünya
...
## <a name="frame-based-trimming-of-multibitrate-mp4-output"></a><a id="frame_based_trim"></a>Çoklu bit hızı MP4 çıkışının çerçeve tabanlı bölünmesi
...
### <a name="blueprint-overview-to-start-adding-trimming-to"></a><a id="frame_based_trim_start"></a>Şemayı eklemeye başlamak için Blueprint genel bakışı
...
### <a name="using-the-clip-list-xml"></a><a id="frame_based_trim_clip_list"></a>Klip Listesi XML 'i kullanma
...
### <a name="modifying-the-clip-list-from-a-scripted-component"></a><a id="frame_based_trim_modify_clip_list"></a>Betikleştirilmiş bir bileşenden klip listesini değiştirme
...
### <a name="adding-a-clippingenabled-convenience-property"></a><a id="frame_based_trim_clippingenabled_prop"></a>Clienppingenabled kolay özelliği ekleme
...
[Media Encoder Premium İş Akış Biçimleri ve Kodlayıcıları](media-services-premium-workflow-encoder-formats.md)
