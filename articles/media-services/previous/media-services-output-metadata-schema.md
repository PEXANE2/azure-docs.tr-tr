...
Bu makalede, çıkış metada ( &lt; source_file_name_manifest.xml) temel ALDıĞı XML şemasının öğeleri ve türleri açıklanmaktadır &gt; . Giriş varlığı hakkında meta veriler içeren dosya hakkında daha fazla bilgi için bkz. giriş meta verileri.  
