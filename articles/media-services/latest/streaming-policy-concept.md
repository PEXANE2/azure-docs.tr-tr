...
Bir akış Ilkesinin tanımını görmek istiyorsanız [Get](https://docs.microsoft.com/rest/api/media/streamingpolicies/get) ' i kullanın ve ilke adını belirtin. Örneğin:
