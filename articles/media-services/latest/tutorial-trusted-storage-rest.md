...
Kiracı KIMLIĞINIZ ve abonelik KIMLIĞINIZI nasıl alacağınız hakkında bilgi sahibi değilseniz, bkz. [KIRACı kimliğinizi bulma](how-to-set-azure-tenant.md) ve [kiracı kimliğinizi bulma](how-to-set-azure-tenant.md).
...
[Varlık oluşturma](how-to-create-asset.md)
