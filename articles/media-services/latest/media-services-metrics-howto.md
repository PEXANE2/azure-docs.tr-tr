...
- [İzleme Media Services ölçümleri ve tanılama günlüklerini](monitoring/monitor-media-services-data-reference.md) gözden geçirin
...
1. **Kapsam** kutusuna tıklayın ve izlemek istediğiniz kaynağı seçin.
    ...
    * &lt;depolama hesabı adı&gt;
    ...
    Ardından, kaynağı seçin ve **Uygula**' ya basın. Desteklenen kaynaklar ve ölçümler hakkında daha fazla bilgi için bkz. [izleme Media Services ölçümleri](monitoring/monitor-media-services-data-reference.md).
