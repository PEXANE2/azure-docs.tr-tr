---
title: Media Services Python temel kodlama hızlı başlangıç
description: Bu hızlı başlangıçta Python ve Azure Media Services ile temel kodlamanın nasıl yapılacağı gösterilmektedir.
...
Bu hızlı başlangıçta Python ve Azure Media Services ile temel kodlamanın nasıl yapılacağı gösterilmektedir. 2020-05-01 Media Service v3 API 'sini kullanır.

## <a name="prerequisites"></a>Ön koşullar

- Azure aboneliğiniz yoksa başlamadan önce [ücretsiz bir hesap](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) oluşturun.
- Bu hızlı başlangıç ile kullanılacak bir kaynak grubu oluşturun.
- Media Services v3 hesabı oluşturun.
- Depolama hesabı anahtarınızı alın.
- Hizmet sorumlusu ve anahtarı oluşturun.

## <a name="get-the-sample"></a>Örneği alma

Bir çatal oluşturun ve [Python örnekleri deposunda](https://github.com/Azure-Samples/media-services-v3-python)bulunan örneği kopyalayın. Bu hızlı başlangıçta, BasicEncoding örneğiyle çalışıyoruz.

## <a name="create-the-env-file"></a>. Env dosyası oluşturma

*. Env* dosyası oluşturmak için hesabınızdan değerleri alın. Bu doğru, yalnızca uzantıda değil, adı olmadan kaydedin.  *Örnek. env* 'yi şablon olarak kullanın ve ardından *. env* dosyasını yerel kopyanızda basicencoder klasörüne kaydedin.

## <a name="try-the-code"></a>Kodu deneyin

Aşağıdaki kod ayrıntılı olarak yorumlanma.  Tüm betiği kullanın veya kendi betiğinizin parçalarını kullanın.

Bu örnekte, komut dosyasını çalıştırdığınızda birlikte oluşturulmuş bir grup olarak belirleyebilmeniz için, adlandırma işlemleri için rastgele bir sayı oluşturulur.  Rastgele sayı isteğe bağlıdır ve betiği test etmeyi bitirdiğinizde kaldırılabilir.

Bu örnekteki giriş varlığı için SAS URL 'sini kullanmıyoruz.
...
Hızlı başlangıç ile işiniz bittiğinde, kaynak grubunda oluşturulan kaynakları silin.

## <a name="next-steps"></a>Sonraki adımlar

[Python SDK Media Services](https://docs.microsoft.com/python/api/azure-mgmt-media/?view=azure-python) hakkında bilgi edinin