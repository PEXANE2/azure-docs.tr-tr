---
title: Media Services ve Apple FairPlay lisans desteği-Azure
...
Aşağıdaki örnek, lisansı yapılandırmak için [.NET SDK Media Services](/dotnet/api/microsoft.azure.management.media.models?view=azure-dotnet) kullanır.
