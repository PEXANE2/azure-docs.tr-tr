---
title: Birden çok depolama hesabı genelinde Media Services v3 varlıklarını yönetme | Microsoft Docs
description: Bu makaleler, Media Services v3 varlıklarının birden çok depolama hesabında nasıl yönetilebileceğine kılavuzluk sağlar.
...
ms.locfileid: "105572584"
---
# <a name="managing-media-services-v3-assets-across-multiple-storage-accounts"></a>Birden çok depolama hesabı genelinde Media Services v3 varlıklarını yönetme  
