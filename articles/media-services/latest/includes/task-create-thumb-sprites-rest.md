...
ms.locfileid: "101705475"
---
<!--Create a thumbnail sprites REST-->

Aşağıdaki Azure REST komutu bir küçük resim Sprite dönüşümü oluşturur. , Ve değerlerini `subscriptionID` `resourceGroup` `accountName` Şu anda çalıştığınız değerlerle değiştirin. 

Dönüşümle bir adı ayarlayarak bir ad verin `transformName` .
