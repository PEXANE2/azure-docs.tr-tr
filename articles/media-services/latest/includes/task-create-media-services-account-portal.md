...
1. **Media Services hesabı oluştur** bölümünde gerekli değerleri girin.
    ...
    |**Kaynak Grubu**|Yeni veya mevcut kaynağı seçin. Kaynak grubu; yaşam döngüsünü, izinleri ve ilkeleri paylaşan kaynakların bir koleksiyonudur. [Daha fazla bilgi edinin](../../../azure-resource-manager/management/overview.md#resource-groups).|
