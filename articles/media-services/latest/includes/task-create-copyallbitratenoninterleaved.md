...
Kullanılabilir REST API dönüştürmelerini görüntülemek için bkz. [dönüşümler-oluştur veya Güncelleştir](/rest/api/media/transforms/createorupdate#definitions).
