---
title: Azure portal kullanarak Azure AD kimlik doğrulaması ile çalışmaya başlama
...
ms.locfileid: "79082753"
---
# <a name="use-the-azure-portal-to-get-credentials-to-access-media-services-api"></a>Media Services API 'sine erişmek için kimlik bilgilerini almak üzere Azure portal kullanın  
...
Bu makalede, Media Services API 'sine erişmek için kimlik bilgilerini almak üzere Azure portal nasıl kullanılacağı gösterilmektedir.
...
- Bir Media Services hesabı. Daha fazla bilgi için [Azure Portal kullanarak Azure Media Services hesabı oluşturma](create-account-portal.md)konusuna bakın.
