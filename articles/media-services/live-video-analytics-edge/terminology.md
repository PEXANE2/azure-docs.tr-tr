...
[GRPC](https://grpc.io/docs/guides/) , dilden bağımsız, yüksek performanslı bir uzak yordam ÇAĞRıSı (RPC) çerçevesidir. İletişim için temeldeki ileti değişim biçimi olarak [protokol arabellekleri 3](https://developers.google.com/protocol-buffers/docs/proto3) aracılığıyla oturum tabanlı yapılandırılmış şemaları kullanır.
