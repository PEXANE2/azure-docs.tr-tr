...
| **Ölçeklenebilirlik**<br>*İlerisi* | Önceki sürümde cihazlar, iletiler, grafikler ve ölçek birimleri için ölçek sınırlamaları vardı. Abonelik başına yalnızca bir Azure dijital TWINS örneği desteklenir.  | Yeni sürüm, geliştirilmiş ölçeklenebilirlik ile yeni bir mimariye dayanır ve daha fazla işlem gücü içerir. Ayrıca, her abonelik için bölge başına 10 örnek destekler.<br><br>Bkz. başvuru: geçerli sürümdeki limitlerin ayrıntıları için [*hizmet limitleri*](reference-service-limits.md) . |
