...
Visual Studio 'Nun *IoTHubtoTwins.cs*'e yeni projeyle oluşturduğu *function1.cs* örnek işlevini yeniden adlandırın. Dosyadaki kodu aşağıdaki kodla değiştirin:
