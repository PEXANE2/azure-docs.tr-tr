---
title: Yönlendirme olayları için yönetilen kimliği etkinleştirme (Önizleme)
titleSuffix: Azure Digital Twins
description: Bkz. Azure dijital TWINS için sistem tarafından atanan bir kimliği etkinleştirme ve olayları iletmek için kullanma.
author: baanders
ms.author: baanders
ms.date: 1/21/2021
ms.topic: how-to
...
ms.locfileid: "98948954"
---
# <a name="enable-a-managed-identity-for-routing-azure-digital-twins-events-preview"></a>Azure dijital TWINS olaylarını yönlendirme için yönetilen bir kimlik etkinleştirme (Önizleme)
...
Bu bölümde, zaten mevcut olan bir Azure dijital TWINS örneğine sistem tarafından yönetilen bir kimlik eklemek için [Azure Portal](https://portal.azure.com) kullanacaksınız.
