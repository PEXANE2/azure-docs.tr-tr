...
[Hızlı başlangıç](quickstart-view-occupancy-dotnet.md#build-application) veya [öğreticiye](tutorial-facilities-setup.md#configure-the-digital-twins-sample)devam edin.

[Yeni **uygulama kayıtları** dikey penceresini kullanarak uygulamanızı nasıl kaydedeceğinizi](tutorial-facilities-setup.md#grant-permissions-to-your-app)öğrenin.