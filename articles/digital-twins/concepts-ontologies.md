...
Bunları [Azure Digital TWINS (ADT) Gezgini](/samples/azure-samples/digital-twins-explorer/digital-twins-explorer/) veya [ADT model görselleştiricisi](https://github.com/Azure/opendigitaltwins-building-tools/tree/master/AdtModelVisualizer)gibi örneklerle görselleştirebilir veya [dijital TWINS](concepts-twins-graph.md)oluşturmak için bunları kullanmaya geçebilirsiniz.
