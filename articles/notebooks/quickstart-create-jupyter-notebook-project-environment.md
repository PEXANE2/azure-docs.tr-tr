...
1. Ortamınızı test etmek için yeni bir not defteri oluşturup çalıştırın, sonra, bir Python `import` deyimi kullanma gibi, ortamdaki bir pakete bağlı olan deyimlerle bir kod hücresi oluşturun. İfade başarılı olursa, gerekli paket ortama başarıyla yüklendi.
