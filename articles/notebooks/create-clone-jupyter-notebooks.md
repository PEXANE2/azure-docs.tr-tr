...
| **Delete** | Sahip | Seçili proje siler. Bu işlem geri alınamaz. |
...
| | | | | | |
| --- | --- | --- | --- | --- | --- |
| bilgi | account | yönetim | API | lenemeyen | ders |
| content | pano | Explorer | SSS | Yardım | html |
| sayfa | aktarmaya | Kitaplığı | yönetim | yeni | Mini |
| not defterleri | belgesini | önizleme | Fiyat | profile | search |
| durum | support | test | | | |
