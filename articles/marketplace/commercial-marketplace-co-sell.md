...
### <a name="select-solution-areas"></a>Çözüm alanını seçin

Çözüm bölgeleri, çözümünüzü daha da tanımlamaya yardımcı olur. Bu, Microsoft satış ekiplerinin çözümünüzün değer teklifini bulmasına ve anlamasına yardımcı olur. Teklifinizin en az birini ve en fazla üç çözüm alanını seçmeniz gerekir. Her çözüm alanı için, daha fazla iki çözüm alt alanı seçebilirsiniz.

1. **+ Çözüm alanı Ekle (3 max)** bağlantısını seçin.
1. Görüntülenen aşağı açılan listeden bir çözüm alanı seçin.
1. En az bir ve en fazla iki çözüm alt alanı seçin. Birden çok alt alan seçmek için, `Ctrl` anahtarı (Windows üzerinde) veya `Command` anahtarı (MacOS 'ta) kullanın.
1. Başka bir çözüm alanı eklemek için 1 ile 3 arasındaki adımları yineleyin.

## <a name="upload-documents"></a>Belgeleri karşıya yükleme

Teklifinizle ilgili ayrıntıları sağlayan yardımcı belgeler sağlamanız gerekir. Microsoft satış ekipleri teklifinizi önermek ve satmak için teklifinizin müşteri gereksinimlerine uygun olup olmadığını değerlendirmek için bu bilgileri kullanır. Sağladığınız daha fazla bilgi, Microsoft satış takımlarının ürününüzü anlaması ve yükseltmeniz gerekecektir.

Desteklenen dosya türleri. PDF,. ppt,. pptx,. doc,. docx,. xls,. xlsx,. jpg,. png ve. mp4 'dir. Bazı belgelerin şablonları aşağıda tablo 2 ' de verilmiştir.

> [!NOTE]
> Tek bir sayfalayıcı ve **çözüm/teklif sıklık destesi** **çözümü/teklifi** , ortak satış için hazırlık durumuna ulaşmak için gereklidir. Ayrıca, bazı tekliflerin Azure IP ortak satış incentivized olması için de önkoşullardır. Azure IP ortak satış incentivized durumu için başvuru mimarisi diyagramı da gereklidir. Bu tabloda açıklanan diğer belgeler isteğe bağlıdır, ancak önerilir.

***Tablo 2: ortak satışı destekleyen belgeler***

| **Belgeler**    | **Açıklama**  |
| :------------------- | :-------------------|
| *Çözüm/teklif tek sayfalayıcı (gerekli)* | Çözümünüzün değer teklifini gösteren, profesyonel olarak tasarlanan tek bir sayfalayıcı ile potansiyel müşteriler arasında bir tanıma.<br><br>Teklifinizle ilgili bir müşterinin kullanımına yönelik bir açıklama sağlamak için ilgili şablonlardan birini kullanabilirsiniz:<br><ul><li> [Tek sayfalayıcı şablonu Microsoft Azure](https://aka.ms/Customer-One-Pager_MicrosoftAzure)</li><li>[Microsoft Dynamics 365 1-sayfalayıcı şablonu](https://aka.ms/Customer-One-Pager_MicrosoftDynamics365)</li> <li>[Microsoft 365 1-sayfalayıcı şablonu](https://aka.ms/Customer-One-Pager_MicrosoftOffice365) </li><li>[Windows 10 1-sayfalayıcı şablonu](https://aka.ms/Customer-One-Pager_Windows)</li></ul> <br> Microsoft satış ekipleri, teklifinizin uygun olup olmadığını belirlemenize ve müşterinin hazır olmasını sağlamaya yardımcı olmak için bu bilgileri müşterilerle paylaşabilir. |
| *Çözüm/teklif aralığı destesi (gerekli)* | Aralıklı destesi oluşturmak için [müşteri sunum şablonunu](https://aka.ms/GTMServices_CustomerPresentation) kullanabilirsiniz. Bu deste, [başvuru mimarisi diyagramına](reference-architecture-diagram.md)başvurmalıdır. Bu slayt destesi amacı teklifinizi ve değer teklifini göstersağlamaktır. Teklifinizin müşteriye hazırlandığından emin olduktan sonra, Microsoft satış ekipleri bu sunuyu, şirketinizin ve Microsoft 'un ortak bir çözümü dağıtmakta olduğu değeri ifade etmek için müşterilerle paylaşabilir. Sunum, teklifinizin ne yaptığını, müşterilerin müşterilere nasıl yardımcı olduğunu, teklifin hangi sektörlerin ilgili olduğunu ve rakip çözümlerle nasıl karşılaştırdığını kapsamalıdır. |
| *Müşteri örnek olay incelemesi* (isteğe bağlı)| Müşteri örnek olay araştırmayı oluşturmak için [örnek olay incelemesi şablonunu](https://aka.ms/GTM_Case_Study_Template) kullanın. Bu bilgiler, sizin ve Microsoft 'un teklifinizi nasıl başarılı bir şekilde dağıttığından, olası bir müşteriyi gösterir. |
| *Doğrulanabilen müşteri WINS* (isteğe bağlı) | Teklifiniz dağıtıldıktan sonra müşteri başarılarını belirli örneklere sunun. |
| *Kanal aralığı destesi* (isteğe bağlı) | Kanal satıcılarının teklifleriniz hakkında daha fazla bilgi edinmelerini ve satış ekiplerini satmaya hazırlamalarını sağlayan bilgileri içeren bir slayt destesi. Bu deste genellikle bir Asansör aralığı, hedef müşteriler hakkında bilgiler, müşterilere Sorulacak sorular, iletişim noktaları ve videoların, belgelerin ve destek bilgilerinin bağlantıları bulunur. |
| *Başvuru mimarisi diyagramı* (Azure IP ortak satışı incentivized durumu için gereklidir) | Teklifinizi ve Microsoft bulut hizmetleriyle ilişkisini temsil eden bir diyagram. Ayrıca teklifinizin Azure IP ortak satış incentivized durumu için teknik gereksinimleri nasıl karşıladığı de gösterebilir. [Başvuru mimarisi diyagramı hakkında daha fazla bilgi edinin.](reference-architecture-diagram.md) |
| *Diğer belgeler* (isteğe bağlı) | Microsoft satış ekiplerine ve kanal satıcılarına, teklifleriniz, kuruluşunuz ve diğer tekliflerden farklı olma hakkında daha fazla bilgi edinmek için beş adede kadar ek belge veya video yükleyebilirsiniz. |
|||

- Belgelerinizi oluşturduktan sonra **Belgeler** altında uygun kutuya sürükleyin veya bilgisayarınızdan bir belge yüklemek için **dosya (ler)** i seçin seçeneğini belirleyin.

    [![Microsoft ile ortak satış belge bölümünün ortak satış belgelerini gösterir.](./media/co-sell/co-sell-documents-section.png)](./media/co-sell/co-sell-documents-section.png#lightbox)

## <a name="product-landing-page"></a>Ürün giriş sayfası

- **Belgeler**' in altında, **ürün giriş sayfası sayfasında** , ürününüzün sitesinin bağlantısını girin; burada Microsoft Sales ekipleri ve kanal satıcıları teklifiniz hakkında daha fazla bilgi alabilir ve en son güncelleştirmeleri görüntüleyebilir.
...
1. Öğesini açın. Microsoft Excel gibi bir uygulamadaki CSV dosyası ve sonra her satırı ilgili kişiyle ilgili bilgilerle doldurur.
    ...
    ***Tablo 3: rollerin açıklaması***
    ...
    - Durumlar/bölgeler (Isteğe bağlı): şablonu doldururken, [durumlar, bölgeler ve bölgeler tablolarında](commercial-marketplace-co-sell-states.md)listelenen XX-XX biçimini kullanın.
