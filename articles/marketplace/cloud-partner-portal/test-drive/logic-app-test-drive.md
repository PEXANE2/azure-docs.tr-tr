...
- **Bölge** - *[gerekli alan]* seçtiğiniz bölge, test sürücüsü Logic App kaynaklarınızın dağıtıldığı yeri seçin.
...
- **En fazla eşzamanlı test sürücüsü** - *[gerekli alan]* zaten dağıtılan ve seçilen bölge başına erişim bekleyen test sürücüsü örneklerinin sayısı. Müşteriler, bir dağıtımı beklemek yerine bu test sürücülerine anında erişebilir.
