...
1.  [Iş Ortağı Merkezi](https://partner.microsoft.com/dashboard)' nde oturum açın.
2.  **Ayarları** (dişli simgesi) seçin ve **Geliştirici ayarları**' nı seçin.
3.  **Hesap**altında **Faturalandırma profili**' ni seçin.
...
5.  Uygulanabiliyorsa, vergi KIMLIĞI/KDV KIMLIK ayarları ' nı belirtin.
6.  Değişikliklerinizi kaydetmek için **Kaydet**'e tıklayın.
