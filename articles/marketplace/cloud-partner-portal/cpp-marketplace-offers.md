...
| [Müşteri Etkileşimi için Dynamics 365](./dyn365ce/cpp-customer-engagement-offer.md) | AppSource | Bu müşteri kaynak yönetimi (CRM) sistemini Sales, Service, Project Service ve Field Service modülleri aracılığıyla genişleten bir paket  |
| [Finans ve Operasyon için Dynamics 365](../cloud-partner-portal-orig/cpp-dynamics-365-operations-offer.md) | AppSource | Gelişmiş finans, işlemler, üretim ve tedarik zinciri yönetimini destekleyen bu kurumsal kaynak planlama (ERP) hizmetini genişleten bir paket |
...
| [Power BI App](./power-bi/cpp-power-bi-offer.md) | AppSource | Veri kümeleri, raporlar ve panolar gibi Özelleştirilebilir Power BI içeriği paketleyen Power BI uygulaması |
