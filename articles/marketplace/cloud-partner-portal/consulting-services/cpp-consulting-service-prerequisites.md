---
title: Azure ve Dynamics 365 danışmanlık hizmeti ön koşullar sunuyor | Azure Marketi
description: Bulut İş Ortağı Portalı'ndaki Azure veya Dynamics 365 danışmanlık hizmeti teklifi için ön koşullar.
author: qianw211
...
|Power Apps | [PowerApps Ortaklık Programı'nda](https://aka.ms/PowerAppsPartner)Gelişmiş Avantajlar için uygun olmalıdır. |

## <a name="next-steps"></a>Sonraki adımlar

Önceki gereksinimleri karşıladıktan sonra, [bir danışmanlık hizmetleri teklifi oluşturmaya](./cpp-consulting-service-create-offer.md)hazırsınız.
