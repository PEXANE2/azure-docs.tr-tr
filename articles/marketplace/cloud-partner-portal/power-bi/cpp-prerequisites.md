...
- Kayıtlı bir bulut marketi yayımcısı olun. Kaydolmadıysanız, [bulut marketi yayımcısı haline](https://docs.microsoft.com/azure/marketplace/become-publisher)gelen adımları izleyin.
    ...
    > [!NOTE] 
    > [Bulut iş ortağı portalı](https://cloudpartner.azure.com)oturum açmak Için aynı Microsoft Geliştirici Merkezi kayıt hesabını kullanın. AppSource teklifleriniz için yalnızca bir tane Microsoft hesabınızın olması gerekir. Hesaplar, ayrı hizmetlere veya tekliflere özel olmamalıdır.
