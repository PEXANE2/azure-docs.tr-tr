...
| **Uygulamanız için yardım bağlantısı\***               | Uygulamanız için çevrimiçi yardım sunan bir sayfanın URL 'sini sağlayın.           |
...
| *Belgeler*                          | **Daha fazla bilgi edinin** başlığı altında appsource 'ta görüntülenecek en fazla üç belge ekleyin.  |
| **Adı**                             | Destekleyici bir belgenin adını veya başlığını girin.                              |
| **Dosya**                             | PDF dosyasını karşıya yükleyin.                             |
| *Ekran görüntüleri\**                      | En fazla beş ekran görüntüsü ekleyin.                        |
| **Adı**                             | Bir ekran görüntüsünün adını veya başlığını girin.                                       |
...
|------------------------|--------------------------------------            |
|  **Yok**              | Müşteri adayı toplanmaz. Bu varsayılan seçenektir.  |
