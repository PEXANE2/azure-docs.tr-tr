...
ms.locfileid: "92284922"
---
# <a name="vm-certification-troubleshooting"></a>VM sertifikası sorunlarını giderme
...
> [!NOTE]
> Tek seferde bir plana yalnızca bir VM görüntüsü ekleyebilirsiniz. Birden çok VM görüntüsü eklemek için, ilk olanı yayımlayın ve Yayımcı oturum açma aşamasına gelene kadar bekleyin, sonra sonraki VM görüntüsünü ekleyin.
...
- [VM teklif özelliklerini yapılandırma](azure-vm-create-properties.md)
