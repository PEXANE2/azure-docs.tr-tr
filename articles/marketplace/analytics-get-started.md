---
title: Analiz verilerine programlı erişim ile çalışmaya başlama
...
---
# <a name="get-started-with-programmatic-access-to-analytics-data"></a>Analiz verilerine programlı erişim ile çalışmaya başlama
...
Ticari Market Analytics verilerine programlı erişimin temel değeri, raporlama ve dahili bı sistemleri ve platformları ile tümleştirme için tasarlanmıştır.

> [!NOTE]
> İş ortaklarının API arabirimine bir kez ekleme yapması için adanmış mühendislik kaynakları gerekecektir.
