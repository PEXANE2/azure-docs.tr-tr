...
| :------------------- | :-------------------|:-------------------|:-------------------|:-------------------|
|  | Benimle iletişim kurun | Deneme | Test Sürüşü | Transact |
...
- Azure AD 'yi listeleyerek tümleştirerek çoklu oturum açmayı etkinleştirme hakkında bilgi için, bkz. [Azure Active Directory geliştiriciler]( https://docs.microsoft.com/azure/active-directory/develop/).
