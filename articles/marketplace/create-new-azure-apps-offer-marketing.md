---
title: Azure uygulama teklifinizi satma
...
ms.locfileid: "96621442"
---
# <a name="how-to-sell-your-azure-application-offer"></a>Azure uygulama teklifinizi satma

Bu makalede, Microsoft aracılığıyla Azure uygulama teklifinizi satdıysanız seçebileceğiniz ek seçenekler açıklanmaktadır. Teklifinizi Microsoft ile birlikte satın alabilir, [bulut çözümü sağlayıcıları (CSP) programı](cloud-solution-providers.md)veya her ikisiyle de yeniden satın alabilirsiniz.
