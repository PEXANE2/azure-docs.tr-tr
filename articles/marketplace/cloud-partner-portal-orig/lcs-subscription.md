---
title: LCS aboneliği
description: Bu CPP, bılgısayar makalesine bağlı olan kullanım dışı bırakıldı makalesi; "abonelik oluşturmaya yönelik öğreticiye giriş" idi.
...
ms.locfileid: "73824204"
---
# <a name="lcs-subscription"></a>LCS aboneliği
