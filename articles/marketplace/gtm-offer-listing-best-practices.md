...
* Birincil ve ikincil kategori dahil olmak üzere en fazla iki (2) kategori (isteğe bağlı).
* Her birincil ve/veya ikincil kategori için en fazla iki (2) alt kategorisi. Alt kategori seçilmezse, teklif yalnızca seçili kategori üzerinde bulunabilir olmaya devam eder.

| [**Azure Marketi**](https://azuremarketplace.microsoft.com/marketplace/apps) (BT uzmanları ve geliştiriciler)  | [**Appsource**](https://appsource.microsoft.com/marketplace/apps) (iş kullanıcıları)|
| :------------------- |:----------------|
|**Analiz** | **Analiz** |
