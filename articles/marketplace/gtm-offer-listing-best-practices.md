---
title: Go-to-market Services-teklif listesi en iyi uygulamalar | Mavisi
...
* **kaynak**: Trafiğin AppSource 'a yönlendirildiği kaynağı ekleyin (örneğin, Web sitesi, LinkedIn veya Facebook).
* **mktcmpıd**: Tüm harf, sayı, alt çizgi ve kısa çizgi birleşimlerinde en fazla 16 karakter içerebilen pazarlama kampanyası KIMLIĞINIZ (örneğin, *blogpost_12*).
