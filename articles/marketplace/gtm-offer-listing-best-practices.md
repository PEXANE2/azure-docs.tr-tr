...
| Anahtar sözcükleri ara (en fazla 3) | Arama anahtar sözcükleri, iş kullanıcılarının arama sırasında teklifinizi bulmasına yardımcı olabilir <ul>  <li>Microsoft AppSource</li> <li>Azure Marketi 'nde</li><li>Arama altyapılarını kullanma</li> </ul> Listelerinizin Bu aramalarda görünmesi için şunları yapmanız gerekir: <ul> <li> Teklifiniz için en üstteki üç arama anahtar sözcüğünü belirler; </li> <li> Arama anahtar sözcüklerini teklif özetinizdeki ve açıklamasında ekleyin; </li> <li> Arama anahtar sözcüklerini buraya listeleyin. </li> </ul> |

### <a name="category"></a>Kategori

Microsoft AppSource ve Azure Market, farklı ve benzersiz müşteri gereksinimlerine yönelik olarak tasarlanmıştır. Müşterilerinizi role göre hedeflemek için her teklifin doğru storefront ve kategorilerini seçin. 
...
| Kamu    | * Savunma & zeka (Ulusal ve genel güvenlik olarak adlandırılabilmesi için kullanılır) <br> * Genel güvenlik & Let <br> * Cıvilian kamu |
