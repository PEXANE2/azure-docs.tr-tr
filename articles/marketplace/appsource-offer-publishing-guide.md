...
Microsoft AppSource, Office 365, Dynamics 365, Power Apps ve Power BI oluşturan veya genişleten teklifleri içerir. Bu ürünlerin her birinde yayımlama sürecinde size kılavuzluk eden belirli belgeler vardır. 

AppSource 'ta ödeme, liste ve deneme teklifleri sunulduğundan, *Şimdi*eyleme *geçin, benimle Iletişim kurun*ve *Şimdi deneyin*.
...
| :------------------- | :-------------------|
| Office 365 | [Yayımlama işlemini ve yönergeleri](/office/dev/store/submit-to-appsource-via-partner-center)gözden geçirin. |
