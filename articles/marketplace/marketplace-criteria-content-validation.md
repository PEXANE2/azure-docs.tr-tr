...
| 3 | Logo | Logo doğru şekilde görüntülenir | Logo doğru şekilde görüntülenir ve Azure portalında büyük biçimli görüntü olan [Hero görüntüsünü](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal-orig/cloud-partner-portal-solution-template-offer-publish) içerir |
...
| 5 | Kategoriler & sektör | <br>• Kategoriler çözüm teklif özellikleri ile eşleşir <br>• Çözümün sığmadığı kategorilere genişlemeyin <br>• En iyi sektör veya tüm sektörler seçildi (en iyi sektörler yoksa) | <br>Biçimlendir. 3 kategori <br>Biçimlendir. 3 sektör |
| 6 | Görüntüler | <br>• Görüntü gerekmez, ancak sağlanmışsa ve yüksek çözünürlüklü bir görüntü olması gerekir. <br>• Görüntü gereksinimleri CPP ve ayrıca burada listelenir <br>• Ekran görüntüsüne eklenen metin, şifresiz görüntüyle okunabilir | Çözüm sunumu bir bakışta kolayca anlaşılır |
...
| 8 | Liste durumu (eylem çağrısı) | <br>Aşağıdaki türden biri etiketlenmelidir: <ul>Benimle Iletişim kurun</ul><ul>o deneme/deneme sürümünü şimdi al/deneme/test sürüşü Başlat</ul><ul>Şimdi satın alın/hemen alın</ul> | Müşteri, kullanılabilir olan sonraki adımların ne olduğunu kolayca anlayabilir: <ul>1. Denemeyi deneyin</ul> <ul>2. Şimdi Satın Alın</ul><ul>3. PoC, değerlendirme veya Brit için düzenlemek amacıyla e-posta veya telefon numarası ile iletişim kurun.</ul> | 
...
|  | Listeleme öğesi | Temel gereksinimler | En iyi gereksinimler | 
|:--- |:--- |:--- |:--- |
|  | Liste durumu | Bağlantı, müşteri tarafından LED deneme deneyimine yol açmalıdır | Diğer CTAs (örn. Şimdi satın al) de kullanılabilir | 

---
## <a name="saas-apps-requirements"></a>SaaS uygulamaları gereksinimleri
...
| 2 | Teknik bilgi: Yapılandırma |<br>• SaaS uygulaması için, yalnızca uygulamanızı listelemek isteyip istemediğinizi veya müşterilerin uygulamanızı Azure üzerinden satın almasını etkinleştirmek istiyorsanız seçin.<br>• Teklifinizin Alım düğmesinde istediğiniz uygun metni seçin: Ücretsiz, ücretsiz deneme sürümü veya benimle Iletişim kurun<br>• Uygulamanız teknolojiyi kullanıyorsa yalnızca Seç (açılır kutu)-ilgili ürünlerden biri: Cortana Intelligence, Power BI çözüm şablonları, güç uygulamaları |  |
| 3 | Test Sürüşü | Seçin: Evet veya Hayır | Müşteri, kullanılabilir olan sonraki adımların ne olduğunu kolayca anlayabilir: <br>1. Denemeyi deneyin <br>2. Şimdi Satın Alın <br>3. PoC, değerlendirme veya Brit için düzenlemek amacıyla e-posta veya telefon numarası ile iletişim kurun. |
| 4 | Storefront ayrıntıları: Teklif Özeti | Bu, uygulamanızın arama sayfasında en fazla 100 karakter olacak şekilde görünür | |
| 5 | Storefront ayrıntıları: Sektörler | Sektörler (en fazla 2): Uygulamanızın en iyi hizalandığı ve için geçerli olduğu endüstrileri seçin. | |
...
| 10 | Kişiler Çözüm desteği & yardım | <br>• Mühendislik İletişim adı: Uygulamanız için mühendislik kişisinin adını girin. Bu kişi, Microsoft 'tan teknik iletişimler alır.<br>• Mühendislik iletişim e-postası:  Uygulamanızın mühendislik kişisinin e-posta adresini girin.<br>• Mühendislik kişileri telefonu: Mühendislik kişisinin telefon numarasını girin. ISO telefon numarası gösterimleri desteklenir; Ayrıntılar için bkz https://en.wikipedia.org/wiki/E.123.<br>• Destek iletişim adı: Uygulamanız için destek kişisinin adını girin. Bu kişi, Microsoft 'tan destek ile ilgili iletişimler alır.<br>• Destek iletişim e-postası: Uygulamanız için destek kişisinin e-posta adresini girin. <br>• Destek iletişim telefonu: Destek kişisinin telefon numarasını girin. ISO telefon numarası gösterimleri desteklenir; Ayrıntılar için bkz https://en.wikipedia.org/wiki/E.123. <br>• Destek URL 'SI: Destek sayfanızın URL 'sini girin. | <br>• Listelenen tüm destek yöntemleri: telefon & e-posta desteği. <br>• Deneme veya test sürücü döneminde ücretli destek ücretsizdir |
...
|  | Listeleme öğesi | Temel gereksinimler | En iyi gereksinimler | 
|:--- |:--- |:--- |:--- |
|1\. |Teklif ayarları | <br>• Teklif KIMLIĞI: En fazla 50 karakter <br>• Yayımcı KIMLIĞI: Açılan kutudan seç <br>Ada En fazla 50 karakter | Açıklamada zaten bulunan başlık stilini yansıtır; uzun başlıklar istemezsiniz. | 
| 2 | SKU | İş ortağı yeni SKU 'Lara tıklamalar| Açıklamada zaten bulunan başlık stilini yansıtır; uzun başlıklar istemezsiniz.  |
| 3 | Market yapıtları | Amblemler doğru şekilde görüntülenir |<br>• Logo, Azure portalında büyük biçimli görüntü olan "Hero görüntüsü" içerir <br>Ların Küçük (48x48) & büyük (216x216) gereksinimleridir <br>• Hero görüntü gereksinimleri: https://docs.microsoft.com/azure/marketplace/cloud-partner-portal-orig/cloud-partner-portal-solution-template-offer-publish<br>• Ekran görüntüsü (en fazla 5):  CPP, 1280 x 720 çözünürlükte bir. png görüntüsü gerektirir.|
