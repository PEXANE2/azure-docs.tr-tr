...
API 'nin bu sürümü için belgeler artık kullanılamıyor. Erişmeniz gerektiğini düşünüyorsanız, lütfen iletişim kurun saas-api-v1@microsoft.com .

Tüm yeni gelişmeler için, zaten v1 kullanıyor olsanız bile, [API 'Nin v2 sürümüne](./pc-saas-fulfillment-api-v2.md) geçin. Bu sürüm gelecekte tamamen kullanım dışı olacaktır.
