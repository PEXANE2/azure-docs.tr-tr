---
title: Mevcut bir teklifi güncelleştirme-Microsoft ticari marketi
description: Mevcut bir ticari Market teklifine veya planına güncelleştirme yapma, özel izleyicileri eşitleme ve bir teklifi kaldırma.
...
ms.locfileid: "93129992"
---
# <a name="update-existing-offers-in-the-commercial-marketplace"></a>Ticari Market 'teki mevcut teklifleri güncelleştirme

Bu makalede, mevcut tekliflerle ve planlarda nasıl güncelleştirme yapılacağı ve ayrıca ticari Market 'ten teklif kaldırma işlemleri açıklanmaktadır. Tekliflerinizi, Iş Ortağı Merkezi ' nde [ticari Market portalının](https://partner.microsoft.com/dashboard/commercial-marketplace/offers) **genel bakış** sekmesinde görebilirsiniz.

## <a name="update-a-published-offer"></a>Yayınlanmış bir teklifi güncelleştirme
...
## <a name="update-a-plan-for-an-existing-offer"></a>Mevcut bir teklif için bir planı güncelleştirme
...
## <a name="compare-changes-to-your-offer"></a>Teklifinizdeki değişiklikleri karşılaştırın

Canlı veya [Önizleme](#compare-changes-to-a-preview-offer) teklifinizin güncelleştirmelerini yayımlamadan önce, **karşılaştırma** sayfasında kaydedilen değişiklikleri denetleyebilirsiniz. **Özellikler** veya **teklif listesi** sayfası gibi herhangi bir teklif sayfasının sağ üst köşesindeki **Karşılaştır** sayfasına erişebilirsiniz. **Compare** sayfasında, bu teklifin kaydedilen değişikliklerinin ve yayımlanan Market teklifinin yan yana sürümleri gösterilir.
...
2. Açılan menü **ile** öğesini seçin ve **canlı tekliften** **Önizleme teklifini** değiştirin. Teklifiniz henüz canlı değilse **canlı teklif** seçeneğini görmezsiniz.
...
Microsoft ticari Market 'ten teklif listelerini ve planları kaldırabilirsiniz. Bu, yeni müşterilerin bunları bulmasını ve satın almasını engeller. Teklifi veya planı önceden almış olan müşteriler onu kullanmaya devam edebilir ve gerekirse yeniden indirebilir. Bununla birlikte, teklif veya planı daha sonra yeniden yayımlamayı seçerseniz güncelleştirmeler almaz.

- Bir teklifi yayımladıktan sonra satışı durdurmak için **teklif genel bakış** sayfasından **satışı durdur** ' u seçin. Onayınızı birkaç saat içinde, teklif artık ticari Market 'te görünmez olmayacaktır.

- Bir planı satmaya durdurmak için **plana genel bakış** sayfasından **satışı durdur** ' u seçin. Bir planı satmaya durdurma seçeneği yalnızca teklifte birden fazla planınız varsa kullanılabilir. Teklifinizin içindeki diğer planları etkilemeden bir plan satmaya izin vermeyi seçebilirsiniz.
     >[!NOTE]
     > Planı satmaya durdurmak istediğinizi onaylayın, değişikliğin etkili olması için teklifi yeniden yayımlamanız gerekir.

Bir teklif veya planı satmaya durdurduktan sonra, bunu Iş Ortağı Merkezi 'nde **mevcut olmayan** bir durum ile görmeye devam edersiniz. Bu teklifi veya planı yeniden listeya da satmaya karar verirseniz, [yayınlanmış bir teklifi güncelleştirmek](#update-a-published-offer)için yönergeleri izleyin. Herhangi bir değişiklik yaptıktan sonra teklifi veya planı **yayımlamanız** gerektiğini unutmayın.
...
- [Ticari Market teklifinizin Yayımlanma durumunu kontrol edin](../review-publish-offer.md)
