---
title: VM Görüntünüz için paylaşılan erişim imzası URI 'SI alın | Azure Marketi
description: Bu makalede, her bir sanal sabit disk (VHD) için paylaşılan erişim imzası (SAS) URI 'sinin nasıl alınacağı açıklanmaktadır.
author: anbene
