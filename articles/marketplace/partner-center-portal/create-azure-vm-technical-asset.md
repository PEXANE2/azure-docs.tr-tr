...
Linux tabanlı bir VM 'ye bağlanmak için güvenli bir kabuk Protokolü (SSH) istemcisine ihtiyacınız vardır. Aşağıdaki adımlarda ücretsiz [Putty](https://www.ssh.com/ssh/putty/) SSH terminali kullanılır.
