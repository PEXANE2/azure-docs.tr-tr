...
Test sürücüsü, bu kullanıcılara teklifinizi "satın almadan önce dene" seçeneği sunarak, daha fazla dönüştürmeye ve yüksek oranda nitelikli müşteri adaylarının oluşturulmasına neden olacak şekilde sergilemenin harika bir yoludur. Daha fazla bilgi edinmek için bkz. [müşterilerinizin teklifinizi sürücüyü test](./test-drive.md)etme olanağı sağlar.
...
- [Test sürücüsü pazarlama en iyi uygulamaları](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal/test-drive/marketing-and-best-practices)- [test sürücüsü teknik en iyi yöntemler](https://github.com/Azure/AzureTestDrive/wiki/Test-Drive-Best-Practices)
- [Test sürücüsüne genel bakış (PDF indirme)](https://assetsprod.microsoft.com/mpn/azure-marketplace-appsource-test-drives.pdf)
...
Ücretsiz deneme yapılandırma özelliği, teklifinizin her bir planı için kullanılabilir. Her teklifin fiyatlandırma ve kullanılabilirliğine gidin ve bir aylık denemeye izin vermek için kutuyu işaretleyin.
...
Planınız için Birleşik Devletler dolar (USD) cinsinden zaten fiyatlar ayarladıysanız ve başka bir pazar konumu eklerseniz, yeni pazar fiyatı geçerli döviz kurlarına göre hesaplanır. Yayımlamadan önce her bir pazar için fiyatı gözden geçirin. Fiyatlandırma, değişiklikleriniz kaydedildikten sonra "fiyatları dışarı aktar (xlsx)" bağlantısı kullanılarak incelenebilir.
