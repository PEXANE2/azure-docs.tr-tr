...
![Uygulamaları kaydetme](./media/authenticate/app-registrations-register.png)
...
## <a name="add-rbac-roles-using-the-azure-portal"></a>Azure portal kullanarak RBAC rolleri ekleme  
