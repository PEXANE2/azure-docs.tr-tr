...
7. SSH için 22 numaralı bağlantı noktasını açmak üzere bir kural ekleyin. Aşağıdaki ayarları kullanın:
    ...
    |Kaynak IP adresleri|Genel IP 'nizi <\>|Genel IP adresinizi girin. [Bing.com](https://www.bing.com/) adresini ziyaret ederek ve **"My IP"** araması yaparak genel IP adresinizi bulabilirsiniz.|
    ...
    |Hedef IP adresleri|VM genel IP 'nizi <\>|Sanal makinenizin genel IP adresini girin. Bunu, sanal makinenizin **genel bakış** sayfasında bulabilirsiniz.|
