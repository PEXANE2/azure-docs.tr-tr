...
> Bulut hizmetlerini mobil uygulamanızla tümleştirmek istiyorsanız bugün [App Center](https://appcenter.ms/signup?utm_source=zumo&utm_medium=Azure&utm_campaign=zumo%20doc)'a kaydolun.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Mobile Apps hakkında bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>App Service Video Kitaplığı</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Android uygulaması oluşturmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Apache Cordova uygulaması oluşturmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>iOS uygulaması oluşturmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Windows uygulaması oluşturmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>xamarin.iOS uygulaması oluşturmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Diller</h3>
                        <p><a href="https://msdn.microsoft.com/library/azure/dn961176.aspx">.NET arka uç SDK’sı</a></p>
                        <p><a href="https://azure.github.io/azure-mobile-apps-node/">Node.js arka uç SDK’sı</a></p>
                        <p><a href="https://azure.github.io/azure-mobile-apps-android-client/">Android istemci SDK’sı</a></p>
                        <p><a href="https://azure.github.io/azure-mobile-apps-ios-client/">iOS istemci SDK’sı</a></p>
                        <p><a href="https://azure.github.io/azure-mobile-apps-js-client/">JavaScript/Cordova istemci SDK’sı</a></p>
                        <p><a href="https://msdn.microsoft.com/library/azure/mt419521.aspx">Windows/Xamarin istemci SDK’sı</a></p>
                    </div>
                </div>
            </div>
        </div>
