...
[Azure Portal](batch-account-create-portal.md) veya komut satırından ([POWERSHELL](batch-powershell-cmdlets-get-started.md) /[Azure CLI](/cli/azure)) oluşturabilirsiniz.
