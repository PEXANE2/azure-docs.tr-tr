---
title: Azure Batch görev başarısız olayı | Microsoft Docs
description: Batch görevi hata olayı için başvuru.
services: batch
author: laurenhughes
manager: gwallace
ms.assetid: ''
...
|Öğe adı|Type|Notlar|
|------------------|----------|-----------|
|Numberofınstances|Int32|Görevin gerektirdiği işlem düğümü sayısı.|
