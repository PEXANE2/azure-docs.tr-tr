---
title: Disk şifrelemesi etkinken havuz oluşturma
...
ms.locfileid: "89038693"
---
# <a name="create-a-pool-with-disk-encryption-enabled"></a>Disk şifrelemesi etkinken havuz oluşturma
...
![Azure portal disk şifrelemesi yapılandırma seçeneğinin ekran görüntüsü.](./media/disk-encryption/portal-view.png)

Havuz oluşturulduktan sonra, havuzun **Özellikler** bölümünde disk şifrelemesi yapılandırma hedeflerini görebilirsiniz.

![Azure portal disk şifrelemesi yapılandırma hedeflerini gösteren ekran görüntüsü.](./media/disk-encryption/disk-encryption-configuration-target.png)
