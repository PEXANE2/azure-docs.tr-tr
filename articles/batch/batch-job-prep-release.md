...
Iş sürümü görevleri, Batch hizmeti tarafından sonlandırılmadan önce en fazla 15 dakika boyunca çalıştırılabilir. Daha fazla bilgi için [REST API başvuru belgelerine](/rest/api/batchservice/job/add#jobreleasetask)bakın.
> 
> 
