...
1. Ardından, **ad** kutusuna uygulamanız için genel olarak benzersiz bir ad sağlayın. Geçerli karakterler `a-z` ,, `A-Z` ve `0-9` içerir `-` . Bu değer, statik uygulamanız için biçiminde URL öneki olarak kullanılır `https://<APP_NAME>....` .
...
1. _Uygulama yapıtı konumunu_ **ortak**olarak ayarlayın.
   ...
   :::image type="content" source="./media/publish-hugo/build-details.png" alt-text="Derleme ayarları":::
...
1. `- uses: actions/checkout@v1`Kugo uygulamasını derlemek için çizgiyi (18. satır) aşağıdaki ile değiştirin.
