...
VM içinde çalışan konuk işletim sistemi, .NET tabanlı veya Java Web uygulaması bileşenlerinde performans ve sistem durumu sorunlarını algılamak ve tanılamak için Azure Izleyici, VM'ler için Azure İzleyici ve Application Insights gibi kapsamlı özelliklerle merkezi bir izleme sağlar.
