...
ms.locfileid: "98901245"
---
Azure IoT Hub kullanmaya başlayın ve IoT DevKit kullanarak diğer IoT senaryolarını araştırmak için aşağıdakilere bakın:

- [IoT DevKit 'i Azure IoT uzaktan Izleme çözüm hızlandırıcısına bağlama](/previous-versions/azure/iot-accelerators/iot-accelerators-arduino-iot-devkit-az3166-devkit-remote-monitoring-v2)
...
- [Manyetik algılayıcıyı izleme ve Azure İşlevleri ile e-posta bildirimleri gönderme](../articles/iot-hub/iot-hub-arduino-iot-devkit-az3166-door-monitor.md)