...
1. **Gözden geçir + oluştur** ve sonra **Oluştur**' u seçin.
    ...
    ![Disk şifrelemesi oluşturma dikey penceresinin ekran görüntüsü. Abonelik, kaynak grubu, disk şifreleme kümesi adı, bölge ve Anahtar Kasası + anahtar Seçicisi gösteriliyor.](media/virtual-machines-disk-encryption-portal/server-side-encryption-disk-encryption-set-blade-key.png)
