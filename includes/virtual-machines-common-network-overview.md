...
| [Azure CLI](../articles/virtual-network/quick-create-cli.md) | Alt ağ ve VNet aynı anda oluşturulur. **az network vnet create** komutuna alt ağın adını içeren bir [--subnet-name](https://docs.microsoft.com/cli/azure/network/vnet) parametresi sağlayın. |
