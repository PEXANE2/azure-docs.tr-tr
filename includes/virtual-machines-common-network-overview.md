...
| Yöntem | Açıklama |
| ------ | ----------- |
| Azure portalında |  [Azure Portal kullanarak, sanal makinelere internet trafiği dengeleyebilirsiniz](../articles/load-balancer/tutorial-load-balancer-standard-manage-portal.md). |
...
| Yöntem | Açıklama |
| ------ | ----------- |
| Azure portalında | [Azure Portal temel yük dengeleyiciye iç trafik yükünü dengeleyebilirsiniz](../articles/load-balancer/tutorial-load-balancer-basic-internal-portal.md). |
