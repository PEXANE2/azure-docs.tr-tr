...
| Yöntem | Açıklama |
| ------ | ----------- |
| Azure Portal | [Azure Portal temel yük dengeleyiciye iç trafik yükünü dengeleyebilirsiniz](../articles/load-balancer/tutorial-load-balancer-basic-internal-portal.md). |
