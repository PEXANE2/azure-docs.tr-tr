...
|Dil                                 |'in         |2.x| 3.x |
|-----------------------------------------|------------|---| --- |
|[, #](../articles/azure-functions/functions-reference-csharp.md)|GA (.NET Framework 4,7)|GA (.NET Core 2,2)| GA (.NET Core 3,1) |
...
|[PowerShell](../articles/azure-functions/functions-reference-powershell.md) |Yok|GA (PowerShell Core 6)| GA (PowerShell Core 6)|
...
<sup>1</sup> Transpiling aracılığıyla JavaScript 'e desteklenir.
