...
| Klasik | [Öğretici](../articles/vpn-gateway/vpn-gateway-howto-point-to-site-classic-azure-portal.md) | Desteklenir |

**Radius kimlik doğrulaması**

**Dağıtım modeli/yöntemi** | **Azure portalı** | **PowerShell** |
|---|---|---|
| Resource Manager | Desteklenir | [Öğretici](../articles/vpn-gateway/point-to-site-how-to-radius-ps.md)|
