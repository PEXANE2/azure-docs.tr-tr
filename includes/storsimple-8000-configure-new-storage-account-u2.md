...
1. StorSimple Cihaz Yöneticisi hizmetinize gidin. **Yapılandırma** bölümünde **Depolama hesabı kimlik bilgileri** ’ne tıklayın.
    ...
    ![Depolama hesabı kimlik bilgilerine git](./media/storsimple-8000-configure-new-storage-account-u2/createnewstorageacct1.png)
...
![Depolama hesabı kimlik bilgilerini listeleyin](./media/storsimple-8000-configure-new-storage-account-u2/createnewstorageacct6.png)
