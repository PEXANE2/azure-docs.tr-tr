...
1. **Tüm hizmetler**  >  **depolama hesapları**' na tıklayın ve ardından depolama hesabınızın adına tıklayın.
2. **BLOB**  >  *çıktısı*' na tıklayın.
...
![Çıkış dosyasını indirme](./media/batch-common-tutorial-download/download.png)
