...
2. Sanal ağınızın sayfasında, **Ayarlar** bölümünde **DNS sunucuları**' nı seçin.
3. Bir DNS sunucusu ekleyin.
4. Ayarlarınızı kaydetmek için sayfanın en üstünde bulunan **Kaydet** ' i seçin.