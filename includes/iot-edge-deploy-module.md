...
1. Sihirbazın **rotalar** sekmesinde, iletilerin modüller arasında nasıl geçtiğini tanımlar ve IoT Hub. İletiler ad/değer çiftleri kullanılarak oluşturulur. Hızlı başlangıç için tüm modüllerden gelen tüm iletilerin IoT Hub (`$upstream`) gitmesini istiyorsunuz. Otomatik olarak doldurulmamışsa, `upstream`**adı** **için aşağıdaki** kodu ekleyin:
