...
Yerel makinenizden uzak SSH oturumu açmak için bkz. [Uzak kabuktan SSH oturumu açma](../articles/app-service/configure-linux-open-ssh-session.md#open-ssh-session-from-remote-shell).