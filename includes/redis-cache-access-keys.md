...
- Ana bilgisayar adını ve bağlantı noktalarını, önbellek sol gezininizden almak için **Özellikler**' i seçin. Ana bilgisayar adı, * \<>. Redis.cache.Windows.net biçiminde DNS adıdır*.
