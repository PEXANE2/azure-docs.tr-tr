...
ms.locfileid: "70232050"
---
* [Uygulama Hizmeti Kimlik Doğrulama / Yetkilendirme genel bakış](../articles/app-service/overview-authentication-authorization.md).
* [Azure Uygulama Hizmeti'nde kimlik doğrulama ve yetkilendirmenin gelişmiş kullanımı](../articles/app-service/app-service-authentication-how-to.md)
* Mobil Uygulamaiçin kimlik doğrulama ekleyin: [iOS][ios-get-started-users], [Android][android-get-started-users], [Windows Universal][windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms][xamarin-forms-get-started-users], [Cordova][cordova-get-started-users].  
