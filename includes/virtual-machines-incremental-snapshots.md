...
* İlk olarak, [anlık görüntü blobu](/rest/api/storageservices/Snapshot-Blob) işlemini kullanarak temel Blobun anlık görüntüsünü alın.
* Ardından, [kopya blobu](/rest/api/storageservices/Copy-Blob)kullanarak anlık görüntüyü bir hedef depolama hesabına kopyalayın.
...
* Blob, [Putpage](/rest/api/storageservices/Put-Page) veya iki anlık görüntü arasındaki [kopya blobu](/rest/api/storageservices/Copy-Blob) ile üzerine yazılmadı.
...
* [Anlık görüntü blobu](/rest/api/storageservices/Snapshot-Blob)kullanarak temel Blobun anlık görüntüsünü alın.
* Anlık görüntüyü, [kopya blobu](/rest/api/storageservices/Copy-Blob)kullanarak aynı veya başka bir Azure bölgesindeki hedef yedekleme depolama hesabına kopyalayın. Bu, yedekleme sayfası blobudur. Yedekleme sayfası blobunun anlık görüntüsünü alın ve yedekleme hesabında saklayın.
...
* Bu değişiklikleri yedekleme sayfası blobuna uygulamak için [putpage](/rest/api/storageservices/Put-Page) kullanın.
...
Depolama hesabı oluşturma hakkında bilgi edinmek için bkz. [depolama hesabı oluşturma](../articles/storage/common/storage-account-create.md).
...
3. [Anlık görüntü blobu](/rest/api/storageservices/Snapshot-Blob) kullanarak *mybackupstdpageblob_ss1* adlı *mybackupstdpageblob* 'un anlık görüntüsünü alın ve *mybackupstdaccount* içinde saklayın.
...
5. *Mypremiumdisk_ss2* ve *mypremiumdisk_ss1* iki **anlık görüntü arasında** artımlı değişiklikler alın, bu, *mypremiumdisk_ss2* üzerinde [getpageranges](/rest/api/storageservices/Get-Page-Ranges) kullanarak *mypremiumdisk_ss1* zaman damgasına ayarlanır. Bu artımlı değişiklikleri *mybackupstdaccount* içindeki *mybackupstdpageblob* yedekleme sayfasına yazın. Artımlı değişiklikler içinde silinen aralıklar varsa, bunların yedekleme sayfası blobundan temizlenmesi gerekir. Yedekleme sayfası blobuna artımlı değişiklikler yazmak için [putpage](/rest/api/storageservices/Put-Page) kullanın.
