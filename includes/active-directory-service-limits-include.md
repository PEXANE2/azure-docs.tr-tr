...
| Uygulama Proxy'si | <ul><li>Her uygulama proxy uygulaması için saniyede en fazla 500 işlem</li><li>Azure AD kuruluşu için saniye başına en fazla 750 işlem</li></ul><br/>Bir işlem, benzersiz bir kaynak için tek bir http isteği ve yanıtı olarak tanımlanır. Kısıtlandığınızda, istemciler bir 429 yanıtı (çok fazla istek) alır. |
