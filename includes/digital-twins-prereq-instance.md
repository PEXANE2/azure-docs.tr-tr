...
* Örneğin **ana bilgisayar adı**. Bu değeri Azure portal ([yönergeler](../articles/digital-twins/how-to-set-up-instance-portal.md#verify-success-and-collect-important-values)) içinde bulabilirsiniz.
