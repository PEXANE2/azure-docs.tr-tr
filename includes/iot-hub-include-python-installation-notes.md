...
* Gerekirse, komutunu kullanarak [Azure-IoT-Device](https://pypi.org/project/azure-iot-device/) paketini yükledikten sonra`pip install azure-iot-device`
