...
| Tutarlılık | Birincil bölge içinde güçlü. İkincil bölge içinde nihai. | Uygulama gereksinimlerinize bağlı olarak kullanılabilirliği, gecikmeyi, iş ortalığını ve tutarlılığı kapatmak için [iyi tanımlanmış beş tutarlılık düzeyi.](../articles/cosmos-db/consistency-levels.md) |
