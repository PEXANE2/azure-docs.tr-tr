...
| Tablo depolama| [Giriş](../articles/azure-functions/functions-bindings-storage-table.md?tabs=csharp#input)<br/>[Çıktı](../articles/azure-functions/functions-bindings-storage-table.md?tabs=csharp#output) | |
...
| Tablo depolama| [Giriş](../articles/azure-functions/functions-bindings-storage-table.md?tabs=java#input)<br/>[Çıktı](../articles/azure-functions/functions-bindings-storage-table.md?tabs=java#output) | |
...
| Tablo depolama| [Giriş](../articles/azure-functions/functions-bindings-storage-table.md?tabs=javascript#input)<br/>[Çıktı](../articles/azure-functions/functions-bindings-storage-table.md?tabs=javascript#output) | |
...
| Tablo depolama| [Giriş](../articles/azure-functions/functions-bindings-storage-table.md?tabs=powershell#input)<br/>[Çıktı](../articles/azure-functions/functions-bindings-storage-table.md?tabs=powershell#output) | |
...
| Tablo depolama| [Giriş](../articles/azure-functions/functions-bindings-storage-table.md?tabs=python#input)<br/>[Çıktı](../articles/azure-functions/functions-bindings-storage-table.md?tabs=python#output) | |
