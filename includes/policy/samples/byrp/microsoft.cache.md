...
ms.locfileid: "84230828"
---
|Adı |Açıklama |Efekt (ler) |Sürüm |GitHub |
|---|---|---|---|---|
|[Redo için Azure önbelleği bir sanal ağ içinde yer almalıdır](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F7d092e0a-7acd-40d2-a975-dca21cae48c4) |Bu ilke, Redo kaynak için Azure önbelleğinin bir sanal ağa dağıtılarak genel olmayan bir uç noktaya sahip olup olmadığını denetler. |Denetim, reddetme, devre dışı |1.0.0 |[Bağlantısının](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Cache/RedisCache_CacheInVnet_Audit.json) |
