...
|[MariaDB sunucusu bir sanal ağ hizmeti uç noktası kullanmalıdır](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fdfbd9a64-6114-48de-a47d-90574dc2e489) |Bu ilke, bir sanal ağ hizmeti uç noktası kullanmak üzere yapılandırılmayan MariaDB sunucularını denetler. Daha fazla ayrıntı için, [https://aka.ms/mariadbvirtualnetwork](https://aka.ms/mariadbvirtualnetwork)adresini ziyaret edin. |Auditınotexists, devre dışı |1.0.1 |[Bağlantı](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/MariaDB_VirtualNetworkServiceEndpoint_Audit.json) |
|[MariaDB sunucuları için özel uç nokta etkinleştirilmelidir](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F0a1302fb-a631-4106-9753-f3d494733990) |Bu ilke, özel bir uç nokta kullanmak üzere yapılandırılmayan MariaDB sunucularını denetler. Daha fazla ayrıntı için, [https://aka.ms/mariadbprivatelink](https://aka.ms/mariadbprivatelink)adresini ziyaret edin. |Auditınotexists, devre dışı |1.0.1 |[Bağlantı](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/MariaDB_EnablePrivateEndPoint_Audit.json) |
|[MariaDB sunucuları için genel ağ erişimi devre dışı bırakılmalıdır](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ffdccbe47-f3e3-4213-ad5d-ea459b2fa077) |Bu ilke, ortamınızdaki genel ağ erişimi etkinleştirilmiş olan MariaDB sunucularını denetler. Daha fazla ayrıntı için, [https://go.microsoft.com/fwlink/?linkid=2119542](https://go.microsoft.com/fwlink/?linkid=2119542)adresini ziyaret edin. |Denetim, devre dışı |1.0.0 |[Bağlantı](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/MariaDB_DisablePublicNetworkAccess_Audit.json) |
