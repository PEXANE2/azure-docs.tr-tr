...
1. Veri Gezgini'ndeki **Öğeler** sekmesinin üst kısmında `SELECT * FROM c`varsayılan sorguyu gözden geçirin. Bu sorgu, koleksiyondaki tüm belgeleri kimlik sırasına göre alır ve görüntüler. 
