...
ms.locfileid: "67188722"
---
> [!NOTE]
> Örneği basitleştirmek için Batch ve Depolama hesabı kimlik bilgileri düz metin şeklinde gösterilmiştir. Uygulamada kimlik bilgilerine erişimi kısıtlamanızı ve bunlara kodunuzda ortam değişkenlerini kullanarak veya yapılandırma dosyası ile başvurmanızı öneririz. Örnekler için bkz. Azure Batch [kod örnekleri deposu](https://github.com/Azure-Samples/azure-batch-samples).
>
