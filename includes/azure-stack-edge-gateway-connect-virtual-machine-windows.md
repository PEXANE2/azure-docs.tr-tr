...
1. VM 'nin IP adresini ve VM şablonu parametreleri dosyasında kullandığınız erişim kimlik bilgilerini girin.
    ...
    ![Windows VM 'ye RDP aracılığıyla bağlanma](media/azure-stack-edge-gateway-connect-vm-windows/connect-vm-rdp-1.png)
1. Güvenilmeyen bir makineye bağlanmayı onaylamanız gerekebilir. 
1. Artık gereç üzerinde çalışan sanal makinenizde oturum açtınız. 