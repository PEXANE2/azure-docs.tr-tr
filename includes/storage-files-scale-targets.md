...
| Dosya paylaşımının en büyük boyutu | 5 TiB (GA), 100 TiB (Önizleme) | 100 TiB |
| Dosya paylaşımındaki bir dosyanın en büyük boyutu | 1 TiB | 1 TiB |
| Dosya paylaşımındaki en fazla dosya sayısı | Sınır yok | Sınır yok |
| Paylaşma başına maksimum ıOPS | 1\.000 ıOPS (GA), 10.000 ıOPS (Önizleme) | 100.000 IOPS |
| Dosya paylaşma başına en fazla depolanan erişim ilkesi sayısı | 5 | 5 |
| Tek bir dosya paylaşımının hedef performansı | En fazla 60 MIB/sn (GA), en fazla 300 MIB/sn (Önizleme) | Bkz. Premium dosya paylaşma giriş ve çıkış değerleri|
