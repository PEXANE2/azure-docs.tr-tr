...
---
## <a name="request-and-response-json"></a>JSON iste ve Yanıtla

REST API için JSON biçimli örnek bir soru:
...
Bu soru, ilk üç yanıtı döndüren bir özelliği içerir. 

Yanıt bir JSON nesnesinde döndürülür:
