...
4. Yeni sunucu ayrıntıları formunu aşağıdaki bilgilerle doldurun:
   ...
   - Onay kutusunu etkinleştirin, **Önizleme özelliklerini etkinleştirin**.
...
5. **Sunucu grubunu yapılandır** öğesine tıklayın.
   - **Katman** için **temel** radyo düğmesini seçin.
   - **Kaydet**’e tıklayın.
