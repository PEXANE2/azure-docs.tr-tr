...
[**Azure dijital TWINS Gezgini**](https://docs.microsoft.com/samples/azure-samples/digital-twins-explorer/digital-twins-explorer/) , Azure dijital TWINS 'i görselleştirme ve bunlarla çalışmaya yönelik örnek bir uygulamadır. Uygulama kodunu indirmek ve çalıştırmak için örnekle birlikte sunulan yönergeleri izleyin. 
