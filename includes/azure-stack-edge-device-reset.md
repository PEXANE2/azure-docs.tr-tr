...
2. **Cihazı Sıfırla**' yı seçin.
    ...
    ![Cihaz sıfırlama](media/azure-stack-edge-device-reset/device-reset-1.png)

3. Onay istendiğinde, uyarıyı gözden geçirin ve devam etmek için **Evet** ' i seçin.

    ![Sıfırlamayı Onayla](media/azure-stack-edge-device-reset/device-reset-2.png)  
