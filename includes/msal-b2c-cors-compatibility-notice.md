...
ms.locfileid: "87311559"
---
> [!IMPORTANT]
> MSAL.js 2,0, şu anda PKI CE yetkilendirme kodu akışıyla kullanım için Azure AD B2C desteklememektedir. Şu anda Azure AD B2C, [öğretici: uygulamayı kaydetme][implicit-flow]bölümünde açıklandığı gibi örtük akışın kullanılmasını önerir. Bu sorunla ilgili ilerleme durumunu izlemek için bkz. [MSAL.js wiki][msal-wiki].
