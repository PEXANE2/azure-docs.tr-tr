...
Bağlantı dizenizi kopyaladıktan sonra, *MainPage.xaml.cs* dosyanızda bir sınıf düzeyi değişkenine ayarlayın. *MainPaage.xaml.cs* açın ve `storageConnectionString` değişkenini bulun. Gerçek `<yourconnectionstring>` bağlantı dizeniz ile değiştirin.
