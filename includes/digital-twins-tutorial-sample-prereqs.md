...
Öğretici, C# dilinde yazılmış örnek bir proje tarafından çalıştırılır. Örnek şurada bulunur: [Azure dijital TWINS örnekleri](https://docs.microsoft.com/samples/azure-samples/digital-twins-samples/digital-twins-samples). Örnek bağlantısına gidip başlık altındaki *posta indir* düğmesini seçerek makinenizde **örnek projeyi alın** .

Bu, bir yükler *. ZIP* klasörünü makinenize **Azure_Digital_Twins_samples.zip**. Klasörü sıkıştırmayı açın ve dosyaları ayıklayın.
