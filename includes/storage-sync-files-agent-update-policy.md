...
Bir kabuk açın ve eşitleme aracısını yüklediğiniz dizine gidin ve sunucu cmdlet 'lerini içeri aktarın, varsayılan olarak bu şuna benzer:
```powershell
...
Geçerli ilke ayarını gecikmeli güncelleştirme izlemesine göre değiştirmek için şunları kullanabilirsiniz:`Set-StorageSyncAgentAutoUpdatePolicy -PolicyMode UpdateBeforeExpiration`

Geçerli ilke ayarını anında güncelleştirme izi olarak değiştirmek için şunları kullanabilirsiniz:`Set-StorageSyncAgentAutoUpdatePolicy -PolicyMode InstallLatest`
