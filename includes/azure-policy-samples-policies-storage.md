...
ms.locfileid: "77193074"
---
|Ad |Açıklama |Efekt (ler) |Sürüm |
|---|---|---|---|
|[İzin verilen depolama hesabı SKU'ları](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Storage/AllowedStorageSkus_Deny.json) |Bu ilke, kuruluşunuzun dağıtabileceğiniz bir depolama hesabı SKU 'Ları kümesi belirtmenizi sağlar. |Reddet |1.0.0 |
...
|[Depolama hesaplarında Gelişmiş tehdit koruması dağıtma](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Storage/StorageAdvancedThreatProtection_Deploy.json) |Bu ilke, depolama hesaplarında Gelişmiş tehdit koruması sunar. |DeployIfNotExists, devre dışı |1.0.0 |
