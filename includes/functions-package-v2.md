...
| Azure Portalı             | Yalnızca portalda çevrimiçi | Bağlama eklerken yüklenir<br /><br /> İşlev uygulamanızı yeniden yayımlamak zorunda kalmadan mevcut bağlama uzantılarını güncelleştirmek için bkz. [uzantılarınızı güncelleştirme](../articles/azure-functions/install-update-binding-extensions-manual.md) . |
