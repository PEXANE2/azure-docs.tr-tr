...
-->
Kopyalama etkinliğini bir işlem hattı ile kullanmak için aşağıdaki araçlardan veya SDK 'Lardan birini kullanabilirsiniz. Adım adım yönergeler için bir bağlantı seçin:

- [Veri kopyalama aracı](../articles/data-factory/quickstart-create-data-factory-copy-data-tool.md)
