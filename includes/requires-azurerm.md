...
> 2. Bir PowerShell 5,1 oturumundan [Azurerd modülünü yükler](/powershell/azure/azurerm/install-azurerm-ps) .
> 3. [PowerShell Core 6. x veya üstünü indirin ve yükleyin](/powershell/scripting/install/installing-powershell-core-on-windows).
> 4. Bir PowerShell Çekirdek oturumunda [az Module 'Ü yükler](/powershell/azure/install-az-ps) .
