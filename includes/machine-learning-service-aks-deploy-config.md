...
| ----- | ----- | ----- |
| `computeType` | Yok | Bilgi işlem hedefi. AKS için değerin `aks`olması gerekir. |
| `autoScaler` | Yok | Otomatik ölçeklendirme için yapılandırma öğelerini içerir. Bkz. otomatik Scaler tablosu. |
...
| `dataCollection` | Yok | Veri toplama için yapılandırma öğelerini içerir. |
...
| `keys` | Yok | Anahtarlar için yapılandırma öğelerini içerir. |
...
| `livenessProbeRequirements` | Yok | Lizleştirme araştırma gereksinimleri için yapılandırma öğelerini içerir. |
