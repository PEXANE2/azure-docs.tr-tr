...
ms.locfileid: "92521418"
---
Aşağıdaki kaynaklar da kullanılabilir:

- [Java SDK başvuru belgeleri](/java/api/com.microsoft.azure.sdk.iot.service.devicetwin.devicetwindevice?preserve-view=true&view=azure-java-stable)
