...
1. **Uygulama yapılandırması** > **Oluştur** bölmesinde, aşağıdaki ayarları girin:
    ...
    |---|---|---|
    | **Kaynak adı** | Genel olarak benzersiz bir ad | Uygulama yapılandırma deposu kaynağı için kullanılacak benzersiz bir kaynak adı girin. Ad, 5 ila 50 karakter arasında bir dize olmalı ve yalnızca rakam, harf ve `-` karakteri içermelidir. Ad `-` karakteriyle başlayamaz veya bitemez.  |
