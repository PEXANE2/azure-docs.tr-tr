...
1. [Microsoft Azure Devlet Portalı'nda](https://portal.azure.us/)oturum açtırmak için Microsoft hesap kimlik bilgilerinizi kullanın.
2. Devlet Portalı'nda, **+** tıklatın ve ardından pazarda, **Tümlerini Gör'e**tıklayın. _StorSimple Fiziksel_ ifadesini aratın. **StorSimple Fiziksel Cihaz Serisi**‘ni seçip tıklayın ve **Oluştur**’a tıklayın. Alternatif olarak, Devlet portalında, **+** **depolama,** **StorSimple Fiziksel Aygıt Serisi'ni**tıklatın.
3. **StorSimple Cihaz Yöneticisi** dikey penceresinde aşağıdaki adımları gerçekleştirin:
   ...
   4. Hizmetiniz için bir **Konum** sağlayın. Konum, cihazınızı dağıtmak istediğiniz coğrafi bölge anlamına gelir. USGov **Iowa** veya **USGov Virginia**seçin.
   ...
   7. StorSimple Cihaz Yöneticisi’ni oluşturmak için **Oluştur**’a tıklayın. Hizmetin oluşturulması birkaç dakika sürer. Hizmet başarıyla oluşturulduktan sonra bir bildirim görürsünüz ve yeni hizmet dikey penceresi açılır.
