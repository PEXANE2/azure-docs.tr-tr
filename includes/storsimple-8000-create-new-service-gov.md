...
3. **StorSimple Cihaz Yöneticisi** dikey penceresinde aşağıdaki adımları gerçekleştirin:
   ...
   4. Hizmetiniz için bir **Konum** sağlayın. Konum, cihazınızı dağıtmak istediğiniz coğrafi bölgeyi ifade eder. **Usgov Iowa** veya **Usgov Virginia** öğesini seçin.
