...
Evet, Azure VPN ağ geçitleri artık 32 bit (4 baytlık) ASNs 'yi destekliyor. Lütfen tamsayı kullanarak ondalık biçimde yapılandırmak için PowerShell/CLı/SDK kullanın.
