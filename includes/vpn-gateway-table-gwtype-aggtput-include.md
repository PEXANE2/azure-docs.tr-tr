...
|**Generation1**|**VpnGw1AZ**| En çok, 30*   | En çok, 128  | En çok, 250       | 650 Mbps  | Desteklenen | Evet |
|**Generation1**|**VpnGw2AZ**| En çok, 30*   | En çok, 128  | En çok, 500       | 1 Gbps    | Desteklenen | Evet |
|**Generation1**|**VpnGw3AZ**| En çok, 30*   | En çok, 128  | En çok, 1000      | 1,25 Gb/sn | Desteklenen | Evet |
|        |            |            |           |                |           |           |     |
...
|**Generation2**|**VpnGw4**  | En çok, 30*   | En çok, 128  | En çok, 1000      | 5 Gbps    | Desteklenen | Hayır |
|**Generation2**|**VpnGw5**  | En çok, 30*   | En çok, 128  | En çok, 1000      | 10 Gbps   | Desteklenen | Hayır |
|**Generation2**|**VpnGw2AZ**| En çok, 30*   | En çok, 128  | En çok, 500       | 1,25 Gb/sn | Desteklenen | Evet |
|**Generation2**|**VpnGw3AZ**| En çok, 30*   | En çok, 128  | En çok, 1000      | 2,5 Gbps  | Desteklenen | Evet |
|**Generation2**|**VpnGw4AZ**| En çok, 30*   | En çok, 128  | En çok, 1000      | 5 Gbps    | Desteklenen | Evet |
|**Generation2**|**VpnGw5AZ**| En çok, 30*   | En çok, 128  | En çok, 1000      | 10 Gbps   | Desteklenen | Evet |
