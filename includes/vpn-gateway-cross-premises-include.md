...
---
|  | **Noktadan Siteye** | **Siteden Siteye** | **Ekspres Rota** |
| --- | --- | --- | --- |
...
| **Desteklenen Protokoller** |Güvenli Soketler Tünel Protokolü (SSTP), OpenVPN ve IPsec |IPsec |VLAN, NSP'nin VPN’si teknolojileri (MPLS, VPLS,...) üzerinden doğrudan bağlantı |
