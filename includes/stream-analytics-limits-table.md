...
ms.locfileid: "67188767"
---
---
| Sınır tanımlayıcı | Sınır | Açıklamalar |
| --- | --- | --- |
| Her bölge için abonelik başına en fazla akış birimi sayısı |500 |Aboneliğiniz için 500 ' den fazla akış birimlerinde artış istemek için [Microsoft desteği](https://support.microsoft.com/en-us)başvurun. |
